...
public class IjkMediaMeta {
    ...
    public static class IjkStreamMeta {
        ...
        public String getBitrateInline() {
            ...
            if (j3 < 1000) {
                return String.format(Locale.US, "%d bit/s", Long.valueOf(j3));
            }
            return String.format(Locale.US, "%d kb/s", Long.valueOf(j3 / 1000));
        }

        public String getChannelLayoutInline() {
            long j3 = this.mChannelLayout;
            if (j3 <= 0) {
                return WiFiDash.NOT_AVALIBLE;
            }
            if (j3 == 4) {
            ...
            return String.format(Locale.US, "%x", Long.valueOf(j3));
        }
        ...
        public String getFpsInline() {
            int i3;
            int i16 = this.mFpsNum;
            if (i16 > 0 && (i3 = this.mFpsDen) > 0) {
                return String.valueOf(i16 / i3);
            }
            return WiFiDash.NOT_AVALIBLE;
        }
        ...
        public String getResolutionInline() {
            ...
            if (i3 > 0 && this.mHeight > 0) {
                if (this.mSarNum > 0 && this.mSarDen > 0) {
                    return String.format(Locale.US, "%d x %d [SAR %d:%d]", Integer.valueOf(i3), Integer.valueOf(this.mHeight), Integer.valueOf(this.mSarNum), Integer.valueOf(this.mSarDen));
                }
                return String.format(Locale.US, "%d x %d", Integer.valueOf(i3), Integer.valueOf(this.mHeight));
            }
            return WiFiDash.NOT_AVALIBLE;
        }
        ...
        public String getSampleRateInline() {
            ...
            return String.format(Locale.US, "%d Hz", Integer.valueOf(i3));
        }
    ...
    public static IjkMediaMeta parse(Bundle bundle) {
        ...
        int i3 = -1;
        int i16 = ijkMediaMeta.getInt("video", -1);
        int i17 = ijkMediaMeta.getInt("audio", -1);
    ...
    public String getDurationInline() {
        long j3 = (this.mDurationUS + 5000) / 1000000;
        long j16 = j3 / 60;
        return String.format(Locale.US, "%02d:%02d:%02d", Long.valueOf(j16 / 60), Long.valueOf(j16 % 60), Long.valueOf(j3 % 60));
    }
