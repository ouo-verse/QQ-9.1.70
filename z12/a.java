...
public final class a implements ViewBinding {
    ...
    @NonNull
    private final LinearLayout f451725a;

    /* renamed from: b, reason: collision with root package name */
    @NonNull
    public final LinearLayout f451726b;

    /* renamed from: c, reason: collision with root package name */
    @NonNull
    public final ImageView f451727c;

    /* renamed from: d, reason: collision with root package name */
    @NonNull
    public final ImageView f451728d;

    /* renamed from: e, reason: collision with root package name */
    @NonNull
    public final TextView f451729e;

    /* renamed from: f, reason: collision with root package name */
    @NonNull
    public final GuildImmersiveTitleBar f451730f;
    ...
    a(@NonNull LinearLayout linearLayout, @NonNull LinearLayout linearLayout2, @NonNull ImageView imageView, @NonNull ImageView imageView2, @NonNull TextView textView, @NonNull GuildImmersiveTitleBar guildImmersiveTitleBar) {
        this.f451725a = linearLayout;
        this.f451726b = linearLayout2;
        this.f451727c = imageView;
        this.f451728d = imageView2;
        this.f451729e = textView;
        this.f451730f = guildImmersiveTitleBar;
    }
    ...
    public static a g(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.ewe, viewGroup, false);
        if (z16) {
