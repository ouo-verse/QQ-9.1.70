...
public final class GatewayVerify$RspPhoneSmsExtendLogin extends MessageMicro<GatewayVerify$RspPhoneSmsExtendLogin> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{82, 88, 98, 106, 114}, new String[]{"rpt_bind_uin_info", "int32_phone_bind_result", "str_phone_bind_msg_title", "str_phone_bind_msg_content", "str_unbind_wording"}, new Object[]{null, 0, "", "", ""}, GatewayVerify$RspPhoneSmsExtendLogin.class);
