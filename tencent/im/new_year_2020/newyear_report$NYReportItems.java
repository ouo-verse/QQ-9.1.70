...
public final class newyear_report$NYReportItems extends MessageMicro<newyear_report$NYReportItems> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 32, 42, 48}, new String[]{"optime", "event", "action", "result", "param_array", "count"}, new Object[]{0L, "", 0, 0, "", 0}, newyear_report$NYReportItems.class);
