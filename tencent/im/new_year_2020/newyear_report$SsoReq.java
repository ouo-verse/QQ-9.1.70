...
public final class newyear_report$SsoReq extends MessageMicro<newyear_report$SsoReq> {
    ...
    public newyear_report$NYReportReq data = new MessageMicro<newyear_report$NYReportReq>() { // from class: tencent.im.new_year_2020.newyear_report$NYReportReq
        ...
        public newyear_report$NYCommonInfo commonInfo = new MessageMicro<newyear_report$NYCommonInfo>() { // from class: tencent.im.new_year_2020.newyear_report$NYCommonInfo
    ...
    public newyear_report$OptionReq option = new MessageMicro<newyear_report$OptionReq>() { // from class: tencent.im.new_year_2020.newyear_report$OptionReq
        ...
        public final PBStringField f435961id = PBField.initString("");
