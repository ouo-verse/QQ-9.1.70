...
public final class mutualmark$ResourceInfo_17 extends MessageMicro<mutualmark$ResourceInfo_17> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 40, 50}, new String[]{"bytes_dynamic_url", "bytes_static_url", "bytes_cartoon_url", "bytes_cartoon_md5", "uint32_play_cartoon", "bytes_word"}, new Object[]{byteStringMicro, byteStringMicro, byteStringMicro, byteStringMicro, 0, byteStringMicro}, mutualmark$ResourceInfo_17.class);
    }

    public mutualmark$ResourceInfo_17() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
