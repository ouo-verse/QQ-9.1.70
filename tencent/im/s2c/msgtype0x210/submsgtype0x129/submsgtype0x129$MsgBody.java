...
public final class submsgtype0x129$MsgBody extends MessageMicro<submsgtype0x129$MsgBody> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 48}, new String[]{"uint64_seq", "uint32_action_type", "uint64_friend_uin", "uint64_oper_uin", "bytes_gray_tips", "join_state"}, new Object[]{0L, 0, 0L, 0L, ByteStringMicro.EMPTY, 1}, submsgtype0x129$MsgBody.class);
