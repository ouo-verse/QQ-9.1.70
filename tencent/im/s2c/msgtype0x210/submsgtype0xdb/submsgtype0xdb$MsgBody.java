...
public final class submsgtype0xdb$MsgBody extends MessageMicro<submsgtype0xdb$MsgBody> {
    public static final int STRING_RSPBODY_FIELD_NUMBER = 2;
    public static final int UINT32_RSPTYPE_FIELD_NUMBER = 1;
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"uint32_rsptype", "string_rspbody"}, new Object[]{0, ""}, submsgtype0xdb$MsgBody.class);
