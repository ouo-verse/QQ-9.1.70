...
public final class C2CType0x211_SubC2CType0x8$UserExtraInfo extends MessageMicro<C2CType0x211_SubC2CType0x8$UserExtraInfo> {
    public static final int ABILITY_FIELD_NUMBER = 1;
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10}, new String[]{"ability"}, new Object[]{null}, C2CType0x211_SubC2CType0x8$UserExtraInfo.class);
    public C2CType0x211_SubC2CType0x8$UserAbility ability = new MessageMicro<C2CType0x211_SubC2CType0x8$UserAbility>() { // from class: tencent.im.s2c.msgtype0x211.submsgtype0x8.C2CType0x211_SubC2CType0x8$UserAbility
