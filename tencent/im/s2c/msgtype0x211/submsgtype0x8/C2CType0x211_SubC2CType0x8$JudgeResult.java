...
public final class C2CType0x211_SubC2CType0x8$JudgeResult extends MessageMicro<C2CType0x211_SubC2CType0x8$JudgeResult> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 40, 48, 56, 64}, new String[]{"type", "str_ssid", "str_tips", "int32_idle_timeout", "uint32_idle_waiting", "uint32_force_wifi", "uint32_flags_wifipsw", "uint32_flags_netcheck"}, new Object[]{0, "", "", 0, 0, 0, 0, 0}, C2CType0x211_SubC2CType0x8$JudgeResult.class);
