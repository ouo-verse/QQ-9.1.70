...
public final class C2CType0x211_SubC2CType0xb$MsgBody extends MessageMicro<C2CType0x211_SubC2CType0xb$MsgBody> {
    public static final int MSG_MSG_HEADER_FIELD_NUMBER = 1;
    public static final int MSG_REJECT_MOTIFY_FIELD_NUMBER = 2;
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"msg_msg_header", "msg_reject_motify"}, new Object[]{null, null}, C2CType0x211_SubC2CType0xb$MsgBody.class);
    ...
    public static final class MsgHeader extends MessageMicro<MsgHeader> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 34, 40}, new String[]{"uint32_body_type", "uint32_session_type", "uint64_to_uin", "str_to_mobile", "uint64_room_id"}, new Object[]{101, 0, 0L, "", 0L}, MsgHeader.class);
    ...
    /* compiled from: P */
    /* loaded from: classes29.dex */
    public static final class RejectNotify extends MessageMicro<RejectNotify> {
        ...
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26}, new String[]{"enum_reject_reason", "str_msg", "str_ring_filename"}, new Object[]{201, "", ""}, RejectNotify.class);
