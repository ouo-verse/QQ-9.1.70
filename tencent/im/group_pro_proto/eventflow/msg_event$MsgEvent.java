...
public final class msg_event$MsgEvent extends MessageMicro<msg_event$MsgEvent> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26}, new String[]{"msg_seq", "event_version", LinkReportConstant$GlobalKey.EVENTS}, new Object[]{0L, 0L, null}, msg_event$MsgEvent.class);
