...
public final class common$DirectMessageMember extends MessageMicro<common$DirectMessageMember> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 34, 42, 50, 56, 64}, strArr, new Object[]{0L, 0L, 0L, byteStringMicro, byteStringMicro, byteStringMicro, 0, 0}, common$DirectMessageMember.class);
    }

    public common$DirectMessageMember() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
