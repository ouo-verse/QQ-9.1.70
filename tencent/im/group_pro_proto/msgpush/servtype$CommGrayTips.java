...
public final class servtype$CommGrayTips extends MessageMicro<servtype$CommGrayTips> {
    ...
    public static final class TemplParam extends MessageMicro<TemplParam> {
        ...
        static {
            ...
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"bytes_name", "bytes_value"}, new Object[]{byteStringMicro, byteStringMicro}, TemplParam.class);
        }
    ...
    static {
        String[] strArr = {MessageForUniteGrayTip.KEY_UINT64_BUSI_TYPE, MessageForUniteGrayTip.KEY_UINT64_BUSI_ID, "uint32_ctrl_flag", MessageForUniteGrayTip.KEY_UINT64_TEMPL_ID, "rpt_msg_templ_param", MessageForUniteGrayTip.KEY_BYTES_CONTENT, MessageForUniteGrayTip.KEY_UINT64_TIPS_SEQ_ID, "bytes_pb_reserv"};
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 50, 80, 802}, strArr, new Object[]{0L, 0L, 0, 0L, null, byteStringMicro, 0L, byteStringMicro}, servtype$CommGrayTips.class);
    }

    public servtype$CommGrayTips() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
