...
public final class cmd0x7c7$RspBody extends MessageMicro<cmd0x7c7$RspBody> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24}, new String[]{"uint64_uin", "uint32_not_see_qzone", "uint32_prevent_dynamic"}, new Object[]{0L, 0, 0}, cmd0x7c7$RspBody.class);
