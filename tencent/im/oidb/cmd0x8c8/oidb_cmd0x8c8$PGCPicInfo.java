...
public final class oidb_cmd0x8c8$PGCPicInfo extends MessageMicro<oidb_cmd0x8c8$PGCPicInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 42, 48}, new String[]{"uint32_pic_width", "uint32_pic_height", "bytes_pic_md5", "bytes_pic_url", "bytes_thumbnail_url", "is_animation"}, new Object[]{0, 0, byteStringMicro, byteStringMicro, byteStringMicro, 0}, oidb_cmd0x8c8$PGCPicInfo.class);
    }

    public oidb_cmd0x8c8$PGCPicInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
