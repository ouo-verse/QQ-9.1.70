...
public final class Oidb_0x6df$RspBody extends MessageMicro<Oidb_0x6df$RspBody> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 40, 48, 56, 66, 74, 82}, new String[]{"uint32_result", "uint32_src", "str_country_code", "str_binding_phone", "uint32_binding_time", "uint32_need_unify", "uint32_phone_type", "phone_info", "bytes_skip_url", "bytes_vas_result"}, new Object[]{0, 0, "", "", 0, 0, 0, null, byteStringMicro, byteStringMicro}, Oidb_0x6df$RspBody.class);
    }

    public Oidb_0x6df$RspBody() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
