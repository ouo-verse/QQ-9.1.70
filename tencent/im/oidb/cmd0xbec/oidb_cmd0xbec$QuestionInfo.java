...
public final class oidb_cmd0xbec$QuestionInfo extends MessageMicro<oidb_cmd0xbec$QuestionInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 42}, new String[]{"bytes_rowkey", "bytes_title", "uint32_fans_num", "uint32_answer_num", "bytes_url"}, new Object[]{byteStringMicro, byteStringMicro, 0, 0, byteStringMicro}, oidb_cmd0xbec$QuestionInfo.class);
    }

    public oidb_cmd0xbec$QuestionInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
