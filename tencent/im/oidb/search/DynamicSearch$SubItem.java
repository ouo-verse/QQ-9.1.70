...
public final class DynamicSearch$SubItem extends MessageMicro<DynamicSearch$SubItem> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 42, 50, 56, 66}, new String[]{"layout_id", "title", "summary", "media_total_count", "media_list", "jump_url", "show_arrow", "backgroud_color"}, new Object[]{0, null, null, 0, null, byteStringMicro, 0, byteStringMicro}, DynamicSearch$SubItem.class);
    }

    public DynamicSearch$SubItem() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
