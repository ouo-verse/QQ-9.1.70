...
public final class cmd0x7cf$ReqBody extends MessageMicro<cmd0x7cf$ReqBody> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 48, 800}, new String[]{"uint32_stamp", "uint32_start", "uint32_want", "uint32_req_valid_only", "rpt_msg_appoint_ids", "uint32_appoint_operation", "uint64_request_uin"}, new Object[]{0, 0, 0, 0, null, 0, 0L}, cmd0x7cf$ReqBody.class);
