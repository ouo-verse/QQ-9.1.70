...
public final class oidb_0x88d$GroupInfo extends MessageMicro<oidb_0x88d$GroupInfo> {
    ...
    public oidb_0x88d$GroupGeoInfo group_geo_info;
    public oidb_0x88d$GroupHeadPortrait msg_head_portrait;
    ...
    public oidb_0x88d$GroupInfo() {
        ...
        this.group_geo_info = new MessageMicro<oidb_0x88d$GroupGeoInfo>() { // from class: tencent.im.oidb.cmd0x88d.oidb_0x88d$GroupGeoInfo
            static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 50, 56}, new String[]{"uint64_owneruin", "uint32_settime", "uint32_cityid", "int64_longitude", "int64_latitude", "bytes_geocontent", "uint64_poi_id"}, new Object[]{0L, 0, 0, 0L, 0L, ByteStringMicro.EMPTY, 0L}, oidb_0x88d$GroupGeoInfo.class);
        ...
        this.msg_head_portrait = new oidb_0x88d$GroupHeadPortrait();
        ...
        this.st_group_ex_info = new MessageMicro<oidb_0x88d$GroupExInfoOnly>() { // from class: tencent.im.oidb.cmd0x88d.oidb_0x88d$GroupExInfoOnly
            static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16}, new String[]{"uint32_tribe_id", "uint32_money_for_add_group"}, new Object[]{0, 0}, oidb_0x88d$GroupExInfoOnly.class);
        ...
        this.st_group_card_prefix = new MessageMicro<oidb_0x88d$GroupCardPrefix>() { // from class: tencent.im.oidb.cmd0x88d.oidb_0x88d$GroupCardPrefix
            static final MessageMicro.FieldMap __fieldMap__;
            ...
            static {
                ...
                __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"bytes_introduction", "rpt_bytes_prefix"}, new Object[]{byteStringMicro2, byteStringMicro2}, oidb_0x88d$GroupCardPrefix.class);
            }
        };
