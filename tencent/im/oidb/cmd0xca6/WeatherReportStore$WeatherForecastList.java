...
public final class WeatherReportStore$WeatherForecastList extends MessageMicro<WeatherReportStore$WeatherForecastList> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 24}, new String[]{"weatherForecast", "updatetime"}, new Object[]{null, 0L}, WeatherReportStore$WeatherForecastList.class);
