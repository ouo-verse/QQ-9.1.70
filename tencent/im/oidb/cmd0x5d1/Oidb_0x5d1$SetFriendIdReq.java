...
public final class Oidb_0x5d1$SetFriendIdReq extends MessageMicro<Oidb_0x5d1$SetFriendIdReq> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24}, new String[]{"uint32_if_check_seq", "uint64_seq", "rpt_uint64_friends"}, new Object[]{0, 0L, 0L}, Oidb_0x5d1$SetFriendIdReq.class);
