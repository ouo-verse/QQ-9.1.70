...
public final class Oidb_0x5cf$ReqBody extends MessageMicro<Oidb_0x5cf$ReqBody> {
    ...
    public Oidb_0x5cf$ClrMsgInfo msg_clr_msg_info = new MessageMicro<Oidb_0x5cf$ClrMsgInfo>() { // from class: tencent.im.oidb.cmd0x5cf.Oidb_0x5cf$ClrMsgInfo
        public static final int UINT32_PLATFORM_FIELD_NUMBER = 1;
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8}, new String[]{"uint32_platform"}, new Object[]{0}, Oidb_0x5cf$ClrMsgInfo.class);
