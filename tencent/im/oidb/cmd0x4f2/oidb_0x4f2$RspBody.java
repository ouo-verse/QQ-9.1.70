...
public final class oidb_0x4f2$RspBody extends MessageMicro<oidb_0x4f2$RspBody> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 32}, new String[]{"opt_uint32_result", "opt_bytes_errinfo", "rpt_uint64_appid_list", "opt_uint64_update_seq"}, new Object[]{0, ByteStringMicro.EMPTY, 0L, 0L}, oidb_0x4f2$RspBody.class);
