...
public final class oidb_cmd0xf51$C2CMsgInfo extends MessageMicro<oidb_cmd0xf51$C2CMsgInfo> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40}, new String[]{"uint64_aio_uin", "uint64_msg_type", "uint64_msg_seq", "uint64_msg_time", "uint64_msg_uid"}, new Object[]{0L, 0L, 0L, 0L, 0L}, oidb_cmd0xf51$C2CMsgInfo.class);
