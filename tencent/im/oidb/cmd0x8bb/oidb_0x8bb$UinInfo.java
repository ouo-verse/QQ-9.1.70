...
public final class oidb_0x8bb$UinInfo extends MessageMicro<oidb_0x8bb$UinInfo> {
    public static final int UINT32_FROM_FIELD_NUMBER = 3;
    public static final int UINT32_UPDATE_TIME_FIELD_NUMBER = 2;
    public static final int UINT64_UIN_FIELD_NUMBER = 1;
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24}, new String[]{"uint64_uin", "uint32_update_time", "uint32_from"}, new Object[]{0L, 0, 0}, oidb_0x8bb$UinInfo.class);
