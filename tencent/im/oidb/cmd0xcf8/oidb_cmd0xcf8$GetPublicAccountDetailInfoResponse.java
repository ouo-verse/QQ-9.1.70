...
public final class oidb_cmd0xcf8$GetPublicAccountDetailInfoResponse extends MessageMicro<oidb_cmd0xcf8$GetPublicAccountDetailInfoResponse> {
    ...
    static {
        String[] strArr = {"ret_info", "seqno", "name", "display_number", "summary", "is_recv_msg", "is_recv_push", "certified_grade", "config_group_info", "is_show_share_button", "is_show_follow_button", "follow_type", "is_sync_lbs", "group_id", "show_flag", "account_flag", "luin", "config_background_color", "config_background_img", "config_group_info_new", IPublicAccountConfigAttr.CERT_DESP, "unified_account_descrpition", "account_flag2", "account_uid"};
        Boolean bool = Boolean.FALSE;
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 34, 42, 50, 56, 64, 72, 82, 88, 96, 104, 112, 120, 128, 136, 144, 154, 162, 170, 178, 186, 192, 210}, strArr, new Object[]{null, 0, "", "", "", bool, bool, 0, null, bool, bool, 0, bool, 0, 0, 0, 0L, "", "", null, "", "", 0L, ""}, oidb_cmd0xcf8$GetPublicAccountDetailInfoResponse.class);
    }
}
