...
public final class Oidb_0x6de$ReqBody extends MessageMicro<Oidb_0x6de$ReqBody> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 42}, new String[]{"uint32_src", "uint32_phone_type", "str_country_code", "str_phone", "dev_info"}, new Object[]{0, 0, "", "", null}, Oidb_0x6de$ReqBody.class);
    ...
    public Oidb_0x6de$DevInfo dev_info = new MessageMicro<Oidb_0x6de$DevInfo>() { // from class: tencent.im.oidb.cmd0x6de.Oidb_0x6de$DevInfo
        ...
        static {
            ...
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42, 48}, new String[]{"uint32_appid", "bytes_imei", "bytes_guid", "bytes_vendorid", "bytes_androidid", "uint32_wifi"}, new Object[]{0, byteStringMicro, byteStringMicro, byteStringMicro, byteStringMicro, 0}, Oidb_0x6de$DevInfo.class);
        }
