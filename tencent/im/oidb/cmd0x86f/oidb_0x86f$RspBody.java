...
public final class oidb_0x86f$RspBody extends MessageMicro<oidb_0x86f$RspBody> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24}, new String[]{"uint64_seq", "rpt_msg_interact_list", "uint32_isend"}, new Object[]{0L, null, 0}, oidb_0x86f$RspBody.class);
