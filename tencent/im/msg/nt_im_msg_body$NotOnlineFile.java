...
public final class nt_im_msg_body$NotOnlineFile extends MessageMicro<nt_im_msg_body$NotOnlineFile> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42, 48, 58, 64, 72, 80, 90, 96, 400, 408, 416, 424, 432, 440, 450, 458}, new String[]{"uint32_file_type", "bytes_sig", "bytes_file_uuid", "bytes_file_md5", "bytes_file_name", "uint64_file_size", "bytes_note", "uint32_reserved", "uint32_subcmd", "uint32_micro_cloud", "rpt_bytes_file_urls", "uint32_download_flag", "uint32_danger_evel", "uint32_life_time", "uint32_upload_time", "uint32_abs_file_type", "uint32_client_type", "uint32_expire_time", "bytes_pb_reserve", "str_fileidcrc_media"}, new Object[]{0, byteStringMicro, byteStringMicro, byteStringMicro, byteStringMicro, 0L, byteStringMicro, 0, 0, 0, byteStringMicro, 0, 0, 0, 0, 0, 0, 0, byteStringMicro, ""}, nt_im_msg_body$NotOnlineFile.class);
    }

    public nt_im_msg_body$NotOnlineFile() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
