...
public final class im_msg_body$NotOnlineImage extends MessageMicro<im_msg_body$NotOnlineImage> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 34, 40, 50, 58, 64, 72, 82, 90, 98, 104, 114, 122, 128, 136, 144, 154, 160, 168, 176, 184, 192, 200, 210, 216, 224, 234}, strArr, new Object[]{byteStringMicro, 0, byteStringMicro, byteStringMicro, 0, byteStringMicro, byteStringMicro, 0, 0, byteStringMicro, byteStringMicro, "", 0, "", "", 0, 0, 0, byteStringMicro, Boolean.FALSE, 0, 0, 0, 0, 0, "", 0, 0, byteStringMicro}, im_msg_body$NotOnlineImage.class);
    }

    public im_msg_body$NotOnlineImage() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
