...
public final class nt_im_msg_body$ElemFlags2 extends MessageMicro<nt_im_msg_body$ElemFlags2> {
    ...
    public nt_im_msg_body$PcSupportDef pc_support_def = new MessageMicro<nt_im_msg_body$PcSupportDef>() { // from class: tencent.im.msg.nt_im_msg_body$PcSupportDef
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48}, new String[]{"uint32_pc_ptl_begin", "uint32_pc_ptl_end", "uint32_mac_ptl_begin", "uint32_mac_ptl_end", "rpt_ptls_support", "rpt_ptls_not_support"}, new Object[]{0, 0, 0, 0, 0, 0}, nt_im_msg_body$PcSupportDef.class);
