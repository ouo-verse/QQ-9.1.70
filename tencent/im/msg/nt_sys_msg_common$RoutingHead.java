...
public final class nt_sys_msg_common$RoutingHead extends MessageMicro<nt_sys_msg_common$RoutingHead> {
    static final MessageMicro.FieldMap __fieldMap__;
    public nt_sys_msg_common$C2c c2c;
    ...
    public nt_sys_msg_common$Group group;
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 32, 40, 50, 58, 66}, strArr, new Object[]{0L, byteStringMicro, 0, 0, 0L, byteStringMicro, null, null}, nt_sys_msg_common$RoutingHead.class);
    }

    /* JADX WARN: Type inference failed for: r0v3, types: [tencent.im.msg.nt_sys_msg_common$C2c] */
    /* JADX WARN: Type inference failed for: r0v4, types: [tencent.im.msg.nt_sys_msg_common$Group] */
    public nt_sys_msg_common$RoutingHead() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        ...
        this.c2c = new MessageMicro<nt_sys_msg_common$C2c>() { // from class: tencent.im.msg.nt_sys_msg_common$C2c
            static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[0], new String[0], new Object[0], nt_sys_msg_common$C2c.class);
        };
        this.group = new MessageMicro<nt_sys_msg_common$Group>() { // from class: tencent.im.msg.nt_sys_msg_common$Group
            static final MessageMicro.FieldMap __fieldMap__;
            ...
            static {
                ...
                __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 34, 40, 48, 58, 66, 72}, new String[]{"group_code", "group_type", "group_info_seq", "group_card", "group_card_type", "group_level", "group_name", "ext_group_key_info", "msg_flag"}, new Object[]{0L, 0, 0L, byteStringMicro2, 0, 0, byteStringMicro2, byteStringMicro2, 0}, nt_sys_msg_common$Group.class);
            }
