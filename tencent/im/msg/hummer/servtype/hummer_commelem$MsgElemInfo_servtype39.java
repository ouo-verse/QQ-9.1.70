...
public final class hummer_commelem$MsgElemInfo_servtype39 extends MessageMicro<hummer_commelem$MsgElemInfo_servtype39> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 32, 40, 50, 58, 64, 72}, new String[]{"uint32_action_id", "bytes_action_name", "uint32_player_number", "uint32_action_type", "uint64_peer_uin", "bytes_pic_url", "bytes_reserve_info", "uint32_meme_width", "uint32_meme_height"}, new Object[]{0, byteStringMicro, 0, 0, 0L, byteStringMicro, byteStringMicro, 0, 0}, hummer_commelem$MsgElemInfo_servtype39.class);
    }

    public hummer_commelem$MsgElemInfo_servtype39() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
