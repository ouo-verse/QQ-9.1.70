...
public final class nt_msg_common$RoutingHead extends MessageMicro<nt_msg_common$RoutingHead> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48, 56}, new String[]{"guild_id", "channel_id", ShortVideoConstants.FROM_UIN, "from_tinyid", "guild_code", "from_appid", "direct_message_flag"}, new Object[]{0L, 0L, 0L, 0L, 0L, 0L, 0}, nt_msg_common$RoutingHead.class);
