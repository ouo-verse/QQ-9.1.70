...
public final class nt_msg_common$ContentHead extends MessageMicro<nt_msg_common$ContentHead> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48, 58}, new String[]{QQHealthReportApiImpl.MSG_TYPE_KEY, "sub_type", QzoneSetBackgroundMusicPlayModeRequest.PLAY_MODE_RANDOM, "msg_seq", "cnt_seq", ProtocolDownloaderConstants.HEADER_C2C_MSG_TIME, "msg_meta"}, new Object[]{0L, 0L, 0L, 0L, 0L, 0L, ByteStringMicro.EMPTY}, nt_msg_common$ContentHead.class);
