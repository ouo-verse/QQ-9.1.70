...
public final class hd_video_voip2$VoipHead extends MessageMicro<hd_video_voip2$VoipHead> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 48, 56, 64, 176}, new String[]{"uint64_uin", "uint64_seq", "uint32_cmd", "uint32_error_no", "bytes_build_ver", "uint32_term_type", "uint32_app_type", "uint32_biz_id", "int32_sub_service_type"}, new Object[]{0L, 0L, 0, 0, ByteStringMicro.EMPTY, 0, 0, 0, 0}, hd_video_voip2$VoipHead.class);
