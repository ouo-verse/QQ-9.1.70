...
public final class hd_video$InviteTempSessionData extends MessageMicro<hd_video$InviteTempSessionData> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 32, 42}, new String[]{"uint64_uin", "uint64_group_uin", "bytes_relationship", "uint32_relationship_type", "bytes_relationship_ext"}, new Object[]{0L, 0L, byteStringMicro, 0, byteStringMicro}, hd_video$InviteTempSessionData.class);
    }

    public hd_video$InviteTempSessionData() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
