...
public final class cmd0x346$ApplyUploadReqV3 extends MessageMicro<cmd0x346$ApplyUploadReqV3> {
    ...
    public final PBEnumField uint32_contenttype;
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{80, 160, 240, 322, 402, 482, PlayerResources.ViewId.GET_MORE_JUMP_AREA, 640, 720, 800, 882, 962}, new String[]{"uint64_sender_uin", "uint64_recver_uin", "uint64_file_size", "str_file_name", "bytes_10m_md5", "bytes_sha", "str_local_filepath", "uint32_danger_level", "uint64_total_space", "uint32_contenttype", "bytes_md5", "bytes_3sha"}, new Object[]{0L, 0L, 0L, "", byteStringMicro, byteStringMicro, "", 0, 0L, 0, byteStringMicro, byteStringMicro}, cmd0x346$ApplyUploadReqV3.class);
    }

    public cmd0x346$ApplyUploadReqV3() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        ...
        this.uint32_contenttype = PBField.initEnum(0);
