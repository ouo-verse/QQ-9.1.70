...
public final class cmd0x346$ApplyUploadHitReqV2 extends MessageMicro<cmd0x346$ApplyUploadHitReqV2> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{80, 160, 240, 322, 402, 482, PlayerResources.ViewId.GET_MORE_JUMP_AREA, 642, 720, 800}, new String[]{"uint64_sender_uin", "uint64_recver_uin", "uint64_file_size", "str_file_name", "bytes_10m_md5", "bytes_3sha", "bytes_sha", "str_local_filepath", "uint32_danger_level", "uint64_total_space"}, new Object[]{0L, 0L, 0L, "", byteStringMicro, byteStringMicro, byteStringMicro, "", 0, 0L}, cmd0x346$ApplyUploadHitReqV2.class);
    }

    public cmd0x346$ApplyUploadHitReqV2() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
