...
public final class Stt$TransGroupPttReq extends MessageMicro<Stt$TransGroupPttReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 42, 48, 56, 64, 74, 80, 88, 96}, new String[]{"uint64_sessionid", "uint64_sender_uin", "uint64_group_uin", "uint32_fileid", "str_filemd5", "uint32_ptt_time", "uint32_filesize", "uint32_ptt_format", "str_file_path", "uint32_event_type", "uint32_msg_type", "is_caption"}, new Object[]{0L, 0L, 0L, 0, "", 0, 0, 0, "", 1, 0, Boolean.FALSE}, Stt$TransGroupPttReq.class);
