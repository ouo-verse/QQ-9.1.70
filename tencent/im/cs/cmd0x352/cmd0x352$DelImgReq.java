...
public final class cmd0x352$DelImgReq extends MessageMicro<cmd0x352$DelImgReq> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 50, 58, 64, 72}, new String[]{"uint64_src_uin", "uint64_dst_uin", "uint32_req_term", "uint32_req_platform_type", "uint32_bu_type", "bytes_build_ver", "bytes_file_resid", "uint32_pic_width", "uint32_pic_height"}, new Object[]{0L, 0L, 0, 0, 0, byteStringMicro, byteStringMicro, 0, 0}, cmd0x352$DelImgReq.class);
    }

    public cmd0x352$DelImgReq() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
