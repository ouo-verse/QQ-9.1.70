...
public final class mutualmark$SpecialWordInfo extends MessageMicro<mutualmark$SpecialWordInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 40, 48, 56, 64, 74}, new String[]{"bytes_card_id", "bytes_static_url", "bytes_wording_1", "bytes_wording_2", "uint32_close_flag", "uint32_recentchat_msg_count", "uint32_all_word_light_up_days", "uint32_mark_days", "bytes_jump_url"}, new Object[]{byteStringMicro, byteStringMicro, byteStringMicro, byteStringMicro, 0, 0, 0, 0, byteStringMicro}, mutualmark$SpecialWordInfo.class);
    }

    public mutualmark$SpecialWordInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
