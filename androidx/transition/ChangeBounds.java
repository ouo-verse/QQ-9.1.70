...
public class ChangeBounds extends Transition {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (viewGroup2 != null && viewGroup3 != null) {
                ...
                if (parentMatches(viewGroup2, viewGroup3)) {
                    ...
                    int i17 = rect3.left;
                    final int i18 = rect4.left;
                    int i19 = rect3.top;
                    final int i26 = rect4.top;
                    int i27 = rect3.right;
                    final int i28 = rect4.right;
                    int i29 = rect3.bottom;
                    final int i36 = rect4.bottom;
                    int i37 = i27 - i17;
                    int i38 = i29 - i19;
                    int i39 = i28 - i18;
                    int i46 = i36 - i26;
                    ...
                    if (i3 > 0) {
                        if (!this.mResizeClip) {
                            view = view2;
                            ViewUtils.setLeftTopRightBottom(view, i17, i19, i27, i29);
                            if (i3 == 2) {
                                if (i37 == i39 && i38 == i46) {
                                    mergeAnimators = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i17, i19, i18, i26));
                                } else {
                                    ViewBounds viewBounds = new ViewBounds(view);
                                    ObjectAnimator ofPointF2 = ObjectAnimatorUtils.ofPointF(viewBounds, TOP_LEFT_PROPERTY, getPathMotion().getPath(i17, i19, i18, i26));
                                    ObjectAnimator ofPointF3 = ObjectAnimatorUtils.ofPointF(viewBounds, BOTTOM_RIGHT_PROPERTY, getPathMotion().getPath(i27, i29, i28, i36));
                            ...
                            } else if (i17 == i18 && i19 == i26) {
                                mergeAnimators = ObjectAnimatorUtils.ofPointF(view, BOTTOM_RIGHT_ONLY_PROPERTY, getPathMotion().getPath(i27, i29, i28, i36));
                            } else {
                                mergeAnimators = ObjectAnimatorUtils.ofPointF(view, TOP_LEFT_ONLY_PROPERTY, getPathMotion().getPath(i17, i19, i18, i26));
                            }
                        } else {
                            view = view2;
                            ViewUtils.setLeftTopRightBottom(view, i17, i19, Math.max(i37, i39) + i17, Math.max(i38, i46) + i19);
                            if (i17 == i18 && i19 == i26) {
                                ofPointF = null;
                            } else {
                                ofPointF = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath(i17, i19, i18, i26));
                            }
                            if (rect5 == null) {
                                i16 = 0;
                            ...
                            if (rect6 == null) {
                                rect2 = new Rect(i16, i16, i39, i46);
                            } else {
                                rect2 = rect6;
                            }
                                ...
                                ofObject.addListener(new AnimatorListenerAdapter() { // from class: androidx.transition.ChangeBounds.8
                                    ...
                                    public void onAnimationEnd(Animator animator) {
                                        if (!this.mIsCanceled) {
                                            ...
                                            ViewUtils.setLeftTopRightBottom(view, i18, i26, i28, i36);
                                        }
                                    }
                                });
                ...
                int i47 = iArr[0];
                int i48 = iArr[1];
                ObjectAnimator ofPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(bitmapDrawable, PropertyValuesHolderUtils.ofPointF(DRAWABLE_ORIGIN_PROPERTY, pathMotion.getPath(intValue - i47, intValue2 - i48, intValue3 - i47, intValue4 - i48)));
    ...
    public void setResizeClip(boolean z16) {
        this.mResizeClip = z16;
    }
