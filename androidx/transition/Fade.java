...
public class Fade extends Visibility {
    ...
    private Animator createAnimation(final View view, float f16, float f17) {
        if (f16 == f17) {
            return null;
        }
        ViewUtils.setTransitionAlpha(view, f16);
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(view, ViewUtils.TRANSITION_ALPHA, f17);
    ...
    private static float getStartAlpha(TransitionValues transitionValues, float f16) {
        Float f17;
        if (transitionValues != null && (f17 = (Float) transitionValues.values.get(PROPNAME_TRANSITION_ALPHA)) != null) {
    ...
    public Animator onAppear(ViewGroup viewGroup, View view, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        return createAnimation(view, f16, 1.0f);
    }
