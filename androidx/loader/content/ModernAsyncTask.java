    ...
    static {
        ThreadFactory threadFactory = new ThreadFactory() { // from class: androidx.loader.content.ModernAsyncTask.1
            ...
            public Thread newThread(Runnable runnable) {
                return new BaseThread(runnable, "ModernAsyncTask #" + this.mCount.getAndIncrement());
            }
        };
        sThreadFactory = threadFactory;
        LinkedBlockingQueue linkedBlockingQueue = new LinkedBlockingQueue(10);
        sPoolWorkQueue = linkedBlockingQueue;
        BaseThreadPoolExecutor baseThreadPoolExecutor = new BaseThreadPoolExecutor(5, 128, 1L, TimeUnit.SECONDS, linkedBlockingQueue, threadFactory);
        THREAD_POOL_EXECUTOR = baseThreadPoolExecutor;
        sDefaultExecutor = baseThreadPoolExecutor;
    }
        ...
        this.mFuture = new FutureTask<Result>(workerRunnable) { // from class: androidx.loader.content.ModernAsyncTask.3
            ...
            protected void done() {
                try {
                    ...
                    Log.w(ModernAsyncTask.LOG_TAG, e16);
