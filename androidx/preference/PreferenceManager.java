...
public class PreferenceManager {
    ...
    public static void setDefaultValues(Context context, int i3, boolean z16) {
        setDefaultValues(context, getDefaultSharedPreferencesName(context), getDefaultSharedPreferencesMode(), i3, z16);
    }

    private void setNoCommit(boolean z16) {
        SharedPreferences.Editor editor;
        if (!z16 && (editor = this.mEditor) != null) {
            editor.apply();
        }
        this.mNoCommit = z16;
    }
    ...
    public void setSharedPreferencesMode(int i3) {
        this.mSharedPreferencesMode = i3;
    ...
    public static void setDefaultValues(Context context, String str, int i3, int i16, boolean z16) {
        SharedPreferences sharedPreferences = context.getSharedPreferences(KEY_HAS_SET_DEFAULT_VALUES, 0);
        if (z16 || !sharedPreferences.getBoolean(KEY_HAS_SET_DEFAULT_VALUES, false)) {
            PreferenceManager preferenceManager = new PreferenceManager(context);
            preferenceManager.setSharedPreferencesName(str);
            preferenceManager.setSharedPreferencesMode(i3);
            preferenceManager.inflateFromResource(context, i16, null);
