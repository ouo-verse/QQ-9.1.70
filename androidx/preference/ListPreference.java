...
public class ListPreference extends DialogPreference {
    ...
    public ListPreference(Context context, AttributeSet attributeSet, int i3, int i16) {
        super(context, attributeSet, i3, i16);
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ListPreference, i3, i16);
        ...
        TypedArray obtainStyledAttributes2 = context.obtainStyledAttributes(attributeSet, R.styleable.Preference, i3, i16);
    ...
    public void setValue(String str) {
        boolean z16 = !TextUtils.equals(this.mValue, str);
        if (z16 || !this.mValueSet) {
            this.mValue = str;
            this.mValueSet = true;
            persistString(str);
            if (z16) {
