...
public interface SupportSQLiteDatabase extends Closeable {
    ...
    long insert(String str, int i3, ContentValues contentValues) throws SQLException;
    ...
    @RequiresApi(api = 16)
    void setForeignKeyConstraintsEnabled(boolean z16);
    ...
    int update(String str, int i3, ContentValues contentValues, String str2, Object[] objArr);
