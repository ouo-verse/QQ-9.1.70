...
class FrameworkSQLiteOpenHelper implements SupportSQLiteOpenHelper {
    ...
    public static class OpenHelper extends SQLiteOpenHelper {
        ...
        public void onDowngrade(SQLiteDatabase sQLiteDatabase, int i3, int i16) {
            this.mMigrated = true;
            this.mCallback.onDowngrade(getWrappedDb(sQLiteDatabase), i3, i16);
        }
        ...
        public void onUpgrade(SQLiteDatabase sQLiteDatabase, int i3, int i16) {
            this.mMigrated = true;
            this.mCallback.onUpgrade(getWrappedDb(sQLiteDatabase), i3, i16);
        }
    ...
    public void setWriteAheadLoggingEnabled(boolean z16) {
        synchronized (this.mLock) {
            ...
            if (openHelper != null) {
                SupportSQLiteCompat.Api16Impl.setWriteAheadLoggingEnabled(openHelper, z16);
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public FrameworkSQLiteOpenHelper(Context context, String str, SupportSQLiteOpenHelper.Callback callback, boolean z16) {
