...
class VersionedParcelStream extends VersionedParcel {
    ...
    public static class FieldBuffer {
        ...
        void flushField() throws IOException {
            ...
            int i16 = this.mFieldId << 16;
            if (size >= 65535) {
                i3 = 65535;
            } else {
                i3 = size;
            }
            this.mTarget.writeInt(i16 | i3);
            if (size >= 65535) {
    ...
    public void closeField() {
        ...
        if (fieldBuffer != null) {
            try {
                ...
                throw new VersionedParcel.ParcelException(e16);
            }
        }
    }
    ...
    public boolean readField(int i3) {
        while (true) {
            try {
                ...
                this.mCount = 0;
                int i17 = readInt & 65535;
                if (i17 == 65535) {
                    i17 = this.mMasterInput.readInt();
                }
    ...
    public void writeBoolean(boolean z16) {
        try {
            this.mCurrentOutput.writeBoolean(z16);
        } catch (IOException e16) {
            throw new VersionedParcel.ParcelException(e16);
        }
    }
    ...
    public void writeDouble(double d16) {
        try {
            this.mCurrentOutput.writeDouble(d16);
        } catch (IOException e16) {
            throw new VersionedParcel.ParcelException(e16);
        }
    }
    ...
    public void writeFloat(float f16) {
        try {
            this.mCurrentOutput.writeFloat(f16);
        } catch (IOException e16) {
            throw new VersionedParcel.ParcelException(e16);
        }
    }
    ...
    public void writeLong(long j3) {
        try {
            this.mCurrentOutput.writeLong(j3);
        } catch (IOException e16) {
            throw new VersionedParcel.ParcelException(e16);
        }
    }
    ...
    VersionedParcelStream(InputStream inputStream, OutputStream outputStream, ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
        ...
        DataInputStream dataInputStream = inputStream != null ? new DataInputStream(new FilterInputStream(inputStream) { // from class: androidx.versionedparcelable.VersionedParcelStream.1
            ...
            public int read(byte[] bArr, int i3, int i16) throws IOException {
                VersionedParcelStream versionedParcelStream = VersionedParcelStream.this;
                int i17 = versionedParcelStream.mFieldSize;
                if (i17 != -1 && versionedParcelStream.mCount >= i17) {
                    throw new IOException();
                }
    ...
    public void writeByteArray(byte[] bArr, int i3, int i16) {
        try {
            if (bArr != null) {
                this.mCurrentOutput.writeInt(i16);
                this.mCurrentOutput.write(bArr, i3, i16);
            } else {
                this.mCurrentOutput.writeInt(-1);
            }
        } catch (IOException e16) {
