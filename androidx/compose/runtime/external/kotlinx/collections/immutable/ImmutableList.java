...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0003\b`\u0018\u0000*\u0006\b\u0000\u0010\u0001 \u00012\b\u0012\u0004\u0012\u0002H\u00010\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003:\u0001\bJ\u001e\u0010\u0004\u001a\b\u0012\u0004\u0012\u00028\u00000\u00002\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\u0006H\u0016\u00f8\u0001\u0000\u0082\u0002\u0006\n\u0004\b!0\u0001\u00a8\u0006\t\u00c0\u0006\u0001"}, d2 = {"Landroidx/compose/runtime/external/kotlinx/collections/immutable/ImmutableList;", "E", "", "Landroidx/compose/runtime/external/kotlinx/collections/immutable/ImmutableCollection;", "subList", "fromIndex", "", "toIndex", "SubList", "runtime_release"}, k = 1, mv = {1, 6, 0}, xi = 48)
...
public interface ImmutableList<E> extends List<E>, ImmutableCollection<E>, KMappedMarker {
    ...
    public static final class SubList<E> extends AbstractList<E> implements ImmutableList<E> {
        ...
        public SubList(ImmutableList<? extends E> source, int i3, int i16) {
            Intrinsics.checkNotNullParameter(source, "source");
            this.source = source;
            this.fromIndex = i3;
            this.toIndex = i16;
            ListImplementation.checkRangeIndexes$runtime_release(i3, i16, source.size());
            this._size = i16 - i3;
        }
        ...
        public ImmutableList<E> subList(int fromIndex, int toIndex) {
            ...
            return new SubList(immutableList, fromIndex + i3, i3 + toIndex);
        }
    }
    ...
    @Override // java.util.List
    /* bridge */ /* synthetic */ List subList(int i3, int i16);
}
