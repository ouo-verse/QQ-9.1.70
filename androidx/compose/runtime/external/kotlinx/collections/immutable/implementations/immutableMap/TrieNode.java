...
public final class TrieNode<K, V> {
    ...
    public TrieNode(int i3, int i16, Object[] buffer, MutabilityOwnership mutabilityOwnership) {
    ...
    private final TrieNode<K, V> collisionRemoveEntryAtIndex(int i3) {
        Object[] objArr = this.buffer;
        if (objArr.length == 2) {
            return null;
        }
        return new TrieNode<>(0, 0, TrieNodeKt.access$removeEntryAtIndex(objArr, i3));
    }
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> otherNode, DeltaCounter intersectionCounter, MutabilityOwnership owner) {
        CommonFunctionsKt.m32assert(this.nodeMap == 0);
        CommonFunctionsKt.m32assert(this.dataMap == 0);
        CommonFunctionsKt.m32assert(otherNode.nodeMap == 0);
        CommonFunctionsKt.m32assert(otherNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutableCollisionRemoveEntryAtIndex(int i3, PersistentHashMapBuilder<K, V> mutator) {
        mutator.setSize(mutator.size() - 1);
        mutator.setOperationResult$runtime_release(valueAtKeyIndex(i3));
        if (this.buffer.length == 2) {
            return null;
        }
        if (this.ownedBy == mutator.getOwnership()) {
            this.buffer = TrieNodeKt.access$removeEntryAtIndex(this.buffer, i3);
            return this;
        }
        return new TrieNode<>(0, 0, TrieNodeKt.access$removeEntryAtIndex(this.buffer, i3), mutator.getOwnership());
    }
    ...
    public TrieNode(int i3, int i16, Object[] buffer) {
        this(i3, i16, buffer, null);
        Intrinsics.checkNotNullParameter(buffer, "buffer");
    }
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> otherNode, int shift, DeltaCounter intersectionCounter, PersistentHashMapBuilder<K, V> mutator) {
        ...
        int i27 = 0;
        if ((i3 & i26) == 0) {
            TrieNode<K, V> trieNode = (Intrinsics.areEqual(this.ownedBy, mutator.getOwnership()) && this.dataMap == i26 && this.nodeMap == i3) ? this : new TrieNode<>(i26, i3, new Object[(Integer.bitCount(i26) * 2) + Integer.bitCount(i3)]);
            int i28 = i3;
            int i29 = 0;
            while (i28 != 0) {
                int lowestOneBit2 = Integer.lowestOneBit(i28);
                Object[] objArr = trieNode.buffer;
                objArr[(objArr.length - 1) - i29] = mutablePutAllFromOtherNodeCell(otherNode, lowestOneBit2, shift, intersectionCounter, mutator);
                i29++;
                i28 ^= lowestOneBit2;
            }
            while (i26 != 0) {
                ...
                if (!otherNode.hasEntryAt$runtime_release(lowestOneBit3)) {
                    ...
                    trieNode.buffer[i36] = keyAtIndex(entryKeyIndex$runtime_release);
                    trieNode.buffer[i36 + 1] = valueAtKeyIndex(entryKeyIndex$runtime_release);
                } else {
                    int entryKeyIndex$runtime_release2 = otherNode.entryKeyIndex$runtime_release(lowestOneBit3);
                    trieNode.buffer[i36] = otherNode.keyAtIndex(entryKeyIndex$runtime_release2);
                    trieNode.buffer[i36 + 1] = otherNode.valueAtKeyIndex(entryKeyIndex$runtime_release2);
        ...
        if (otherNode.hasNodeAt(positionMask)) {
            ...
            if (hasEntryAt$runtime_release(positionMask)) {
                ...
                if (nodeAtIndex$runtime_release2.containsKey(keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, i3)) {
                    ...
                    return nodeAtIndex$runtime_release2.mutablePut(keyAtIndex2 != null ? keyAtIndex2.hashCode() : 0, keyAtIndex2, valueAtKeyIndex(entryKeyIndex$runtime_release2), i3, mutator);
                }
            }
