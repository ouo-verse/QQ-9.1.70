...
final class MutableMapEntry<K, V> extends MapEntry<K, V> implements KMutableMap.Entry {
    ...
    public MutableMapEntry(Map<K, LinkedValue<V>> mutableMap, K k3, LinkedValue<V> links) {
        super(k3, links.getValue());
