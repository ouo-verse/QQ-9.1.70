...
public abstract class PersistentHashMapBaseIterator<K, V, T> implements Iterator<T>, KMappedMarker {
    ...
    private final void ensureNextEntryIsReady() {
        ...
        for (int i3 = this.pathLastIndex; -1 < i3; i3--) {
            ...
            if (moveToNextNodeWithData == -1 && this.path[i3].hasNextNode()) {
                this.path[i3].moveToNextNode();
            ...
            if (i3 > 0) {
                this.path[i3 - 1].moveToNextNode();
            }
            this.path[i3].reset(TrieNode.INSTANCE.getEMPTY$runtime_release().getBuffer(), 0);
        }
        this.hasNext = false;
    }
