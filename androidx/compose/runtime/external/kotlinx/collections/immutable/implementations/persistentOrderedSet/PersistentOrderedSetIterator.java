...
public class PersistentOrderedSetIterator<E> implements Iterator<E>, KMappedMarker {
    ...
    public E next() {
        checkHasNext();
        E e16 = (E) this.nextElement;
        this.index++;
        Links links = this.map.get(e16);
        if (links != null) {
            this.nextElement = links.getNext();
            return e16;
        }
        throw new ConcurrentModificationException("Hash code of an element (" + e16 + ") has changed after it was added to the persistent set.");
    }
