...
public final class PersistentOrderedMap<K, V> extends AbstractMap<K, V> implements PersistentMap<K, V> {
    ...
    @Override // java.util.Map, androidx.compose.runtime.external.kotlinx.collections.immutable.PersistentMap
    public PersistentMap<K, V> putAll(Map<? extends K, ? extends V> m3) {
    ...
    public PersistentOrderedMap<K, V> remove(K key) {
        ...
        if (linkedValue.getHasPrevious()) {
            ...
            r56 = (PersistentHashMap<K, LinkedValue<V>>) remove.put((PersistentHashMap<K, LinkedValue<V>>) linkedValue.getPrevious(), (Object) ((LinkedValue) obj).withNext(linkedValue.getNext()));
        }
        PersistentHashMap persistentHashMap = r56;
        if (linkedValue.getHasNext()) {
            Object obj2 = r56.get(linkedValue.getNext());
            Intrinsics.checkNotNull(obj2);
            persistentHashMap = r56.put(linkedValue.getNext(), ((LinkedValue) obj2).withPrevious(linkedValue.getPrevious()));
        }
