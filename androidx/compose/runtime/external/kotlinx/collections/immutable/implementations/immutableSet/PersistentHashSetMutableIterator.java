...
public final class PersistentHashSetMutableIterator<E> extends PersistentHashSetIterator<E> implements KMutableIterator {
    ...
    private final void resetPath(int hashCode, TrieNode<?> node, E element, int pathIndex) {
        int indexOf;
        if (isCollision(node)) {
            indexOf = ArraysKt___ArraysKt.indexOf((E[]) node.getBuffer(), element);
            CommonFunctionsKt.m32assert(indexOf != -1);
