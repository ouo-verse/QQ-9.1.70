...
public final class PersistentVectorMutableIterator<T> extends AbstractListIterator<T> implements KMutableListIterator {
    ...
    public PersistentVectorMutableIterator(PersistentVectorBuilder<T> builder, int i3) {
