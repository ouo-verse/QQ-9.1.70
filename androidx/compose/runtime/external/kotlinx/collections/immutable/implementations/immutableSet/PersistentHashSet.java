...
public final class PersistentHashSet<E> extends AbstractSet<E> implements PersistentSet<E> {
    ...
    public PersistentHashSet(TrieNode<E> node, int i3) {
