...
public final class ListImplementation {
    ...
    @JvmStatic
    public static final boolean orderedEquals$runtime_release(Collection<?> c16, Collection<?> other) {
    ...
    @JvmStatic
    public static final int orderedHashCode$runtime_release(Collection<?> c16) {
        Intrinsics.checkNotNullParameter(c16, "c");
