...
public final class RecomposerKt {
    ...
    public static final <K, V> boolean addMultiValue(Map<K, List<V>> map, K k3, V v3) {
    ...
    public static final <K, V> V removeLastMultiValue(Map<K, List<V>> map, K k3) {
        Object removeFirst;
        Intrinsics.checkNotNullParameter(map, "<this>");
        List<V> list = map.get(k3);
        if (list == null) {
