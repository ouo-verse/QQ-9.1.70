...
public interface ControlledComposition extends Composition {
    ...
    <R> R delegateInvalidations(ControlledComposition to5, int groupIndex, Function0<? extends R> block);
