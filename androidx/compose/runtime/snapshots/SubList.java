...
public final class SubList<T> implements List<T>, KMutableList {
    ...
    public SubList(SnapshotStateList<T> parentList, int i3, int i16) {
    ...
    public void clear() {
        if (size() > 0) {
            ...
            int i3 = this.offset;
            snapshotStateList.removeRange(i3, size() + i3);
            this.size = 0;
            this.modification = this.parentList.getModification$runtime_release();
        }
    }
    ...
    public int indexOf(Object element) {
        ...
        validateModification();
        int i3 = this.offset;
        until = RangesKt___RangesKt.until(i3, size() + i3);
    ...
    public boolean retainAll(Collection<? extends Object> elements) {
        ...
        SnapshotStateList<T> snapshotStateList = this.parentList;
        int i3 = this.offset;
        int retainAllInRange$runtime_release = snapshotStateList.retainAllInRange$runtime_release(elements, i3, size() + i3);
    ...
    public T set(int index, T element) {
        SnapshotStateListKt.validateRange(index, size());
        validateModification();
        T t16 = this.parentList.set(index + this.offset, element);
        this.modification = this.parentList.getModification$runtime_release();
        return t16;
    }
    ...
    public List<T> subList(int fromIndex, int toIndex) {
        if ((fromIndex >= 0 && fromIndex <= toIndex) && toIndex <= size()) {
            ...
            SnapshotStateList<T> snapshotStateList = this.parentList;
            int i3 = this.offset;
            return new SubList(snapshotStateList, fromIndex + i3, toIndex + i3);
        }
