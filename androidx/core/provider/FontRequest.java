...
public final class FontRequest {
    ...
    public String toString() {
        ...
        sb5.append("FontRequest {mProviderAuthority: " + this.mProviderAuthority + ", mProviderPackage: " + this.mProviderPackage + ", mQuery: " + this.mQuery + ", mCertificates:");
        ...
        sb5.append("}");
        sb5.append("mCertificatesArray: " + this.mCertificatesArray);
        return sb5.toString();
    }
