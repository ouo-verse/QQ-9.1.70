...
public class SelfDestructiveThread {
    ...
    public SelfDestructiveThread(String str, int i3, int i16) {
        this.mThreadName = str;
        this.mPriority = i3;
        this.mDestructAfterMillisec = i16;
    }

    private void post(Runnable runnable) {
        synchronized (this.mLock) {
            if (this.mThread == null) {
                BaseHandlerThread baseHandlerThread = new BaseHandlerThread(this.mThreadName, this.mPriority);
    ...
    public <T> T postAndWait(final Callable<T> callable, int i3) throws InterruptedException {
