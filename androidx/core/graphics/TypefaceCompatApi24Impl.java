...
class TypefaceCompatApi24Impl extends TypefaceCompatBaseImpl {
    ...
    static {
        ...
        try {
            ...
            Log.e(TAG, e16.getClass().getName(), e16);
            cls = null;
            method = null;
            constructor = null;
            method2 = null;
    ...
    private static boolean addFontWeightStyle(Object obj, ByteBuffer byteBuffer, int i3, int i16, boolean z16) {
        try {
            return ((Boolean) sAddFontWeightStyle.invoke(obj, byteBuffer, Integer.valueOf(i3), null, Integer.valueOf(i16), Boolean.valueOf(z16))).booleanValue();
