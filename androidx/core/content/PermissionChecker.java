...
public final class PermissionChecker {
    ...
    public static int checkPermission(@NonNull Context context, @NonNull String str, int i3, int i16, @Nullable String str2) {
        if (context.checkPermission(str, i3, i16) == -1) {
            return -1;
        }
