...
public abstract class JobIntentService extends Service {
    ...
    public final class CommandProcessor extends AsyncTask<Void, Void, Void> {
        ...
        /* JADX INFO: Access modifiers changed from: protected */
        @Override // android.os.AsyncTask
        public void onCancelled(Void r16) {
    ...
    static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z16, int i3) {
    ...
    void ensureProcessorRunningLocked(boolean z16) {
        if (this.mCurProcessor == null) {
            this.mCurProcessor = new CommandProcessor();
            WorkEnqueuer workEnqueuer = this.mCompatWorkEnqueuer;
            if (workEnqueuer != null && z16) {
    ...
    public int onStartCommand(@Nullable Intent intent, int i3, int i16) {
        if (this.mCompatQueue != null) {
            ...
            synchronized (this.mCompatQueue) {
                ...
                arrayList.add(new CompatWorkItem(intent, i16));
    ...
    public void setInterruptIfStopped(boolean z16) {
        this.mInterruptIfStopped = z16;
    }
