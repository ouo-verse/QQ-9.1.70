...
public final class ShareCompat {
    ...
    public static class IntentReader {
        ...
        private static void withinStyle(StringBuilder sb5, CharSequence charSequence, int i3, int i16) {
            while (i3 < i16) {
                ...
                if (charAt == '<') {
                    ...
                    if (charAt == ' ') {
                        while (true) {
                            int i17 = i3 + 1;
                            if (i17 >= i16 || charSequence.charAt(i17) != ' ') {
                                break;
                            }
                            sb5.append("&nbsp;");
                            i3 = i17;
        ...
        public Drawable getCallingActivityIcon() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve icon for calling activity", e16);
                return null;
            }
        }
        ...
        public Drawable getCallingApplicationIcon() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve icon for calling application", e16);
                return null;
            }
        }
        ...
        public CharSequence getCallingApplicationLabel() {
            ...
            try {
                ...
                Log.e(TAG, "Could not retrieve label for calling application", e16);
                return null;
            }
        }
