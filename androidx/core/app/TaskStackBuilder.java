...
public final class TaskStackBuilder implements Iterable<Intent> {
    ...
    TaskStackBuilder(Context context) {
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i3, int i16) {
        return getPendingIntent(i3, i16, null);
    }
    ...
    @Nullable
    public PendingIntent getPendingIntent(int i3, int i16, @Nullable Bundle bundle) {
        if (!this.mIntents.isEmpty()) {
            ArrayList<Intent> arrayList = this.mIntents;
            Intent[] intentArr = (Intent[]) arrayList.toArray(new Intent[arrayList.size()]);
            intentArr[0] = new Intent(intentArr[0]).addFlags(268484608);
            return PendingIntent.getActivities(this.mSourceContext, i3, intentArr, i16, bundle);
        }
