...
final class ActivityRecreator {
    ...
    protected static boolean queueOnStopIfNecessary(Object obj, int i3, Activity activity) {
        try {
                ...
                mainHandler.postAtFrontOfQueue(new Runnable() { // from class: androidx.core.app.ActivityRecreator.3
                    ...
                    public void run() {
                        try {
                            ...
                            if (e16.getClass() == RuntimeException.class && e16.getMessage() != null && e16.getMessage().startsWith("Unable to stop")) {
                                throw e16;
                            }
                        } catch (Throwable th5) {
                            Log.e(ActivityRecreator.LOG_TAG, "Exception while invoking performStopActivity", th5);
                        }
                    }
                });
                return true;
            ...
            Log.e(LOG_TAG, "Exception while fetching field values", th5);
            return false;
        }
    }
