...
public class DragStartHelper {
    ...
    private final View.OnLongClickListener mLongClickListener = new View.OnLongClickListener() { // from class: androidx.core.view.DragStartHelper.1
        ...
        public boolean onLongClick(View view) {
            ...
            boolean onLongClick = DragStartHelper.this.onLongClick(view);
    ...
    */
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                    if (MotionEventCompat.isFromSource(motionEvent, 8194) && (motionEvent.getButtonState() & 1) != 0 && !this.mDragging && (this.mLastTouchX != x16 || this.mLastTouchY != y16)) {
