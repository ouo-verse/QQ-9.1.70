...
public class WindowInsetsCompat {
    ...
    static class Api21ReflectionHolder {
        ...
        static {
            try {
                ...
                Log.w(WindowInsetsCompat.TAG, "Failed to get visible insets from AttachInfo " + e16.getMessage(), e16);
            }
        }
        ...
        public static WindowInsetsCompat getRootWindowInsets(@NonNull View view) {
            if (sReflectionSucceeded && view.isAttachedToWindow()) {
                try {
                    ...
                    Log.w(WindowInsetsCompat.TAG, "Failed to get insets from AttachInfo. " + e16.getMessage(), e16);
                }
            }
            return null;
        }
    ...
    public static class BuilderImpl {
        ...
        void setInsets(int i3, @NonNull Insets insets) {
            if (this.mInsetsTypeMask == null) {
                this.mInsetsTypeMask = new Insets[9];
            }
            for (int i16 = 1; i16 <= 256; i16 <<= 1) {
                if ((i3 & i16) != 0) {
                    this.mInsetsTypeMask[Type.indexOf(i16)] = insets;
                }
            }
        }

        void setInsetsIgnoringVisibility(int i3, @NonNull Insets insets) {
            if (i3 != 8) {
            } else {
        ...
        void setVisible(int i3, boolean z16) {
        }
    }
    ...
    private static class BuilderImpl30 extends BuilderImpl29 {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.BuilderImpl
        void setVisible(int i3, boolean z16) {
            this.mPlatBuilder.setVisible(TypeImpl30.toPlatformType(i3), z16);
        }
    ...
    public static class Impl20 extends Impl {
            ...
            if (Build.VERSION.SDK_INT < 30) {
                ...
                if (method != null && sAttachInfoClass != null && sVisibleInsetsField != null) {
                    try {
                        ...
                        Log.e(WindowInsetsCompat.TAG, "Failed to get visible insets. (Reflection error). " + e16.getMessage(), e16);
                    }
                }
                return null;
            }
        ...
        @NonNull
        protected Insets getInsetsForType(int i3, boolean z16) {
            int i16;
            ...
            if (i3 != 1) {
                ...
                if (i3 != 2) {
                    ...
                    int i17 = systemWindowInsets.bottom;
                    if (i17 > rootStableInsets.bottom) {
                        return Insets.of(0, 0, 0, i17);
                    }
                    Insets insets2 = this.mRootViewVisibleInsets;
                    if (insets2 != null && !insets2.equals(Insets.NONE) && (i16 = this.mRootViewVisibleInsets.bottom) > rootStableInsets.bottom) {
                        return Insets.of(0, 0, 0, i16);
                    }
                    return Insets.NONE;
                }
                if (z16) {
                ...
                int i18 = systemWindowInsets2.bottom;
                if (insets != null) {
                    i18 = Math.min(i18, insets.bottom);
                }
                return Insets.of(systemWindowInsets2.left, 0, systemWindowInsets2.right, i18);
            }
            if (z16) {
        ...
        @Override // androidx.core.view.WindowInsetsCompat.Impl
        @NonNull
        WindowInsetsCompat inset(int i3, int i16, int i17, int i18) {
            Builder builder = new Builder(WindowInsetsCompat.toWindowInsetsCompat(this.mPlatformInsets));
            builder.setSystemWindowInsets(WindowInsetsCompat.insetInsets(getSystemWindowInsets(), i3, i16, i17, i18));
            builder.setStableInsets(WindowInsetsCompat.insetInsets(getStableInsets(), i3, i16, i17, i18));
        ...
        @NonNull
        @SuppressLint({"WrongConstant"})
        private Insets getInsets(int i3, boolean z16) {
            Insets insets = Insets.NONE;
            for (int i16 = 1; i16 <= 256; i16 <<= 1) {
                if ((i3 & i16) != 0) {
                    insets = Insets.max(insets, getInsetsForType(i16, z16));
                }
            }
            return insets;
        }
    ...
    @RequiresApi(20)
    WindowInsetsCompat(@NonNull WindowInsets windowInsets) {
    ...
    public static Insets insetInsets(@NonNull Insets insets, int i3, int i16, int i17, int i18) {
        int max = Math.max(0, insets.left - i3);
        int max2 = Math.max(0, insets.top - i16);
        int max3 = Math.max(0, insets.right - i17);
        int max4 = Math.max(0, insets.bottom - i18);
        if (max == i3 && max2 == i16 && max3 == i17 && max4 == i18) {
            return insets;
        }
    ...
    public WindowInsetsCompat replaceSystemWindowInsets(int i3, int i16, int i17, int i18) {
        return new Builder(this).setSystemWindowInsets(Insets.of(i3, i16, i17, i18)).build();
    }
        ...
        private static WindowInsets createWindowInsetsInstance() {
            if (!sConsumedFieldFetched) {
                try {
                    ...
                    Log.i(WindowInsetsCompat.TAG, "Could not retrieve WindowInsets.CONSUMED field", e16);
                }
            ...
            if (field != null) {
                try {
                    ...
                    Log.i(WindowInsetsCompat.TAG, "Could not get value from WindowInsets.CONSUMED field", e17);
                }
            }
            if (!sConstructorFetched) {
                try {
                    ...
                    Log.i(WindowInsetsCompat.TAG, "Could not retrieve WindowInsets(Rect) constructor", e18);
                }
            ...
            if (constructor != null) {
                try {
                    ...
                    Log.i(WindowInsetsCompat.TAG, "Could not invoke WindowInsets(Rect) constructor", e19);
                }
            }
            return null;
        }
    ...
    @NonNull
    public WindowInsetsCompat inset(@IntRange(from = 0) int i3, @IntRange(from = 0) int i16, @IntRange(from = 0) int i17, @IntRange(from = 0) int i18) {
        return this.mImpl.inset(i3, i16, i17, i18);
    }
    ...
    private static class Impl29 extends Impl28 {
        ...
        WindowInsetsCompat inset(int i3, int i16, int i17, int i18) {
            WindowInsets inset;
            inset = this.mPlatformInsets.inset(i3, i16, i17, i18);
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setVisible(int i3, boolean z16) {
            this.mImpl.setVisible(i3, z16);
            return this;
        }
    ...
    public static class Impl {
        ...
        @NonNull
        Insets getInsets(int i3) {
            return Insets.NONE;
        }

        @NonNull
        Insets getInsetsIgnoringVisibility(int i3) {
            if ((i3 & 8) == 0) {
                return Insets.NONE;
            }
