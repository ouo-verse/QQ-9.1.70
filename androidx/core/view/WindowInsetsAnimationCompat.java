...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        static int buildAnimationMask(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2) {
            ...
            for (int i16 = 1; i16 <= 256; i16 <<= 1) {
                if (!windowInsetsCompat.getInsets(i16).equals(windowInsetsCompat2.getInsets(i16))) {
                    i3 |= i16;
                }
            }
            return i3;
        ...
        @NonNull
        static BoundsCompat computeAnimationBounds(@NonNull WindowInsetsCompat windowInsetsCompat, @NonNull WindowInsetsCompat windowInsetsCompat2, int i3) {
        ...
        static void dispatchOnPrepare(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsets windowInsets, boolean z16) {
            Callback callback = getCallback(view);
            if (callback != null) {
            ...
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i3 = 0; i3 < viewGroup.getChildCount(); i3++) {
                    dispatchOnPrepare(viewGroup.getChildAt(i3), windowInsetsAnimationCompat, windowInsets, z16);
                }
            }
        }
        ...
        static WindowInsets forwardToViewIfNeeded(@NonNull View view, @NonNull WindowInsets windowInsets) {
            if (view.getTag(R.id.f922757f) != null) {
                return windowInsets;
            }
        ...
        static Callback getCallback(View view) {
            Object tag = view.getTag(R.id.f924557x);
        ...
        @SuppressLint({"WrongConstant"})
        static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f16, int i3) {
            WindowInsetsCompat.Builder builder = new WindowInsetsCompat.Builder(windowInsetsCompat);
            for (int i16 = 1; i16 <= 256; i16 <<= 1) {
                if ((i3 & i16) == 0) {
                    builder.setInsets(i16, windowInsetsCompat.getInsets(i16));
                } else {
                    Insets insets = windowInsetsCompat.getInsets(i16);
                    Insets insets2 = windowInsetsCompat2.getInsets(i16);
                    float f17 = 1.0f - f16;
                    builder.setInsets(i16, WindowInsetsCompat.insetInsets(insets, (int) (((insets.left - insets2.left) * f17) + 0.5d), (int) (((insets.top - insets2.top) * f17) + 0.5d), (int) (((insets.right - insets2.right) * f17) + 0.5d), (int) (((insets.bottom - insets2.bottom) * f17) + 0.5d)));
                }
            }
        ...
        static void setCallback(@NonNull View view, @Nullable Callback callback) {
            Object tag = view.getTag(R.id.f922757f);
            if (callback == null) {
                view.setTag(R.id.f924557x, null);
                if (tag == null) {
            ...
            view.setTag(R.id.f924557x, createProxyListener);
            if (tag == null) {
    ...
    public WindowInsetsAnimationCompat(int i3, @Nullable Interpolator interpolator, long j3) {
        if (Build.VERSION.SDK_INT >= 30) {
            this.mImpl = new Impl30(i3, interpolator, j3);
        } else {
            this.mImpl = new Impl21(i3, interpolator, j3);
        }
    }
    ...
    public void setAlpha(@FloatRange(from = 0.0d, to = 1.0d) float f16) {
        this.mImpl.setAlpha(f16);
    }

    public void setFraction(@FloatRange(from = 0.0d, to = 1.0d) float f16) {
        this.mImpl.setFraction(f16);
    }
    ...
    public static final class BoundsCompat {
        ...
        @RequiresApi(30)
        BoundsCompat(@NonNull WindowInsetsAnimation.Bounds bounds) {
    ...
    @RequiresApi(30)
    WindowInsetsAnimationCompat(@NonNull WindowInsetsAnimation windowInsetsAnimation) {
        this(0, null, 0L);
        if (Build.VERSION.SDK_INT >= 30) {
