...
public final class AccessibilityManagerCompat {
    ...
    public interface AccessibilityStateChangeListener {
        @Deprecated
        void onAccessibilityStateChanged(boolean z16);
    }
    ...
    private static class AccessibilityStateChangeListenerWrapper implements AccessibilityManager.AccessibilityStateChangeListener {
        ...
        public void onAccessibilityStateChanged(boolean z16) {
            this.mListener.onAccessibilityStateChanged(z16);
        }
    }
    ...
    public interface TouchExplorationStateChangeListener {
        void onTouchExplorationStateChanged(boolean z16);
    }
    ...
    private static final class TouchExplorationStateChangeListenerWrapper implements AccessibilityManager.TouchExplorationStateChangeListener {
        ...
        public void onTouchExplorationStateChanged(boolean z16) {
            this.mListener.onTouchExplorationStateChanged(z16);
        }
    }
