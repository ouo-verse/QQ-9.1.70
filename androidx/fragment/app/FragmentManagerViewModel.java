...
public final class FragmentManagerViewModel extends ViewModel {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public FragmentManagerViewModel(boolean z16) {
        this.mStateAutomaticallySaved = z16;
    }
    ...
    public void removeRetainedFragment(@NonNull Fragment fragment) {
        ...
        if (z16 && FragmentManager.isLoggingEnabled(2)) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void setIsStateSaved(boolean z16) {
        this.mIsStateSaved = z16;
    }
    ...
    public String toString() {
        ...
        Iterator<String> it5 = this.mChildNonConfigs.keySet().iterator();
        while (it5.hasNext()) {
            sb5.append(it5.next());
            if (it5.hasNext()) {
                sb5.append(", ");
        ...
        Iterator<String> it6 = this.mViewModelStores.keySet().iterator();
        while (it6.hasNext()) {
            sb5.append(it6.next());
            if (it6.hasNext()) {
                sb5.append(", ");
