...
class DefaultSpecialEffectsController extends SpecialEffectsController {
    ...
    public static class AnimationInfo extends SpecialEffectsInfo {
        ...
        AnimationInfo(@NonNull SpecialEffectsController.Operation operation, @NonNull CancellationSignal cancellationSignal, boolean z16) {
        ...
        FragmentAnim.AnimationOrAnimator getAnimation(@NonNull Context context) {
            ...
            FragmentAnim.AnimationOrAnimator loadAnimation = FragmentAnim.loadAnimation(context, fragment, z16, this.mIsPop);
    ...
    private void startAnimations(@NonNull List<AnimationInfo> list, @NonNull List<SpecialEffectsController.Operation> list2, boolean z16, @NonNull Map<SpecialEffectsController.Operation, Boolean> map) {
        final boolean z17;
    ...
    @NonNull
    private Map<SpecialEffectsController.Operation, Boolean> startTransitions(@NonNull List<TransitionInfo> list, @NonNull List<SpecialEffectsController.Operation> list2, final boolean z16, @Nullable final SpecialEffectsController.Operation operation, @Nullable final SpecialEffectsController.Operation operation2) {
        ...
        for (TransitionInfo transitionInfo3 : list) {
            if (!transitionInfo3.hasSharedElementTransition() || operation7 == null || operation8 == null) {
                ...
                for (int size = sharedElementSourceNames.size(); i16 < size; size = size) {
                    arrayMap2.put(sharedElementSourceNames.get(i16), sharedElementTargetNames2.get(i16));
                    i16++;
                }
                ...
                if (arrayMap2.isEmpty()) {
                    ...
                    FragmentTransition.callSharedElementStartEnd(operation2.getFragment(), operation.getFragment(), z17, arrayMap3, true);
                    ...
                    OneShotPreDrawListener.add(getContainer(), new Runnable() { // from class: androidx.fragment.app.DefaultSpecialEffectsController.6
                        @Override // java.lang.Runnable
                        public void run() {
                            FragmentTransition.callSharedElementStartEnd(operation2.getFragment(), operation.getFragment(), z16, arrayMap4, false);
                        }
                    });
        ...
        while (it5.hasNext()) {
            ...
            if (next.isVisibilityUnchanged()) {
                ...
                boolean z19 = obj3 != null && (operation11 == operation9 || operation11 == operation10);
        ...
        for (final TransitionInfo transitionInfo4 : list) {
            if (!transitionInfo4.isVisibilityUnchanged()) {
                ...
                boolean z26 = obj3 != null && (operation13 == operation9 || operation13 == operation12);
                if (transition != null || z26) {
    ...
    public void executeOperations(@NonNull List<SpecialEffectsController.Operation> list, boolean z16) {
        ...
        for (final SpecialEffectsController.Operation operation4 : list) {
            ...
            arrayList.add(new AnimationInfo(operation4, cancellationSignal, z16));
            CancellationSignal cancellationSignal2 = new CancellationSignal();
            operation4.markStartedSpecialEffect(cancellationSignal2);
            boolean z17 = false;
            if (z16) {
                if (operation4 != operation) {
                    arrayList2.add(new TransitionInfo(operation4, cancellationSignal2, z16, z17));
        ...
        Map<SpecialEffectsController.Operation, Boolean> startTransitions = startTransitions(arrayList2, arrayList3, z16, operation, operation2);
    ...
    public static class TransitionInfo extends SpecialEffectsInfo {
        ...
        TransitionInfo(@NonNull SpecialEffectsController.Operation operation, @NonNull CancellationSignal cancellationSignal, boolean z16, boolean z17) {
            super(operation, cancellationSignal);
