...
public class FragmentTransition {
    ...
    */
    private static void addToFirstInLastOut(BackStackRecord backStackRecord, FragmentTransaction.Op op5, SparseArray<FragmentContainerTransition> sparseArray, boolean z16, boolean z17) {
        int i3;
        int i16;
        boolean z18;
        boolean z19;
                    ...
                    if (i16 != 5) {
                        if (i16 != 6) {
                            if (i16 != 7) {
                                ...
                                z28 = false;
                                z19 = false;
                                fragmentContainerTransition = sparseArray.get(i3);
                                if (z27) {
                                    fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray, i3);
                                    fragmentContainerTransition.lastIn = fragment;
                                    fragmentContainerTransition.lastInIsPop = z16;
                                ...
                                if (z19 && (fragmentContainerTransition == null || fragmentContainerTransition.firstOut == null)) {
                                    fragmentContainerTransition = ensureContainer(fragmentContainerTransition, sparseArray, i3);
                                    fragmentContainerTransition.firstOut = fragment;
                                    fragmentContainerTransition.firstOutIsPop = z16;
                                    fragmentContainerTransition.firstOutTransaction = backStackRecord;
                                }
                                if (!z17 && z26 && fragmentContainerTransition != null && fragmentContainerTransition.lastIn == fragment) {
    ...
    public static void calculateFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z16) {
        int size = backStackRecord.mOps.size();
        for (int i3 = 0; i3 < size; i3++) {
            addToFirstInLastOut(backStackRecord, backStackRecord.mOps.get(i3), sparseArray, false, z16);
        }
    }

    private static ArrayMap<String, String> calculateNameOverrides(int i3, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i16, int i17) {
    ...
    public static void calculatePopFragments(BackStackRecord backStackRecord, SparseArray<FragmentContainerTransition> sparseArray, boolean z16) {
        if (!backStackRecord.mManager.getContainer().onHasView()) {
            return;
        }
        for (int size = backStackRecord.mOps.size() - 1; size >= 0; size--) {
            addToFirstInLastOut(backStackRecord, backStackRecord.mOps.get(size), sparseArray, true, z16);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void callSharedElementStartEnd(Fragment fragment, Fragment fragment2, boolean z16, ArrayMap<String, View> arrayMap, boolean z17) {
    ...
    private static Object configureSharedElementsOrdered(final FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, final View view, final ArrayMap<String, String> arrayMap, final FragmentContainerTransition fragmentContainerTransition, final ArrayList<View> arrayList, final ArrayList<View> arrayList2, final Object obj, Object obj2) {
        ...
        final boolean z16 = fragmentContainerTransition.lastInIsPop;
        if (arrayMap.isEmpty()) {
            arrayMap2 = arrayMap;
            sharedElementTransition = null;
        } else {
            sharedElementTransition = getSharedElementTransition(fragmentTransitionImpl, fragment, fragment2, z16);
            arrayMap2 = arrayMap;
        }
        ...
        callSharedElementStartEnd(fragment, fragment2, z16, captureOutSharedElements, true);
        if (obj3 != null) {
            rect = new Rect();
        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable() { // from class: androidx.fragment.app.FragmentTransition.6
            ...
            public void run() {
                ...
                FragmentTransition.callSharedElementStartEnd(fragment, fragment2, z16, captureInSharedElements, false);
                Object obj5 = obj4;
                if (obj5 != null) {
                    FragmentTransitionImpl.this.swapSharedElementTargets(obj5, arrayList, arrayList2);
                    View inEpicenterView = FragmentTransition.getInEpicenterView(captureInSharedElements, fragmentContainerTransition, obj, z16);
    ...
    private static Object configureSharedElementsReordered(final FragmentTransitionImpl fragmentTransitionImpl, ViewGroup viewGroup, View view, ArrayMap<String, String> arrayMap, FragmentContainerTransition fragmentContainerTransition, ArrayList<View> arrayList, ArrayList<View> arrayList2, Object obj, Object obj2) {
        ...
        if (obj3 != null) {
            ...
            setOutEpicenter(fragmentTransitionImpl, obj3, obj2, captureOutSharedElements, fragmentContainerTransition.firstOutIsPop, fragmentContainerTransition.firstOutTransaction);
            Rect rect2 = new Rect();
            View inEpicenterView = getInEpicenterView(captureInSharedElements, fragmentContainerTransition, obj, z16);
            if (inEpicenterView != null) {
        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable() { // from class: androidx.fragment.app.FragmentTransition.5
            @Override // java.lang.Runnable
            public void run() {
                FragmentTransition.callSharedElementStartEnd(Fragment.this, fragment2, z16, captureInSharedElements, false);
                View view3 = view2;
                if (view3 != null) {
    ...
    private static void configureTransitionsOrdered(@NonNull ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, final Callback callback) {
        ...
        boolean z16 = fragmentContainerTransition.lastInIsPop;
        boolean z17 = fragmentContainerTransition.firstOutIsPop;
        Object enterTransition = getEnterTransition(chooseImpl, fragment, z16);
        Object exitTransition = getExitTransition(chooseImpl, fragment2, z17);
        ArrayList arrayList = new ArrayList();
        ArrayList<View> arrayList2 = new ArrayList<>();
    ...
    private static void configureTransitionsReordered(@NonNull ViewGroup viewGroup, FragmentContainerTransition fragmentContainerTransition, View view, ArrayMap<String, String> arrayMap, final Callback callback) {
        ...
        Object mergeTransitions = mergeTransitions(chooseImpl, enterTransition, obj, configureSharedElementsReordered, fragment, z16);
    ...
    private static Object getEnterTransition(FragmentTransitionImpl fragmentTransitionImpl, Fragment fragment, boolean z16) {
    ...
    private static Object getExitTransition(FragmentTransitionImpl fragmentTransitionImpl, Fragment fragment, boolean z16) {
    ...
    static View getInEpicenterView(ArrayMap<String, View> arrayMap, FragmentContainerTransition fragmentContainerTransition, Object obj, boolean z16) {
        ArrayList<String> arrayList;
        String str;
        BackStackRecord backStackRecord = fragmentContainerTransition.lastInTransaction;
    ...
    private static Object getSharedElementTransition(FragmentTransitionImpl fragmentTransitionImpl, Fragment fragment, Fragment fragment2, boolean z16) {
    ...
    private static Object mergeTransitions(FragmentTransitionImpl fragmentTransitionImpl, Object obj, Object obj2, Object obj3, Fragment fragment, boolean z16) {
        boolean z17;
        if (obj != null && obj2 != null && fragment != null) {
            if (z16) {
                z17 = fragment.getAllowReturnTransitionOverlap();
            } else {
                z17 = fragment.getAllowEnterTransitionOverlap();
            }
        } else {
            z17 = true;
        }
    ...
    private static void setOutEpicenter(FragmentTransitionImpl fragmentTransitionImpl, Object obj, Object obj2, ArrayMap<String, View> arrayMap, boolean z16, BackStackRecord backStackRecord) {
        String str;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void startTransitions(@NonNull Context context, @NonNull FragmentContainer fragmentContainer, ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i3, int i16, boolean z16, Callback callback) {
        ViewGroup viewGroup;
        SparseArray sparseArray = new SparseArray();
        for (int i17 = i3; i17 < i16; i17++) {
            BackStackRecord backStackRecord = arrayList.get(i17);
            if (arrayList2.get(i17).booleanValue()) {
                calculatePopFragments(backStackRecord, sparseArray, z16);
            } else {
                calculateFragments(backStackRecord, sparseArray, z16);
            }
        }
        if (sparseArray.size() != 0) {
            ...
            for (int i18 = 0; i18 < size; i18++) {
                ...
                ArrayMap<String, String> calculateNameOverrides = calculateNameOverrides(keyAt, arrayList, arrayList2, i3, i16);
                FragmentContainerTransition fragmentContainerTransition = (FragmentContainerTransition) sparseArray.valueAt(i18);
