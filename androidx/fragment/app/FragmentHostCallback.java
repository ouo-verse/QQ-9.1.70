...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    @Deprecated
    public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i3, @Nullable Intent intent, int i16, int i17, int i18, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i3 == -1) {
            ActivityCompat.startIntentSenderForResult(this.mActivity, intentSender, i3, intent, i16, i17, i18, bundle);
            return;
        }
    ...
    FragmentHostCallback(@Nullable Activity activity, @NonNull Context context, @NonNull Handler handler, int i3) {
