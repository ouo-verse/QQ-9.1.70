...
public class FragmentController {
    ...
    FragmentController(FragmentHostCallback<?> fragmentHostCallback) {
    ...
    public void dispatchMultiWindowModeChanged(boolean z16) {
        this.mHost.mFragmentManager.dispatchMultiWindowModeChanged(z16);
    }
    ...
    public void dispatchPictureInPictureModeChanged(boolean z16) {
        this.mHost.mFragmentManager.dispatchPictureInPictureModeChanged(z16);
    }
    ...
    @Deprecated
    public void doLoaderStop(boolean z16) {
    }
