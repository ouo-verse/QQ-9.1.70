...
public final class ActivityResultCallerKt {
    @NotNull
    public static final <I, O> ActivityResultLauncher<Unit> registerForActivityResult(@NotNull ActivityResultCaller registerForActivityResult, @NotNull ActivityResultContract<I, O> contract, I i3, @NotNull ActivityResultRegistry registry, @NotNull final Function1<? super O, Unit> callback) {
        ...
        ActivityResultLauncher<I> registerForActivityResult2 = registerForActivityResult.registerForActivityResult(contract, registry, new ActivityResultCallback<O>() { // from class: androidx.activity.result.ActivityResultCallerKt$registerForActivityResult$resultLauncher$1
            ...
            public final void onActivityResult(O o16) {
                Function1.this.invoke(o16);
            }
        });
    ...
    @NotNull
    public static final <I, O> ActivityResultLauncher<Unit> registerForActivityResult(@NotNull ActivityResultCaller registerForActivityResult, @NotNull ActivityResultContract<I, O> contract, I i3, @NotNull final Function1<? super O, Unit> callback) {
        Intrinsics.checkNotNullParameter(registerForActivityResult, "$this$registerForActivityResult");
        Intrinsics.checkNotNullParameter(contract, "contract");
        Intrinsics.checkNotNullParameter(callback, "callback");
