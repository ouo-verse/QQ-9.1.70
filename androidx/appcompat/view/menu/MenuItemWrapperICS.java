...
public class MenuItemWrapperICS extends BaseMenuWrapper implements MenuItem {
    ...
    private class ActionProviderWrapperJB extends ActionProviderWrapper implements ActionProvider.VisibilityListener {
        ...
        public void onActionProviderVisibilityChanged(boolean z16) {
            ...
            if (visibilityListener != null) {
                visibilityListener.onActionProviderVisibilityChanged(z16);
            }
        }
    ...
    public MenuItem setAlphabeticShortcut(char c16) {
        this.mWrappedObject.setAlphabeticShortcut(c16);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setCheckable(boolean z16) {
        this.mWrappedObject.setCheckable(z16);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setChecked(boolean z16) {
        this.mWrappedObject.setChecked(z16);
        return this;
    }
    ...
    public MenuItem setEnabled(boolean z16) {
        this.mWrappedObject.setEnabled(z16);
        return this;
    }
    ...
    public void setExclusiveCheckable(boolean z16) {
        try {
            ...
            this.mSetExclusiveCheckableMethod.invoke(this.mWrappedObject, Boolean.valueOf(z16));
        } catch (Exception e16) {
            Log.w(LOG_TAG, "Error while calling setExclusiveCheckable", e16);
        }
    }
    ...
    public MenuItem setNumericShortcut(char c16) {
        this.mWrappedObject.setNumericShortcut(c16);
        return this;
    }
    ...
    public MenuItem setShortcut(char c16, char c17) {
        this.mWrappedObject.setShortcut(c16, c17);
        return this;
    }
    ...
    public MenuItem setVisible(boolean z16) {
        return this.mWrappedObject.setVisible(z16);
    }

    @Override // android.view.MenuItem
    public MenuItem setAlphabeticShortcut(char c16, int i3) {
        this.mWrappedObject.setAlphabeticShortcut(c16, i3);
        return this;
    }
    ...
    public MenuItem setNumericShortcut(char c16, int i3) {
        this.mWrappedObject.setNumericShortcut(c16, i3);
        return this;
    }

    @Override // android.view.MenuItem
    public MenuItem setShortcut(char c16, char c17, int i3, int i16) {
        this.mWrappedObject.setShortcut(c16, c17, i3, i16);
        return this;
    }
