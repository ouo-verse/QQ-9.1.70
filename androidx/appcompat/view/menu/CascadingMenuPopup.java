...
final class CascadingMenuPopup extends MenuPopup implements View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    private final MenuItemHoverListener mMenuItemHoverListener = new MenuItemHoverListener() { // from class: androidx.appcompat.view.menu.CascadingMenuPopup.3
        ...
        public void onItemHoverEnter(@NonNull final MenuBuilder menuBuilder, @NonNull final MenuItem menuItem) {
            ...
            int i16 = i3 + 1;
            if (i16 < CascadingMenuPopup.this.mShowingMenus.size()) {
                cascadingMenuInfo = CascadingMenuPopup.this.mShowingMenus.get(i16);
            }
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View view, @AttrRes int i3, @StyleRes int i16, boolean z16) {
        ...
        this.mMenuMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.bur));
    ...
    private View findParentViewForSubmenu(@NonNull CascadingMenuInfo cascadingMenuInfo, @NonNull MenuBuilder menuBuilder) {
        ...
        while (true) {
            if (i16 < count) {
                if (findMenuItemForSubmenu == menuAdapter.getItem(i16)) {
                    break;
                }
                i16++;
            } else {
        ...
        if (i16 == -1 || (firstVisiblePosition = (i16 + i3) - listView.getFirstVisiblePosition()) < 0 || firstVisiblePosition >= listView.getChildCount()) {
            return null;
        }
    ...
    private int getNextMenuPosition(int i3) {
        ...
        if (this.mLastPosition == 1) {
            if (iArr[0] + listView.getWidth() + i3 <= rect.right) {
                return 1;
            }
            return 0;
        }
    ...
    private void showMenu(@NonNull MenuBuilder menuBuilder) {
        ...
        if (view != null) {
            ...
            if ((this.mDropDownGravity & 5) == 5) {
                if (!z16) {
                    ...
                    i17 = i3 - measureIndividualMenuWidth;
                }
                i17 = i3 + measureIndividualMenuWidth;
            } else {
                if (z16) {
            ...
            createPopupWindow.setHorizontalOffset(i17);
            createPopupWindow.setOverlapAnchor(true);
            createPopupWindow.setVerticalOffset(i16);
        } else {
            if (this.mHasXOffset) {
        ...
        if (cascadingMenuInfo == null && this.mShowTitle && menuBuilder.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) from.inflate(R.layout.dpi, (ViewGroup) listView, false);
