...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, R.attr.b1v, 0);
    }
    ...
    private MenuPopup createPopup() {
        ...
        if (Math.min(point.x, point.y) >= this.mContext.getResources().getDimensionPixelSize(R.dimen.buq)) {
            z16 = true;
        } else {
            z16 = false;
        }
    ...
    private void showPopup(int i3, int i16, boolean z16, boolean z17) {
        MenuPopup popup = getPopup();
        popup.setShowTitle(z17);
        if (z16) {
            if ((GravityCompat.getAbsoluteGravity(this.mDropDownGravity, ViewCompat.getLayoutDirection(this.mAnchorView)) & 7) == 5) {
                i3 -= this.mAnchorView.getWidth();
            }
            popup.setHorizontalOffset(i3);
            popup.setVerticalOffset(i16);
            int i17 = (int) ((this.mContext.getResources().getDisplayMetrics().density * 48.0f) / 2.0f);
            popup.setEpicenterBounds(new Rect(i3 - i17, i16 - i17, i3 + i17, i16 + i17));
        }
        popup.show();
    }
    ...
    public void setForceShowIcon(boolean z16) {
        ...
        MenuPopup menuPopup = this.mPopup;
        if (menuPopup != null) {
            menuPopup.setForceShowIcon(z16);
        }
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view) {
        this(context, menuBuilder, view, false, R.attr.b1v, 0);
    }

    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z16, @AttrRes int i3) {
        this(context, menuBuilder, view, z16, i3, 0);
    }
    ...
    public MenuPopupHelper(@NonNull Context context, @NonNull MenuBuilder menuBuilder, @NonNull View view, boolean z16, @AttrRes int i3, @StyleRes int i16) {
    ...
    public boolean tryShow(int i3, int i16) {
        if (isShowing()) {
            return true;
        }
        if (this.mAnchorView == null) {
