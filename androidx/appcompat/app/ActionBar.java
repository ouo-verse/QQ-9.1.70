...
public abstract class ActionBar {
    ...
    public interface OnMenuVisibilityListener {
        void onMenuVisibilityChanged(boolean z16);
    }
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i3, boolean z16);

    @Deprecated
    public abstract void addTab(Tab tab, boolean z16);
    ...
    public abstract void setDisplayHomeAsUpEnabled(boolean z16);

    public abstract void setDisplayOptions(int i3);

    public abstract void setDisplayOptions(int i3, int i16);

    public abstract void setDisplayShowCustomEnabled(boolean z16);

    public abstract void setDisplayShowHomeEnabled(boolean z16);

    public abstract void setDisplayShowTitleEnabled(boolean z16);

    public abstract void setDisplayUseLogoEnabled(boolean z16);
