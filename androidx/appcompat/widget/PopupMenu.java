...
public class PopupMenu {
    ...
    public PopupMenu(@NonNull Context context, @NonNull View view, int i3) {
        this(context, view, i3, R.attr.b1v, 0);
    }

    public PopupMenu(@NonNull Context context, @NonNull View view, int i3, @AttrRes int i16, @StyleRes int i17) {
        ...
        MenuPopupHelper menuPopupHelper = new MenuPopupHelper(context, menuBuilder, view, false, i16, i17);
