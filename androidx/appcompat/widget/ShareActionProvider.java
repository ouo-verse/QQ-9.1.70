...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        this.mContext.getTheme().resolveAttribute(R.attr.f4396d, typedValue, true);
        ...
        activityChooserView.setDefaultActionButtonContentDescription(R.string.yiz);
        activityChooserView.setExpandActivityOverflowButtonContentDescription(R.string.yiy);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (min < activityCount) {
            SubMenu addSubMenu = subMenu.addSubMenu(0, min, min, this.mContext.getString(R.string.yie));
            for (int i16 = 0; i16 < activityCount; i16++) {
                ResolveInfo activity2 = activityChooserModel.getActivity(i16);
                addSubMenu.add(0, i16, i16, activity2.loadLabel(packageManager)).setIcon(activity2.loadIcon(packageManager)).setOnMenuItemClickListener(this.mOnMenuItemClickListener);
            }
        }
    }
