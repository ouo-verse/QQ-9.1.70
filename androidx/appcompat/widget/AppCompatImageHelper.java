...
public class AppCompatImageHelper {
    ...
    public void loadFromAttributes(AttributeSet attributeSet, int i3) {
        ...
        try {
            ...
            int i16 = R.styleable.AppCompatImageView_tint;
            if (obtainStyledAttributes.hasValue(i16)) {
                ImageViewCompat.setImageTintList(this.mView, obtainStyledAttributes.getColorStateList(i16));
            }
            int i17 = R.styleable.AppCompatImageView_tintMode;
            if (obtainStyledAttributes.hasValue(i17)) {
                ImageViewCompat.setImageTintMode(this.mView, DrawableUtils.parseTintMode(obtainStyledAttributes.getInt(i17, -1), null));
            }
        } finally {
