...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public View getView(int i3, View view, ViewGroup viewGroup) {
            if (view == null) {
                view = ScrollingTabContainerView.this.createTabView((ActionBar.Tab) getItem(i3), true);
            } else {
    ...
    public class TabView extends LinearLayout {
        ...
        public TabView(Context context, ActionBar.Tab tab, boolean z16) {
            super(context, null, R.attr.f4215w);
            int[] iArr = {android.R.attr.background};
            this.BG_ATTRS = iArr;
            this.mTab = tab;
            TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, null, iArr, R.attr.f4215w, 0);
        ...
        public void onMeasure(int i3, int i16) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0) {
                ...
                int i17 = ScrollingTabContainerView.this.mMaxTabWidth;
        ...
        public void update() {
            ...
            if (z16) {
                if (this.mTextView == null) {
                    AppCompatTextView appCompatTextView = new AppCompatTextView(getContext(), null, R.attr.f4225x);
    ...
    private Spinner createSpinner() {
        AppCompatSpinner appCompatSpinner = new AppCompatSpinner(getContext(), null, R.attr.f42661);
    ...
    private LinearLayoutCompat createTabLayout() {
        LinearLayoutCompat linearLayoutCompat = new LinearLayoutCompat(getContext(), null, R.attr.f4205v);
    ...
    TabView createTabView(ActionBar.Tab tab, boolean z16) {
        TabView tabView = new TabView(getContext(), tab, z16);
        if (z16) {
    ...
    public void onMeasure(int i3, int i16) {
        ...
        if (z16 && measuredWidth != measuredWidth2) {
    ...
    public void setAllowCollapse(boolean z16) {
        this.mAllowCollapse = z16;
    }
    ...
    public void setTabSelected(int i3) {
        ...
        for (int i16 = 0; i16 < childCount; i16++) {
            View childAt = this.mTabLayout.getChildAt(i16);
            if (i16 == i3) {
                z16 = true;
            } else {
                z16 = false;
