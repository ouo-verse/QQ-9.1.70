...
public class ThemeUtils {
    ...
    @NonNull
    public static ColorStateList createDisabledStateList(int i3, int i16) {
        return new ColorStateList(new int[][]{DISABLED_STATE_SET, EMPTY_STATE_SET}, new int[]{i16, i3});
    }
    ...
    static int getThemeAttrColor(@NonNull Context context, int i3, float f16) {
        return ColorUtils.setAlphaComponent(getThemeAttrColor(context, i3), Math.round(Color.alpha(r0) * f16));
    }
}
