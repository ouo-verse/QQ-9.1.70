...
public class Placeholder extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (isInEditMode()) {
            ...
            paint.getTextBounds(QZoneIntimateSpaceApiImpl.URL_QUERY_SPLITTER, 0, 1, rect);
            canvas.drawText(QZoneIntimateSpaceApiImpl.URL_QUERY_SPLITTER, ((width / 2.0f) - (rect.width() / 2.0f)) - rect.left, ((height / 2.0f) + (rect.height() / 2.0f)) - rect.bottom, paint);
        }
    }
    ...
    public Placeholder(Context context, AttributeSet attributeSet, int i3, int i16) {
        super(context, attributeSet, i3);
        this.mContentId = -1;
        this.mContent = null;
        this.mEmptyVisibility = 4;
