...
public class Guideline extends ConstraintWidget {
    ...
    public void addToSolver(LinearSystem linearSystem, boolean z16) {
        ...
        if (this.resolved && this.mAnchor.hasFinalValue()) {
            ...
            } else if (this.mRelativeEnd != -1 && z17) {
    ...
    void inferRelativePercentPosition() {
        float x16 = getX() / getParent().getWidth();
        if (this.mOrientation == 0) {
            x16 = getY() / getParent().getHeight();
        }
        setGuidePercent(x16);
    }
    ...
    public void setOrientation(int i3) {
        ...
        for (int i16 = 0; i16 < length; i16++) {
            this.mListAnchors[i16] = this.mAnchor;
        }
    }
    ...
    public void setGuidePercent(float f16) {
        if (f16 > -1.0f) {
            this.mRelativePercent = f16;
            this.mRelativeBegin = -1;
            this.mRelativeEnd = -1;
        }
    }
