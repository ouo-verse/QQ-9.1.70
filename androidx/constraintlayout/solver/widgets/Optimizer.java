...
public class Optimizer {
    ...
    public static void checkMatchParent(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, ConstraintWidget constraintWidget) {
        ...
        if (constraintWidgetContainer.mListDimensionBehaviors[1] != dimensionBehaviour2 && constraintWidget.mListDimensionBehaviors[1] == ConstraintWidget.DimensionBehaviour.MATCH_PARENT) {
            int i16 = constraintWidget.mTop.mMargin;
            ...
            linearSystem.addEquality(constraintWidget.mTop.mSolverVariable, i16);
            ...
            if (constraintWidget.mBaselineDistance > 0 || constraintWidget.getVisibility() == 8) {
                ...
                linearSystem.addEquality(constraintWidget.mBaseline.mSolverVariable, constraintWidget.mBaselineDistance + i16);
            }
            constraintWidget.mVerticalResolution = 2;
            constraintWidget.setVerticalDimension(i16, height);
        }
    }

    public static final boolean enabled(int i3, int i16) {
        if ((i3 & i16) == i16) {
            return true;
        }
        return false;
