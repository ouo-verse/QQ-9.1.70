...
public class ConstraintReference implements Reference {
    ...
    public void apply() {
        ...
        int i16 = this.mVerticalChainStyle;
        if (i16 != 0) {
            this.mConstraintWidget.setVerticalChainStyle(i16);
        }
    ...
    public ConstraintReference bias(float f16) {
    ...
    public ConstraintReference horizontalBias(float f16) {
        this.mHorizontalBias = f16;
        return this;
    }
    ...
    public ConstraintReference verticalBias(float f16) {
        this.mVerticalBias = f16;
        return this;
    }
