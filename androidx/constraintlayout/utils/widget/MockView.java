...
public class MockView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f16 = width;
            float f17 = height;
            canvas.drawLine(0.0f, 0.0f, f16, f17, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f17, f16, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(0.0f, 0.0f, f16, 0.0f, this.mPaintDiagonals);
            canvas.drawLine(f16, 0.0f, f16, f17, this.mPaintDiagonals);
            canvas.drawLine(f16, f17, 0.0f, f17, this.mPaintDiagonals);
            canvas.drawLine(0.0f, f17, 0.0f, 0.0f, this.mPaintDiagonals);
        }
        ...
        if (str != null && this.mDrawLabel) {
            ...
            rect.set(i3 - i16, rect.top - i16, rect.right + i16, rect.bottom + i16);
