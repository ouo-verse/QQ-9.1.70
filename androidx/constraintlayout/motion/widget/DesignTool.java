...
public class DesignTool implements ProxyInterface {
    ...
    private static void Connect(int i3, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i16, int i17) {
        int i18;
        String str = allAttributes.get(Pair.create(Integer.valueOf(i16), Integer.valueOf(i17)));
        String str2 = hashMap.get(str);
        if (str2 != null) {
            String str3 = allMargins.get(str);
            if (str3 != null) {
                i18 = GetPxFromDp(i3, hashMap.get(str3));
            } else {
                i18 = 0;
            }
            int parseInt = Integer.parseInt(str2);
            constraintSet.connect(view.getId(), i16, parseInt, i17, i18);
        }
    }
    ...
    private static void SetDimensions(int i3, ConstraintSet constraintSet, View view, HashMap<String, String> hashMap, int i16) {
        String str;
        int i17;
        if (i16 == 1) {
            str = "layout_height";
        ...
        String str2 = hashMap.get(str);
        if (str2 != null) {
            if (!str2.equalsIgnoreCase(ParseCommon.LAYOUT_PARAMS_WRAP_CONTENT)) {
                i17 = GetPxFromDp(i3, str2);
            } else {
                i17 = -2;
            }
            if (i16 == 0) {
                constraintSet.constrainWidth(view.getId(), i17);
            } else {
                constraintSet.constrainHeight(view.getId(), i17);
            }
        }
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public int designAccess(int i3, String str, Object obj, float[] fArr, int i16, float[] fArr2, int i17) {
        ...
        if (i3 != 1) {
            if (i3 != 2) {
                ...
                return motionController.getAttributeValues(str, fArr2, i17);
            }
    ...
    public void disableAutoTransition(boolean z16) {
        this.mMotionLayout.disableAutoTransition(z16);
    }
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public float getKeyFramePosition(Object obj, int i3, float f16, float f17) {
        return this.mMotionLayout.mFrameArrayList.get((View) obj).getKeyFrameParameter(i3, f16, f17);
    }
    ...
    public Object getKeyframe(int i3, int i16, int i17) {
        MotionLayout motionLayout = this.mMotionLayout;
        MotionScene motionScene = motionLayout.mScene;
        if (motionScene == null) {
            return null;
        }
        return motionScene.getKeyFrame(motionLayout.getContext(), i3, i16, i17);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Object getKeyframeAtLocation(Object obj, float f16, float f17) {
        MotionController motionController;
        View view = (View) obj;
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
        ...
        return motionController.getPositionKeyframe(viewGroup.getWidth(), viewGroup.getHeight(), f16, f17);
    }

    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public Boolean getPositionKeyframe(Object obj, Object obj2, float f16, float f17, String[] strArr, float[] fArr) {
        if (obj instanceof KeyPositionBase) {
            View view = (View) obj2;
            this.mMotionLayout.mFrameArrayList.get(view).positionKeyframe(view, (KeyPositionBase) obj, f16, f17, strArr, fArr);
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public boolean setKeyFramePosition(Object obj, int i3, int i16, float f16, float f17) {
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene != null) {
            MotionController motionController = motionLayout.mFrameArrayList.get(obj);
            MotionLayout motionLayout2 = this.mMotionLayout;
            int i17 = (int) (motionLayout2.mTransitionPosition * 100.0f);
            if (motionController != null) {
                View view = (View) obj;
                if (motionLayout2.mScene.hasKeyFramePosition(view, i17)) {
                    float keyFrameParameter = motionController.getKeyFrameParameter(2, f16, f17);
                    float keyFrameParameter2 = motionController.getKeyFrameParameter(5, f16, f17);
                    this.mMotionLayout.mScene.setKeyframe(view, i17, "motion:percentX", Float.valueOf(keyFrameParameter));
                    this.mMotionLayout.mScene.setKeyframe(view, i17, "motion:percentY", Float.valueOf(keyFrameParameter2));
                    this.mMotionLayout.rebuildScene();
                    this.mMotionLayout.evaluate(true);
    ...
    @Override // androidx.constraintlayout.motion.widget.ProxyInterface
    public void setToolPosition(float f16) {
        MotionLayout motionLayout = this.mMotionLayout;
        if (motionLayout.mScene == null) {
            motionLayout.mScene = this.mSceneCache;
        }
    ...
    public Object getKeyframe(Object obj, int i3, int i16) {
        if (this.mMotionLayout.mScene == null) {
            return null;
        }
        int id5 = ((View) obj).getId();
        MotionLayout motionLayout = this.mMotionLayout;
        return motionLayout.mScene.getKeyFrame(motionLayout.getContext(), i3, id5, i16);
    }
}
