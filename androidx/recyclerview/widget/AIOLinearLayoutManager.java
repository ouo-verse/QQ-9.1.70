...
public class AIOLinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    private static boolean DEBUG = com.tencent.aio.base.a.f69150c.a();
    ...
    public static class LayoutState {
        ...
        public View nextViewInLimitedList(View view) {
            ...
            int size = this.mScrapList.size();
            if (AIOLinearLayoutManager.DEBUG && this.mIsPreLayout) {
        ...
        public String toString() {
            return "LayoutState{mRecycle=" + this.mRecycle + ", mOffset=" + this.mOffset + ", mAvailable=" + this.mAvailable + ", mCurrentPosition=" + this.mCurrentPosition + ", mItemDirection=" + this.mItemDirection + ", mLayoutDirection=" + this.mLayoutDirection + ", mScrollingOffset=" + this.mScrollingOffset + ", mExtraFillSpace=" + this.mExtraFillSpace + ", mNoRecycleSpace=" + this.mNoRecycleSpace + ", mIsPreLayout=" + this.mIsPreLayout + ", mLastScrollDelta=" + this.mLastScrollDelta + ", mScrapList=" + this.mScrapList + ", mInfinite=" + this.mInfinite + '}';
        }
    ...
    public static class SavedState implements Parcelable {
        public static final Parcelable.Creator<SavedState> CREATOR = new Parcelable.Creator<SavedState>() { // from class: androidx.recyclerview.widget.AIOLinearLayoutManager.SavedState.1
    ...
    public AIOLinearLayoutManager(Context context) {
    ...
    private int fixLayoutEndGap(int i3, RecyclerView.Recycler recycler, RecyclerView.State state, boolean z16) {
        ...
        if (!this.needFixGap || (endAfterPadding = this.mOrientationHelper.getEndAfterPadding() - i3) <= 0) {
            return 0;
        }
    ...
    private int fixLayoutStartGap(int i3, RecyclerView.Recycler recycler, RecyclerView.State state, boolean z16) {
        ...
        if (!this.needFixGap || (starForFixGap = i3 - getStarForFixGap()) <= 0) {
            return 0;
        }
        int i16 = -scrollBy(starForFixGap, recycler, state);
        int i17 = i3 + i16;
    ...
    public /* synthetic */ Object lambda$fill$0(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        layoutChunk(recycler, state, layoutState, layoutChunkResult);
        return null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Object lambda$layoutChunk$2(View view) {
        measureChildWithMargins(view, 0, 0);
        return null;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ Object lambda$layoutChunk$3(View view, int i3, int i16, int i17, int i18) {
        layoutDecoratedWithMargins(view, i3, i16, i17, i18);
        return null;
    }
    ...
    private void layoutForPredictiveAnimations(RecyclerView.Recycler recycler, RecyclerView.State state, int i3, int i16) {
        ...
        if (state.willRunPredictiveAnimations() && getChildCount() != 0 && !state.isPreLayout() && supportsPredictiveItemAnimations()) {
            ...
            if (DEBUG) {
                Log.d(TAG, "for unused scrap, decided to add " + i17 + " towards start and " + i18 + " towards end");
            }
    ...
    private void setNeedFixGap(boolean z16) {
        this.needFixGap = z16;
    }
    ...
    private boolean updateAnchorFromChildren(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (check(findReferenceChildClosestToStart, anchorInfo, state, this.mLayoutState).booleanValue()) {
            return true;
        }
    ...
    private void updateAnchorInfoForLayout(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo) {
        ...
        if (updateAnchorFromAsnyFocus(state, anchorInfo)) {
            if (DEBUG) {
                Log.d(TAG, "updated anchor info from updateAnchorFromAsnyFocus");
            }
        } else {
    ...
    public boolean canScrollHorizontally() {
        if (!this.mDisableScroll && this.mOrientation == 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean canScrollVertically() {
        if (!this.mDisableScroll && this.mOrientation == 1) {
            return true;
        }
        return false;
    }

    protected Boolean check(View view, AnchorInfo anchorInfo, RecyclerView.State state, LayoutState layoutState) {
        return Boolean.FALSE;
    }

    public boolean checkValidPosition(int i3, int i16, boolean z16) {
        if (this.mPendingScrollPosition == i3 && this.mPendingScrollPositionOffset == i16 && this.mPendingScrollPositionBottom == z16) {
            return false;
        }
        return true;
    }
    ...
    int convertFocusDirectionToLayoutDirection(int i3) {
        if (i3 != 1) {
            if (i3 != 2) {
                if (i3 != 17) {
                    if (i3 != 33) {
    ...
    int fill(final RecyclerView.Recycler recycler, final LayoutState layoutState, final RecyclerView.State state, boolean z16) {
        ...
        final LayoutChunkResult layoutChunkResult = this.mLayoutChunkResult;
        while (true) {
            try {
                ...
                com.tencent.aio.pref.a.p("LayoutChunk", new Function0() { // from class: androidx.recyclerview.widget.d
                    @Override // kotlin.jvm.functions.Function0
                    public final Object invoke() {
                        Object lambda$fill$0;
                        lambda$fill$0 = AIOLinearLayoutManager.this.lambda$fill$0(recycler, state, layoutState, layoutChunkResult);
                ...
                com.tencent.aio.base.log.a.f69187b.a(TAG, "fill error", e16);
            }
        }
    ...
    View findFirstVisibleChildClosestToEnd(boolean z16, boolean z17) {
        if (this.mShouldReverseLayout) {
    ...
    View findFirstVisibleChildClosestToStart(boolean z16, boolean z17) {
        if (this.mShouldReverseLayout) {
            return findOneVisibleChild(getChildCount() - 1, -1, z16, z17);
        }
        return findOneVisibleChild(0, getChildCount(), z16, z17);
    ...
    protected View findReferenceChildClosestToEnd(RecyclerView.Recycler recycler, RecyclerView.State state) {
        if (this.mShouldReverseLayout) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public View findReferenceChildClosestToStart(RecyclerView.Recycler recycler, RecyclerView.State state) {
        if (this.mShouldReverseLayout) {
            return findLastReferenceChild(recycler, state);
        }
        return findFirstReferenceChild(recycler, state);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public int fixStackFromEndStartOffset(int i3) {
        return 0;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public int fixStackFromEndStartOffsetV1(int i3) {
        return 0;
    }
    ...
    void layoutChunk(final RecyclerView.Recycler recycler, RecyclerView.State state, final LayoutState layoutState, LayoutChunkResult layoutChunkResult) {
        boolean z16;
        int i3;
        int i16;
        int i17;
        ...
        int i26;
        boolean z17;
        final View view = (View) com.tencent.aio.pref.a.p("getChildView", new Function0() { // from class: androidx.recyclerview.widget.a
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                View next;
                next = AIOLinearLayoutManager.LayoutState.this.next(recycler);
                return next;
            }
        });
        if (view == null) {
        ...
        com.tencent.aio.pref.a.p("measureChild", new Function0() { // from class: androidx.recyclerview.widget.b
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Object lambda$layoutChunk$2;
                lambda$layoutChunk$2 = AIOLinearLayoutManager.this.lambda$layoutChunk$2(view);
                return lambda$layoutChunk$2;
            }
        });
        ...
        if (this.mOrientation == 1) {
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i19 = i26 - layoutChunkResult.mConsumed;
            } else {
                i19 = layoutState.mOffset;
                i26 = layoutChunkResult.mConsumed + i19;
            }
            i17 = i26;
            ...
            if (layoutState.mLayoutDirection == -1) {
                ...
                i3 = i27 - layoutChunkResult.mConsumed;
            } else {
                int i28 = layoutState.mOffset;
                i3 = i28;
                i16 = paddingTop;
                i17 = decoratedMeasurementInOther2;
                i18 = layoutChunkResult.mConsumed + i28;
            }
        }
        final int i29 = i3;
        final int i36 = i16;
        final int i37 = i18;
        final int i38 = i17;
        com.tencent.aio.pref.a.p("layoutChild", new Function0() { // from class: androidx.recyclerview.widget.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                Object lambda$layoutChunk$3;
                lambda$layoutChunk$3 = AIOLinearLayoutManager.this.lambda$layoutChunk$3(view, i29, i36, i37, i38);
                return lambda$layoutChunk$3;
            }
        });
        if (DEBUG) {
            Log.d(TAG, "laid out child at position " + getPosition(view) + ", with l:" + (i3 + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin) + ", t:" + (i16 + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin) + ", r:" + (i18 - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin) + ", b:" + (i17 - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin));
        }
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (DEBUG) {
            Log.d(TAG, "Anchor info:" + this.mAnchorInfo);
        }
        LayoutState layoutState = this.mLayoutState;
        ...
        if (getChildCount() > 0) {
            ...
            int i48 = i18 + fixLayoutEndGap;
            int i49 = i19 + fixLayoutEndGap;
            if (this.mStackFromEnd) {
                int fixStackFromEndStartOffset = fixStackFromEndStartOffset(i48);
                i48 -= fixStackFromEndStartOffset;
                i49 -= fixStackFromEndStartOffset;
            }
            int fixStackFromEndStartOffsetV1 = fixStackFromEndStartOffsetV1(i48);
            i17 = i48 - fixStackFromEndStartOffsetV1;
            i16 = i49 - fixStackFromEndStartOffsetV1;
        }
        ...
        if (DEBUG) {
            Log.w(TAG, "layoutChildren " + (System.currentTimeMillis() - currentTimeMillis));
        }
    }
    ...
    protected void recycleChildren(RecyclerView.Recycler recycler, int i3, int i16) {
        if (i3 == i16) {
            return;
        }
        if (DEBUG) {
            Log.d(TAG, "Recycling " + Math.abs(i3 - i16) + " items");
        }
        if (i16 > i3) {
    ...
    protected void recycleViewsFromStart(RecyclerView.Recycler recycler, int i3, int i16) {
        RecyclerView.ViewHolder childViewHolder;
        RecyclerView.ViewHolder childViewHolder2;
        if (i3 < 0) {
            if (DEBUG) {
        ...
        if (this.mShouldReverseLayout) {
            ...
            for (int i19 = i18; i19 >= 0; i19--) {
                ...
                if (childAt != null && (childViewHolder2 = this.mRecyclerView.getChildViewHolder(childAt)) != null && !childViewHolder2.shouldIgnore() && (this.mOrientationHelper.getDecoratedEnd(childAt) > i17 || this.mOrientationHelper.getTransformedEndWithDecoration(childAt) > i17)) {
                    recycleChildren(recycler, i18, i19);
                    return;
                }
            }
        ...
        for (int i26 = 0; i26 < childCount; i26++) {
            ...
            if (childAt2 != null && (childViewHolder = this.mRecyclerView.getChildViewHolder(childAt2)) != null && !childViewHolder.shouldIgnore() && (this.mOrientationHelper.getDecoratedEnd(childAt2) > i17 || this.mOrientationHelper.getTransformedEndWithDecoration(childAt2) > i17)) {
    ...
    public void scrollToPositionWithOffset(int i3, int i16) {
        scrollToPositionWithOffset(i3, i16, this.mShouldReverseLayout);
    }
    ...
    public void setScrollDisabled(boolean z16) {
        this.mDisableScroll = z16;
    }
    ...
    protected boolean updateAnchorFromAsnyFocus(RecyclerView.State state, AnchorInfo anchorInfo) {
        return false;
    }

    protected boolean updateAnchorFromPendingData(RecyclerView.State state, AnchorInfo anchorInfo) {
        int i3;
        boolean z16;
        int decoratedStart;
        boolean z17 = false;
        if (!state.isPreLayout() && (i3 = this.mPendingScrollPosition) != -1) {
            if (i3 >= 0 && i3 < state.getItemCount()) {
                ...
                if (this.mPendingScrollPositionOffset == Integer.MIN_VALUE) {
                    ...
                    if (findViewByPosition != null) {
                        ...
                        if (getChildCount() > 0) {
                            ...
                            if (z16 == this.mPendingScrollPositionBottom) {
                                z17 = true;
                            }
                ...
                boolean z19 = this.mPendingScrollPositionBottom;
    ...
    public AIOLinearLayoutManager(Context context, int i3, boolean z16) {
        this.mOrientation = 1;
    ...
    public Boolean scrollToPositionWithOffset(int i3, int i16, boolean z16) {
        if (!checkValidPosition(i3, i16, z16)) {
            return Boolean.FALSE;
        }
        this.mPendingScrollPosition = i3;
        this.mPendingScrollPositionOffset = i16;
        this.mPendingScrollPositionBottom = z16;
        SavedState savedState = this.mPendingSavedState;
        if (savedState != null) {
            savedState.invalidateAnchor();
        }
    ...
    public static class AnchorInfo {
        ...
        public void assignFromView(View view, int i3, boolean z16) {
            if (z16) {
                this.mCoordinate = this.mOrientationHelper.getDecoratedEnd(view) + this.mOrientationHelper.getTotalSpaceChange();
            } else {
                this.mCoordinate = this.mOrientationHelper.getDecoratedStart(view);
    ...
    void onAnchorReady(RecyclerView.Recycler recycler, RecyclerView.State state, AnchorInfo anchorInfo, int i3) {
    }
}
