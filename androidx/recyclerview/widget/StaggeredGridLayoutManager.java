...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    */
    ...
    private void measureChildWithDecorationsAndMargin(View view, LayoutParams layoutParams, boolean z16) {
        if (layoutParams.mFullSpan) {
            if (this.mOrientation == 1) {
                measureChildWithDecorationsAndMargin(view, this.mFullSizeSpec, RecyclerView.LayoutManager.getChildMeasureSpec(getHeight(), getHeightMode(), getPaddingTop() + getPaddingBottom(), ((ViewGroup.MarginLayoutParams) layoutParams).height, true), z16);
                return;
            } else {
                measureChildWithDecorationsAndMargin(view, RecyclerView.LayoutManager.getChildMeasureSpec(getWidth(), getWidthMode(), getPaddingLeft() + getPaddingRight(), ((ViewGroup.MarginLayoutParams) layoutParams).width, true), this.mFullSizeSpec, z16);
                return;
            }
        }
        if (this.mOrientation == 1) {
        ...
        if (getChildCount() != 0 && i3 != 0) {
            ...
            for (int i19 = 0; i19 < this.mSpanCount; i19++) {
                ...
                if (layoutState.mItemDirection == -1) {
                    ...
                    i17 = this.mSpans[i19].getStartLine(endLine);
                } else {
                    endLine = this.mSpans[i19].getEndLine(layoutState.mEndLine);
                    i17 = this.mLayoutState.mEndLine;
                }
                int i26 = endLine - i17;
                if (i26 >= 0) {
                    this.mPrefetchDistances[i18] = i26;
                    i18++;
                }
            }
            Arrays.sort(this.mPrefetchDistances, 0, i18);
            for (int i27 = 0; i27 < i18 && this.mLayoutState.hasMore(state); i27++) {
                layoutPrefetchRegistry.addPosition(this.mLayoutState.mCurrentPosition, this.mPrefetchDistances[i27]);
                LayoutState layoutState2 = this.mLayoutState;
    ...
    View findFirstVisibleItemClosestToEnd(boolean z16) {
        int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        View view = null;
        for (int childCount = getChildCount() - 1; childCount >= 0; childCount--) {
    ...
    View findFirstVisibleItemClosestToStart(boolean z16) {
        int startAfterPadding = this.mPrimaryOrientation.getStartAfterPadding();
        int endAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
        int childCount = getChildCount();
        View view = null;
    ...
    */
    ...
    public View onFocusSearchFailed(View view, int i3, RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        boolean z18 = layoutParams.mFullSpan;
        ...
        if (!z18 && (focusableViewAfter = span.getFocusableViewAfter(firstChildPosition, convertFocusDirectionToLayoutDirection)) != null && focusableViewAfter != findContainingItemView) {
        ...
        boolean z19 = !this.mReverseLayout;
        if (convertFocusDirectionToLayoutDirection == -1) {
            z16 = true;
        } else {
            z16 = false;
        ...
        if (preferLastSpan(convertFocusDirectionToLayoutDirection)) {
            for (int i18 = this.mSpanCount - 1; i18 >= 0; i18--) {
                if (i18 != span.mIndex) {
                    if (z17) {
                        findLastPartiallyVisibleItemPosition2 = this.mSpans[i18].findFirstPartiallyVisibleItemPosition();
                    } else {
                        findLastPartiallyVisibleItemPosition2 = this.mSpans[i18].findLastPartiallyVisibleItemPosition();
                    }
    ...
    public void onInitializeAccessibilityNodeInfoForItem(RecyclerView.Recycler recycler, RecyclerView.State state, View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
        ...
        if (this.mOrientation == 0) {
            ...
            accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(spanIndex, i3, -1, -1, false, false));
            return;
        }
        ...
        accessibilityNodeInfoCompat.setCollectionItemInfo(AccessibilityNodeInfoCompat.CollectionItemInfoCompat.obtain(-1, -1, spanIndex2, i3, false, false));
    }
    ...
    void prepareLayoutStateForDelta(int i3, RecyclerView.State state) {
        int firstChildPosition;
        int i16;
        if (i3 > 0) {
            firstChildPosition = getLastChildPosition();
    ...
    */
    private void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state, boolean z16) {
        ...
        boolean z17 = true;
        boolean z18 = (anchorInfo.mValid && this.mPendingScrollPosition == -1 && this.mPendingSavedState == null) ? false : true;
        if (z18) {
            anchorInfo.reset();
            if (this.mPendingSavedState != null) {
        ...
        if (getChildCount() > 0 && ((savedState = this.mPendingSavedState) == null || savedState.mSpanOffsetsSize < 1)) {
            ...
            } else if (!z18 && this.mAnchorInfo.mSpanReferenceLines != null) {
                for (int i17 = 0; i17 < this.mSpanCount; i17++) {
                    Span span = this.mSpans[i17];
                    span.clear();
                    span.setLine(this.mAnchorInfo.mSpanReferenceLines[i17]);
                }
            } else {
                for (int i18 = 0; i18 < this.mSpanCount; i18++) {
                    this.mSpans[i18].cacheReferenceLineAndClear(this.mShouldReverseLayout, anchorInfo.mOffset);
                }
    ...
    public class Span {
        ...
        int findOnePartiallyOrCompletelyVisibleChild(int i3, int i16, boolean z16, boolean z17, boolean z18) {
            int i17;
            boolean z19;
            ...
            while (i3 != i16) {
                ...
                boolean z26 = false;
                if (!z18 ? decoratedStart < endAfterPadding : decoratedStart <= endAfterPadding) {
                    z19 = true;
                } else {
                    z19 = false;
                }
        ...
        int findOnePartiallyVisibleChild(int i3, int i16, boolean z16) {
            return findOnePartiallyOrCompletelyVisibleChild(i3, i16, false, false, z16);
        }

        int findOneVisibleChild(int i3, int i16, boolean z16) {
            return findOnePartiallyOrCompletelyVisibleChild(i3, i16, z16, true, false);
        }
