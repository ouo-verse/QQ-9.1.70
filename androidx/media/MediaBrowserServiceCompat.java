...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    public class ConnectionRecord implements IBinder.DeathRecipient {
        ...
        ConnectionRecord(String str, int i3, int i16, Bundle bundle, ServiceCallbacks serviceCallbacks) {
            this.pkg = str;
            this.pid = i3;
            this.uid = i16;
            this.browserInfo = new MediaSessionManager.RemoteUserInfo(str, i3, i16);
    ...
    class MediaBrowserServiceImplApi21 implements MediaBrowserServiceImpl {
        ...
        class MediaBrowserServiceApi21 extends MediaBrowserService {
            ...
            public MediaBrowserService.BrowserRoot onGetRoot(String str, int i3, Bundle bundle) {
                ...
                BrowserRoot onGetRoot = mediaBrowserServiceImplApi21.onGetRoot(str, i3, bundle2);
                if (onGetRoot == null) {
                    return null;
                }
        ...
        public BrowserRoot onGetRoot(String str, int i3, Bundle bundle) {
            ...
            if (bundle != null && bundle.getInt(MediaBrowserProtocol.EXTRA_CLIENT_VERSION, 0) != 0) {
                ...
                i16 = bundle.getInt(MediaBrowserProtocol.EXTRA_CALLING_PID, -1);
                bundle.remove(MediaBrowserProtocol.EXTRA_CALLING_PID);
            } else {
                bundle2 = null;
            }
            ConnectionRecord connectionRecord = new ConnectionRecord(str, i16, i3, bundle, null);
    ...
    public static class ResultWrapper<T> {
        ...
        public void sendResult(T t16) {
            if (t16 instanceof List) {
                this.mResultFwk.sendResult(parcelListToItemList((List) t16));
                return;
            }
            if (t16 instanceof Parcel) {
                Parcel parcel = (Parcel) t16;
                parcel.setDataPosition(0);
    ...
    private class ServiceBinderImpl {
        ...
        public void connect(final String str, final int i3, final int i16, final Bundle bundle, final ServiceCallbacks serviceCallbacks) {
            if (MediaBrowserServiceCompat.this.isValidPackage(str, i16)) {
                MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.1
                    ...
                    public void run() {
                        ...
                        ConnectionRecord connectionRecord = new ConnectionRecord(str, i3, i16, bundle, serviceCallbacks);
                        MediaBrowserServiceCompat mediaBrowserServiceCompat = MediaBrowserServiceCompat.this;
                        mediaBrowserServiceCompat.mCurConnection = connectionRecord;
                        BrowserRoot onGetRoot = mediaBrowserServiceCompat.onGetRoot(str, i16, bundle);
        ...
        public void registerCallbacks(final ServiceCallbacks serviceCallbacks, final String str, final int i3, final int i16, final Bundle bundle) {
            MediaBrowserServiceCompat.this.mHandler.postOrRun(new Runnable() { // from class: androidx.media.MediaBrowserServiceCompat.ServiceBinderImpl.6
                ...
                public void run() {
                    ...
                    if (connectionRecord == null) {
                        connectionRecord = new ConnectionRecord(str, i3, i16, bundle, serviceCallbacks);
                    }
    ...
    boolean isValidPackage(String str, int i3) {
        if (str == null) {
            return false;
        }
    ...
    public static class Result<T> {
        ...
        private void checkExtraFields(@Nullable Bundle bundle) {
            if (bundle != null && bundle.containsKey(MediaBrowserCompat.EXTRA_DOWNLOAD_PROGRESS)) {
                float f16 = bundle.getFloat(MediaBrowserCompat.EXTRA_DOWNLOAD_PROGRESS);
                if (f16 < -1.0E-5f || f16 > 1.00001f) {
        ...
        public void sendResult(@Nullable T t16) {
            if (!this.mSendResultCalled && !this.mSendErrorCalled) {
        ...
        void onResultSent(@Nullable T t16) {
        }
    }
