...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static void setForceLegacyBehavior(boolean z16) {
        sForceLegacyBehavior = z16;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static int toVolumeStreamType(boolean z16, int i3, int i16) {
        if ((i3 & 1) == 1) {
            if (z16) {
                return 1;
            }
        ...
        switch (i16) {
            ...
            default:
                ...
                throw new IllegalArgumentException("Unknown usage value " + i16 + " in audio attributes");
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setContentType(int i3) {
            this.mBuilderImpl.setContentType(i3);
            return this;
        }

        public Builder setFlags(int i3) {
            this.mBuilderImpl.setFlags(i3);
            return this;
        }

        public Builder setLegacyStreamType(int i3) {
            this.mBuilderImpl.setLegacyStreamType(i3);
            return this;
        }

        public Builder setUsage(int i3) {
            this.mBuilderImpl.setUsage(i3);
            return this;
        }
