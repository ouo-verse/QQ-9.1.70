...
public final class CoroutineLiveDataKt$addDisposableSource$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super EmittedSource>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            this.$this_addDisposableSource.addSource(this.$source, new Observer<Object>() { // from class: androidx.lifecycle.CoroutineLiveDataKt$addDisposableSource$2.1
                @Override // androidx.lifecycle.Observer
                public final void onChanged(T t16) {
                    CoroutineLiveDataKt$addDisposableSource$2.this.$this_addDisposableSource.setValue(t16);
                }
            });
