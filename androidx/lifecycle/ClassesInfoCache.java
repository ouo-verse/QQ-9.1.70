...
final class ClassesInfoCache {
    ...
    public static final class MethodReference {
        ...
        MethodReference(int i3, Method method) {
            this.mCallType = i3;
            this.mMethod = method;
        ...
        void invokeCallback(LifecycleOwner lifecycleOwner, Lifecycle.Event event, Object obj) {
            try {
                ...
                throw new RuntimeException("Failed to call observer method", e17.getCause());
            }
        }
    }
    ...
    private CallbackInfo createInfo(Class<?> cls, @Nullable Method[] methodArr) {
        ...
        this.mHasLifecycleMethods.put(cls, Boolean.valueOf(z16));
        return callbackInfo;
    }
    ...
    private Method[] getDeclaredMethods(Class<?> cls) {
        try {
            ...
            throw new IllegalArgumentException("The observer class has some methods that use newer APIs which are not available in the current OS version. Lifecycles cannot access even other methods so you should make sure that your observer classes only access framework classes that are available in your min API level OR use lifecycle:compiler annotation processor.", e16);
        }
    }
