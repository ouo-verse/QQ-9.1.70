...
public class AnimationHandler {
    ...
    private boolean isCallbackDue(AnimationFrameCallback animationFrameCallback, long j3) {
        Long l3 = this.mDelayedCallbackStartTime.get(animationFrameCallback);
        if (l3 == null) {
            return true;
        }
        if (l3.longValue() < j3) {
    ...
    public void addAnimationFrameCallback(AnimationFrameCallback animationFrameCallback, long j3) {
        ...
        if (j3 > 0) {
            this.mDelayedCallbackStartTime.put(animationFrameCallback, Long.valueOf(SystemClock.uptimeMillis() + j3));
        }
    }

    void doAnimationFrame(long j3) {
