...
class AndroidResources {
    ...
    static final int[] STYLEABLE_VECTOR_DRAWABLE_TYPE_ARRAY = {16842755, R.attr.tint, R.attr.height, R.attr.width, R.attr.alpha, R.attr.autoMirrored, R.attr.tintMode, R.attr.viewportWidth, R.attr.viewportHeight};
    static final int[] STYLEABLE_VECTOR_DRAWABLE_GROUP = {16842755, R.attr.pivotX, R.attr.pivotY, R.attr.scaleX, R.attr.scaleY, R.attr.rotation, R.attr.translateX, R.attr.translateY};
    static final int[] STYLEABLE_VECTOR_DRAWABLE_PATH = {16842755, R.attr.fillColor, R.attr.pathData, R.attr.strokeColor, R.attr.strokeWidth, R.attr.trimPathStart, R.attr.trimPathEnd, R.attr.trimPathOffset, R.attr.strokeLineCap, R.attr.strokeLineJoin, R.attr.strokeMiterLimit, R.attr.strokeAlpha, R.attr.fillAlpha, R.attr.fillType};
    static final int[] STYLEABLE_VECTOR_DRAWABLE_CLIP_PATH = {16842755, R.attr.pathData, R.attr.fillType};
    static final int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE = {R.attr.drawable};
    static final int[] STYLEABLE_ANIMATED_VECTOR_DRAWABLE_TARGET = {16842755, R.attr.animation};
