...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public void setAutoMirrored(boolean z16) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAutoMirrored(z16);
        }
    }
    ...
    public boolean setVisible(boolean z16, boolean z17) {
        ...
        this.mAnimatedVectorState.mVectorDrawable.setVisible(z16, z17);
    ...
    AnimatedVectorDrawableCompat(@Nullable Context context) {
    ...
    AnimatedVectorDrawableCompat(@Nullable Context context, @Nullable AnimatedVectorDrawableCompatState animatedVectorDrawableCompatState, @Nullable Resources resources) {
        ...
        Drawable.Callback callback = new Drawable.Callback() { // from class: androidx.vectordrawable.graphics.drawable.AnimatedVectorDrawableCompat.1
            ...
            public void scheduleDrawable(Drawable drawable, Runnable runnable, long j3) {
                AnimatedVectorDrawableCompat.this.scheduleSelf(runnable, j3);
            }
