...
public class ErrorCode {
    ...
    public static final class AdError {
        public static final int ACTION_PARAMS_ERROR = 507;
        ...
        public static final int RESP_CONTENT_ERROR = 508;
        public static final int RETRY_LOAD_SUCCESS = 506;
        public static final int RETRY_NO_FILL_ERROR = 505;
        public static final int SHIELD_SYSTEM_VERSION = 509;
    }
    ...
    public static final class OtherError {
        ...
        public static final int FLOW_AD_DATA_EMPTY_ERROR = 801;
