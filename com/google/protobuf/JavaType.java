...
public final class JavaType {
    ...
    static {
        ...
        DOUBLE = javaType5;
        JavaType javaType6 = new JavaType(AlbumSocialInfoCacheData.TYPE_ALBUM_IS_LIKED, 5, Boolean.TYPE, Boolean.class, Boolean.FALSE);
        BOOLEAN = javaType6;
    ...
    JavaType(String str, int i3, Class cls, Class cls2, Object obj) {
        this.type = cls;
        this.boxedType = cls2;
