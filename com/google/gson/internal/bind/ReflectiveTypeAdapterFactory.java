...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
        ...
        public void write(JsonWriter jsonWriter, T t16) throws IOException {
            ...
            try {
                for (BoundField boundField : this.boundFields.values()) {
                    if (boundField.writeField(t16)) {
                        jsonWriter.name(boundField.name);
                        boundField.write(jsonWriter, t16);
                    }
                }
    ...
    public static abstract class BoundField {
        ...
        protected BoundField(String str, boolean z16, boolean z17) {
            this.name = str;
            this.serialized = z16;
            this.deserialized = z17;
        }
    ...
    private BoundField createBoundField(final Gson gson, final Field field, String str, final TypeToken<?> typeToken, boolean z16, boolean z17) {
        ...
        return new BoundField(str, z16, z17) { // from class: com.google.gson.internal.bind.ReflectiveTypeAdapterFactory.1
    ...
    private Map<String, BoundField> getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls) {
        ...
        while (cls2 != Object.class) {
            ...
            while (i3 < length) {
                ...
                boolean excludeField2 = excludeField(field, z17);
                if (excludeField || excludeField2) {
                    ...
                    while (r26 < size) {
                        ...
                        Field field2 = field;
                        BoundField boundField3 = (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, TypeToken.get(resolve), z16, excludeField2));
                        if (boundField2 == null) {
    ...
    public boolean excludeField(Field field, boolean z16) {
        return excludeField(field, z16, this.excluder);
    }

    static boolean excludeField(Field field, boolean z16, Excluder excluder) {
        return (excluder.excludeClass(field.getType(), z16) || excluder.excludeField(field, z16)) ? false : true;
    }
}
