...
public final class C$Gson$Types {
    ...
    public static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            sb5.append(C$Gson$Types.typeToString(this.rawType));
            sb5.append("<");
            sb5.append(C$Gson$Types.typeToString(this.typeArguments[0]));
            for (int i3 = 1; i3 < length; i3++) {
                sb5.append(", ");
                sb5.append(C$Gson$Types.typeToString(this.typeArguments[i3]));
            }
            sb5.append(">");
            return sb5.toString();
        }
    ...
    private static Type resolve(Type type, Class<?> cls, Type type2, Collection<TypeVariable> collection) {
        ...
        if (type2 instanceof ParameterizedType) {
            ...
            boolean z16 = resolve3 != ownerType;
            Type[] actualTypeArguments = parameterizedType.getActualTypeArguments();
            int length = actualTypeArguments.length;
            for (int i3 = 0; i3 < length; i3++) {
                Type resolve4 = resolve(type, cls, actualTypeArguments[i3], collection);
            ...
            return z16 ? newParameterizedTypeWithOwner(resolve3, parameterizedType.getRawType(), actualTypeArguments) : parameterizedType;
        }
