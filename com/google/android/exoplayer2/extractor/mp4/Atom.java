...
abstract class Atom {
    ...
    public static final int TYPE_meta = Util.getIntegerCodeForString(PublicAccountMessageUtilImpl.META_NAME);
    ...
    static final class ContainerAtom extends Atom {
        ...
        public int getChildAtomOfTypeCount(int i3) {
            ...
            for (int i17 = 0; i17 < size; i17++) {
                if (this.leafChildren.get(i17).type == i3) {
                    i16++;
                }
            }
            int size2 = this.containerChildren.size();
            for (int i18 = 0; i18 < size2; i18++) {
                if (this.containerChildren.get(i18).type == i3) {
                    i16++;
                }
            }
            return i16;
        ...
        public ContainerAtom getContainerAtomOfType(int i3) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                ContainerAtom containerAtom = this.containerChildren.get(i16);
        ...
        public LeafAtom getLeafAtomOfType(int i3) {
            int size = this.leafChildren.size();
            for (int i16 = 0; i16 < size; i16++) {
                LeafAtom leafAtom = this.leafChildren.get(i16);
                if (leafAtom.type == i3) {
                    return leafAtom;
                }
            }
