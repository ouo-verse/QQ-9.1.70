...
public final class SectionReader implements TsPayloadReader {
    ...
    public void consume(ParsableByteArray parsableByteArray, boolean z16) {
        int i3;
        if (z16) {
            i3 = parsableByteArray.getPosition() + parsableByteArray.readUnsignedByte();
        } else {
            i3 = -1;
        }
        ...
        while (parsableByteArray.bytesLeft() > 0) {
            ...
            if (i16 < 3) {
                ...
                int i19 = this.bytesRead + min2;
                this.bytesRead = i19;
                int i26 = this.totalSectionLength;
                if (i19 != i26) {
                    continue;
                } else {
                    if (this.sectionSyntaxIndicator) {
                        if (Util.crc(this.sectionData.data, 0, i26, -1) != 0) {
                            this.waitingForPayloadStart = true;
                            return;
                        }
                        this.sectionData.reset(this.totalSectionLength - 4);
                    } else {
                        this.sectionData.reset(i26);
                    }
