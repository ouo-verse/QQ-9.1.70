...
public final class ExoPlayerFactory {
    ...
    @Deprecated
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int i3) {
        return newSimpleInstance(new DefaultRenderersFactory(context, drmSessionManager, i3), trackSelector, loadControl);
    }

    @Deprecated
    public static SimpleExoPlayer newSimpleInstance(Context context, TrackSelector trackSelector, LoadControl loadControl, @Nullable DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, int i3, long j3) {
        return newSimpleInstance(new DefaultRenderersFactory(context, drmSessionManager, i3, j3), trackSelector, loadControl);
    }
