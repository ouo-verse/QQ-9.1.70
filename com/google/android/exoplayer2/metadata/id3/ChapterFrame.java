...
public final class ChapterFrame extends Id3Frame {
    ...
    public ChapterFrame(String str, int i3, int i16, long j3, long j16, Id3Frame[] id3FrameArr) {
        super(ID);
        this.chapterId = str;
        this.startTimeMs = i3;
        this.endTimeMs = i16;
    ...
    public int hashCode() {
        int i3;
        int i16 = (((((((527 + this.startTimeMs) * 31) + this.endTimeMs) * 31) + ((int) this.startOffset)) * 31) + ((int) this.endOffset)) * 31;
