...
public class BetterAppBarLayout extends AppBarLayout {
    ...
    protected final class Behavior extends AppBarLayout.BaseBehavior<AppBarLayout> {
        ...
        public int getMaxDragOffset(@NotNull AppBarLayout view) {
            ...
            return BetterAppBarLayout.this.getCanCollapsedAppBar() ? super.getMaxDragOffset((Behavior) view) : -c(view);
        }
        ...
        public int getScrollRangeForDragFling(@NotNull AppBarLayout view) {
            Intrinsics.checkNotNullParameter(view, "view");
            return BetterAppBarLayout.this.getCanCollapsedAppBar() ? super.getScrollRangeForDragFling((Behavior) view) : c(view);
        }
        ...
        public boolean onStartNestedScroll(@NotNull CoordinatorLayout parent, @NotNull AppBarLayout child, @NotNull View directTargetChild, @NotNull View target, int nestedScrollAxes, int type) {
            ...
            Intrinsics.checkNotNullParameter(target, "target");
            if (BetterAppBarLayout.this.getCanCollapsedAppBar()) {
    ...
    @JvmOverloads
    public BetterAppBarLayout(@NotNull Context context) {
    ...
    public /* synthetic */ BetterAppBarLayout(Context context, AttributeSet attributeSet, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i3 & 2) != 0 ? null : attributeSet);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public BetterAppBarLayout(@NotNull Context context, @Nullable AttributeSet attributeSet) {
