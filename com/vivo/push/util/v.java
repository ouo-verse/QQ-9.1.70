...
public final class v {
    ...
    public static String b(InsideNotificationItem insideNotificationItem) {
        ...
        jSONArray.mo162put(insideNotificationItem.getTragetContent());
        jSONArray.mo162put(insideNotificationItem.getTitle());
        jSONArray.mo162put(insideNotificationItem.getContent());
        jSONArray.put(insideNotificationItem.getNotifyType());
        jSONArray.mo162put(insideNotificationItem.getPurePicUrl());
        jSONArray.mo162put(insideNotificationItem.getIconUrl());
        jSONArray.mo162put(insideNotificationItem.getCoverUrl());
        jSONArray.mo162put(insideNotificationItem.getSkipContent());
        ...
        if (insideNotificationItem.getParams() != null) {
            jSONArray.mo162put(new JSONObject(insideNotificationItem.getParams()));
        } else {
            jSONArray.mo162put("{}");
        }
        jSONArray.put(insideNotificationItem.getAppType());
        jSONArray.mo162put(insideNotificationItem.getReactPackage());
        jSONArray.put(insideNotificationItem.isShowBigPicOnMobileNet());
        jSONArray.mo162put(insideNotificationItem.getSuitReactVersion());
        jSONArray.put(insideNotificationItem.getMessageType());
        jSONArray.put(insideNotificationItem.getIsMacroReplace());
        jSONArray.mo162put(insideNotificationItem.getAdClickCheckUrl());
    ...
    public static InsideNotificationItem a(String str) {
        ...
        try {
            ...
            u.a("MessageConvertUtil", "notify msg pack to obj error", e16);
        }
