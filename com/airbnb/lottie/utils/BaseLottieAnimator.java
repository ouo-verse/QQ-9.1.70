...
public abstract class BaseLottieAnimator extends ValueAnimator {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void notifyEnd(boolean z16) {
        for (Animator.AnimatorListener animatorListener : this.listeners) {
            if (Build.VERSION.SDK_INT >= 26) {
                animatorListener.onAnimationEnd(this, z16);
            } else {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void notifyStart(boolean z16) {
        for (Animator.AnimatorListener animatorListener : this.listeners) {
            if (Build.VERSION.SDK_INT >= 26) {
                animatorListener.onAnimationStart(this, z16);
            } else {
