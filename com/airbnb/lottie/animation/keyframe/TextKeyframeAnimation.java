...
public class TextKeyframeAnimation extends KeyframeAnimation<DocumentData> {
    ...
    /* bridge */ /* synthetic */ Object getValue(Keyframe keyframe, float f16) {
        return getValue((Keyframe<DocumentData>) keyframe, f16);
    }
    ...
    @Override // com.airbnb.lottie.animation.keyframe.BaseKeyframeAnimation
    DocumentData getValue(Keyframe<DocumentData> keyframe, float f16) {
        DocumentData documentData;
        LottieValueCallback<A> lottieValueCallback = this.valueCallback;
        if (lottieValueCallback == 0) {
            if (f16 == 1.0f && (documentData = keyframe.endValue) != null) {
                return documentData;
            }
            return keyframe.startValue;
        }
        float f17 = keyframe.startFrame;
        Float f18 = keyframe.endFrame;
        float floatValue = f18 == null ? Float.MAX_VALUE : f18.floatValue();
        DocumentData documentData2 = keyframe.startValue;
        DocumentData documentData3 = documentData2;
        DocumentData documentData4 = keyframe.endValue;
        return (DocumentData) lottieValueCallback.getValueInternal(f17, floatValue, documentData3, documentData4 == null ? documentData2 : documentData4, f16, getInterpolatedCurrentKeyframeProgress(), getProgress());
    }
}
