...
public class LottieConfig {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setEnableSystraceMarkers(boolean z16) {
            this.enableSystraceMarkers = z16;
            return this;
        }
    ...
    LottieConfig(@Nullable LottieNetworkFetcher lottieNetworkFetcher, @Nullable LottieNetworkCacheProvider lottieNetworkCacheProvider, boolean z16) {
        this.networkFetcher = lottieNetworkFetcher;
