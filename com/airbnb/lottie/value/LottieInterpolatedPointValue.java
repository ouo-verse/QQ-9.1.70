...
public class LottieInterpolatedPointValue extends LottieInterpolatedValue<PointF> {
    ...
    public PointF interpolateValue(PointF pointF, PointF pointF2, float f16) {
        this.point.set(MiscUtils.lerp(pointF.x, pointF2.x, f16), MiscUtils.lerp(pointF.y, pointF2.y, f16));
        return this.point;
    }
