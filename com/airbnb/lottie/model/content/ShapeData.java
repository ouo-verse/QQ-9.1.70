...
public class ShapeData {
    ...
    public ShapeData(PointF pointF, boolean z16, List<CubicCurveData> list) {
    ...
    public void interpolateBetween(ShapeData shapeData, ShapeData shapeData2, @FloatRange(from = 0.0d, to = 1.0d) float f16) {
        boolean z16;
        ...
        setInitialPoint(MiscUtils.lerp(initialPoint.x, initialPoint2.x, f16), MiscUtils.lerp(initialPoint.y, initialPoint2.y, f16));
        for (int size3 = this.curves.size() - 1; size3 >= 0; size3--) {
            ...
            this.curves.get(size3).setControlPoint1(MiscUtils.lerp(controlPoint1.x, controlPoint12.x, f16), MiscUtils.lerp(controlPoint1.y, controlPoint12.y, f16));
            this.curves.get(size3).setControlPoint2(MiscUtils.lerp(controlPoint2.x, controlPoint22.x, f16), MiscUtils.lerp(controlPoint2.y, controlPoint22.y, f16));
            this.curves.get(size3).setVertex(MiscUtils.lerp(vertex.x, vertex2.x, f16), MiscUtils.lerp(vertex.y, vertex2.y, f16));
        }
    }
    ...
    public void setClosed(boolean z16) {
        this.closed = z16;
    }

    public void setInitialPoint(float f16, float f17) {
        if (this.initialPoint == null) {
            this.initialPoint = new PointF();
        }
        this.initialPoint.set(f16, f17);
    }
