...
public class V8TypedArray extends V8Array {
        ...
        if (i3 != 1) {
            if (i3 != 2) {
                if (i3 != 9) {
                    switch (i3) {
                        case 11:
                            return this.f32585v8.initNewV8UInt8Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
                        case 12:
                            return this.f32585v8.initNewV8UInt8ClampedArray(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
                        case 13:
                            return this.f32585v8.initNewV8Int16Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
                        case 14:
                            return this.f32585v8.initNewV8UInt16Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
                        case 15:
                            return this.f32585v8.initNewV8UInt32Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
                        case 16:
                            return this.f32585v8.initNewV8Float32Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
                        default:
                            throw new IllegalArgumentException("Cannot create a typed array of type " + V8Value.getStringRepresentation(v8ArrayData.type));
                    }
                }
                return this.f32585v8.initNewV8Int8Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
            }
            return this.f32585v8.initNewV8Float64Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
        }
        return this.f32585v8.initNewV8Int32Array(j3, v8ArrayData.buffer.objectHandle, v8ArrayData.offset, v8ArrayData.size);
    }
    ...
    public V8Value createTwin() {
        return new V8TypedArray(this.f32585v8);
    }
