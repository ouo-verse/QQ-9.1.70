...
public abstract class V8Value implements Releasable {
    ...
    public void initialize(long j3, Object obj) {
        long initNewV8Object = this.f32585v8.initNewV8Object(j3);
        this.released = false;
    ...
    public V8Value setWeak() {
        this.f32585v8.checkThread();
        this.f32585v8.checkReleased();
        this.f32585v8.v8WeakReferences.put(Long.valueOf(getHandle()), this);
        V8 v85 = this.f32585v8;
    ...
    public V8Value twin() {
        ...
        this.f32585v8.createTwin(this, createTwin);
        return createTwin;
    }

    public V8Value(V8 v85) {
        if (v85 == null) {
            this.f32585v8 = (V8) this;
        } else {
            this.f32585v8 = v85;
        }
    }
