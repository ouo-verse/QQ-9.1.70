...
public class V8Function extends V8Object {
    ...
    public Object call(V8Object v8Object, V8Array v8Array) {
        ...
        checkReleased();
        this.f32589v8.checkRuntime(v8Object);
        this.f32589v8.checkRuntime(v8Array);
        if (v8Object == null) {
            v8Object = this.f32589v8;
        }
        if (v8Array == null) {
            handle = 0;
        } else {
    ...
    protected V8Value createTwin() {
        return new V8Function(this.f32589v8);
    }
    ...
    public void initialize(long j3, Object obj) {
        ...
        long[] initNewV8Function = this.f32589v8.initNewV8Function(j3);
        this.f32589v8.createAndRegisterMethodDescriptor((JavaCallback) obj, initNewV8Function[1]);
        this.released = false;
