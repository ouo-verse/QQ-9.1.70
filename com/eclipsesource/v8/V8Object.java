...
public class V8Object extends V8Value {
    ...
    protected V8Value createTwin() {
        return new V8Object(this.f32589v8);
    }
    ...
    public V8Array executeArrayFunction(String str, V8Array v8Array) {
        ...
        this.f32589v8.checkThread();
        checkReleased();
        this.f32589v8.checkRuntime(v8Array);
        if (v8Array == null) {
            handle = 0;
        } else {
    ...
    public V8Object registerJavaMethod(JavaCallback javaCallback, String str) {
        this.f32589v8.checkThread();
        checkReleased();
        this.f32589v8.registerCallback(javaCallback, getHandle(), str);
        return this;
    }
    ...
    public String toString() {
        if (!isReleased() && !this.f32589v8.isReleased()) {
            this.f32589v8.checkThread();
            V8 v85 = this.f32589v8;
    ...
    public V8Object(V8 v85, Object obj) {
        ...
        if (v85 != null) {
            this.f32589v8.checkThread();
            initialize(this.f32589v8.getV8RuntimePtr(), obj);
        }
    }
    ...
    public Object executeJSFunction(String str, Object... objArr) {
        ...
        V8Array v8Array = new V8Array(this.f32589v8.getRuntime());
        try {
    ...
    public V8Object registerJavaMethod(JavaVoidCallback javaVoidCallback, String str) {
        this.f32589v8.checkThread();
        checkReleased();
        this.f32589v8.registerVoidCallback(javaVoidCallback, getHandle(), str);
        return this;
    }
    ...
    public V8Object registerJavaMethod(Object obj, String str, String str2, Class<?>[] clsArr, boolean z16) {
        ...
        try {
            ...
            this.f32589v8.registerCallback(obj, method, getHandle(), str2, z16);
            return this;
    ...
    public V8Object add(String str, V8Value v8Value) {
        this.f32589v8.checkThread();
        checkReleased();
        this.f32589v8.checkRuntime(v8Value);
        if (v8Value == null) {
            V8 v85 = this.f32589v8;
            v85.addNull(v85.getV8RuntimePtr(), this.objectHandle, str);
