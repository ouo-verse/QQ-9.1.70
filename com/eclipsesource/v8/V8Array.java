...
public class V8Array extends V8Object {
    ...
    protected V8Value createTwin() {
        return new V8Array(this.f32589v8);
    }
    ...
    public void initialize(long j3, Object obj) {
        long initNewV8Array = this.f32589v8.initNewV8Array(j3);
        this.released = false;
    ...
    @Override // com.eclipsesource.v8.V8Object
    public String toString() {
        if (!this.released && !this.f32589v8.isReleased()) {
    ...
    public V8Array push(Object obj) {
        ...
        if (obj instanceof V8Value) {
            this.f32589v8.checkRuntime((V8Value) obj);
        }
        if (obj == null) {
            V8 v85 = this.f32589v8;
            v85.addArrayNullItem(v85.getV8RuntimePtr(), getHandle());
