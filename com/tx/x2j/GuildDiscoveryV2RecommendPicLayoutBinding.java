...
public class GuildDiscoveryV2RecommendPicLayoutBinding extends c {

    /* renamed from: a, reason: collision with root package name */
    public ImageView f387284a;

    /* renamed from: b, reason: collision with root package name */
    public View f387285b;
    ...
    public View i(Context context) {
        ...
        this.f387284a = imageView;
        this.f387285b = imageView;
        imageView.setId(R.id.w5l);
        this.f387284a.setScaleType(ImageView.ScaleType.CENTER_CROP);
        return this.f387284a;
    }
}
