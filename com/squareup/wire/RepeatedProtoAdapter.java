...
public final class RepeatedProtoAdapter<E> extends ProtoAdapter<List<? extends E>> {
    ...
    */
    public RepeatedProtoAdapter(@NotNull ProtoAdapter<E> originalAdapter) {
        ...
        FieldEncoding fieldEncoding = originalAdapter.getFieldEncoding();
    ...
    public void encodeWithTag(@NotNull ProtoWriter writer, int tag, @Nullable List<? extends E> value) throws IOException {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            this.originalAdapter.encodeWithTag(writer, tag, value.get(i3));
        }
    }
    ...
    public int encodedSizeWithTag(int tag, @Nullable List<? extends E> value) {
        ...
        for (int i16 = 0; i16 < size; i16++) {
            i3 += this.originalAdapter.encodedSizeWithTag(tag, value.get(i16));
        }
        return i3;
    }
