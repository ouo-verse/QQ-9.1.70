...
public interface OnRemoteResponseListener extends IInterface {
    ...
    void onResponse(int i3, GameHealthData gameHealthData) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements OnRemoteResponseListener {
        ...
        /* compiled from: P */
        /* loaded from: classes2.dex */
        private static class Proxy implements OnRemoteResponseListener {
            ...
            public void onResponse(int i3, GameHealthData gameHealthData) throws RemoteException {
                ...
                try {
                    OaidMonitor.writeParcelToken(obtain, OnRemoteResponseListener.DESCRIPTOR);
                    obtain.writeInt(i3);
        ...
        public static OnRemoteResponseListener asInterface(IBinder iBinder) {
            ...
            IInterface queryLocalInterface = iBinder.queryLocalInterface(OnRemoteResponseListener.DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof OnRemoteResponseListener)) {
                return (OnRemoteResponseListener) queryLocalInterface;
            }
        ...
        public boolean onTransact(int i3, Parcel parcel, Parcel parcel2, int i16) throws RemoteException {
            ...
            if (i3 != 1598968902) {
                ...
                onResponse(parcel.readInt(), (GameHealthData) _Parcel.readTypedObject(parcel, GameHealthData.CREATOR));
