package com.qzone.misc.network.qboss.util;
...
public class JsonORM {
    ...
    private static final Map<Class, a[]> f48462a = new IdentityHashMap();
                ...
                for (a aVar : aVarArr) {
                    try {
                        ...
                        switch (i3) {
                            ...
                            case 3:
                            case 4:
                                g(i3, jSONObject, aVar.f48463a, aVar.f48465c, newInstance);
                            case 5:
                                JSONObject optJSONObject = jSONObject.optJSONObject(aVar.f48463a);
                                if (optJSONObject != null) {
                                    Field field = aVar.f48465c;
                                    field.set(newInstance, d(optJSONObject, field.getType()));
                                }
                            case 6:
                                JSONArray optJSONArray = jSONObject.optJSONArray(aVar.f48463a);
                                if (optJSONArray != null) {
                                    Class<?> componentType = aVar.f48465c.getType().getComponentType();
                                    int a16 = a(componentType);
                                    if (a16 != 0 && a16 != 1 && a16 != 2 && a16 != 3 && a16 != 4) {
                                        aVar.f48465c.set(newInstance, e(optJSONArray, componentType));
                                    } else {
                                        f(a16, optJSONArray, aVar.f48465c, newInstance);
                                    }
                                }
                                break;
                            default:
                                throw new JsonParseException("un-support type : " + aVar.f48464b);
                        }
                    } catch (IllegalAccessException e16) {
                        throw new JsonParseException("access field failed : " + aVar.f48465c.getName(), e16);
                    }
                }
                return newInstance;
            } catch (Exception e17) {
