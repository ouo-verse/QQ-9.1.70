...
public final class d extends CursorWrapper {
    ...
    public d(Cursor cursor, String str) {
        super(cursor);
        this.f46677e = str;
        AssertUtils.assertTrue(cursor != null);
    }

    private void a(Throwable th5) {
        DbCacheExceptionHandler.b().c(th5, this.f46677e);
    }
    ...
    public double getDouble(int i3) {
        try {
            return Double.parseDouble(e.f(super.getString(i3)));
        } catch (Throwable th5) {
            a(th5);
            return 0.0d;
        }
    ...
    public float getFloat(int i3) {
        try {
            return Float.parseFloat(e.f(super.getString(i3)));
        } catch (Throwable th5) {
            a(th5);
            return 0.0f;
        }
    ...
    public long getLong(int i3) {
        try {
            return Long.parseLong(e.f(super.getString(i3)));
        } catch (Throwable th5) {
            a(th5);
            return 0L;
        }
    ...
    public int getInt(int i3) {
        try {
            String f16 = e.f(super.getString(i3));
