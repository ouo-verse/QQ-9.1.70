...
public final /* data */ class IntimateUploadImageResult implements Serializable {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\t\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\t\u0010\nJ\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002R\u0014\u0010\u0007\u001a\u00020\u00068\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0007\u0010\b\u00a8\u0006\u000b"}, d2 = {"Lcom/qzone/publish/business/model/intimate/IntimateUploadImageResult$a;", "", "Lqzone/QZoneBaseMeta$StImage;", "image", "Lcom/qzone/publish/business/model/intimate/IntimateUploadImageResult;", "a", "", "serialVersionUID", "J", "<init>", "()V", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.qzone.publish.business.model.intimate.IntimateUploadImageResult$a, reason: from kotlin metadata */
    /* loaded from: classes39.dex */
    public static final class Companion {
        ...
        public final IntimateUploadImageResult a(QZoneBaseMeta$StImage image) {
            Object firstOrNull;
            ...
            IntimateUploadImageResult intimateUploadImageResult = new IntimateUploadImageResult(null, 0, 0, 0, str, str2, 15, null);
            ...
            if (qZoneBaseMeta$StPicSpecUrlEntry != null) {
                intimateUploadImageResult.setSpec(qZoneBaseMeta$StPicSpecUrlEntry.spec.get());
                String str3 = qZoneBaseMeta$StPicSpecUrlEntry.url.url.get();
                Intrinsics.checkNotNullExpressionValue(str3, "it.url.url.get()");
                intimateUploadImageResult.setUrl(str3);
                intimateUploadImageResult.setWidth(qZoneBaseMeta$StPicSpecUrlEntry.url.width.get());
                intimateUploadImageResult.setHeight(qZoneBaseMeta$StPicSpecUrlEntry.url.height.get());
            }
            return intimateUploadImageResult;
        }
    ...
    public IntimateUploadImageResult() {
    ...
    public final IntimateUploadImageResult copy(String url, int width, int height, int spec, String lloc, String sloc) {
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(lloc, "lloc");
        Intrinsics.checkNotNullParameter(sloc, "sloc");
        return new IntimateUploadImageResult(url, width, height, spec, lloc, sloc);
    }
    ...
    public String toString() {
        return "IntimateUploadImageResult(url=" + this.url + ", width=" + this.width + ", height=" + this.height + ", spec=" + this.spec + ", lloc=" + this.lloc + ", sloc=" + this.sloc + ")";
    }

    public IntimateUploadImageResult(String url, int i3, int i16, int i17, String lloc, String sloc) {
        Intrinsics.checkNotNullParameter(url, "url");
        Intrinsics.checkNotNullParameter(lloc, "lloc");
        Intrinsics.checkNotNullParameter(sloc, "sloc");
        this.url = url;
    ...
    public static /* synthetic */ IntimateUploadImageResult copy$default(IntimateUploadImageResult intimateUploadImageResult, String str, int i3, int i16, int i17, String str2, String str3, int i18, Object obj) {
        if ((i18 & 1) != 0) {
            str = intimateUploadImageResult.url;
        }
        if ((i18 & 2) != 0) {
            i3 = intimateUploadImageResult.width;
        }
        int i19 = i3;
        if ((i18 & 4) != 0) {
            i16 = intimateUploadImageResult.height;
        }
        int i26 = i16;
        if ((i18 & 8) != 0) {
            i17 = intimateUploadImageResult.spec;
        }
        int i27 = i17;
        if ((i18 & 16) != 0) {
            str2 = intimateUploadImageResult.lloc;
        }
        String str4 = str2;
        if ((i18 & 32) != 0) {
            str3 = intimateUploadImageResult.sloc;
        }
        return intimateUploadImageResult.copy(str, i19, i26, i27, str4, str3);
    }
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof IntimateUploadImageResult)) {
            return false;
        }
        IntimateUploadImageResult intimateUploadImageResult = (IntimateUploadImageResult) other;
        return Intrinsics.areEqual(this.url, intimateUploadImageResult.url) && this.width == intimateUploadImageResult.width && this.height == intimateUploadImageResult.height && this.spec == intimateUploadImageResult.spec && Intrinsics.areEqual(this.lloc, intimateUploadImageResult.lloc) && Intrinsics.areEqual(this.sloc, intimateUploadImageResult.sloc);
    }

    public /* synthetic */ IntimateUploadImageResult(String str, int i3, int i16, int i17, String str2, String str3, int i18, DefaultConstructorMarker defaultConstructorMarker) {
