...
public class QZMGetFriendFeedListRequest extends QZMBaseRequest {
    private QZMomentReader$StGetFeedListReq mGetFeedListReq;
    private final int mListNum = 10;

    public QZMGetFriendFeedListRequest(QZMomentMeta$StFeed qZMomentMeta$StFeed, String str) {
    ...
    public String getCmdName() {
        return "QzoneV3Service.trpc.qz_moment.commreader.ComReader.GetFriendFeedList";
    }
