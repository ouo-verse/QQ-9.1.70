...
public class ag extends we.b<BusinessFeedData> {
    ...
    public void onInitBlock(Bundle bundle) {
        ...
        this.D = wVar;
        if (wVar == null || k0() == null) {
            return;
        }
        this.D.T1().observe(k0(), new Observer() { // from class: com.qzone.reborn.feedx.block.af
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                ag.this.r0((UIStateData) obj);
            }
        });
    }
