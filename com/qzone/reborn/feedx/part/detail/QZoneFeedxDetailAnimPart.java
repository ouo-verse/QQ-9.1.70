...
import com.qzone.reborn.feedx.util.QZoneFeedxAnimTimeParams;
...
public final class QZoneFeedxDetailAnimPart extends Part {
    ...
    private QZoneFeedxAnimTimeParams animTimeParams = new QZoneFeedxAnimTimeParams(165, 0, 55, 0);

    @Metadata(d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0003\u001a\u00020\u0002H\u0016\u00a8\u0006\u0004"}, d2 = {"com/qzone/reborn/feedx/part/detail/QZoneFeedxDetailAnimPart$b", "Landroid/view/ViewTreeObserver$OnPreDrawListener;", "", "onPreDraw", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes37.dex */
    public static final class b implements ViewTreeObserver.OnPreDrawListener {

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ View f55144d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ QZoneFeedxDetailAnimPart f55145e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ AnimationParams f55146f;

        b(View view, QZoneFeedxDetailAnimPart qZoneFeedxDetailAnimPart, AnimationParams animationParams) {
            this.f55144d = view;
            this.f55145e = qZoneFeedxDetailAnimPart;
            this.f55146f = animationParams;
        }

        @Override // android.view.ViewTreeObserver.OnPreDrawListener
        public boolean onPreDraw() {
            this.f55144d.getViewTreeObserver().removeOnPreDrawListener(this);
            QZoneFeedxDetailAnimPart qZoneFeedxDetailAnimPart = this.f55145e;
            QZoneCommonTitle qZoneCommonTitle = (QZoneCommonTitle) this.f55144d.findViewById(R.id.mz9);
            if (qZoneCommonTitle == null) {
                return true;
            }
            qZoneFeedxDetailAnimPart.mTitleView = qZoneCommonTitle;
            RFWLog.d("QZoneFeedxDetailAnimPart", RFWLog.USR, "source: " + this.f55146f.getScreenX() + " " + this.f55146f.getScreenY() + " " + this.f55146f.getWidthSource() + " " + this.f55146f.getHeightSource());
            this.f55145e.C9(this.f55146f);
            this.f55145e.D9();
            return false;
        }
    }
    ...
    public final void D9() {
        RFWLog.d("QZoneFeedxDetailAnimPart", RFWLog.USR, "cur clipBounds: " + this.startClipBounds);
        ...
        com.qzone.reborn.feedx.util.s.e(partRootView, pair, pair2, TuplesKt.to(valueOf3, valueOf4), TuplesKt.to(Float.valueOf(this.startTranslationY), valueOf4), TuplesKt.to(this.startClipBounds, this.endClipBounds), TuplesKt.to(valueOf4, valueOf2), this.animTimeParams, new Function0<Unit>() { // from class: com.qzone.reborn.feedx.part.detail.QZoneFeedxDetailAnimPart$startOpenAnim$1
        ...
        }, new Function0<Unit>() { // from class: com.qzone.reborn.feedx.part.detail.QZoneFeedxDetailAnimPart$startOpenAnim$2
            ...
            public final void invoke2() {
                ...
                QZoneFeedxDetailAnimPart.this.needFinishAnim = true;
            }
        });
    }
    ...
    public final void C9(AnimationParams source) {
        ...
        RFWLog.d("QZoneFeedxDetailAnimPart", RFWLog.USR, "cur offsetY: " + height);
    ...
    private final void E9() {
        ...
        com.qzone.reborn.feedx.util.s.e(partRootView, pair, pair2, pair3, pair4, pair5, pair6, (r33 & 64) != 0 ? new QZoneFeedxAnimTimeParams(0L, 0L, 0L, 0L, 15, null) : a16, (r33 & 128) != 0 ? null : null, (r33 & 256) != 0 ? null : new Function0<Unit>() { // from class: com.qzone.reborn.feedx.part.detail.QZoneFeedxDetailAnimPart$startReverseAnim$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
            ...
            /* renamed from: invoke, reason: avoid collision after fix types in other method */
            public final void invoke2() {
                Activity activity = QZoneFeedxDetailAnimPart.this.getActivity();
                if (activity != null) {
                    activity.finish();
                }
                Activity activity2 = QZoneFeedxDetailAnimPart.this.getActivity();
                if (activity2 != null) {
