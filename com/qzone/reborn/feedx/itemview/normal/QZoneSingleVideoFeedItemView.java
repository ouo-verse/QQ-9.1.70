...
public class QZoneSingleVideoFeedItemView extends QZoneBaseVideoFeedItemView {
    public QZoneSingleVideoFeedItemView(Context context) {
        super(context);
    }
    ...
    protected String getTAG() {
        return "QZoneSingleVideoFeedItemView";
    }
