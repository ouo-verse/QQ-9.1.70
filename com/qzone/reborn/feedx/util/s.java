...
/* compiled from: P */
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0007\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0002\b\u0007\u001a\u00b2\u0001\u0010\u0010\u001a\u00020\r*\u0004\u0018\u00010\u00002\u0012\u0010\u0003\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0012\u0010\u0005\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0012\u0010\u0006\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0012\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u00070\u00012\u0012\u0010\t\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\b\b\u0002\u0010\u000b\u001a\u00020\n2\u0010\b\u0002\u0010\u000e\u001a\n\u0012\u0004\u0012\u00020\r\u0018\u00010\f2\u0010\b\u0002\u0010\u000f\u001a\n\u0012\u0004\u0012\u00020\r\u0018\u00010\f\u001a \u0010\u0012\u001a\u00020\u0002*\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00020\u00012\u0006\u0010\u0011\u001a\u00020\u0002H\u0002\u001a \u0010\u0013\u001a\u00020\u0007*\u000e\u0012\u0004\u0012\u00020\u0007\u0012\u0004\u0012\u00020\u00070\u00012\u0006\u0010\u0011\u001a\u00020\u0002H\u0002\u00a8\u0006\u0014"}, d2 = {"Landroid/view/View;", "Lkotlin/Pair;", "", BasicAnimation.KeyPath.SCALE_X, BasicAnimation.KeyPath.SCALE_Y, "translationX", "translationY", "Landroid/graphics/Rect;", "clipBounds", com.tencent.luggage.wxa.c8.c.f123400v, "Lcom/qzone/reborn/feedx/util/p;", "animTimeParams", "Lkotlin/Function0;", "", "onAnimationStart", "onAnimationEnd", "e", "v", "c", "d", "qzone_df_impl_release"}, k = 2, mv = {1, 7, 1})
/* loaded from: classes37.dex */
public final class s {

    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001a\u0010\u0007\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016J\u0012\u0010\b\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0016\u00a8\u0006\t"}, d2 = {"com/qzone/reborn/feedx/util/s$a", "Landroid/animation/AnimatorListenerAdapter;", "Landroid/animation/Animator;", "animation", "", "isReverse", "", "onAnimationStart", "onAnimationEnd", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes37.dex */
    public static final class a extends AnimatorListenerAdapter {

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f55780d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Function0<Unit> f55781e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ View f55782f;

        a(Function0<Unit> function0, Function0<Unit> function02, View view) {
            this.f55780d = function0;
            this.f55781e = function02;
            this.f55782f = view;
        }

        @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animation) {
            Function0<Unit> function0 = this.f55781e;
            if (function0 != null) {
                function0.invoke();
            }
            View view = this.f55782f;
            if (view == null) {
                return;
            }
        ...
        public void onAnimationStart(Animator animation, boolean isReverse) {
            Function0<Unit> function0 = this.f55780d;
            if (function0 != null) {
                function0.invoke();
            }
        }
    ...
    public static final void e(final View view, final Pair<Float, Float> scaleX, final Pair<Float, Float> scaleY, final Pair<Float, Float> translationX, final Pair<Float, Float> translationY, final Pair<Rect, Rect> clipBounds, final Pair<Float, Float> alpha, QZoneFeedxAnimTimeParams animTimeParams, Function0<Unit> function0, Function0<Unit> function02) {
        ...
        if (z16) {
            ...
            ofFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.qzone.reborn.feedx.util.q
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    s.g(view, clipBounds, scaleX, scaleY, translationX, translationY, valueAnimator);
                }
            });
            ofFloat.setDuration(animTimeParams.getTotalDuration());
            ofFloat.setStartDelay(animTimeParams.getTotalStartDelay());
            ValueAnimator ofFloat2 = ValueAnimator.ofFloat(0.0f, 1.0f);
            ofFloat2.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.qzone.reborn.feedx.util.r
                @Override // android.animation.ValueAnimator.AnimatorUpdateListener
                public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                    s.h(view, alpha, valueAnimator);
                }
            });
