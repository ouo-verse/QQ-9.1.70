...
public final class ak extends com.qzone.reborn.base.k implements l9.b {
    ...
    public List<Class<? extends Section<CommonGridItemData>>> B4() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(com.qzone.reborn.albumx.qzonex.section.albumdetail.r.class);
    ...
    public List<Class<? extends Section<CommonGridItemData>>> K2() {
        List<Class<? extends Section<CommonGridItemData>>> mutableListOf;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(com.qzone.reborn.albumx.qzonex.section.albumdetail.a.class);
        return mutableListOf;
    }
    ...
    public List<Class<? extends Section<CommonGridItemData>>> r6() {
        List<Class<? extends Section<CommonGridItemData>>> mutableListOf;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(com.qzone.reborn.albumx.qzonex.section.albumdetail.h.class);
        return mutableListOf;
    }
}
