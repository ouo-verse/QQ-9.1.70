...
import com.qzone.reborn.albumx.qzonex.event.QZAlbumxLayerDeleteImageEvent;
...
public final class p extends b implements SimpleEventReceiver<QZAlbumxDeleteMediaEvent> {
    ...
    private final void D9(QZAlbumxDeleteMediaEvent event) {
    ...
    private final void E9(ArrayList<bb.a> mediaList, ArrayList<String> feedIdList, ArrayList<String> batchList) {
        ...
        simpleEventBus.dispatchEvent(new QZAlbumxLayerDeleteImageEvent(z16, str2, str3, mediaList.get(0).getCom.tencent.mobileqq.profilecard.bussiness.qzone.BaseProfileQZoneComponent.KEY_IS_VIDEO java.lang.String(), mediaList.get(0).getLLoc()));
    }

    @Override // com.tencent.biz.richframework.eventbus.SimpleEventReceiver
    public ArrayList<Class<QZAlbumxDeleteMediaEvent>> getEventClass() {
        ArrayList<Class<QZAlbumxDeleteMediaEvent>> arrayList = new ArrayList<>();
        arrayList.add(QZAlbumxDeleteMediaEvent.class);
        return arrayList;
    }
    ...
    public void onReceiveEvent(SimpleBaseEvent event) {
        if (event instanceof QZAlbumxDeleteMediaEvent) {
            QZAlbumxDeleteMediaEvent qZAlbumxDeleteMediaEvent = (QZAlbumxDeleteMediaEvent) event;
            D9(qZAlbumxDeleteMediaEvent);
            E9(qZAlbumxDeleteMediaEvent.getDeleteList(), qZAlbumxDeleteMediaEvent.getFeedList(), qZAlbumxDeleteMediaEvent.getBatchList());
        }
    }
}
