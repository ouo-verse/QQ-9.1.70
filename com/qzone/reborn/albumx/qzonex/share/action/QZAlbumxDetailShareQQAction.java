...
/* compiled from: P */
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010!\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \u00192\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u001aB\u0007\u00a2\u0006\u0004\b\u0017\u0010\u0018J\u0018\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u001e\u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\f\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\bH\u0002J\u000e\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\r0\fH\u0016J\b\u0010\u0010\u001a\u00020\u000fH\u0016J\u0018\u0010\u0011\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016J\"\u0010\u0016\u001a\u00020\u00062\u0006\u0010\u0012\u001a\u00020\r2\u0006\u0010\u0013\u001a\u00020\r2\b\u0010\u0015\u001a\u0004\u0018\u00010\u0014H\u0016\u00a8\u0006\u001b"}, d2 = {"Lcom/qzone/reborn/albumx/qzonex/share/action/QZAlbumxDetailShareQQAction;", "Lcom/qzone/reborn/albumx/common/share/a;", "Lic/b;", "shareContext", "Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;", PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME, "", DomainData.DOMAIN_NAME, "", "Lcom/qzone/reborn/albumx/common/convert/bean/CommonStUser;", "friends", "l", "", "", "c", "Lcom/qzone/reborn/albumx/common/share/QQShareActionManager$ShareLine;", "b", QCircleScheme.AttrQQPublish.INPUT_TAB_MAGIC_STUDIO, "requestCode", QzoneIPCModule.RESULT_CODE, "Landroid/content/Intent;", "data", h.F, "<init>", "()V", "e", "a", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes37.dex */
public final class QZAlbumxDetailShareQQAction extends a<b> {
    /* JADX INFO: Access modifiers changed from: private */
    public final void l(b shareContext, List<CommonStUser> friends) {
        if (friends.isEmpty()) {
            QLog.w("QZAlbumxDetailShareQQAction", 1, "[dealPermission] friends is empty");
            return;
        }
    ...
    private final void n(final b shareContext, ShareActionSheetBuilder.ActionSheetItem item) {
        ...
        shareApi.e(activity, arkShareParams, 1001, new ResultReceiver(handler) { // from class: com.qzone.reborn.albumx.qzonex.share.action.QZAlbumxDetailShareQQAction$shareToQQ$2
            @Override // android.os.ResultReceiver
            protected void onReceiveResult(int resultCode, Bundle resultData) {
                Intrinsics.checkNotNullParameter(resultData, "resultData");
                QLog.w("QZAlbumxDetailShareQQAction", 1, "[registerForwardResultReceiver] onReceiveResult");
                ...
                QZAlbumxDetailShareQQAction.this.l(shareContext, arrayList);
            }
    ...
    public void a(b shareContext, ShareActionSheetBuilder.ActionSheetItem item) {
        ...
        QLog.i("QZAlbumxDetailShareQQAction", 2, "share clicked");
        if (shareContext.getCom.tencent.mobileqq.winkreport.datong.WinkPublishMediaRecord.WINK_REPORT_TYPE_ACTIVITY java.lang.String() == null) {
            QLog.e("QZAlbumxDetailShareQQAction", 1, "doAction activity null");
        } else {
            n(shareContext, item);
        }
    }
