...
public final class v extends c implements RFWGalleryViewPager.OnItemLongClickListener {
    ...
    private final void H9() {
        fo.c.n(this.shareIcon, "em_qz_more");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void I9(v this$0, View view) {
    ...
    public void onInitView(View rootView) {
        ...
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener() { // from class: com.qzone.reborn.feedpro.layer.part.u
