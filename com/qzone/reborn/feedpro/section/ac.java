...
public final class ac extends ne.a {
    ...
    public static final void F(ac this$0, View view) {
    ...
    protected void x(CommonFeed feedData) {
        ...
        if (qZoneRichTextView != null) {
            qZoneRichTextView.setOnClickListener(new View.OnClickListener() { // from class: com.qzone.reborn.feedpro.section.ab
