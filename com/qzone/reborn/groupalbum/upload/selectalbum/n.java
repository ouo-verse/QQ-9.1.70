...
/* compiled from: P */
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u000b\u0018\u0000  2\u00020\u0001:\u0001!B\u0007\u00a2\u0006\u0004\b\u001e\u0010\u001fJX\u0010\u0010\u001a\u00020\u000f2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\b\u0010\u0006\u001a\u0004\u0018\u00010\u00022\u001a\u0010\n\u001a\u0016\u0012\u0004\u0012\u00020\b\u0018\u00010\u0007j\n\u0012\u0004\u0012\u00020\b\u0018\u0001`\t2\b\u0010\u000b\u001a\u0004\u0018\u00010\u00022\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000e\u001a\u00020\fH\u0002J\b\u0010\u0011\u001a\u00020\u0002H\u0016J\u000e\u0010\u0014\u001a\u00020\u000f2\u0006\u0010\u0013\u001a\u00020\u0012J\b\u0010\u0015\u001a\u00020\fH\u0016J\u0010\u0010\u0016\u001a\u00020\u000f2\u0006\u0010\u000e\u001a\u00020\fH\u0014R$\u0010\u001d\u001a\u00020\u00172\u0006\u0010\u0018\u001a\u00020\u00178\u0006@BX\u0086.\u00a2\u0006\f\n\u0004\b\u0019\u0010\u001a\u001a\u0004\b\u001b\u0010\u001c\u00a8\u0006\""}, d2 = {"Lcom/qzone/reborn/groupalbum/upload/selectalbum/n;", "Lcom/qzone/reborn/albumx/common/viewmodel/l;", "", "traceId", "", "retCode", "errMsg", "Ljava/util/ArrayList;", "Lcom/tencent/qqnt/kernel/nativeinterface/AlbumInfo;", "Lkotlin/collections/ArrayList;", "albumList", "attachInfo", "", "hasMore", QFSSearchBaseRequest.EXTRA_KEY_IS_LOAD_MORE, "", "b2", "getLogTag", "Landroid/content/Intent;", "intent", "c2", "Q1", "W1", "Lcom/qzone/reborn/groupalbum/upload/selectalbum/GroupUploadSelectAlbumInitBean;", "<set-?>", UserInfo.SEX_FEMALE, "Lcom/qzone/reborn/groupalbum/upload/selectalbum/GroupUploadSelectAlbumInitBean;", ICustomDataEditor.STRING_ARRAY_PARAM_2, "()Lcom/qzone/reborn/groupalbum/upload/selectalbum/GroupUploadSelectAlbumInitBean;", "initBean", "<init>", "()V", "G", "a", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes37.dex */
public final class n extends com.qzone.reborn.albumx.common.viewmodel.l {

    /* renamed from: F, reason: from kotlin metadata */
    private GroupUploadSelectAlbumInitBean initBean;
    ...
    public static final void d2(NTGetAlbumListReq request, final n this$0, final boolean z16, final NTGetAlbumListRsp nTGetAlbumListRsp) {
        Intrinsics.checkNotNullParameter(request, "$request");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        int i3 = nTGetAlbumListRsp.result;
        v.a(i3 == 0, 2, i3, System.currentTimeMillis() - request.requestTimeLine.requestInvokeTime, nTGetAlbumListRsp.traceId);
        RFWThreadManager.getUIHandler().post(new Runnable() { // from class: com.qzone.reborn.groupalbum.upload.selectalbum.m
            @Override // java.lang.Runnable
            public final void run() {
                n.e2(n.this, nTGetAlbumListRsp, z16);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void e2(n this$0, NTGetAlbumListRsp nTGetAlbumListRsp, boolean z16) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        String str = nTGetAlbumListRsp.traceId;
        Intrinsics.checkNotNullExpressionValue(str, "response.traceId");
        this$0.b2(str, nTGetAlbumListRsp.result, nTGetAlbumListRsp.errMs, nTGetAlbumListRsp.albumList, nTGetAlbumListRsp.attachInfo, nTGetAlbumListRsp.hasMore, z16);
    }
    ...
    protected void W1(final boolean isLoadMore) {
        ...
        nTGetAlbumListReq.qunId = a2().getGroupId();
        ...
        if (b16 != null) {
            b16.getAlbumList(nTGetAlbumListReq, new IAlbumServiceGetAlbumListCallback() { // from class: com.qzone.reborn.groupalbum.upload.selectalbum.l
                ...
                public final void onGetAlbumList(NTGetAlbumListRsp nTGetAlbumListRsp) {
                    n.d2(NTGetAlbumListReq.this, this, isLoadMore, nTGetAlbumListRsp);
                }
            });
        }
    }

    public final GroupUploadSelectAlbumInitBean a2() {
        GroupUploadSelectAlbumInitBean groupUploadSelectAlbumInitBean = this.initBean;
        if (groupUploadSelectAlbumInitBean != null) {
            return groupUploadSelectAlbumInitBean;
        }
    ...
    public final void c2(Intent intent) {
        ...
        Intrinsics.checkNotNull(serializableExtra, "null cannot be cast to non-null type com.qzone.reborn.groupalbum.upload.selectalbum.GroupUploadSelectAlbumInitBean");
        this.initBean = (GroupUploadSelectAlbumInitBean) serializableExtra;
    }

    @Override // com.qzone.reborn.albumx.common.viewmodel.l, com.tencent.biz.richframework.part.BaseViewModel
    public String getLogTag() {
        return "GroupUploadSelectAlbumViewModel";
    }
}
