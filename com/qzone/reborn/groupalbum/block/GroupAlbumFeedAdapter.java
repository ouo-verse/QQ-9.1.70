...
/* compiled from: P */
@Metadata(d1 = {"\u0000J\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0011\u0012\b\u0010\u000f\u001a\u0004\u0018\u00010\u000e\u00a2\u0006\u0004\b\u001e\u0010\u001fJ\u0018\u0010\b\u001a\u00020\u00072\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0006\u001a\u00020\u0005H\u0016J\u0018\u0010\f\u001a\u00020\u000b2\u0006\u0010\t\u001a\u00020\u00072\u0006\u0010\n\u001a\u00020\u0005H\u0016J\b\u0010\r\u001a\u00020\u0005H\u0016J\u0012\u0010\u0010\u001a\u00020\u000b2\b\u0010\u000f\u001a\u0004\u0018\u00010\u000eH\u0016J\u0012\u0010\u0013\u001a\u00020\u000b2\b\u0010\u0012\u001a\u0004\u0018\u00010\u0011H\u0016J\u0012\u0010\u0014\u001a\u00020\u000b2\b\u0010\u0012\u001a\u0004\u0018\u00010\u0011H\u0016J\b\u0010\u0015\u001a\u00020\u0005H\u0016J\u0010\u0010\u0016\u001a\u00020\u00052\u0006\u0010\n\u001a\u00020\u0005H\u0016J\u0010\u0010\u0019\u001a\n\u0012\u0004\u0012\u00020\u0018\u0018\u00010\u0017H\u0014R\u0018\u0010\u001d\u001a\u0004\u0018\u00010\u001a8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u001b\u0010\u001c\u00a8\u0006 "}, d2 = {"Lcom/qzone/reborn/groupalbum/block/GroupAlbumFeedAdapter;", "Lwe/b;", "Lcom/qzone/proxy/feedcomponent/model/BusinessFeedData;", "Landroid/view/ViewGroup;", HippyNestedScrollComponent.PRIORITY_PARENT, "", "viewType", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "onCreateItemViewHolder", "holder", "position", "", "onBindViewHolder", "getItemCount", "Landroid/os/Bundle;", "initParams", "onInitBlock", "Lcom/tencent/biz/richframework/part/block/base/LoadInfo;", "loadInfo", "loadData", "loadMoreData", "getViewTypeCount", "getItemViewType", "", "Lhh/b;", "l0", "Lcom/qzone/reborn/groupalbum/viewmodel/z;", "D", "Lcom/qzone/reborn/groupalbum/viewmodel/z;", "mFeedViewModel", "<init>", "(Landroid/os/Bundle;)V", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes37.dex */
public final class GroupAlbumFeedAdapter extends we.b<BusinessFeedData> {

    /* renamed from: D, reason: from kotlin metadata */
    private z mFeedViewModel;

    public GroupAlbumFeedAdapter(Bundle bundle) {
        super(bundle);
    }
    ...
    public void loadData(LoadInfo loadInfo) {
        ...
        SimpleEventBus.getInstance().dispatchEvent(new GroupAlbumFeedTabRefreshEvent(2));
    }
    ...
    public void onInitBlock(Bundle initParams) {
        ...
        z zVar2 = (z) getViewModel(z.class);
        this.mFeedViewModel = zVar2;
        if (zVar2 == null || k0() == null || (zVar = this.mFeedViewModel) == null || (d26 = zVar.d2()) == null) {
            return;
        }
        LifecycleOwner k06 = k0();
        Intrinsics.checkNotNull(k06);
        final Function1<UIStateData<List<? extends BusinessFeedData>>, Unit> function1 = new Function1<UIStateData<List<? extends BusinessFeedData>>, Unit>() { // from class: com.qzone.reborn.groupalbum.block.GroupAlbumFeedAdapter$onInitBlock$1
            ...
            public final void invoke2(UIStateData<List<BusinessFeedData>> listUIStateData) {
                ...
                GroupAlbumFeedAdapter.this.o0();
            }
        };
        d26.observe(k06, new Observer() { // from class: com.qzone.reborn.groupalbum.block.a
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                GroupAlbumFeedAdapter.r0(Function1.this, obj);
            }
        });
    }
}
