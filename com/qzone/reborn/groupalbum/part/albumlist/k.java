...
public final class k extends com.qzone.reborn.base.k implements l9.d {
    ...
    public List<Class<? extends Section<CommonAlbumListBean>>> Q8() {
        ...
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(si.a.class);
    ...
    public List<Class<? extends Section<CommonAlbumListBean>>> W8() {
        List<Class<? extends Section<CommonAlbumListBean>>> mutableListOf;
        mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(si.c.class, si.b.class);
        return mutableListOf;
    }
}
