...
public final class u extends com.qzone.reborn.albumx.common.layer.part.c<GroupAlbumLayerExtraInfoBean> {
    ...
    public void onInitView(View rootView) {
        ...
        View findViewById = view2.findViewById(R.id.n0k);
        if (findViewById != null) {
            findViewById.setVisibility(8);
        }
        imageView.setOnClickListener(new View.OnClickListener() { // from class: com.qzone.reborn.groupalbum.layer.part.t
