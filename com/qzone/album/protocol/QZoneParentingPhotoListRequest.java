...
public class QZoneParentingPhotoListRequest extends AbsCompatRequest<a> {
    private static final String FIELD_CMD = "getParentPhotoList";
    private static final String TAG = "QZoneParentingPhotoListRequest";
    ...
    public QZoneParentingPhotoListRequest(long j3, String str, String str2, String str3, Map<Integer, String> map, int i3, int i16) {
        super(FIELD_CMD);
        super.setHostUin(j3);
        get_parenting_photo_list_req get_parenting_photo_list_reqVar = new get_parenting_photo_list_req();
        get_parenting_photo_list_reqVar.uin = j3;
        ...
        get_parenting_photo_list_reqVar.type = i16;
        this.req = get_parenting_photo_list_reqVar;
        this.mAlbumType = i3;
    }
    ...
    public a onJceRespParse(JceStruct jceStruct) throws Exception {
        ...
        if (QZLog.isColorLevel()) {
            QZLog.d(TAG, 4, "onRefreshParentingPhotoListResponse ");
        }
        if (!(jceStruct instanceof get_parenting_photo_list_rsp)) {
            return null;
        }
        get_parenting_photo_list_rsp get_parenting_photo_list_rspVar = (get_parenting_photo_list_rsp) jceStruct;
        a aVar = new a();
        aVar.f43960b = get_parenting_photo_list_rspVar.hasmore == 1;
        boolean z16 = !TextUtils.isEmpty(((get_parenting_photo_list_req) this.req).attach_info);
        aVar.f43964f = com.qzone.album.base.Service.a.a1(get_parenting_photo_list_rspVar.features);
        ...
        if (album != null) {
            ...
            albumCacheData = AlbumCacheData.createFromResponse(album, get_parenting_photo_list_rspVar.busi_param);
            if (!z16) {
                albumCacheData.setAlbumThemeTypeValue(this.mAlbumType);
                albumCacheData.setTimeLineList(get_parenting_photo_list_rspVar.timeline, get_parenting_photo_list_rspVar.attach_info, get_parenting_photo_list_rspVar.busi_param);
                albumCacheData.setTimeEventList(get_parenting_photo_list_rspVar.timeevent);
            }
            albumCacheData.photoSearchStatus = get_parenting_photo_list_rspVar.photo_search_status;
            if (QZLog.isColorLevel()) {
        ...
        if (z16) {
            aVar.f43966h = get_parenting_photo_list_rspVar.busi_param;
        } else if (album != null) {
        ...
        aVar.f43965g = get_parenting_photo_list_rspVar.attach_info;
        aVar.f43963e = new ArrayList<>();
        ArrayList<s_picdata> arrayList = get_parenting_photo_list_rspVar.photolist;
        if (arrayList != null) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                ...
                if (s_picdataVar != null) {
                    aVar.f43963e.add(PhotoCacheData.createFromResponse(s_picdataVar, get_parenting_photo_list_rspVar.albuminfo));
                }
            }
            if (QZLog.isColorLevel()) {
        ...
        s_outshare s_outshareVar = get_parenting_photo_list_rspVar.shareinfo;
        if (s_outshareVar != null) {
            aVar.f43962d = AlbumDataOutShare.createFrom(s_outshareVar);
        }
        aVar.f43967i = new ArrayList<>();
        RecommendPhotos recommendPhotos = get_parenting_photo_list_rspVar.recommend_photos;
        if (recommendPhotos != null) {
            ...
            RecommendPhotos recommendPhotos3 = get_parenting_photo_list_rspVar.recommend_photos;
    ...
    public QZoneParentingPhotoListRequest(long j3, String str, String str2, String str3, Map<Integer, String> map, int i3, int i16, BannerAttachInfo bannerAttachInfo) {
        super(FIELD_CMD);
        super.setHostUin(j3);
        get_parenting_photo_list_req get_parenting_photo_list_reqVar = new get_parenting_photo_list_req();
        get_parenting_photo_list_reqVar.uin = j3;
        ...
        get_parenting_photo_list_reqVar.busi_param = map;
        get_parenting_photo_list_reqVar.type = i16;
        get_parenting_photo_list_reqVar.banner_attach_info = bannerAttachInfo;
        this.req = get_parenting_photo_list_reqVar;
        this.mAlbumType = i3;
    }
}
