...
public final class ZPlanMaintainingFrameLayout extends FrameLayout {
    ...
    public ZPlanMaintainingFrameLayout(Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        this.mShowedGender = (short) -1;
        LayoutInflater.from(context).inflate(R.layout.hmj, this);
        e();
        d();
    }
    ...
    private final short b() {
        ...
        Manager manager = waitAppRuntime.getManager(QQManagerFactory.FRIENDS_MANAGER);
        Intrinsics.checkNotNull(manager, "null cannot be cast to non-null type com.tencent.mobileqq.app.FriendsManager");
        Card t16 = ((FriendsManager) manager).t(waitAppRuntime.getCurrentAccountUin());
        if (t16 != null) {
            return t16.shGender;
        }
        return (short) -1;
    ...
    private final void f(View view, int viewWidth, int viewHeight) {
        ...
        float intValue = r0.intValue() - (f16 + (800 * min));
    ...
    private final void g(final View view) {
        if (view.getWidth() != 0 && view.getHeight() != 0) {
            ...
            this.mOnPreDrawListener = new ViewTreeObserver.OnPreDrawListener() { // from class: kp.b
    ...
    private final void e() {
        ...
        try {
            ...
            obtain.mFailedDrawable = drawable;
            Unit unit = Unit.INSTANCE;
            imageView.setBackground(URLDrawable.getDrawable("https://static-res.qq.com/static-res/zplan/maintenance/zplan_stop_service_backgroud.png", obtain));
