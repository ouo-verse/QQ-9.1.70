...
public final class ZPlanGuideFrameLayout extends FrameLayout {
    ...
    public ZPlanGuideFrameLayout(Context context) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        LayoutInflater.from(context).inflate(R.layout.hmi, this);
        d();
        b();
    }

    private final void b() {
        LottieHelper.b(BaseApplication.getContext(), "zplan/qzone_zplan_guide_lottie.json", null, 20, 20, -1, new LottieHelper.d() { // from class: kp.a
