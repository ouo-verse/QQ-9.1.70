...
public class GreaterThanHandler extends AbstractHanlder {
    ...
    protected boolean canHandle(ConditionItem conditionItem) {
        ...
        if (Operator.GT == conditionItem.getOperator()) {
            return true;
        }
        return false;
    }
    ...
    protected boolean doHandle(ConditionItem conditionItem, Fact fact) {
        ...
        if (fact.getValue() == null || Integer.parseInt(fact.getValue().toString()) <= Integer.parseInt(conditionItem.getValue().toString())) {
            return false;
        }
        return true;
    }
