...
@DebugMetadata(c = "com.tencent.sqshow.zootopia.friendsdressup.filament.FilamentAnimHelper$loadFemaleInitAnim$2$initAnimFemaleActionJob$1", f = "FriendsDressUpAnimHelper.kt", i = {}, l = {216}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes34.dex */
final class FilamentAnimHelper$loadFemaleInitAnim$2$initAnimFemaleActionJob$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAction>, Object> {
    ...
    public FilamentAnimHelper$loadFemaleInitAnim$2$initAnimFemaleActionJob$1(FilamentAnimHelper filamentAnimHelper, Ref.ObjectRef<String> objectRef, Continuation<? super FilamentAnimHelper$loadFemaleInitAnim$2$initAnimFemaleActionJob$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new FilamentAnimHelper$loadFemaleInitAnim$2$initAnimFemaleActionJob$1(this.this$0, this.$errorMsg, continuation);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAction> continuation) {
        return ((FilamentAnimHelper$loadFemaleInitAnim$2$initAnimFemaleActionJob$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
