...
public abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    private int f372321l;

    /* renamed from: m, reason: collision with root package name */
    private int f372322m;

    public HeaderScrollingViewBehavior() {
        this.f372319j = new Rect();
        this.f372320k = new Rect();
        this.f372321l = 0;
    }
    ...
    protected void layoutChild(CoordinatorLayout coordinatorLayout, View view, int i3) {
        ...
        if (findFirstDependency != null) {
            ...
            this.f372321l = rect2.top - findFirstDependency.getBottom();
            return;
        }
