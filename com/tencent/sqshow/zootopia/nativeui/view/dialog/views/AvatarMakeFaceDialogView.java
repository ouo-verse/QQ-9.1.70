...
public final class AvatarMakeFaceDialogView extends BaseSubPanelDialogView implements SimpleEventReceiver<SwitchAvatarViewportEvent>, z94.a, r {
    ...
    private n74.i binding;

    public /* synthetic */ AvatarMakeFaceDialogView(Context context, AttributeSet attributeSet, int i3, com.tencent.sqshow.zootopia.nativeui.data.j jVar, int i16, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private final void T() {
        ...
        AvatarPanelAllData value;
        com.tencent.sqshow.zootopia.nativeui.data.repo.i dataController = this.channel.getDataController();
        av faceEditorCfg = (dataController == null || (b16 = dataController.b()) == null || (value = b16.getValue()) == null) ? null : value.getFaceEditorCfg();
    ...
    private final void X() {
        ...
        ViewGroup.LayoutParams layoutParams = iVar.f419349c.getLayoutParams();
        ...
        this.channel.Y(true);
        n74.i iVar3 = this.binding;
        if (iVar3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
            iVar3 = null;
        }
        iVar3.f419350d.g(this.channel);
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        this.faceItemAdapter = new com.tencent.sqshow.zootopia.nativeui.view.customerface.g(context, this.channel);
        n74.i iVar4 = this.binding;
        if (iVar4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("binding");
        } else {
            iVar2 = iVar4;
        }
        ZPlanAverageLinearLayout zPlanAverageLinearLayout = iVar2.f419348b;
        com.tencent.sqshow.zootopia.nativeui.view.customerface.g gVar = this.faceItemAdapter;
    ...
    public boolean a() {
        ...
        Context context = getContext();
        Intrinsics.checkNotNullExpressionValue(context, "context");
        makeFaceExitHelper.c(jVar, context, new Function1<Boolean, Unit>() { // from class: com.tencent.sqshow.zootopia.nativeui.view.dialog.views.AvatarMakeFaceDialogView$handleBackEvent$1
            ...
            public final void invoke(boolean z16) {
                ...
                mChannel = AvatarMakeFaceDialogView.this.getMChannel();
                if (mChannel.getNativeViewMode() == AvatarNativeViewMode.ONLY_MAKE_FACE) {
                    AvatarMakeFaceDialogView.this.V();
                    mChannel2 = AvatarMakeFaceDialogView.this.getMChannel();
                ...
                AvatarMakeFaceDialogView.this.o();
            }
        });
        return true;
    }
    ...
    protected View m() {
        Y();
        n74.i g16 = n74.i.g(LayoutInflater.from(getContext()));
    ...
    public void onReceiveEvent(SimpleBaseEvent event) {
        QLog.d("AvatarMakeFaceDialogView", 1, "onReceiveEvent:" + event);
        if (event instanceof SwitchAvatarViewportEvent) {
            int viewportType = ((SwitchAvatarViewportEvent) event).getViewportType();
            QLog.d("AvatarMakeFaceDialogView", 1, "targetType:" + viewportType);
            if (viewportType == 1) {
                o();
            }
        }
    ...
    public AvatarMakeFaceDialogView(final Context context, AttributeSet attributeSet, int i3, com.tencent.sqshow.zootopia.nativeui.data.j channel) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<Float>() { // from class: com.tencent.sqshow.zootopia.nativeui.view.dialog.views.AvatarMakeFaceDialogView$VIEW_HEIGHT$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final Float invoke() {
                float f16;
                float coerceAtLeast;
                f16 = AvatarMakeFaceDialogView.this.MAKE_FACE_PERCENT;
                coerceAtLeast = RangesKt___RangesKt.coerceAtLeast(f16 * u.INSTANCE.b(context), AvatarMakeFaceDialogView.this.getResources().getDimension(R.dimen.f11103v));
