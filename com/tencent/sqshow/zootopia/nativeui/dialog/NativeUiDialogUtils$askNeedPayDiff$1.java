...
public final class NativeUiDialogUtils$askNeedPayDiff$1 extends Lambda implements Function0<Unit> {
    ...
    public NativeUiDialogUtils$askNeedPayDiff$1(Context context, int i3, int i16, Function1<? super Boolean, Unit> function1, com.tencent.sqshow.zootopia.nativeui.data.j jVar) {
        super(0);
    ...
    public static final void f(com.tencent.sqshow.zootopia.nativeui.data.j channel, Context context, QQCustomDialog qQCustomDialog, DialogInterface dialogInterface) {
        ...
        TextView btnLeft = qQCustomDialog.getBtnLeft();
        Intrinsics.checkNotNullExpressionValue(btnLeft, "dialog.btnLeft");
        mReporter2.g(btnLeft, "em_zplan_coin_insufficient_win_close", (r16 & 4) != 0 ? null : null, (r16 & 8) != 0 ? true : true, (r16 & 16) != 0 ? null : null, (r16 & 32) != 0 ? false : false);
        ZplanViewReportHelper mReporter3 = channel.getReporter().getMReporter();
        TextView btnight = qQCustomDialog.getBtnight();
        Intrinsics.checkNotNullExpressionValue(btnight, "dialog.btnight");
        mReporter3.g(btnight, "em_zplan_coin_insufficient_win_confirm", (r16 & 4) != 0 ? null : null, (r16 & 8) != 0 ? true : true, (r16 & 16) != 0 ? null : null, (r16 & 32) != 0 ? false : false);
    }
    ...
    public final void invoke2() {
        ...
        final QQCustomDialog createCustomDialog = DialogUtil.createCustomDialog(this.$context, 0, (String) null, resources.getString(R.string.xsb, Integer.valueOf(this.$currentGoldCoin), Integer.valueOf(this.$diffGoldCoin)), 0, 0, (DialogInterface.OnClickListener) null, (DialogInterface.OnClickListener) null);
        ...
        createCustomDialog.setNegativeButton(string, new DialogInterface.OnClickListener() { // from class: com.tencent.sqshow.zootopia.nativeui.dialog.a
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
                NativeUiDialogUtils$askNeedPayDiff$1.d(Function1.this, jVar, createCustomDialog, dialogInterface, i3);
            }
        });
        ...
        createCustomDialog.setPositiveButton(string2, color, new DialogInterface.OnClickListener() { // from class: com.tencent.sqshow.zootopia.nativeui.dialog.b
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
                NativeUiDialogUtils$askNeedPayDiff$1.e(Function1.this, jVar2, createCustomDialog, dialogInterface, i3);
            }
        });
        final com.tencent.sqshow.zootopia.nativeui.data.j jVar3 = this.$channel;
        final Context context = this.$context;
        createCustomDialog.setOnShowListener(new DialogInterface.OnShowListener() { // from class: com.tencent.sqshow.zootopia.nativeui.dialog.c
            @Override // android.content.DialogInterface.OnShowListener
            public final void onShow(DialogInterface dialogInterface) {
                NativeUiDialogUtils$askNeedPayDiff$1.f(com.tencent.sqshow.zootopia.nativeui.data.j.this, context, createCustomDialog, dialogInterface);
            }
        });
