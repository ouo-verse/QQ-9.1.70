...
public final /* data */ class StickerFrameConfig implements Parcelable {
    ...
    public static final class a implements Parcelable.Creator<StickerFrameConfig> {
        ...
        public final StickerFrameConfig createFromParcel(@NotNull Parcel parcel) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
                return (StickerFrameConfig) iPatchRedirector.redirect((short) 3, (Object) this, (Object) parcel);
            }
        ...
        public final StickerFrameConfig[] newArray(int i3) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
                return (StickerFrameConfig[]) iPatchRedirector.redirect((short) 2, (Object) this, i3);
            }
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(59853);
    ...
    public /* synthetic */ StickerFrameConfig(float f16, float f17, float f18, float f19, float f26, float f27, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? 0.0f : f16, (i3 & 2) != 0 ? 0.0f : f17, (i3 & 4) != 0 ? 0.0f : f18, (i3 & 8) != 0 ? 0.2f : f19, (i3 & 16) != 0 ? 10.0f : f26, (i3 & 32) != 0 ? 0.4f : f27);
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
            return;
        }
        iPatchRedirector.redirect((short) 2, this, Float.valueOf(f16), Float.valueOf(f17), Float.valueOf(f18), Float.valueOf(f19), Float.valueOf(f26), Float.valueOf(f27), Integer.valueOf(i3), defaultConstructorMarker);
    }
}
