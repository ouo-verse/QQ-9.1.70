...
import com.tencent.icgame.trpc.yes.common.YoloRoomOuterClass$YoloRoomForbiddenSpeechAction;
...
/* compiled from: P */
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\r\u001a\u00020\f\u0012\n\b\u0002\u0010\u000f\u001a\u0004\u0018\u00010\u000e\u0012\b\b\u0002\u0010\u0011\u001a\u00020\u0010\u00a2\u0006\u0004\b\u0012\u0010\u0013J\u001a\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0014R\u0014\u0010\u000b\u001a\u00020\b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\t\u0010\n\u00a8\u0006\u0014"}, d2 = {"Lcom/tencent/icgame/game/component/chat/message/ForbiddenSystemMessageItemView;", "Lcom/tencent/icgame/game/component/chat/message/CenterMessageView;", "Lcom/tencent/icgame/game/tim/api/message/a;", "msg", "Lcom/tencent/icgame/trpc/yes/common/CommonOuterClass$QQUserId;", "selfUserId", "", "i", "Landroid/widget/TextView;", "I", "Landroid/widget/TextView;", "forbiddenTv", "Landroid/content/Context;", "ctx", "Landroid/util/AttributeSet;", "attr", "", "def", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class ForbiddenSystemMessageItemView extends CenterMessageView {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001J\u0012\u0010\u0005\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0016J\u001a\u0010\n\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\b\u0010\t\u001a\u0004\u0018\u00010\bH\u0016\u00a8\u0006\u000b"}, d2 = {"com/tencent/icgame/game/component/chat/message/ForbiddenSystemMessageItemView$a", "Lcom/tencent/timi/game/utils/IResultListener;", "Lcom/tencent/icgame/game/userinfo/api/IUserInfo;", ITVKPlayerEventListener.KEY_USER_INFO, "", "a", "", "errorCode", "", "errorMessage", "onError", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes7.dex */
    public static final class a implements IResultListener<IUserInfo> {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ YoloRoomOuterClass$YoloRoomForbiddenSpeechAction f114928a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ ForbiddenSystemMessageItemView f114929b;
        ...
        a(YoloRoomOuterClass$YoloRoomForbiddenSpeechAction yoloRoomOuterClass$YoloRoomForbiddenSpeechAction, ForbiddenSystemMessageItemView forbiddenSystemMessageItemView) {
            this.f114928a = yoloRoomOuterClass$YoloRoomForbiddenSpeechAction;
            this.f114929b = forbiddenSystemMessageItemView;
        }
        ...
        public void onSuccess(@Nullable IUserInfo userInfo) {
            ...
            String str2;
            if (userInfo != null) {
                str = userInfo.h(this.f114928a.user_id.get());
            } else {
                str = null;
            }
            if (this.f114928a.second.get() != 0) {
                str2 = "\u4e3b\u6301\u4eba\u7981\u8a00" + str + cy0.c.e(this.f114928a.second.get());
            } else {
                str2 = "\u4e3b\u6301\u4eba\u89e3\u9664\u4e86\u5bf9" + str + "\u7684\u7981\u8a00";
            }
            this.f114929b.forbiddenTv.setText(str2);
        }

        @Override // com.tencent.timi.game.utils.IResultListener
        public void onError(int errorCode, @Nullable String errorMessage) {
            com.tencent.icgame.game.utils.g.d("ForbiddenSystemMessageItemView", "getUserInfoFromDBOrNet failed: errorCode == " + errorCode + ",errorMessage == " + errorMessage);
        }
    }
    ...
    public void i(@NotNull com.tencent.icgame.game.tim.api.message.a msg2, @Nullable CommonOuterClass$QQUserId selfUserId) {
        ...
        if (yoloRoomOuterClass$YoloRoomAction != null && (yoloRoomOuterClass$YoloRoomForbiddenSpeechAction = yoloRoomOuterClass$YoloRoomAction.yolo_room_forbidden_speech_action) != null && (yoloRoomOuterClass$YoloRoomForbiddenSpeechAction2 = yoloRoomOuterClass$YoloRoomForbiddenSpeechAction.get()) != null) {
            ...
            dVar.i0(commonOuterClass$QQUserId, new a(yoloRoomOuterClass$YoloRoomForbiddenSpeechAction2, this));
        }
    }
    ...
    public ForbiddenSystemMessageItemView(@NotNull Context ctx, @Nullable AttributeSet attributeSet, int i3) {
        ...
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-2, uu0.a.b(19));
