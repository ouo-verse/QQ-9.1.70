...
public final class QQLiveFollowRoomRequest<T> extends LiveBaseRequest<T> {
    ...
    public <T> T decode(@Nullable byte[] convertInputStreamtoByteArray) {
        try {
            ...
            a.INSTANCE.i("ICGameVSRequest|QQLiveFollowRoomRequest", "decode", "error, ", e16);
            return null;
        }
    }
