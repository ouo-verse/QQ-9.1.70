...
public class TimiNoticeEditFragment extends QPublicBaseFragment implements View.OnClickListener {
    ...
    public class b implements t22.b {
        ...
        final /* synthetic */ String f115448a;
        ...
        public void onSuccess() {
            TimiNoticeEditFragment.this.vh(this.f115448a);
            SimpleEventBus.getInstance().dispatchEvent(new UpdateNoticeEvent());
            TimiNoticeEditFragment.this.finish();
            g.h("ICGame_Notice", "getRoomAnnounce success ");
        }
    }
    ...
    private void initData() {
        ...
        this.F.postDelayed(new Runnable() { // from class: com.tencent.icgame.game.liveroom.impl.room.notice.TimiNoticeEditFragment.2
    ...
    private void th() {
        ILiveRoomOperation A;
        String obj = this.F.getText().toString();
        if (!TextUtils.isEmpty(obj) && (A = ((c) qx0.a.b(c.class)).A(this.H)) != null) {
            A.setRoomAnnounce(this.H, this.I, obj, new b(obj));
        }
    }
    ...
    public void vh(String str) {
        ...
        mVar.approved = false;
        mVar.b(false);
        com.tencent.icgame.game.liveroom.impl.room.notice.a.INSTANCE.a().d(str, 2);
        SimpleEventBus.getInstance().dispatchEvent(new NoticeCommitEvent(mVar));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void wh(String str) {
        this.E.setEnabled(uh(str));
    }
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater layoutInflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup viewGroup, @Nullable @org.jetbrains.annotations.Nullable Bundle bundle) {
        this.C = layoutInflater.inflate(R.layout.fbt, viewGroup, false);
        initIntent();
        initView();
        initListener();
        initData();
