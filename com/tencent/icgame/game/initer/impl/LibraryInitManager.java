...
/* compiled from: P */
@Metadata(d1 = {"\u0000@\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u001c\u0010\u001dJ\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0002J\b\u0010\u0006\u001a\u00020\u0004H\u0002J\b\u0010\u0007\u001a\u00020\u0004H\u0002J\u000e\u0010\n\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\bJ\u000e\u0010\u000b\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\bJ\u0006\u0010\f\u001a\u00020\u0002J\u001c\u0010\u0011\u001a\u00020\u00042\b\u0010\u000e\u001a\u0004\u0018\u00010\r2\b\u0010\u0010\u001a\u0004\u0018\u00010\u000fH\u0016R\u0016\u0010\u0015\u001a\u00020\u00128\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u0013\u0010\u0014R\u0016\u0010\u0017\u001a\u00020\u00028\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\f\u0010\u0016R \u0010\u001b\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\b0\u00190\u00188\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u0006\u0010\u001a\u00a8\u0006\u001e"}, d2 = {"Lcom/tencent/icgame/game/initer/impl/LibraryInitManager;", "Landroid/content/BroadcastReceiver;", "", "result", "", "f", "d", "e", "Lev0/c;", "listener", h.F, "i", "c", "Landroid/content/Context;", "context", "Landroid/content/Intent;", "intent", "onReceive", "", "b", "I", "status", "Z", "broadcastHasRegistered", "Ljava/util/concurrent/CopyOnWriteArrayList;", "Lmqq/util/WeakReference;", "Ljava/util/concurrent/CopyOnWriteArrayList;", "pagLibraryLoadedListenerList", "<init>", "()V", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes7.dex */
public final class LibraryInitManager extends BroadcastReceiver {

    /* renamed from: a, reason: collision with root package name */
    @NotNull
    public static final LibraryInitManager f115064a;
    ...
    @NotNull
    private static final CopyOnWriteArrayList<WeakReference<ev0.c>> pagLibraryLoadedListenerList;

    static {
        LibraryInitManager libraryInitManager = new LibraryInitManager();
        f115064a = libraryInitManager;
        status = 1;
    ...
    private final void e() {
        ...
        if (MobileQQ.sProcessId != 1) {
            ...
            if (iAEResUtil.isAEResExist(aEResInfo)) {
                QLog.i("ICGameLibraryInitManager", 1, "already download");
                f115064a.f(iVasTempApi.initPagSo());
                return;
            }
            ...
            if (Result.m482isFailureimpl(m476constructorimpl)) {
                ...
                QLog.e("ICGameLibraryInitManager", 1, "loadPagWithIPC throw e:" + str);
                return;
            }
            return;
        }
        iVasTempApi.requestPagDownload(new Function0<Unit>() { // from class: com.tencent.icgame.game.initer.impl.LibraryInitManager$loadPAGWithIPC$1
            ...
            public final void invoke2() {
                LibraryInitManager.f115064a.f(IVasTempApi.this.initPagSo());
            }
        });
    }
    ...
    public final void f(boolean result) {
        if (!result) {
            QLog.e("ICGameLibraryInitManager", 1, "PAG download failed");
            return;
        }
        status = 3;
        ...
        while (it.hasNext()) {
            ...
            k.b(new Runnable() { // from class: com.tencent.icgame.game.initer.impl.c
    ...
    public static final void g(WeakReference weakReference) {
        ev0.c cVar = (ev0.c) weakReference.get();
        if (cVar != null) {
            cVar.onLoaded();
        }
    }
    ...
    public final void h(@NotNull ev0.c listener) {
        Intrinsics.checkNotNullParameter(listener, "listener");
        i(listener);
        pagLibraryLoadedListenerList.add(new WeakReference<>(listener));
    }

    public final void i(@NotNull final ev0.c listener) {
        Intrinsics.checkNotNullParameter(listener, "listener");
        CollectionsKt__MutableCollectionsKt.removeAll((List) pagLibraryLoadedListenerList, (Function1) new Function1<WeakReference<ev0.c>, Boolean>() { // from class: com.tencent.icgame.game.initer.impl.LibraryInitManager$unregisterOnPAGLibraryLoadedListener$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(1);
            }
            ...
            @NotNull
            public final Boolean invoke(WeakReference<ev0.c> weakReference) {
                return Boolean.valueOf(Intrinsics.areEqual(weakReference.get(), ev0.c.this));
            }
        });
    }
    ...
    public void onReceive(@Nullable Context context, @Nullable Intent intent) {
        ...
        if (Intrinsics.areEqual(AECameraConstants.AE_CAMERA_RES_DOWNLOAD_FINISH_BROADCAST_ACTION, intent.getAction())) {
            ...
            QLog.i("ICGameLibraryInitManager", 1, "\u6536\u5230\u5e7f\u64ad: path = " + stringExtra + " agent = " + stringExtra2);
