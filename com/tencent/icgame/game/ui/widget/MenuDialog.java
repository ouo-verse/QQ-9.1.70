...
public class MenuDialog extends ReportDialog {
    ...
    public static class c {
        ...
        private Context f115932a;

        /* renamed from: b, reason: collision with root package name */
        private CharSequence[] f115933b;

        /* renamed from: c, reason: collision with root package name */
        private DialogInterface.OnClickListener f115934c;

        public c(Context context) {
            this.f115932a = context;
        }

        public MenuDialog a() {
            MenuDialog menuDialog = new MenuDialog(this.f115932a);
            ViewGroup viewGroup = (ViewGroup) LayoutInflater.from(this.f115932a).inflate(R.layout.fbh, (ViewGroup) null);
            menuDialog.E = (LinearLayout) viewGroup.findViewById(R.id.epy);
            float f16 = this.f115932a.getResources().getDisplayMetrics().density;
            for (int i3 = 0; i3 < this.f115933b.length; i3++) {
                TextView textView = new TextView(this.f115932a);
                ...
                textView.setText(this.f115933b[i3]);
                textView.setOnClickListener(menuDialog.F);
            }
            menuDialog.C = this.f115934c;
        ...
        public c b(CharSequence[] charSequenceArr, DialogInterface.OnClickListener onClickListener) {
            this.f115933b = charSequenceArr;
            this.f115934c = onClickListener;
            return this;
        }
    }
    ...
    public void S(final float f16, final float f17) {
        ...
        com.tencent.icgame.game.utils.k.b(new Runnable() { // from class: com.tencent.icgame.game.ui.widget.MenuDialog.3
