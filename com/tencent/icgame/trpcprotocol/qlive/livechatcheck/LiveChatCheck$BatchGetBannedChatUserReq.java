...
public final class LiveChatCheck$BatchGetBannedChatUserReq extends MessageMicro<LiveChatCheck$BatchGetBannedChatUserReq> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32}, new String[]{"roomid", "master_tinyid", "page_num", "qunatity"}, new Object[]{0L, 0L, 0, 0}, LiveChatCheck$BatchGetBannedChatUserReq.class);
