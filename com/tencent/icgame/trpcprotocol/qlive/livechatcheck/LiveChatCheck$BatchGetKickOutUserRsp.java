...
public final class LiveChatCheck$BatchGetKickOutUserRsp extends MessageMicro<LiveChatCheck$BatchGetKickOutUserRsp> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 32, 40, 48, 58}, new String[]{"roomid", "master_tinyid", "userlist", "sum", "is_end", "retcode", "msg"}, new Object[]{0L, 0L, null, 0, 0, 0, ByteStringMicro.EMPTY}, LiveChatCheck$BatchGetKickOutUserRsp.class);
    ...
    public final PBBytesField f116229msg = PBField.initBytes(ByteStringMicro.EMPTY);
}
