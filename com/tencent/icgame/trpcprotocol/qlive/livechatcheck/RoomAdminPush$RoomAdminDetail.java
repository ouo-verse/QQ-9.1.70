...
public final class RoomAdminPush$RoomAdminDetail extends MessageMicro<RoomAdminPush$RoomAdminDetail> {
    ...
    public final PBBytesField f116241face;
    ...
    static {
        String[] strArr = {"admin_uin", "admin_tinyid", "nickname", PreDetect.FACE_DETECT, "sign", "gender", "face_url"};
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 42, 48, 58}, strArr, new Object[]{0L, 0L, byteStringMicro, byteStringMicro, byteStringMicro, Boolean.FALSE, byteStringMicro}, RoomAdminPush$RoomAdminDetail.class);
    }

    public RoomAdminPush$RoomAdminDetail() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        this.nickname = PBField.initBytes(byteStringMicro);
        this.f116241face = PBField.initBytes(byteStringMicro);
