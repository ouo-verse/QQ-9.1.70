package com.tencent.icgame.api.auth.impl;

import android.content.BroadcastReceiver;
import android.content.Context;
import android.content.Intent;
import android.content.IntentFilter;
import com.tencent.icgame.api.auth.impl.QQLiveAuthCheckApiImpl;
import com.tencent.icgame.common.api.IAegisLogApi;
import com.tencent.icgame.game.initer.impl.b;
...
/* compiled from: P */
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \u00172\u00020\u0001:\u0001\u0018B\u0007\u00a2\u0006\u0004\b\u0015\u0010\u0016J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0002J\b\u0010\u0006\u001a\u00020\u0004H\u0002J\b\u0010\u0007\u001a\u00020\u0004H\u0016J\u0010\u0010\n\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\bH\u0016J\u0010\u0010\u000b\u001a\u00020\u00042\u0006\u0010\t\u001a\u00020\bH\u0016R\u0014\u0010\r\u001a\u00020\f8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\r\u0010\u000eR\u0016\u0010\u0010\u001a\u00020\u000f8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u0010\u0010\u0011R\u0016\u0010\u0013\u001a\u00020\u00128\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u0013\u0010\u0014\u00a8\u0006\u0019"}, d2 = {"Lcom/tencent/icgame/api/auth/impl/QQLiveAuthCheckApiImpl;", "Lcom/tencent/timi/game/api/auth/IQQLiveAuthCheckApi;", "Lnh2/c;", "giftSDK", "", "initGiftSdkIfNeed", "registerAccountBroadcast", "fetchAndCacheAuthState", "Lcom/tencent/timi/game/api/auth/a;", "callback", "checkAuth", "forceCheckAuth", "Lcom/tencent/icgame/common/api/IAegisLogApi;", "log", "Lcom/tencent/icgame/common/api/IAegisLogApi;", "", "localStateValid", "Z", "Lcom/tencent/timi/game/api/auth/AuthState;", "authState", "Lcom/tencent/timi/game/api/auth/AuthState;", "<init>", "()V", "Companion", "a", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class QQLiveAuthCheckApiImpl implements IQQLiveAuthCheckApi {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\b\n\u0002\b\u0004\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\n\u0010\u000bR\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0005\u0010\u0004R\u0014\u0010\u0006\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0006\u0010\u0004R\u0014\u0010\b\u001a\u00020\u00078\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\b\u0010\t\u00a8\u0006\f"}, d2 = {"Lcom/tencent/icgame/api/auth/impl/QQLiveAuthCheckApiImpl$a;", "", "", "CODE_NOT_REAL_NAME_AUTH", "I", "CODE_REAL_NAME_AUTH_OK", "CODE_REAL_NAME_AUTH_UNDER_AGE", "", "QQ_ACTION_LOGOUT", "Ljava/lang/String;", "<init>", "()V", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes7.dex */
    ...
    public static final void forceCheckAuth$lambda$1(QQLiveAuthCheckApiImpl this$0, com.tencent.timi.game.api.auth.a callback, boolean z16, int i3, String str) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(callback, "$callback");
        this$0.log.i("ICGameAuthCheckApiImpl", "checkIdentityStatus success:" + z16 + ",errorCode=" + i3 + ",errorMsg=" + str);
        ...
        this$0.log.i("ICGameAuthCheckApiImpl", "checkIdentityStatus authState " + this$0.authState);
    }

    private final void initGiftSdkIfNeed(c giftSDK) {
        if (!giftSDK.isInited() || giftSDK.isDestroyed()) {
            QLog.i("ICGameAuthCheckApiImpl", 1, "initGiftSdk isDestroyed:" + giftSDK.isDestroyed());
            b.f115068a.d(QQLiveSDKConfigHelper.getSceneId());
        }
    }
    ...
    private final void registerAccountBroadcast() {
        ...
        baseApplication.registerReceiver(new BroadcastReceiver() { // from class: com.tencent.icgame.api.auth.impl.QQLiveAuthCheckApiImpl$registerAccountBroadcast$accountBroadcast$1
            ...
            public void onReceive(@NotNull Context context, @NotNull Intent intent) {
                ...
                iAegisLogApi.i("ICGameAuthCheckApiImpl", "receive, action " + action + ", authState " + authState);
            }
        }, intentFilter);
    }
    ...
    public void checkAuth(@NotNull com.tencent.timi.game.api.auth.a callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.log.i("ICGameAuthCheckApiImpl", "checkAuth, localStateValid " + this.localStateValid + ", authState " + this.authState);
    ...
    public void fetchAndCacheAuthState() {
        ...
        forceCheckAuth(new com.tencent.timi.game.api.auth.a() { // from class: kt0.b
            @Override // com.tencent.timi.game.api.auth.a
            public final void a(AuthState authState, String str) {
                QQLiveAuthCheckApiImpl.fetchAndCacheAuthState$lambda$0(authState, str);
            }
        });
    }
    ...
    public void forceCheckAuth(@NotNull final com.tencent.timi.game.api.auth.a callback) {
        Intrinsics.checkNotNullParameter(callback, "callback");
        this.log.i("ICGameAuthCheckApiImpl", "forceCheckAuth");
        c sDKImpl = ((IQQGiftManager) QRoute.api(IQQGiftManager.class)).getSDKImpl(QQLiveSDKConfigHelper.getSceneId());
        if (sDKImpl == null) {
            this.log.e("ICGameAuthCheckApiImpl", "giftSDK is null");
            callback.a(AuthState.UNKNOWN, "giftSDK is null");
        } else {
            initGiftSdkIfNeed(sDKImpl);
            sDKImpl.e().C(new c.a() { // from class: kt0.a
                @Override // oh2.c.a
                public final void a(boolean z16, int i3, String str) {
                    QQLiveAuthCheckApiImpl.forceCheckAuth$lambda$1(QQLiveAuthCheckApiImpl.this, callback, z16, i3, str);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void fetchAndCacheAuthState$lambda$0(AuthState authState, String str) {
    }
}
