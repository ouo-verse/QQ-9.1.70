...
public final class GameDataServerOuterClass$GetAnchorLivingHeroRsp extends MessageMicro<GameDataServerOuterClass$GetAnchorLivingHeroRsp> {
    ...
    public GameDataServerOuterClass$AnchorSmobaHeroInfo hero_info = new MessageMicro<GameDataServerOuterClass$AnchorSmobaHeroInfo>() { // from class: com.tencent.icgame.trpc.yes.common.GameDataServerOuterClass$AnchorSmobaHeroInfo
        ...
        public GameDataServerOuterClass$SmobaEquipConfig equip_config = new MessageMicro<GameDataServerOuterClass$SmobaEquipConfig>() { // from class: com.tencent.icgame.trpc.yes.common.GameDataServerOuterClass$SmobaEquipConfig
        ...
        public GameDataServerOuterClass$SmobaRunePage rune_page = new MessageMicro<GameDataServerOuterClass$SmobaRunePage>() { // from class: com.tencent.icgame.trpc.yes.common.GameDataServerOuterClass$SmobaRunePage
