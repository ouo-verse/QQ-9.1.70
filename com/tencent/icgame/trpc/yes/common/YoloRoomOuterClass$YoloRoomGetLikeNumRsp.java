...
public final class YoloRoomOuterClass$YoloRoomGetLikeNumRsp extends MessageMicro<YoloRoomOuterClass$YoloRoomGetLikeNumRsp> {
    ...
    public YoloRoomOuterClass$GameResultLikeList list = new MessageMicro<YoloRoomOuterClass$GameResultLikeList>() { // from class: com.tencent.icgame.trpc.yes.common.YoloRoomOuterClass$GameResultLikeList
