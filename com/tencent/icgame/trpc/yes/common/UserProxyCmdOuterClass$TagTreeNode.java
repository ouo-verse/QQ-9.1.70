...
public final class UserProxyCmdOuterClass$TagTreeNode extends MessageMicro<UserProxyCmdOuterClass$TagTreeNode> {
    ...
    public UserProxyCmdOuterClass$TagNode root_node = new MessageMicro<UserProxyCmdOuterClass$TagNode>() { // from class: com.tencent.icgame.trpc.yes.common.UserProxyCmdOuterClass$TagNode
        static final MessageMicro.FieldMap __fieldMap__;

        /* renamed from: id, reason: collision with root package name */
        public final PBStringField f116208id = PBField.initString("");
