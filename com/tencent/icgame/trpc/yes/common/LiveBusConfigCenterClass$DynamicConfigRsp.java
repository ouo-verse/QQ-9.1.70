...
public final class LiveBusConfigCenterClass$DynamicConfigRsp extends MessageMicro<LiveBusConfigCenterClass$DynamicConfigRsp> {
    ...
    public LiveBusConfigCenterClass$FreeLove freelove = new MessageMicro<LiveBusConfigCenterClass$FreeLove>() { // from class: com.tencent.icgame.trpc.yes.common.LiveBusConfigCenterClass$FreeLove
