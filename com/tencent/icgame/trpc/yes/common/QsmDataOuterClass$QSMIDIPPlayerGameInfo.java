...
public final class QsmDataOuterClass$QSMIDIPPlayerGameInfo extends MessageMicro<QsmDataOuterClass$QSMIDIPPlayerGameInfo> {
    ...
    public QsmDataOuterClass$QSMIDIPSingleGameStatistics speed_single_game = new MessageMicro<QsmDataOuterClass$QSMIDIPSingleGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPSingleGameStatistics
    ...
    public QsmDataOuterClass$QSMIDIPSingleGameStatistics prob_single_game = new MessageMicro<QsmDataOuterClass$QSMIDIPSingleGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPSingleGameStatistics
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40}, new String[]{"match_count", "complete_count", "add_together_game_index", "max_continue_complete_count", "all_kill_count"}, new Object[]{0, 0, 0L, 0, 0}, QsmDataOuterClass$QSMIDIPSingleGameStatistics.class);
        public final PBUInt32Field match_count = PBField.initUInt32(0);
        public final PBUInt32Field complete_count = PBField.initUInt32(0);
        public final PBUInt64Field add_together_game_index = PBField.initUInt64(0);
    ...
    public QsmDataOuterClass$QSMIDIPTeamGameStatistics speed_team_game = new MessageMicro<QsmDataOuterClass$QSMIDIPTeamGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPTeamGameStatistics
    ...
    public QsmDataOuterClass$QSMIDIPTeamGameStatistics prob_team_game = new MessageMicro<QsmDataOuterClass$QSMIDIPTeamGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPTeamGameStatistics
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48}, new String[]{"match_count", "win_count", "max_continue_win_count", "mvp_count", "all_win_count", "num_1_count"}, new Object[]{0, 0, 0, 0, 0, 0}, QsmDataOuterClass$QSMIDIPTeamGameStatistics.class);
        public final PBUInt32Field match_count = PBField.initUInt32(0);
        public final PBUInt32Field win_count = PBField.initUInt32(0);
        public final PBUInt32Field max_continue_win_count = PBField.initUInt32(0);
    ...
    public QsmDataOuterClass$QSMIDIPEncounterGameStatistics encounter_speed_game = new MessageMicro<QsmDataOuterClass$QSMIDIPEncounterGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPEncounterGameStatistics
    ...
    public QsmDataOuterClass$QSMIDIPEncounterGameStatistics encounter_prob_game = new MessageMicro<QsmDataOuterClass$QSMIDIPEncounterGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPEncounterGameStatistics
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32}, new String[]{"match_count", "complete_count", "max_continue_complete_count", "team_first_count"}, new Object[]{0, 0, 0, 0}, QsmDataOuterClass$QSMIDIPEncounterGameStatistics.class);
        public final PBUInt32Field match_count = PBField.initUInt32(0);
        public final PBUInt32Field complete_count = PBField.initUInt32(0);
        public final PBUInt32Field max_continue_complete_count = PBField.initUInt32(0);
    ...
    public QsmDataOuterClass$QSMIDIPSkateSingleGameStatistics skate_single_game = new MessageMicro<QsmDataOuterClass$QSMIDIPSkateSingleGameStatistics>() { // from class: com.tencent.icgame.trpc.yes.common.QsmDataOuterClass$QSMIDIPSkateSingleGameStatistics
