...
public final class PremadesTeamServerOuterClass$SearchGamePremadesTeamReq extends MessageMicro<PremadesTeamServerOuterClass$SearchGamePremadesTeamReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24, 32, 40, 48, 56, 64, 72, 82, 90, 96}, new String[]{"origin_id", "game_mode_list", "grade_list", "lane_type_list", "page", EmotionConstants.DISPLAY_TYPE, "uid", WinkDaTongReportConstant.ElementParamKey.XSJ_USER_FROM, "game_id", "client_version", "list_param", "phone_system"}, new Object[]{"", 0, 0, 0, 0, 0, 0L, 0, 0, "", null, 0}, PremadesTeamServerOuterClass$SearchGamePremadesTeamReq.class);
    ...
    public final PBRepeatMessageField<YoloRoomOuterClass$ListParam> list_param;
    ...
    public PremadesTeamServerOuterClass$SearchGamePremadesTeamReq() {
        ...
        this.list_param = PBField.initRepeatMessage(YoloRoomOuterClass$ListParam.class);
