...
public final class TrpcUserInfoSvrOuterClass$GetUserInfoRsp extends MessageMicro<TrpcUserInfoSvrOuterClass$GetUserInfoRsp> {
    ...
    public TrpcUserInfoSvrOuterClass$UserBaseInfo user_info = new MessageMicro<TrpcUserInfoSvrOuterClass$UserBaseInfo>() { // from class: com.tencent.icgame.trpc.qlive.trpc_user_info_svr.TrpcUserInfoSvrOuterClass$UserBaseInfo
        ...
        public final PBUInt64Field f116196qq = PBField.initUInt64(0);
    };
    public TrpcUserInfoSvrOuterClass$FollowInfo follow_info = new MessageMicro<TrpcUserInfoSvrOuterClass$FollowInfo>() { // from class: com.tencent.icgame.trpc.qlive.trpc_user_info_svr.TrpcUserInfoSvrOuterClass$FollowInfo
    ...
    public TrpcUserInfoSvrOuterClass$FansGroupInfo fans_group_info = new MessageMicro<TrpcUserInfoSvrOuterClass$FansGroupInfo>() { // from class: com.tencent.icgame.trpc.qlive.trpc_user_info_svr.TrpcUserInfoSvrOuterClass$FansGroupInfo
