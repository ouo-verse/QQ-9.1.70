...
public final class ilive_user_basic_info$MedalInfo extends MessageMicro<ilive_user_basic_info$MedalInfo> {
    ...
    public final PBBytesField fans_medal_bg_img_style;
    ...
    static {
        String[] strArr = {"medal_id", "medal_name", "medal_face_small", "medal_type", "medal_start_time", "medal_end_time", "medal_priority_level", "medal_desc", "medal_url", "medal_face_bigger", "medal_version", "medal_index", "medal_level", "medal_point", AlbumCacheData.CREATE_TIME, "update_time", "medal_bg", "medal_frame", "medal_bg_img", "fans_medal_bg_img_style"};
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 40, 48, 56, 66, 74, 82, 88, 96, 104, 112, 120, 128, 136, 144, 154, 210}, strArr, new Object[]{0, byteStringMicro, byteStringMicro, 0, 0L, 0L, 0, byteStringMicro, byteStringMicro, byteStringMicro, 0, 0, 0, 0, 0L, 0L, 0, 0, byteStringMicro, byteStringMicro}, ilive_user_basic_info$MedalInfo.class);
    }
    ...
    public ilive_user_basic_info$MedalInfo() {
        ...
        this.fans_medal_bg_img_style = PBField.initBytes(byteStringMicro);
    }
}
