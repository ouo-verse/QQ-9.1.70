...
public class a {
    ...
    private static Intent b(Context context, String str, Bundle bundle, Class<? extends QQBrowserActivity> cls, int[] iArr, Integer num, String str2) {
        ...
        if (!TextUtils.isEmpty(str2)) {
            g16 = a(g16, "qqlivestream_sdk_app_id=" + str2);
        }
        intent.putExtra("url", g16);
        intent.setData(Uri.parse(g16));
        if (bundle != null) {
    ...
    private static SharedPreferences d() {
        return QMMKV.fromSpAdapter(BaseApplication.getContext(), "ICGameCommonSp", QMMKVFile.FILE_ICGAME);
    }
    ...
    private static void e() {
        ...
        QMMKV.migrate(BaseApplication.getContext(), QMMKVFile.FILE_ICGAME, BaseApplication.getContext().getSharedPreferences("ICGameCommonSp", 0));
        d16.edit().putBoolean("sp_key_has_migrate_QQLiveCommonSp", true).apply();
    }

    public static void f(Context context, String str, Bundle bundle, Class<? extends QQBrowserActivity> cls, int[] iArr, Integer num, String str2) {
    ...
    public static String g(String str) {
        ...
        if (QLog.isDevelopLevel()) {
            QLog.d("ICGameWebViewUtils", 4, "parseUrl url:" + b16);
        }
        return b16;
    }
}
