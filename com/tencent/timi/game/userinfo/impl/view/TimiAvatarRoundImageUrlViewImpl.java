...
public class TimiAvatarRoundImageUrlViewImpl extends TimiRoundImageView {
    ...
    public final void setAvatarUrl(@Nullable String url) {
        if (TextUtils.isEmpty(url)) {
            ...
            io4.b.f408106a.g(url, this, this.avatarSize);
        }
    }
