...
/* compiled from: P */
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\"\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\b\u0006\b&\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\"\u0010#J\u001c\u0010\u0006\u001a\u00020\u00052\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00030\u0002H\u0002J\u0010\u0010\b\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0003H\u0002J$\u0010\n\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00030\u00022\u0006\u0010\u0007\u001a\u00020\u00032\u0006\u0010\t\u001a\u00020\u0005H\u0002J\u0010\u0010\u000e\u001a\u00020\r2\u0006\u0010\f\u001a\u00020\u000bH\u0016J\u0014\u0010\u000f\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00030\u0002H\u0016J\u0010\u0010\u0010\u001a\u00020\u00052\u0006\u0010\u0007\u001a\u00020\u0003H\u0016J\u001c\u0010\u0011\u001a\u00020\u00052\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00030\u0002H\u0016J\u0010\u0010\u0012\u001a\u00020\r2\u0006\u0010\u0007\u001a\u00020\u0003H\u0016J\b\u0010\u0013\u001a\u00020\u0003H\u0004R\u001b\u0010\u0018\u001a\u00020\u00148BX\u0082\u0084\u0002\u00a2\u0006\f\n\u0004\b\u0013\u0010\u0015\u001a\u0004\b\u0016\u0010\u0017R!\u0010\u001c\u001a\b\u0012\u0004\u0012\u00020\u00030\u00198BX\u0082\u0084\u0002\u00a2\u0006\f\n\u0004\b\u0016\u0010\u0015\u001a\u0004\b\u001a\u0010\u001bR\u001a\u0010!\u001a\b\u0012\u0004\u0012\u00020\u001e0\u001d8$X\u00a4\u0004\u00a2\u0006\u0006\u001a\u0004\b\u001f\u0010 \u00a8\u0006$"}, d2 = {"Lcom/tencent/timi/game/api/cookie/impl/BaseCookieStrategy;", "Lcom/tencent/timi/game/api/cookie/IQQLiveCookieStrategy;", "", "", "cookies", "", "g", "domain", "f", "tbs", "e", "Lcom/tencent/timi/game/api/cookie/CookieDataCallback;", "callback", "", "buildAsync", "buildSync", "isCookieExpired", "isCookieLegal", "removeCookies", "a", "Lcom/tencent/timi/game/api/cookie/IQQLiveCookieApi;", "Lkotlin/Lazy;", "b", "()Lcom/tencent/timi/game/api/cookie/IQQLiveCookieApi;", "cookieApi", "", "d", "()Ljava/util/Set;", "cookieKeys", "", "Lcom/tencent/timi/game/api/cookie/impl/a;", "c", "()Ljava/util/List;", "cookieBuilders", "<init>", "()V", "timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
...
public abstract class BaseCookieStrategy implements IQQLiveCookieStrategy {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000!\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010$\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001c\u0010\u0006\u001a\u00020\u00052\u0012\u0010\u0004\u001a\u000e\u0012\u0004\u0012\u00020\u0003\u0012\u0004\u0012\u00020\u00030\u0002H\u0016J\u0018\u0010\n\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u00072\u0006\u0010\t\u001a\u00020\u0003H\u0016\u00a8\u0006\u000b"}, d2 = {"com/tencent/timi/game/api/cookie/impl/BaseCookieStrategy$a", "Lcom/tencent/timi/game/api/cookie/CookieDataCallback;", "", "", "cookies", "", "onSuccess", "", "code", "msg", "onFailed", "timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes26.dex */
    public static final class a implements CookieDataCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ Ref.IntRef f376269a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ HashMap<String, String> f376270b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f376271c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ CookieDataCallback f376272d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ Ref.BooleanRef f376273e;

        a(Ref.IntRef intRef, HashMap<String, String> hashMap, int i3, CookieDataCallback cookieDataCallback, Ref.BooleanRef booleanRef) {
            this.f376269a = intRef;
            this.f376270b = hashMap;
            this.f376271c = i3;
            this.f376272d = cookieDataCallback;
            this.f376273e = booleanRef;
        }

        @Override // com.tencent.timi.game.api.cookie.CookieDataCallback
        public void onFailed(int code, @NotNull String msg2) {
            Intrinsics.checkNotNullParameter(msg2, "msg");
            this.f376273e.element = true;
            this.f376272d.onFailed(code, msg2);
        }

        @Override // com.tencent.timi.game.api.cookie.CookieDataCallback
        public void onSuccess(@NotNull Map<String, String> cookies) {
            Intrinsics.checkNotNullParameter(cookies, "cookies");
            this.f376269a.element++;
            this.f376270b.putAll(cookies);
            if (this.f376269a.element >= this.f376271c) {
                this.f376272d.onSuccess(this.f376270b);
            }
        }
    }
    ...
    public BaseCookieStrategy() {
        Lazy lazy;
        Lazy lazy2;
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<IQQLiveCookieApi>() { // from class: com.tencent.timi.game.api.cookie.impl.BaseCookieStrategy$cookieApi$2
        ...
        this.cookieApi = lazy;
        lazy2 = LazyKt__LazyJVMKt.lazy(new Function0<HashSet<String>>() { // from class: com.tencent.timi.game.api.cookie.impl.BaseCookieStrategy$cookieKeys$2
    ...
    private final Map<String, String> e(String domain, boolean tbs) {
        ...
        if (QLog.isColorLevel()) {
            QLog.i("BaseCookieStrategy", 2, "tbs:" + tbs + ",domain:" + domain + ",planted cookie:" + str);
        }
        ...
        if (split$default.isEmpty()) {
            QLog.e("BaseCookieStrategy", 1, "empty cookie");
            return hashMap;
        }
        for (String str2 : split$default) {
            if (!TextUtils.isEmpty(str2)) {
                ...
                if (split$default2.size() == 2) {
                    ...
                    QLog.e("BaseCookieStrategy", 1, "illegal cookie:" + str2);
                }
            }
        }
        return hashMap;
    ...
    private final boolean f(String domain) {
        if (!isCookieLegal(e(domain, true))) {
            QLog.i("BaseCookieStrategy", 1, "tbsCookie illLegal,domain:" + domain);
            return false;
        }
        if (isCookieLegal(e(domain, false))) {
            return true;
        }
        QLog.i("BaseCookieStrategy", 1, "sysCookie illLegal,domain:" + domain);
        return false;
    }
    ...
    private final boolean g(Map<String, String> cookies) {
        for (String str : d()) {
            if (TextUtils.isEmpty(cookies.get(str))) {
                QLog.i("BaseCookieStrategy", 1, "miss cookie " + str);
                return true;
            }
        }
        return false;
    ...
    public final String a() {
        ...
        if (waitAppRuntime == null) {
            QLog.e("BaseCookieStrategy", 1, "isCookieLegal,appInterface is null");
            return "";
        }
        if (!waitAppRuntime.isLogin()) {
            QLog.e("BaseCookieStrategy", 1, "isCookieLegal,not login");
            return "";
        }
        String a16 = HttpBaseUtil.a(waitAppRuntime.getCurrentAccountUin());
    ...
    public void buildAsync(@NotNull CookieDataCallback callback) {
        ...
        for (com.tencent.timi.game.api.cookie.impl.a aVar : c()) {
    ...
    public Map<String, String> buildSync() {
        HashMap hashMap = new HashMap();
        Iterator<com.tencent.timi.game.api.cookie.impl.a> it = c().iterator();
        while (it.hasNext()) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @NotNull
    public abstract List<com.tencent.timi.game.api.cookie.impl.a> c();

    @Override // com.tencent.timi.game.api.cookie.IQQLiveCookieStrategy
    public boolean isCookieExpired(@NotNull String domain) {
        Intrinsics.checkNotNullParameter(domain, "domain");
        boolean f16 = f(domain);
        QLog.i("BaseCookieStrategy", 1, "plantedCookieLegal:" + f16);
        return !f16;
    }
