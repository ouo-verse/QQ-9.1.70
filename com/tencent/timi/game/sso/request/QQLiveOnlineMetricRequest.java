...
public final class QQLiveOnlineMetricRequest<T> extends LiveBaseRequest<T> {
    ...
    public QQLiveOnlineMetricRequest(long j3, @NotNull String reqProgramId) {
    ...
    public <T> T decode(@Nullable byte[] resBytes) {
        try {
            ...
            AegisLogger.INSTANCE.e("VSRequest|QQLiveOnlineMetricRequest", "decode", "error, ", e16);
            return null;
        }
    }
    ...
    public String getMainCmd() {
        return "trpc.qlive.room_data_svr.RoomDataSvr";
    }
    ...
    public MessageNano getMessageNano() {
        d dVar = new d();
        dVar.f408449a = this.reqRoomId;
        dVar.f408450b = this.reqProgramId;
        dVar.f408451c = new int[]{3};
        return dVar;
    }
