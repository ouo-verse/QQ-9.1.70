...
public class e extends RecyclerView.ViewHolder {
    ...
    private TeamListGiftImageView I;
    ...
    private TeamListAvatarStorkRoundImageView Q;
    private TeamListAvatarStorkRoundImageView R;
    private TeamListAvatarStorkRoundImageView S;
    private ArrayList<TeamListAvatarStorkRoundImageView> T;
    ...
    class a implements View.OnClickListener {
        ...
        final /* synthetic */ c.b f379901d;

        /* renamed from: e, reason: collision with root package name */
        final /* synthetic */ long f379902e;

        /* renamed from: f, reason: collision with root package name */
        final /* synthetic */ int f379903f;

        /* renamed from: h, reason: collision with root package name */
        final /* synthetic */ int f379904h;

        /* renamed from: i, reason: collision with root package name */
        final /* synthetic */ List f379905i;

        /* compiled from: P */
        /* renamed from: com.tencent.timi.game.teamlist.view.e$a$a, reason: collision with other inner class name */
        /* loaded from: classes26.dex */
        class C9984a implements IResultListener<YoloRoomOuterClass$YoloRoomInfo> {
            C9984a() {
            }
        ...
        public void onClick(View view) {
            ...
            if (expandHallLaunchParam != null) {
                ...
                dVar.f379329f = cVar;
                dVar.f379330g = j3;
                dVar.f379324a = this.f379902e;
                dVar.f379325b = com.tencent.timi.game.utils.b.h(expandHallLaunchParam.f376301d);
                dVar.f379326c = 1;
                dVar.f379328e = this.f379903f;
                dVar.f379327d = ((g) mm4.b.b(g.class)).h2(this.f379903f);
                dVar.f379331h = 0L;
                com.tencent.timi.game.room.impl.util.c cVar2 = new com.tencent.timi.game.room.impl.util.c();
                cVar2.f379322a = this.f379904h;
                cVar2.f379323b = this.f379905i;
                ((sm4.a) mm4.b.b(sm4.a.class)).Y2(true, vf4.a.b(), dVar, cVar2, new C9984a());
            }
    ...
    public e(@NonNull View view) {
        ...
        this.E = view;
        this.F = (RelativeLayout) view.findViewById(R.id.f930359h);
        this.G = (TextView) view.findViewById(R.id.f930459i);
        this.H = (RCImageView) view.findViewById(R.id.f930159f);
        this.I = (TeamListGiftImageView) view.findViewById(R.id.f931259q);
        this.J = (MediumBoldTextView) view.findViewById(R.id.f931759v);
        this.K = (TextView) view.findViewById(R.id.f931559t);
        this.L = (TextView) view.findViewById(R.id.f931659u);
        this.M = (TeamListAvatarStorkRoundImageView) view.findViewById(R.id.f930559j);
        this.N = (TeamListAvatarStorkRoundImageView) view.findViewById(R.id.f930659k);
        this.P = (TeamListAvatarStorkRoundImageView) view.findViewById(R.id.f930759l);
        this.Q = (TeamListAvatarStorkRoundImageView) view.findViewById(R.id.f930859m);
        this.R = (TeamListAvatarStorkRoundImageView) view.findViewById(R.id.f930959n);
        this.S = (TeamListAvatarStorkRoundImageView) view.findViewById(R.id.f931059o);
        this.T.add(this.M);
        this.T.add(this.N);
        this.T.add(this.P);
        this.T.add(this.Q);
    ...
    public void l(List<PremadesTeamServerOuterClass$YesGamePremadesTeamUserInfo> list, String str, String str2) {
        Iterator<TeamListAvatarStorkRoundImageView> it = this.T.iterator();
        while (it.hasNext()) {
            it.next().setVisibility(8);
        }
        for (int i3 = 0; i3 < list.size() && i3 < this.T.size(); i3++) {
            ...
            TeamListAvatarStorkRoundImageView teamListAvatarStorkRoundImageView = this.T.get(i3);
    ...
    public void m(YoloRoomOuterClass$YoloGiftConfig yoloRoomOuterClass$YoloGiftConfig) {
        if (yoloRoomOuterClass$YoloGiftConfig != null && yoloRoomOuterClass$YoloGiftConfig.gift_material_id.get() != 0 && yoloRoomOuterClass$YoloGiftConfig.gift_num.get() != 0) {
            ...
            this.I.setGiftInfo(yoloRoomOuterClass$YoloGiftConfig.gift_num.get(), yoloRoomOuterClass$YoloGiftConfig.gift_material_id.get());
        } else {
    ...
    public void p(int i3, float f16, float f17, String str, String str2, String str3, String str4, String str5) {
        ...
        this.H.setRadius(ViewUtils.dip2px(6.0f));
        this.H.setImageDrawable(gn4.c.b(str, drawable, f16, f17));
        Iterator<TeamListAvatarStorkRoundImageView> it = this.T.iterator();
        while (it.hasNext()) {
            it.next().setDrawable(gn4.c.a(str3, 26.0f, 26.0f));
        }
        if (!TextUtils.isEmpty(str4)) {
            this.J.setTextColor(fh4.c.a(str4));
        }
        if (!TextUtils.isEmpty(str5)) {
            this.K.setTextColor(fh4.c.a(str5));
            this.L.setTextColor(fh4.c.a(str5));
        }
    }
