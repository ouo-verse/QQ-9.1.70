...
public class b extends ReportDialog implements LifecycleOwner {
    ...
    public void dismiss() {
        if (isActivityDestroyed()) {
            com.tencent.timi.game.utils.l.e("BaseDialog", getContext() + " is finishing, can't dismiss");
            return;
        }
        if (isShowing()) {
            super.dismiss();
        } else {
            com.tencent.timi.game.utils.l.e("BaseDialog", getContext() + " not showing, can't dismiss");
        }
        List<g> list = this.C;
        if (list != null) {
            for (g gVar : list) {
    ...
    public void show() {
        if (isActivityDestroyed()) {
            com.tencent.timi.game.utils.l.e("BaseDialog", getContext() + "show() is destroyed, can't show");
            return;
        }
        if (this.E != 0 && getWindow() != null) {
