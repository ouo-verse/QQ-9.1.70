...
public class BaseSlideUpDialog extends j {
    public boolean I;
    ValueAnimator J;
    ValueAnimator K;
    private View L;
    ...
    class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            BaseSlideUpDialog.this.d0(valueAnimator);
        }
    }
    ...
    class b extends AnimatorListenerAdapter {
        ...
        public void onAnimationCancel(Animator animator) {
            ...
            baseSlideUpDialog.i0(baseSlideUpDialog.M, 0.7f);
        }
        ...
        public void onAnimationStart(Animator animator) {
            ...
            if (BaseSlideUpDialog.this.M != null) {
                BaseSlideUpDialog baseSlideUpDialog = BaseSlideUpDialog.this;
                baseSlideUpDialog.i0(baseSlideUpDialog.M, 0.0f);
    ...
    public class d implements ValueAnimator.AnimatorUpdateListener {
        ...
        final /* synthetic */ float f380072d;
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            if (!BaseSlideUpDialog.this.R) {
                BaseSlideUpDialog.this.L.setTranslationY(this.f380072d * floatValue);
            } else {
                BaseSlideUpDialog.this.L.setTranslationX(this.f380072d * floatValue);
            }
            BaseSlideUpDialog baseSlideUpDialog = BaseSlideUpDialog.this;
            baseSlideUpDialog.i0(baseSlideUpDialog.M, (1.0f - floatValue) * 0.7f);
        }
    }
    ...
    public class e extends AnimatorListenerAdapter {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ float f380074d;
        ...
        public void onAnimationCancel(Animator animator) {
            super.onAnimationCancel(animator);
            if (!BaseSlideUpDialog.this.R) {
                BaseSlideUpDialog.this.L.setTranslationY(this.f380074d);
            } else {
                BaseSlideUpDialog.this.L.setTranslationX(this.f380074d);
            }
            BaseSlideUpDialog baseSlideUpDialog = BaseSlideUpDialog.this;
            baseSlideUpDialog.i0(baseSlideUpDialog.M, 0.0f);
    ...
    public BaseSlideUpDialog(Context context) {
        ...
        com.tencent.timi.game.utils.u.c(getWindow());
    }
    ...
    public void d0(ValueAnimator valueAnimator) {
        ...
        i0(this.M, (1.0f - floatValue) * 0.7f);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void i0(View view, float f16) {
        if (view != null) {
    ...
    @Override // com.tencent.timi.game.ui.widget.b, android.app.Dialog, android.content.DialogInterface
    public void cancel() {
        super.cancel();
        dismiss();
    }
    ...
    public void show() {
        ...
        if (this.L != null && this.Q) {
            ...
            this.J.setDuration(b0());
            this.J.addUpdateListener(new a());
            this.J.addListener(new b());
            this.L.post(new Runnable() { // from class: com.tencent.timi.game.ui.widget.BaseSlideUpDialog.3
