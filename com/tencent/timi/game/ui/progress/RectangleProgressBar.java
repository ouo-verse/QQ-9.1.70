package com.tencent.timi.game.ui.progress;
...
public final class RectangleProgressBar extends View {
    ...
    protected void onDraw(@Nullable Canvas canvas) {
        ...
        if (width != 0 && height != 0 && canvas != null) {
            ...
            l.i("RectangleProgressBar_", "onDraw width:" + width + ", height:" + height + ", progress:" + this.mProgress + ", bg rectF:" + rectF);
            ...
            l.i("RectangleProgressBar_", "onDraw width:" + width + ", height:" + height + ", progress:" + this.mProgress + ", progress rectF:" + rectF2);
            return;
        }
        l.e("RectangleProgressBar_", "onDraw width or height is 0");
    }
