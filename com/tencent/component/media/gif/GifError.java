...
public class GifError {
    ...
    private static SparseArray<String> ERR_MAP = null;
    ...
    static {
        ...
        ERR_MAP = sparseArray;
        sparseArray.put(-1, ERR_MSG_DEFAULT);
    ...
    public static GifError fromCode(int i3) {
        return new GifError(i3, ERR_MAP.get(i3, ERR_MSG_DEFAULT));
    }
