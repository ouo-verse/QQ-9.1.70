...
public class LyricViewDetail extends LyricView {
    ...
    public LyricViewDetail(Context context, AttributeSet attributeSet) {
        ...
        View inflate = LayoutInflater.from(context).inflate(R.layout.fky, this);
        ...
        this.f147106d = lyricViewInternalDetail;
        lyricViewInternalDetail.l(this.f147108f);
        this.f147107e.setScrollEnable(this.f147109h);
        this.f147107e.setSeekScrollListener(((LyricViewInternalDetail) this.f147106d).f147215i1);
    }
}
