...
public final class GuildLiveSetAnnounceActionItem extends SetChosenActionItem {
    ...
    public static final class SetDialog extends BottomSheetDialogFragment {
        ...
        public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
            ...
            g16.getRoot().setBackgroundResource(R.drawable.guild_live_aio_msgmenu_bg);
            m mVar2 = this.binding;
            if (mVar2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("binding");
                mVar2 = null;
            }
            mVar2.f441978c.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.guildlive.aio.halfpop.menu.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    GuildLiveSetAnnounceActionItem.SetDialog.rh(GuildLiveSetAnnounceActionItem.SetDialog.this, view);
                }
            });
            ...
            mVar3.f441977b.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.guildlive.aio.halfpop.menu.c
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    GuildLiveSetAnnounceActionItem.SetDialog.sh(GuildLiveSetAnnounceActionItem.SetDialog.this, view);
                }
            });
    ...
    public GuildLiveSetAnnounceActionItem() {
        super(new t.ItemData(R.drawable.qui_announcement_sub_channel, R.string.f1648326w), "pg_sgrp_stream_aio");
    }
    ...
    private final boolean R() {
        return Intrinsics.areEqual(h().g().n(), com.tencent.guildlive.aio.factory.b.class.getName());
    }
    ...
    public void b(@NotNull View view, @NotNull GuildMsgItem data) {
        ...
        new SetDialog(new Function0<Unit>() { // from class: com.tencent.guildlive.aio.halfpop.menu.GuildLiveSetAnnounceActionItem$onItemClick$1
            ...
            public final void invoke2() {
                GuildLiveSetAnnounceActionItem.this.L();
            }
    ...
    public boolean a(@NotNull GuildMsgItem data) {
        long msgSeq;
        Intrinsics.checkNotNullParameter(data, "data");
        if (data.isWalletMsg() || !yr0.a.g(data)) {
            return false;
        }
        if (S(data) && !T(data)) {
            return false;
        ...
        AIOParam g18 = h().g();
        Intrinsics.checkNotNullExpressionValue(g18, "aioContext.aioParam");
        Boolean hasPermission = iQQGuildUtilApi.hasTargetSecondaryPermission(30004, g17, com.tencent.guild.aio.util.a.b(g18));
        Intrinsics.checkNotNullExpressionValue(hasPermission, "hasPermission");
        if (hasPermission.booleanValue()) {
            return true;
        }
        if (!U(data)) {
            return ((IGuildLiveChannelApi) QRoute.api(IGuildLiveChannelApi.class)).isSelfLiving();
        }
        AIOParam g19 = h().g();
        Intrinsics.checkNotNullExpressionValue(g19, "aioContext.aioParam");
        String b16 = com.tencent.guild.aio.util.a.b(g19);
        if (S(data)) {
            msgSeq = Q(data);
        } else {
            msgSeq = data.getMsgSeq();
        }
        return yr0.a.j(b16, msgSeq);
    }
}
