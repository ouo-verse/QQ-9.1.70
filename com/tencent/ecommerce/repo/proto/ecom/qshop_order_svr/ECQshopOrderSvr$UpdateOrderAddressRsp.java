...
public final class ECQshopOrderSvr$UpdateOrderAddressRsp extends MessageMicro<ECQshopOrderSvr$UpdateOrderAddressRsp> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"order_info", "order_change_refresh_msg"}, new Object[]{null, null}, ECQshopOrderSvr$UpdateOrderAddressRsp.class);
