...
public final class ECQshopOrderSvr$ConfirmReceiptRsp extends MessageMicro<ECQshopOrderSvr$ConfirmReceiptRsp> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18}, new String[]{"order_info", "order_change_refresh_msg"}, new Object[]{null, null}, ECQshopOrderSvr$ConfirmReceiptRsp.class);
