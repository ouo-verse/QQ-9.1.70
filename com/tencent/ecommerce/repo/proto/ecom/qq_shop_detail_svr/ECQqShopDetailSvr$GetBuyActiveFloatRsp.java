...
public final class ECQqShopDetailSvr$GetBuyActiveFloatRsp extends MessageMicro<ECQqShopDetailSvr$GetBuyActiveFloatRsp> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 82, 162}, new String[]{"spu_id", "biz_type", "buy_limit", "toast", "sku_infos"}, new Object[]{"", 0, null, "", null}, ECQqShopDetailSvr$GetBuyActiveFloatRsp.class);
