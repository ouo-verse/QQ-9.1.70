...
@DebugMetadata(c = "com.tencent.ecommerce.biz.commission.subsidy.ECSubsidyListViewModel$loadMoreSubsidyList$1", f = "ECSubsidyListViewModel.kt", i = {}, l = {49}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes31.dex */
public final class ECSubsidyListViewModel$loadMoreSubsidyList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    int label;
    final /* synthetic */ ECSubsidyListViewModel this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ECSubsidyListViewModel$loadMoreSubsidyList$1(ECSubsidyListViewModel eCSubsidyListViewModel, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ECSubsidyListViewModel$loadMoreSubsidyList$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ECSubsidyListViewModel$loadMoreSubsidyList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
