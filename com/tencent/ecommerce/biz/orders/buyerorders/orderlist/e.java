...
public final class e extends FragmentStateAdapter {
    ...
    public final ECOrderListFragment i0(int index) {
        Object orNull;
        orNull = CollectionsKt___CollectionsKt.getOrNull(this.fragmentList, index);
        return (ECOrderListFragment) orNull;
    }

    public final void j0(List<ECOrderListFragment> newFragmentList) {
        List<ECOrderListFragment> list = this.fragmentList;
        list.clear();
