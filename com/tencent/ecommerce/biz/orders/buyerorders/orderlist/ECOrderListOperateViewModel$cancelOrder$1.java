...
@DebugMetadata(c = "com.tencent.ecommerce.biz.orders.buyerorders.orderlist.ECOrderListOperateViewModel$cancelOrder$1", f = "ECOrderListOperateViewModel.kt", i = {1}, l = {47, 49}, m = "invokeSuspend", n = {"opResult"}, s = {"L$0"})
/* loaded from: classes31.dex */
public final class ECOrderListOperateViewModel$cancelOrder$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ECOrderListOperateViewModel$cancelOrder$1(ECOrderListOperateViewModel eCOrderListOperateViewModel, String str, String str2, OrderListScene orderListScene, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ECOrderListOperateViewModel$cancelOrder$1(this.this$0, this.$orderId, this.$token, this.$scene, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ECOrderListOperateViewModel$cancelOrder$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i3 == 0) {
            ...
            this.label = 1;
            obj = d.a.a(dVar, str2, str3, false, this, 4, null);
            ...
            if (i3 != 1) {
                if (i3 == 2) {
                    ...
                    ResultKt.throwOnFailure(obj);
                    fVar = fVar2;
                    ECOrderSpan.c(ECOrderSpan.f103884c, this.$orderId, g.a(this.$scene), ECOrderOperation.CancelOrder, fVar.requestInfo, null, 16, null);
