...
@DebugMetadata(c = "com.tencent.ecommerce.biz.orders.buyerorders.detail.domain.qshop.ECShopOrderDetailViewModel$cancelOrder$1", f = "ECShopOrderDetailViewModel.kt", i = {2}, l = {370, 374, 376}, m = "invokeSuspend", n = {"opResult"}, s = {"L$0"})
/* loaded from: classes31.dex */
public final class ECShopOrderDetailViewModel$cancelOrder$1 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
    ...
    public ECShopOrderDetailViewModel$cancelOrder$1(ECShopOrderDetailViewModel eCShopOrderDetailViewModel, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(Continuation<?> continuation) {
        return new ECShopOrderDetailViewModel$cancelOrder$1(this.this$0, this.$orderId, continuation);
    }

    @Override // kotlin.jvm.functions.Function1
    public final Object invoke(Continuation<? super Unit> continuation) {
        return ((ECShopOrderDetailViewModel$cancelOrder$1) create(continuation)).invokeSuspend(Unit.INSTANCE);
    }
        ...
        if (i3 == 0) {
            ...
            if (!(this.$orderId.length() == 0)) {
                ...
                if (!(str2.length() == 0)) {
                    ...
                    this.label = 2;
                    obj = dVar.c(str4, str3, true, this);
                    ...
                    ECOrderSpan.c(ECOrderSpan.f103884c, this.$orderId, ECOrderSpanScene.OrderDetail, ECOrderOperation.CancelOrder, fVar.requestInfo, null, 16, null);
                    return Unit.INSTANCE;
                }
            }
            o26 = this.this$0.o2(this.$orderId);
            cg0.a.a("ECShopOrderDetailViewModel", "cancelOrder", o26);
