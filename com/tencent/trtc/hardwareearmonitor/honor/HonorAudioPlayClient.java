...
public class HonorAudioPlayClient extends HonorAudioFeaturesKit {
    ...
    public void serviceInit(String str) {
        ...
        try {
            ...
            HonorLogUtils.error(TAG, "HnAudioPlayClient isSupported,RemoteException ex :" + e16.getMessage());
        }
    }
    ...
    public void enableHighSampleRatePlay(boolean z16) {
        ...
        HonorLogUtils.info(TAG, "enableHighSampleRatePlay, enable = ".concat(String.valueOf(z16)));
        try {
            IHonorAudioPlayService iHonorAudioPlayService = this.mHnAudioPlayService;
            if (iHonorAudioPlayService != null && this.mIsServiceConnected) {
                iHonorAudioPlayService.enableHighSampleRatePlay(z16);
            }
        } catch (RemoteException e16) {
            HonorLogUtils.error(TAG, "enableHighSampleRatePlay,RemoteException ex : " + e16.getMessage());
        }
    }
