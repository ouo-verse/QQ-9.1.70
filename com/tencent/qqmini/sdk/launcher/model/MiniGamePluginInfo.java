...
public class MiniGamePluginInfo implements Parcelable {
    ...
    @NonNull
    public static INTERFACE$StPluginInfo toProtocol(@Nullable MiniGamePluginInfo miniGamePluginInfo) {
        INTERFACE$StPluginInfo iNTERFACE$StPluginInfo = new INTERFACE$StPluginInfo();
        if (miniGamePluginInfo != null) {
            iNTERFACE$StPluginInfo.pluginId.set(miniGamePluginInfo.f348088id);
            iNTERFACE$StPluginInfo.pluginName.set(miniGamePluginInfo.name);
            iNTERFACE$StPluginInfo.version.set(miniGamePluginInfo.version);
            iNTERFACE$StPluginInfo.url.set(miniGamePluginInfo.url);
            iNTERFACE$StPluginInfo.fileSize.set(miniGamePluginInfo.packageSize);
        }
        return iNTERFACE$StPluginInfo;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.packageSize != miniGamePluginInfo.packageSize || !this.name.equals(miniGamePluginInfo.name) || !this.f348088id.equals(miniGamePluginInfo.f348088id) || !this.version.equals(miniGamePluginInfo.version)) {
            return false;
        }
    ...
    public int hashCode() {
        return (((((((this.name.hashCode() * 31) + this.f348088id.hashCode()) * 31) + this.version.hashCode()) * 31) + this.url.hashCode()) * 31) + this.packageSize;
    }

    public String toString() {
        return "MiniGamePluginInfo{name='" + this.name + "', id='" + this.f348088id + "', version='" + this.version + "', url='" + this.url + "', packageSize=" + this.packageSize + '}';
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i3) {
        parcel.writeString(this.name);
        parcel.writeString(this.f348088id);
    ...
    protected MiniGamePluginInfo(Parcel parcel) {
        ...
        this.f348088id = parcel.readString();
