...
public class Switch extends CompoundButton {
    ...
    */
    ...
    public void setSwitchTextAppearance(Context context, int i3) {
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(i3, com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_TextAppearanceSwitch);
        ColorStateList colorStateList = obtainStyledAttributes.getColorStateList(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_TextAppearanceSwitch_mini_sdk_textColor);
        if (colorStateList != null) {
            this.mTextColors = colorStateList;
        } else {
            this.mTextColors = getTextColors();
        }
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_TextAppearanceSwitch_mini_sdk_textSize, 0);
        ...
        setSwitchTypefaceByIndex(obtainStyledAttributes.getInt(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_TextAppearanceSwitch_mini_sdk_typeface, -1), obtainStyledAttributes.getInt(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_TextAppearanceSwitch_mini_sdk_textStyle, -1));
        if (obtainStyledAttributes.getBoolean(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_TextAppearanceSwitch_mini_sdk_textAllCaps, false)) {
    ...
    public Switch(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, com.tencent.qqmini.sdk.launcher.R.attr.mini_sdk_switchStyle);
    }
    ...
    public Switch(Context context, AttributeSet attributeSet, int i3) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch, i3, com.tencent.qqmini.sdk.launcher.R.style.mini_sdk_switch_optimus);
        this.mThumbDrawable = obtainStyledAttributes.getDrawable(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_thumb);
        this.mTrackDrawable = obtainStyledAttributes.getDrawable(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_track);
        CharSequence text = obtainStyledAttributes.getText(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_textOn);
        this.mTextOn = text;
        if (text == null) {
            this.mTextOn = "";
        }
        CharSequence text2 = obtainStyledAttributes.getText(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_textOff);
        this.mTextOff = text2;
        if (text2 == null) {
            this.mTextOff = "";
        }
        this.mThumbTextPadding = obtainStyledAttributes.getDimensionPixelSize(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_thumbTextPadding, 0);
        this.mSwitchMinWidth = obtainStyledAttributes.getDimensionPixelSize(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_switchMinWidth, 0);
        this.mSwitchPadding = obtainStyledAttributes.getDimensionPixelSize(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_switchPadding, 0);
        int resourceId = obtainStyledAttributes.getResourceId(com.tencent.qqmini.sdk.launcher.R.styleable.mini_sdk_Switch_mini_sdk_switchTextAppearance, 0);
        if (resourceId != 0) {
        ...
        setOnClickListener(new View.OnClickListener() { // from class: com.tencent.qqmini.sdk.launcher.widget.Switch.1
