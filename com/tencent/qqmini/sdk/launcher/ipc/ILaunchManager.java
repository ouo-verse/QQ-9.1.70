...
public interface ILaunchManager extends IInterface {
    void onAppLifecycle(int i3, String str, MiniAppInfo miniAppInfo, Bundle bundle) throws RemoteException;

    void preloadDownloadPackage(MiniAppInfo miniAppInfo, ResultReceiver resultReceiver) throws RemoteException;
    ...
    /* compiled from: P */
    /* loaded from: classes23.dex */
    public static class Default implements ILaunchManager {
    ...
    /* compiled from: P */
    /* loaded from: classes23.dex */
    public static abstract class Stub extends Binder implements ILaunchManager {
        ...
        /* compiled from: P */
        /* loaded from: classes23.dex */
        public static class Proxy implements ILaunchManager {
            public static ILaunchManager sDefaultImpl;
            ...
            public void preloadDownloadPackage(MiniAppInfo miniAppInfo, ResultReceiver resultReceiver) throws RemoteException {
                ...
                try {
                    ...
                    if (!OaidMonitor.binderTransact(this.mRemote, 4, obtain, obtain2, 0) && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().preloadDownloadPackage(miniAppInfo, resultReceiver);
                    } else {
                        obtain2.readException();
                    }
                } finally {
        ...
        public static ILaunchManager asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (queryLocalInterface != null && (queryLocalInterface instanceof ILaunchManager)) {
                return (ILaunchManager) queryLocalInterface;
            }
            return new Proxy(iBinder);
        }

        public static ILaunchManager getDefaultImpl() {
            return Proxy.sDefaultImpl;
        }

        public static boolean setDefaultImpl(ILaunchManager iLaunchManager) {
            if (Proxy.sDefaultImpl == null && iLaunchManager != null) {
                Proxy.sDefaultImpl = iLaunchManager;
                return true;
            }
            return false;
        }
            ...
            if (i3 != 1598968902) {
                ...
                switch (i3) {
                    ...
                    case 4:
                        ...
                        preloadDownloadPackage(miniAppInfo2, resultReceiver2);
                        parcel2.writeNoException();
                        return true;
                    case 5:
                        parcel.enforceInterface(DESCRIPTOR);
                        ...
                        onAppLifecycle(readInt, readString, miniAppInfo3, bundle4);
                        parcel2.writeNoException();
                        return true;
                    case 6:
                        parcel.enforceInterface(DESCRIPTOR);
