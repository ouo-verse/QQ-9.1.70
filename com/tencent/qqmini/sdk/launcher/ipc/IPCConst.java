...
public class IPCConst {
    ...
    public static final String CMD_CONSOLE_LOG = "cmd_print_console_log";
    public static final String CMD_DC_REPORT_LOG_KEY_DATA = "cmd_dc_report_log_key_data";
    public static final String CMD_DOWNLOAD_GAME_PKG = "cmd_download_game_package";
    public static final String CMD_DOWNLOAD_GAME_SUB_PKG = "cmd_download_game_sub_package";
    public static final String CMD_EXIT_QQ = "cmd_exit_qq";
    public static final String CMD_GAME_ENGINE_INFO = "cmd_game_engine_info";
    ...
    public static final String KEY_CONSOLE_LOG_MSG = "key_console_log_msg";
    ...
    public static final String KEY_GAME_NEW_ENGINE = "key_game_new_engine";
