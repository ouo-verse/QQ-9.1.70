...
public class EngineVersion implements Comparable<EngineVersion>, Parcelable {
    ...
    public int compareTo(EngineVersion engineVersion) {
        try {
            ...
            QMLog.e("EngineVersion", "[MiniEng] compare error " + DebugUtil.getPrintableStackTrace(e16));
            return 0;
        }
    }
    ...
    public EngineVersion(String str) {
        this.mMajor = QUAUtil.isQQApp() ? ((MiniAppProxy) ProxyManager.get(MiniAppProxy.class)).getAppVersion() : "1.83.3";
        this.mMinor = str;
    }
}
