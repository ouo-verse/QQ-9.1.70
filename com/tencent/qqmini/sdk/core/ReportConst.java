...
public abstract class ReportConst {
    ...
    public static List<String> apiReportList = new ArrayList(Arrays.asList("requestPayment", "updateHTMLWebView", "insertHTMLWebView", "removeHTMLWebView", "insertMap", "wnsRequest", "getQua", "openUrl", "notifyNative", "launchApplication", PluginConst.DataJsPluginConst.PRIVATE_API_GET_NATIVE_USER_INFO_EXTRA, "updateShareMenu", c.NAME, a.NAME, "getShareInfo", d.NAME));
    ...
    public static class ACTION {
        ...
        public static final String EM_CLICK = "em_click";
        public static final String EM_EXPO = "em_expo";
        public static final String FULLSCREEN = "fullscreen";
        public static final String GAME_INNER_ACTION = "game_inner";
        public static final String HALFSCREEN = "halfscreen";
        public static final String HALFSCREEN_MINIAPP_CLOSE_BUTTON = "halfscreen_miniapp_close_button";
        public static final String HALFSCREEN_MINIAPP_TOFULLSCREEN = "halfscreen_miniapp_tofullscreen";
    ...
    public static MiniAppInfo miniAppConfigForPreload() {
        if (MINI_APP_CONFIG_FOR_PRELOAD == null) {
            synchronized (ReportConst.class) {
                if (MINI_APP_CONFIG_FOR_PRELOAD == null) {
