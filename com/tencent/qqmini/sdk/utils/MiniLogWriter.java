...
public class MiniLogWriter extends Writer {
    ...
    private boolean charBufferInnerLogic(char[] cArr, int i3, int i16) throws ClassNotFoundException, NoSuchFieldException, IllegalAccessException {
        Class cls;
    ...
    private CharBuffer wrap(char[] cArr, int i3, int i16) {
        ...
        if (mCanRecycle) {
            ...
            try {
                if (charBufferInnerLogic(cArr, i3, i16)) {
