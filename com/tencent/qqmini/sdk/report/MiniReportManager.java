...
public class MiniReportManager {
    ...
    private static ArrayList<String> eventNeedRecordFirstTime = new ArrayList<>();
    private static final Map<String, List<String>> eventForFirstTime = new HashMap();
    ...
    public static class EventId {
        ...
        public static final int APPLAUNCH = 35;
        public static final int APPLAUNCH_START = 46;
        ...
        public static final int NAVIGATE_BACK = 32;
        public static final int NAVIGATE_BACK_START = 43;
        public static final int NAVIGATE_TO = 31;
        public static final int NAVIGATE_TO_START = 42;
        ...
        public static final int REDIRECT_TO = 30;
        public static final int REDIRECT_TO_START = 41;
        public static final int RELAUNCH = 34;
        public static final int RELAUNCH_START = 45;
        ...
        public static final int SWITCH_TAB = 33;
        public static final int SWITCH_TAB_START = 44;
    ...
    static {
        ...
        eventNameSparseArray.put(120, EventName.APP_ON_WEBVIEW_READY);
        eventNameSparseArray.put(121, "app_route_done");
        eventNameSparseArray.put(150, "app_err_white_screen");
        eventNameSparseArray.put(151, EventName.APP_ERR_INIT_V8_FAILED);
        ...
        eventNameSparseArray.put(650, EventName.SDK_SERVICE_USE_TYPE);
        eventNameSparseArray.put(EventId.SDK_EMBEDDED_VIDEO, EventName.SDK_EMBEDDED_VIDEO);
        eventNameSparseArray.put(EventId.SDK_EMBEDDED_LIVE_PLAYER, EventName.SDK_EMBEDDED_LIVE_PLAYER);
        eventNameSparseArray.put(772, EventName.SDK_EMBEDDED_LIVE_ELEMENT);
        eventNameSparseArray.put(EventId.SDK_EMBEDDED_SUPPORT_RESULT, EventName.SDK_EMBEDDED_SUPPORT_RESULT);
        eventNameSparseArray.put(EventId.SDK_EMBEDDED_UPDATE_RESULT, EventName.SDK_EMBEDDED_UPDATE_RESULT);
        ...
        eventNeedRecordTime.add(120);
        eventNeedRecordTime.add(121);
        eventNeedRecordTime.add(611);
        ...
        eventCostTimeSparseArray.put(106, new CostTimeRecord(EventName.LAUNCH_2_WEB_APP_START_RESULT, 1));
        eventCostTimeSparseArray.put(104, new CostTimeRecord(EventName.LAUNCH_2_SERVICE_APP_START_RESULT, 1));
        eventCostTimeSparseArray.put(107, new CostTimeRecord(EventName.WEB_APP_END_RESULT, 106));
        eventCostTimeSparseArray.put(105, new CostTimeRecord(EventName.SERVICE_APP_END_RESULT, 104));
        eventCostTimeSparseArray.put(611, new CostTimeRecord(EventName.WEB_APP_TO_DOMREADY_RESULT, 107));
        eventCostTimeSparseArray.put(121, new CostTimeRecord(EventName.SERVICE_APP_TO_ROUTEDONE_RESULT, 105));
        ...
        eventNeedRecordFirstTime.add(EventName.LAUNCH_2_WEB_APP_START_RESULT);
        eventNeedRecordFirstTime.add(EventName.LAUNCH_2_SERVICE_APP_START_RESULT);
        eventNeedRecordFirstTime.add(EventName.WEB_APP_END_RESULT);
        eventNeedRecordFirstTime.add(EventName.SERVICE_APP_END_RESULT);
        eventNeedRecordFirstTime.add(EventName.WEB_APP_TO_DOMREADY_RESULT);
        eventNeedRecordFirstTime.add(EventName.SERVICE_APP_TO_ROUTEDONE_RESULT);
    }

    public static void addCostTimeEventAttachInfo(MiniAppInfo miniAppInfo, int i3, String str) {
        String str2;
        if (miniAppInfo != null) {
        ...
        QMLog.d(TAG, "addCostTimeEventAttachInfo:  mileStoneEventKey:" + i3 + "   attachInfo:" + str);
    }

    private static void addReportEventToFirstTime(MiniAppInfo miniAppInfo, String str) {
        String str2;
        if (eventNeedRecordFirstTime.contains(str)) {
            if (miniAppInfo != null) {
                str2 = miniAppInfo.appId;
            } else {
                str2 = "0000000000";
            }
            Map<String, List<String>> map = eventForFirstTime;
    ...
    private static void appendJsErrorToReportedList(MiniAppInfo miniAppInfo, String str) {
        if (miniAppInfo != null && !TextUtils.isEmpty(miniAppInfo.appId) && !TextUtils.isEmpty(str)) {
            ...
            if (map.get(miniAppInfo.appId) == null) {
                map.put(miniAppInfo.appId, new ArrayList());
            }
            map.get(miniAppInfo.appId).add(str);
        }
    }

    private static void detectWhiteScreen(MiniAppInfo miniAppInfo, int i3, String str, String str2, String str3, long j3, String str4, MiniAppLaunchState miniAppLaunchState) {
        if (i3 == 20 && !miniAppLaunchState.hasOnloaded && miniAppLaunchState.eventTime.containsKey(121)) {
            ...
            boolean containsKey = miniAppLaunchState.eventTime.containsKey(611);
            miniAppLaunchState.eventTime.remove(121);
            long j16 = j3 - longValue;
            int config = WnsConfig.getConfig("qqminiapp", "mini_app_report_white_screen_check", 5000);
            if (longValue > 0 && j16 > config && !containsKey) {
                QMLog.e(TAG, "detect white_screen. after routedone time:" + j16 + " domreadyTime:" + containsKey);
                MiniProgramLpReportDC04266.report(miniAppInfo, 150, str, str2, "", 0, str3, 0L, "", j3, "route_done", String.valueOf(j16), "", "", str4);
                if (WnsConfig.getConfig("qqminiapp", WnsConfig.MINI_APP_REPORT_WHITE_SCREEN_ENABLE_CLEAR_APKG_CACHE, 0) == 1) {
                    QMLog.e(TAG, "detect white_screen. clear apkg:" + miniAppInfo);
                    MiniCacheFreeManager.freeCache(LoginManager.getInstance().getAccount(), miniAppInfo, true, null);
                }
            }
        }
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:10:0x024f A[Catch: Exception -> 0x043b, TRY_LEAVE, TryCatch #1 {Exception -> 0x043b, blocks: (B:8:0x0247, B:10:0x024f, B:23:0x0060), top: B:22:0x0060 }] */
    /*
    ...
    */
    public static JSONArray getLaunchPerformance(String str) {
        ...
        if (launchState.eventTimeFirst.size() == 0) {
            launchState.eventTimeFirst.putAll(launchState.eventTime);
            launchState.launchIdFirst = launchState.launchId;
            launchState.launchId = "";
        } else if (launchState.eventTimeFirst.size() > 0) {
            JSONObject jSONObject = new JSONObject();
            Map<Integer, Long> map = launchState.eventTimeFirst;
            str2 = TAG;
            try {
                jSONObject.put("navigationStart", map.get(1));
                jSONObject.put("serviceStart", launchState.eventTimeFirst.get(100));
                jSONObject.put("serviceEnd", launchState.eventTimeFirst.get(101));
                jSONObject.put("viewStart", launchState.eventTimeFirst.get(102));
                str4 = "viewStart";
                jSONObject.put("viewEnd", launchState.eventTimeFirst.get(103));
                jSONObject.put("fetchPkgStart", launchState.eventTimeFirst.get(619));
                jSONObject.put("fetchPkgEnd", launchState.eventTimeFirst.get(620));
                jSONObject.put("fetchSdkStart", launchState.eventTimeFirst.get(4));
                jSONObject.put("fetchSdkEnd", launchState.eventTimeFirst.get(5));
                jSONObject.put("loadSdkServiceStart", launchState.eventTimeFirst.get(14));
                jSONObject.put("loadSdkServiceEnd", launchState.eventTimeFirst.get(15));
                jSONObject.put("loadSdkViewStart", launchState.eventTimeFirst.get(18));
                jSONObject.put("loadSdkViewEnd", launchState.eventTimeFirst.get(19));
                jSONObject.put("loadAppServiceStart", launchState.eventTimeFirst.get(104));
                jSONObject.put("loadAppServiceEnd", launchState.eventTimeFirst.get(105));
                jSONObject.put("loadAppViewStart", launchState.eventTimeFirst.get(106));
                jSONObject.put("loadAppViewEnd", launchState.eventTimeFirst.get(107));
                jSONObject.put("redirectToStart", launchState.eventTime.get(41));
                jSONObject.put("redirectToEnd", launchState.eventTime.get(30));
                jSONObject.put("navigateToStart", launchState.eventTime.get(42));
                jSONObject.put("navigateToEnd", launchState.eventTime.get(31));
                jSONObject.put("navigateBackStart", launchState.eventTime.get(43));
                jSONObject.put("navigateBackEnd", launchState.eventTime.get(32));
                jSONObject.put("switchTabStart", launchState.eventTime.get(44));
                jSONObject.put("switchTabEnd", launchState.eventTime.get(33));
                jSONObject.put("reLaunchStart", launchState.eventTime.get(45));
                jSONObject.put("reLaunchEnd", launchState.eventTime.get(34));
                jSONObject.put("appLaunchStart", launchState.eventTime.get(46));
                jSONObject.put("appLaunchEnd", launchState.eventTime.get(35));
                ...
                if (launchState.eventTime.size() > 0) {
                    ...
                    jSONObject2.put(str4, launchState.eventTime.get(102));
                    ...
                    jSONObject2.put("redirectToStart", launchState.eventTime.get(41));
                    jSONObject2.put("redirectToEnd", launchState.eventTime.get(30));
                    jSONObject2.put("navigateToStart", launchState.eventTime.get(42));
                    jSONObject2.put("navigateToEnd", launchState.eventTime.get(31));
                    jSONObject2.put("navigateBackStart", launchState.eventTime.get(43));
                    jSONObject2.put("navigateBackEnd", launchState.eventTime.get(32));
                    jSONObject2.put("switchTabStart", launchState.eventTime.get(44));
                    jSONObject2.put("switchTabEnd", launchState.eventTime.get(33));
                    jSONObject2.put("reLaunchStart", launchState.eventTime.get(45));
                    jSONObject2.put("reLaunchEnd", launchState.eventTime.get(34));
                    jSONObject2.put("appLaunchStart", launchState.eventTime.get(46));
                    jSONObject2.put("appLaunchEnd", launchState.eventTime.get(35));
                ...
                e = e17;
                str3 = str2;
                QMLog.e(str3, "create performance result failed", e);
                QMLog.e(str3, "getformance: " + jSONArray.toString());
                return jSONArray;
            }
            QMLog.e(str3, "getformance: " + jSONArray.toString());
            return jSONArray;
    ...
    private static long getStartTime(MiniAppLaunchState miniAppLaunchState, CostTimeRecord costTimeRecord) {
        Long l3 = miniAppLaunchState.eventTime.get(Integer.valueOf(costTimeRecord.eventStart));
        if (l3 != null) {
            return l3.longValue();
        }
        return 0L;
    ...
    private static boolean needReportEvent(MiniAppInfo miniAppInfo, String str) {
        String str2;
        if (eventNeedRecordFirstTime.contains(str)) {
            if (miniAppInfo != null) {
                str2 = miniAppInfo.appId;
            ...
            List<String> list = eventForFirstTime.get(str2);
    ...
    private static long onLaunchStart(MiniAppInfo miniAppInfo, int i3, long j3, long j16, String str, MiniAppLaunchState miniAppLaunchState) {
        LaunchParam launchParam;
        boolean z16 = true;
        if (i3 == 1) {
            QMLog.d(TAG, "launch start  uptimeMillis:" + SystemClock.uptimeMillis() + "  currentTimeMillis :" + j16);
            if (miniAppInfo == null || !miniAppInfo.isEngineTypeMiniApp() || !miniAppInfo.supportNativeRenderMode()) {
                z16 = false;
            }
            if (!z16) {
            ...
            if (miniAppInfo != null && (launchParam = miniAppInfo.launchParam) != null) {
                long j17 = launchParam.launchClickTimeMillis;
                if (j17 != 0) {
                    QMLog.d(TAG, "reportEventType: fix onlaunch timestamp to " + miniAppInfo.launchParam.launchClickTimeMillis);
                    miniAppInfo.launchParam.launchClickTimeMillis = 0L;
                    j3 = j17;
                }
            }
            miniAppLaunchState.hasOnloaded = false;
            try {
                if (!miniAppLaunchState.firstRender) {
                    MiniAppLaunchState launchState = getLaunchState("0000000000");
                    if (launchState != null && launchState.eventTime.size() > 0) {
                        miniAppLaunchState.eventTime.putAll(launchState.eventTime);
                        launchState.eventTime.clear();
                    }
                } else if (miniAppLaunchState.eventTimeFirst.size() == 0) {
                    miniAppLaunchState.eventTimeFirst.putAll(miniAppLaunchState.eventTime);
                    miniAppLaunchState.launchIdFirst = miniAppLaunchState.launchId;
                    miniAppLaunchState.launchId = "";
                }
            } catch (Exception e16) {
                QMLog.e(TAG, "onLaunchStart error: " + e16.toString());
            }
        }
        return j3;
    }

    public static void recordMiniLaunchTime(int i3, String str) {
        MiniAppLaunchState launchState = getLaunchState(str);
        if (i3 == 35) {
            launchState.eventTime.put(35, Long.valueOf(System.currentTimeMillis()));
        }
    }

    private static void reportCostTimeEvent(MiniAppInfo miniAppInfo, int i3, int i16, String str, String str2, String str3, String str4, long j3, long j16, MiniAppLaunchState miniAppLaunchState, String str5) {
        CostTimeRecord costTimeRecord = eventCostTimeSparseArray.get(i3);
        if (costTimeRecord != null) {
            long startTime = getStartTime(miniAppLaunchState, costTimeRecord);
            if (startTime > 0) {
                long j17 = j3 - startTime;
                String str6 = costTimeRecord.eventName;
                boolean needReportEvent = needReportEvent(miniAppInfo, str6);
                String str7 = miniAppLaunchState.attachInfo.get(Integer.valueOf(i3));
                if (j17 >= 0) {
                    int i17 = MAX_TIME_COST;
                    if (j17 > i17) {
                        j17 = i17;
                    }
                    long j18 = j17;
                    if (QMLog.isColorLevel()) {
                        QMLog.e(TAG, "timeCostEvent  event:" + str6 + ";costTime:" + j18 + "ms");
                    }
                    if (needReportEvent) {
                        MiniProgramLpReportDC04266.reportCostTimeEvent(miniAppInfo, str6, str7, i16, j18, j16, str, str2, str3, str4, str5);
                        addReportEventToFirstTime(miniAppInfo, str6);
                        return;
                    }
                    return;
                }
                QMLog.e(TAG, "costTime < 0 " + j17);
            }
        }
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str) {
        reportEventType(miniAppInfo, i3, null, null, null, 0, str, 0L, null, "", "", "", "");
    }
    ...
    private static void reportPostProcess(int i3, String str) {
        if (i3 == 22) {
            eventForFirstTime.remove(str);
        }
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, long j3) {
        reportEventType(miniAppInfo, i3, null, null, null, 0, str, j3, null, "", "", "", "");
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, String str2, String str3, String str4, String str5) {
        reportEventType(miniAppInfo, i3, null, null, null, 0, str, 0L, null, str2, str3, str4, str5);
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, String str2) {
        reportEventType(miniAppInfo, i3, null, str, null, 0, str2, 0L, null, "", "", "", "");
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, String str2, String str3, int i16, String str4, String str5, String str6, String str7) {
        reportEventType(miniAppInfo, i3, str, str2, str3, i16, getAppType(miniAppInfo), 0L, null, str4, str5, str6, str7);
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, String str2, String str3, int i16) {
        reportEventType(miniAppInfo, i3, str, str2, str3, i16, getAppType(miniAppInfo), 0L, null);
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, String str2, String str3, int i16, String str4, long j3, String str5) {
        reportEventType(miniAppInfo, i3, str, str2, str3, i16, str4, j3, str5, "", "", "", "");
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, String str, String str2, String str3, int i16, String str4, long j3, String str5, String str6, String str7, String str8, String str9) {
        reportEventType(miniAppInfo, i3, System.currentTimeMillis(), str, str2, str3, i16, str4, j3, str5, str6, str7, str8, str9);
    }

    public static void reportEventType(MiniAppInfo miniAppInfo, int i3, long j3, String str, String str2, String str3, int i16, String str4, long j16, String str5, String str6, String str7, String str8, String str9) {
        String str10;
        String str11;
        int i17;
        String str12;
        ...
        if (miniAppInfo != null) {
            str10 = miniAppInfo.appId;
            str11 = String.valueOf(miniAppInfo.renderMode);
        } else {
            str10 = "0000000000";
            str11 = "";
        }
        String str13 = str10;
        String str14 = str11;
        MiniAppLaunchState launchState = getLaunchState(str13);
        long onLaunchStart = onLaunchStart(miniAppInfo, i3, j3, currentTimeMillis, str13, launchState);
        int i18 = (i3 != 611 || launchState.hasOnloaded) ? i3 : 2;
        if (i18 == 2) {
            QMLog.d(TAG, "launch end  uptimeMillis:" + SystemClock.uptimeMillis() + "  currentTimeMillis :" + currentTimeMillis);
            if (launchState.hasOnloaded) {
                ...
                launchState.launchId = MiniProgramReportHelper.launchIdForMiniAppConfig(miniAppInfo);
            }
        }
        detectWhiteScreen(miniAppInfo, i18, str, str2, str4, onLaunchStart, str14, launchState);
        if (eventNeedRecordTime.contains(Integer.valueOf(i18))) {
            launchState.eventTime.put(Integer.valueOf(i18), Long.valueOf(onLaunchStart));
        }
        int i19 = i18;
        MiniProgramLpReportDC04266.report(miniAppInfo, i18, str, str2, str3, i16, str4, j16, str5, onLaunchStart, str6, str7, str8, str9, str14);
        reportCostTimeEvent(miniAppInfo, i19, i16, str6, str7, str8, str9, currentTimeMillis, onLaunchStart, launchState, str14);
        if (i19 == 2 && "0".equals(str4)) {
            MiniProgramLpReportDC04266.report(miniAppInfo, 630, str, "0", null, 0, str4, 0L, null, onLaunchStart, "", "", "", "", str14);
            str12 = str13;
            i17 = i19;
        } else {
            i17 = i19;
