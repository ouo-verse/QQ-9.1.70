...
public class TPDownloadProxyEnum {
    public static final String CELLULAR_INTERFACE_NAME = "cellular_interface_name";
    public static final String CELLULAR_NETWORK_INTERFACE_ID = "cellular_interface_id";
    public static final int CLEAR_CACHE_MODE_ALL_MEMORY_CACHE = 16;
    ...
    public static final String DLPARAM_AUTHENTICATION_ENCRYPT_KEY = "dl_param_authentication_encrypt_key";
    public static final String DLPARAM_AUTHENTICATION_TOKEN_KEY = "dl_param_authentication_token_key";
    ...
    public static final String DLPARAM_CLIP_FILE_ID = "dl_param_play_clip_keyid";
    ...
    public static final String DLPARAM_DOWNLOAD_DATA_REUSABLE = "dl_param_download_data_reusable";
    public static final String DLPARAM_EMERGENCY_TIME = "dl_param_emergency_time";
    public static final String DLPARAM_ENABLE_EXPAND_DOWNLOAD_URL = "dl_param_enable_expand_download_url";
    ...
    public static final String DLPARAM_FIRST_CLIP = "dl_param_first_clip";
    ...
    public static final String DLPARAM_INT_BIZ_ID = "task_biz_id";
    public static final String DLPARAM_INT_FILE_TYPE = "task_file_type";
    ...
    public static final String DLPARAM_NEED_CACHE = "dl_param_need_cache";
    ...
    public static final String DLPARAM_PCDN_FILE_MIN_BUFF_TIME = "dl_param_pcdn_file_min_buff_time";
    public static final String DLPARAM_PCDN_FILE_PROTECT_BUFF_TIME = "dl_param_pcdn_file_protect_buff_time";
    ...
    public static final String DLPARAM_PLAYER_BUFFER_MINI_DURATION = "dl_param_player_buffer_mini_duration";
    public static final String DLPARAM_PLAYER_EMERGENCY_SAFE_TIME_EFFECT_SELF = "dl_param_player_emergency_safe_time_effect_self";
    public static final String DLPARAM_PLAYER_INVALID_CONTENT_TYPE = "dl_param_invalid_content_type";
    public static final String DLPARAM_PLAYER_SELF_EMERGENCY_TIME = "dl_param_player_self_emergency_time";
    public static final String DLPARAM_PLAYER_SELF_SAFE_TIME = "dl_param_player_self_safe_time";
    ...
    public static final String DLPARAM_PREPARE_ATTACH_PERSISTENT_PROPERY = "dl_param_attach_persistent_property";
    public static final String DLPARAM_PREPARE_HTTP_START_TIME = "dl_param_prepare_http_start_time";
    public static final String DLPARAM_PREPARE_RUNNING_TIMEOUT = "dl_param_prepare_running_timeout";
    ...
    public static final String DLPARAM_VINFO_CDN_ORIGIN = "dl_param_vinfo_cdn_origin";
    ...
    public static final String DLPPARAM_PLAYER_SELF_EMERGENCY_TIME_FOR_PRE_PLAYER = "dl_param_player_self_emergency_time_for_pre_player";
    public static final String DLPPARAM_PLAYER_SELF_SAFE_TIME_FOR_PRE_PLAYER = "dl_param_player_self_safe_time_for_pre_player";
    ...
    public static final int DLTYPE_HLS_BATCH = 22;
    ...
    public static final int DLTYPE_MP4_BATCH = 20;
    public static final int DLTYPE_MP4_CLIP_BATCH = 21;
    ...
    public static final int DLTYPE_P2P_FLV_LIVE = 23;
    ...
    public static final int DL_NATIVEINFO_TYPE_ADAPTIVE_STRATEGY_BANDWIDTH_FIRST = 6;
    public static final int DL_NATIVEINFO_TYPE_ADAPTIVE_STRATEGY_QOS_FIRST = 7;
    public static final int DL_NATIVEINFO_TYPE_CELLULAR_FLOW = 2;
    public static final int DL_NATIVEINFO_TYPE_FLOW = 3;
    public static final int DL_NATIVEINFO_TYPE_GLOBAL_BANDWIDTH = 11;
    ...
    public static final int DL_NATIVEINFO_TYPE_VERIFY_OFFLINE = 10;
    ...
    public static final String DL_PARAM_ENABLE_PRELOAD_LIMIT = "dl_param_enable_preload_limit";
    ...
    public static final int EVENT_CANCEL_BUFFER_MORE_DATA = 22;
    public static final int EVENT_DOWNLOAD_PAUSE = 11;
    public static final int EVENT_DOWNLOAD_RESUME = 12;
    public static final int EVENT_MAIN_PROCESS = 102;
    public static final int EVENT_MEMORY_WARNING = 25;
    ...
    public static final int EVENT_PREPUSH_OFF = 51;
    public static final int EVENT_PREPUSH_ON = 50;
    public static final int EVENT_PRIVACY_P2P_UPLOAD_OFF = 27;
    public static final int EVENT_PRIVACY_P2P_UPLOAD_ON = 26;
    public static final int EVENT_PROCESS_ALIVE = 101;
    ...
    public static final String MAX_PREPUSH_HTTP_DOWNLOAD_SPEED_KB = "max_prepush_http_download_speed_kb";
    ...
    public static final String TAB_APPTESTID = "app_test_id";
    public static final String TAB_CALLBACK_ACK = "tab_callback_ack";
    public static final String TASKINFO_ADAPTIVE_CONTROL_STRATEGY = "taskinfo_adaptive_control_strategy";
    ...
    public static final String UPLOAD_BANDWIDTH_USAGE = "upload_bandwidth_usage";
    public static final String UPLOAD_SPEED_KB = "upload_speed_kb";
    ...
    public static final String USER_PCDN_BIZ_ID = "pcdn_biz_id";
