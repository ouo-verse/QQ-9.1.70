...
import com.tencent.richframework.widget.round.imageview.R$styleable;
...
public class RFWRoundImageView extends ImageView {
    ...
    public RFWRoundImageView(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.mBorderWidth = obtainStyledAttributes.getDimensionPixelSize(R$styleable.RFWRoundImageView_riv_border_width, 0);
        this.mBorderColor = obtainStyledAttributes.getColor(R$styleable.RFWRoundImageView_riv_border_color, -16777216);
        this.mBorderOverlay = obtainStyledAttributes.getBoolean(R$styleable.RFWRoundImageView_riv_border_overlay, false);
        this.mCircleBackgroundColor = obtainStyledAttributes.getColor(R$styleable.RFWRoundImageView_riv_circle_background_color, 0);
        boolean z16 = obtainStyledAttributes.getBoolean(R$styleable.RFWRoundImageView_riv_is_circle, true);
        this.mIsCircle = z16;
        if (!z16) {
            setTopLeftRadius(obtainStyledAttributes.getDimensionPixelSize(R$styleable.RFWRoundImageView_riv_corner_top_left_radius, 0));
            setTopRightRadius(obtainStyledAttributes.getDimensionPixelSize(R$styleable.RFWRoundImageView_riv_corner_top_right_radius, 0));
            setBottomLeftRadius(obtainStyledAttributes.getDimensionPixelSize(R$styleable.RFWRoundImageView_riv_corner_bottom_left_radius, 0));
            setBottomRightRadius(obtainStyledAttributes.getDimensionPixelSize(R$styleable.RFWRoundImageView_riv_corner_bottom_right_radius, 0));
        }
