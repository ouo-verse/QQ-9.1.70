...
public class Patterns {
    ...
    private static HashMap<String, Integer> sWeishiEmotionHashMap;
    ...
    public static boolean sParseOrNot = true;
    ...
    public static final String[] EMO_WEISHI_SYMBOL = {"[em]e252[/em]", "[em]e249[/em]", "[em]e243[/em]", "[em]e244[/em]", "[em]e282[/em]", "[em]e245[/em]", "[em]e248[/em]", "[em]e247[/em]", "[em]e250[/em]", "[em]e246[/em]", "[em]e241[/em]", "[em]e205[/em]", "[em]e206[/em]", "[em]e207[/em]", "[em]e209[/em]", "[em]e213[/em]", "[em]e215[/em]", "[em]e216[/em]", "[em]e217[/em]", "[em]e220[/em]", "[em]e227[/em]", "[em]e237[/em]", "[em]e238[/em]", "[em]e258[/em]", "[em]e262[/em]", "[em]e254[/em]", "[em]e255[/em]", "[em]e260[/em]", "[em]e257[/em]", "[em]e263[/em]", "[em]e264[/em]", "[em]e267[/em]", "[em]e268[/em]", "[em]e269[/em]", "[em]e270[/em]", "[em]e271[/em]", "[em]e272[/em]", "[em]e273[/em]", "[em]e274[/em]", "[em]e275[/em]", "[em]e276[/em]", "[em]e277[/em]", "[em]e278[/em]", "[em]e280[/em]", "[em]e281[/em]"};
    ...
    public static final Pattern PATTERN_EMO = Pattern.compile("\\[em\\]e\\d{1,}\\[/em\\]", 2);
    public static final Pattern QUICK_SMILEY_PATTERN = Pattern.compile("\\[em2\\]e\\d{1,},\\d{1,},\\d{1,}\\[/em2\\]", 2);
    public static final Pattern COLOR_PATTERN = Pattern.compile("\\{text:.*?,color:.*?\\}");
    public static String SIGN_ICON_URL_END = QzoneEmotionUtils.SIGN_ICON_URL_END;

    static {
        initSmileyHashMap();
        initWeishiEmotionHashMap();
    }
    ...
    private static void initSmileyHashMap() {
        ...
        while (true) {
            ...
            if (i3 < strArr.length) {
                sSmileyHashMap.put(strArr[i3], Integer.valueOf(i3));
                i3++;
            } else {
                return;
            }
    ...
    private static void initWeishiEmotionHashMap() {
        if (sWeishiEmotionHashMap == null) {
            sWeishiEmotionHashMap = new HashMap<>();
            int i3 = 0;
            while (true) {
                String[] strArr = EMO_WEISHI_SYMBOL;
                if (i3 < strArr.length) {
                    sWeishiEmotionHashMap.put(strArr[i3], Integer.valueOf(i3));
                    i3++;
                } else {
                    return;
                }
