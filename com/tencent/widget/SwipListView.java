...
public class SwipListView extends XListView implements Handler.Callback {
    ...
    private boolean mDragWhenPreItemShow;
    private boolean mHandleActionDownWhenPreItemShow;
    ...
    private boolean handleActionDown(int i3) {
        if (!this.mIsShowRV) {
            return false;
        }
        if (this.mCurItemView != this.mPreItemView) {
            return this.mHandleActionDownWhenPreItemShow;
        }
        return isHitCurItemLeft(i3);
    }
    ...
    private void hiddeRight(View view) {
        ...
        if (rightIconMenuListener != null) {
            rightIconMenuListener.onRightIconMenuHide(view);
        }
    }
    ...
    private void showRight(View view) {
        ...
        if (view != null) {
            ...
            if (this.mStartNewDrag && (dragItemListener = this.mDragItemListener) != null) {
                dragItemListener.showItem(view);
            }
            i3 = scrollX;
        } else {
            i3 = 0;
        ...
        RightIconMenuListener rightIconMenuListener = this.mRIMListenr;
        if (rightIconMenuListener != null && view != null) {
            rightIconMenuListener.onRightIconMenuShow(view);
        }
    }

    public RightIconMenuListener getRightIconMenuListener() {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 7)) {
            return (RightIconMenuListener) iPatchRedirector.redirect((short) 7, (Object) this);
        }
        return this.mRIMListenr;
    }
    ...
    public boolean handleMessage(Message message) {
        ...
        if (i17 != 0) {
            if (i17 != 1) {
                ...
                View view3 = this.mToAnimView;
                if (view3 != null && view3.getScrollX() > (i16 = (int) currX)) {
                    this.mToAnimView.scrollTo(i16, 0);
                    invalidate();
                }
                if (computeScrollOffset) {
                    ...
                    RightIconMenuListener rightIconMenuListener = this.mRIMListenr;
                    if (rightIconMenuListener != null && (view2 = this.mToAnimView) != null) {
                        rightIconMenuListener.onRightIconMenuHide(view2);
                    }
                    this.mToAnimView = null;
                }
            }
            ...
            View view4 = this.mToAnimView;
            if (view4 != null && view4.getScrollX() < (i3 = (int) currX2)) {
                this.mToAnimView.scrollTo(i3, 0);
                invalidate();
            }
            if (computeScrollOffset2) {
                ...
                if (rightIconMenuListener2 != null && (view = this.mToAnimView) != null) {
                    rightIconMenuListener2.onRightIconMenuShow(view);
                }
                this.mToAnimView = null;
            }
        }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            ...
            if (swipListListener2 != null) {
                swipListListener2.updateCurShowRightView(null);
            }
            this.mStartX = x16;
            this.mCurX = x16;
            this.mStartY = y16;
            ...
            handleActionDown = handleActionDown(x16);
            this.mStartNewDrag = false;
        }
        if (action == 0 && this.mIsShowRV) {
            SwipListListener swipListListener3 = this.mListener;
            if (swipListListener3 != null) {
                swipListListener3.interceptTouchEvent(true);
            }
            cancelShowHideAnim();
            View view2 = this.mPreItemView;
            if (view2 != this.mCurItemView) {
                hiddeRight(view2);
            }
    ...
    */
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (action != 0) {
            if (action != 1) {
                if (action == 2) {
                    if (this.mIsShowRV) {
                        ...
                        if (this.mCurItemView == this.mPreItemView || this.mDragWhenPreItemShow) {
                            if (this.mSlideDir != 0 || judgeScrollDirection(Math.abs(x16 - this.mStartX), Math.abs(y16 - this.mStartY))) {
                                if (this.mSlideDir == 1) {
                                    ...
                                    if (this.mCurItemView != this.mPreItemView && !this.mStartNewDrag) {
                                        this.mStartNewDrag = true;
                                        DragItemListener dragItemListener = this.mDragItemListener;
                                        if (dragItemListener != null) {
                                            dragItemListener.startDrag();
                                        }
                                    }
                                    handleActionDown = true;
                                }
                        ...
                        if (this.mCurViewRVWidth != 0) {
                            if (this.mSlideDir != 0 || judgeScrollDirection(Math.abs(x16 - this.mStartX), Math.abs(y16 - this.mStartY))) {
                                if (this.mSlideDir == 1) {
                                    scrollItemView(x16, y16, this.mCurItemView, this.mCurViewRVWidth);
                                    if (!this.mStartNewDrag) {
                                        this.mStartNewDrag = true;
                                        DragItemListener dragItemListener2 = this.mDragItemListener;
                                        if (dragItemListener2 != null) {
                                            dragItemListener2.startDrag();
                                        }
                                    }
                                    handleActionDown = true;
                                    this.mCurX = x16;
            ...
            if (this.mIsShowRV) {
                ...
                View view = this.mCurItemView;
                if (view == this.mPreItemView) {
                    if (this.mSlideDir == 1) {
                        endOfTouch();
                        handleActionDown = true;
                    } else {
                        hiddeRight(view);
                        handleActionDown = z16;
                    }
                } else {
                    if (this.mDragWhenPreItemShow && this.mSlideDir == 1) {
                        endOfTouch();
                        handleActionDown = true;
                    }
                    handleActionDown = z16;
    ...
    public void setDragItemListener(DragItemListener dragItemListener) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 11)) {
            iPatchRedirector.redirect((short) 11, (Object) this, (Object) dragItemListener);
        } else {
            this.mDragItemListener = dragItemListener;
        }
    }

    public void setDragWhenPreItemShow(boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 9)) {
            iPatchRedirector.redirect((short) 9, (Object) this, z16);
        } else {
            this.mDragWhenPreItemShow = z16;
        }
    }

    public void setHandleActionDownWhenPreItemShow(boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 10)) {
            iPatchRedirector.redirect((short) 10, (Object) this, z16);
        } else {
            this.mHandleActionDownWhenPreItemShow = z16;
        }
    }
    ...
    public void showSpecificRightView(View view) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public void setAdapter(ListAdapter listAdapter) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 4)) {
            iPatchRedirector.redirect((short) 4, (Object) this, (Object) listAdapter);
            return;
        }
        super.setAdapter(listAdapter);
        if (listAdapter instanceof SwipListListener) {
            this.mListener = (SwipListListener) listAdapter;
        }
    }
    ...
    public SwipListView(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.mHandleActionDownWhenPreItemShow = true;
