...
public class QQAVImageDenoiseGaussianBlurFilter extends QQAVImageTwoPassTextureSamplingFilter {
    ...
    public void setRadiusInPixels(float f16) {
        if (Math.round(f16) != this.mRadiusInPixels) {
            ...
            runOnDraw(new Runnable() { // from class: com.tencent.av.video.effect.core.qqavimage.denoise.QQAVImageDenoiseGaussianBlurFilter.1
                ...
                public void run() {
                    if (((QQAVImageFilterGroup) QQAVImageDenoiseGaussianBlurFilter.this).mFilters != null) {
                        for (int i3 = 0; i3 < ((QQAVImageFilterGroup) QQAVImageDenoiseGaussianBlurFilter.this).mFilters.size(); i3++) {
                            ((QQAVImageFilter) ((QQAVImageFilterGroup) QQAVImageDenoiseGaussianBlurFilter.this).mFilters.get(i3)).init();
                            ((QQAVImageFilter) ((QQAVImageFilterGroup) QQAVImageDenoiseGaussianBlurFilter.this).mFilters.get(i3)).onOutputSizeChanged(((QQAVImageFilter) QQAVImageDenoiseGaussianBlurFilter.this).mOutputWidth, ((QQAVImageFilter) QQAVImageDenoiseGaussianBlurFilter.this).mOutputHeight);
                            QQAVImageDenoiseGaussianBlurFilter qQAVImageDenoiseGaussianBlurFilter = QQAVImageDenoiseGaussianBlurFilter.this;
                            qQAVImageDenoiseGaussianBlurFilter.onOutputSizeChanged(((QQAVImageFilter) qQAVImageDenoiseGaussianBlurFilter).mOutputWidth, ((QQAVImageFilter) QQAVImageDenoiseGaussianBlurFilter.this).mOutputHeight);
                        }
                    }
                }
            });
    ...
    public QQAVImageDenoiseGaussianBlurFilter(float f16) {
