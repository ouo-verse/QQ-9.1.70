...
public class af extends x {
    ...
    public af(Context context, VideoAppInterface videoAppInterface) {
        super(context, videoAppInterface);
    }

    private void m(GLVideoView gLVideoView, GLVideoView gLVideoView2, int i3) {
        int i16 = i3 >> 1;
        int n3 = z.n(i3);
        gLVideoView.O(0, 0, 0, 0);
        gLVideoView.q(i16, 0, i3, n3);
        gLVideoView.I(-15197410);
        gLVideoView2.O(0, 0, 0, 0);
        gLVideoView2.q(0, 0, i16, n3);
    ...
    public void h(GLVideoView[] gLVideoViewArr, int i3, int i16, int i17, int i18, int i19, boolean z16) {
        ...
        AVCoreLog.printColorLog("ScreenLayoutSmallUIDouble", "layoutCommon: " + z16 + "|" + z17);
        if (z17) {
            z16 = !z16;
        }
        ...
        if (z16) {
            m(gLVideoViewArr[0], gLVideoViewArr[1], i3);
        } else {
            m(gLVideoViewArr[1], gLVideoViewArr[0], i3);
        }
    }
}
