...
public class aa extends x {
    ...
    public aa(Context context, VideoAppInterface videoAppInterface) {
    ...
    private void m(GLVideoView gLVideoView, GLVideoView gLVideoView2, int i3, int i16) {
        ...
        if (FoldInfoUtils.j(this.f76644a)) {
            gLVideoView.q(i18, 0, i3, i17);
            gLVideoView2.q(i18, i17, i3, i16);
            gLVideoView2.P(270);
        } else {
            gLVideoView.q(0, 0, i18, i17);
            gLVideoView2.q(0, i17, i18, i16);
            gLVideoView2.P(90);
        }
    }
    ...
    public void h(GLVideoView[] gLVideoViewArr, int i3, int i16, int i17, int i18, int i19, boolean z16) {
        ...
        AVCoreLog.printColorLog("ScreenLayoutDoubleVerticalFoldingScreen", "layoutCommon: " + z16 + "|" + z17);
        if (!z17) {
