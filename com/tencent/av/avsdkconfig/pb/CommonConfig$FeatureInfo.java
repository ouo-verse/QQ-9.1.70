...
public final class CommonConfig$FeatureInfo extends MessageMicro<CommonConfig$FeatureInfo> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 32, 40}, new String[]{"feature_name", "feature_attribute_1", "feature_attribute_2", "feature_time", "feature_qp"}, new Object[]{"", "", "", 0L, 0L}, CommonConfig$FeatureInfo.class);
