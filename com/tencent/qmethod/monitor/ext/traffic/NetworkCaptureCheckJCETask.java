...
public final class NetworkCaptureCheckJCETask extends NetworkCaptureBaseTask {
    ...
    public void e() {
        ...
        if (this.reqBody != null) {
            ...
            jSONObject2.put("reqBody", new String(this.reqBody, Charsets.UTF_8));
            b(jSONObject2, jSONObject);
            this.httpBody = jSONObject.getString("reqBody");
        }
        try {
            if (!m().isEmpty()) {
                if (com.tencent.qmethod.monitor.a.f343451h.g().getDebug()) {
                    o.a("NetworkCapture", "issueNetUrlJce = " + getUrl());
                    StringBuilder sb5 = new StringBuilder();
                    sb5.append("issueNetTypeJce = ");
                    ...
                    o.a("NetworkCapture", "issueNetDataJce = " + i().toString());
                    o.a("NetworkCapture", "issueNetStackJce = " + getStack());
                }
                if (f()) {
                    if (com.tencent.qmethod.monitor.a.f343451h.g().getDebug()) {
                        o.a("NetworkCapture", "issueNetUrlJce filterSameQuestion = $" + o());
                        return;
                    }
                    return;
                }
            ...
            o.d("NetworkCapture", "issueNetDataJce decodeFail " + getUrl(), e16);
        }
    }
    ...
    public JSONObject i() {
        JSONObject jSONObject = new JSONObject();
        if (this.reqBody != null) {
            jSONObject.put("JCE_Buffer", this.httpBody);
        }
        return jSONObject;
    }
