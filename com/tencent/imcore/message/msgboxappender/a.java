...
public class a implements b {
    ...
    public Object[] a(IMessageManager iMessageManager, MessageRecord messageRecord, EntityManager entityManager, Map<String, RecentUser> map, RecentUserProxy recentUserProxy, IConversationFacade iConversationFacade, String str, int i3, long j3) {
        ...
        if (ao.c(messageRecord.istroop) == 1032) {
            if (ConfessMsgUtil.f(messageRecord)) {
                ((C2CMessageManager) iMessageManager).B0(messageRecord, AppConstants.CONFESS_UIN, messageRecord.frienduin);
            }
            return new Object[]{Boolean.TRUE, AppConstants.CONFESS_UIN, 1032, Long.valueOf(messageRecord.time)};
        }
