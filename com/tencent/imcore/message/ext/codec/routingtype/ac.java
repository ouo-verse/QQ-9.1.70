...
public class ac implements com.tencent.imcore.message.core.codec.d<AppInterface> {
    ...
    public int a() {
        ...
        return MessageHandlerConstants.NOTIFY_TYPE_SQUARE_CHAT_ERROR_RSP;
    }
    ...
    public boolean c(msg_svc$RoutingHead msg_svc_routinghead, MessageRecord messageRecord, AppInterface appInterface) {
        ...
        msg_svc_commtmp.svr_type.set(173);
        msg_svc_commtmp.to_uin.set(Long.valueOf(messageRecord.frienduin).longValue());
        byte[] Y0 = ((QQAppInterface) appInterface).getMsgCache().Y0(messageRecord.frienduin, messageRecord.selfuin);
        if (Y0 != null) {
            msg_svc_commtmp.sig.set(ByteStringMicro.copyFrom(Y0));
        }
