...
public class a implements com.tencent.imcore.message.core.codec.d<AppInterface> {
    ...
    public boolean c(msg_svc$RoutingHead msg_svc_routinghead, MessageRecord messageRecord, AppInterface appInterface) {
        ...
        msg_svc_commtmp.svr_type.set(144);
        msg_svc_commtmp.to_uin.set(Long.valueOf(messageRecord.frienduin).longValue());
        byte[] f06 = ((QQAppInterface) appInterface).getMsgCache().f0(messageRecord.frienduin);
        if (f06 != null) {
            msg_svc_commtmp.sig.set(ByteStringMicro.copyFrom(f06));
        }
