...
public class j implements com.tencent.imcore.message.core.codec.d<AppInterface> {
    ...
    public boolean c(msg_svc$RoutingHead msg_svc_routinghead, MessageRecord messageRecord, AppInterface appInterface) {
        ...
        msg_svc$Dis msg_svc_dis = new msg_svc$Dis();
        msg_svc_dis.dis_uin.set(Long.valueOf(messageRecord.frienduin).longValue());
        msg_svc_routinghead.dis.set(msg_svc_dis);
        return true;
    }
