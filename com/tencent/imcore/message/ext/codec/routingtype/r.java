...
public class r implements com.tencent.imcore.message.core.codec.d<AppInterface> {
    ...
    public int a() {
        ...
        return MessageHandlerConstants.NOTIFY_TYPE_MATCH_CHAT_ERROR_RSP;
    }
    ...
    public boolean c(msg_svc$RoutingHead msg_svc_routinghead, MessageRecord messageRecord, AppInterface appInterface) {
        ...
        msg_svc_commtmp.svr_type.set(163);
        msg_svc_commtmp.to_uin.set(Long.valueOf(messageRecord.frienduin).longValue());
        byte[] G0 = ((QQAppInterface) appInterface).getMsgCache().G0(messageRecord.frienduin, messageRecord.selfuin);
        if (G0 != null) {
            msg_svc_commtmp.sig.set(ByteStringMicro.copyFrom(G0));
        }
