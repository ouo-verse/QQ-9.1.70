...
public class ap implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(QQAppInterface qQAppInterface, MsgType0x210 msgType0x210) {
        ((ISttManagerService) qQAppInterface.getRuntimeService(ISttManagerService.class)).onSttResultPush(msgType0x210.vProtobuf);
    }
