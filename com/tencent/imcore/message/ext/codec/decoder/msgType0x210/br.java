...
public class br implements a<com.tencent.imcore.message.af> {
    ...
    public MessageRecord decode(com.tencent.imcore.message.af afVar, MsgType0x210 msgType0x210, long j3, byte[] bArr, MsgInfo msgInfo) {
        ...
        b(afVar, msgType0x210.vProtobuf, msgInfo.uRealMsgTime);
        return null;
    }

    public static void b(com.tencent.imcore.message.af afVar, byte[] bArr, long j3) {
    }
}
