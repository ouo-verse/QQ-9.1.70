...
public class bc implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(QQAppInterface qQAppInterface, MsgInfo msgInfo, MsgType0x210 msgType0x210) {
        if (QLog.isColorLevel()) {
            QLog.d(IQWalletHelper.TAG_WALLET_PUSH, 2, "receive msg0x210submsg0x7e");
        }
        ((IQWalletPushApi) QRoute.api(IQWalletPushApi.class)).parseMsg0x210Sub0x7e(qQAppInterface, msgType0x210.vProtobuf, msgInfo.lFromUin, msgInfo.shMsgSeq, msgInfo.lMsgUid, msgInfo.shMsgType);
    }
