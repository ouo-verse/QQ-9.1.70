...
public class az implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(QQAppInterface qQAppInterface, MsgType0x210 msgType0x210) {
        ((QPayHandler) qQAppInterface.getBusinessHandler(BusinessHandlerFactory.QPAY_HANDLER)).D2(msgType0x210.vProtobuf);
    }
