...
public class cg implements a<com.tencent.imcore.message.af> {
    ...
    public MessageRecord decode(com.tencent.imcore.message.af afVar, MsgType0x210 msgType0x210, long j3, byte[] bArr, MsgInfo msgInfo) {
        ...
        com.tencent.mobileqq.service.message.p.I(msgInfo.lFromUin, msgInfo.shMsgSeq, msgInfo.lMsgUid, msgInfo.shMsgType, ((QQAppInterface) afVar.d()).getMsgHandler().getApp());
        return null;
    }
}
