...
public class h implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(com.tencent.imcore.message.af afVar, MsgType0x210 msgType0x210) {
        ...
        try {
            submsgtype0x11b$MsgBody submsgtype0x11b_msgbody = new submsgtype0x11b$MsgBody();
            if (afVar.L(msgType0x210)) {
                submsgtype0x11b_msgbody.mergeFrom(msgType0x210.vProtobuf);
                com.tencent.mobileqq.msgbackup.authentication.c.b().d(submsgtype0x11b_msgbody);
            }
        } catch (Exception e16) {
            QLog.e("Q.msg.BaseMessageProcessor", 1, "[msg0x210.uSubMsgType == 0x11b], errInfo->" + e16.getMessage());
        }
    }
