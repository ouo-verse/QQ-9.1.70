...
public class bo implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(QQAppInterface qQAppInterface, MsgType0x210 msgType0x210) {
        ...
        try {
            SubMsgType0xab$MsgBody subMsgType0xab$MsgBody = new SubMsgType0xab$MsgBody();
            subMsgType0xab$MsgBody.mergeFrom(msgType0x210.vProtobuf);
            com.tencent.mobileqq.troop.utils.az.e(qQAppInterface, subMsgType0xab$MsgBody);
        } catch (Exception e16) {
            if (QLog.isColorLevel()) {
                QLog.w(".troop.troop_reward.push", 2, "onLinePush 0x210_0xab push exception", e16);
            }
        }
    }
