...
public class bz implements a<com.tencent.imcore.message.af> {
    ...
    public MessageRecord decode(com.tencent.imcore.message.af afVar, MsgType0x210 msgType0x210, long j3, byte[] bArr, MsgInfo msgInfo) {
        ...
        ((WerewolvesHandler) afVar.d().getBusinessHandler(BusinessHandlerFactory.WEREWOLVES_HANDLER)).D2(msgType0x210.vProtobuf);
        return null;
    }
}
