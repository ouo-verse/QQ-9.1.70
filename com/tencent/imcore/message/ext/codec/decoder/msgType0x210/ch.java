...
public class ch implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(QQAppInterface qQAppInterface, MsgType0x210 msgType0x210) {
        ...
        ((MsgBoxInterFollowManager) qQAppInterface.getManager(QQManagerFactory.MSG_BOX_INTERACT_MANAGER)).decode0xfeInteractAndFollowMsg(msgType0x210.vProtobuf);
    }
