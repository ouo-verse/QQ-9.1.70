...
public class o implements a<com.tencent.imcore.message.af> {
    ...
    private static void b(QQAppInterface qQAppInterface, MsgType0x210 msgType0x210) {
        ...
        Face2FaceAddContactHandler face2FaceAddContactHandler = (Face2FaceAddContactHandler) qQAppInterface.getBusinessHandler(BusinessHandlerFactory.FACE2FACE_ADD_FRIEND_HANDLER);
        if (face2FaceAddContactHandler != null) {
            face2FaceAddContactHandler.D2(msgType0x210.vProtobuf);
        }
    }
