...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    public BaseWXApiImplV10(Context context, String str, boolean z16, int i3) {
        this.checkSignature = false;
        this.launchMode = 2;
        Log.d(TAG, "<init>, appId = " + str + ", checkSignature = " + z16 + ", launchMode = " + i3);
        this.context = context;
        this.appId = str;
        this.checkSignature = z16;
        this.launchMode = i3;
        b.f151806a = context.getApplicationContext();
    }
    ...
    private String getTokenFromWX(Context context) {
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638058496"}, null);
    ...
    private boolean handleWxInternalRespType(String str, IWXAPIEventHandler iWXAPIEventHandler) {
        ...
        try {
            ...
            Log.e(TAG, "handleWxInternalRespType fail, ex = " + e16.getMessage());
        }
        ...
        resp5.errStr = parse.getQueryParameter(HippyReporter.EXTRA_KEY_REPORT_ERRMSG);
    ...
    private void launchWXUsingPendingIntent() {
        if (!this.detached) {
            ...
            try {
                ...
                PendingIntent.getActivity(this.context, 1, InstalledAppListMonitor.getLaunchIntentForPackage(this.context.getPackageManager(), "com.tencent.mm"), 134217728).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
                    @Override // android.app.PendingIntent.OnFinished
                    public void onSendFinished(PendingIntent pendingIntent, Intent intent, int i3, String str, Bundle bundle) {
                        Log.d(BaseWXApiImplV10.TAG, "onSendFinished resultCode: " + i3 + ", resultData: " + str);
                    }
                }, null);
                return;
            } catch (Exception e16) {
                Log.e(TAG, "launchWXUsingPendingIntent pendingIntent send failed: " + e16.getMessage());
                openWXApp();
                return;
            }
        }
    ...
    private boolean sendAddCardToWX(Context context, Bundle bundle) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/addCardToWX"), null, null, new String[]{this.appId, bundle.getString("_wxapi_add_card_to_wx_card_list"), bundle.getString("_wxapi_basereq_transaction")}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendFinderOpenFeed(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/finderOpenFeed"), null, null, new String[]{this.appId, req.feedID, req.nonceID, String.valueOf(req.notGetReleatedList)}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendFinderOpenLive(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/finderOpenLive"), null, null, new String[]{this.appId, req.feedID, req.nonceID}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendFinderOpenProfile(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/finderOpenProfile"), null, null, new String[]{this.appId, ((WXChannelOpenProfile.Req) baseReq).userName}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendFinderShareVideo(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/finderShareVideo"), null, null, new String[]{this.appId, req.videoPath, "", "", req.extData, finderShareVideoJumpInfoToString(req.jumpInfo)}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendHandleScanResult(Context context, Bundle bundle) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/handleScanResult"), null, null, new String[]{this.appId, bundle.getString("_wxapi_scan_qrcode_result")}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendInvoiceAuthInsert(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, String.valueOf(2), URLEncoder.encode(String.format("url=%s", URLEncoder.encode(((WXInvoiceAuthInsert.Req) baseReq).url)))}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendJumpToOfflinePayReq(Context context, Bundle bundle) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/jumpToOfflinePay"), null, null, new String[]{this.appId}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendLaunchWXMiniprogram(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/launchWXMiniprogram"), null, null, new String[]{this.appId, req.userName, req.path, req.miniprogramType + "", req.extData}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendLaunchWXMiniprogramWithToken(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/launchWXMiniprogramWithToken"), null, null, new String[]{this.appId, ((WXLaunchMiniProgramWithToken.Req) baseReq).token}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendNonTaxPay(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, String.valueOf(3), URLEncoder.encode(String.format("url=%s", URLEncoder.encode(((WXNontaxPay.Req) baseReq).url)))}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendOpenBusinessView(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openBusinessView"), null, null, new String[]{this.appId, req.businessType, req.query, req.extInfo, req.transaction, req.openId}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendOpenBusinessWebview(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(contentResolver, parse, null, null, new String[]{this.appId, req.businessType + "", str}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendOpenCustomerServiceChat(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openCustomerServiceChat"), null, null, new String[]{this.appId, req.corpId, req.url}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendOpenRankListReq(Context context, Bundle bundle) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openRankList"), null, null, new String[0], null);
        if (query != null) {
            query.close();
            return true;
        }
    ...
    private boolean sendOpenWebview(Context context, Bundle bundle) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openWebview"), null, null, new String[]{this.appId, bundle.getString("_wxapi_jump_to_webview_url"), bundle.getString("_wxapi_basereq_transaction")}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendPayInSurance(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, String.valueOf(4), URLEncoder.encode(String.format("url=%s", URLEncoder.encode(((WXPayInsurance.Req) baseReq).url)))}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendPayReq(Context context, Bundle bundle) {
        if (wxappPayEntryClassname == null) {
            ...
            if (wxappPayEntryClassname == null) {
                try {
                    ...
                    Log.e(TAG, "get from metaData failed : " + e16.getMessage());
                }
            }
            if (wxappPayEntryClassname == null) {
        ...
        try {
            ...
            Log.e(TAG, "getTokenFromWX fail, exception = " + e17);
        }
    ...
    private boolean sendPreloadWXMiniProgramEnvironment(Context context, BaseReq baseReq) {
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/preloadWXMiniprogramEnvironment"), null, null, new String[]{this.appId, ((WXPreloadMiniProgramEnvironment.Req) baseReq).extData}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendPreloadWXMiniprogram(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/preloadWXMiniprogram"), null, null, new String[]{this.appId, req.userName, req.path, req.miniprogramType + "", req.extData}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendQRCodePayReq(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/QRCodePay"), null, null, new String[]{this.appId, req.codeContent, req.extraMsg}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendSubscribeMessage(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, String.valueOf(1), String.valueOf(req.scene), req.templateID, req.reserved}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendSubscribeMiniProgramMsg(Context context, BaseReq baseReq) {
        launchWXIfNeed();
        Cursor query = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.tencent.mm.sdk.comm.provider/openTypeWebview"), null, null, new String[]{this.appId, String.valueOf(5), ((SubscribeMiniProgramMsg.Req) baseReq).miniProgramAppId}, null);
        if (query != null) {
            query.close();
        }
        return true;
    ...
    private boolean sendToWxaRedirectingPage(Context context, BaseReq baseReq) {
        ...
        Cursor query = ContactsMonitor.query(contentResolver, parse, null, null, (String[]) arrayList.toArray(new String[0]), null);
        if (query != null) {
            query.close();
            return true;
        }
    ...
    public int getWXAppSupportAPI() {
        if (!this.detached) {
            ...
            b.f151810e.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
                ...
                public void run() {
                    try {
                        ...
                        Log.w(BaseWXApiImplV10.TAG, e16.getMessage());
                    }
            ...
            if (this.wxSdkVersion == 0) {
                try {
                    ...
                    Log.e(TAG, "get from metaData failed : " + e17.getMessage());
                }
            }
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.e(TAG, "handleIntent fail, ex = " + e16.getMessage());
        }
                        ...
                        if (str != null && str.contains("openbusinesswebview")) {
                            try {
                                ...
                                if (parse != null && "openbusinesswebview".equals(parse.getHost())) {
                                    ...
                                    resp.errStr = parse.getQueryParameter(HippyReporter.EXTRA_KEY_REPORT_ERRMSG);
                                ...
                                Log.e(TAG, "parse fail, ex = " + e17.getMessage());
                            }
                        }
    ...
    public boolean isWXAppInstalled() {
        if (!this.detached) {
            try {
                PackageInfo packageInfo = InstalledAppListMonitor.getPackageInfo(this.context.getPackageManager(), "com.tencent.mm", 64);
                if (packageInfo == null) {
                    return false;
                }
        ...
        if (!this.detached) {
            if (!isWXAppInstalled()) {
                ...
                try {
                    ...
                    context.startActivity(InstalledAppListMonitor.getLaunchIntentForPackage(context.getPackageManager(), "com.tencent.mm"));
                    return true;
                } catch (Exception e16) {
                    str = "startActivity fail, exception = " + e16.getMessage();
                }
            }
            Log.e(TAG, str);
            return false;
                ...
                if (!baseReq.checkArgs()) {
                    ...
                    if (baseReq.getType() != 5 && baseReq.getType() != 27) {
                        ...
                        try {
                            ...
                            Log.e(TAG, "getTokenFromWX fail, exception = " + e16);
                        }
    ...
    public void unregisterApp() {
        if (!this.detached) {
            ...
            if (str != null && str.length() != 0) {
                ...
                a.C7048a c7048a = new a.C7048a();
                c7048a.f151765a = "com.tencent.mm";
                c7048a.f151766b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
                c7048a.f151767c = "weixin://unregisterapp?appid=" + this.appId;
                a.a(this.context, c7048a);
                return;
            }
    ...
    @Override // com.tencent.mm.opensdk.openapi.IWXAPI
    public boolean registerApp(String str, long j3) {
        if (this.detached) {
        ...
        a.C7048a c7048a = new a.C7048a();
        c7048a.f151765a = "com.tencent.mm";
        c7048a.f151766b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c7048a.f151767c = "weixin://registerapp?appid=" + this.appId;
        c7048a.f151768d = j3;
        return a.a(this.context, c7048a);
    }
}
