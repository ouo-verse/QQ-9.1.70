...
public class EdgeIndependentCloudPolicyRankEvent extends TEdgeBaseEvent {
    static IPatchRedirector $redirector_ = null;
    public static final String EVENT_NAME = "edge_independent_cloud_and_policy_rank";
    public List<EdgeItem> itemList;

    public EdgeIndependentCloudPolicyRankEvent(h hVar) {
    ...
    public EdgeIndependentCloudPolicyRankEvent(h hVar, EdgeAction edgeAction) {
        IPatchRedirector iPatchRedirector = $redirector_;
