...
public class EdgeClientRankEvent extends TEdgeBaseEvent {
    static IPatchRedirector $redirector_ = null;
    public static final String EVENT_NAME = "edge_client_rank";
    public List<EdgeItem> itemList;

    public EdgeClientRankEvent(h hVar) {
    ...
    public EdgeClientRankEvent(h hVar, EdgeAction edgeAction) {
        IPatchRedirector iPatchRedirector = $redirector_;
