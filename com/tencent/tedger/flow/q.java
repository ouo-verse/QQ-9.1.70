...
public class q extends r {
    ...
    public q(com.tencent.tedgecontext.a aVar) {
        super(aVar);
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, (Object) this, (Object) aVar);
        } else {
            this.f375234b = "sdk.user_center.sdk_user_center_action_type";
        }
    }
    ...
    public void v(com.tencent.tedger.outapi.api.f fVar) {
        ...
        if (!getRouter().a() && (fVar instanceof EdgeUserActionEvent) && fVar.getAction() != null) {
            EdgeStatus edgeStatus = new EdgeStatus();
            J(fVar);
            if (getRouter().f375307e != null) {
                getRouter().f375307e.d(fVar.getAction(), edgeStatus);
            }
        }
    }
}
