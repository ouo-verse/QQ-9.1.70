...
abstract class ZipUtils {
    ...
    static long getZipEocdCentralDirectorySize(ByteBuffer byteBuffer) {
        assertByteOrderLittleEndian(byteBuffer);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static final boolean isZip64EndOfCentralDirectoryLocatorPresent(RandomAccessFile randomAccessFile, long j3) throws IOException {
        long j16 = j3 - 20;
        if (j16 < 0) {
            return false;
        }
