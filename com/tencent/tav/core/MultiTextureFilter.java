...
public class MultiTextureFilter {
    ...
    public TextureInfo applyFilter(TextureInfo textureInfo, Matrix matrix, Matrix matrix2, float f16, CGRect cGRect) {
        ...
        float f17 = cGRect3.origin.x + cGRect3.size.width;
        int i3 = textureInfo.width;
        if (f17 > i3) {
            f17 = i3;
            Log.e(TAG, "applyFilter: crop right pixel exceed texture width");
        }
        float f18 = cGRect3.origin.y + cGRect3.size.height;
        ...
        if (multiTextureFilter != null) {
            multiTextureFilter.applyFilter(this._textureInfo, matrix, matrix2, f16, cGRect3);
        }
    ...
    public MultiTextureFilter mo256clone() {
        ...
        if (multiTextureFilter2 != null) {
            multiTextureFilter.setSubFilter(multiTextureFilter2.mo256clone());
        }
