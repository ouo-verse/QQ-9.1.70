...
public final class GuildMsgRepoDelegate$loadFirstPage$1$1 extends Lambda implements Function1<com.tencent.aio.msgservice.h<com.tencent.aio.data.msglist.a>, Unit> {
    final /* synthetic */ String $source;
    final /* synthetic */ GuildMsgRepoDelegate this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildMsgRepoDelegate$loadFirstPage$1$1(String str, GuildMsgRepoDelegate guildMsgRepoDelegate) {
        super(1);
        this.$source = str;
    ...
    public static final void b(String source, GuildMsgRepoDelegate this$0, com.tencent.aio.msgservice.h rsp) {
    ...
    public final void invoke2(@NotNull final com.tencent.aio.msgservice.h<com.tencent.aio.data.msglist.a> rsp) {
        ...
        a.C11711a.b(a16, new Runnable() { // from class: com.tencent.guild.aio.factory.business.holder.msglist.data.guild.u
            @Override // java.lang.Runnable
            public final void run() {
                GuildMsgRepoDelegate$loadFirstPage$1$1.b(str, guildMsgRepoDelegate, rsp);
            }
        }, null, 2, null);
    }
}
