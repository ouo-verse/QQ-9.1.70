package com.tencent.guild.aio.msglist.unsupport;
    ...
    public void b1(int position, @NotNull com.tencent.aio.data.msglist.a msgItem, @NotNull List<Object> payloads) {
        ...
        if (!((IAppSetting) QRoute.api(IAppSetting.class)).mo112public()) {
            if (msgItem instanceof GuildMsgItem) {
                i1().setText("\u4e0d\u652f\u6301\u7684\u6d88\u606f\u7c7b\u578b msgType: " + ((GuildMsgItem) msgItem).getMsgRecord().msgType);
                return;
            }
            i1().setText("\u4e0d\u652f\u6301\u7684\u6d88\u606f\u7c7b\u578b");
            return;
        }
        i1().setText("\u5f53\u524d\u7248\u672c\u6682\u4e0d\u652f\u6301\u8be5\u6d88\u606f");
    }
