...
public final class GuildMsgNoticeDefaultSettingsGrayTipsComponent extends com.tencent.guild.aio.msglist.holder.component.a {
    ...
    public GuildMsgNoticeDefaultSettingsGrayTipsComponent(@NotNull View root) {
        Lazy lazy;
        Intrinsics.checkNotNullParameter(root, "root");
        this.root = root;
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<s>() { // from class: com.tencent.guild.aio.msglist.graytips.local.msgnitify.GuildMsgNoticeDefaultSettingsGrayTipsComponent$mBinding$2
            ...
            public final s invoke() {
                return s.g(LayoutInflater.from(GuildMsgNoticeDefaultSettingsGrayTipsComponent.this.getRoot().getContext()));
            }
        });
        this.mBinding = lazy;
    }
    ...
    private final void l1() {
        ...
        ((IGuildDTReportApi) QRoute.api(IGuildDTReportApi.class)).setElementExposureAndClickParams(j1().getRoot(), "em_aio_graytext", hashMap);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public final void m1(int position, com.tencent.aio.data.msglist.a msgItem, List<Object> payloads) {
        QLog.i("GuildMsgNoticeDefaultSettingsGrayTipsComponent", 1, "initUI position=" + position);
        ...
        ImageView imageView = j1().f442023b;
    ...
    public void b1(final int position, @NotNull final com.tencent.aio.data.msglist.a msgItem, @NotNull final List<Object> payloads) {
        ...
        if (k1(payloads)) {
            n1(msgItem, new Function0<Unit>() { // from class: com.tencent.guild.aio.msglist.graytips.local.msgnitify.GuildMsgNoticeDefaultSettingsGrayTipsComponent$bind$1
                /* JADX INFO: Access modifiers changed from: package-private */
                ...
                public final void invoke2() {
                    GuildMsgNoticeDefaultSettingsGrayTipsComponent.this.m1(position, msgItem, payloads);
                }
            });
        }
    }
