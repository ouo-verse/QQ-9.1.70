...
public final class GuildMsgItemComponentProvider implements com.tencent.guild.aio.msglist.holder.config.d {
    ...
    public GuildMsgItemComponentProvider(@NotNull View root, @NotNull Function1<? super View, ? extends a> avatarComponentGetter, @NotNull Function1<? super View, ? extends a> nickComponentGetter, @NotNull Function1<? super View, ? extends a> statusComponentGetter, @NotNull Function1<? super View, ? extends a> contentComponentGetter, @NotNull Function1<? super View, ? extends a> tailComponentGetter, @NotNull Function1<? super View, ? extends a> selectComponentGetter, @NotNull Function1<? super View, ? extends a> replyComponentGetter, @NotNull Function1<? super View, ? extends a> newMsgLineComponentGetter, @NotNull Function1<? super View, ? extends a> msgReactionComponentGetter, @NotNull Function1<? super View, ? extends a> replyAndContentContainerGetter) {
        ...
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<SparseArray<a>>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider$componentList$2
            ...
            public final SparseArray<a> invoke() {
                ...
                GuildMsgItemComponentProvider guildMsgItemComponentProvider = GuildMsgItemComponentProvider.this;
                sparseArray.put(0, guildMsgItemComponentProvider.a().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(1, guildMsgItemComponentProvider.f().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(2, guildMsgItemComponentProvider.k().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(3, guildMsgItemComponentProvider.c().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(4, guildMsgItemComponentProvider.l().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(6, guildMsgItemComponentProvider.j().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(8, guildMsgItemComponentProvider.h().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(7, guildMsgItemComponentProvider.e().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(5, guildMsgItemComponentProvider.d().invoke(guildMsgItemComponentProvider.getRoot()));
                sparseArray.put(9, guildMsgItemComponentProvider.g().invoke(guildMsgItemComponentProvider.getRoot()));
                return sparseArray;
            }
        });
    ...
    public /* synthetic */ GuildMsgItemComponentProvider(final View view, Function1 function1, Function1 function12, Function1 function13, Function1 function14, Function1 function15, Function1 function16, Function1 function17, Function1 function18, Function1 function19, Function1 function110, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(view, (i3 & 2) != 0 ? new Function1<View, GuildBubbleAvatarComponent>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.1
        ...
        } : function1, (i3 & 4) != 0 ? new Function1<View, com.tencent.guild.aio.msglist.holder.component.nick.c>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            @Override // kotlin.jvm.functions.Function1
            @NotNull
            public final com.tencent.guild.aio.msglist.holder.component.nick.c invoke(@NotNull View it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return new com.tencent.guild.aio.msglist.holder.component.nick.c(view);
            }
        } : function12, (i3 & 8) != 0 ? new Function1<View, GuildBubbleMsgStatusComponent>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        } : function13, (i3 & 16) != 0 ? new Function1<View, GuildBubbleContentComponent>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        } : function14, (i3 & 32) != 0 ? new Function1<View, GuildBubbleTailComponent>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.5
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        } : function15, (i3 & 64) != 0 ? new Function1<View, GuildBubbleCheckBoxComponent>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.6
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        } : function16, (i3 & 128) != 0 ? new Function1() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.7
            @Override // kotlin.jvm.functions.Function1
            @Nullable
        ...
        } : function17, (i3 & 256) != 0 ? new Function1<View, GuildBubbleNewMsgLineComponent>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.8
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        } : function18, (i3 & 512) != 0 ? new Function1<View, p>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.9
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        } : function19, (i3 & 1024) != 0 ? new Function1<View, hq0.a>() { // from class: com.tencent.guild.aio.msglist.holder.component.GuildMsgItemComponentProvider.10
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
