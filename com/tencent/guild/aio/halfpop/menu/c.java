...
public class c extends t {
    ...
    public void b(@NotNull View view, @NotNull GuildMsgItem data) {
        ...
        QLog.i("ChosenMultiSelectActionItem", 4, "onItemClick");
    ...
    public boolean a(@NotNull GuildMsgItem data) {
        Intrinsics.checkNotNullParameter(data, "data");
        Boolean hasPermission = ((IQQGuildUtilApi) QRoute.api(IQQGuildUtilApi.class)).hasTargetSecondaryPermission(30001, w(), u());
        QLog.i("ChosenMultiSelectActionItem", 4, "hasPermission=" + hasPermission);
    ...
    public /* synthetic */ c(t.ItemData itemData, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? new t.ItemData(R.drawable.qui_tick_circle, R.string.f16494277) : itemData);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public c(@NotNull t.ItemData itemData) {
        super(itemData);
