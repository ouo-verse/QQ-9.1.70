...
public abstract class LinearSmoothScroller extends RecyclerViewBase.SmoothScroller {
    ...
    public int calculateDxToMakeVisible(View view, int i3) {
        RecyclerViewBase.LayoutManager layoutManager = getLayoutManager();
    ...
    @Override // com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller
    protected void onSeekTargetStep(int i3, int i16, RecyclerViewBase.State state, RecyclerViewBase.SmoothScroller.Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    @Override // com.tencent.mtt.supportui.views.recyclerview.RecyclerViewBase.SmoothScroller
    protected void onTargetFound(View view, RecyclerViewBase.State state, RecyclerViewBase.SmoothScroller.Action action) {
    ...
    protected void updateActionForInterimTarget(RecyclerViewBase.SmoothScroller.Action action) {
