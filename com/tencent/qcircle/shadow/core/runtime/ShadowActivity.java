...
public abstract class ShadowActivity extends PluginActivity {
    ...
    @Override // com.tencent.qcircle.shadow.core.runtime.PluginActivity
    ...
    public void setContentView(int i3) {
        if (DeviceType.DeviceCategory.MERGER.equals(XmlPullParserUtil.getLayoutStartTagName(getResources(), i3))) {
            LayoutInflater.from(this).inflate(i3, (ViewGroup) this.mHostActivityDelegator.getWindow().getDecorView().findViewById(android.R.id.content));
        } else {
