...
public class DefaultObjectWrapper<T> implements ObjectWrapper<T> {
    static IPatchRedirector $redirector_;
    private final InjectConstructor<T> constructor;

    public DefaultObjectWrapper(InjectConstructor<T> injectConstructor) {
    ...
    public ObjectWrapper<T> combine(T t16) {
        ...
        return new FixObjectWrapper(t16);
    }
