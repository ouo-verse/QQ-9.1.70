...
public final class XmlElement implements Serializable {
    ...
    public XmlElement(long j3, long j16, int i3, int i16, int i17, String str, Long l3, Long l16, HashMap<String, String> hashMap, byte[] bArr, HashMap<String, String> hashMap2) {
        this.serialVersionUID = 1L;
        this.busiType = j3;
        this.busiId = j16;
        this.c2cType = i3;
