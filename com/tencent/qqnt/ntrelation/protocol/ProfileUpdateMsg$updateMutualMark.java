...
public final class ProfileUpdateMsg$updateMutualMark extends MessageMicro<ProfileUpdateMsg$updateMutualMark> {
    ...
    public ProfileUpdateMsg$ResourceInfo resourceInfo = new ProfileUpdateMsg$ResourceInfo();
    public ProfileUpdateMsg$ResourceInfo gradeResourceInfo = new ProfileUpdateMsg$ResourceInfo();
