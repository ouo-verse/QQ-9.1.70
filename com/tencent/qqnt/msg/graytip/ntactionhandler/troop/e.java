...
public final class e implements a {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/qqnt/msg/graytip/ntactionhandler/troop/e$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "AQQLiteModule_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.qqnt.msg.graytip.ntactionhandler.troop.e$a, reason: from kotlin metadata */
    /* loaded from: classes24.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(64005);
    ...
    public void a(@NotNull AppRuntime app, @NotNull Context context, int jp5, @NotNull String param, @NotNull JsonGrayElement jsonGrayElement, @Nullable gv3.a aioAbility) {
        ...
        try {
            ...
            if (app instanceof QQAppInterface) {
                ...
                if (z16 && (c16 = bi.c((BaseQQAppInterface) app, context, str)) != null) {
                    c16.z();
                    c16.b();
                }
            }
        } catch (Exception e16) {
            QLog.e("TroopJumpSchemeProcessor", 1, "handleOnClick error! e = " + e16.getMessage());
        }
    }
}
