...
public final class GroupSchoolNoticeContent {
    ...
    public GroupSchoolNoticeContent(String str, String str2, ArrayList<GroupSchoolNoticeMediaContent> arrayList, ArrayList<GroupSchoolNoticeMediaContent> arrayList2, ArrayList<GroupSchoolNoticeMediaContent> arrayList3, ArrayList<GroupSchoolNoticeMediaContent> arrayList4, boolean z16) {
        this.title = "";
        this.content = "";
        this.pics = new ArrayList<>();
        this.audios = new ArrayList<>();
