...
public final class NTGetAllAlbumListRsp {
    ...
    public NTGetAllAlbumListRsp(int i3, int i16, String str, String str2, RequestTimelineInfo requestTimelineInfo, ArrayList<GetAllAlbumListItem> arrayList, String str3, boolean z16) {
        this.errMs = "";
        this.traceId = "";
        this.requestTimeLine = new RequestTimelineInfo();
        new ArrayList();
