...
public final class RDeliveryConfig implements IKernelModel {
    ...
    public void setSystemId(int i3) {
        this.systemId = i3;
    }
    ...
    public RDeliveryConfig(String str, int i3, String str2, String str3, int i16, String str4, String str5, String str6, String str7, String str8, String str9, String str10, ArrayList<String> arrayList) {
        this.appKey = "";
        this.appId = "";
        this.logicEnvironment = "";
        this.language = "";
