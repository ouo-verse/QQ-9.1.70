...
public final class ImportMsgPbRecord {
    ...
    public ImportMsgPbRecord(int i3, byte[] bArr, ArrayList<ImportMsgRecordFileInfo> arrayList, byte[] bArr2, DataImportGameChatSession dataImportGameChatSession, Integer num) {
        new ArrayList();
        this.pbType = i3;
