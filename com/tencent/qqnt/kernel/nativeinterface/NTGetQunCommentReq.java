...
public final class NTGetQunCommentReq {
    ...
    public NTGetQunCommentReq(int i3, RequestTimelineInfo requestTimelineInfo, StCommonExt stCommonExt, String str, String str2, int i16, String str3, String str4, String str5, String str6) {
        this.requestTimeLine = new RequestTimelineInfo();
        new StCommonExt();
        this.seq = i3;
