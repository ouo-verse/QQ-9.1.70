...
public final class VASPersonalElement {
    ...
    public VASPersonalElement(VASPersonalNamePlate vASPersonalNamePlate, Integer num, Integer num2, Long l3, Integer num3, Integer num4, Integer num5) {
        new VASPersonalNamePlate();
