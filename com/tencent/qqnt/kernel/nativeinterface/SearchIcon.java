...
public final class SearchIcon {
    ...
    public String toString() {
        return "SearchIcon{iconLink=" + this.iconLink + ",jumpLink=" + this.jumpLink + ",title=" + this.title + ",subTitle=" + this.subTitle + ",timestamp=" + this.timestamp + ",auth=" + this.auth + ",reportInfo=" + this.reportInfo + ",iconType=" + this.iconType + ",width=" + this.width + ",height=" + this.height + ",uin=" + this.uin + ",uinType=" + this.uinType + ",iconToken=" + this.iconToken + ",iconColorToken=" + this.iconColorToken + ",iconBgColor=" + this.iconBgColor + ",hideBackground=" + this.hideBackground + ",iconStatus=" + this.iconStatus + ",visibleRangeIconLink=" + this.visibleRangeIconLink + ",visibleRangeTitleText=" + this.visibleRangeTitleText + ",}";
    }
}
