...
public final class GProGuildRobotPanelListItemInfo {
    ...
    public String toString() {
        return "GProGuildRobotPanelListItemInfo{title=" + this.title + ",icon=" + this.icon + JefsClass.INDEX_URL + this.url + ",color=" + this.color + ",fontColor=" + this.fontColor + ",borderColor=" + this.borderColor + ",}";
    }
