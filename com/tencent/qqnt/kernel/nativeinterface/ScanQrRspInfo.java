...
public final class ScanQrRspInfo {
    ...
    public ScanQrRspInfo(String str, String str2, String str3, String str4, boolean z16, OpenAppInfo openAppInfo, SecCheckResult secCheckResult, TipsCtrl tipsCtrl, AutoLoginInfo autoLoginInfo, LoginPlat loginPlat) {
        this.dstAppName = "";
        this.loginCity = "";
        this.loginDevType = "";
        this.loginDevName = "";
        ...
        this.tips = new TipsCtrl();
        this.autoLogin = new AutoLoginInfo();
        LoginPlat loginPlat2 = LoginPlat.values()[0];
        this.dstAppName = str;
        this.loginCity = str2;
