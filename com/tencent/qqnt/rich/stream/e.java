...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u00c6\u0002\u0018\u00002\u00020\u0001:\u0001\u0005B\t\b\u0002\u00a2\u0006\u0004\b\u0006\u0010\u0007J\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002\u00a8\u0006\b"}, d2 = {"Lcom/tencent/qqnt/rich/stream/e;", "", "Landroid/content/Context;", "context", "Landroid/text/SpannableString;", "a", "<init>", "()V", "rich_kit_release"}, k = 1, mv = {1, 7, 1})
...
public final class e {
    ...
    public static final class a extends ReplacementSpan {
        ...
        public void draw(@NotNull Canvas canvas, @Nullable CharSequence text, int start, int end, float x16, int top, int y16, int bottom, @NotNull Paint paint) {
            ...
            canvas.translate(x16 + this.marginHorizontal, (bottom - ((((fontMetricsInt.bottom - fontMetricsInt.top) + (fontMetricsInt.descent - fontMetricsInt.ascent)) / 2) / 2)) - (height / 2));
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(36906);
