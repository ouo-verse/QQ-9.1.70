package com.tencent.qqnt.chats.biz.publicaccount.highlight;
...
public final class a extends com.tencent.qqnt.chats.biz.summary.highlight.core.a {
    ...
    public b a(@NotNull g item, @NotNull Context context, @NotNull AppRuntime appRuntime) {
        ...
        if (!com.tencent.qqnt.chats.biz.publicaccount.a.f354371a.a(item.n()) || (arrayList = item.s().listOfSpecificEventTypeInfosInMsgBox) == null) {
            return null;
        }
        ...
        while (true) {
            if (it.hasNext()) {
                obj = it.next();
                if (((SpecificEventTypeInfoInMsgBox) obj).eventTypeInMsgBox == 1010) {
                    z16 = true;
                } else {
                    z16 = false;
                }
        ...
        if (specificEventTypeInfoInMsgBox != null && (arrayList2 = specificEventTypeInfoInMsgBox.msgInfos) != null) {
            ...
            MsgBoxNecessaryMsgInfo msgBoxNecessaryMsgInfo = (MsgBoxNecessaryMsgInfo) orNull;
            if (msgBoxNecessaryMsgInfo == null) {
                return null;
            }
            b bVar = new b();
            String str = msgBoxNecessaryMsgInfo.highlightDigest;
            Intrinsics.checkNotNullExpressionValue(str, "it.highlightDigest");
            bVar.e(str);
            bVar.f(7);
            return bVar;
        }
