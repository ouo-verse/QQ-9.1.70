...
import com.tencent.qqnt.graytips.action.o;
...
public final class UserForAddFriendActionHandler extends a {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/qqnt/graytips/handler/UserForAddFriendActionHandler$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "graytips_kit_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.qqnt.graytips.handler.UserForAddFriendActionHandler$a, reason: from kotlin metadata */
    /* loaded from: classes24.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(30799);
    ...
    public UserForAddFriendActionHandler() {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, (Object) this);
        }
    ...
    public void c(@NotNull AppRuntime app, @NotNull Context context, @NotNull com.tencent.qqnt.graytips.action.f actionInfo, @Nullable gv3.a aioAbility) {
        ...
        o oVar = (o) actionInfo;
        QLog.i("AddFriendActionHandler", 1, "handle on click! nick is " + oVar.a());
        if (!TextUtils.isEmpty(oVar.b())) {
            ((IContactApi) com.tencent.qqnt.aio.adapter.a.INSTANCE.a(IContactApi.class)).openAddFriend(context, oVar.a(), oVar.b());
        }
    }
