...
public class i extends a {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/qqnt/graytips/handler/i$a;", "", "", "KEY_URL", "Ljava/lang/String;", "<init>", "()V", "graytips_kit_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.qqnt.graytips.handler.i$a, reason: from kotlin metadata */
    /* loaded from: classes24.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(31081);
    ...
    public void c(@NotNull AppRuntime app, @NotNull Context context, @NotNull com.tencent.qqnt.graytips.action.f actionInfo, @Nullable gv3.a aioAbility) {
        ...
        if (!TextUtils.isEmpty(rVar.d())) {
            ((IAIOJumpAction) com.tencent.qqnt.aio.adapter.a.INSTANCE.a(IAIOJumpAction.class)).openBrowser(context, rVar.d());
        }
    }
    ...
    public com.tencent.qqnt.graytips.action.f d(@NotNull JSONObject jsonObject, @NotNull String uid, @NotNull String nick, @NotNull String uin) {
        ...
        return new r(optString, uid, nick, uin);
    }
    ...
    public void e(@NotNull JSONObject jsonObject, @NotNull com.tencent.qqnt.graytips.action.a actionInfo) {
        ...
        Intrinsics.checkNotNullParameter(jsonObject, "jsonObject");
        Intrinsics.checkNotNullParameter(actionInfo, "actionInfo");
        jsonObject.put("url", ((r) actionInfo).d());
    }
}
