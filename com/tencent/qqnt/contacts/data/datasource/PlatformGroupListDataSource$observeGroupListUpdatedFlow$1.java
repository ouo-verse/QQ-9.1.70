...
@Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00010\u0000H\u008a@"}, d2 = {"Lkotlinx/coroutines/channels/ProducerScope;", "", "Lcom/tencent/qqnt/kernel/nativeinterface/GroupSimpleInfo;", "", "<anonymous>"}, k = 3, mv = {1, 7, 1})
@DebugMetadata(c = "com.tencent.qqnt.contacts.data.datasource.PlatformGroupListDataSource$observeGroupListUpdatedFlow$1", f = "PlatformGroupListDataSource.kt", i = {}, l = {74}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes24.dex */
public final class PlatformGroupListDataSource$observeGroupListUpdatedFlow$1 extends SuspendLambda implements Function2<ProducerScope<? super List<? extends GroupSimpleInfo>>, Continuation<? super Unit>, Object> {
    static IPatchRedirector $redirector_;
    private /* synthetic */ Object L$0;
    int label;
    final /* synthetic */ PlatformGroupListDataSource this$0;

    @Metadata(d1 = {"\u0000!\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u001e\u0010\b\u001a\u00020\u00072\u0006\u0010\u0003\u001a\u00020\u00022\f\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u0016\u00a8\u0006\t"}, d2 = {"com/tencent/qqnt/contacts/data/datasource/PlatformGroupListDataSource$observeGroupListUpdatedFlow$1$a", "Lcom/tencent/qqnt/kernel/nativeinterface/IKernelGroupListener;", "Lcom/tencent/qqnt/kernel/nativeinterface/GroupListUpdateType;", "updateType", "Ljava/util/ArrayList;", "Lcom/tencent/qqnt/kernel/nativeinterface/GroupSimpleInfo;", "groupList", "", "onGroupListUpdate", "contacts_impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes24.dex */
    public static final class a implements IKernelGroupListener {
        static IPatchRedirector $redirector_;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ ProducerScope<List<GroupSimpleInfo>> f355843d;

        /* JADX WARN: Multi-variable type inference failed */
        a(ProducerScope<? super List<GroupSimpleInfo>> producerScope) {
            this.f355843d = producerScope;
        ...
        public void onGroupListUpdate(@NotNull GroupListUpdateType updateType, @NotNull ArrayList<GroupSimpleInfo> groupList) {
            ...
            if (QLog.isColorLevel()) {
                QLog.d("PlatformGroupListDataSource", 2, "onGroupListChange list:" + groupList.size());
            }
            this.f355843d.mo2003trySendJP2dKIU(groupList);
        }
    ...
    public PlatformGroupListDataSource$observeGroupListUpdatedFlow$1(PlatformGroupListDataSource platformGroupListDataSource, Continuation<? super PlatformGroupListDataSource$observeGroupListUpdatedFlow$1> continuation) {
        super(2, continuation);
        this.this$0 = platformGroupListDataSource;
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, (Object) this, (Object) platformGroupListDataSource, (Object) continuation);
        }
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        PlatformGroupListDataSource$observeGroupListUpdatedFlow$1 platformGroupListDataSource$observeGroupListUpdatedFlow$1 = new PlatformGroupListDataSource$observeGroupListUpdatedFlow$1(this.this$0, continuation);
        platformGroupListDataSource$observeGroupListUpdatedFlow$1.L$0 = obj;
        return platformGroupListDataSource$observeGroupListUpdatedFlow$1;
    }

    @Override // kotlin.jvm.functions.Function2
    public /* bridge */ /* synthetic */ Object invoke(ProducerScope<? super List<? extends GroupSimpleInfo>> producerScope, Continuation<? super Unit> continuation) {
        return invoke2((ProducerScope<? super List<GroupSimpleInfo>>) producerScope, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
            ...
            if (i3 != 0) {
                ...
                Function0<Unit> function0 = new Function0<Unit>(this.this$0) { // from class: com.tencent.qqnt.contacts.data.datasource.PlatformGroupListDataSource$observeGroupListUpdatedFlow$1.1
                    static IPatchRedirector $redirector_;
                    final /* synthetic */ PlatformGroupListDataSource this$0;
                    ...
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        ...
                        if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 1)) {
                            iPatchRedirector2.redirect((short) 1, (Object) this, (Object) a.this, (Object) r5);
                        }
                    }
                    ...
                    public final void invoke2() {
                        ...
                        QLog.d("PlatformGroupListDataSource", 1, "GroupListUpdated deleteObserver! " + a.this);
                        f17 = this.this$0.f();
                        if (f17 != null) {
                            f17.x0(a.this);
                        }
    ...
    @Nullable
    /* renamed from: invoke, reason: avoid collision after fix types in other method */
    public final Object invoke2(@NotNull ProducerScope<? super List<GroupSimpleInfo>> producerScope, @Nullable Continuation<? super Unit> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? ((PlatformGroupListDataSource$observeGroupListUpdatedFlow$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE) : iPatchRedirector.redirect((short) 4, (Object) this, (Object) producerScope, (Object) continuation);
    }
}
