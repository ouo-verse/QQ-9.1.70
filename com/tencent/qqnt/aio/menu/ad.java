...
public final class ad<VB extends com.tencent.aio.base.mvvm.a<com.tencent.qqnt.aio.holder.a, IMsgItemMviUIState>> extends com.tencent.qqnt.aio.menu.ui.d {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/qqnt/aio/menu/ad$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "aio_kit_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.qqnt.aio.menu.ad$a, reason: from kotlin metadata */
    /* loaded from: classes23.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(47565);
    ...
    public ad(@NotNull Context context, @NotNull AIOMsgItem msgItem, @NotNull VB vb5) {
        super(msgItem);
        ...
        this.vb = vb5;
        String string = context.getResources().getString(R.string.f208185c1);
        Intrinsics.checkNotNullExpressionValue(string, "context.resources.getStr\u2026_qqstr_qbpublic_97b15486)");
        this.title = string;
    }
    ...
    public void h() {
        ...
        QLog.i("ReplyMenuItem", 4, "onItemClick");
        ...
        if (iAIOMenuApi.checkSupportReply(context, msgItem)) {
            VB vb5 = this.vb;
            AIOMsgItem msgItem2 = d();
            Intrinsics.checkNotNullExpressionValue(msgItem2, "msgItem");
            vb5.sendIntent(new p.m(msgItem2, 1));
        }
    }
}
