...
public final class c<VB extends com.tencent.aio.base.mvvm.a<com.tencent.qqnt.aio.holder.a, IMsgItemMviUIState>> extends com.tencent.qqnt.aio.menu.ui.d {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/qqnt/aio/menu/c$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "aio_kit_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.qqnt.aio.menu.c$a, reason: from kotlin metadata */
    /* loaded from: classes23.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(46586);
    ...
    public c(@NotNull Context context, @NotNull AIOMsgItem msgItem, @NotNull VB vb5) {
        super(msgItem);
        ...
        this.vb = vb5;
        String string = context.getResources().getString(R.string.f207695ap);
        Intrinsics.checkNotNullExpressionValue(string, "context.resources.getStr\u2026qcommon_image_menu_fllow)");
        this.title = string;
    }
    ...
    public void h() {
        ...
        if (d().getMsgRecord().msgType == 17) {
            ...
            ((IMarketFaceTailConfigExt) QRoute.api(IMarketFaceTailConfigExt.class)).reportAction(QCircleDaTongConstant.ElementParamValue.LONG_PRESS, "add", "4", 102, jSONObject.toString());
        }
        VB vb5 = this.vb;
        AIOMsgItem msgItem = d();
        Intrinsics.checkNotNullExpressionValue(msgItem, "msgItem");
        vb5.sendIntent(new p.C9487p(msgItem));
    }
}
