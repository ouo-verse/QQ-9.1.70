...
import com.tencent.qqnt.aio.helper.fp;
...
public final class k implements com.tencent.aio.api.help.d, z {
    ...
    public boolean a(com.tencent.aio.api.help.a param) {
        ...
        return (b16 == null || (c16 = b16.c()) == null || c16.e() != 117) ? false : true;
    }
    ...
    public com.tencent.aio.main.businesshelper.h[] getLifeCycleHelper() {
        return new com.tencent.aio.main.businesshelper.h[]{new fp(), new bq(), new AddFriendNtHelper(), new NTEmoPanelHelper(), new UinUidUpdateHelper(), new cc()};
    }
