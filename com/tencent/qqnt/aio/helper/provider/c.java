...
import com.tencent.qqnt.aio.helper.an;
...
public final class c implements com.tencent.aio.api.help.d, z {
    ...
    public boolean a(com.tencent.aio.api.help.a param) {
        ...
        return (b16 == null || (c16 = b16.c()) == null || c16.e() != 111) ? false : true;
    }
    ...
    public com.tencent.aio.main.businesshelper.h[] getLifeCycleHelper() {
        return new com.tencent.aio.main.businesshelper.h[]{new an(), new NTEmoPanelHelper(), new UinUidUpdateHelper(), new cc(), new bq(), new de()};
    }
