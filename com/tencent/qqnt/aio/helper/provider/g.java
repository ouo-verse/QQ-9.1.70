...
import com.tencent.qqnt.aio.helper.bb;
...
public final class g implements com.tencent.aio.api.help.d {
    ...
    public com.tencent.aio.main.businesshelper.h[] getLifeCycleHelper() {
        com.tencent.aio.main.businesshelper.h aioHelper = ((IGameMallAIOApi) QRoute.api(IGameMallAIOApi.class)).getAioHelper();
        Intrinsics.checkNotNullExpressionValue(aioHelper, "api(IGameMallAIOApi::class.java).aioHelper");
        return new com.tencent.aio.main.businesshelper.h[]{new bb(), aioHelper};
    }
