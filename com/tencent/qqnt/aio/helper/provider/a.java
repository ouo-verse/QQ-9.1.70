...
import com.tencent.qqnt.aio.helper.StrangerTitleHelper;
import com.tencent.qqnt.aio.helper.UinUidUpdateHelper;
import com.tencent.qqnt.aio.helper.au;
...
public final class a implements com.tencent.aio.api.help.d, z {
    ...
    public boolean a(com.tencent.aio.api.help.a param) {
        ...
        if ((b16 == null || (c18 = b16.c()) == null || c18.e() != 100) ? false : true) {
            return true;
        }
        AIOSession b17 = param.b();
        if ((b17 == null || (c17 = b17.c()) == null || c17.e() != 101) ? false : true) {
            return true;
        }
        AIOSession b18 = param.b();
        return b18 != null && (c16 = b18.c()) != null && c16.e() == 115;
    }
    ...
    public com.tencent.aio.main.businesshelper.h[] getLifeCycleHelper() {
        return new com.tencent.aio.main.businesshelper.h[]{new bq(), new au(), new AddFriendNtHelper(), new NTEmoPanelHelper(), new UinUidUpdateHelper(), new cc(), ((IStickerRecHelperApi) QRoute.api(IStickerRecHelperApi.class)).createLifeCycleHelper(), new StrangerTitleHelper()};
    }
