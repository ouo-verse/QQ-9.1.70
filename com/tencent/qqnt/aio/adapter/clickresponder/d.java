...
/* compiled from: P */
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0018\u0000 \f2\u00020\u0001:\u0001\tB\u0007\u00a2\u0006\u0004\b\n\u0010\u000bJ \u0010\t\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016\u00a8\u0006\r"}, d2 = {"Lcom/tencent/qqnt/aio/adapter/clickresponder/d;", "Lcom/tencent/qqnt/aio/adapter/clickresponder/b;", "Landroid/content/Context;", "context", "", "isScaleChat", "Lcom/tencent/mobileqq/aio/msg/ah;", PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME, "", "a", "<init>", "()V", "b", "base_proj_nt_ext_impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class d extends b {
    ...
    public void a(Context context, boolean isScaleChat, ah item) {
        ...
        QLog.d("GeBiaoResponder", 1, "click tofu: " + item);
        ...
        AllInOne allInOne = new AllInOne(valueOf, 1);
        Intent intent = new Intent(context, (Class<?>) PersonalityLabelGalleryActivity.class);
        intent.putExtra("personality_label_allinone", allInOne);
        intent.putExtra(IProfileCardConst.KEY_FROM_TYPE, 2);
        intent.putExtra("uin", valueOf);
        intent.putExtra("nickname", item.getMsgRecord().peerName);
