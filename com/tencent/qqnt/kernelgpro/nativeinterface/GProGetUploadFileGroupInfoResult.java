...
public final class GProGetUploadFileGroupInfoResult implements Serializable {
    ...
    public String toString() {
        return "GProGetUploadFileGroupInfoResult{fileGroupInfo=" + this.fileGroupInfo + ",fileParams=" + this.fileParams + ",}";
    }
}
