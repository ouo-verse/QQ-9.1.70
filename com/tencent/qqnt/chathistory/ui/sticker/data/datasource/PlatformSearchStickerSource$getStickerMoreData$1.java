...
@DebugMetadata(c = "com.tencent.qqnt.chathistory.ui.sticker.data.datasource.PlatformSearchStickerSource$getStickerMoreData$1", f = "PlatformSearchStickerSource.kt", i = {}, l = {60}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes23.dex */
public final class PlatformSearchStickerSource$getStickerMoreData$1 extends SuspendLambda implements Function2<ProducerScope<? super List<? extends SearchStickerItemModel>>, Continuation<? super Unit>, Object> {
    ...
    public PlatformSearchStickerSource$getStickerMoreData$1(long j3, long j16, long j17, int i3, String str, int i16, PlatformSearchStickerSource platformSearchStickerSource, Continuation<? super PlatformSearchStickerSource$getStickerMoreData$1> continuation) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, this, Long.valueOf(j3), Long.valueOf(j16), Long.valueOf(j17), Integer.valueOf(i3), str, Integer.valueOf(i16), platformSearchStickerSource, continuation);
        }
    }
    ...
    public static final void b(int i3, ProducerScope producerScope, PlatformSearchStickerSource platformSearchStickerSource, int i16, String str, int i17, String str2, ArrayList msgList) {
        ...
        dVar.a("PlatformSearchStickerSource", "result " + i17 + ", errMsg " + str2 + " \u5206\u9875\u52a0\u8f7d  requestCount " + i3 + " size " + num);
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        PlatformSearchStickerSource$getStickerMoreData$1 platformSearchStickerSource$getStickerMoreData$1 = new PlatformSearchStickerSource$getStickerMoreData$1(this.$msgId, this.$msgTime, this.$msgSeq, this.$chatType, this.$peerId, this.$requestCount, this.this$0, continuation);
        platformSearchStickerSource$getStickerMoreData$1.L$0 = obj;
        return platformSearchStickerSource$getStickerMoreData$1;
    }
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
            ...
            if (i3 != 0) {
                ...
                if (e16 != null) {
                    ...
                    e16.queryEmoticonMsgs(j3, j16, j17, queryMsgsParams, new IMsgOperateCallback() { // from class: com.tencent.qqnt.chathistory.ui.sticker.data.datasource.b
                        @Override // com.tencent.qqnt.kernel.nativeinterface.IMsgOperateCallback
                        public final void onResult(int i18, String str2, ArrayList arrayList) {
                            PlatformSearchStickerSource$getStickerMoreData$1.b(i16, producerScope, platformSearchStickerSource, i17, str, i18, str2, arrayList);
                        }
                    });
                }
    ...
    public final Object invoke2(@NotNull ProducerScope<? super List<SearchStickerItemModel>> producerScope, @Nullable Continuation<? super Unit> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? ((PlatformSearchStickerSource$getStickerMoreData$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE) : iPatchRedirector.redirect((short) 4, (Object) this, (Object) producerScope, (Object) continuation);
    }
}
