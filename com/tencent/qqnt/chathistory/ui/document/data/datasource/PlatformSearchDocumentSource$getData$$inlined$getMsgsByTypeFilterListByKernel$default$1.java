...
@DebugMetadata(c = "com.tencent.qqnt.chathistory.ui.document.data.datasource.PlatformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1", f = "PlatformSearchDocumentSource.kt", i = {}, l = {62}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes23.dex */
public final class PlatformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1 extends SuspendLambda implements Function2<ProducerScope<? super List<? extends b>>, Continuation<? super Unit>, Object> {
    ...
    public static final class a implements IMsgOperateCallback {
        ...
        final /* synthetic */ ProducerScope<List<? extends b>> f353487a;

        public a(ProducerScope producerScope) {
            this.f353487a = producerScope;
        ...
        public final void onResult(int i3, String errMsg, ArrayList<MsgRecord> msgList) {
            ...
            ProducerScope<List<? extends b>> producerScope = this.f353487a;
            ...
            if (i3 != 0) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new b((MsgRecord) it.next()));
                }
            }
    ...
    public PlatformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1(long j3, long j16, long j17, int i3, String str, List list, List list2, long j18, long j19, int i16, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        PlatformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1 platformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1 = new PlatformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1(this.$msgId, this.$msgTime, this.$msgSeq, this.$chatType, this.$peerId, this.$typeFilters, this.$filterSendUids, this.$filterStartTime, this.$filterEndTime, this.$cnt, continuation);
        platformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1.L$0 = obj;
        return platformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1;
    }
    ...
    @Nullable
    public final Object invoke(@NotNull ProducerScope<? super List<? extends b>> producerScope, @Nullable Continuation<? super Unit> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? ((PlatformSearchDocumentSource$getData$$inlined$getMsgsByTypeFilterListByKernel$default$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE) : iPatchRedirector.redirect((short) 4, (Object) this, (Object) producerScope, (Object) continuation);
    }
}
