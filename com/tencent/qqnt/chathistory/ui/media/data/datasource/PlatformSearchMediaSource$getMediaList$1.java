...
@DebugMetadata(c = "com.tencent.qqnt.chathistory.ui.media.data.datasource.PlatformSearchMediaSource$getMediaList$1", f = "PlatformSearchMediaSource.kt", i = {}, l = {41}, m = "invokeSuspend", n = {}, s = {})
...
public final class PlatformSearchMediaSource$getMediaList$1 extends SuspendLambda implements Function2<ProducerScope<? super Pair<? extends Integer, ? extends List<? extends SearchMediaItemModel>>>, Continuation<? super Unit>, Object> {
    ...
    public PlatformSearchMediaSource$getMediaList$1(int i3, String str, int i16, PlatformSearchMediaSource platformSearchMediaSource, Continuation<? super PlatformSearchMediaSource$getMediaList$1> continuation) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, this, Integer.valueOf(i3), str, Integer.valueOf(i16), platformSearchMediaSource, continuation);
        }
    }
    ...
    public static final void b(int i3, ProducerScope producerScope, PlatformSearchMediaSource platformSearchMediaSource, int i16, String str, ArrayList arrayList) {
        ...
        QLog.d("PlatformSearchMediaSource", 1, "result " + i16 + ", errMsg " + str + " reqCount " + i3 + " \u9996\u5c4f  size " + num);
        if (arrayList == null) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
            ...
            if (i3 != 0) {
                ...
                if (e16 != null) {
                    ...
                    e16.queryPicOrVideoMsgs(0L, 0L, 0L, queryMsgsParams, new IMsgOperateCallback() { // from class: com.tencent.qqnt.chathistory.ui.media.data.datasource.a
    ...
    public final Object invoke2(@NotNull ProducerScope<? super Pair<Integer, ? extends List<SearchMediaItemModel>>> producerScope, @Nullable Continuation<? super Unit> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? ((PlatformSearchMediaSource$getMediaList$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE) : iPatchRedirector.redirect((short) 4, (Object) this, (Object) producerScope, (Object) continuation);
    }
}
