...
public final class ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1 extends Lambda implements Function2<c, SearchMediaItemModel, Unit> {
    ...
    final /* synthetic */ ChatHistoryMediaAdapter.ContentVideoItemProvider this$1;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1(ChatHistoryMediaAdapter chatHistoryMediaAdapter, ImageView imageView, com.tencent.qqnt.expandRecyclerView.adapter.a aVar, QUICheckBox qUICheckBox, ChatHistoryMediaAdapter.ContentVideoItemProvider contentVideoItemProvider, TextView textView) {
        super(2);
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, this, chatHistoryMediaAdapter, imageView, aVar, qUICheckBox, contentVideoItemProvider, textView);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:9:0x003f, code lost:
        ...
        r0 = kotlin.sequences.SequencesKt___SequencesKt.map(r0, com.tencent.qqnt.chathistory.ui.media.adapter.ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1$4$allData$1.INSTANCE);
     */
    /*
    ...
    */
    public static final void b(c this_cast, ImageView iv5, SearchMediaItemModel data, ChatHistoryMediaAdapter this$0, View view) {
        ...
        if (m3 != null && (r0 = m3.m0()) != null && asSequence != null) {
            filter = SequencesKt___SequencesKt.filter(asSequence, ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1$invoke$lambda$1$$inlined$filterIsInstance$1.INSTANCE);
            ...
            if (filter != null && map != null) {
                ...
                mutableMapOf = MapsKt__MapsKt.mutableMapOf(TuplesKt.to("operation_content", Integer.valueOf(HistoryDtReportHelper.OperationContent.NORMAL.ordinal())), TuplesKt.to("entry_message_type", Integer.valueOf(HistoryDtReportHelper.MediaType.VIDEO.ordinal())));
        ...
        i3 = this$0.source;
        aVar2.j(e162, k36, list22, iv5, i3);
        EventCollector.getInstance().onViewClicked(view);
    }
    ...
    public final void invoke2(@NotNull final c cast, @NotNull final SearchMediaItemModel data) {
        ...
        f.b(data.n(), new Function0<Unit>(this.$iv, this.this$0, this.this$1) { // from class: com.tencent.qqnt.chathistory.ui.media.adapter.ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1.1
            static IPatchRedirector $redirector_;
            final /* synthetic */ ImageView $iv;
            final /* synthetic */ ChatHistoryMediaAdapter this$0;
            final /* synthetic */ ChatHistoryMediaAdapter.ContentVideoItemProvider this$1;
            ...
            public final void invoke2() {
                ...
                if (FileUtils.fileExists(r16)) {
                    d.f354054a.a("ChatHistoryMediaAdapter", SearchMediaItemModel.this.j() + " video load oriPath " + r16);
                ...
                if (SearchMediaItemModel.this.i()) {
                    d.f354054a.a("ChatHistoryMediaAdapter", SearchMediaItemModel.this.j() + " video load expire");
        ...
        }, new Function1<File, Unit>(this.$iv, this.this$0) { // from class: com.tencent.qqnt.chathistory.ui.media.adapter.ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1.2
            static IPatchRedirector $redirector_;
            final /* synthetic */ ImageView $iv;
            final /* synthetic */ ChatHistoryMediaAdapter this$0;
            ...
            public final void invoke2(@NotNull File it) {
                ...
                d.f354054a.a("ChatHistoryMediaAdapter", SearchMediaItemModel.this.j() + " video load thumb " + it.getAbsolutePath());
                ImageView imageView = this.$iv;
        ...
        this.$iv.setContentDescription(HardCodeUtil.qqStr(R.string.zji) + valueOf);
        ...
        chatHistoryMediaAdapter.l1(view, k3, data, qUICheckBox, i16, new View.OnClickListener() { // from class: com.tencent.qqnt.chathistory.ui.media.adapter.b
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                ChatHistoryMediaAdapter$ContentVideoItemProvider$convert$1.b(c.this, imageView, data, chatHistoryMediaAdapter2, view2);
            }
