...
@DebugMetadata(c = "com.tencent.qqnt.chathistory.ui.troopMember.TestFragment$onStart$1$1$onMemberListChange$1", f = "TroopMemberFragment.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes23.dex */
final class TestFragment$onStart$1$1$onMemberListChange$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public TestFragment$onStart$1$1$onMemberListChange$1(GroupMemberListChangeInfo groupMemberListChangeInfo, TestFragment testFragment, Continuation<? super TestFragment$onStart$1$1$onMemberListChange$1> continuation) {
        super(2, continuation);
        this.$info = groupMemberListChangeInfo;
        this.this$0 = testFragment;
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, this, groupMemberListChangeInfo, testFragment, continuation);
        }
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        return new TestFragment$onStart$1$1$onMemberListChange$1(this.$info, this.this$0, continuation);
    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? ((TestFragment$onStart$1$1$onMemberListChange$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE) : iPatchRedirector.redirect((short) 4, (Object) this, (Object) coroutineScope, (Object) continuation);
    }
}
