...
public final class p implements ViewBinding {
    ...
    public p(@NotNull Context context, @Nullable Integer num) {
        RelativeLayout f16;
    ...
    public /* synthetic */ p(Context context, Integer num, int i3, DefaultConstructorMarker defaultConstructorMarker) {
