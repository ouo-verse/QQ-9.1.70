...
public class C2CHistoryViewModel extends a {
    ...
    public C2CHistoryViewModel(@NotNull String peerId, @Nullable String str, boolean z16) {
        super(peerId, str);
        Lazy lazy;
        Lazy lazy2;
        ...
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<List<? extends Integer>>() { // from class: com.tencent.qqnt.chathistory.business.C2CHistoryViewModel$tabTexts$2
            static IPatchRedirector $redirector_;
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                ...
                if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 1)) {
                    iPatchRedirector2.redirect((short) 1, (Object) this, (Object) C2CHistoryViewModel.this);
                }
            }
            ...
            public final List<? extends Integer> invoke() {
                ...
                z17 = C2CHistoryViewModel.this.fromStorageScan;
                if (z17) {
                ...
                listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(R.string.a1e), Integer.valueOf(R.string.a1i), Integer.valueOf(R.string.a1f), Integer.valueOf(R.string.a1g), Integer.valueOf(R.string.f170732im3), Integer.valueOf(R.string.a1h)});
                return listOf;
            }
        });
        this.tabTexts = lazy;
        lazy2 = LazyKt__LazyJVMKt.lazy(new Function0<List<? extends Integer>>() { // from class: com.tencent.qqnt.chathistory.business.C2CHistoryViewModel$tabIds$2
            static IPatchRedirector $redirector_;
            ...
            public final List<? extends Integer> invoke() {
                ...
                z17 = C2CHistoryViewModel.this.fromStorageScan;
                if (z17) {
                    listOf2 = CollectionsKt__CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(R.id.auk), Integer.valueOf(R.id.aup), Integer.valueOf(R.id.aum), Integer.valueOf(R.id.aun), Integer.valueOf(R.id.lco), Integer.valueOf(R.id.auo)});
                    return listOf2;
                }
                listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new Integer[]{Integer.valueOf(R.id.aul), Integer.valueOf(R.id.auk), Integer.valueOf(R.id.aup), Integer.valueOf(R.id.aum), Integer.valueOf(R.id.aun), Integer.valueOf(R.id.lco), Integer.valueOf(R.id.auo), Integer.valueOf(R.id.tt9)});
                return listOf;
            }
        });
        this.tabIds = lazy2;
    ...
    private final BaseHistoryFragment<?> S1(int position) {
        ...
        if (position == 2) {
            return new ChatHistoryFileFragment(1);
        }
        if (position == 3) {
            return new ChatHistoryDocumentFragment(1);
        }
        if (position == Q1().size() - 1) {
            return new ChatHistoryLinkFragment(1);
        }
        return new TestFragment(Q1().get(position).intValue());
    }
    ...
    public BaseHistoryFragment<?> M1(int position) {
        ...
        int i16 = 1;
        if (position == 1) {
            return new ChatHistoryMediaFragment(i3, i16, defaultConstructorMarker);
        }
        if (position == 2) {
            return new ChatHistoryStickerFragment(i3, i16, defaultConstructorMarker);
        }
        if (position == 3) {
            return new ChatHistoryFileFragment(i3, i16, defaultConstructorMarker);
        }
        if (position == 4) {
            return new ChatHistoryDocumentFragment(i3, i16, defaultConstructorMarker);
        }
        if (position == Q1().size() - 1) {
            return new ChatHistoryLinkFragment(i3, i16, defaultConstructorMarker);
        }
        return new TestFragment(Q1().get(position).intValue());
    }
    ...
    public /* synthetic */ C2CHistoryViewModel(String str, String str2, boolean z16, int i3, DefaultConstructorMarker defaultConstructorMarker) {
