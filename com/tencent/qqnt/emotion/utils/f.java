...
public class f {
    ...
    public static String a(AppInterface appInterface, com.tencent.qqnt.http.api.b bVar, boolean z16) {
        String c16;
        byte[] bArr = null;
        if (appInterface == null || bVar == null) {
            return null;
        }
        ...
        int i3 = bundle.getInt("jsonType", com.tencent.qqnt.emotion.constant.c.f356199a);
        File d16 = bVar.d();
        com.tencent.mobileqq.temp.transfile.c cVar = new com.tencent.mobileqq.temp.transfile.c();
        if (d16 != null && d16.exists()) {
            bArr = FileUtils.fileToBytes(d16);
        }
        byte[] bArr2 = bArr;
        ArrayList arrayList = new ArrayList();
        if (z16) {
            c16 = n(appInterface, emoticonPackage, i3, bArr2, arrayList);
        } else {
            c16 = c(appInterface, emoticonPackage, i3, bArr2, arrayList, cVar);
        }
        if (QLog.isColorLevel() && c16 != null) {
            QLog.e(EmotionJsonUtils.TAG, 2, "handleJsonFileDownload : json parse result = " + c16);
        }
        return c16;
    }
    ...
    */
    protected static void b(EmoticonPackage emoticonPackage, int i3, ArrayList<Emoticon> arrayList, IEmoticonManagerService iEmoticonManagerService, JSONArray jSONArray, int i16, boolean z16) throws JSONException {
        for (int i17 = 0; i17 < i16; i17++) {
            ...
            if (syncFindEmoticonById == null) {
                if (i3 != com.tencent.qqnt.emotion.constant.c.f356200b) {
                ...
                if (syncFindEmoticonById == null) {
                    if (QLog.isColorLevel()) {
                        QLog.d(EmotionJsonUtils.TAG, 2, "emoticon json update, cannot find emoticon from epId: " + str);
                    }
                } else {
                    boolean a16 = d.a(emoticonPackage);
    ...
    public static String c(AppInterface appInterface, EmoticonPackage emoticonPackage, int i3, byte[] bArr, ArrayList<Emoticon> arrayList, com.tencent.mobileqq.temp.transfile.c cVar) {
        String obj;
        String k3 = k(appInterface, emoticonPackage, bArr, arrayList, cVar);
        if (k3 != null) {
            return k3;
        }
        ...
        try {
            ...
            String string = jSONObject.getString("id");
            String string2 = jSONObject.getString("name");
            f(emoticonPackage, jSONObject);
            String d16 = d(emoticonPackage, i3, iEmoticonManagerService, jSONObject, string, string2, "");
            if (d16 != null) {
                return d16;
            }
            ...
            String g16 = g(emoticonPackage, i3, arrayList, cVar, iEmoticonManagerService, jSONObject, string, iEmoticonManagerService.getExtensionSizeByScreenSize(string), d.a(emoticonPackage));
            if (g16 != null) {
                return g16;
            }
            return null;
            ...
            e16.printStackTrace();
            obj = e16.toString();
            QLog.e(EmotionJsonUtils.TAG, 1, "parseJson: PARSE_EMOTICON_JSON fail 01 RESULT_CODE_JSON_PARSE_FAIL  ep=" + emoticonPackage.epId + " exception=" + e16.toString());
            return obj;
        } catch (Exception e17) {
            e17.printStackTrace();
            obj = e17.toString();
            QLog.d(EmotionJsonUtils.TAG, 1, "parseJson: PARSE_EMOTICON_JSON fail 02 RESULT_CODE_JSON_PARSE_FAIL  ep=" + emoticonPackage.epId + " exception=" + e17.toString());
            return obj;
        }
    }
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    protected static String d(EmoticonPackage emoticonPackage, int i3, IEmoticonManagerService iEmoticonManagerService, JSONObject jSONObject, String str, String str2, String str3) throws JSONException {
        int i16;
        int i17;
        String str4;
        int i18;
        ...
        if (jSONObject.has("ringtype")) {
            ...
            if ("1".equals(string)) {
                ...
                l(emoticonPackage, i3, iEmoticonManagerService, jSONObject, str, i26, i18, i27);
                j(emoticonPackage, jSONObject);
                e(emoticonPackage, jSONObject);
                return null;
            }
            if ("2".equals(string)) {
    ...
    protected static void e(EmoticonPackage emoticonPackage, JSONObject jSONObject) throws JSONException {
        String[] split;
    ...
    protected static void f(EmoticonPackage emoticonPackage, JSONObject jSONObject) {
    ...
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    protected static String g(EmoticonPackage emoticonPackage, int i3, ArrayList<Emoticon> arrayList, com.tencent.mobileqq.temp.transfile.c cVar, IEmoticonManagerService iEmoticonManagerService, JSONObject jSONObject, String str, int i16, boolean z16) throws JSONException {
        int i17;
        int i18;
        String str2;
        int i19;
        ...
        while (i26 < length) {
            ...
            String i27 = i(jSONObject2, string2);
            ...
            if (syncFindEmoticonById == null) {
                ...
                if (i3 != com.tencent.qqnt.emotion.constant.c.f356200b) {
                    ...
                    syncFindEmoticonById.keywords = i27;
                    ...
                    if (emoticon != null) {
                        ...
                        String h16 = h(emoticonPackage, emoticon);
                        if (h16 != null) {
                            return h16;
                        }
                        ...
                        m(emoticonPackage, arrayList, i16, z16, z18, arrayList2, jSONObject2, string, string2, emoticon);
                        z27 = z19;
                    }
                    i26 = i19 + 1;
                ...
                if (string.equals(syncFindEmoticonById.eId) && str.equals(syncFindEmoticonById.epId) && string2.equals(syncFindEmoticonById.name)) {
                    if (!i27.equals(syncFindEmoticonById.keywords)) {
                        syncFindEmoticonById.keywords = i27;
                        z17 = true;
                    } else {
                        z17 = false;
    ...
    private static String h(EmoticonPackage emoticonPackage, Emoticon emoticon) {
    ...
    protected static void j(EmoticonPackage emoticonPackage, JSONObject jSONObject) throws JSONException {
        JSONArray jSONArray;
    ...
    protected static String k(AppInterface appInterface, EmoticonPackage emoticonPackage, byte[] bArr, ArrayList<Emoticon> arrayList, com.tencent.mobileqq.temp.transfile.c cVar) {
        if (appInterface == null) {
            if (QLog.isColorLevel()) {
                QLog.d(EmotionJsonUtils.TAG, 2, "parseJson : ap is null");
                return "app is null";
            }
            return "app is null";
        }
        if (emoticonPackage == null) {
            if (QLog.isColorLevel()) {
                QLog.d(EmotionJsonUtils.TAG, 2, "parseJson : ep is null");
                return "ep is null";
            }
            return "ep is null";
        }
        if (bArr != null && bArr.length >= 1) {
            ...
            if (QLog.isColorLevel()) {
                QLog.d(EmotionJsonUtils.TAG, 2, "parseJson : params is null");
                return "params is null";
            }
            return "params is null";
        }
        if (QLog.isColorLevel()) {
            QLog.d(EmotionJsonUtils.TAG, 2, "parseJson : json data is null");
            return "json data is null";
        }
        return "json data is null";
    }

    protected static void l(EmoticonPackage emoticonPackage, int i3, IEmoticonManagerService iEmoticonManagerService, JSONObject jSONObject, String str, int i16, int i17, int i18) {
        if (emoticonPackage.copywritingType != com.tencent.qqnt.emotion.constant.a.f356189b) {
            emoticonPackage.extraFlags |= 4;
            if (QLog.isColorLevel()) {
                QLog.d(EmotionJsonUtils.TAG, 2, "parseJson, ep.extraFlags = " + emoticonPackage.extraFlags);
            }
        }
    ...
    private static void m(EmoticonPackage emoticonPackage, ArrayList<Emoticon> arrayList, int i3, boolean z16, boolean z17, ArrayList<Emoticon> arrayList2, JSONObject jSONObject, String str, String str2, Emoticon emoticon) {
    ...
    public static String n(AppInterface appInterface, EmoticonPackage emoticonPackage, int i3, byte[] bArr, ArrayList<Emoticon> arrayList) {
        ...
        if (appInterface == null) {
            if (QLog.isColorLevel()) {
                QLog.d(EmotionJsonUtils.TAG, 2, "parseSmallJson: app is null");
                return "app is null";
            }
            return "app is null";
        }
        if (emoticonPackage == null) {
            if (QLog.isColorLevel()) {
                QLog.d(EmotionJsonUtils.TAG, 2, "parseSmallJson: ep is null");
                return "ep is null";
            }
            return "ep is null";
        }
        if (bArr != null && bArr.length >= 1) {
            if (arrayList == null) {
                if (QLog.isColorLevel()) {
                    QLog.d(EmotionJsonUtils.TAG, 2, "parseSmallJson: params is null");
                    return "params is null";
                }
                return "params is null";
            }
            ...
            try {
                ...
                QLog.e(EmotionJsonUtils.TAG, 1, "parseSmallJson: fail 02 RESULT_CODE_JSON_PARSE_FAIL  ep=" + emoticonPackage.epId + " exception=" + e16.toString());
                return obj;
            } catch (OutOfMemoryError e17) {
                QLog.e(EmotionJsonUtils.TAG, 1, "parseSmallJson: fail OutOfMemoryError  exception=" + e17.toString());
            } catch (JSONException e18) {
                e18.printStackTrace();
                String obj2 = e18.toString();
                QLog.e(EmotionJsonUtils.TAG, 1, "parseSmallJson: fail 01 RESULT_CODE_JSON_PARSE_FAIL  ep=" + emoticonPackage.epId + " exception=" + e18.toString());
                return obj2;
            }
            if (jSONArray != null && jSONArray2 != null) {
                o(emoticonPackage, i3, arrayList, iEmoticonManagerService, jSONObject, j3, jSONObject2, jSONArray, jSONArray2);
                return null;
            }
            return "parseSmallJson:json data is error";
        }
        if (QLog.isColorLevel()) {
            QLog.d(EmotionJsonUtils.TAG, 2, "parseSmallJson: data is null");
            return "json data is null";
        }
        return "json data is null";
    }

    protected static void o(EmoticonPackage emoticonPackage, int i3, ArrayList<Emoticon> arrayList, IEmoticonManagerService iEmoticonManagerService, JSONObject jSONObject, long j3, JSONObject jSONObject2, JSONArray jSONArray, JSONArray jSONArray2) throws JSONException {
        int i16;
        int i17;
        String str;
        int i18 = 0;
        ...
        b(emoticonPackage, i3, arrayList, iEmoticonManagerService, jSONArray3, jSONArray3.length(), true);
    }
}
