...
public final class PicSearchSvr$ReqBody extends MessageMicro<PicSearchSvr$ReqBody> {
    ...
    public final PBBoolField is_support_mall;
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24, 32, 40, 50, 58, 64, 72, 80, 90, 96, 106, 112}, new String[]{"bytes_session_id", "uint64_src_uin", "uint32_src_term", "uint32_aio_type", "uint64_to_uin", "bytes_user_text", "bytes_key_word", "uin32_gender", "uint32_age", "uint32_open_emotion", "bytes_app_qua", "uint32_support_emotion", "bytes_ext_info", "is_support_mall"}, new Object[]{byteStringMicro, 0L, 0, 0, 0L, byteStringMicro, byteStringMicro, 0, 0, 0, byteStringMicro, 0, byteStringMicro, Boolean.FALSE}, PicSearchSvr$ReqBody.class);
    }
    ...
    public PicSearchSvr$ReqBody() {
        ...
        this.is_support_mall = PBField.initBool(false);
    }
}
