...
public final class TroopInfoRepo$fetchTroopMemberNumForJoin$1 extends Lambda implements Function2<Long, Function3<? super Integer, ? super String, ? super GroupMemberMaxNumRsp, ? extends Unit>, Unit> {
    static IPatchRedirector $redirector_;
    public static final TroopInfoRepo$fetchTroopMemberNumForJoin$1 INSTANCE;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(62999);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 3)) {
            redirector.redirect((short) 3);
        } else {
            INSTANCE = new TroopInfoRepo$fetchTroopMemberNumForJoin$1();
        }
    }

    TroopInfoRepo$fetchTroopMemberNumForJoin$1() {
        super(2);
    ...
    public final void invoke(long j3, @NotNull final Function3<? super Integer, ? super String, ? super GroupMemberMaxNumRsp, Unit> onRsp) {
        ...
        if (b16 != null) {
            b16.getGroupMemberMaxNum(j3, 111, new IGroupMemberMaxNumCallback() { // from class: com.tencent.qqnt.troop.aw
                ...
                public final void onResult(int i3, String str, GroupMemberMaxNumRsp groupMemberMaxNumRsp) {
                    TroopInfoRepo$fetchTroopMemberNumForJoin$1.b(Function3.this, i3, str, groupMemberMaxNumRsp);
                }
            });
        }
    }
