...
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\u0018\u0000 \f2\u00020\u0001:\u0001\fB\u0007\u00a2\u0006\u0004\b\u0013\u0010\u0014J \u0010\t\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0002J\u0018\u0010\f\u001a\u00020\b2\u0006\u0010\u000b\u001a\u00020\n2\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J \u0010\u0012\u001a\u00020\b2\u0006\u0010\u0007\u001a\u00020\r2\u0006\u0010\u000f\u001a\u00020\u000e2\b\u0010\u0011\u001a\u0004\u0018\u00010\u0010\u00a8\u0006\u0015"}, d2 = {"Lcom/tencent/qqnt/pluspanel/processor/VideoCallOnClickProcessor;", "Lcom/tencent/qqnt/pluspanel/logic/b;", "", "uin", "Lcom/tencent/mobileqq/app/QQAppInterface;", "app", "Lcom/tencent/aio/api/runtime/a;", "context", "", "f", "Lcom/tencent/qqnt/pluspanel/data/a;", "data", "a", "Landroid/content/Context;", "Landroid/app/Activity;", WinkPublishMediaRecord.WINK_REPORT_TYPE_ACTIVITY, "", "content", "d", "<init>", "()V", "base_proj_nt_ext_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes34.dex */
public final class VideoCallOnClickProcessor implements com.tencent.qqnt.pluspanel.logic.b {

    /* renamed from: a, reason: collision with root package name */
    private static final a f360486a = new a(null);

    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/qqnt/pluspanel/processor/VideoCallOnClickProcessor$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "base_proj_nt_ext_impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes34.dex */
    ...
    public void a(com.tencent.qqnt.pluspanel.data.a data, final com.tencent.aio.api.runtime.a context) {
        ...
        com.tencent.qqnt.pluspanel.processor.util.a.f360544a.a(context, new Function2<Long, QQAppInterface, Unit>() { // from class: com.tencent.qqnt.pluspanel.processor.VideoCallOnClickProcessor$onClick$1
            ...
            public final void invoke(long j3, QQAppInterface app) {
                ...
                VideoCallOnClickProcessor.this.f(j3, app, context);
            }
        });
    }
    ...
    public final void d(Context context, Activity activity, String content) {
        ...
        ?? N2 = LBSHandler.N2(context, content, new DialogInterface.OnClickListener() { // from class: com.tencent.qqnt.pluspanel.processor.ag
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
                VideoCallOnClickProcessor.e(Ref.ObjectRef.this, dialogInterface, i3);
            }
        }, null);
    ...
    public final void f(long uin, QQAppInterface app, com.tencent.aio.api.runtime.a context) {
        ...
        sessionInfo2.f179563i = context.g().r().c().g();
        if (app.getAVNotifyCenter().g(requireActivity, 2, sessionInfo2.f179555d, sessionInfo2.f179557e)) {
            return;
        }
        int i3 = sessionInfo2.f179555d;
        if (i3 == 1) {
            cp.c.e(true);
            a71.a.a(app, requireActivity, sessionInfo2, 10, true, app.getCurrentUin(), "AIOQAVCheckPermission");
            com.tencent.qqnt.pluspanel.processor.util.a.f360544a.b(context, "VideoCallOnClickProcessor");
            return;
        }
        if (i3 == 1010 && !com.tencent.mobileqq.dating.f.a(app, sessionInfo2.f179557e)) {
        ...
        if (i16 == 1001 || i16 == 10002) {
            str = "VideoCallOnClickProcessor";
            sessionInfo = sessionInfo2;
            ReportController.o(app, "CliOper", "", "", "0X8005153", "0X8005153", 0, 0, "", "", "", "");
            if (!LBSHandler.D2(app, sessionInfo.f179557e)) {
                ...
                ReportController.o(app, "CliOper", "", "", "0X8005155", "0X8005155", 0, 0, "", "", "", "");
                ReportController.o(app, "CliOper", "", "", "0X8005155", "0X8005155", 0, 0, "", "", "", "");
                if (sessionInfo.f179555d == 1001) {
                    str2 = "0";
                } else {
                    str2 = "1";
                }
                ReportController.o(app, "dc00899", "grp_lbs", "", "c2c_tmp", "tip_annoy", 0, 0, str2, "1", "", "");
                return;
            }
        } else {
            str = "VideoCallOnClickProcessor";
        ...
        PlusPanelUtils.h(app, requireActivity, sessionInfo3, false, null, hashMap);
        com.tencent.qqnt.pluspanel.processor.util.a.f360544a.b(context, str);
        l61.a.b(app, "0X8004086", sessionInfo3.f179555d);
    }
}
