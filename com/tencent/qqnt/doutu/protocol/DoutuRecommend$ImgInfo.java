...
public final class DoutuRecommend$ImgInfo extends MessageMicro<DoutuRecommend$ImgInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24, 32, 42, 50, 56, 64, 72, 82, 90}, new String[]{"bytes_pic_md5", "uint64_pic_size", "uint32_pic_width", "uint32_pic_height", "bytes_pic_down_url", "bytes_thumb_file_md5", "uint64_thumb_size", "uint32_thumb_width", "uint32_thumb_height", "bytes_thumb_down_url", "bytes_source_name"}, new Object[]{byteStringMicro, 0L, 0, 0, byteStringMicro, byteStringMicro, 0L, 0, 0, byteStringMicro, byteStringMicro}, DoutuRecommend$ImgInfo.class);
    }

    public DoutuRecommend$ImgInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
