...
public final class LinkAndPkInvitePage extends ConstraintLayout {
    ...
    public LinkAndPkInvitePage(@NotNull b eventTrigger, @NotNull Context context, @NotNull LifecycleOwner lifecycleOwner, @NotNull AnchorTabPageContext pageContext, @NotNull a anchorSelectInviteInfoModel) {
        super(context);
    ...
    private final void z0(Context context) {
        ...
        linkAndPkInviteHeadView.setInviteBizType(3);
        ...
        recommendAnchorListView.setRecommendInviteType(3);
        recommendAnchorListView.setSource(1);
