...
public class DownloadStartLog extends ReplaceBaseLog {
    static IPatchRedirector $redirector_;
    public long downloadStartTime;

    public DownloadStartLog() {
    ...
    public String build() {
        ...
        return super.build() + "|" + this.downloadStartTime + "|" + b.a(this.externalParams, ContainerUtils.FIELD_DELIMITER);
    }
