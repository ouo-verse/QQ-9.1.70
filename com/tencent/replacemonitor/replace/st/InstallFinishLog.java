...
public class InstallFinishLog extends ReplaceBaseLog {
    static IPatchRedirector $redirector_;
    public long installEndTime;

    public InstallFinishLog() {
    ...
    public String build() {
        ...
        return super.build() + "|" + this.installEndTime + "|" + b.a(this.externalParams, ContainerUtils.FIELD_DELIMITER);
    }
