...
public class DownloadFinishLog extends ReplaceBaseLog {
    static IPatchRedirector $redirector_;
    public long downloadFinishTime;

    public DownloadFinishLog() {
    ...
    public String build() {
        ...
        return super.build() + "|" + this.downloadFinishTime + "|" + b.a(this.externalParams, ContainerUtils.FIELD_DELIMITER);
    }
