...
public class TbsConfig {
    ...
    public static final boolean ENABLE_DEBUGTBS = true;
    ...
    public static final boolean TBS_READER_MODE = true;
    public static final String TBS_SDK_VERSIONNAME = "4.4.2";
    public static final boolean TMF_BUILD = false;
}
