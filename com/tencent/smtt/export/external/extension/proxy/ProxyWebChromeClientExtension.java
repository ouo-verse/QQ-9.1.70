...
public class ProxyWebChromeClientExtension implements IX5WebChromeClientExtension {
    ...
    @Override // com.tencent.smtt.export.external.extension.interfaces.IX5WebChromeClientExtension
    public void onBackforwardFinished(int i3) {
        IX5WebChromeClientExtension iX5WebChromeClientExtension = this.mWebChromeClient;
        if (iX5WebChromeClientExtension != null) {
            iX5WebChromeClientExtension.onBackforwardFinished(i3);
        }
    }
    ...
    @Override // com.tencent.smtt.export.external.extension.interfaces.IX5WebChromeClientExtension
    public boolean onPermissionRequest(String str, long j3, MediaAccessPermissionsCallback mediaAccessPermissionsCallback) {
        return false;
    }
    ...
    @Override // com.tencent.smtt.export.external.extension.interfaces.IX5WebChromeClientExtension
    public boolean onSavePassword(String str, String str2, String str3, boolean z16, Message message) {
        IX5WebChromeClientExtension iX5WebChromeClientExtension = this.mWebChromeClient;
        if (iX5WebChromeClientExtension == null) {
            return false;
        }
        try {
            return iX5WebChromeClientExtension.onSavePassword(str, str2, str3, z16, message);
    ...
    public void openFileChooser(ValueCallback<Uri[]> valueCallback, String str, String str2) {
        ...
        if (iX5WebChromeClientExtension != null && sCompatibleOpenFileChooser) {
            try {
                ...
                if (e16.getMessage() != null && e16.getMessage().contains("openFileChooser")) {
    ...
    @Override // com.tencent.smtt.export.external.extension.interfaces.IX5WebChromeClientExtension
    public boolean onSavePassword(ValueCallback<String> valueCallback, String str, String str2, String str3, String str4, String str5, boolean z16) {
        IX5WebChromeClientExtension iX5WebChromeClientExtension = this.mWebChromeClient;
        if (iX5WebChromeClientExtension != null && sCompatibleNewOnSavePassword) {
            try {
                return iX5WebChromeClientExtension.onSavePassword(valueCallback, str, str2, str3, str4, str5, z16);
            } catch (NoSuchMethodError e16) {
                if (e16.getMessage() == null) {
                    throw e16;
                }
                if (e16.getMessage().contains("onSavePassword")) {
    ...
    @Override // com.tencent.smtt.export.external.extension.interfaces.IX5WebChromeClientExtension
    public void onColorModeChanged(long j3) {
    }
}
