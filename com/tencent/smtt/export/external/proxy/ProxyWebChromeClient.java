...
public class ProxyWebChromeClient implements IX5WebChromeClient {
    ...
    @Override // com.tencent.smtt.export.external.interfaces.IX5WebChromeClient
    public boolean onCreateWindow(IX5WebViewBase iX5WebViewBase, boolean z16, boolean z17, Message message) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            return iX5WebChromeClient.onCreateWindow(iX5WebViewBase, z16, z17, message);
        }
        return false;
    }
    ...
    public void onExceededDatabaseQuota(String str, String str2, long j3, long j16, long j17, QuotaUpdater quotaUpdater) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            iX5WebChromeClient.onExceededDatabaseQuota(str, str2, j3, j16, j17, quotaUpdater);
        }
    }
    ...
    public void onProgressChanged(IX5WebViewBase iX5WebViewBase, int i3) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            iX5WebChromeClient.onProgressChanged(iX5WebViewBase, i3);
        }
    }
    ...
    public void onReachedMaxAppCacheSize(long j3, long j16, QuotaUpdater quotaUpdater) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            iX5WebChromeClient.onReachedMaxAppCacheSize(j3, j16, quotaUpdater);
        }
    }
    ...
    public void onReceivedTouchIconUrl(IX5WebViewBase iX5WebViewBase, String str, boolean z16) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            iX5WebChromeClient.onReceivedTouchIconUrl(iX5WebViewBase, str, z16);
        }
    }
    ...
    @Override // com.tencent.smtt.export.external.interfaces.IX5WebChromeClient
    public void openFileChooser(ValueCallback<Uri[]> valueCallback, String str, String str2, boolean z16) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            iX5WebChromeClient.openFileChooser(valueCallback, str, str2, z16);
        }
    }
    ...
    public void onConsoleMessage(String str, int i3, String str2) {
        IX5WebChromeClient iX5WebChromeClient = this.mWebChromeClient;
        if (iX5WebChromeClient != null) {
            iX5WebChromeClient.onConsoleMessage(str, i3, str2);
        }
    }
