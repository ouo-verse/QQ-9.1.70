...
public abstract class ProxyWebViewClient implements IX5WebViewClient {
    ...
    public void doUpdateVisitedHistory(IX5WebViewBase iX5WebViewBase, String str, boolean z16) {
        ...
        if (iX5WebViewClient != null) {
            iX5WebViewClient.doUpdateVisitedHistory(iX5WebViewBase, str, z16);
        }
    }

    @Override // com.tencent.smtt.export.external.interfaces.IX5WebViewClient
    public void onContentSizeChanged(IX5WebViewBase iX5WebViewBase, int i3, int i16) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null) {
            iX5WebViewClient.onContentSizeChanged(iX5WebViewBase, i3, i16);
        }
    }
    ...
    public void onReceivedError(IX5WebViewBase iX5WebViewBase, int i3, String str, String str2) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null) {
            iX5WebViewClient.onReceivedError(iX5WebViewBase, i3, str, str2);
        }
    }
    ...
    public void onScaleChanged(IX5WebViewBase iX5WebViewBase, float f16, float f17) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null) {
            iX5WebViewClient.onScaleChanged(iX5WebViewBase, f16, f17);
        }
    }
    ...
    public boolean shouldOverrideKeyEvent(IX5WebViewBase iX5WebViewBase, KeyEvent keyEvent) {
        IX5WebViewClient iX5WebViewClient = this.mWebViewClient;
        if (iX5WebViewClient != null && iX5WebViewClient.shouldOverrideKeyEvent(iX5WebViewBase, keyEvent)) {
            return true;
        }
        return false;
    }
