...
public class j1 extends t8 {

    /* renamed from: e, reason: collision with root package name */
    public String f127925e;

    /* renamed from: f, reason: collision with root package name */
    public LinkedList f127926f = new LinkedList();
    ...
    public final int a(int i3, Object... objArr) {
        ...
        if (i3 == 0) {
            ...
            String str = this.f127925e;
            if (str != null) {
                aVar.a(2, str);
            }
            aVar.a(3, 8, this.f127926f);
            return 0;
        }
        if (i3 == 1) {
            ...
            return i16 + com.tencent.luggage.wxa.gr.a.a(3, 8, this.f127926f);
        }
        if (i3 == 2) {
        ...
        if (intValue != 1) {
            if (intValue != 2) {
                ...
                for (int i17 = 0; i17 < size; i17++) {
                    ...
                    j1Var.f127926f.add(o1Var);
                }
                return 0;
            }
            j1Var.f127925e = aVar3.i(intValue);
            return 0;
        }
