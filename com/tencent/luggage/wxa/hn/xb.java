...
public class xb extends com.tencent.luggage.wxa.fn.b {
    ...
    public final int a(int i3, Object... objArr) {
        if (i3 == 0) {
            ((com.tencent.luggage.wxa.mr.a) objArr[0]).b(1, this.f129032d);
            return 0;
        }
        if (i3 == 1) {
            return com.tencent.luggage.wxa.gr.a.b(1, this.f129032d) + 0;
        }
        if (i3 == 2) {
        ...
        xbVar.f129032d = aVar2.f(intValue);
        return 0;
    }
}
