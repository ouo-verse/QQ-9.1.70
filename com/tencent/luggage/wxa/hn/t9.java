...
public class t9 extends t8 {
    ...
    public final int a(int i3, Object... objArr) {
        ...
        if (i3 == 0) {
            ...
            y yVar = this.f128744e;
            if (yVar != null) {
                aVar.c(2, yVar.a());
                this.f128744e.a(aVar);
            }
            String str = this.f128745f;
            if (str != null) {
                aVar.a(3, str);
            }
            return 0;
        ...
        if (i3 == 1) {
            ...
            y yVar2 = this.f128744e;
            if (yVar2 != null) {
                i16 += com.tencent.luggage.wxa.gr.a.c(2, yVar2.a());
            }
            String str2 = this.f128745f;
            if (str2 != null) {
        ...
        if (intValue != 1) {
            if (intValue != 2) {
                ...
                t9Var.f128745f = aVar3.i(intValue);
                return 0;
            }
