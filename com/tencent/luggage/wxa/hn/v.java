...
public class v extends com.tencent.luggage.wxa.fn.b {
    ...
    public final int a(int i3, Object... objArr) {
        ...
        if (i3 == 1) {
            String str3 = this.f128850d;
            if (str3 != null) {
                i16 = 0 + com.tencent.luggage.wxa.gr.a.a(1, str3);
            }
            String str4 = this.f128851e;
            if (str4 != null) {
        ...
        if (intValue != 1) {
            ...
            vVar.f128851e = aVar3.i(intValue);
            return 0;
        }
        vVar.f128850d = aVar3.i(intValue);
        return 0;
    }
}
