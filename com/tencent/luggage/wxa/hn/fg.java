...
public class fg extends com.tencent.luggage.wxa.fn.b {
    ...
    public final int a(int i3, Object... objArr) {
        ...
        if (i3 == 1) {
            ...
            return i16 + com.tencent.luggage.wxa.gr.a.b(3, this.f127642f);
        }
        if (i3 == 2) {
        ...
        if (intValue != 1) {
            if (intValue != 2) {
                ...
                fgVar.f127642f = aVar3.f(intValue);
                return 0;
            }
            fgVar.f127641e = aVar3.i(intValue);
            return 0;
        }
        fgVar.f127640d = aVar3.i(intValue);
        return 0;
    }
}
