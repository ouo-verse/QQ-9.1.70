...
public class f3 extends t8 {
    ...
    public final int a(int i3, Object... objArr) {
        ...
        if (i3 == 1) {
            ...
            return i16 + com.tencent.luggage.wxa.gr.a.b(3, this.f127600f);
        }
        if (i3 == 2) {
        ...
        if (intValue != 1) {
            if (intValue != 2) {
                ...
                f3Var.f127600f = aVar3.f(intValue);
                return 0;
            }
            f3Var.f127599e = aVar3.i(intValue);
            return 0;
        }
