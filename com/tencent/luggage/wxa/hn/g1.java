...
public class g1 extends s8 {
    ...
    public final int a(int i3, Object... objArr) {
        ...
        if (i3 == 0) {
            ...
            String str = this.f127660e;
            if (str != null) {
                aVar.a(2, str);
            }
            String str2 = this.f127661f;
            if (str2 != null) {
                aVar.a(3, str2);
            }
            String str3 = this.f127662g;
            if (str3 != null) {
                aVar.a(4, str3);
            }
            return 0;
        ...
        if (intValue != 1) {
            if (intValue != 2) {
                if (intValue != 3) {
                    ...
                    g1Var.f127662g = aVar3.i(intValue);
                    return 0;
                }
                g1Var.f127661f = aVar3.i(intValue);
                return 0;
            }
            g1Var.f127660e = aVar3.i(intValue);
            return 0;
        }
