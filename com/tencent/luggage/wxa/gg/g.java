...
public class g extends com.tencent.luggage.wxa.xd.a {
    ...
    public void invoke(l lVar, JSONObject jSONObject, int i3) {
        w.d("MicroMsg.JsApiUpdateShareMenuShareTicket", "invoke");
        v J = lVar.J();
        if (J != null) {
            ...
            b16.c().b("enable_share_with_share_ticket", Boolean.valueOf(optBoolean));
            lVar.a(i3, makeReturnJson(FaceConstant.HeadUpload.QQ_HEAD_UPLOAD_ERRMSG_SUCCESS));
            w.d("MicroMsg.JsApiUpdateShareMenuShareTicket", "update share menu withShareTicket(%s)", Boolean.valueOf(optBoolean));
            return;
        }
