...
public class l implements d {
    ...
    public final boolean a(com.tencent.luggage.wxa.vc.d dVar, Canvas canvas, String str, float f16, float f17, float f18) {
        ...
        if (dVar.f().c() == a.EnumC5993a.TOP) {
            ...
            d16 = dVar.d();
            float measureText = d16.measureText(str);
            if (f18 <= 0.0f && f18 < measureText) {
                canvas.save();
                canvas.translate(f16, f17);
                canvas.scale(f18 / measureText, 1.0f);
                canvas.drawText(str, 0.0f, 0.0f, d16);
                canvas.restore();
                return true;
            }
            canvas.drawText(str, f16, f17, d16);
            return true;
        }
        f17 += abs;
        d16 = dVar.d();
        float measureText2 = d16.measureText(str);
        if (f18 <= 0.0f) {
        }
        canvas.drawText(str, f16, f17, d16);
        return true;
