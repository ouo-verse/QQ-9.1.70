...
public final class ItemViewProfileView extends AbstractItemView {
    ...
    public ItemViewProfileView(Context context, final ShowMsgPanelParams params, final Function1<? super MsgAction, Unit> dispatchAction) {
        ...
        doBindImage(R.drawable.i95);
        doBindText(R.string.f169759xg1);
        ...
        squareReporter.setElementInfo(item, SquareReportConst.ElementId.ELEMENT_ID_CHAT_MSG_PANEL_VIEW_TA_PROFILE_BTN, mutableMapOf, false, false);
        setOnClickListener(new View.OnClickListener() { // from class: com.tencent.state.publicchat.view.msgPanel.ItemViewProfileView.1
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                dispatchAction.invoke(new ViewTaProfileAction(params.getUser()));
                SquareBaseKt.getSquareReporter().reportEvent("clck", ItemViewProfileView.this.getItem(), new LinkedHashMap());
            }
        });
    }
}
