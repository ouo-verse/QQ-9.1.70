...
public final class ItemViewReportView extends AbstractItemView {
    ...
    public ItemViewReportView(Context context, final ShowMsgPanelParams params, final Function1<? super MsgAction, Unit> dispatchAction) {
        ...
        if (params.getShowReport()) {
            ...
            doBindImage(R.drawable.i97);
            doBindText(R.string.xfz);
            ...
            squareReporter.setElementInfo(item, SquareReportConst.ElementId.ELEMENT_ID_CHAT_MSG_PANEL_REPORT_BTN, mutableMapOf, false, false);
            setOnClickListener(new View.OnClickListener() { // from class: com.tencent.state.publicchat.view.msgPanel.ItemViewReportView.1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    dispatchAction.invoke(new ReportMsgAction(params.getMsg()));
                    SquareBaseKt.getSquareReporter().reportEvent("clck", ItemViewReportView.this.getItem(), new LinkedHashMap());
                }
            });
            return;
        }
