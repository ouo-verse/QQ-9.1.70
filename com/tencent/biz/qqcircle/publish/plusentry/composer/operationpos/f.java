...
public final class f extends BasePlusEntryOperationPosComposer {
    ...
    public f(@NotNull IPartHost partHost, @NotNull View plusEntryLayout) {
        ...
        this.normalView = plusEntryLayout.findViewById(R.id.f501724o);
    }
    ...
    @NotNull
    public String d() {
        return "PlusEntry-QTabPlusEntryOperationPosComposerExpD";
    }
