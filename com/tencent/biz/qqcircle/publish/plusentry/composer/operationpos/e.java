...
public final class e extends BasePlusEntryOperationPosComposer {
    ...
    public e(@NotNull IPartHost partHost, @NotNull View plusEntryLayout) {
        ...
        this.normalView = plusEntryLayout.findViewById(R.id.f501624n);
    }
    ...
    @NotNull
    public String d() {
        return "PlusEntry-QTabPlusEntryOperationPosComposerExpC";
    }
