...
public final class d extends BasePlusEntryOperationPosComposer {
    ...
    public d(@NotNull IPartHost partHost, @NotNull View plusEntryLayout) {
        ...
        this.normalView = plusEntryLayout.findViewById(R.id.f501524m);
    }
    ...
    @NotNull
    public String d() {
        return "PlusEntry-QTabPlusEntryOperationPosComposerExpB";
    }
