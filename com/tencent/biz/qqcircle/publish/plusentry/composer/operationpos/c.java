...
public class c extends BasePlusEntryOperationPosComposer {
    ...
    public c(@NotNull IPartHost partHost, @NotNull View plusEntryLayout) {
        ...
        this.normalView = plusEntryLayout.findViewById(R.id.f501924q);
    }
    ...
    @NotNull
    public String d() {
        return "PlusEntry-QTabPlusEntryOperationPosComposer";
    }
