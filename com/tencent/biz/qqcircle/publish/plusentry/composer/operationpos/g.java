...
public final class g extends BasePlusEntryOperationPosComposer {
    ...
    public g(@NotNull IPartHost partHost, @NotNull View plusEntryLayout) {
        ...
        this.normalView = plusEntryLayout.findViewById(R.id.f501824p);
    }
    ...
    @NotNull
    public String d() {
        return "PlusEntry-QTabPlusEntryOperationPosComposerExpE";
    }
