...
public class QFSGetFeedListUnifiedTagRequest extends QCircleBaseRequest {
    public FeedCloudRead$StGetFeedListReq mRequest = new FeedCloudRead$StGetFeedListReq();

    public QFSGetFeedListUnifiedTagRequest(QFSFlowAggregationInitBean qFSFlowAggregationInitBean, String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            this.mRequest.feedAttchInfo.set(str);
        }
        this.mRequest.from.set(0);
        this.mRequest.source.set(44);
        ...
        if (qFSFlowAggregationInitBean != null && qFSFlowAggregationInitBean.getFeedUnifiedTag() != null) {
            qQCircleFeedBase$StFeedListBusiReqData.unifiedTagInfo.set(qFSFlowAggregationInitBean.getFeedUnifiedTag());
        }
    ...
    public String get$cmd() {
        return "FeedCloudSvr.trpc.feedcloud.commreader.ComReader.GetFeedListUnifiedTag";
    }
