...
public class QFSSearchMixTagItemView extends QFSSearchBaseCardItemView {
    public QFSSearchMixTagItemView(@NonNull Context context, int i3) {
        super(context, i3);
    }
    ...
    public String getLogTag() {
        return "QFSSearchMixTagItemView";
    }
    ...
    @Override // com.tencent.biz.qqcircle.immersive.views.search.component.cardcontainer.view.QFSSearchBaseCardItemView
    protected String u0() {
        return QCircleDaTongConstant.ElementId.EM_XSJ_TAG_CARD_FEED;
    }
