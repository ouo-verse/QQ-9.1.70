...
public class QFSSplitLineItemView extends QFSBaseMessageItemView {
    private static final String TAG = "QFSSplitLineItemView";

    public QFSSplitLineItemView(@NonNull Context context, int i3) {
        super(context, i3);
    }
