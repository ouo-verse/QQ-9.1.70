...
public class QFSPolymerizationHotTagFragment extends QFSPolymerizationTagBaseFragment {
    ...
    class a implements MultiViewBlock.OnLoadDataDelegate {
        ...
        public void onLoadData(LoadInfo loadInfo, Object obj) {
            QFSPolymerizationHotTagFragment qFSPolymerizationHotTagFragment;
            QCirclePolymerizationViewModel qCirclePolymerizationViewModel;
            if (loadInfo.isLoadMoreState() && (qCirclePolymerizationViewModel = (qFSPolymerizationHotTagFragment = QFSPolymerizationHotTagFragment.this).P) != null) {
                qCirclePolymerizationViewModel.h2(qFSPolymerizationHotTagFragment.getContext(), QFSPolymerizationHotTagFragment.this.Q, true, false, 0);
            }
        }
    }
    ...
    public void Gh(UIStateData<List<e30.b>> uIStateData, boolean z16) {
        ...
        if (!z16 && this.U && f.i()) {
            RFWLog.e("QFSPolymerizationHotTagFragment", RFWLog.USR, "[handleSuccessRsp] tag: hot tab load more in advance");
            this.P.h2(getContext(), this.Q, true, true, 0);
            this.U = false;
        }
    }
    ...
    public Map<String, Object> getChildDaTongPageParams() {
        ...
        childDaTongPageParams.put(QCircleDaTongConstant.ElementParamKey.XSJ_TAB_TITLE, h.a(R.string.f196084gc));
    ...
    public String getTAG() {
        return "QFSPolymerizationHotTagFragment";
    }
    ...
    public void initViewModel() {
        super.initViewModel();
        this.P.C.observe((QCirclePolymerizationFragment) getParentFragment(), new Observer() { // from class: com.tencent.biz.qqcircle.fragments.polymerization.a
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                QFSPolymerizationHotTagFragment.this.Ch((UIStateData) obj);
            }
        });
    }
}
