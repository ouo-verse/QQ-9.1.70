...
public class QCircleRelativePopupWindow extends PopupWindow {
    ...
    public QCircleRelativePopupWindow(Context context) {
        super(context);
    }
    ...
    public void dismiss() {
        z70.b x16 = QFSFeedChildAdTopViewPresenter.x1(com.tencent.biz.qqcircle.immersive.utils.bk.b(getContentView()));
        if (x16 != null) {
            x16.j(this);
        }
        super.dismiss();
    ...
    */
                        ...
                        if (i16 == 0) {
                            if (i16 != 1) {
                                if (i16 != 2) {
                                    ...
                                    x16 = QFSFeedChildAdTopViewPresenter.x1(com.tencent.biz.qqcircle.immersive.utils.bk.b(getContentView()));
                                    if (x16 == null) {
                                        x16.c(this);
                                        return;
                                    }
    ...
    public QCircleRelativePopupWindow(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    public QCircleRelativePopupWindow(Context context, AttributeSet attributeSet, int i3) {
