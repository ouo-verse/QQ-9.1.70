...
public class a<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public a(T t16) {
        this.f82487m = t16;
        t16.registerAdapterDataObserver(new C0840a());
    }

    static /* bridge */ /* synthetic */ d i0(a aVar) {
        aVar.getClass();
        return null;
    }
    ...
    public int getItemCount() {
        return this.C.size() + this.f82487m.getItemCount() + this.D.size();
    }
    ...
    public long getItemId(int i3) {
        ...
        if (i3 < this.C.size() + this.f82487m.getItemCount()) {
            return this.f82487m.getItemId(i3 - this.C.size());
        }
        return this.D.get((i3 - this.C.size()) - this.f82487m.getItemCount()).hashCode();
    }
    ...
    public int getItemViewType(int i3) {
        ...
        if (i3 < this.C.size() + this.f82487m.getItemCount()) {
            return this.f82487m.getItemViewType(i3 - this.C.size());
        }
        return ((i3 - 2000) - this.C.size()) - this.f82487m.getItemCount();
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3, List<Object> list) {
        ...
        } else if (i3 < this.C.size() + this.f82487m.getItemCount()) {
            this.f82487m.onBindViewHolder(viewHolder, i3 - this.C.size(), list);
        } else {
            super.onBindViewHolder(viewHolder, i3, list);
        }
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i3) {
        ...
        return this.f82487m.onCreateViewHolder(viewGroup, i3);
    }
    ...
    public void onViewAttachedToWindow(RecyclerView.ViewHolder viewHolder) {
        ...
        T t16 = this.f82487m;
        if (t16 == null || !(viewHolder instanceof z10.b)) {
            return;
        }
    ...
    /* compiled from: P */
    /* renamed from: com.tencent.biz.pubaccount.weishi.view.recyclerview.a$a, reason: collision with other inner class name */
    /* loaded from: classes32.dex */
    class C0840a extends RecyclerView.AdapterDataObserver {
        C0840a() {
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3) {
        ...
        if (i3 < this.C.size() + this.f82487m.getItemCount()) {
            this.f82487m.onBindViewHolder(viewHolder, i3 - this.C.size());
            return;
        }
        layoutParams = StaggeredGridLayoutManager.LayoutParams.class.isInstance(viewHolder.itemView.getLayoutParams()) ? (StaggeredGridLayoutManager.LayoutParams) viewHolder.itemView.getLayoutParams() : null;
        if (layoutParams == null) {
