...
public class RoundCornerImageView extends PressDarkImageView {
    ...
    public void draw(Canvas canvas) {
        if (this.f94223m == null) {
            this.f94223m = new Path();
        }
        this.f94223m.reset();
        ...
        float f16 = i3;
        this.f94223m.addRoundRect(rectF, f16, f16, Path.Direction.CCW);
        this.f94223m.setFillType(Path.FillType.EVEN_ODD);
        canvas.clipPath(this.f94223m);
        super.draw(canvas);
        if (this.F) {
