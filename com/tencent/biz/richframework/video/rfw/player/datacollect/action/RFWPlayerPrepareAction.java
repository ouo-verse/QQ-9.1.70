...
public class RFWPlayerPrepareAction implements RFWPlayerCollectBaseAction {
    ...
    public void onAction(String str, RFWPlayerCollectParams rFWPlayerCollectParams, Object... objArr) {
        if (!TextUtils.isEmpty(str) && rFWPlayerCollectParams != null && objArr.length != 0) {
            ...
            if (obj instanceof Long) {
                rFWPlayerCollectParams.setPrepareCostTimeS(Float.valueOf(a(rFWPlayerCollectParams.getPlayRequestStartTime(), ((Long) obj).longValue())).floatValue());
                c(b(str), "onPrepareFinish", rFWPlayerCollectParams.toString());
            }
        }
    }
}
