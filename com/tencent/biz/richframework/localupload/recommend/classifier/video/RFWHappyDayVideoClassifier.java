...
public final class RFWHappyDayVideoClassifier extends RFWBaseVideoClassifier {
    ...
    public Pair<String, String[]> getQuerySelectInfo() {
        return RFWResearchClassifyUtils.getQueryInfoByTags$default(RFWResearchClassifyUtils.INSTANCE, new String[]{"\u901a\u7528"}, new String[]{"\u5a5a\u793c"}, 0.0f, 4, null);
    }
    ...
    public List<RFWMediaInfo> handpick(@NotNull List<RFWMediaInfo> rfwMediaInfoList) {
        ...
        sortedWith = CollectionsKt___CollectionsKt.sortedWith(rfwMediaInfoList, new Comparator() { // from class: com.tencent.biz.richframework.localupload.recommend.classifier.video.RFWHappyDayVideoClassifier$handpick$$inlined$sortedByDescending$1
