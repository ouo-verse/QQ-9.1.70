...
public final class RFWFootprintVideoClassifier extends RFWBaseTravelVideoClassifier {
    ...
    public Pair<String, String[]> getQuerySelectInfo() {
        ...
        plus = ArraysKt___ArraysJvmKt.plus((Object[]) new String[]{residentCityConfig, "none", "", String.valueOf(currentTimeMillis - 31536000000L), String.valueOf(currentTimeMillis)}, (Object[]) travelTagQueryInfo.getSecond());
