...
public class QUIShimmerFrameLayout extends FrameLayout implements QUIShimmerInterface {
    private static final String TAG = "QUIShimmerFrameLayout";
    QUIShimmerEntity shimmerEntity;

    public QUIShimmerFrameLayout(Context context) {
        this(context, null);
    }
    ...
    public QUIShimmerFrameLayout(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public QUIShimmerFrameLayout(Context context, @Nullable AttributeSet attributeSet, int i3) {
