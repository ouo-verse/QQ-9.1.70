...
public class QUIShimmerLinearLayout extends RelativeLayout implements QUIShimmerInterface {
    private static final String TAG = " QUIShimmerLinearLayout";
    QUIShimmerEntity shimmerEntity;

    public QUIShimmerLinearLayout(Context context) {
        this(context, null);
    }
    ...
    public QUIShimmerLinearLayout(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public QUIShimmerLinearLayout(Context context, @Nullable AttributeSet attributeSet, int i3) {
