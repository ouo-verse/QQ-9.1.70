...
public class QUIShimmerRelativeLayout extends RelativeLayout implements QUIShimmerInterface {
    private static final String TAG = " QUIShimmerRelativeLayout";
    QUIShimmerEntity shimmerEntity;

    public QUIShimmerRelativeLayout(Context context) {
        this(context, null);
    }
    ...
    public QUIShimmerRelativeLayout(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public QUIShimmerRelativeLayout(Context context, @Nullable AttributeSet attributeSet, int i3) {
