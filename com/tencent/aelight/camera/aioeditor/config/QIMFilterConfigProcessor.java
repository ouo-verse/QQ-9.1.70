...
public class QIMFilterConfigProcessor extends l<a.c> {
    ...
    public class a implements a.b {
        ...
        public void a(String str) {
            ((IVideoFilterTools) QRoute.api(IVideoFilterTools.class)).updateQQShortVideoFilterConfig(BaseApplication.getContext(), str);
        }
    }
    ...
    public int migrateOldVersion() {
        if (new File(((ICaptureVideoFilterManager) QRoute.api(ICaptureVideoFilterManager.class)).getQQFilterConfigpath() + IVideoFilterTools.BASE_CONFIG).exists()) {
            return ((IVideoFilterTools) QRoute.api(IVideoFilterTools.class)).getQQShortVideoFilterConfigVersion(BaseApplication.getContext());
        }
        return 0;
    }
    ...
    public a.c onParsed(ai[] aiVarArr) {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("QIMFilterConfigProcessor", 2, "handleGetQIMFilterConfig onParsed, content:" + str);
        }
        return new com.tencent.aelight.camera.aioeditor.capture.util.a().b(str, b.e(), IVideoFilterTools.TEMP_FILTER_CONFIG_ZIP, new a());
    }
}
