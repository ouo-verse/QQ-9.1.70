...
public class QIMDynamicTextConfigProcessor extends l<a.c> {
    ...
    public class a implements a.b {
        ...
        public void a(String str) {
            ((DynamicTextConfigManager) f.c(7)).l(str);
        }
    }
    ...
    public int migrateOldVersion() {
        if (DynamicTextConfigManager.n()) {
            return ea.U(BaseApplication.getContext());
        }
        return 0;
    }
    ...
    public a.c onParsed(ai[] aiVarArr) {
        ...
        String str = aiVarArr[aiVarArr.length - 1].f202268b;
        if (QLog.isColorLevel()) {
            QLog.d("QIMDynamicTextConfigProcessor", 2, "handleQIMDynamicTextConfig onParsed, content:" + str);
        }
        return new com.tencent.aelight.camera.aioeditor.capture.util.a().b(str, DynamicTextConfigManager.G.getAbsolutePath(), "temp_dynamic_text_zip", new a());
    }
}
