...
import com.tencent.aelight.camera.ae.camera.ui.panel.bp;
...
/* compiled from: P */
@Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u001a\"\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u00022\b\b\u0002\u0010\u0005\u001a\u00020\u0004H\u0002\u001a4\u0010\u000e\u001a\u00020\u00062\"\u0010\f\u001a\u001e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n0\bj\u000e\u0012\u0004\u0012\u00020\t\u0012\u0004\u0012\u00020\n`\u000b2\u0006\u0010\r\u001a\u00020\u0004H\u0002\u001a\u0018\u0010\u000f\u001a\u00020\u00062\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0002\u001a\u0018\u0010\u0010\u001a\u00020\u00062\u0006\u0010\u0001\u001a\u00020\u00002\u0006\u0010\u0003\u001a\u00020\u0002H\u0002\u001a\f\u0010\u0012\u001a\u00020\t*\u00020\u0011H\u0002\u001a\f\u0010\u0014\u001a\u00020\t*\u00020\u0013H\u0002\u00a8\u0006\u0015"}, d2 = {"Landroid/view/View;", "v", "Lcom/tencent/aelight/camera/ae/camera/ui/panel/bj;", PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME, "", "rightBeautyBtnMode", "", "e", "Ljava/util/HashMap;", "", "", "Lkotlin/collections/HashMap;", "paramsMap", "isRightBeautyBtnMode", "d", tl.h.F, "i", "Lcom/tencent/aelight/camera/ae/camera/ui/panel/BeautyItem;", "f", "Lcom/tencent/aelight/camera/ae/camera/ui/panel/BeautySecondaryItem;", "g", "aelight_impl_release"}, k = 2, mv = {1, 7, 1})
...
public final class ab {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f65018b;
    ...
    public static final void e(View view, bj bjVar, int i3) {
        if (bjVar instanceof ar) {
            ar arVar = (ar) bjVar;
            int i16 = a.f65017a[arVar.getBeautyConfig().getCom.tencent.biz.pubaccount.util.api.impl.PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME java.lang.String().ordinal()];
            if (i16 == 1) {
                ...
                d(e17, i3);
                Intrinsics.checkNotNullExpressionValue(e17, "g().generateElementParam\u2026tnMode)\n                }");
                ...
                Intrinsics.checkNotNullExpressionValue(e18, "this");
                d(e18, i3);
                VideoReport.setElementParams(view, e18);
            }
        }
        if (bjVar instanceof bu) {
            ...
            d(e19, i3);
            Intrinsics.checkNotNullExpressionValue(e19, "g().generateElementParam\u2026tBeautyBtnMode)\n        }");
    ...
    private static final String f(BeautyItem beautyItem) {
        switch (a.f65017a[beautyItem.ordinal()]) {
            case 1:
            default:
                return "none";
            case 2:
    ...
    private static final String g(BeautySecondaryItem beautySecondaryItem) {
        switch (a.f65018b[beautySecondaryItem.ordinal()]) {
            case 1:
            case 17:
                return "ziran";
            case 2:
    ...
    public static final void h(View view, bj bjVar) {
        ...
        if (bjVar instanceof ar) {
            ar arVar = (ar) bjVar;
            int i3 = a.f65017a[arVar.getBeautyConfig().getCom.tencent.biz.pubaccount.util.api.impl.PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME java.lang.String().ordinal()];
            if (i3 == 1) {
    ...
    private static final void d(HashMap<String, Object> hashMap, int i3) {
        String str;
        if (i3 == 0) {
            return;
        }
