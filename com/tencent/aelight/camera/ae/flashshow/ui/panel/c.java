...
public final class c extends RecyclerView.Adapter<a> {
    ...
    public static final class a extends RecyclerView.ViewHolder {
        ...
        public a(View itemView) {
            ...
            int itemHighlightColor = f.a().getItemHighlightColor();
            int itemNormalColor = f.a().getItemNormalColor();
    ...
    public c(Context context, int i3, Function3<? super View, ? super bj, ? super Integer, Unit> listener) {
    ...
    public static final void t(bj item, c this$0, a aVar, int i3, View view) {
        ...
        if (item.getEnable()) {
            ...
            String string = this$0.context.getResources().getString(f.a().getUnusableToastTextId());
    ...
    */
    public void onBindViewHolder(final a p06, final int p16) {
        ...
        if (bk.a(bjVar)) {
            ...
            p06.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.aelight.camera.ae.flashshow.ui.panel.b
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    c.t(bj.this, this, p06, p16, view);
                }
            });
            ...
            ab.e(view, bjVar, this.rightBeautyBtnMode);
        ...
        p06.itemView.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.aelight.camera.ae.flashshow.ui.panel.b
            ...
            public final void onClick(View view3) {
                c.t(bj.this, this, p06, p16, view3);
            }
        });
        p06.getDownloadView().setVisibility((bjVar.getUsable() && !bjVar.getCom.tencent.libra.trace.LibraTraceConst.Node.IMAGE_DOWNLOADING java.lang.String() && bjVar.getEnable()) ? 0 : 8);
        p06.getProgressView().setVisibility((bjVar.getUsable() && bjVar.getCom.tencent.libra.trace.LibraTraceConst.Node.IMAGE_DOWNLOADING java.lang.String() && bjVar.getEnable()) ? 0 : 8);
        ...
        Intrinsics.checkNotNullExpressionValue(view3, "p0.itemView");
        ab.e(view3, bjVar, this.rightBeautyBtnMode);
