...
public class AEPlayMaterialDownloadWrap {
    ...
    public static class InstanceHolder {
        public static final AEPlayMaterialDownloadWrap multiDownloadManager = new AEPlayMaterialDownloadWrap();

        InstanceHolder() {
        }
    }

    AEPlayMaterialDownloadWrap() {
    }
    ...
    public synchronized void notifyDownloadFinish(final AEMaterialMetaData aEMaterialMetaData, boolean z16) {
        ...
        if (str2 != null && str2.equals(str) && z16 && aEMaterialMetaData.equals(AEPlayShowGridAdapter.selectedMaterial)) {
            ThreadManager.getUIHandler().post(new Runnable() { // from class: com.tencent.aelight.camera.ae.play.AEPlayMaterialDownloadWrap.2
                /* JADX WARN: Multi-variable type inference failed */
                @Override // java.lang.Runnable
                public void run() {
                    int i3 = aEMaterialMetaData.playShowType;
                    if (i3 == 0) {
                        if (AEPlayMaterialDownloadWrap.this.mPartManager == null || AEPlayMaterialDownloadWrap.this.mPartManager.get() == 0) {
                            return;
                        }
                        AEPlayShowGridAdapter.selectedMidMaterial = aEMaterialMetaData;
                        ((c) AEPlayMaterialDownloadWrap.this.mPartManager.get()).q(393218, aEMaterialMetaData);
                        return;
                    }
                    if ((i3 != 4 && i3 != 5 && i3 != 6 && i3 != 7) || AEPlayMaterialDownloadWrap.this.mPartManager == null || AEPlayMaterialDownloadWrap.this.mPartManager.get() == 0) {
                        return;
                    }
                    ((c) AEPlayMaterialDownloadWrap.this.mPartManager.get()).q(655361, aEMaterialMetaData);
                }
            });
        }
        if (list == null) {
    ...
    public void startDownload(c cVar, final AEMaterialManager aEMaterialManager, final AEMaterialMetaData aEMaterialMetaData) {
        ...
        ThreadManagerV2.excute(new Runnable() { // from class: com.tencent.aelight.camera.ae.play.AEPlayMaterialDownloadWrap.1
            @Override // java.lang.Runnable
            public void run() {
    ...
    private static class DownloadProcessListener implements com.tencent.aelight.camera.download.a {
        ...
        public void onDownloadFinish(AEMaterialMetaData aEMaterialMetaData, boolean z16, int i3) {
            ...
            if (z16) {
                ...
                QLog.e(AEPlayMaterialDownloadWrap.TAG, 1, "download failed with id: " + aEMaterialMetaData.f69050id);
            }
            AEPlayMaterialDownloadWrap.getInstance().notifyDownloadFinish(aEMaterialMetaData, z16);
            AEPlayMaterialDownloadWrap.getInstance().deleteDownloadListener(aEMaterialMetaData.f69050id);
        }
        ...
        public void onProgressUpdate(AEMaterialMetaData aEMaterialMetaData, int i3) {
            ...
            AEPlayMaterialDownloadWrap.getInstance().notifyDownloadProgress(aEMaterialMetaData.f69050id, i3);
        }
    }
}
