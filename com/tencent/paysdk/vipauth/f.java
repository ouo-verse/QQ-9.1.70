...
public class f extends DefinitionAuthInternal {
    static IPatchRedirector $redirector_;

    public f(@NonNull @NotNull com.tencent.paysdk.api.c cVar) {
        super(cVar);
    ...
    public void a(int i3, String str) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
            ...
            com.tencent.paysdk.log.c.b("VodDefinitionAuthInternal", str);
            super.a(i3, str);
        }
    }
    ...
    protected Map<String, Object> c(int i3, long j3) {
        ...
        hashMap.put("vid", this.f342103c.c().c().n());
        hashMap.put("cid", this.f342103c.c().c().b());
        return hashMap;
    }
    ...
    public void onFailed(int i3) {
        ...
        com.tencent.paysdk.log.c.a("VodDefinitionAuthInternal", "Definition auth failed:\n" + this.f342101a.toString());
        super.onFailed(i3);
    }
}
