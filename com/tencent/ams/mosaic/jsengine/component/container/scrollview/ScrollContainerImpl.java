...
public class ScrollContainerImpl extends BasicScrollContainer<d> {
    ...
    public class a extends d {
        ...
        a(Context context) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1, (Object) this, (Object) ScrollContainerImpl.this, (Object) context);
            }
        }
        ...
        public void e(Canvas canvas) {
            ...
            if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
                ScrollContainerImpl.this.o(canvas);
                super.e(canvas);
            } else {
    ...
    public ScrollContainerImpl(Context context, String str, float f16, float f17) {
    ...
    public float getScrollPosition() {
        ...
        return MosaicUtils.E(((d) this.f71095e).g());
    }
    ...
    public void scrollTo(float f16, boolean z16) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 7)) {
            ...
            ((d) this.f71095e).i(0, (int) MosaicUtils.j(f16));
        } else {
            ((d) this.f71095e).m(0, (int) MosaicUtils.j(f16));
        }
    }
    ...
    protected void x() {
        ...
        ((d) this.f71095e).getView().addView(this.f71096f, new FrameLayout.LayoutParams(-1, -2));
        ((d) this.f71095e).k(this);
