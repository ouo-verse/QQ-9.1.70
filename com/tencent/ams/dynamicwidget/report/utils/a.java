...
public class a {
    ...
    public static boolean a(String str) {
        return b(str, "GET", "", false);
    }

    public static boolean b(String str, String str2, String str3, boolean z16) {
        ...
        try {
            ...
            try {
                ...
                url2 = url;
                try {
                    b.f70218a.b("ReportHttpUtils", "ping failed: " + url2 + ", with exception", th);
        ...
        if (responseCode > -1 && responseCode < 400) {
            b.f70218a.a("ReportHttpUtils", "ping success: " + url);
            try {
                httpURLConnection.disconnect();
        ...
        b.f70218a.a("ReportHttpUtils", "ping failed: " + url);
        httpURLConnection.disconnect();
    }
}
