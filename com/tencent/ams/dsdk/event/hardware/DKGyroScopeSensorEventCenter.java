...
public class DKGyroScopeSensorEventCenter extends DKSensorEventCenter {
    ...
    public interface EventParamsBuilder {
        JSONObject build(float f16, float f17, float f18, long j3);
    }

    public DKGyroScopeSensorEventCenter(WeakReference<DKEngine> weakReference, Handler handler, int i3) {
    ...
    protected JSONObject createParams(SensorEvent sensorEvent) {
        ...
        if (sensorEvent != null && (fArr = sensorEvent.values) != null && fArr.length >= 3) {
            ...
            return eventParamsBuilder.build(f16, f17, f18, j3);
        }
    ...
    public void setEventParamsBuilder(WeakReference<EventParamsBuilder> weakReference) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
            ...
            run(new Runnable(weakReference) { // from class: com.tencent.ams.dsdk.event.hardware.DKGyroScopeSensorEventCenter.1
...

                {
                    ...
                    if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 1)) {
                        iPatchRedirector2.redirect((short) 1, (Object) this, (Object) DKGyroScopeSensorEventCenter.this, (Object) weakReference);
                    }
                }
                ...
                public void run() {
                    ...
                    if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 2)) {
                        DKGyroScopeSensorEventCenter.this.setEventParamsBuilderImpl(this.val$builder);
                    } else {
