...
public final class e implements Cloneable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj == null || !(obj instanceof e) || this.f368868d != ((e) obj).b()) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        return (int) this.f368868d;
    }

    public e(byte[] bArr, int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
            this.f368868d = ((bArr[i3 + 3] << 24) & 4278190080L) + ((bArr[i3 + 2] << RegisterType.UNINIT_REF) & ITVKAsset.VOD_ASSET_MASK_BIT) + ((bArr[i3 + 1] << 8) & 65280) + (bArr[i3] & 255);
        } else {
