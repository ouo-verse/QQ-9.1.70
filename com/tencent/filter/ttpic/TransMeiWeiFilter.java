...
public class TransMeiWeiFilter extends BaseFilter {
    ...
    public void applyFilterChain(boolean z16, float f16, float f17) {
        ...
        gPUImageLookupFilter.addParam(new UniformParam.TextureBitmapParam("inputImageTexture2", BitmapUtils.decodeBitmap("filter/egWeizhidao1/eftMeiwei/meiwei_lf.png"), 33986, true));
