...
public class FengJngFilter extends BaseFilter {
    ...
    public void applyFilterChain(boolean z16, float f16, float f17) {
        ...
        baseFilter2.addParam(new UniformParam.FloatsParam("shadowsShift", new float[]{-0.02745098f, 0.0f, 0.011764706f}));
        baseFilter2.addParam(new UniformParam.FloatsParam("midtonesShift", new float[]{-0.02745098f, 0.0f, 0.011764706f}));
        baseFilter2.addParam(new UniformParam.FloatsParam("highlightsShift", new float[]{-0.02745098f, 0.0f, 0.011764706f}));
