...
public class ActiveLogReportWithTxcLoginV2Task extends BaseLogReportTask {
    public static final String TAG = "MSF.C.ActiveLogReportWithTxcLoginV2Task";

    /* JADX INFO: Access modifiers changed from: package-private */
    public ActiveLogReportWithTxcLoginV2Task(@NonNull ReportLogInfoContext reportLogInfoContext) {
