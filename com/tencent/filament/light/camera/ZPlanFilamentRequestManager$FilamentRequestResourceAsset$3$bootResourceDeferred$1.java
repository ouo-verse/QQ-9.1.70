...
@DebugMetadata(c = "com.tencent.filament.light.camera.ZPlanFilamentRequestManager$FilamentRequestResourceAsset$3$bootResourceDeferred$1", f = "ZPlanFilamentRequestManager.kt", i = {}, l = {104}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes2.dex */
final class ZPlanFilamentRequestManager$FilamentRequestResourceAsset$3$bootResourceDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BootResourceModel>, Object> {
    int label;

    /* JADX INFO: Access modifiers changed from: package-private */
    public ZPlanFilamentRequestManager$FilamentRequestResourceAsset$3$bootResourceDeferred$1(Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new ZPlanFilamentRequestManager$FilamentRequestResourceAsset$3$bootResourceDeferred$1(completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super BootResourceModel> continuation) {
        return ((ZPlanFilamentRequestManager$FilamentRequestResourceAsset$3$bootResourceDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
