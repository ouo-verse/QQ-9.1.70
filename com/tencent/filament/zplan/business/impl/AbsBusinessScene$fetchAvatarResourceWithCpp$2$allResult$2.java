...
@DebugMetadata(c = "com.tencent.filament.zplan.business.impl.AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$2", f = "AbsBusinessScene.kt", i = {}, l = {394, 396}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAvatarInterfaceResult>, Object> {
    final /* synthetic */ List $checkAvatarResult;
    int I$0;
    Object L$0;
    Object L$1;
    int label;
    ...
    public AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$2(AbsBusinessScene$fetchAvatarResourceWithCpp$2 absBusinessScene$fetchAvatarResourceWithCpp$2, List list, Continuation continuation) {
        super(2, continuation);
        this.this$0 = absBusinessScene$fetchAvatarResourceWithCpp$2;
        this.$checkAvatarResult = list;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$2(this.this$0, this.$checkAvatarResult, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAvatarInterfaceResult> continuation) {
        return ((AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i16 != 0) {
            ...
            JSONObject jSONObject = absBusinessScene$fetchAvatarResourceWithCpp$2.$avatarInfo;
            this.label = 1;
            obj = absBusinessScene.fetchAvatarWithCpp(zPlanAvatarService, jSONObject, this);
        ...
        if (cVar.getEnableCheck()) {
            List list3 = this.$checkAvatarResult;
