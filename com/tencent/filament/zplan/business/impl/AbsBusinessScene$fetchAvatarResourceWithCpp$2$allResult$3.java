...
@DebugMetadata(c = "com.tencent.filament.zplan.business.impl.AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$3", f = "AbsBusinessScene.kt", i = {}, l = {401}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAction[]>, Object> {
    ...
    public AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$3(AbsBusinessScene$fetchAvatarResourceWithCpp$2 absBusinessScene$fetchAvatarResourceWithCpp$2, EnumUserGender enumUserGender, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$3(this.this$0, this.$gender, completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAction[]> continuation) {
        return ((AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            this.label = 1;
            obj = absBusinessScene.fetchActionArrayWithCpp(zPlanAvatarService, enumUserGender, this);
