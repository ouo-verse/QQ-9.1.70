...
@DebugMetadata(c = "com.tencent.filament.zplan.business.impl.AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$1", f = "AbsBusinessScene.kt", i = {}, l = {e0.CTRL_INDEX, 391}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAvatarInterfaceResult>, Object> {
    final /* synthetic */ List $checkBootResult;
    int I$0;
    Object L$0;
    Object L$1;
    int label;
    ...
    public AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$1(AbsBusinessScene$fetchAvatarResourceWithCpp$2 absBusinessScene$fetchAvatarResourceWithCpp$2, List list, Continuation continuation) {
        super(2, continuation);
        this.this$0 = absBusinessScene$fetchAvatarResourceWithCpp$2;
        this.$checkBootResult = list;
    }
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$1(this.this$0, this.$checkBootResult, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAvatarInterfaceResult> continuation) {
        return ((AbsBusinessScene$fetchAvatarResourceWithCpp$2$allResult$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i16 != 0) {
            ...
            this.label = 1;
            obj = absBusinessScene.fetchBootWithCpp(zPlanAvatarService, this);
        ...
        if (cVar.getEnableCheck()) {
            List list3 = this.$checkBootResult;
