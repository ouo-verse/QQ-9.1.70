...
/* compiled from: P */
@Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\u0010\u0000\u001a\u00020\u0001*\u00020\u0002H\u008a@\u00a2\u0006\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0006"}, d2 = {"<anonymous>", "Lcom/tencent/filament/zplan/animation/ZPlanAction;", "Lkotlinx/coroutines/CoroutineScope;", "invoke", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", "com/tencent/filament/zplan/business/impl/AbsBusinessScene$fetchActionWithStatistic$2$actions$1$1$1", "com/tencent/filament/zplan/business/impl/AbsBusinessScene$fetchActionWithStatistic$2$$special$$inlined$forEach$lambda$1"}, k = 3, mv = {1, 4, 2})
@DebugMetadata(c = "com.tencent.filament.zplan.business.impl.AbsBusinessScene$fetchActionWithStatistic$2$actions$1$1$1", f = "AbsBusinessScene.kt", i = {}, l = {1096}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class AbsBusinessScene$fetchActionWithStatistic$2$invokeSuspend$$inlined$measure$lambda$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAction>, Object> {
    ...
    public AbsBusinessScene$fetchActionWithStatistic$2$invokeSuspend$$inlined$measure$lambda$1(FetchActionData fetchActionData, Continuation continuation, ArrayList arrayList, AbsBusinessScene$fetchActionWithStatistic$2 absBusinessScene$fetchActionWithStatistic$2, CoroutineScope coroutineScope, b bVar) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new AbsBusinessScene$fetchActionWithStatistic$2$invokeSuspend$$inlined$measure$lambda$1(this.$fetchActionData, completion, this.$jobList$inlined, this.this$0, this.$this_supervisorScope$inlined, this.$fetchActionSpan$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAction> continuation) {
        return ((AbsBusinessScene$fetchActionWithStatistic$2$invokeSuspend$$inlined$measure$lambda$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            this.label = 1;
            obj = zPlanAvatarResourceHelper.z(cVar, enumUserGender, actionId, urlTemplate, this);
