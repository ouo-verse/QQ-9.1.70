...
@DebugMetadata(c = "com.tencent.filament.zplan.business.impl.AbsBusinessScene$onCostumeChange$2", f = "AbsBusinessScene.kt", i = {0, 0, 0, 0, 2}, l = {FilterEnum.MIC_PTU_BAIXI, 302, 307}, m = "invokeSuspend", n = {"onCostumeChangeSpan", "fetchAvatarInfoSpan", "avatarInfoStep", "this_$iv", "onCostumeChangeSpan"}, s = {"L$0", "L$1", "L$2", "L$3", "L$0"})
/* loaded from: classes6.dex */
public final class AbsBusinessScene$onCostumeChange$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public AbsBusinessScene$onCostumeChange$2(AbsBusinessScene absBusinessScene, c cVar, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new AbsBusinessScene$onCostumeChange$2(this.this$0, this.$zplanSpanContext, completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((AbsBusinessScene$onCostumeChange$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            FLog.INSTANCE.i(AbsBusinessScene.TAG, "onCostumeChange start");
            ZPlanSpanFactory zPlanSpanFactory = ZPlanSpanFactory.INSTANCE;
            startSpan = zPlanSpanFactory.startSpan("onCostumeChange", this.$zplanSpanContext);
            this.this$0.getFirstRenderEnd().set(false);
            FilamentEventDispatcher dispatcher = this.this$0.getDispatcher();
            if (dispatcher != null) {
                dispatcher.onEvent("onCostumeChange", "");
            }
            if (startSpan != null) {
                cVar = startSpan.c();
            } else {
            ...
            AbsBusinessScene.FetchAvatarInfoFrom fetchAvatarInfoFrom = AbsBusinessScene.FetchAvatarInfoFrom.ON_COSTUME_CHANGE;
            this.L$0 = startSpan;
            this.L$1 = startSpan2;
            this.L$2 = aVar;
            this.L$3 = aVar;
        ...
        if (a16 == EnumUserGender.GENDER_UNINIT) {
            ...
            if (dispatcher2 != null) {
                ...
                dispatcher2.onEvent("onFilamentRenderFail", jSONObject2);
            }
            return Unit.INSTANCE;
        }
        ...
        if (dispatcher3 != null) {
            ...
            dispatcher3.onEvent("onAvatarInfoReady", jSONObject3);
        }
        FLog.INSTANCE.e(AbsBusinessScene.TAG, "onCostumeChange avatarInfo:" + jSONObject);
