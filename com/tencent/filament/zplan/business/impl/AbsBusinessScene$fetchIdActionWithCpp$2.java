...
@DebugMetadata(c = "com.tencent.filament.zplan.business.impl.AbsBusinessScene$fetchIdActionWithCpp$2", f = "AbsBusinessScene.kt", i = {0, 1}, l = {BusinessInfoCheckUpdateItem.UIAPPID_LEBA_NEARBY_TROOPS, 887}, m = "invokeSuspend", n = {"bodyPathDeferred", "faceResult"}, s = {"L$0", "L$0"})
/* loaded from: classes6.dex */
public final class AbsBusinessScene$fetchIdActionWithCpp$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAction>, Object> {
    ...
    public AbsBusinessScene$fetchIdActionWithCpp$2(ZPlanAvatarService zPlanAvatarService, long j3, EnumUserGender enumUserGender, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        AbsBusinessScene$fetchIdActionWithCpp$2 absBusinessScene$fetchIdActionWithCpp$2 = new AbsBusinessScene$fetchIdActionWithCpp$2(this.$avatarService, this.$actionId, this.$gender, completion);
        absBusinessScene$fetchIdActionWithCpp$2.L$0 = obj;
        return absBusinessScene$fetchIdActionWithCpp$2;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAction> continuation) {
        return ((AbsBusinessScene$fetchIdActionWithCpp$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            async$default = BuildersKt__Builders_commonKt.async$default(coroutineScope, null, null, new AbsBusinessScene$fetchIdActionWithCpp$2$facePathDeferred$1(this, null), 3, null);
            async$default2 = BuildersKt__Builders_commonKt.async$default(coroutineScope, null, null, new AbsBusinessScene$fetchIdActionWithCpp$2$bodyPathDeferred$1(this, null), 3, null);
