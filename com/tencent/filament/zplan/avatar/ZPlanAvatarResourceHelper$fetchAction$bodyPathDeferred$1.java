...
@DebugMetadata(c = "com.tencent.filament.zplan.avatar.ZPlanAvatarResourceHelper$fetchAction$bodyPathDeferred$1", f = "ZPlanAvatarResourceHelper.kt", i = {}, l = {484}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class ZPlanAvatarResourceHelper$fetchAction$bodyPathDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Resource>, Object> {
    ...
    public ZPlanAvatarResourceHelper$fetchAction$bodyPathDeferred$1(com.tencent.zplan.zplantracing.b bVar, String str, FilamentUrlTemplate filamentUrlTemplate, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new ZPlanAvatarResourceHelper$fetchAction$bodyPathDeferred$1(this.$fetchActionSpan, this.$bodyUrl, this.$urlTemplate, completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Resource> continuation) {
        return ((ZPlanAvatarResourceHelper$fetchAction$bodyPathDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
