...
@DebugMetadata(c = "com.tencent.filament.zplan.avatar.ZPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2$pTorsoAssetList$1", f = "ZPlanAvatarResourceHelper.kt", i = {}, l = {1479}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class ZPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2$pTorsoAssetList$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Pair<? extends ZPlanCommonGltfFAsset, ? extends Boolean>>, Object> {
    ...
    public ZPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2$pTorsoAssetList$1(ZPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2 zPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2, com.tencent.zplan.zplantracing.b bVar, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new ZPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2$pTorsoAssetList$1(this.this$0, this.$torsoAssetsSpan, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Pair<? extends ZPlanCommonGltfFAsset, ? extends Boolean>> continuation) {
        return ((ZPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2$pTorsoAssetList$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            boolean z16 = zPlanAvatarResourceHelper$slotFAssetMapWithAvatar$2.$useLod2;
            this.label = 1;
            obj = zPlanAvatarResourceHelper.J(cVar, jSONObject, filamentUrlTemplate, z16, this);
