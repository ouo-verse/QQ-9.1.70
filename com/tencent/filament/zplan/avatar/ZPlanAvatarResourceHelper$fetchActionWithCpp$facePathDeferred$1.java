...
@DebugMetadata(c = "com.tencent.filament.zplan.avatar.ZPlanAvatarResourceHelper$fetchActionWithCpp$facePathDeferred$1", f = "ZPlanAvatarResourceHelper.kt", i = {}, l = {450}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class ZPlanAvatarResourceHelper$fetchActionWithCpp$facePathDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAvatarInterfaceResult>, Object> {
    ...
    public ZPlanAvatarResourceHelper$fetchActionWithCpp$facePathDeferred$1(int i3, EnumUserGender enumUserGender, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new ZPlanAvatarResourceHelper$fetchActionWithCpp$facePathDeferred$1(this.$actionId, this.$gender, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAvatarInterfaceResult> continuation) {
        return ((ZPlanAvatarResourceHelper$fetchActionWithCpp$facePathDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
