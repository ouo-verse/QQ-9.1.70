...
@DebugMetadata(c = "com.tencent.filament.zplan.scene.square.SquareAvatarScene$NormalState$fetchReloadAvatarResourceAsync$1", f = "SquareAvatarScene.kt", i = {}, l = {513}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class SquareAvatarScene$NormalState$fetchReloadAvatarResourceAsync$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ReloadAvatarResourceModel>, Object> {
    ...
    public SquareAvatarScene$NormalState$fetchReloadAvatarResourceAsync$1(SquareAvatarScene.NormalState normalState, com.tencent.zplan.zplantracing.c cVar, JSONObject jSONObject, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new SquareAvatarScene$NormalState$fetchReloadAvatarResourceAsync$1(this.this$0, this.$spanContext, this.$avatarInfo, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ReloadAvatarResourceModel> continuation) {
        return ((SquareAvatarScene$NormalState$fetchReloadAvatarResourceAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            this.label = 1;
            W = ZPlanAvatarResourceHelper.W(zPlanAvatarResourceHelper, cVar, jSONObject, filamentUrlTemplate, false, this, 8, null);
