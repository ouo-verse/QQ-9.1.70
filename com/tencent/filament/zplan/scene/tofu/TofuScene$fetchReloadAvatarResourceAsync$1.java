...
@DebugMetadata(c = "com.tencent.filament.zplan.scene.tofu.TofuScene$fetchReloadAvatarResourceAsync$1", f = "TofuScene.kt", i = {}, l = {298}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class TofuScene$fetchReloadAvatarResourceAsync$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ReloadAvatarResourceModel>, Object> {
    ...
    public TofuScene$fetchReloadAvatarResourceAsync$1(TofuScene tofuScene, c cVar, JSONObject jSONObject, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new TofuScene$fetchReloadAvatarResourceAsync$1(this.this$0, this.$spanContext, this.$avatarInfo, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ReloadAvatarResourceModel> continuation) {
        return ((TofuScene$fetchReloadAvatarResourceAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!tofuScene.hasDownloadFromNet && !reloadAvatarResourceModel.getDownloadFromNet()) {
            z16 = false;
        }
