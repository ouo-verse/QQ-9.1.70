...
@DebugMetadata(c = "com.tencent.filament.zplan.scene.couple.CoupleAvatarScene$fetchBootResourceAndBootAsync$1", f = "CoupleAvatarScene.kt", i = {}, l = {555}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class CoupleAvatarScene$fetchBootResourceAndBootAsync$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super BootResourceModel>, Object> {
    ...
    public CoupleAvatarScene$fetchBootResourceAndBootAsync$1(CoupleAvatarScene coupleAvatarScene, c cVar, String str, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new CoupleAvatarScene$fetchBootResourceAndBootAsync$1(this.this$0, this.$spanContext, this.$bodyTypeName, completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super BootResourceModel> continuation) {
        return ((CoupleAvatarScene$fetchBootResourceAndBootAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        z16 = coupleAvatarScene.hasDownloadFromNet;
        if (!z16 && !bootResourceModel.getDownloadFromNet()) {
            z17 = false;
        }
        coupleAvatarScene.hasDownloadFromNet = z17;
        this.this$0.z0(this.$spanContext, bootResourceModel, this.$bodyTypeName);
