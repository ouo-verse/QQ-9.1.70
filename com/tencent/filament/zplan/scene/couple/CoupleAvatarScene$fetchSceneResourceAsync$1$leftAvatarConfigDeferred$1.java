...
@DebugMetadata(c = "com.tencent.filament.zplan.scene.couple.CoupleAvatarScene$fetchSceneResourceAsync$1$leftAvatarConfigDeferred$1", f = "CoupleAvatarScene.kt", i = {}, l = {620}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class CoupleAvatarScene$fetchSceneResourceAsync$1$leftAvatarConfigDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super AvatarConfig>, Object> {
    int label;
    final /* synthetic */ CoupleAvatarScene$fetchSceneResourceAsync$1 this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CoupleAvatarScene$fetchSceneResourceAsync$1$leftAvatarConfigDeferred$1(CoupleAvatarScene$fetchSceneResourceAsync$1 coupleAvatarScene$fetchSceneResourceAsync$1, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new CoupleAvatarScene$fetchSceneResourceAsync$1$leftAvatarConfigDeferred$1(this.this$0, completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super AvatarConfig> continuation) {
        return ((CoupleAvatarScene$fetchSceneResourceAsync$1$leftAvatarConfigDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            ResultKt.throwOnFailure(obj);
            String b16 = EnumUserGender.INSTANCE.b(this.this$0.$leftAvatarCharacter.optInt("gender"));
            CoupleAvatarScene.Companion companion = CoupleAvatarScene.INSTANCE;
            aVar = this.this$0.this$0.coupleSceneUrlTemplate;
            m3 = companion.m(aVar, this.this$0.$sceneId, "left", b16);
            aVar2 = this.this$0.this$0.coupleSceneUrlTemplate;
            l3 = companion.l(aVar2, this.this$0.$sceneId, "left", b16, "head_anim");
            aVar3 = this.this$0.this$0.coupleSceneUrlTemplate;
            l16 = companion.l(aVar3, this.this$0.$sceneId, "left", b16, "body_anim");
