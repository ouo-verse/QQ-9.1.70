...
@DebugMetadata(c = "com.tencent.filament.zplan.scene.couple.CoupleAvatarScene$fetchReloadAvatarResourceAsync$1", f = "CoupleAvatarScene.kt", i = {}, l = {598}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class CoupleAvatarScene$fetchReloadAvatarResourceAsync$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ReloadAvatarResourceModel>, Object> {
    ...
    public CoupleAvatarScene$fetchReloadAvatarResourceAsync$1(CoupleAvatarScene coupleAvatarScene, c cVar, JSONObject jSONObject, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new CoupleAvatarScene$fetchReloadAvatarResourceAsync$1(this.this$0, this.$spanContext, this.$avatarInfo, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ReloadAvatarResourceModel> continuation) {
        return ((CoupleAvatarScene$fetchReloadAvatarResourceAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (!z16 && !reloadAvatarResourceModel.getDownloadFromNet()) {
            z17 = false;
        }
