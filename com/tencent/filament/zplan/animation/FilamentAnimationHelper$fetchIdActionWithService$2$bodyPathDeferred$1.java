...
@DebugMetadata(c = "com.tencent.filament.zplan.animation.FilamentAnimationHelper$fetchIdActionWithService$2$bodyPathDeferred$1", f = "FilamentAnimationHelper.kt", i = {}, l = {49}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
final class FilamentAnimationHelper$fetchIdActionWithService$2$bodyPathDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ZPlanAvatarInterfaceResult>, Object> {
    int label;
    final /* synthetic */ FilamentAnimationHelper$fetchIdActionWithService$2 this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FilamentAnimationHelper$fetchIdActionWithService$2$bodyPathDeferred$1(FilamentAnimationHelper$fetchIdActionWithService$2 filamentAnimationHelper$fetchIdActionWithService$2, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new FilamentAnimationHelper$fetchIdActionWithService$2$bodyPathDeferred$1(this.this$0, completion);
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super ZPlanAvatarInterfaceResult> continuation) {
        return ((FilamentAnimationHelper$fetchIdActionWithService$2$bodyPathDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
