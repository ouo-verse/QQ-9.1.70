...
@DebugMetadata(c = "com.tencent.filament.zplan.record.FilamentRecordHelper$fetchStickerAnimation$2$bodyDeferred$1", f = "FilamentRecordHelper.kt", i = {}, l = {64}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes6.dex */
public final class FilamentRecordHelper$fetchStickerAnimation$2$bodyDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Resource>, Object> {
    final /* synthetic */ String $bodyName;
    ...
    public FilamentRecordHelper$fetchStickerAnimation$2$bodyDeferred$1(FilamentRecordHelper$fetchStickerAnimation$2 filamentRecordHelper$fetchStickerAnimation$2, String str, String str2, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        return new FilamentRecordHelper$fetchStickerAnimation$2$bodyDeferred$1(this.this$0, this.$bodyUrl, this.$bodyName, completion);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Resource> continuation) {
        return ((FilamentRecordHelper$fetchStickerAnimation$2$bodyDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
