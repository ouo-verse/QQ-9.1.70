...
public final class SceneFocusState$NativeDoFlowerOpRsp extends MessageMicro<SceneFocusState$NativeDoFlowerOpRsp> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 42}, new String[]{"scene_address", "do_op_result", "do_op_message", "flower_data", "gif_url"}, new Object[]{0L, 0, "", null, ""}, SceneFocusState$NativeDoFlowerOpRsp.class);
