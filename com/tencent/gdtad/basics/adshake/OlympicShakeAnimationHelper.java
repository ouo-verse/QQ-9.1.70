...
import com.tencent.gdtad.basics.adshake.animatorview.animator.RotationAnimator;
...
public class OlympicShakeAnimationHelper {
    ...
    private static final int SHAKE_ANIMATOR_TIME = 480;
    ...
    private static RotationAnimator createStepAnimator(AnimatorLayer animatorLayer, IconParams iconParams, float f16, float f17, long j3, float f18, float f19, float f26, float f27) {
        ...
        rotationAnimator.setRotationCenter((iconParams.iconX + iconParams.iconWidth) - Utils.n(5.0f, Resources.getSystem()), (iconParams.iconY + iconParams.iconHeight) - Utils.n(16.0f, Resources.getSystem()));
        rotationAnimator.setInterpolator(new PathInterpolator(f18, f19, f26, f27));
    ...
    public static AnimatorLayer getShakeIconAnimatorLayer(Bitmap bitmap, IconParams iconParams, Animator.AnimatorListener animatorListener) {
        if (bitmap != null && iconParams != null) {
            ...
            sequentialAnimator.setRepeatInterval(480L);
