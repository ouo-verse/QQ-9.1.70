...
final class GdtDeviceIdJsCallHandler implements GdtJsCallHandler {
    private static final String TAG = "GdtDeviceJsCallHandler";

    GdtDeviceIdJsCallHandler() {
    }
    ...
    public boolean handleJsCallRequest(@Nullable GdtAdWebPlugin gdtAdWebPlugin, String str, String... strArr) {
        ...
        if (gdtAdWebPlugin != null && activity != null) {
            ...
            try {
                jSONObject.put(Constants.SP_DEVICE_ID, (Object) null);
            } catch (Throwable th5) {
            ...
            AdAnalysisHelperForUtil.reportForJSBridgeInvoked(activity, false, "getDeviceId", gdtAdWebPlugin.getCurrentUrl());
            return true;
        }
