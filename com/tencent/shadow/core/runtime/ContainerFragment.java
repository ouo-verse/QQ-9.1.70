...
public class ContainerFragment extends ReportFragment implements IContainerFragment {
    ...
    private static ShadowFragment instantiatePluginFragment(ContainerFragment containerFragment, Context context) {
        String str = containerFragment.getClass().getName() + "_";
        ...
        try {
            return (ShadowFragment) ShadowFragment.class.cast(constructor.newInstance(new Object[0]));
        } catch (Exception e17) {
    ...
    private void onBindPluginFragment(Context context) {
        ShadowFragment instantiatePluginFragment = instantiatePluginFragment(this, context);
    ...
    @Override // com.tencent.shadow.core.runtime.IContainerFragment
    public void bindPluginFragment(ShadowFragment shadowFragment) {
        this.init = true;
        this.mIsAppCreateFragment = true;
        this.mPluginFragment = shadowFragment;
    }
    ...
    @Override // android.app.Fragment, com.tencent.shadow.core.runtime.IContainerFragment
    ...
    public void onInflate(AttributeSet attributeSet, Bundle bundle) {
        ...
        ShadowFragment shadowFragment = this.mPluginFragment;
        if (shadowFragment != null) {
            shadowFragment.onInflate(attributeSet, bundle);
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        if (activity instanceof PluginContainerActivity) {
            this.mPluginFragment.onAttach((ShadowActivity) ((PluginContainerActivity) activity).getPluginActivity());
        }
    }
