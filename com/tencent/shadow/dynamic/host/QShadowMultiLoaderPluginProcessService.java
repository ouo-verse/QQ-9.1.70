...
public class QShadowMultiLoaderPluginProcessService extends BasePluginProcessService {
                ...
                try {
                    try {
                        try {
                            ...
                            if (file.exists()) {
                                PluginLoaderImpl load = new QShadowLoaderImplLoader().load(pluginLoader, str2, getApplicationContext());
                                if (this.mLogger.isInfoEnabled()) {
                                    this.mLogger.info("setUuidManager " + str);
                                }
