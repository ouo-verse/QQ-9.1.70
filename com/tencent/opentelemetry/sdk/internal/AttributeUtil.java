...
public class AttributeUtil {
    ...
    public static Attributes applyAttributesLimit(Attributes attributes, int i3, final int i16) {
        if (attributes.isEmpty() || attributes.size() <= i3) {
            ...
            if (allMatch(attributes.asMap().values(), new Predicate() { // from class: com.tencent.opentelemetry.sdk.internal.a
    ...
    private static boolean isValidLength(Object obj, final int i3) {
        if (obj instanceof List) {
            return allMatch((List) obj, new Predicate() { // from class: com.tencent.opentelemetry.sdk.internal.b
                @Override // java.util.function.Predicate
