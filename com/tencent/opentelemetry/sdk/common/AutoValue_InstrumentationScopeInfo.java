...
final class AutoValue_InstrumentationScopeInfo extends InstrumentationScopeInfo {
    ...
    public AutoValue_InstrumentationScopeInfo(String str, @Nullable String str2, @Nullable String str3) {
    ...
    @Override // com.tencent.opentelemetry.sdk.common.InstrumentationScopeInfo
    ...
    public String toString() {
        ...
        return "InstrumentationScopeInfo{name=" + this.name + ", version=" + this.version + ", schemaUrl=" + this.schemaUrl + "}";
    }
}
