...
public final class AutoValue_ImmutableLongPointData extends ImmutableLongPointData {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AutoValue_ImmutableLongPointData(long j3, long j16, Attributes attributes, List<ExemplarData> list, long j17) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, this, Long.valueOf(j3), Long.valueOf(j16), attributes, list, Long.valueOf(j17));
            return;
        }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.startEpochNanos == immutableLongPointData.getStartEpochNanos() && this.epochNanos == immutableLongPointData.getEpochNanos() && this.attributes.equals(immutableLongPointData.getAttributes()) && this.exemplars.equals(immutableLongPointData.getExemplars()) && this.value == immutableLongPointData.getValue()) {
            return true;
        }
        return false;
    }
    ...
    @Override // com.tencent.opentelemetry.sdk.metrics.data.LongPointData
    ...
    public String toString() {
        ...
        return "ImmutableLongPointData{startEpochNanos=" + this.startEpochNanos + ", epochNanos=" + this.epochNanos + ", attributes=" + this.attributes + ", exemplars=" + this.exemplars + ", value=" + this.value + "}";
    }
}
