...
public final class WeatherReportStore$WeatherWarningDetail extends MessageMicro<WeatherReportStore$WeatherWarningDetail> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24, 32, 40, 50, 56, 64, 74, 82, 90, 98, 106, 114, 122, 130, 138, 146, 152, 162}, new String[]{"id", "area_id", "type", "level", "status", "content", "pub_time", "op_time", "pub_org", "affect", "defend", "cancle_desc", "province", "city", "type_name", "level_name", ChatsRevealApiImpl.KEY_JUMP_SCHEME, "title", "update_type", GdtGetUserInfoHandler.KEY_AREA}, new Object[]{"", 0, 0, 0, 0, "", 0, 0, "", "", "", "", "", "", "", "", "", "", 0, ""}, WeatherReportStore$WeatherWarningDetail.class);

    /* renamed from: id, reason: collision with root package name */
    public final PBStringField f116941id = PBField.initString("");
    ...
    public final PBEnumField update_type = PBField.initEnum(0);
