...
class TVKOPAvs3AudioDecoderConfigBuilder implements ITVKOptionalParamBuilder {
    ...
    public List<TPOptionalParam<?>> buildOptionalParamList(@NonNull TVKQQLiveAssetPlayerContext tVKQQLiveAssetPlayerContext, boolean z16) {
        ...
        if (!TVKMediaPlayerConfig.PlayerConfig.enable_avs3_audio_decoder_multi_thread) {
            arrayList.add(TPOptionalParam.buildInt(TPOptionalID.OPTIONAL_ID_BEFORE_INT_AVS3_AUDIO_DECODER_THREAD_COUNT, 1));
        }
        return arrayList;
    }
}
