...
public class TVKOPRendererUnlimitedRetryBuilder implements ITVKOptionalParamBuilder {
    ...
    public List<TPOptionalParam<?>> buildOptionalParamList(@NonNull TVKQQLiveAssetPlayerContext tVKQQLiveAssetPlayerContext, boolean z16) {
        ...
        arrayList.add(TPOptionalParam.buildBoolean(TPOptionalID.OPTIONAL_ID_BEFORE_BOOL_ENABLE_RENDERER_UNLIMITED_RETRY, TVKMediaPlayerConfig.PlayerConfig.enable_renderer_unlimited_retry));
        return arrayList;
    }
}
