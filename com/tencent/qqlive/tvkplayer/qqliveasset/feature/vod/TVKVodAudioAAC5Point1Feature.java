...
public class TVKVodAudioAAC5Point1Feature extends TVKVodPlayerFeatureBase {
    public TVKVodAudioAAC5Point1Feature(TVKContext tVKContext) {
        super(tVKContext);
    }
    ...
    public void buildVodCGIParams(@NonNull TVKCGIRequestParam tVKCGIRequestParam, ITVKFeatureParamGroup iTVKFeatureParamGroup, @NonNull Map<String, String> map) {
        boolean z16;
        if (TVKMediaPlayerConfig.PlayerConfig.enable_vod_aac_5_1 && "true".equals(tVKCGIRequestParam.getVideoInfo().getConfigMapValue(TVKPlayerVideoInfo.PLAYER_CFG_KEY_ENABLE_VOD_AUDIO_VIVID_AND_AAC51, ""))) {
            z16 = true;
        } else {
            z16 = false;
        }
        int optInt = TVKUtils.optInt(map.get("spaudio"), 0);
        if (TVKCapabilityMgr.getInstance().isSupportAudioEffect(8, z16)) {
            optInt |= 128;
        }
