...
public class TVKVodAvs3Feature extends TVKVodPlayerFeatureBase {
    public TVKVodAvs3Feature(TVKContext tVKContext) {
        super(tVKContext);
    }

    private int getAvs3Level() {
        if (!this.mEnable) {
            this.mLogger.info("getAvs3Level, mEnable = false, return SPAVS3_NONE", new Object[0]);
            return 0;
        }
        int videoCodecCgiLevel = TVKCapabilityMgr.getInstance().getVideoCodecCgiLevel(2);
        this.mLogger.info("CGI: getAvs3Level, spavs3=" + videoCodecCgiLevel, new Object[0]);
        return videoCodecCgiLevel;
    }
    ...
    public void buildVodCGIParams(@NonNull TVKCGIRequestParam tVKCGIRequestParam, ITVKFeatureParamGroup iTVKFeatureParamGroup, @NonNull Map<String, String> map) {
        map.put(TVKCommonParamEnum.REQ_PARAM_KEY_INNER_AVS3_LEVEL, String.valueOf(getAvs3Level()));
    }
    ...
    public ITVKPlayerFeature.FeaturePlayerAndDecoderChoosePriority getPlayerAndDecoderChoosePriority() {
        return ITVKPlayerFeature.FeaturePlayerAndDecoderChoosePriority.PLAYER_AND_DECODER_CHOOSE_AVS3;
    }
    ...
    public ITVKPlayerFeature.FeatureRetryPriority getRetryPriority() {
        return ITVKPlayerFeature.FeatureRetryPriority.RETRY_AVS3;
    }
    ...
    public boolean isMatchFeature(TVKNetVideoInfo tVKNetVideoInfo) {
        if (tVKNetVideoInfo == null || tVKNetVideoInfo.getCurDefinition() == null || tVKNetVideoInfo.getCurDefinition().getVideoCodec() != 13) {
            return false;
        }
        return true;
    }
