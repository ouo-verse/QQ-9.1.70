...
public class TVKVodAntiScreenShotFeature extends TVKVodPlayerFeatureBase {
    public TVKVodAntiScreenShotFeature(TVKContext tVKContext) {
        super(tVKContext);
    }
    ...
    private void parseVinfoViNode(@NonNull TVKVodVideoInfo tVKVodVideoInfo, NodeList nodeList) {
        ...
        for (int i3 = 0; i3 < nodeList.getLength(); i3++) {
            ...
            if (item.getNodeType() == 1 && "vi".equalsIgnoreCase(item.getNodeName())) {
                tVKVodVideoInfo.setSshot(TVKUtils.optInt(TVKVodPlayerFeatureBase.getElementsTagNameStringValue(item, "sshot"), 0));
                tVKVodVideoInfo.setMshot(TVKUtils.optInt(TVKVodPlayerFeatureBase.getElementsTagNameStringValue(item, "mshot"), 0));
                return;
            }
        }
    }
