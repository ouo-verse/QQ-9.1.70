...
public class TVKVodHdrVividFeature extends TVKVodPlayerFeatureBase {
    private static final int SPVIDEO_HDR_VIVID = 1024;

    public TVKVodHdrVividFeature(TVKContext tVKContext) {
        super(tVKContext);
    }
    ...
    public void buildVodCGIParams(@NonNull TVKCGIRequestParam tVKCGIRequestParam, ITVKFeatureParamGroup iTVKFeatureParamGroup, @NonNull Map<String, String> map) {
        boolean z16;
        if (TVKMediaPlayerConfig.PlayerConfig.hdr_enable && TVKMediaPlayerConfig.PlayerConfig.enable_vod_hdr_vivid && this.mEnable && TVKVodHdrFeatureUtil.doesViewSupportHdr(iTVKFeatureParamGroup)) {
            z16 = true;
        } else {
            z16 = false;
        }
    ...
    public boolean isMatchFeature(TVKNetVideoInfo tVKNetVideoInfo) {
        ...
        if (!"hdr10".equals(curDefinition.getDefn()) || curDefinition.getVideoCodec() != 19) {
            return false;
        }
        return true;
    }
