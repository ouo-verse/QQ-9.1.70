...
public class TVKVodHighFpsFeature extends TVKVodPlayerFeatureBase {
    private static final int COMPLEX_CODEC = 172;

    public TVKVodHighFpsFeature(TVKContext tVKContext) {
        super(tVKContext);
    }

    private int getMaxFpsLevel() {
        int maxFrameRate = TVKTPCapability.getMaxFrameRate(172);
        this.mLogger.info("CGI: \u6700\u5927\u5e27\u7387\uff1a" + maxFrameRate, new Object[0]);
        return maxFrameRate;
    }
    ...
    public void buildVodCGIParams(@NonNull TVKCGIRequestParam tVKCGIRequestParam, ITVKFeatureParamGroup iTVKFeatureParamGroup, @NonNull Map<String, String> map) {
        if (TVKMediaPlayerConfig.PlayerConfig.high_fps_enable) {
            map.put(TVKCommonParamEnum.REQ_PARAM_KEY_SPVFPS, String.valueOf(getMaxFpsLevel()));
        }
    }
    ...
    public boolean isMatchFeature(TVKNetVideoInfo tVKNetVideoInfo) {
        return TVKMediaPlayerConfig.PlayerConfig.high_fps_enable;
    }
