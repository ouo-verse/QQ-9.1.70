...
public class TVKVodChinaDrmFeature extends TVKVodPlayerFeatureBase {
    public TVKVodChinaDrmFeature(TVKContext tVKContext) {
        super(tVKContext);
    }
    ...
    public ITVKPlayerFeature.FeaturePlayerAndDecoderChoosePriority getPlayerAndDecoderChoosePriority() {
        return ITVKPlayerFeature.FeaturePlayerAndDecoderChoosePriority.PLAYER_AND_DECODER_CHOOSE_SELF_CHINA_DRM;
    }
    ...
    public ITVKPlayerFeature.FeatureRetryPriority getRetryPriority() {
        return ITVKPlayerFeature.FeatureRetryPriority.RETRY_SELF_CHINA_DRM;
    }
    ...
    public boolean isMatchFeature(TVKNetVideoInfo tVKNetVideoInfo) {
        ...
        return tVKNetVideoInfo.isMatchDrmType(6);
    }
