...
public class TVKLivePreviewPlayFeature extends TVKLivePlayerFeatureBase {
    public TVKLivePreviewPlayFeature(TVKContext tVKContext) {
        super(tVKContext);
    }
    ...
    public void parseLiveCGIResponse(@NonNull TVKLiveVideoInfo tVKLiveVideoInfo, @NonNull JSONObject jSONObject) throws Exception {
        ...
        tVKLiveVideoInfo.setLiveCurrentPreviewDurationSec(TVKJsonUtils.optInt(optJSONObject, TPReportKeys.LiveExKeys.LIVE_EX_PLAY_TIME, 0));
        tVKLiveVideoInfo.setPreviewDurationSec(TVKJsonUtils.optInt(optJSONObject, "totalplaytime", 0));
        tVKLiveVideoInfo.setPrePlayCountPerDay(TVKJsonUtils.optInt(optJSONObject, "previewcnt", 0));
        tVKLiveVideoInfo.setRestPrePlayCount(TVKJsonUtils.optInt(optJSONObject, "restpreviewcnt", 0));
    }
