...
public class TVKLiveFlvFeature extends TVKLivePlayerFeatureBase {
    public TVKLiveFlvFeature(TVKContext tVKContext) {
        super(tVKContext);
    }
    ...
    public void buildLiveCGIParams(@NonNull TVKCGIRequestParam tVKCGIRequestParam, ITVKFeatureParamGroup iTVKFeatureParamGroup, @NonNull Map<String, String> map) {
        if (!TVKMediaPlayerConfig.PlayerConfig.enable_live_flv) {
            return;
        }
        if (tVKCGIRequestParam.getStreamFormatId() != 1 && tVKCGIRequestParam.getStreamFormatId() != 0) {
            return;
        }
        if (tVKCGIRequestParam.getRequestSource() != 3 && !TVKLivePlayerFeatureBase.isSelfPlayerAvailableForLive()) {
            return;
        }
        addFormatCapabilities(map, 1);
    }
    ...
    public ITVKPlayerFeature.FeaturePlayerAndDecoderChoosePriority getPlayerAndDecoderChoosePriority() {
        return ITVKPlayerFeature.FeaturePlayerAndDecoderChoosePriority.PLAYER_AND_DECODER_CHOOSE_FLV;
    }
    ...
    public ITVKPlayerFeature.FeatureRetryPriority getRetryPriority() {
        return ITVKPlayerFeature.FeatureRetryPriority.RETRY_FLV;
    }
    ...
    public boolean isNeedDisableFeatureForRetry() {
        return TVKMediaPlayerConfig.PlayerConfig.enable_live_flv_downward_retry;
    }
