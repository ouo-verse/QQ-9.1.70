...
public class DTParamKey {
    public static final String CRE_PAGE_CONTENT_ID = "dt_crepg_contentid";
    ...
    public static final String REPORT_KEY_AGG_FLAG = "dt_aggFlag";
    ...
    public static final String REPORT_KEY_AUDIO_DURATION_BACKGROUND = "dt_bg_play_duration";
    public static final String REPORT_KEY_AUDIO_DURATION_FOREGROUND = "dt_audio_duration_foreground";
    public static final String REPORT_KEY_AUDIO_ENDTIME = "dt_audio_endtime";
    ...
    public static final String REPORT_KEY_AUDIO_PLAY_DURATION = "dt_play_duration";
    ...
    public static final String REPORT_KEY_CLICK_TYPE = "dt_click_type";
    ...
    public static final String REPORT_KEY_CRE_PAGE_ID = "dt_cre_pgid";
    ...
    public static final String REPORT_KEY_ELE_SAMPLE_RATE = "dt_ele_samplerate";
    public static final String REPORT_KEY_INEFFECTIVE_TIME_AVERAGE = "dt_ineffective_average";
    public static final String REPORT_KEY_INFO_COUNT = "dt_info_count";
    ...
    public static final String REPORT_KEY_MEDIUM_PLAY_DURATION = "dt_medium_play_duration";
    public static final String REPORT_KEY_PAGE_LIST = "dt_pg_list";
    ...
    public static final String REPORT_KEY_PG_SAMPLE_RATE = "dt_pg_samplerate";
    ...
    public static final String REPORT_KEY_SUM_MEDIUM_PLAY_DURATION = "dt_sum_medium_play_duration";
    ...
    public static final String REPORT_KEY_VISUAL_APP_ID = "dt_appid";
    public static final String REPORT_KEY_VISUAL_DATA = "dt_visual";
    public static final String REPORT_KEY_VISUAL_DEBUG_ID = "dt_debugid";
    public static final String REPORT_KEY_VISUAL_ELEMENTS = "elements";
    public static final String REPORT_KEY_VISUAL_HEIGHT = "height";
    public static final String REPORT_KEY_VISUAL_SESSION_ID = "sessionId";
    public static final String REPORT_KEY_VISUAL_UID = "dt_uid";
    public static final String REPORT_KEY_VISUAL_WIDTH = "width";
