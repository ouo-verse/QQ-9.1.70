...
public class InnerKey {
    ...
    public static final String ELEMENT_EVENT_TYPE = "element_event_type";
    ...
    public static final String PAGE_COLLECT_ALL_ENABLE = "page_collect_all_enable";
    ...
    public static final String PAGE_LINK_ENABLE = "page_link_enable";
    public static final String PAGE_REPORT_IGNORE = "page_report_ignore";
    public static final String PAGE_REPORT_POLICY = "page_report_policy";
