...
public class ReportV7AlertDialog extends AlertDialog {
    ...
    public ReportV7AlertDialog(@NonNull Context context, int i3) {
        super(context, i3);
    }

    protected ReportV7AlertDialog(@NonNull Context context, boolean z16, @Nullable DialogInterface.OnCancelListener onCancelListener) {
