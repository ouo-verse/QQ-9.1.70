...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\t\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\u001a\u000e\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000\u001a\u000e\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000\u001a\u000e\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000\u001a\u001a\u0010\u0007\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u00002\b\b\u0002\u0010\u0006\u001a\u00020\u0002H\u0002\u001a\u0011\u0010\b\u001a\u0004\u0018\u00010\u0002H\u0002\u00a2\u0006\u0004\b\b\u0010\t\u001a\b\u0010\n\u001a\u00020\u0002H\u0002\u001a\b\u0010\u000b\u001a\u00020\u0002H\u0002\u001a\u0018\u0010\u0010\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\f2\u0006\u0010\u000f\u001a\u00020\u000eH\u0002\u00a8\u0006\u0011"}, d2 = {"Landroid/content/Context;", "context", "", h.F, "g", "d", "isCheckConfig", "e", "f", "()Ljava/lang/Boolean;", "a", "c", "", "target", "Lorg/json/JSONArray;", "arr", "b", "qq-live-common-api_release"}, k = 2, mv = {1, 7, 1})
/* loaded from: classes22.dex */
public final class a {
    private static final boolean a() {
        Object obj;
        String MODEL;
        String d16 = ht3.a.d("qqlive_task_pad_black_white_list", "");
        if (TextUtils.isEmpty(d16)) {
            return false;
        }
        try {
            obj = new JSONObject(d16).get("black_list");
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type org.json.JSONArray");
            MODEL = DeviceInfoMonitor.getModel();
            Intrinsics.checkNotNullExpressionValue(MODEL, "MODEL");
        } catch (JSONException unused) {
            QLog.w("ScreenSupportUtil", 1, "isInBlack json parse error,content:" + d16);
        }
    ...
    private static final boolean b(String str, JSONArray jSONArray) {
        ...
        for (int i3 = 0; i3 < length; i3++) {
            try {
                ...
                QLog.w("ScreenSupportUtil", 1, "json parse error,str:" + jSONArray.get(i3));
            }
    ...
    private static final boolean c() {
        ...
        try {
            obj = new JSONObject(d16).get(MobileQQ.PREF_WHITE_LIST_KEY);
            Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type org.json.JSONArray");
            MODEL = DeviceInfoMonitor.getModel();
            Intrinsics.checkNotNullExpressionValue(MODEL, "MODEL");
        } catch (JSONException unused) {
            QLog.w("ScreenSupportUtil", 1, "isInWhite json parse error,content:" + d16);
        }
        if (!b(MODEL, (JSONArray) obj)) {
            return false;
        }
    ...
    public static final boolean g(@NotNull Context context) {
        ...
        if (ScreenUtils.getScreenWidth(context) / displayMetrics.density >= 840.0f && d(context)) {
            z16 = true;
        } else {
            z16 = false;
        }
        ...
        if (ScreenUtils.getScreenWidth(context) <= ScreenUtils.getScreenHeight(context) || !c()) {
            return false;
        }
        return true;
    }
    ...
    public static final boolean h(@NotNull Context context) {
        ...
        if (ScreenUtils.getScreenHeight(context) / displayMetrics.density >= 900.0f && d(context)) {
            z16 = true;
        } else {
            z16 = false;
        }
