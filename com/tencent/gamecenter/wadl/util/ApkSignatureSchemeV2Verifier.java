...
public class ApkSignatureSchemeV2Verifier {
    ...
    private static ByteBuffer b(ByteBuffer byteBuffer, int i3) throws SignatureNotFoundException {
        a(byteBuffer);
        ...
        throw new SignatureNotFoundException("No APK Signature Scheme block with id : " + i3 + " in APK Signing Block");
    }
    ...
    static ByteBuffer e(ByteBuffer byteBuffer, int i3) throws BufferUnderflowException {
        if (i3 >= 0) {
    ...
    public static long f(ByteBuffer byteBuffer, long j3) throws SignatureNotFoundException {
        long g16 = o.g(byteBuffer);
        if (g16 < j3) {
            if (o.h(byteBuffer) + g16 == j3) {
                return g16;
            }
    ...
    public static Pair<ByteBuffer, Long> g(RandomAccessFile randomAccessFile) throws IOException, SignatureNotFoundException {
        Pair<ByteBuffer, Long> c16 = o.c(randomAccessFile);
        if (c16 != null) {
            return c16;
        }
    ...
    public static boolean h(String str, int i3) throws IOException {
        ...
        try {
            ...
            try {
                ...
                if (!o.i(randomAccessFile2, longValue)) {
                    b((ByteBuffer) c(randomAccessFile2, f(byteBuffer, longValue)).first, i3);
    ...
    static ByteBuffer i(ByteBuffer byteBuffer, int i3, int i16) {
        if (i3 >= 0) {
            if (i16 >= i3) {
