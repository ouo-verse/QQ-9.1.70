...
public class SoterBiometricCanceller {
    ...
    /* compiled from: P */
    /* renamed from: com.tencent.soter.wrapper.wrap_biometric.SoterBiometricCanceller$1, reason: invalid class name */
    /* loaded from: classes25.dex */
    class AnonymousClass1 implements Runnable {
        ...
        AnonymousClass1(boolean z16) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1, this, SoterBiometricCanceller.this, Boolean.valueOf(z16));
            }
        }
        ...
        public void run() {
            ...
            SLogger.v(SoterBiometricCanceller.TAG, "soter: enter worker thread. perform cancel", new Object[0]);
    ...
    @SuppressLint({"NewApi"})
    public boolean asyncCancelBiometricAuthenticationInnerImp(boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
        ...
        if (!this.mCancellationSignal.isCanceled()) {
            SoterTaskThread.getInstance().postToWorker(new Runnable() { // from class: com.tencent.soter.wrapper.wrap_biometric.SoterBiometricCanceller.2
                static IPatchRedirector $redirector_;

                {
                    IPatchRedirector iPatchRedirector2 = $redirector_;
                    if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 1)) {
                        iPatchRedirector2.redirect((short) 1, (Object) this, (Object) SoterBiometricCanceller.this);
                    }
                }
            ...
            SoterTaskThread.getInstance().postToWorkerDelayed(new Runnable() { // from class: com.tencent.soter.wrapper.wrap_biometric.SoterBiometricCanceller.3
                static IPatchRedirector $redirector_;
                ...
                public void run() {
                    ...
                    if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 2)) {
                        ...
                        SLogger.w(SoterBiometricCanceller.TAG, "hy: waiting for %s ms not callback to system callback. cancel manually", 350L);
                        SoterBiometricCanceller.this.publishCancel();
                    }
                }
            }, 350L);
