...
public class SoterExportResult implements Parcelable {
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(18309);
        ...
        if (redirector != null && redirector.hasPatch((short) 5)) {
            ...
            CREATOR = new Parcelable.Creator<SoterExportResult>() { // from class: com.tencent.soter.soterserver.SoterExportResult.1
                ...
                public SoterExportResult createFromParcel(Parcel parcel) {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) ? new SoterExportResult(parcel) : (SoterExportResult) iPatchRedirector.redirect((short) 2, (Object) this, (Object) parcel);
                }

                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.os.Parcelable.Creator
                public SoterExportResult[] newArray(int i3) {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? new SoterExportResult[i3] : (SoterExportResult[]) iPatchRedirector.redirect((short) 3, (Object) this, i3);
                }
            };
        }
    }
