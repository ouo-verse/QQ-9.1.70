...
public class SoterSignResult implements Parcelable {
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(18350);
        ...
        if (redirector != null && redirector.hasPatch((short) 5)) {
            ...
            CREATOR = new Parcelable.Creator<SoterSignResult>() { // from class: com.tencent.soter.soterserver.SoterSignResult.1
                ...
                public SoterSignResult createFromParcel(Parcel parcel) {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) ? new SoterSignResult(parcel) : (SoterSignResult) iPatchRedirector.redirect((short) 2, (Object) this, (Object) parcel);
                }

                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.os.Parcelable.Creator
                public SoterSignResult[] newArray(int i3) {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? new SoterSignResult[i3] : (SoterSignResult[]) iPatchRedirector.redirect((short) 3, (Object) this, i3);
                }
            };
        }
    }
