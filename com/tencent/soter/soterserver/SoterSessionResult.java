...
public class SoterSessionResult implements Parcelable {
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(18343);
        ...
        if (redirector != null && redirector.hasPatch((short) 5)) {
            ...
            CREATOR = new Parcelable.Creator<SoterSessionResult>() { // from class: com.tencent.soter.soterserver.SoterSessionResult.1
                ...
                public SoterSessionResult createFromParcel(Parcel parcel) {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) ? new SoterSessionResult(parcel) : (SoterSessionResult) iPatchRedirector.redirect((short) 2, (Object) this, (Object) parcel);
                }

                /* JADX WARN: Can't rename method to resolve collision */
                @Override // android.os.Parcelable.Creator
                public SoterSessionResult[] newArray(int i3) {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) ? new SoterSessionResult[i3] : (SoterSessionResult[]) iPatchRedirector.redirect((short) 3, (Object) this, i3);
                }
            };
        }
    }
