...
@DebugMetadata(c = "com.tencent.hippykotlin.demo.pages.vas_pages.upload_background.UpLoadBackgroundPage$pageDidAppear$1", f = "UploadBackgroundPage.kt", i = {}, l = {356}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes33.dex */
public final class UpLoadBackgroundPage$pageDidAppear$1 extends SuspendLambda implements Function2<b, Continuation<? super Unit>, Object> {
    public UpLoadBackgroundPage L$0;
    public int label;
    public final /* synthetic */ UpLoadBackgroundPage this$0;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UpLoadBackgroundPage$pageDidAppear$1(UpLoadBackgroundPage upLoadBackgroundPage, Continuation<? super UpLoadBackgroundPage$pageDidAppear$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new UpLoadBackgroundPage$pageDidAppear$1(this.this$0, continuation);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(b bVar, Continuation<? super Unit> continuation) {
        return ((UpLoadBackgroundPage$pageDidAppear$1) create(bVar, continuation)).invokeSuspend(Unit.INSTANCE);
    }
