...
import com.tencent.hippykotlin.demo.pages.qsearch_detail_page.data.pb.QSearchVerticalList;
...
public final class QSearchVerticalTemplateModel extends QSearchBaseTitleGroupTemplateModel {
    ...
    public final void parseContent(QSearchTemplate qSearchTemplate) {
        ...
        QSearchVerticalList decode = new QSearchVerticalList(null, null, null, null).decode(new e(qSearchTemplate.data));
