...
public final class QSearchDoubleColumnList implements ISSOReqModel, ISSORspModel<QSearchDoubleColumnList> {
    ...
    public QSearchDoubleColumnList(QSearchText qSearchText, QSearchText qSearchText2, QSearchButton qSearchButton, List<QSearchListDetail> list) {
    ...
    public final QSearchDoubleColumnList decode(e eVar) {
        ArrayList arrayList;
        e m3 = eVar.m("title");
        ...
        return new QSearchDoubleColumnList(m16, m18, decode, arrayList != null ? CollectionsKt___CollectionsKt.toList(arrayList) : null);
    }
}
