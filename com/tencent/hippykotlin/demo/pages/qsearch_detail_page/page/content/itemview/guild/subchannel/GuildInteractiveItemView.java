...
public final class GuildInteractiveItemView extends GuildBaseImageItemView {
    ...
    public final void configFooter(GuildItemFooterAttr guildItemFooterAttr) {
        ...
        guildItemFooterAttr.buttonText = "\u4e00\u8d77\u73a9";
        guildItemFooterAttr.buttonColor = new h(1291845631L);
        guildItemFooterAttr.buttonWidth = 55.0f;
    }

    /* JADX WARN: Type inference failed for: r0v5, types: [com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildInteractiveItemView$configHeader$1$1, kotlin.jvm.internal.Lambda] */
    @Override // com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildBaseImageItemView
    public final void configHeader(GuildItemHeaderAttr guildItemHeaderAttr, final GuildCommonItemModel guildCommonItemModel) {
        guildItemHeaderAttr.text = "\u4e92\u52a8\u4e2d";
        guildItemHeaderAttr.iconColor = new h(4281460479L);
        ...
        guildItemHeaderAttr.rightPartViewBuilder = new Function1<ViewContainer<?, ?>, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildInteractiveItemView$configHeader$1$1
            {
                super(1);
            }
            ...
            public final Unit invoke(ViewContainer<?, ?> viewContainer) {
                ...
                w.a(viewContainer, new Function1<v, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildInteractiveItemView$configHeader$1$1.1
                    {
                        super(1);
                    }
                    ...
                    public final Unit invoke(v vVar) {
                        v vVar2 = vVar;
                        vVar2.attr(new Function1<t, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildInteractiveItemView.configHeader.1.1.1.1
                            @Override // kotlin.jvm.functions.Function1
                        ...
                        cg.a(vVar2, new Function1<TextView, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildInteractiveItemView.configHeader.1.1.1.2
                            {
                                super(1);
                            }
                            ...
                            public final Unit invoke(TextView textView) {
                                ...
                                textView.attr(new Function1<ce, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.qsearch_detail_page.page.content.itemview.guild.subchannel.GuildInteractiveItemView.configHeader.1.1.1.2.1
                                    {
                                        super(1);
                                    }
