...
public final class GuildItemHeaderAttr extends k {
    public static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {YiFanShangDetailBottomButtonAttr$$ExternalSyntheticOutline0.m(GuildItemHeaderAttr.class, "iconSrcAnd", "getIconSrcAnd()Ljava/lang/String;", 0), YiFanShangDetailBottomButtonAttr$$ExternalSyntheticOutline0.m(GuildItemHeaderAttr.class, "iconSrcIOS", "getIconSrcIOS()Ljava/lang/String;", 0), YiFanShangDetailBottomButtonAttr$$ExternalSyntheticOutline0.m(GuildItemHeaderAttr.class, "iconSrcImg", "getIconSrcImg()Ljava/lang/String;", 0), YiFanShangDetailBottomButtonAttr$$ExternalSyntheticOutline0.m(GuildItemHeaderAttr.class, "pageStatus", "getPageStatus()Lcom/tencent/hippykotlin/demo/pages/qsearch_detail_page/PageStatus;", 0)};
    ...
    public float maskStartAlpha;
    public final ReadWriteProperty pageStatus$delegate;
    public Lambda rightPartViewBuilder;
    public UnifySearchTabInfo tabData;
    public String text = "";

    public GuildItemHeaderAttr() {
