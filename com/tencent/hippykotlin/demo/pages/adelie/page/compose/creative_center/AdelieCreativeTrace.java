...
public final class AdelieCreativeTrace {
    ...
    public AdelieCreativeTrace(long j3) {
        this.startTime = j3;
    }
    ...
    public final void report() {
        ...
        m3.append(dump());
        kLog.i("AdelieCreativeTrace", m3.toString());
        this.hasReported = true;
        ((AdelieKuiklyBaseModule) c.f117352a.g().acquireModule("AdelieKuiklyBaseModule")).reportBeacon("adelie_creative_center_page_nt_compose", dump());
    }
}
