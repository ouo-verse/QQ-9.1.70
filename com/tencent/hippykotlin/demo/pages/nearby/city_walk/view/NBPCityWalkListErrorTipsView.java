...
public final class NBPCityWalkListErrorTipsView extends ComposeView<NBPCityWalkListErrorTipsAttr, NBPCityWalkListErrorTipsEvent> {
    /* JADX WARN: Multi-variable type inference failed */
    public static final /* synthetic */ NBPCityWalkListErrorTipsAttr access$getAttr(NBPCityWalkListErrorTipsView nBPCityWalkListErrorTipsView) {
        return (NBPCityWalkListErrorTipsAttr) nBPCityWalkListErrorTipsView.getAttr();
    }

    @Override // com.tencent.kuikly.core.base.ComposeView
    public final Function1<ViewContainer<?, ?>, Unit> body() {
        return new Function1<ViewContainer<?, ?>, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView$body$1
            {
                super(1);
            }
            ...
            public final Unit invoke(ViewContainer<?, ?> viewContainer) {
                ...
                viewContainer2.attr(new Function1<m, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView$body$1.1
                    @Override // kotlin.jvm.functions.Function1
                ...
                final NBPCityWalkListErrorTipsView nBPCityWalkListErrorTipsView = NBPCityWalkListErrorTipsView.this;
                viewContainer2.event(new Function1<Event, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView$body$1.2
                    {
                        super(1);
                    }
                    ...
                    public final Unit invoke(Event event) {
                        final NBPCityWalkListErrorTipsView nBPCityWalkListErrorTipsView2 = NBPCityWalkListErrorTipsView.this;
                        event.click(new Function1<ClickParams, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView.body.1.2.1
                            {
                                super(1);
                            }
                            ...
                            public final Unit invoke(ClickParams clickParams) {
                                NBPCityWalkViewModel nBPCityWalkViewModel = NBPCityWalkListErrorTipsView.access$getAttr(NBPCityWalkListErrorTipsView.this).viewModel;
                                if (nBPCityWalkViewModel == null) {
                                    Intrinsics.throwUninitializedPropertyAccessException("viewModel");
                                    nBPCityWalkViewModel = null;
                                }
                                nBPCityWalkViewModel.fetchSelectList();
                                return Unit.INSTANCE;
                            }
                        });
                        return Unit.INSTANCE;
                ...
                ah.a(viewContainer2, new Function1<ImageView, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView$body$1.3
                    @Override // kotlin.jvm.functions.Function1
                    public final Unit invoke(ImageView imageView) {
                        imageView.attr(new Function1<af, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView.body.1.3.1
                            @Override // kotlin.jvm.functions.Function1
                ...
                cg.a(viewContainer2, new Function1<TextView, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView$body$1.4
                    @Override // kotlin.jvm.functions.Function1
                    public final Unit invoke(TextView textView) {
                        textView.attr(new Function1<ce, Unit>() { // from class: com.tencent.hippykotlin.demo.pages.nearby.city_walk.view.NBPCityWalkListErrorTipsView.body.1.4.1
                            @Override // kotlin.jvm.functions.Function1
    ...
    public final Attr createAttr() {
        return new NBPCityWalkListErrorTipsAttr();
    }

    @Override // com.tencent.kuikly.core.base.AbstractBaseView
    public final Event createEvent() {
        return new NBPCityWalkListErrorTipsEvent();
    }
}
