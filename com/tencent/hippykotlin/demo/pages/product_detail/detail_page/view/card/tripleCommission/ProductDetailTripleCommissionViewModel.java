...
public final class ProductDetailTripleCommissionViewModel implements IProductDetailCardViewModel {
    public final ProductDetailDistributionInfo info;

    public ProductDetailTripleCommissionViewModel(String str) {
    ...
    public final ComposeView<ProductDetailCardAttr, ProductDetailEvent> getCardView() {
        return new ProductDetailTripleCommissionView();
    }
