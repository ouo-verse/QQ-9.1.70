...
public final class ProductDetailDistributionPicturesViewModel extends ProductDetailPicturesViewModel {
    public IReportParamsBuilder reportParams;

    public ProductDetailDistributionPicturesViewModel(String str, IReportParamsBuilder iReportParamsBuilder) {
        super(str);
    ...
    public final ArrayList<ProductDetailPicInfo> getDetailPicArray() {
        ...
        if (detailInfo == null || (sellerProductCardRsp = detailInfo.detail) == null || (product = sellerProductCardRsp.product) == null) {
            return null;
        }
        return product.detailPictures;
    }
