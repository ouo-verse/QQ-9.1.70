...
public final class ProductDetailDistributionCommentViewModel extends ProductDetailCommentViewModel {
    ...
    public ProductDetailDistributionCommentViewModel(String str, IReportParamsBuilder iReportParamsBuilder) {
        this.spuId = str;
    ...
    public final ArrayList<ProductReviewReviewDetail> commentAllItems() {
        ...
        return (productDetailDistributionInfo == null || (productReviewGetsRsp = productDetailDistributionInfo.comment) == null || (arrayList = productReviewGetsRsp.reviewDetail) == null) ? new ArrayList<>() : arrayList;
    }
    ...
    public final String commentCountText() {
        ProductReviewGetsRsp productReviewGetsRsp;
        ProductDetailDistributionInfo productDetailDistributionInfo = this.info;
        int i3 = (productDetailDistributionInfo == null || (productReviewGetsRsp = productDetailDistributionInfo.comment) == null) ? 0 : productReviewGetsRsp.reviewCount;
