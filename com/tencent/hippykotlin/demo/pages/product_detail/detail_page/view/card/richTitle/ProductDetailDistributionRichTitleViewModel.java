...
public final class ProductDetailDistributionRichTitleViewModel implements IProductDetailCardViewModel {
    public final ProductDetailDistributionInfo info;

    public ProductDetailDistributionRichTitleViewModel(String str) {
    ...
    public final ComposeView<ProductDetailCardAttr, ProductDetailEvent> getCardView() {
        return new ProductDetailDistributionRichTextView();
    }
