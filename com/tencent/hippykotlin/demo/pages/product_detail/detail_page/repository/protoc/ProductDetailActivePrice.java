...
public final class ProductDetailActivePrice implements ISSOModel {
    ...
    public ProductDetailActivePrice() {
    ...
    public final String toString() {
        StringBuilder m3 = BlindBoxOperationBottomBarButton$$ExternalSyntheticOutline2.m("ProductDetailActivePrice(min=");
        m3.append(this.min);
        m3.append(", max=");
        m3.append(this.max);
        m3.append(", original=");
    ...
    public ProductDetailActivePrice(long j3, long j16, long j17, String str, String str2, long j18, long j19) {
        this.min = j3;
        this.max = j16;
        this.original = j17;
    ...
    public final boolean equals(Object obj) {
        ...
        if (!(obj instanceof ProductDetailActivePrice)) {
            return false;
        }
        ProductDetailActivePrice productDetailActivePrice = (ProductDetailActivePrice) obj;
        return this.min == productDetailActivePrice.min && this.max == productDetailActivePrice.max && this.original == productDetailActivePrice.original && Intrinsics.areEqual(this.discountPriceTxt, productDetailActivePrice.discountPriceTxt) && Intrinsics.areEqual(this.discountPriceDesc, productDetailActivePrice.discountPriceDesc) && this.live == productDetailActivePrice.live && this.liveSpecial == productDetailActivePrice.liveSpecial;
    }

    public /* synthetic */ ProductDetailActivePrice(long j3, long j16, long j17, String str, String str2, long j18, long j19, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(0L, 0L, 0L, "", "", 0L, 0L);
    }
}
