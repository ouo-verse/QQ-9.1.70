...
public final class ProductDetailPicInfo implements ISSOModel {
    ...
    public final String toString() {
        StringBuilder m3 = BlindBoxOperationBottomBarButton$$ExternalSyntheticOutline2.m("ProductDetailPicInfo(url=");
        m3.append(this.url);
        m3.append(", width=");
    ...
    public ProductDetailPicInfo(String str, int i3, int i16, String str2, String str3, int i17, int i18) {
        this.url = str;
        this.width = i3;
        this.height = i16;
        this.desc = str2;
    ...
    public final boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual(this.url, productDetailPicInfo.url) && this.width == productDetailPicInfo.width && this.height == productDetailPicInfo.height && Intrinsics.areEqual(this.desc, productDetailPicInfo.desc) && Intrinsics.areEqual(this.thumbnailUrl, productDetailPicInfo.thumbnailUrl) && this.thumbnailWidth == productDetailPicInfo.thumbnailWidth && this.thumbnailHeight == productDetailPicInfo.thumbnailHeight;
    }

    public /* synthetic */ ProductDetailPicInfo(String str, int i3, int i16, String str2, String str3, int i17, int i18, int i19, DefaultConstructorMarker defaultConstructorMarker) {
        this("", 0, 0, "", "", 0, 0);
    }
}
