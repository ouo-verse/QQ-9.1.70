...
public final class DoLikeReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DoLikeReq(null, null, null, 0, null, 31, null));
    }

    public /* synthetic */ DoLikeReq(StCommonExt stCommonExt, String str, UnionID unionID, int i3, OverlayInfo overlayInfo, int i16, DefaultConstructorMarker defaultConstructorMarker) {
        this((i16 & 1) != 0 ? null : stCommonExt, (i16 & 2) != 0 ? "" : str, (i16 & 4) != 0 ? null : unionID, (i16 & 8) != 0 ? d.c.f30317b.b().getValue() : i3, (i16 & 16) != 0 ? null : overlayInfo);
    }

    public DoLikeReq(StCommonExt stCommonExt, String str, UnionID unionID, int i3, OverlayInfo overlayInfo) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.likeKey, new b.e.g(false))), TuplesKt.to(3, new h(3, this.unionId, new b.d(new UnionID(null, null, null, null, null, 31, null)))), TuplesKt.to(4, new h(4, Integer.valueOf(this.likeType), new b.a(false))), TuplesKt.to(5, new h(5, this.overlayInfo, new b.d(new OverlayInfo(null, 1, null)))));
        return mapOf;
    }
    ...
    public void setValue(int fieldNumber, Object v3) {
        ...
        if (fieldNumber == 3) {
            ...
            Intrinsics.checkNotNull(v3, "null cannot be cast to non-null type kotlin.Int{ com.tencent.hippykotlin.demo.pages.qqkmp.qzone.pb.kuikly.com.tencent.trpcprotocol.qzone.interaction_writer.interaction_writer.Interaction_writerKt.LikeType }");
