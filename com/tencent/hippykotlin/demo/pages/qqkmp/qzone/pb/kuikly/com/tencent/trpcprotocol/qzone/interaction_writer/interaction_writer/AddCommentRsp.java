...
public final class AddCommentRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new AddCommentRsp(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    public /* synthetic */ AddCommentRsp(StCommonExt stCommonExt, StComment stComment, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : stComment);
    }

    public AddCommentRsp(StCommonExt stCommonExt, StComment stComment) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.comment, new b.d(new StComment(null, null, null, null, null, null, null, null, null, null, null, null, 4095, null)))));
        return mapOf;
    }
