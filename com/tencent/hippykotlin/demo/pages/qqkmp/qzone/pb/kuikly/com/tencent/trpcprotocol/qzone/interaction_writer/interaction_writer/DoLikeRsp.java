...
public final class DoLikeRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DoLikeRsp(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    public /* synthetic */ DoLikeRsp(StCommonExt stCommonExt, StLike stLike, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : stLike);
    }

    public DoLikeRsp(StCommonExt stCommonExt, StLike stLike) {
