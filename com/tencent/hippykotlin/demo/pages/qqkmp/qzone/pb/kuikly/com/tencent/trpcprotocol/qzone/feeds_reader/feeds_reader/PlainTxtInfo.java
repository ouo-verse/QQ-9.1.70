...
public final class PlainTxtInfo extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new PlainTxtInfo(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ PlainTxtInfo(List list, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to(1, new h(1, this.txtInfo, new b.f(new b.d(new StRichMsg(0, null, null, null, null, null, null, null, null, 511, null)), false))));
        return mapOf;
    }

    public PlainTxtInfo(List<StRichMsg> list) {
        this.txtInfo = list;
    }
