...
public final class RecommendItem extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new RecommendItem(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ RecommendItem(AlbumInfo albumInfo, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to(1, new h(1, this.album, new b.d(new AlbumInfo(null, null, null, null, null, null, null, null, null, 0 == true ? 1 : 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, LockFreeTaskQueueCore.MAX_CAPACITY_MASK, null)))));
        return mapOf;
    }

    public RecommendItem(AlbumInfo albumInfo) {
