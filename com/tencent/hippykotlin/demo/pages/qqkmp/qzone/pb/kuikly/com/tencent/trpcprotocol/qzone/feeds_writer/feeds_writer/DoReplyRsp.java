...
public final class DoReplyRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DoReplyRsp(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    public /* synthetic */ DoReplyRsp(StCommonExt stCommonExt, StReply stReply, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : stReply);
    }

    public DoReplyRsp(StCommonExt stCommonExt, StReply stReply) {
