...
public final class GetNoticeListReq extends j {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.ext, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.attachInfo, new b.e.g(false))), TuplesKt.to(3, new h(3, this.qunId, new b.e.g(false))));
        return mapOf;
    }

    public GetNoticeListReq(StCommonExt stCommonExt, String str, String str2) {
