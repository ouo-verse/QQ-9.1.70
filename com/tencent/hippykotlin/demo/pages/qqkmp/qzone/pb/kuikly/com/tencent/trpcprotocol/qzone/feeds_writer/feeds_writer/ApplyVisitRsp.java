...
public final class ApplyVisitRsp extends j {
    public static final int $stable = 8;
    public StCommonExt extInfo;

    public ApplyVisitRsp() {
        this(null, 1, 0 == true ? 1 : 0);
    }

    @Override // c45.j
    public j decodeWith(f u16) {
        return u16.g(new ApplyVisitRsp(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ ApplyVisitRsp(StCommonExt stCommonExt, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public ApplyVisitRsp(StCommonExt stCommonExt) {
