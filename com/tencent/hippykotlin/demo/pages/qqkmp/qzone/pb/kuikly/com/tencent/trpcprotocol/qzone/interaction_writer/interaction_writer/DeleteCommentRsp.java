...
public final class DeleteCommentRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DeleteCommentRsp(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ DeleteCommentRsp(StCommonExt stCommonExt, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public DeleteCommentRsp(StCommonExt stCommonExt) {
