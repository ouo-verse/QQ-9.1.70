...
public final class DoLikeReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DoLikeReq(null, null, null, null, null, 31, null));
    }

    public /* synthetic */ DoLikeReq(String str, String str2, StUser stUser, String str3, Integer num, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public DoLikeReq(String str, String str2, StUser stUser, String str3, Integer num) {
        this.albumId = str;
        this.mediaId = str2;
