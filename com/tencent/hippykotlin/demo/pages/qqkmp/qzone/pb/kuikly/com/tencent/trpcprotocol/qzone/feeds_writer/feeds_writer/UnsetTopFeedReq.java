...
public final class UnsetTopFeedReq extends j {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(3, new h(3, this.unionId, new b.d(new UnionID(null, null, null, null, null, 31, null)))));
        return mapOf;
    }
