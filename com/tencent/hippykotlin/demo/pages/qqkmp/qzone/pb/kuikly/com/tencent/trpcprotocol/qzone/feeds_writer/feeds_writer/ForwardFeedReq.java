...
public final class ForwardFeedReq extends j {
    ...
    public ForwardFeedReq() {
        this(null, null, null, null, false, 0, 63, null);
    }

    @Override // c45.j
    public j decodeWith(f u16) {
        return u16.g(new ForwardFeedReq(null, null, null, null, false, 0, 63, null));
    }

    public /* synthetic */ ForwardFeedReq(StCommonExt stCommonExt, UnionID unionID, Map map, String str, boolean z16, int i3, int i16, DefaultConstructorMarker defaultConstructorMarker) {
        this((i16 & 1) != 0 ? null : stCommonExt, (i16 & 2) == 0 ? unionID : null, (i16 & 4) != 0 ? new LinkedHashMap() : map, (i16 & 8) != 0 ? "" : str, (i16 & 16) != 0 ? false : z16, (i16 & 32) != 0 ? 0 : i3);
    }

    public ForwardFeedReq(StCommonExt stCommonExt, UnionID unionID, Map<String, String> map, String str, boolean z16, int i3) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.unionId, new b.d(new UnionID(null, null, null, null, null, 31, null)))), TuplesKt.to(3, new h(3, this.extendInfo, new b.C0166b(new b.e.g(false), new b.e.g(false)))), TuplesKt.to(4, new h(4, this.reason, new b.e.g(false))), TuplesKt.to(5, new h(5, Boolean.valueOf(this.withCmt), new b.e.a(false))), TuplesKt.to(6, new h(6, Integer.valueOf(this.from), new b.e.C0168e(false))));
        return mapOf;
    }
