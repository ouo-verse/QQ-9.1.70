...
public final class AddReplyReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new AddReplyReq(null, null, null, null, null, 31, null));
    }

    public /* synthetic */ AddReplyReq(StCommonExt stCommonExt, UnionID unionID, StComment stComment, StReply stReply, OverlayInfo overlayInfo, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : unionID, (i3 & 4) != 0 ? null : stComment, (i3 & 8) != 0 ? null : stReply, (i3 & 16) != 0 ? null : overlayInfo);
    }

    public AddReplyReq(StCommonExt stCommonExt, UnionID unionID, StComment stComment, StReply stReply, OverlayInfo overlayInfo) {
