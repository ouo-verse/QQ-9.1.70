...
public final class RemoveSpecialRsp extends j {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))));
        return mapOf;
    }

    public RemoveSpecialRsp(StCommonExt stCommonExt) {
