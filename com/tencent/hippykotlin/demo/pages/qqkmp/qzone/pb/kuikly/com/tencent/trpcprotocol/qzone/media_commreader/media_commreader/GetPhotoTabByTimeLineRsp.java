...
public final class GetPhotoTabByTimeLineRsp extends j {
    ...
    public GetPhotoTabByTimeLineRsp() {
        this(null, null, null, null, null, 31, null);
    }

    @Override // c45.j
    public j decodeWith(f u16) {
        return u16.g(new GetPhotoTabByTimeLineRsp(null, null, null, null, null, 31, null));
    }

    public /* synthetic */ GetPhotoTabByTimeLineRsp(List list, String str, Boolean bool, Boolean bool2, PageEndMsg pageEndMsg, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? new ArrayList() : list, (i3 & 2) != 0 ? null : str, (i3 & 4) != 0 ? null : bool, (i3 & 8) != 0 ? null : bool2, (i3 & 16) == 0 ? pageEndMsg : null);
    }

    public GetPhotoTabByTimeLineRsp(List<PhotoInfo> list, String str, Boolean bool, Boolean bool2, PageEndMsg pageEndMsg) {
        this.photos = list;
        this.attachInfo = str;
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.photos, new b.f(new b.d(new PhotoInfo(null, null, null, null, 15, null)), false))), TuplesKt.to(2, new h(2, this.attachInfo, new b.e.g(true))), TuplesKt.to(3, new h(3, this.preHasMore, new b.e.a(true))), TuplesKt.to(4, new h(4, this.nextHasMore, new b.e.a(true))), TuplesKt.to(5, new h(5, this.endMsg, new b.d(new PageEndMsg(null, null, null, 7, null)))));
        return mapOf;
    }
