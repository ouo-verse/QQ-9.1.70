...
public final class StFeedCellUserInfo extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new StFeedCellUserInfo(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ StFeedCellUserInfo(StUser stUser, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to(1, new h(1, this.user, new b.d(new StUser(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 65535, null)))));
        return mapOf;
    }
