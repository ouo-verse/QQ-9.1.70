...
public final class AddAlbumRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new AddAlbumRsp(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ AddAlbumRsp(AlbumInfo albumInfo, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public AddAlbumRsp(AlbumInfo albumInfo) {
