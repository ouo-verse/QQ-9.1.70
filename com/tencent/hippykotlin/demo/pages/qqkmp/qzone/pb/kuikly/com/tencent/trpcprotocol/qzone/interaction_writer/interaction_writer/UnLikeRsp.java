...
public final class UnLikeRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new UnLikeRsp(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    public /* synthetic */ UnLikeRsp(StCommonExt stCommonExt, StLike stLike, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : stLike);
    }

    public UnLikeRsp(StCommonExt stCommonExt, StLike stLike) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.like, new b.d(new StLike(0 == true ? 1 : 0, 0 == true ? 1 : 0, 0 == true ? 1 : 0, 0 == true ? 1 : 0, null, 0 == true ? 1 : 0, 63, null)))));
        return mapOf;
    }
