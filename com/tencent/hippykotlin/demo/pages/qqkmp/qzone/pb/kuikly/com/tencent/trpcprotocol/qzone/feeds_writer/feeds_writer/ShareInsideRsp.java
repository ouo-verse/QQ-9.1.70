...
public final class ShareInsideRsp extends j {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.newUnionId, new b.d(new UnionID(null, null, null, null, null, 31, null)))));
        return mapOf;
    }
