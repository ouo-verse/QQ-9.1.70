...
public final class AddCommentReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new AddCommentReq(null, null, null, false, null, 31, null));
    }

    public /* synthetic */ AddCommentReq(StCommonExt stCommonExt, UnionID unionID, StComment stComment, boolean z16, OverlayInfo overlayInfo, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : unionID, (i3 & 4) != 0 ? null : stComment, (i3 & 8) != 0 ? false : z16, (i3 & 16) != 0 ? null : overlayInfo);
    }

    public AddCommentReq(StCommonExt stCommonExt, UnionID unionID, StComment stComment, boolean z16, OverlayInfo overlayInfo) {
