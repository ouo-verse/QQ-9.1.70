...
public final class UnLikeReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new UnLikeReq(null, null, null, 0, null, 31, null));
    }

    public /* synthetic */ UnLikeReq(StCommonExt stCommonExt, String str, UnionID unionID, int i3, OverlayInfo overlayInfo, int i16, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public UnLikeReq(StCommonExt stCommonExt, String str, UnionID unionID, int i3, OverlayInfo overlayInfo) {
