...
public final class ClientFeed extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new ClientFeed(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ ClientFeed(StFeed stFeed, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stFeed);
    }

    @Override // c45.j
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsJVMKt.mapOf(TuplesKt.to(1, new h(1, this.feed, new b.d(new StFeed(null, null, null, null, null, null, null, null, null, 0 == true ? 1 : 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, Integer.MAX_VALUE, null)))));
        return mapOf;
    }

    public ClientFeed(StFeed stFeed) {
        this.feed = stFeed;
    }
