...
public final class GetCommentReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new GetCommentReq(null, null, null, 7, null));
    }

    public /* synthetic */ GetCommentReq(StCommonExt stCommonExt, UnionID unionID, String str, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : unionID, (i3 & 4) != 0 ? "" : str);
    }

    public GetCommentReq(StCommonExt stCommonExt, UnionID unionID, String str) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.ext, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.unionId, new b.d(new UnionID(null, null, null, null, null, 31, null)))), TuplesKt.to(3, new h(3, this.attachInfo, new b.e.g(false))));
        return mapOf;
    }
