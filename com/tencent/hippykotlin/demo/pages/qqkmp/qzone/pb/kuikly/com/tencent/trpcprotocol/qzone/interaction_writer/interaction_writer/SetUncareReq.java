...
public final class SetUncareReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new SetUncareReq(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    public /* synthetic */ SetUncareReq(StCommonExt stCommonExt, List list, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? new ArrayList() : list);
    }

    public SetUncareReq(StCommonExt stCommonExt, List<StUser> list) {
