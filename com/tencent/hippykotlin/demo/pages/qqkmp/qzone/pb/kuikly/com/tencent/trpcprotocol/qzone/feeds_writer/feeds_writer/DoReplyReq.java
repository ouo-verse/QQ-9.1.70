...
public final class DoReplyReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DoReplyReq(null, 0, null, null, null, 31, null));
    }

    public /* synthetic */ DoReplyReq(StCommonExt stCommonExt, int i3, StFeed stFeed, StComment stComment, StReply stReply, int i16, DefaultConstructorMarker defaultConstructorMarker) {
        this((i16 & 1) != 0 ? null : stCommonExt, (i16 & 2) != 0 ? d.c.f30317b.b().getValue() : i3, (i16 & 4) != 0 ? null : stFeed, (i16 & 8) != 0 ? null : stComment, (i16 & 16) != 0 ? null : stReply);
    }

    public DoReplyReq(StCommonExt stCommonExt, int i3, StFeed stFeed, StComment stComment, StReply stReply) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.extInfo, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, Integer.valueOf(this.replyType), new b.a(false))), TuplesKt.to(3, new h(3, this.feed, new b.d(new StFeed(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, Integer.MAX_VALUE, null)))), TuplesKt.to(4, new h(4, this.comment, new b.d(new StComment(null, null, null, null, null, null, null, null, null, null, null, null, 4095, null)))), TuplesKt.to(5, new h(5, this.reply, new b.d(new StReply(null, null, null, null, null, null, null, null, 255, null)))));
        return mapOf;
    }
    ...
    public void setValue(int fieldNumber, Object v3) {
        ...
        if (fieldNumber == 2) {
            Intrinsics.checkNotNull(v3, "null cannot be cast to non-null type kotlin.Int{ com.tencent.hippykotlin.demo.pages.qqkmp.qzone.pb.kuikly.com.tencent.trpcprotocol.qzone.feeds_writer.feeds_writer.Feeds_writerKt.DoReplyType }");
            this.replyType = ((Integer) v3).intValue();
            return;
        }
        if (fieldNumber == 3) {
