...
public final class SetUncareRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new SetUncareRsp(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ SetUncareRsp(StCommonExt stCommonExt, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public SetUncareRsp(StCommonExt stCommonExt) {
