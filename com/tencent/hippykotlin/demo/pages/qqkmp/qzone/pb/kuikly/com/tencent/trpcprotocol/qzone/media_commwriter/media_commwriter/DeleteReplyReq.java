...
public final class DeleteReplyReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DeleteReplyReq(null, null, null, null, null, null, null, 127, null));
    }
    ...
    public /* synthetic */ DeleteReplyReq(String str, String str2, Long l3, String str3, String str4, Integer num, StUser stUser, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : str, (i3 & 2) != 0 ? null : str2, (i3 & 4) != 0 ? null : l3, (i3 & 8) != 0 ? null : str3, (i3 & 16) != 0 ? null : str4, (i3 & 32) != 0 ? null : num, (i3 & 64) != 0 ? null : stUser);
    }

    public DeleteReplyReq(String str, String str2, Long l3, String str3, String str4, Integer num, StUser stUser) {
        this.albumId = str;
        this.mediaId = str2;
        this.batchId = l3;
        this.commentId = str3;
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.albumId, new b.e.g(true))), TuplesKt.to(2, new h(2, this.mediaId, new b.e.g(true))), TuplesKt.to(3, new h(3, this.batchId, new b.e.f(true))), TuplesKt.to(4, new h(4, this.commentId, new b.e.g(true))), TuplesKt.to(5, new h(5, this.replyId, new b.e.g(true))), TuplesKt.to(6, new h(6, this.commentType, new b.a(false))), TuplesKt.to(7, new h(7, this.albumOwner, new b.d(new StUser(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 65535, null)))));
        return mapOf;
    }
}
