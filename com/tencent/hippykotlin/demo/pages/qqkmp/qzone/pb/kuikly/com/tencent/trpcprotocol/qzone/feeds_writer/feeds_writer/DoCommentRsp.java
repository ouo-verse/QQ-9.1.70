...
public final class DoCommentRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new DoCommentRsp(null, 0 == true ? 1 : 0, 3, 0 == true ? 1 : 0));
    }

    public /* synthetic */ DoCommentRsp(StCommonExt stCommonExt, StComment stComment, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? null : stComment);
    }

    public DoCommentRsp(StCommonExt stCommonExt, StComment stComment) {
