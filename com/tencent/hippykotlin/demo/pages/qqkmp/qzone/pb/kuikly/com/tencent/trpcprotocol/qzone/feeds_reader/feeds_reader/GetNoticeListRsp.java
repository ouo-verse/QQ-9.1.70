...
public final class GetNoticeListRsp extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new GetNoticeListRsp(null, null, null, false, 15, null));
    }

    public /* synthetic */ GetNoticeListRsp(StCommonExt stCommonExt, List list, String str, boolean z16, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? null : stCommonExt, (i3 & 2) != 0 ? new ArrayList() : list, (i3 & 4) != 0 ? "" : str, (i3 & 8) != 0 ? false : z16);
    }

    public GetNoticeListRsp(StCommonExt stCommonExt, List<Notice> list, String str, boolean z16) {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.ext, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.notices, new b.f(new b.d(new Notice(null, 0, 0L, null, null, null, null, null, null, null, null, null, 4095, null)), false))), TuplesKt.to(3, new h(3, this.attachInfo, new b.e.g(false))), TuplesKt.to(4, new h(4, Boolean.valueOf(this.hasMore), new b.e.a(false))));
        return mapOf;
    }
    ...
    public void setValue(int fieldNumber, Object v3) {
        ...
        if (fieldNumber == 2) {
            ...
            Intrinsics.checkNotNull(v3, "null cannot be cast to non-null type kotlin.sequences.Sequence<com.tencent.hippykotlin.demo.pages.qqkmp.qzone.pb.kuikly.com.tencent.trpcprotocol.qzone.feeds_reader.feeds_reader.Notice>");
