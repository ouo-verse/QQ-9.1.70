...
public final class AddAlbumReq extends j {
    ...
    public j decodeWith(f u16) {
        return u16.g(new AddAlbumReq(null, 1, 0 == true ? 1 : 0));
    }

    public /* synthetic */ AddAlbumReq(AlbumInfo albumInfo, int i3, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public AddAlbumReq(AlbumInfo albumInfo) {
