...
public final class GetMainPageHeadReq extends j {
    ...
    public Map<Integer, h> getIndexes() {
        Map<Integer, h> mapOf;
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new h(1, this.ext, new b.d(new StCommonExt(null, null, null, null, 15, null)))), TuplesKt.to(2, new h(2, this.hostUid, new b.e.g(false))), TuplesKt.to(3, new h(3, this.hostUin, new b.e.g(false))));
        return mapOf;
    }

    public GetMainPageHeadReq(StCommonExt stCommonExt, String str, String str2) {
