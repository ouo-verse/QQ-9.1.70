...
public final class DeleteReplyRequest extends QZoneBaseRequest<DeleteReplyReq, DeleteReplyRsp> {
    ...
    public final DeleteReplyReq getBusiReq() {
        return new DeleteReplyReq(null, this.unionId, this.comment, this.reply, null, 16, null);
    }

    @Override // com.tencent.hippykotlin.demo.pages.foundation.module.BasePbRequest
    public final String getCmd() {
        return "QzoneV4Service.trpc.qzone.interaction_writer.InteractionWriter.DeleteReply";
    }

    public DeleteReplyRequest(StCommonExt stCommonExt, UnionID unionID, StComment stComment, StReply stReply) {
        super(null, 1, null);
