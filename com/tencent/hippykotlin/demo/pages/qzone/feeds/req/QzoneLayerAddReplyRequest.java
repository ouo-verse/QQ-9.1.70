...
public final class QzoneLayerAddReplyRequest extends QZoneBaseRequest<AddReplyReq, AddReplyRsp> {
    ...
    public final AddReplyReq getBusiReq() {
        return new AddReplyReq(null, this.unionId, this.comment, this.reply, this.overlayInfo);
    }

    @Override // com.tencent.hippykotlin.demo.pages.foundation.module.BasePbRequest
    public final String getCmd() {
        return "QzoneV4Service.trpc.qzone.interaction_writer.InteractionWriter.AddReplyOverlay";
    }

    public QzoneLayerAddReplyRequest(StCommonExt stCommonExt, UnionID unionID, StComment stComment, StReply stReply, OverlayInfo overlayInfo) {
        super(null, 1, null);
