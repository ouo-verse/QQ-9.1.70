...
public final class QPOrderDetailCommodityDataViewModel implements IQPOrderDetailCardViewModel {
    public final QPlusGetPromotionDetailRsp info;

    public QPOrderDetailCommodityDataViewModel(QPlusGetPromotionDetailRsp qPlusGetPromotionDetailRsp) {
    ...
    public final IQPOrderDetailCardView getCardView() {
        return new QPOrderDetailCommodityDataView();
    }
}
