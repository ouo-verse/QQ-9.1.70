...
public final class QPOrderDetailPromotionDataViewModel implements IQPOrderDetailCardViewModel {
    public final QPlusGetPromotionDetailRsp info;

    public QPOrderDetailPromotionDataViewModel(QPlusGetPromotionDetailRsp qPlusGetPromotionDetailRsp) {
    ...
    public final IQPOrderDetailCardView getCardView() {
        return new QPOrderDetailPromotionDataView();
    }
}
