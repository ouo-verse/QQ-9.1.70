...
public final class QPOrderDetailPageHeaderViewModel implements IQPOrderDetailCardViewModel {
    public final QPlusGetPromotionDetailRsp info;

    public QPOrderDetailPageHeaderViewModel(QPlusGetPromotionDetailRsp qPlusGetPromotionDetailRsp) {
    ...
    public final IQPOrderDetailCardView getCardView() {
        return new QPOrderDetailPageHeaderView();
    }
}
