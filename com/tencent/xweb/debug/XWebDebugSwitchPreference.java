...
public class XWebDebugSwitchPreference extends SwitchPreferenceCompat implements k {

    /* renamed from: a, reason: collision with root package name */
    public String f385106a;
    ...
    public XWebDebugSwitchPreference(Context context, AttributeSet attributeSet) {
        ...
        this.f385106a = obtainStyledAttributes.getString(R.styleable.XWebDebugPreference_debug_key);
    ...
    public com.tencent.luggage.wxa.qq.a a(b bVar) {
        ...
        bundle.putString("command", "http://debugxweb.qq.com/?" + a() + ContainerUtils.KEY_VALUE_DELIMITER + isChecked());
        return r0.a(bundle, bVar);
    }

    @Override // com.tencent.luggage.wxa.qq.k
    public String a() {
        return this.f385106a;
    }
}
