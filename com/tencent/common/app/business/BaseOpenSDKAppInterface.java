...
public abstract class BaseOpenSDKAppInterface extends AppInterface {
    static IPatchRedirector $redirector_;

    public BaseOpenSDKAppInterface(MobileQQ mobileQQ, String str) {
        super(mobileQQ, str);
    ...
    public <T extends IRuntimeService> T getRuntimeService(Class<T> cls) {
        ...
        return (T) getRuntimeService(cls, ProcessConstant.OPEN_SDK);
    }
}
