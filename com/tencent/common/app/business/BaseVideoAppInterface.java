...
public abstract class BaseVideoAppInterface extends AppInterface {
    static IPatchRedirector $redirector_;

    public BaseVideoAppInterface(MobileQQ mobileQQ, String str) {
        super(mobileQQ, str);
    ...
    public <T extends IRuntimeService> T getRuntimeService(Class<T> cls) {
        ...
        return (T) getRuntimeService(cls, "video");
    }
}
