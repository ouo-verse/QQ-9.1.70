...
public abstract class BaseMiniBoxAppInterface extends AppInterface {
    static IPatchRedirector $redirector_;

    public BaseMiniBoxAppInterface(MobileQQ mobileQQ, String str) {
        super(mobileQQ, str);
    ...
    public <T extends IRuntimeService> T getRuntimeService(Class<T> cls) {
        ...
        return (T) getRuntimeService(cls, ProcessConstant.MULTI);
    }
}
