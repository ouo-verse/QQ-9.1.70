...
public abstract class BaseAVGameAppInterface extends AppInterface {
    static IPatchRedirector $redirector_;

    public BaseAVGameAppInterface(MobileQQ mobileQQ, String str) {
        super(mobileQQ, str);
    ...
    public <T extends IRuntimeService> T getRuntimeService(Class<T> cls) {
        ...
        return (T) getRuntimeService(cls, ProcessConstant.AVGAME);
    }
}
