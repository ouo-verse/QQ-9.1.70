...
public final class g implements c {
    ...
    public g(@NotNull KRRecyclerView recyclerView) {
        ...
        if (kRRecyclerView != null) {
            ...
            if (findPointerIndex >= 0 && (layoutManager = kRRecyclerView.getLayoutManager()) != null) {
                ...
                if (canScrollHorizontally && Math.abs(i3) > this.touchSlop && Math.abs(i3) > Math.abs(i16)) {
                    if (i3 > 0 && kRRecyclerView.getContentOffsetX() <= 0.0f) {
                        return false;
                    }
                    if (i3 < 0) {
                        if (kRRecyclerView.computeHorizontalScrollExtent() + kRRecyclerView.computeHorizontalScrollOffset() >= kRRecyclerView.computeHorizontalScrollRange()) {
                            z16 = true;
                        } else {
                            z16 = false;
                        }
