...
public final class RowView extends b<m, Event> {
    ...
    public void willInit() {
        super.willInit();
        attr(new Function1<m, Unit>() { // from class: com.tencent.kuikly.core.views.layout.RowView$willInit$1
            ...
            public final void invoke2(m attr) {
                ...
                attr.alignItems(RowView.this.getAlign());
            }
        });
    }
}
