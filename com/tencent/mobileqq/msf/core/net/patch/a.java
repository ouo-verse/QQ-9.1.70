...
public class a {
    ...
    public static final String f248907a = "HttpDownloadUtil";

    /* renamed from: b, reason: collision with root package name */
    public static final int f248908b = 2;

    /* renamed from: c, reason: collision with root package name */
    public static final int f248909c = 0;

    /* renamed from: d, reason: collision with root package name */
    public static final int f248910d = 1;

    /* renamed from: e, reason: collision with root package name */
    public static final int f248911e = 2;

    /* renamed from: f, reason: collision with root package name */
    public static final int f248912f = 4;

    /* renamed from: g, reason: collision with root package name */
    public static final int f248913g = 5;

    /* renamed from: h, reason: collision with root package name */
    @Deprecated
    public static final int f248914h = 7;

    /* renamed from: i, reason: collision with root package name */
    public static final int f248915i = 8;

    /* renamed from: j, reason: collision with root package name */
    public static final int f248916j = 10;

    /* renamed from: k, reason: collision with root package name */
    public static final int f248917k = 11;

    /* renamed from: l, reason: collision with root package name */
    public static final int f248918l = 13;
    ...
    public static boolean a(String str, String str2) {
        ...
        String str3 = str2 + System.currentTimeMillis() + ".tmp";
        File file = new File(str3);
        try {
            int a16 = a(new URL(str), file, recentNetworkInfo, 2);
            if (a16 == 0) {
                try {
                    file.renameTo(new File(str2));
                } catch (Exception e16) {
                    e16.printStackTrace();
                    PatchReporter.reportPatchDownload(str, str2, str3, 5002, 0, System.currentTimeMillis() - currentTimeMillis);
                    return false;
                }
            }
            PatchReporter.reportPatchDownload(str, str2, str3, a16, 0, System.currentTimeMillis() - currentTimeMillis);
            return a16 == 0;
        } catch (MalformedURLException e17) {
            e17.printStackTrace();
            PatchReporter.reportPatchDownload(str, str2, str3, 5001, 0, 0L);
            return false;
        }
    }
