...
public class GameMsgAppFragment extends BaseHippyFragment implements Handler.Callback {
    private ViewGroup C;
    private ViewGroup D;
    private HippyProgressBarWrapper E = new HippyProgressBarWrapper();
    private HippyErrorViewWrapper F = new HippyErrorViewWrapper();
    ...
    protected void initNetworkErrorView(ViewGroup viewGroup, View.OnClickListener onClickListener) {
        ...
        this.F.initNetworkErrorView(frameLayout, onClickListener);
    }

    public void initProgressBar(ViewGroup viewGroup) {
        HippyQQPreloadEngine hippyQQPreloadEngine = this.mHippyQQEngine;
        if (hippyQQPreloadEngine != null && hippyQQPreloadEngine.isReady()) {
            return;
        }
        this.E.initProgressBar(viewGroup);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ViewGroup viewGroup2 = (ViewGroup) layoutInflater.inflate(R.layout.dqt, (ViewGroup) null, false);
        this.C = viewGroup2;
        ViewGroup viewGroup3 = (ViewGroup) viewGroup2.findViewById(R.id.x_x);
        this.D = viewGroup3;
        loadHippy(viewGroup3);
    ...
    protected void onLoadHippyError(int i3, String str) {
        ...
        initNetworkErrorView(this.C, null);
    }
