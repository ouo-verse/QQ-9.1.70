...
final class QQSettingMeNavigationPart$initStatusBar$1 extends Lambda implements Function1<Boolean, Unit> {
    static IPatchRedirector $redirector_;
    final /* synthetic */ QQSettingMeNavigationPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QQSettingMeNavigationPart$initStatusBar$1(QQSettingMeNavigationPart qQSettingMeNavigationPart) {
        super(1);
    ...
    public static final void b(QQSettingMeNavigationPart this$0) {
    ...
    public final void invoke2(Boolean bool) {
        ...
        partRootView.post(new Runnable() { // from class: com.tencent.mobileqq.bizParts.ag
            @Override // java.lang.Runnable
            public final void run() {
                QQSettingMeNavigationPart$initStatusBar$1.b(QQSettingMeNavigationPart.this);
            }
        });
    }
}
