...
public final class HermesShareToWXFriendAction extends HermesAbsShareAction {
    ...
    public HermesShareToWXFriendAction() {
    ...
    public final void l(String filePath, k shareContext) {
        if (this.mWXShareListener == null) {
            this.mWXShareListener = new WXShareHelper.a() { // from class: com.tencent.mobileqq.hermes.share.l
                @Override // com.tencent.mobileqq.wxapi.WXShareHelper.a
                public final void onWXShareResp(BaseResp baseResp) {
                    HermesShareToWXFriendAction.m(baseResp);
                }
            };
            WXShareHelper.b0().A(this.mWXShareListener);
        }
        WXShareHelper.b0().u0(filePath, shareContext.f(), 0);
    }
    ...
    public void b(@NotNull k shareContext, @NotNull ShareActionSheetBuilder.ActionSheetItem item) {
        ...
        BuildersKt__Builders_commonKt.launch$default(c(), null, null, new HermesShareToWXFriendAction$doAction$1(this, shareContext, null), 3, null);
    }
