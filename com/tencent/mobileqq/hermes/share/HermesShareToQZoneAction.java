...
public final class HermesShareToQZoneAction extends HermesAbsShareAction {
    ...
    public final void k(String filePath, k shareContext) {
        ...
        QZoneHelper.forwardToPublishMood(shareContext.a(), userInfo, filePath, "\u5206\u4eab\u5230\u7a7a\u95f4", "", 20001);
    }
    ...
    public void b(@NotNull k shareContext, @NotNull ShareActionSheetBuilder.ActionSheetItem item) {
        ...
        BuildersKt__Builders_commonKt.launch$default(c(), null, null, new HermesShareToQZoneAction$doAction$1(this, shareContext, null), 3, null);
    }
