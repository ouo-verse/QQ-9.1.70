...
public final class HermesAddFavoriteAction extends HermesAbsShareAction {
    ...
    public final void k(String filePath, k shareContext) {
        ...
        if (peekAppRuntime == null) {
            ...
            QLog.e("HermesAbsShareAction", 1, "addToFavorite failed, appRuntime is null!");
        } else {
            ((IQQFavHelper) peekAppRuntime.getRuntimeService(IQQFavHelper.class, "all")).addPictureToFavorite(peekAppRuntime, shareContext.a(), filePath);
        }
    }
    ...
    public void b(@NotNull k shareContext, @NotNull ShareActionSheetBuilder.ActionSheetItem item) {
        ...
        BuildersKt__Builders_commonKt.launch$default(c(), null, null, new HermesAddFavoriteAction$doAction$1(this, shareContext, null), 3, null);
    }
