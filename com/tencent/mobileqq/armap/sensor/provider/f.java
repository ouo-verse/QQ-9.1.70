...
public class f extends d {
    ...
    public f(Context context, int i3, SensorManager sensorManager, a.InterfaceC7424a interfaceC7424a) throws OrientationProviderNotFound {
        ...
        this.K = new float[16];
        Sensor defaultSensor = SensorMonitor.getDefaultSensor(sensorManager, 15);
