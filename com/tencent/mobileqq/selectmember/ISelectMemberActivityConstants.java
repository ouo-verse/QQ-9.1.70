...
public interface ISelectMemberActivityConstants {
    public static final int ACTION_TYPE_APPLY_Q_ROBOT_INSTRUCTION_COPY = 3;
    public static final int ACTION_TYPE_SELECT_FOR_BATCH_ANNOUNCEMENT = 5;
    public static final int ACTION_TYPE_SELECT_FOR_SHARE_TO_AIO = 6;
    public static final int ACTION_TYPE_SELECT_TROOP_TO_OPEN_AI_VOICE = 4;
    public static final int ACTION_TYPE_TROOP_AUTO_SWITCH = 1;
    public static final int ACTION_TYPE_TROOP_BIND_ROBOT = 2;
    public static final int ACTION_TYPE_TROOP_MEMBER_DISTINCT = 0;
    ...
    public static final int ENTRANCE_CREATE_TROOP_BY_SCHEMA = 47;
    ...
    public static final int ENTRANCE_GUILD_INVITE_FRIENDS = 49;
    ...
    public static final int ENTRANCE_QCIRCLE_COMMENT_PERMISSION = 48;
    ...
    public static final int ENTRANCE_ZPLAN = 44;
    ...
    public static final String PARAM_BATCH_ADDFRD_MAYKNOW_STRATEGY = "batch_addfrd_mayknow_strategy";
    ...
    public static final String PARAM_KEY_EXTRA_CHOOSE_FILTER_TROOP_UIN_LIST = "extra_choose_filter_troop_uin_list";
    public static final String PARAM_KEY_EXTRA_CHOOSE_RESULT = "extra_choose_troop_result";
    public static final String PARAM_KEY_EXTRA_CHOOSE_TROOP_MAX_NUM = "extra_choose_troop_max_num";
    public static final String PARAM_KEY_EXTRA_CHOOSE_TROOP_NAME = "extra_choose_troop_name";
    public static final String PARAM_KEY_EXTRA_CHOOSE_TROOP_TYPE = "extra_choose_troop_type";
    public static final String PARAM_KEY_EXTRA_CHOOSE_TROOP_UIN = "extra_choose_troop_uin";
    public static final String PARAM_KEY_EXTRA_FILTER_BLOCK_GROUP = "extra_filter_block_group";
    public static final String PARAM_KEY_EXTRA_INSTRUCTION_LIST = "extra_instruction_list";
    public static final String PARAM_KEY_SHOW_BLOCK_OR_GAG_TROOP = "show_block_or_gag_troop";
    public static final String PARAM_KEY_SHOW_CREATE_TROOP = "show_create_troop";
    public static final String PARAM_KEY_SHOW_JOIN_TROOP = "show_join_troop";
    public static final String PARAM_KEY_SHOW_MANAGE_TROOP = "show_manage_troop";
    public static final String PARAM_KEY_SHOW_RECENT_TROOP = "show_recent_troop";
    public static final String PARAM_KEY_SHOW_SET_TOP_TROOP = "show_set_top_troop";
    public static final String PARAM_KEY_SHOW_UN_NAME_TROOP = "show_un_name_troop";
    ...
    public static final String PARAM_SHOW_DONE_BUTTON_IN_BOTTOM = "param_show_done_button_in_bottom";
    ...
    public static final String PARAM_SHOW_ROBOT_GROUP = "param_show_robot_group";
    ...
    public static final String PARAM_WITH_HISTORY = "with_history";
