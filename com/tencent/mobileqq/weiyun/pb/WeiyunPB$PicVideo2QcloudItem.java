...
public final class WeiyunPB$PicVideo2QcloudItem extends MessageMicro<WeiyunPB$PicVideo2QcloudItem> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 42, 48, 56, 64, 74, 80, 90, 98, 104}, new String[]{"str_src_id", "str_dst_id", "uint32_chat_type", "uint32_bid", "str_file_id", "uint64_file_id", "uint64_file_size", "bool_auto_create_user", "str_file_name", "uint32_user_type", "str_file_md5", "raw_url", "image_type"}, new Object[]{"", "", 0, 0, "", 0L, 0L, Boolean.TRUE, "", 0, "", "", 0}, WeiyunPB$PicVideo2QcloudItem.class);
