...
public final class MiniGamePAApiProvider implements HippyAPIProvider {
    /* JADX INFO: Access modifiers changed from: private */
    public static final MiniGamePANativeModule getNativeModules$lambda$0(HippyEngineContext hippyEngineContext) {
        Intrinsics.checkNotNullParameter(hippyEngineContext, "$hippyEngineContext");
        return new MiniGamePANativeModule(hippyEngineContext);
    }
    ...
    public Map<Class<? extends HippyNativeModuleBase>, Provider<? extends HippyNativeModuleBase>> getNativeModules(final HippyEngineContext hippyEngineContext) {
        ...
        hashMap.put(MiniGamePANativeModule.class, new Provider() { // from class: com.tencent.mobileqq.minigame.publicaccount.hippy.a
            @Override // com.tencent.mtt.hippy.common.Provider
            public final Object get() {
                MiniGamePANativeModule nativeModules$lambda$0;
                nativeModules$lambda$0 = MiniGamePAApiProvider.getNativeModules$lambda$0(HippyEngineContext.this);
                return nativeModules$lambda$0;
            }
        });
        hashMap.put(MiniGameCenterNativeModule.class, new Provider() { // from class: com.tencent.mobileqq.minigame.publicaccount.hippy.b
            @Override // com.tencent.mtt.hippy.common.Provider
            public final Object get() {
                HippyNativeModuleBase nativeModules$lambda$1;
                nativeModules$lambda$1 = MiniGamePAApiProvider.getNativeModules$lambda$1(HippyEngineContext.this);
