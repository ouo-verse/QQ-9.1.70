...
import com.tencent.mobileqq.flock.topic.section.FlockTagListItemSection;
...
public final class a extends com.tencent.mobileqq.flock.base.a<g> {
    ...
    public boolean isForViewType(@NotNull g item, @NotNull List<g> items, int position) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public int getLayoutId() {
        ...
        return R.layout.f167967e94;
    }

    @Override // com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(@NotNull ViewGroup parent, @NotNull View itemView, @NotNull List<Class<? extends Section<g>>> sections) {
        IPatchRedirector iPatchRedirector = $redirector_;
        ...
        sections.add(FlockTagListItemSection.class);
    }
}
