...
public class a extends PagerAdapter {
    ...
    private Map<Integer, View> f288427d;
    ...
    public Object instantiateItem(ViewGroup viewGroup, int i3) {
        ...
        viewGroup.addView(this.f288427d.get(Integer.valueOf(i3)));
        return this.f288427d.get(Integer.valueOf(i3));
    }
