...
public final class LinkMicInviteReq extends ExtendableMessageNano<LinkMicInviteReq> {
    private static volatile LinkMicInviteReq[] _emptyArray;
    public long anchorUid;
    public long[] inviteAnchorUid;
    ...
    public static LinkMicInviteReq[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new LinkMicInviteReq[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static LinkMicInviteReq parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (LinkMicInviteReq) MessageNano.mergeFrom(new LinkMicInviteReq(), bArr);
    }

    public LinkMicInviteReq clear() {
        this.anchorUid = 0L;
        this.inviteAnchorUid = WireFormatNano.EMPTY_LONG_ARRAY;
        this.inviteState = 0;
        this.linkMicType = 0;
        this.mode = 0;
    ...
    public int computeSerializedSize() {
        ...
        long[] jArr2 = this.inviteAnchorUid;
        if (jArr2 != null && jArr2.length > 0) {
            int i3 = 0;
            int i16 = 0;
            while (true) {
                jArr = this.inviteAnchorUid;
                if (i3 >= jArr.length) {
                    break;
                }
    ...
    public void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        long[] jArr = this.inviteAnchorUid;
    ...
    public static LinkMicInviteReq parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new LinkMicInviteReq().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public LinkMicInviteReq mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 8) {
                ...
                long[] jArr3 = this.inviteAnchorUid;
