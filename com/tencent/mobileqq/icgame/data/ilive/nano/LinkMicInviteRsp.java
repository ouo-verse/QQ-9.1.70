...
public final class LinkMicInviteRsp extends ExtendableMessageNano<LinkMicInviteRsp> {
    ...
    public int computeSerializedSize() {
        ...
        AnchorInfo[] anchorInfoArr = this.inviteAnchorInfo;
        if (anchorInfoArr != null && anchorInfoArr.length > 0) {
            int i16 = 0;
            while (true) {
                AnchorInfo[] anchorInfoArr2 = this.inviteAnchorInfo;
    ...
    public LinkMicInviteRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 8) {
                ...
                this.inviteAnchorInfo = anchorInfoArr2;
            }
        }
    }
}
