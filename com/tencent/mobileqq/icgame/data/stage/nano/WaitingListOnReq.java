...
public final class WaitingListOnReq extends ExtendableMessageNano<WaitingListOnReq> {
    ...
    public static WaitingListOnReq parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (WaitingListOnReq) MessageNano.mergeFrom(new WaitingListOnReq(), bArr);
    }
    ...
    public static WaitingListOnReq parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new WaitingListOnReq().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public WaitingListOnReq mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
