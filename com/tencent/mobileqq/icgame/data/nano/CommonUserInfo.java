...
public final class CommonUserInfo extends ExtendableMessageNano<CommonUserInfo> {
    ...
    public int computeSerializedSize() {
        ...
        if (qQInfo != null) {
            computeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(44, qQInfo);
        }
        long j18 = this.uin;
        if (j18 != 0) {
    ...
    public void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        QQInfo qQInfo = this.qqInfo;
        if (qQInfo != null) {
            codedOutputByteBufferNano.writeMessage(44, qQInfo);
        }
        long j18 = this.uin;
        if (j18 != 0) {
        ...
        while (true) {
            ...
            switch (readTag) {
                case 0:
                    return this;
                case 8:
                    this.f237274id = codedInputByteBufferNano.readUInt64();
                    break;
                case 26:
                ...
                case 346:
                    ...
                    break;
                case f.CTRL_INDEX /* 354 */:
                    if (this.qqInfo == null) {
                        this.qqInfo = new QQInfo();
                    }
                    codedInputByteBufferNano.readMessage(this.qqInfo);
                    break;
                case 808:
