...
public final class GetIMControlInfoRsp extends ExtendableMessageNano<GetIMControlInfoRsp> {
    private static volatile GetIMControlInfoRsp[] _emptyArray;
    public SwitchInfo[] receiveSwitch;
    public SwitchInfo[] remindSwitch;

    public GetIMControlInfoRsp() {
        clear();
    }

    public static GetIMControlInfoRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new GetIMControlInfoRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static GetIMControlInfoRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (GetIMControlInfoRsp) MessageNano.mergeFrom(new GetIMControlInfoRsp(), bArr);
    }

    public GetIMControlInfoRsp clear() {
    ...
    public static GetIMControlInfoRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new GetIMControlInfoRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public GetIMControlInfoRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
