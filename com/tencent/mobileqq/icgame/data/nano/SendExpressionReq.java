...
public final class SendExpressionReq extends ExtendableMessageNano<SendExpressionReq> {
    private static volatile SendExpressionReq[] _emptyArray;
    ...
    public SendExpressionReq() {
        clear();
    }

    public static SendExpressionReq[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SendExpressionReq[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static SendExpressionReq parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (SendExpressionReq) MessageNano.mergeFrom(new SendExpressionReq(), bArr);
    }

    public SendExpressionReq clear() {
    ...
    public static SendExpressionReq parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new SendExpressionReq().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public SendExpressionReq mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
