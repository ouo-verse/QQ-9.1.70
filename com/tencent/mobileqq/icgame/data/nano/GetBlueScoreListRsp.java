...
public final class GetBlueScoreListRsp extends ExtendableMessageNano<GetBlueScoreListRsp> {
    private static volatile GetBlueScoreListRsp[] _emptyArray;
    public UserMeleeRankItem[] userItemList;

    public GetBlueScoreListRsp() {
        clear();
    }

    public static GetBlueScoreListRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new GetBlueScoreListRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static GetBlueScoreListRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (GetBlueScoreListRsp) MessageNano.mergeFrom(new GetBlueScoreListRsp(), bArr);
    }

    public GetBlueScoreListRsp clear() {
    ...
    public static GetBlueScoreListRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new GetBlueScoreListRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public GetBlueScoreListRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
