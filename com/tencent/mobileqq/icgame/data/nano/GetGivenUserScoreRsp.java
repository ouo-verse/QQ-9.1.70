...
public final class GetGivenUserScoreRsp extends ExtendableMessageNano<GetGivenUserScoreRsp> {
    private static volatile GetGivenUserScoreRsp[] _emptyArray;
    public UserScoreItem[] userItemList;

    public GetGivenUserScoreRsp() {
        clear();
    }

    public static GetGivenUserScoreRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new GetGivenUserScoreRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static GetGivenUserScoreRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (GetGivenUserScoreRsp) MessageNano.mergeFrom(new GetGivenUserScoreRsp(), bArr);
    }

    public GetGivenUserScoreRsp clear() {
    ...
    public static GetGivenUserScoreRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new GetGivenUserScoreRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public GetGivenUserScoreRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
