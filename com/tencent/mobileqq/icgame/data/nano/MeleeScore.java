...
public final class MeleeScore extends ExtendableMessageNano<MeleeScore> {
    private static volatile MeleeScore[] _emptyArray;
    ...
    public static MeleeScore[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new MeleeScore[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static MeleeScore parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (MeleeScore) MessageNano.mergeFrom(new MeleeScore(), bArr);
    }

    public MeleeScore clear() {
        this.redScore = null;
        this.blueScore = null;
        this.mvpUid = 0L;
        this.mvpLevel = 0;
    ...
    public static MeleeScore parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new MeleeScore().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public MeleeScore mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            int readTag = codedInputByteBufferNano.readTag();
            if (readTag == 0) {
                return this;
