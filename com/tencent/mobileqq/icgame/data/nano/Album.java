...
public final class Album extends ExtendableMessageNano<Album> {
    private static volatile Album[] _emptyArray;

    /* renamed from: id, reason: collision with root package name */
    public long f237272id;
    ...
    public Album mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 10) {
                ...
                this.f237272id = codedInputByteBufferNano.readUInt64();
            }
        }
    }
}
