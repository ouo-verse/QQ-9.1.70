...
public final class RoomManagerInfoList extends ExtendableMessageNano<RoomManagerInfoList> {
    private static volatile RoomManagerInfoList[] _emptyArray;
    public ManagerInfo[] managerInfo;

    public RoomManagerInfoList() {
        clear();
    }

    public static RoomManagerInfoList[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new RoomManagerInfoList[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static RoomManagerInfoList parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (RoomManagerInfoList) MessageNano.mergeFrom(new RoomManagerInfoList(), bArr);
    }

    public RoomManagerInfoList clear() {
    ...
    public static RoomManagerInfoList parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new RoomManagerInfoList().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public RoomManagerInfoList mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
