...
public final class GetRoomManagerInfoRsp extends ExtendableMessageNano<GetRoomManagerInfoRsp> {
    private static volatile GetRoomManagerInfoRsp[] _emptyArray;
    public ManagerInfo[] managerInfo;
    public int total;

    public GetRoomManagerInfoRsp() {
        clear();
    }

    public static GetRoomManagerInfoRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new GetRoomManagerInfoRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static GetRoomManagerInfoRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (GetRoomManagerInfoRsp) MessageNano.mergeFrom(new GetRoomManagerInfoRsp(), bArr);
    }

    public GetRoomManagerInfoRsp clear() {
    ...
    public static GetRoomManagerInfoRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new GetRoomManagerInfoRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public GetRoomManagerInfoRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
