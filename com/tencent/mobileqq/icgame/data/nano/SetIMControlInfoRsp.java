...
public final class SetIMControlInfoRsp extends ExtendableMessageNano<SetIMControlInfoRsp> {
    private static volatile SetIMControlInfoRsp[] _emptyArray;
    public SwitchInfo[] receiveSwitch;
    public SwitchInfo[] remindSwitch;

    public SetIMControlInfoRsp() {
        clear();
    }

    public static SetIMControlInfoRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new SetIMControlInfoRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static SetIMControlInfoRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (SetIMControlInfoRsp) MessageNano.mergeFrom(new SetIMControlInfoRsp(), bArr);
    }

    public SetIMControlInfoRsp clear() {
    ...
    public static SetIMControlInfoRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new SetIMControlInfoRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public SetIMControlInfoRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
