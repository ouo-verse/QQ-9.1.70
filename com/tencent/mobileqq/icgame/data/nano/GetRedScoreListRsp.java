...
public final class GetRedScoreListRsp extends ExtendableMessageNano<GetRedScoreListRsp> {
    private static volatile GetRedScoreListRsp[] _emptyArray;
    public UserMeleeRankItem[] userItemList;

    public GetRedScoreListRsp() {
        clear();
    }

    public static GetRedScoreListRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new GetRedScoreListRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static GetRedScoreListRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (GetRedScoreListRsp) MessageNano.mergeFrom(new GetRedScoreListRsp(), bArr);
    }

    public GetRedScoreListRsp clear() {
    ...
    public static GetRedScoreListRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new GetRedScoreListRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public GetRedScoreListRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
