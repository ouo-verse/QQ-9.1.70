...
public final class GetGiftStoreRsp extends ExtendableMessageNano<GetGiftStoreRsp> {
    ...
    public int computeSerializedSize() {
        ...
        GiftStore[] giftStoreArr = this.stores;
        if (giftStoreArr != null && giftStoreArr.length > 0) {
            int i3 = 0;
            while (true) {
                GiftStore[] giftStoreArr2 = this.stores;
