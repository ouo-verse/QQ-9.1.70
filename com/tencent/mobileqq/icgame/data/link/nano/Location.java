...
public final class Location extends ExtendableMessageNano<Location> {
    ...
    public double f237261x;

    /* renamed from: y, reason: collision with root package name */
    public double f237262y;
    ...
    public int computeSerializedSize() {
        ...
        if (Double.doubleToLongBits(this.f237261x) != Double.doubleToLongBits(0.0d)) {
            computeSerializedSize += CodedOutputByteBufferNano.computeDoubleSize(3, this.f237261x);
        }
        if (Double.doubleToLongBits(this.f237262y) != Double.doubleToLongBits(0.0d)) {
            return computeSerializedSize + CodedOutputByteBufferNano.computeDoubleSize(4, this.f237262y);
        }
    ...
    public void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        ...
        if (Double.doubleToLongBits(this.f237261x) != Double.doubleToLongBits(0.0d)) {
            codedOutputByteBufferNano.writeDouble(3, this.f237261x);
        }
        if (Double.doubleToLongBits(this.f237262y) != Double.doubleToLongBits(0.0d)) {
            codedOutputByteBufferNano.writeDouble(4, this.f237262y);
        }
    ...
    public Location mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 9) {
                ...
                this.f237261x = codedInputByteBufferNano.readDouble();
            } else if (readTag != 33) {
                if (!storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            } else {
                this.f237262y = codedInputByteBufferNano.readDouble();
            }
        }
    }
}
