...
public final class GetWaitingListReq extends ExtendableMessageNano<GetWaitingListReq> {
    ...
    public int computeSerializedSize() {
        ...
        int i3 = this.isGetRed;
        if (i3 != 0) {
            computeSerializedSize += CodedOutputByteBufferNano.computeUInt32Size(2, i3);
        }
        int i16 = this.isGetBlue;
        if (i16 != 0) {
    ...
    public GetWaitingListReq mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 8) {
                ...
                this.isGetRed = codedInputByteBufferNano.readUInt32();
            } else if (readTag != 24) {
                if (!storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            } else {
                this.isGetBlue = codedInputByteBufferNano.readUInt32();
            }
        }
    }
}
