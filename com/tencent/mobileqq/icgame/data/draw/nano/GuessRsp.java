...
public final class GuessRsp extends ExtendableMessageNano<GuessRsp> {
    private static volatile GuessRsp[] _emptyArray;
    ...
    public static GuessRsp[] emptyArray() {
        if (_emptyArray == null) {
            synchronized (InternalNano.LAZY_INIT_LOCK) {
                if (_emptyArray == null) {
                    _emptyArray = new GuessRsp[0];
                }
            }
        }
        return _emptyArray;
    ...
    public static GuessRsp parseFrom(byte[] bArr) throws InvalidProtocolBufferNanoException {
        return (GuessRsp) MessageNano.mergeFrom(new GuessRsp(), bArr);
    }

    public GuessRsp clear() {
        this.result = 0;
        this.info = null;
        this.errMsg = "";
    ...
    public static GuessRsp parseFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        return new GuessRsp().mergeFrom(codedInputByteBufferNano);
    }

    @Override // com.google.protobuf.nano.MessageNano
    public GuessRsp mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
