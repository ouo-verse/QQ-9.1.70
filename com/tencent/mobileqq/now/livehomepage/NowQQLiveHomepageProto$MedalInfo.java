...
public final class NowQQLiveHomepageProto$MedalInfo extends MessageMicro<NowQQLiveHomepageProto$MedalInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 40, 48, 56, 66, 74, 82, 88, 96, 104, 112, 120, 128, 136, 144, 154}, strArr, new Object[]{0, byteStringMicro, byteStringMicro, 0, 0L, 0L, 0, byteStringMicro, byteStringMicro, byteStringMicro, 0, 0, 0, 0, 0L, 0L, 0, 0, byteStringMicro}, NowQQLiveHomepageProto$MedalInfo.class);
    }

    public NowQQLiveHomepageProto$MedalInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
