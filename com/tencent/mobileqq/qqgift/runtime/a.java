...
public class a extends MSFServlet {
    ...
    public void onReceive(Intent intent, FromServiceMsg fromServiceMsg) {
        ...
        if (QLog.isDevelopLevel()) {
            QLog.i("QQGiftSdkServlet", 4, "onReceive, cmd[" + fromServiceMsg.getServiceCmd() + "]");
        }
    ...
    public void onSend(Intent intent, Packet packet) {
        ...
        if (intent != null) {
            ...
            if (toServiceMsg != null) {
                ...
                if (QLog.isDevelopLevel()) {
                    QLog.i("QQGiftSdkServlet", 4, "send, cmd[" + toServiceMsg.getServiceCmd() + "]");
                    return;
                }
                return;
            }
    ...
    public void sendToMSF(Intent intent, ToServiceMsg toServiceMsg) {
        ...
        if (toServiceMsg != null) {
            ...
            toServiceMsg.extraData.putString("moduleId", com.tencent.mobileqq.qqgift.utils.a.b());
        }
