...
public class QQGiftToolAppInterface extends BaseToolAppInterface implements IToolProcEventListener {
    static IPatchRedirector $redirector_;

    /* renamed from: d, reason: collision with root package name */
    private MobileQQServiceBase f264970d;

    public QQGiftToolAppInterface(MobileQQ mobileQQ, String str) {
        super(mobileQQ, str);
    ...
    private void release() {
        MobileQQServiceBase mobileQQServiceBase = this.f264970d;
