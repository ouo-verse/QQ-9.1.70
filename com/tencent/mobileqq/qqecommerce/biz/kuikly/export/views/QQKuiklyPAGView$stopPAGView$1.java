...
final class QQKuiklyPAGView$stopPAGView$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ WeakReference<QQKuiklyPAGView> $selfRef;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QQKuiklyPAGView$stopPAGView$1(WeakReference<QQKuiklyPAGView> weakReference) {
        super(0);
    ...
    */
    ...
    public final void invoke2() {
        ...
        ThreadManagerV2.executeOnSubThread(new Runnable() { // from class: com.tencent.mobileqq.qqecommerce.biz.kuikly.export.views.h
            @Override // java.lang.Runnable
            public final void run() {
                QQKuiklyPAGView$stopPAGView$1.b(WeakReference.this);
            }
        });
    }
}
