...
public class MessageForNearbyLiveTip extends ChatMessage {
    ...
    public static boolean isGroupVideoTip(String str) {
        if (str != null && str.contains("identifier_for_huayang=tips_for_qq_huayang") && str.contains("buz_type=videohub")) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isHuayangTip(String str) {
        if (str != null && str.contains("identifier_for_huayang=tips_for_qq_huayang")) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isSupportHuayangBusinessType(String str) {
        if (str != null && (str.contains("buz_type=huayang") || str.contains("buz_type=videohub"))) {
            return true;
        }
        return false;
    }
            ...
            try {
                ...
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert byte array to MessageForNearbyLiveTip failed", e16);
                    }
    ...
    public void prewrite() {
        ...
        try {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert MessageForNearbyLiveTip to byte array failed", e18);
                }
            }
            throw th5;
        }
        try {
            try {
                ...
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert MessageForNearbyLiveTip to byte array failed", e19);
                    }
                }
                try {
                    byteArrayOutputStream.close();
                    ...
                    QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert MessageForNearbyLiveTip to byte array failed", e);
                }
            } catch (Throwable th7) {
                th5 = th7;
                if (objectOutputStream != null) {
                    try {
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert MessageForNearbyLiveTip to byte array failed", e27);
                        }
                    }
                }
                byteArrayOutputStream.close();
            ...
            e16 = e28;
            if (QLog.isColorLevel()) {
                QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert MessageForNearbyLiveTip to byte array failed", e16);
            }
            if (objectOutputStream != null) {
                try {
                    objectOutputStream.close();
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.d(LogTag.TAG_NEARBY_LIVE_TIP, 2, "convert MessageForNearbyLiveTip to byte array failed", e29);
                    }
                }
            }
            try {
