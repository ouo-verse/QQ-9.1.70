...
public class MessageForYanZhi extends ChatMessage {
    ...
    private void readExternal(ObjectInput objectInput) throws IOException {
        ...
        this.pushUin = objectInput.readLong();
        this.likeCount = objectInput.readInt();
        this.pushTime = objectInput.readInt();
    ...
    private void writeExternal(ObjectOutput objectOutput) throws IOException {
        ...
        objectOutput.writeLong(this.pushUin);
        objectOutput.writeInt(this.likeCount);
        objectOutput.writeInt(this.pushTime);
            ...
            try {
                ...
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.d(TAG, 2, "convert byte array to MessageForYanZhi failed", e16);
                    }
    ...
    public void prewrite() {
        ...
        try {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.d(TAG, 2, "convert MessageForYanZhi to byte array failed", e18);
                }
            }
            throw th5;
        }
        try {
            try {
                ...
                try {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.d(TAG, 2, "convert MessageForYanZhi to byte array failed", e19);
                    }
                }
                try {
                    byteArrayOutputStream.close();
                    ...
                    QLog.d(TAG, 2, "convert MessageForYanZhi to byte array failed", e);
                }
            } catch (Throwable th7) {
                th5 = th7;
                if (objectOutputStream != null) {
                    try {
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.d(TAG, 2, "convert MessageForYanZhi to byte array failed", e27);
                        }
                    }
                }
                byteArrayOutputStream.close();
            ...
            e16 = e28;
            if (QLog.isColorLevel()) {
                QLog.d(TAG, 2, "convert MessageForYanZhi to byte array failed", e16);
            }
            if (objectOutputStream != null) {
                try {
                    objectOutputStream.close();
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.d(TAG, 2, "convert MessageForYanZhi to byte array failed", e29);
                    }
                }
            }
            try {
