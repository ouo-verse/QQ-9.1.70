...
public final class GuildHomeSubFragmentPart$initData$7 extends Lambda implements Function1<Boolean, Unit> {
    final /* synthetic */ GuildHomeSubFragmentPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildHomeSubFragmentPart$initData$7(GuildHomeSubFragmentPart guildHomeSubFragmentPart) {
        super(1);
    ...
    public final void invoke2(Boolean bool) {
        ...
        guildHomeSubFragmentContentLayout.postDelayed(new Runnable() { // from class: com.tencent.mobileqq.guild.home.parts.cc
            @Override // java.lang.Runnable
            public final void run() {
                GuildHomeSubFragmentPart$initData$7.b(GuildHomeSubFragmentPart.this);
            }
        }, 100L);
    }
}
