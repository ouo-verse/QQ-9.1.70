...
public final class GuildHomeLiveInactiveAdapterDelegate extends GuildHomeChannelBaseAdapterDelegate<so1.k, b> {
    ...
    protected boolean k(@NotNull so1.h item, int position) {
        ...
        return item instanceof so1.k;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // com.tencent.mobileqq.guild.home.activechannel.adapterdelegates.GuildHomeChannelBaseAdapterDelegate
    /* renamed from: n, reason: merged with bridge method [inline-methods] */
    public void m(@NotNull so1.k item, @NotNull b holder, @NotNull List<? extends Object> payloads, int pos) {
        Intrinsics.checkNotNullParameter(item, "item");
        Intrinsics.checkNotNullParameter(holder, "holder");
        Intrinsics.checkNotNullParameter(payloads, "payloads");
        Logger logger = Logger.f235387a;
        if (QLog.isColorLevel()) {
            logger.d().d("Guild.NewHome.content.active.Delegate.LiveInactive", 1, "onBindViewHolder item:" + item);
        }
        holder.x(item);
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000,\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\t\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\r\u001a\u00020\n\u0012\u0006\u0010\u0011\u001a\u00020\u000e\u00a2\u0006\u0004\b\u0015\u0010\u0016J\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002J\b\u0010\u0006\u001a\u00020\u0004H\u0016J\b\u0010\u0007\u001a\u00020\u0004H\u0016J\b\u0010\t\u001a\u00020\bH\u0016R\u0014\u0010\r\u001a\u00020\n8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u000b\u0010\fR\u0014\u0010\u0011\u001a\u00020\u000e8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u000f\u0010\u0010R\u0016\u0010\u0014\u001a\u00020\u00028\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u0012\u0010\u0013\u00a8\u0006\u0017"}, d2 = {"Lcom/tencent/mobileqq/guild/home/activechannel/adapterdelegates/GuildHomeLiveInactiveAdapterDelegate$b;", "Lcom/tencent/mobileqq/guild/home/activechannel/adapterdelegates/GuildHomeChannelBaseAdapterDelegate$a;", "Lso1/k;", PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME, "", HippyTKDListViewAdapter.X, ReportConstant.COSTREPORT_PREFIX, "t", "", "getTag", "Lvp1/bg;", "H", "Lvp1/bg;", "binding", "Lqo1/a$b;", "I", "Lqo1/a$b;", "callback", "J", "Lso1/k;", "itemData", "<init>", "(Lvp1/bg;Lqo1/a$b;)V", "qqguild-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes13.dex */
    public static final class b extends GuildHomeChannelBaseAdapterDelegate.a {
        ...
        */
        public b(@NotNull bg binding, @NotNull a.b callback) {
            ...
            this.callback = callback;
            binding.getRoot().post(new Runnable() { // from class: com.tencent.mobileqq.guild.home.activechannel.adapterdelegates.v
                @Override // java.lang.Runnable
                public final void run() {
                    GuildHomeLiveInactiveAdapterDelegate.b.w(GuildHomeLiveInactiveAdapterDelegate.b.this);
                }
            });
        }
        ...
        public static final void w(final b this$0) {
            ...
            this$0.binding.getRoot().setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.home.activechannel.adapterdelegates.w
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    GuildHomeLiveInactiveAdapterDelegate.b.y(GuildHomeLiveInactiveAdapterDelegate.b.this, view);
                }
            });
            this$0.binding.f442452d.setImageDrawable(UIUtil.f112434a.x().getDrawable(R.drawable.qui_guild_live_room_icon));
        ...
        public String getTag() {
            return "Guild.NewHome.content.active.Delegate.LiveInactive";
        }

        public final void x(@NotNull so1.k item) {
            float f16;
            Intrinsics.checkNotNullParameter(item, "item");
            this.itemData = item;
            ...
            imageView.setImageDrawable(imageView.getResources().getDrawable(R.drawable.guild_live_room_bg_icon));
        }
