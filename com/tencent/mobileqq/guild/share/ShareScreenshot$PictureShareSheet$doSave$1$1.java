...
final class ShareScreenshot$PictureShareSheet$doSave$1$1 extends Lambda implements Function3<String, Boolean, String, Unit> {
    final /* synthetic */ Activity $activity;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ShareScreenshot$PictureShareSheet$doSave$1$1(Activity activity) {
        super(3);
    ...
    public final void invoke(@NotNull final String filePath, final boolean z16, @NotNull String errMsg) {
        ...
        uIHandlerV2.post(new Runnable() { // from class: com.tencent.mobileqq.guild.share.ac
            @Override // java.lang.Runnable
            public final void run() {
                ShareScreenshot$PictureShareSheet$doSave$1$1.b(z16, filePath, activity);
            }
        });
    }
}
