...
final class GuildLLMChatShareScreenshot$PictureShareSheet$doSave$1$1 extends Lambda implements Function3<String, Boolean, String, Unit> {
    final /* synthetic */ Activity $activity;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildLLMChatShareScreenshot$PictureShareSheet$doSave$1$1(Activity activity) {
        super(3);
    ...
    public static final void b(boolean z16, String filePath, Activity activity) {
        ...
        if (!z16 || TextUtils.isEmpty(filePath)) {
            if (activity.isFinishing()) {
                QLog.w("ShareScreenshot", 1, "[doSave] activity is finishing!");
            } else {
    ...
    public final void invoke(@NotNull final String filePath, final boolean z16, @NotNull String errMsg) {
        ...
        uIHandlerV2.post(new Runnable() { // from class: com.tencent.mobileqq.guild.share.e
            @Override // java.lang.Runnable
            public final void run() {
                GuildLLMChatShareScreenshot$PictureShareSheet$doSave$1$1.b(z16, filePath, activity);
            }
        });
    }
}
