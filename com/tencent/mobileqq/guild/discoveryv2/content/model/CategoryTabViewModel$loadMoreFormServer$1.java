...
@DebugMetadata(c = "com.tencent.mobileqq.guild.discoveryv2.content.model.CategoryTabViewModel$loadMoreFormServer$1", f = "CategoryTabViewModel.kt", i = {}, l = {}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes13.dex */
final class CategoryTabViewModel$loadMoreFormServer$1 extends SuspendLambda implements Function2<NetTransaction<bg, ? extends a>, Continuation<? super Unit>, Object> {
    ...
    public CategoryTabViewModel$loadMoreFormServer$1(CategoryTabViewModel categoryTabViewModel, LoadMoreArgs loadMoreArgs, Continuation<? super CategoryTabViewModel$loadMoreFormServer$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        CategoryTabViewModel$loadMoreFormServer$1 categoryTabViewModel$loadMoreFormServer$1 = new CategoryTabViewModel$loadMoreFormServer$1(this.this$0, this.$loadMoreArgs, continuation);
        categoryTabViewModel$loadMoreFormServer$1.L$0 = obj;
        return categoryTabViewModel$loadMoreFormServer$1;
    }
    ...
    public final Object invoke(@NotNull NetTransaction<bg, ? extends a> netTransaction, @Nullable Continuation<? super Unit> continuation) {
        return ((CategoryTabViewModel$loadMoreFormServer$1) create(netTransaction, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (this.label == 0) {
            ...
            if (netTransaction.getFrom() != DataType.NET) {
                ...
                a16 = q.a(recommendList, new RecommendExtData(traceId, bgVar.a().e(), null, null, 0, 28, null));
            }
            ...
            if (aVar.getResult().d() && list.isEmpty()) {
                z16 = true;
            } else {
                z16 = false;
            }
            categoryTabViewModel.e2(new LoadMoreState(true, result, loadMoreType, list, z16, null, 32, null));
