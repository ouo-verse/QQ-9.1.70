...
public final class GuildDiscoveryWebFragment extends QPublicBaseFragment {
    ...
    GuildDiscoveryWebFragment(TabMisc tabMisc) {
        List<Part> listOf;
        this.miscPart = tabMisc;
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new Part[]{tabMisc, new WebContentPart()});
        this.parts = listOf;
    }
    ...
    public GuildDiscoveryWebFragment() {
        this(new TabMisc());
    }
}
