...
public class GuildSubscribeChannelGray extends ChatMessage {
    ...
    public String getSummaryMsg() {
        return HardCodeUtil.qqStr(R.string.f17895382) + HardCodeUtil.qqStr(R.string.f17894381);
    }

    public void initSubscribeChannelGray(String str, String str2, String str3) {
        this.selfTid = str;
        this.channelId = str2;
        this.guildId = str3;
        prewrite();
