...
public final class j extends f {
    ...
    public List<BaseVB<? extends ol3.b, ? extends MviUIState, ChannelSettingMviContext>> initializeChildVB(@NotNull View hostView) {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new com.tencent.mobileqq.guild.channel.managev2.a[]{new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(cVar, R.string.f141540gy, qUIListItemBackgroundType, null, 8, null), new zf1.a(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(qVar, R.string.f141510gv, qUIListItemBackgroundType2, null, 8, null), new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.d(), R.string.f154821fu, qUIListItemBackgroundType, null, 8, null), new zf1.a(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(new r(), R.string.f155031ge, qUIListItemBackgroundType2, null, 8, null), new zf1.b(), new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.delete.b(R.string.f141530gx)});
        return listOf;
    }
}
