...
import com.tencent.mobileqq.guild.channel.managev2.item.arrowform.ChannelSlowModeViewModel;
...
public final class i extends f {
    ...
    public List<BaseVB<? extends ol3.b, ? extends MviUIState, ChannelSettingMviContext>> initializeChildVB(@NotNull View hostView) {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new com.tencent.mobileqq.guild.channel.managev2.a[]{new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(cVar, R.string.f1488710r, qUIListItemBackgroundType, null, 8, null), new zf1.a(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(qVar, R.string.f1488610q, qUIListItemBackgroundType2, null, 8, null), new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(new r(), R.string.f155031ge, qUIListItemBackgroundType, null, 8, null), new zf1.a(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(new o(), R.string.f155021gd, qUIListItemBackgroundType2, null, 8, null), new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.arrowform.g(new ChannelSlowModeViewModel(), R.string.f156411k5, null, Integer.valueOf(R.string.f156891lf), 4, null), new zf1.b(), new com.tencent.mobileqq.guild.channel.managev2.item.delete.b(R.string.f1489310x)});
        return listOf;
    }
}
