...
public final class GuildSwipeBackLayout extends FrameLayout {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\u0007\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u0006\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\b\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u001b\u0010\u001cR\u001b\u0010\u0007\u001a\u00020\u00028BX\u0082\u0084\u0002\u00a2\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u0014\u0010\t\u001a\u00020\b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\t\u0010\nR\u0014\u0010\f\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\f\u0010\rR\u0014\u0010\u000f\u001a\u00020\u000e8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0011\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0011\u0010\rR\u0014\u0010\u0012\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0012\u0010\rR\u0014\u0010\u0013\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0013\u0010\rR\u0014\u0010\u0014\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0014\u0010\rR\u0014\u0010\u0016\u001a\u00020\u00158\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0016\u0010\u0017R\u0014\u0010\u0018\u001a\u00020\u000e8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0018\u0010\u0010R\u0014\u0010\u0019\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0019\u0010\rR\u0014\u0010\u001a\u001a\u00020\u000b8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u001a\u0010\r\u00a8\u0006\u001d"}, d2 = {"Lcom/tencent/mobileqq/guild/widget/GuildSwipeBackLayout$a;", "", "Landroid/view/animation/Interpolator;", "sInterpolator$delegate", "Lkotlin/Lazy;", "b", "()Landroid/view/animation/Interpolator;", "sInterpolator", "", "DEFAULT_EVENT_POS", UserInfo.SEX_FEMALE, "", "DEFAULT_TOP_EDGE_SIZE", "I", "", "HORIZONTAL_PERCENT", "D", "SETTLE_DURATION", "STATE_DRAGGING", "STATE_IDLE", "STATE_SETTLING", "", "TAG", "Ljava/lang/String;", "VERTICAL_PERCENT", "mInitLeft", "mInitTop", "<init>", "()V", "qqguild_df_impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$a, reason: from kotlin metadata */
    /* loaded from: classes33.dex */
    ...
    public GuildSwipeBackLayout(Context context) {
    ...
    private final boolean d(float delta) {
        return Math.abs(delta) > ((float) m());
    }

    private final int e(int delta) {
        return getTop() + delta < 0 ? -getTop() : delta;
    }
    ...
    private final boolean h() {
        if (this.mDragState == 2) {
            ...
            if (!computeScrollOffset) {
                post(new Runnable() { // from class: com.tencent.mobileqq.guild.widget.r
    ...
    private final boolean n() {
        return this.mInitialMotionY < ((float) this.mTopEdgeSize);
    }

    /* JADX WARN: Code restructure failed: missing block: B:23:0x00c3, code lost:
    
        if ((r10 == 0.0f) != false) goto L30;
     */
    /*
    ...
    */
    private final void o(MotionEvent ev5) {
        ...
        if (j().getLeft() <= j().getWidth() * 0.1d && (j().getLeft() <= 0 || xVelocity <= this.mMinVelocity)) {
            width = (((double) j().getLeft()) < ((double) (-j().getWidth())) * 0.1d || (j().getLeft() < 0 && xVelocity < ((float) (-this.mMinVelocity)))) ? -j().getWidth() : 0;
        } else {
            width = j().getWidth();
        }
    ...
    */
    ...
    public final void setBeforeInteceptActionMove(Function2<? super Float, ? super Float, Unit> function2) {
    ...
    public final void setOnPosChange(Function1<? super Float, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "<set-?>");
        this.onPosChange = function1;
    }

    public final void setOnScrollFinish(Function1<? super Boolean, Unit> function1) {
        Intrinsics.checkNotNullParameter(function1, "<set-?>");
        this.onScrollFinish = function1;
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public GuildSwipeBackLayout(Context context, AttributeSet attributeSet) {
    ...
    public GuildSwipeBackLayout(final Context context, AttributeSet attributeSet, int i3) {
        ...
        Lazy lazy4;
        Intrinsics.checkNotNullParameter(context, "context");
        lazy = LazyKt__LazyJVMKt.lazy(new Function0<GuildSwipeBackLayout>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$mContentView$2
        ...
        lazy2 = LazyKt__LazyJVMKt.lazy(new Function0<Integer>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$mTouchSlop$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
        ...
        lazy3 = LazyKt__LazyJVMKt.lazy(new Function0<ScrollerCompat>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$mScroller$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
        ...
        this.mLastMotionX = -1.0f;
        this.mLastMotionY = -1.0f;
        lazy4 = LazyKt__LazyJVMKt.lazy(new Function0<InputMethodManager>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$mInputManager$2
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
        ...
        this.onScrollFinish = new Function1<Boolean, Unit>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$onScrollFinish$1
        ...
        this.onPosChange = new Function1<Float, Unit>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$onPosChange$1
        ...
        this.beforeInteceptActionMove = new Function2<Float, Float, Unit>() { // from class: com.tencent.mobileqq.guild.widget.GuildSwipeBackLayout$beforeInteceptActionMove$1
