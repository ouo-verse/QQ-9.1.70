...
public final class ExcludeFontPaddingTextView extends AppCompatTextView {
    ...
    public static final class a implements LineHeightSpan {
        ...
        public void chooseHeight(@NotNull CharSequence text, int start, int end, int spanstartv, int lineHeight, @NotNull Paint.FontMetricsInt fm5) {
            ...
            Rect rect = this.f235805e;
            int max = Math.max(textSize, rect.bottom - rect.top);
            int abs = Math.abs(fm5.ascent - this.f235805e.top);
            int i16 = fm5.descent - this.f235805e.bottom;
            int i17 = (i3 - max) / 2;
            if (i17 < Math.min(abs, i16)) {
                fm5.ascent += i17;
                fm5.descent -= i17;
            } else if (abs < i16) {
                int i18 = this.f235805e.top;
                fm5.ascent = i18;
                fm5.descent = max + i18;
            } else {
                int i19 = this.f235805e.bottom;
                fm5.descent = i19;
                fm5.ascent = i19 - max;
            }
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ExcludeFontPaddingTextView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i3) {
