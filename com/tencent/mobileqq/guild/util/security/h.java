...
/* compiled from: P */
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0016\u0010\u0017J\u0018\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u001e\u0010\n\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00040\bJ\u001e\u0010\u000b\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u00040\bJ\u0010\u0010\r\u001a\u00020\f2\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002J\u000e\u0010\u000e\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u0002J\u0010\u0010\u0010\u001a\u00020\u00062\u0006\u0010\u000f\u001a\u00020\u0002H\u0016R(\u0010\u0015\u001a\u0016\u0012\u0004\u0012\u00020\u0002\u0012\f\u0012\n\u0012\u0004\u0012\u00020\u0004\u0018\u00010\u00120\u00118\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u0013\u0010\u0014\u00a8\u0006\u0018"}, d2 = {"Lcom/tencent/mobileqq/guild/util/security/h;", "Lcom/tencent/mobileqq/guild/base/repository/a;", "", "guildId", "", "state", "", "g", "Landroidx/lifecycle/Observer;", "observer", "b", "f", "", "c", "d", "account", "onAccountChanged", "Ljava/util/concurrent/ConcurrentHashMap;", "Le12/e;", "e", "Ljava/util/concurrent/ConcurrentHashMap;", "liveSpeakSwitchMap", "<init>", "()V", "qqguild-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes14.dex */
public final class h implements com.tencent.mobileqq.guild.base.repository.a {

    /* renamed from: d, reason: collision with root package name */
    @NotNull
    public static final h f235636d = new h();

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    @NotNull
    private static final ConcurrentHashMap<String, e12.e<Integer>> liveSpeakSwitchMap = new ConcurrentHashMap<>();
    ...
    public static final void e(String guildId, int i3, String str, IGProChannelOpenStateResultInfo iGProChannelOpenStateResultInfo) {
        ...
        Logger.f235387a.d().i("GuildSecurityManager", 1, "pullLiveChannelSpeakSwitch: guildId:" + guildId + ", result:" + i3 + " errMsg:" + str + ", stateResultInfo:" + iGProChannelOpenStateResultInfo);
        if (i3 != 0) {
            return;
        }
        ...
        for (IGProSwitchInfo iGProSwitchInfo : switchInfoList) {
            if (iGProSwitchInfo.getSwitchType() == 7) {
                Logger.f235387a.d().i("GuildSecurityManager", 1, "pullChannelSwitch  switchType = " + iGProSwitchInfo.getSwitchType() + ", switchState = " + iGProSwitchInfo.getSwitchState() + ", closeReason = " + iGProSwitchInfo.getCloseReason());
                f235636d.g(guildId, iGProSwitchInfo.getSwitchState());
            }
        }
    }

    private final void g(String guildId, int state) {
        ConcurrentHashMap<String, e12.e<Integer>> concurrentHashMap = liveSpeakSwitchMap;
    ...
    public final void b(@Nullable String guildId, @NotNull Observer<Integer> observer) {
        ...
        if (guildId == null) {
            QLog.i("GuildSecurityManager", 1, "[addGuildLiveMuteObserver] guild is null");
            return;
        }
        ConcurrentHashMap<String, e12.e<Integer>> concurrentHashMap = liveSpeakSwitchMap;
        boolean containsKey = concurrentHashMap.containsKey(guildId);
        QLog.i("GuildSecurityManager", 1, "[addGuildLiveMuteObserver] guild = " + guildId + ", hasData = " + containsKey);
        if (!containsKey) {
    ...
    public final boolean c(@Nullable String guildId) {
        Integer value;
        e12.e<Integer> eVar = liveSpeakSwitchMap.get(guildId);
    ...
    public final void d(@NotNull final String guildId) {
        ...
        Intrinsics.checkNotNullParameter(guildId, "guildId");
        QLog.i("GuildSecurityManager", 1, "[pullLiveChannelSpeakSwitch] guildId = " + guildId);
        ...
        ((IGPSService) runtimeService).fetchSpecifiedTypeChannelsOpenState(parseLong, arrayListOf, 0, new be() { // from class: com.tencent.mobileqq.guild.util.security.g
            @Override // wh2.be
            public final void a(int i3, String str, IGProChannelOpenStateResultInfo iGProChannelOpenStateResultInfo) {
                h.e(guildId, i3, str, iGProChannelOpenStateResultInfo);
            }
        });
    }
    ...
    public final void f(@Nullable String guildId, @NotNull Observer<Integer> observer) {
        Intrinsics.checkNotNullParameter(observer, "observer");
        if (guildId == null) {
            QLog.i("GuildSecurityManager", 1, "[removeGuildLiveSpeakSwitchObserver] guild is null");
            return;
        }
        e12.e<Integer> eVar = liveSpeakSwitchMap.get(guildId);
        QLog.i("GuildSecurityManager", 1, "['removeGuildLiveMuteObserver'] guildId = " + guildId + ", muteLiveData = " + eVar + " ");
        if (eVar != null) {
