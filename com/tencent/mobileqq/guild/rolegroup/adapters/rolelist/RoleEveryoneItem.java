...
/* renamed from: com.tencent.mobileqq.guild.rolegroup.adapters.rolelist.m, reason: from toString */
/* loaded from: classes14.dex */
public final /* data */ class RoleEveryoneItem extends r {
    ...
    public RoleEveryoneItem(@NotNull String text, @NotNull RoleGroupModel role) {
        super(2, role.getId(), null);
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!(other instanceof RoleEveryoneItem)) {
            return false;
        }
        RoleEveryoneItem roleEveryoneItem = (RoleEveryoneItem) other;
        if (Intrinsics.areEqual(this.text, roleEveryoneItem.text) && Intrinsics.areEqual(this.role, roleEveryoneItem.role)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        return "RoleEveryoneItem(text=" + this.text + ", role=" + this.role + ")";
    }
}
