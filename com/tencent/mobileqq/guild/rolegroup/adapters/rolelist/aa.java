...
public final class aa extends ad {
    ...
    public aa(@NotNull ViewGroup parent, @NotNull Function2<? super r, ? super View, Unit> itemClickCallback) {
    ...
    public static final void n(aa this$0, r item, View view) {
    ...
    public void l(@NotNull final r item, @NotNull RoleGroupListViewModel.ShowState state) {
        ...
        if (item instanceof RoleVisitorItem) {
            x.b(this.controller, ((RoleVisitorItem) item).getRole(), state, null, 4, null);
            this.controller.g(R.string.f1384909p, new Object[0]);
            this.controller.f(true);
            this.controller.e(new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.rolegroup.adapters.rolelist.z
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    aa.n(aa.this, item, view);
                }
            });
            return;
        }
