...
public final class o extends GuildBaseModifyRoleMemberStrategy {
    ...
    public o(@NotNull jy1.a viewModel, @NotNull GuildRoleMemberParamData param) {
    ...
    public static final void v(o this$0, int i3, String str, int i16, boolean z16, List list) {
    ...
    public void a(int count, boolean isForce) {
        k(true);
        ((IGPSService) ch.R0(IGPSService.class)).fetchCategoryAdminMemberList(this.param.getGuildId(), this.param.getCategoryId(), this.param.getRoleGroupId(), count, isForce, new vh2.ar() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.n
            @Override // vh2.ar
            public final void a(int i3, String str, int i16, boolean z16, List list) {
                o.v(o.this, i3, str, i16, z16, list);
            }
        });
    }
    ...
    public int getSearchSourceId() {
        return GProGuildMemberSearchSourceId.CATEGORY_ADMIN_MEMBER.ordinal();
    }
}
