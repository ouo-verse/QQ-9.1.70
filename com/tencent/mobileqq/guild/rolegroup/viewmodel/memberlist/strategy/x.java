...
public abstract class x extends GuildBaseBindPermissionMemberStrategy {
    ...
    public /* synthetic */ x(jy1.a aVar, GuildRoleMemberParamData guildRoleMemberParamData, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public void g(@NotNull List<String> userListToAdd, @NotNull List<String> userListToRemove, @NotNull final a.InterfaceC10621a callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        ((IGPSService) ch.R0(IGPSService.class)).setChannelSpeakableMemberList(this.param.getGuildId(), this.param.getSubChannelId(), userListToAdd, userListToRemove, new cd() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.w
            @Override // vh2.cd
            public final void a(int i3, String str, IGProSecurityResult iGProSecurityResult) {
                x.u(a.InterfaceC10621a.this, i3, str, iGProSecurityResult);
            }
        });
    }

    x(jy1.a aVar, GuildRoleMemberParamData guildRoleMemberParamData) {
