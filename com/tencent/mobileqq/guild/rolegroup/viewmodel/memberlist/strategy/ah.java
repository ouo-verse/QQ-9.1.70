...
public class ah extends x {
    ...
    public ah(@NotNull jy1.a viewModel, @NotNull GuildRoleMemberParamData param) {
    ...
    public static final void w(ah this$0, int i3, String str, int i16, boolean z16, byte[] bArr, List memberList) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(memberList, "memberList");
        this$0.k(false);
        Logger logger = Logger.f235387a;
        if (QLog.isDebugVersion()) {
            logger.d().d("Guild.rg..GuildBaseBindPermissionMemberStrategy", 1, "fetchSpeakableUser " + i3 + ", " + str + ", " + i16 + ", " + z16 + ", " + bArr + ", " + memberList);
        }
        if (i3 != 0) {
    ...
    public void a(int count, boolean isForce) {
        ...
        iGPSService.getChannelSpeakableMemberList(guildId, subChannelId, count, bArr, new xh2.h() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.ag
            @Override // xh2.h
            public final void a(int i3, String str, int i16, boolean z16, byte[] bArr2, List list) {
                ah.w(ah.this, i3, str, i16, z16, bArr2, list);
            }
        });
    }
    ...
    public int r() {
        return GProGuildMemberSearchSourceId.CHANNEL_SPEAK_SETTING_MEMBER.ordinal();
    }
}
