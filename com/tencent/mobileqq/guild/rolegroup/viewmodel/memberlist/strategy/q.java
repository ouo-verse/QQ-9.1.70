...
public abstract class q extends GuildBaseBindPermissionMemberStrategy {
    ...
    public void g(@NotNull List<String> userListToAdd, @NotNull List<String> userListToRemove, @NotNull final a.InterfaceC10621a callback) {
        ...
        List<String> list = userListToAdd;
        ...
        List<String> list2 = userListToRemove;
        ...
        iGPSService.setChannelAuthControlMemberList(parseLong, parseLong2, arrayList2, new ArrayList<>(arrayList3), 5, new dv() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.p
            @Override // wh2.dv
            public final void a(int i3, String str, IGProSecurityResult iGProSecurityResult) {
                q.u(a.InterfaceC10621a.this, i3, str, iGProSecurityResult);
            }
        });
    }

    q(jy1.a aVar, GuildRoleMemberParamData guildRoleMemberParamData) {
