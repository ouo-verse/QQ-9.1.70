...
public final class ab extends GuildBaseModifyRoleMemberStrategy {
    ...
    public ab(@NotNull jy1.a viewModel, @NotNull GuildRoleMemberParamData param) {
    ...
    public static final void v(ab this$0, int i3, String str, int i16, boolean z16, List list) {
    ...
    public void a(int count, boolean isForce) {
        k(true);
        ((IGPSService) ch.R0(IGPSService.class)).fetchChannelAdminMemberList(this.param.getGuildId(), this.param.getSubChannelId(), this.param.getRoleGroupId(), count, isForce, new vh2.ar() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.aa
            @Override // vh2.ar
            public final void a(int i3, String str, int i16, boolean z16, List list) {
                ab.v(ab.this, i3, str, i16, z16, list);
            }
        });
    }
    ...
    public int getSearchSourceId() {
        return GProGuildMemberSearchSourceId.CHANNEL_ADMIN_MEMBER.ordinal();
    }
}
