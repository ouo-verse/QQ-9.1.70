...
public final class b extends q {
    ...
    public b(@NotNull jy1.a viewModel, @NotNull GuildRoleMemberParamData param) {
    ...
    public static final void w(b this$0, int i3, String str, boolean z16, byte[] bArr, ArrayList arrayList) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        this$0.k(false);
        Logger logger = Logger.f235387a;
        if (QLog.isDebugVersion()) {
            logger.d().d("Guild.rg..GuildBaseBindPermissionMemberStrategy", 1, "fetchCannotEditMapUser " + i3 + ", " + str + ", " + z16 + ", " + bArr + ", " + arrayList);
        }
        if (i3 != 0) {
    ...
    public void a(int count, boolean isForce) {
        ...
        iGPSService.fetchChannelAuthControlUnableMemberList(parseLong, parseLong2, count, bArr, 5, new wh2.ai() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.a
            @Override // wh2.ai
            public final void onFetchChannelUnableMemberList(int i3, String str, boolean z16, byte[] bArr2, ArrayList arrayList) {
                b.w(b.this, i3, str, z16, bArr2, arrayList);
            }
        });
    }
    ...
    public int r() {
        return GProGuildMemberSearchSourceId.ADD_CHANNEL_ACTIVITY_SETTING_MEMBER.ordinal();
    }
}
