...
public final class f extends s {
    ...
    public f(@NotNull jy1.a viewModel, @NotNull GuildRoleMemberParamData param) {
    ...
    public static final void w(f this$0, int i3, String str, boolean z16, byte[] bArr, List memberList) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(memberList, "memberList");
        this$0.k(false);
        Logger logger = Logger.f235387a;
        if (QLog.isDebugVersion()) {
            logger.d().d("Guild.rg..GuildBaseBindPermissionMemberStrategy", 1, "fetchUnlivableUser " + i3 + ", " + str + ", " + z16 + ", " + bArr + ", " + memberList);
        }
        if (i3 != 0) {
    ...
    public void a(int count, boolean isForce) {
        ...
        iGPSService.fetchChannelUnlivableMemberList(guildId, subChannelId, count, bArr, new xh2.j() { // from class: com.tencent.mobileqq.guild.rolegroup.viewmodel.memberlist.strategy.e
            @Override // xh2.j
            public final void a(int i3, String str, boolean z16, byte[] bArr2, List list) {
                f.w(f.this, i3, str, z16, bArr2, list);
            }
        });
    }
    ...
    public int r() {
        return GProGuildMemberSearchSourceId.ADD_CHANNEL_LIVE_SETTING_MEMBER.ordinal();
    }
}
