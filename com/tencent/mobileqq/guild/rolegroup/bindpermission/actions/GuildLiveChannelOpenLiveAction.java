...
public final class GuildLiveChannelOpenLiveAction implements z {
    ...
    public GuildLiveChannelOpenLiveAction(@NotNull String guildId, @NotNull String channelId) {
    ...
    public static final void k(x callback, ri1.a error, List list) {
        ...
        e.f232387a.b(error, list, "openLive", callback);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void l(final GuildLiveChannelOpenLiveAction this$0, final y callback, final IGPSService service, int i3, String str, int i16, boolean z16, final byte[] bArr, List memberList) {
        ...
        eVar.c(e16, f.a(memberList, this$0.guildId), i16, z16, "openLive", callback, new Function0<Unit>() { // from class: com.tencent.mobileqq.guild.rolegroup.bindpermission.actions.GuildLiveChannelOpenLiveAction$fetchHasPermissionUsers$1$1
            ...
            public final void invoke2() {
                GuildLiveChannelOpenLiveAction.this.e(service, bArr, callback);
            }
        });
    }
    ...
    public PermissionSwitchStatus a(@NotNull IGPSService service) {
        ...
        if (channelInfo != null) {
            return aa.a(channelInfo.getChannelLiveableType());
        }
    ...
    public void b(@NotNull IGPSService service, @NotNull List<String> addRoles, @NotNull List<String> removeRoles, @NotNull final w callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        service.setChannelLiveableRoleList(this.guildId, this.channelId, addRoles, removeRoles, new cd() { // from class: com.tencent.mobileqq.guild.rolegroup.bindpermission.actions.g
            @Override // vh2.cd
            public final void a(int i3, String str, IGProSecurityResult iGProSecurityResult) {
                GuildLiveChannelOpenLiveAction.m(w.this, i3, str, iGProSecurityResult);
            }
        });
    }
    ...
    public void c(@NotNull IGPSService service, @NotNull PermissionSwitchStatus type, @NotNull final w callback) {
        ...
        Intrinsics.checkNotNullParameter(callback, "callback");
        service.setChannelLiveable(this.guildId, this.channelId, aa.d(type), new cd() { // from class: com.tencent.mobileqq.guild.rolegroup.bindpermission.actions.j
            @Override // vh2.cd
            public final void a(int i3, String str, IGProSecurityResult iGProSecurityResult) {
                GuildLiveChannelOpenLiveAction.j(w.this, i3, str, iGProSecurityResult);
            }
        });
    }
    ...
    public void d(@NotNull IGPSService service, @NotNull final x callback) {
        Intrinsics.checkNotNullParameter(service, "service");
        Intrinsics.checkNotNullParameter(callback, "callback");
        com.tencent.mobileqq.guild.rolegroup.model.repositories.s.a().c(new ChannelPermissionTarget(this.guildId, this.channelId, ChannelPermissionType.LivePermission), new com.tencent.mobileqq.guild.base.repository.h() { // from class: com.tencent.mobileqq.guild.rolegroup.bindpermission.actions.h
            @Override // com.tencent.mobileqq.guild.base.repository.h
            public final void a(ri1.a aVar, Object obj) {
                GuildLiveChannelOpenLiveAction.k(x.this, aVar, (List) obj);
            }
        });
    }
    ...
    public void e(@NotNull final IGPSService service, @Nullable byte[] cookieCache, @NotNull final y callback) {
        ...
        service.fetchChannelLiveableMemberList(str, str2, 100, cookieCache, new xh2.f() { // from class: com.tencent.mobileqq.guild.rolegroup.bindpermission.actions.i
            @Override // xh2.f
            public final void a(int i3, String str3, int i16, boolean z16, byte[] bArr, List list) {
                GuildLiveChannelOpenLiveAction.l(GuildLiveChannelOpenLiveAction.this, callback, service, i3, str3, i16, z16, bArr, list);
            }
        });
    }
}
