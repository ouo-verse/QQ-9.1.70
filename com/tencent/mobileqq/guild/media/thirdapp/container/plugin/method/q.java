...
public final class q extends o {
    ...
    public boolean c(@NotNull String url, @Nullable JSONObject args, @NotNull com.tencent.mobileqq.guild.media.thirdapp.container.plugin.c callback) {
        ...
        Logger.f235387a.d().d("NotifyUserAuthResult", 1, "notifyUserAuthResult args: " + args);
        if (args != null) {
            i3 = args.optInt("code");
        } else {
            i3 = -1;
        ...
        g(new MiniAppIntent.NotifyUserAuthResultIntent(i3, str, str3));
