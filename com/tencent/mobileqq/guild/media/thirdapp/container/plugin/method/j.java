...
public final class j extends o {
    ...
    public boolean c(@NotNull String url, @Nullable JSONObject args, @NotNull com.tencent.mobileqq.guild.media.thirdapp.container.plugin.c callback) {
        ...
        MediaShareLoadInfo value = com.tencent.mobileqq.guild.media.core.j.c().C().getValue();
        if (value == null) {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(AskAnonymouslyApiPlugin.KEY_SHARE_TYPE, 0);
            c.a.a(callback, jSONObject, false, 2, null);
            return false;
        }
        JSONObject jSONObject2 = new JSONObject();
        jSONObject2.put(AskAnonymouslyApiPlugin.KEY_SHARE_TYPE, value.getShareType());
        jSONObject2.put("query", value.g());
        c.a.a(callback, jSONObject2, false, 2, null);
