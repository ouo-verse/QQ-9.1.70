...
public final class l extends o {
    ...
    public boolean c(@NotNull String url, @Nullable JSONObject args, @NotNull com.tencent.mobileqq.guild.media.thirdapp.container.plugin.c callback) {
        ...
        Logger.f235387a.d().d("GetMusicProgressMethod", 1, "getMusicCurrentProgress [onInvoke], args: " + args);
        long u16 = TRTCAudioRoomLocalNew.INSTANCE.a().u(args.optInt("id", 0));
        JSONObject jSONObject = new JSONObject();
        jSONObject.put("musicCurrentProgress", u16);
