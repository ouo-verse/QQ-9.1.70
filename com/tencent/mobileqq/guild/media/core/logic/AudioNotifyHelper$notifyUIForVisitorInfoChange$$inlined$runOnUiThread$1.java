...
public final class AudioNotifyHelper$notifyUIForVisitorInfoChange$$inlined$runOnUiThread$1 implements Runnable {
    ...
    public final void run() {
        ...
        while (it.hasNext()) {
            ((com.tencent.mobileqq.guild.media.core.notify.q) it.next()).n(null);
        }
    }
}
