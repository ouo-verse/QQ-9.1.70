...
public final class GuildRecentlyViewedFragment$setRightView$1$actionSheet$1$1 extends Lambda implements Function2<View, ActionSheet, Unit> {
    final /* synthetic */ GuildRecentlyViewedFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildRecentlyViewedFragment$setRightView$1$actionSheet$1$1(GuildRecentlyViewedFragment guildRecentlyViewedFragment) {
        super(2);
    ...
    public final void invoke2(@NotNull View view, @NotNull final ActionSheet actionSheet) {
        ...
        view.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.recently.d
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                GuildRecentlyViewedFragment$setRightView$1$actionSheet$1$1.b(GuildRecentlyViewedFragment.this, actionSheet, view2);
            }
        });
    }
}
