...
public final class GuildProfileFragment$createSettingsItem$1 extends Lambda implements Function1<tz1.b<x.b.d>, Unit> {
    final /* synthetic */ QUIListItemAdapter $adapter;
    final /* synthetic */ GuildProfileFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildProfileFragment$createSettingsItem$1(GuildProfileFragment guildProfileFragment, QUIListItemAdapter qUIListItemAdapter) {
        super(1);
    ...
    public static final void c(GuildProfileFragment this$0, View view) {
    ...
    public final void invoke2(@NotNull final tz1.b<x.b.d> config) {
        ...
        config.x(new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.setting.guildmanage.profile.n
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                GuildProfileFragment$createSettingsItem$1.c(GuildProfileFragment.this, view);
            }
        });
        ...
        MutableLiveData<GuildProfileViewModel.ItemContent> d26 = guildProfileViewModel.d2();
        LifecycleOwner viewLifecycleOwner = this.this$0.getViewLifecycleOwner();
        final QUIListItemAdapter qUIListItemAdapter = this.$adapter;
        final Function1<GuildProfileViewModel.ItemContent, Unit> function1 = new Function1<GuildProfileViewModel.ItemContent, Unit>() { // from class: com.tencent.mobileqq.guild.setting.guildmanage.profile.GuildProfileFragment$createSettingsItem$1.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
        ...
        d26.observe(viewLifecycleOwner, new Observer() { // from class: com.tencent.mobileqq.guild.setting.guildmanage.profile.o
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                GuildProfileFragment$createSettingsItem$1.d(Function1.this, obj);
            }
        });
    }
}
