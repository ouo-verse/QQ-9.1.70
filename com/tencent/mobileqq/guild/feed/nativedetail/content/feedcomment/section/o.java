...
public final class o extends a<jl1.h> implements View.OnClickListener, View.OnLongClickListener {
    ...
    public void onClick(@Nullable View v3) {
        ...
        if (num != null && num.intValue() == R.id.wdm && !v.a().b(v3)) {
            int sendStatus = ((jl1.h) this.mData).getSendStatus();
            if (sendStatus != 0) {
                ...
                jl1.h hVar = (jl1.h) this.mData;
                if (hVar != null && (p16 = p()) != null) {
                    p16.O4(hVar, Integer.valueOf(this.mPosition));
                }
            }
            CommentItemView commentItemView2 = this.itemView;
            if (commentItemView2 == null) {
    ...
    public boolean onLongClick(@Nullable View v3) {
        ...
        boolean z16 = false;
        if (!com.tencent.mobileqq.guild.util.o.c("fastClickGuard") && ((jl1.h) this.mData).getSendStatus() == 0) {
            if (v3 != null) {
                num = Integer.valueOf(v3.getId());
            } else {
                num = null;
            }
            if (num != null && num.intValue() == R.id.wdm) {
                if (((jl1.h) this.mData).getSendStatus() == 0 && (p16 = p()) != null) {
                    T mData = this.mData;
                    Intrinsics.checkNotNullExpressionValue(mData, "mData");
