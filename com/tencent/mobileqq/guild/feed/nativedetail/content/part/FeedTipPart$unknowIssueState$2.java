...
public final class FeedTipPart$unknowIssueState$2 extends Lambda implements Function0<GuildQUIEmptyState> {
    final /* synthetic */ FeedTipPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeedTipPart$unknowIssueState$2(FeedTipPart feedTipPart) {
        super(0);
    ...
    public final GuildQUIEmptyState invoke() {
        ...
        aVar.u("\u5e16\u5b50\u6682\u65f6\u4e0d\u53ef\u67e5\u770b");
        E9 = feedTipPart.E9();
        aVar.p(E9, new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.feed.nativedetail.content.part.ab
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FeedTipPart$unknowIssueState$2.b(FeedTipPart.this, view);
            }
        });
        aVar.n(true);
