...
public final class FeedTipPart$permissionIssueState$2 extends Lambda implements Function0<GuildQUIEmptyState> {
    final /* synthetic */ FeedTipPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeedTipPart$permissionIssueState$2(FeedTipPart feedTipPart) {
        super(0);
    ...
    public final GuildQUIEmptyState invoke() {
        ...
        aVar.u("\u65e0\u7248\u5757\u6743\u9650");
        E9 = feedTipPart.E9();
        aVar.p(E9, new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.feed.nativedetail.content.part.v
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FeedTipPart$permissionIssueState$2.b(FeedTipPart.this, view);
            }
        });
        aVar.n(true);
