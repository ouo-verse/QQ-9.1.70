...
public final class FeedTipPart$quiFeedDeletedState$2 extends Lambda implements Function0<GuildQUIEmptyState> {
    final /* synthetic */ FeedTipPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeedTipPart$quiFeedDeletedState$2(FeedTipPart feedTipPart) {
        super(0);
    ...
    public final GuildQUIEmptyState invoke() {
        ...
        aVar.s(2);
        String string = feedTipPart.getContext().getString(R.string.zxr);
        Intrinsics.checkNotNullExpressionValue(string, "context.getString(R.string.feed_deleted)");
        aVar.u(string);
        E9 = feedTipPart.E9();
        aVar.p(E9, new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.feed.nativedetail.content.part.w
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FeedTipPart$quiFeedDeletedState$2.b(FeedTipPart.this, view);
            }
        });
        aVar.n(true);
