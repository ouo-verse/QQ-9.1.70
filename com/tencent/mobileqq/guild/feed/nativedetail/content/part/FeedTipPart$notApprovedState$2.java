...
public final class FeedTipPart$notApprovedState$2 extends Lambda implements Function0<GuildQUIEmptyState> {
    final /* synthetic */ FeedTipPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeedTipPart$notApprovedState$2(FeedTipPart feedTipPart) {
        super(0);
    ...
    public final GuildQUIEmptyState invoke() {
        ...
        aVar.u("\u5e16\u5b50\u8fdd\u89c4");
        E9 = feedTipPart.E9();
        aVar.p(E9, new View.OnClickListener() { // from class: com.tencent.mobileqq.guild.feed.nativedetail.content.part.u
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                FeedTipPart$notApprovedState$2.b(FeedTipPart.this, view);
            }
        });
        aVar.n(true);
