...
public final class g extends hl1.a<a, hl1.g> {
    ...
    @Override // com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(@NotNull ViewGroup parent, @NotNull View itemView, @NotNull List<Class<? extends Section<a>>> sections) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        List asMutableList = TypeIntrinsics.asMutableList(sections);
        asMutableList.add(k.class);
        asMutableList.add(com.tencent.mobileqq.guild.feed.nativedetail.content.feedmain.section.g.class);
        asMutableList.add(m.class);
        asMutableList.add(FeedBusinessCardSection.class);
    }
}
