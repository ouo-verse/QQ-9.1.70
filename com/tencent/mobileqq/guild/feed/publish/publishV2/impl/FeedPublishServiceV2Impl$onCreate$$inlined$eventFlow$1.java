...
public final class FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1 extends SuspendLambda implements Function2<ProducerScope<? super GuildFeedDeleteEvent>, Continuation<? super Unit>, Object> {
    final /* synthetic */ SimpleEventBus $this_eventFlow;
    private /* synthetic */ Object L$0;
    int label;

    @Metadata(d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005*\u0001\u0000\b\n\u0018\u00002\b\u0012\u0004\u0012\u00028\u00000\u0001J\u0012\u0010\u0005\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0016J$\u0010\t\u001a\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u00070\u0006j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0007`\bH\u0016R0\u0010\f\u001a\u001e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u00070\u0006j\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00028\u00000\u0007`\b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\n\u0010\u000b\u00a8\u0006\r"}, d2 = {"com/tencent/mobileqq/guild/feed/publish/publishV2/impl/FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1$a", "Lcom/tencent/biz/richframework/eventbus/SimpleEventReceiver;", "Lcom/tencent/biz/richframework/eventbus/SimpleBaseEvent;", "event", "", "onReceiveEvent", "Ljava/util/ArrayList;", "Ljava/lang/Class;", "Lkotlin/collections/ArrayList;", "getEventClass", "d", "Ljava/util/ArrayList;", "eventClz", "qqguild-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes13.dex */
    public static final class a implements SimpleEventReceiver<GuildFeedDeleteEvent> {
        ...
        final /* synthetic */ ProducerScope<GuildFeedDeleteEvent> f223031e;

        public a(ProducerScope producerScope) {
            ArrayList<Class<GuildFeedDeleteEvent>> arrayListOf;
            this.f223031e = producerScope;
        ...
        public void onReceiveEvent(@Nullable SimpleBaseEvent event) {
            ...
            if (guildFeedDeleteEvent != null) {
                this.f223031e.mo2003trySendJP2dKIU(guildFeedDeleteEvent);
            }
        }
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1(SimpleEventBus simpleEventBus, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1 feedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1 = new FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1(this.$this_eventFlow, continuation);
        feedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1.L$0 = obj;
        return feedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1;
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            Function0<Unit> function0 = new Function0<Unit>() { // from class: com.tencent.mobileqq.guild.feed.publish.publishV2.impl.FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1.2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
    ...
    public final Object invoke(@NotNull ProducerScope<? super GuildFeedDeleteEvent> producerScope, @Nullable Continuation<? super Unit> continuation) {
        return ((FeedPublishServiceV2Impl$onCreate$$inlined$eventFlow$1) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
