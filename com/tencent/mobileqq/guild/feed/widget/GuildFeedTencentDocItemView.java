...
public final class GuildFeedTencentDocItemView extends GuildFeedBaseItemView {
    ...
    protected List<GuildBaseFeedChildPresenter<ij1.g>> q0() {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new GuildBaseFeedChildPresenter[]{new com.tencent.mobileqq.guild.feed.presenter.m(bean), new com.tencent.mobileqq.guild.feed.presenter.i(this.f224139f)});
        return listOf;
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildFeedTencentDocItemView(@NotNull Context context, int i3) {
        super(context, Integer.valueOf(i3));
        Intrinsics.checkNotNullParameter(context, "context");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public GuildFeedTencentDocItemView(@NotNull Context context, int i3, @NotNull GuildFeedDefaultInitBean defaultInitBean) {
