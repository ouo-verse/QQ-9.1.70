...
public class GuildRefreshHeadView extends LinearLayout implements IRefreshViewProvider {
    ...
    private FrameLayout f224261d;

    /* renamed from: e, reason: collision with root package name */
    private ImageView f224262e;

    /* renamed from: f, reason: collision with root package name */
    private int f224263f;

    /* renamed from: h, reason: collision with root package name */
    private int f224264h;

    /* renamed from: i, reason: collision with root package name */
    private float f224265i;

    /* renamed from: m, reason: collision with root package name */
    private float f224266m;
    ...
    public class a implements ValueAnimator.AnimatorUpdateListener {
        ...
        public void onAnimationUpdate(ValueAnimator valueAnimator) {
            ...
            if (this.f224268d == 0 && ((Integer) valueAnimator.getAnimatedValue()).intValue() == 0) {
    ...
    private void d() {
        ...
        setPadding(0, 0, 0, 0);
        FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(getContext()).inflate(R.layout.eqf, (ViewGroup) null);
        this.f224261d = frameLayout;
        addView(frameLayout, new LinearLayout.LayoutParams(-1, 0));
        ImageView imageView = (ImageView) findViewById(R.id.wdg);
        this.f224262e = imageView;
        imageView.setImageDrawable(LoadingUtil.getLoadingDrawable(getContext(), 2));
        measure(-2, -2);
        this.f224263f = getMeasuredHeight();
    }
    ...
    private void o(boolean z16) {
        int i3;
        ImageView imageView = this.f224262e;
        if (z16) {
            i3 = 0;
        } else {
            i3 = 8;
    ...
    public int c() {
        return ((LinearLayout.LayoutParams) this.f224261d.getLayoutParams()).height;
    }

    @Override // com.tencent.biz.richframework.part.IRefreshViewProvider
    public void callRefresh(final RecyclerView recyclerView) {
        setState(2);
        b().postDelayed(new Runnable() { // from class: com.tencent.mobileqq.guild.feed.widget.GuildRefreshHeadView.3
    ...
    public void g(float f16, float f17) {
        if (c() > 0 || f16 > 0.0f) {
            setVisibleHeight(Math.max(((int) f16) + c(), this.f224263f));
            if (this.f224264h <= 1) {
                if (c() > this.f224263f) {
                    h();
                } else {
    ...
    public void handleRefreshGesture(MotionEvent motionEvent) {
        boolean z16;
        if (this.f224265i == -1.0f) {
            this.f224265i = motionEvent.getRawY();
        }
    ...
    public boolean i() {
        ...
        int i3;
        int c16 = c();
        if (c() > this.f224263f && this.f224264h < 2) {
            setState(2);
            z16 = true;
        } else {
            z16 = false;
        }
        if (this.f224264h == 2 && c16 > (i3 = this.f224263f)) {
            s(i3);
        }
        if (this.f224264h != 2) {
            s(0);
    ...
    public void k() {
        QLog.d("RefreshHeaderView", 1, "refreshComplete: state[" + this.f224264h + "]");
        int i3 = this.f224264h;
        if (i3 == 4 || i3 == 2 || i3 == 0) {
            long currentTimeMillis = 500 - (System.currentTimeMillis() - this.F);
            if (currentTimeMillis > 0) {
                b().postDelayed(new Runnable() { // from class: com.tencent.mobileqq.guild.feed.widget.GuildRefreshHeadView.1
                    @Override // java.lang.Runnable
                    public void run() {
                        if (GuildRefreshHeadView.this.f224264h == 4 || GuildRefreshHeadView.this.f224264h == 2 || GuildRefreshHeadView.this.f224264h == 0) {
    ...
    public void setVisibleHeight(int i3) {
        ...
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) this.f224261d.getLayoutParams();
        layoutParams.height = i3;
        this.f224261d.setLayoutParams(layoutParams);
    }
