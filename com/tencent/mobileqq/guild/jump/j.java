...
public class j extends ax implements IJumpParserApi.c, IJumpParserApi.d, IJumpParserApi.e {
    private final IJumpParserApi.b Q;

    public j(BaseQQAppInterface baseQQAppInterface, Context context, IJumpParserApi.b bVar) {
    ...
    public static ax F(BaseQQAppInterface baseQQAppInterface, Context context, IJumpParserApi.b bVar, String str, JumpParserResult jumpParserResult, IJumpParserApi.a aVar) {
        j jVar = new j(baseQQAppInterface, context, bVar);
        aVar.f226401a = jVar;
        aVar.f226402b = jVar;
        aVar.f226403c = jVar;
        jVar.f307438c = str;
        if (jumpParserResult != null) {
            jVar.f307439d = jumpParserResult.getServer();
            jVar.f307440e = jumpParserResult.getAction();
            jVar.s(jumpParserResult.getParamMap());
        }
        return jVar;
    }
