...
public final class MissionAdapterDelegate extends AbsListItemAdapterDelegate<Mission, Mission, h> {
    ...
    public void l(@NotNull Mission item, @NotNull h holder, @NotNull List<Object> payloads) {
        Intrinsics.checkNotNullParameter(item, "item");
    ...
    public h d(@NotNull ViewGroup parent) {
        ...
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.egp, (ViewGroup) null);
        Intrinsics.checkNotNullExpressionValue(inflate, "from(parent.context).inf\u2026begin_mission_item, null)");
