...
public final class a implements ah {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000%\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J,\u0010\n\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\b\u0010\u0007\u001a\u0004\u0018\u00010\u00062\b\u0010\b\u001a\u0004\u0018\u00010\u0006H\u0016\u00a8\u0006\u000b"}, d2 = {"com/tencent/mobileqq/guild/aiocombinestyle/imagestrategy/a$a", "Lcom/tencent/mobileqq/guild/gift/module/d;", "", "suc", "", DKConfiguration.PreloadKeys.KEY_MATERIAL_ID, "", "filePath", "apngFilePath", "", "a", "qqguild-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.guild.aiocombinestyle.imagestrategy.a$a, reason: collision with other inner class name */
    /* loaded from: classes12.dex */
    public static final class C7661a implements com.tencent.mobileqq.guild.gift.module.d {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ URLDrawable.URLDrawableOptions f213906a;

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ int f213907b;

        /* renamed from: c, reason: collision with root package name */
        final /* synthetic */ int f213908c;

        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ ag f213909d;

        C7661a(URLDrawable.URLDrawableOptions uRLDrawableOptions, int i3, int i16, ag agVar) {
            this.f213906a = uRLDrawableOptions;
            this.f213907b = i3;
            this.f213908c = i16;
            this.f213909d = agVar;
        }
        ...
        public void a(boolean suc, int materialId, @Nullable String filePath, @Nullable String apngFilePath) {
            Drawable drawable;
            if (suc && !TextUtils.isEmpty(filePath)) {
                drawable = URLDrawable.getFileDrawable(filePath, this.f213906a);
                drawable.setBounds(0, 0, this.f213907b, this.f213908c);
            } else {
            ...
            if (drawable != null) {
                this.f213909d.onLoaded(drawable);
            }
        }
    }

    public a(@Nullable Integer num, @Nullable Drawable drawable, @Nullable List<Integer> list, int i3, int i16) {
        this.materialId = num;
    ...
    */
                ...
                if (num2 != null) {
                    ...
                    if (list != null) {
                        ...
                        if (num3 != null) {
                            ...
                            GLiveChannelCore.f226698a.i().a(intValue, new C7661a(obtain, f16, e16, callback));
                        }
                    }
                    e16 = ae.e();
                    obtain.mLoadingDrawable.setBounds(0, 0, f16, e16);
    ...
    public /* synthetic */ a(Integer num, Drawable drawable, List list, int i3, int i16, int i17, DefaultConstructorMarker defaultConstructorMarker) {
