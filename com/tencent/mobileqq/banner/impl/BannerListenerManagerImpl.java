...
public class BannerListenerManagerImpl implements IBannerListenerManager {
    ...
    public BannerListenerManagerImpl() {
    ...
    public void addBannerListener(c cVar) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
            iPatchRedirector.redirect((short) 3, (Object) this, (Object) cVar);
        } else if (cVar != null && !this.bannerListenerList.contains(cVar)) {
            this.bannerListenerList.add(cVar);
        }
    }

    @Override // com.tencent.mobileqq.banner.IBannerListenerManager
    public void notifyBannerDismiss(int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    @Override // com.tencent.mobileqq.banner.IBannerListenerManager
    public void notifyBannerShow(int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    @Override // com.tencent.mobileqq.banner.IBannerListenerManager
    public void removeBannerListener(c cVar) {
        IPatchRedirector iPatchRedirector = $redirector_;
