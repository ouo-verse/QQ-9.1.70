...
/* compiled from: P */
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010%\n\u0002\u0010\u000e\n\u0002\u0010\u000b\n\u0002\b\u0006\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\r\u0010\u000eJ\u0016\u0010\u0006\u001a\u00020\u00052\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H\u0016R \u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\b\u0012\u0004\u0012\u00020\t0\u00078\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\n\u0010\u000b\u00a8\u0006\u000f"}, d2 = {"Lcom/tencent/mobileqq/weather/chat/a;", "Lcom/tencent/qqnt/chats/biz/eventprocessor/b$b;", "", "Lcom/tencent/qqnt/chats/core/bizEvent/b;", "items", "", "b", "", "", "", "a", "Ljava/util/Map;", "uinToHasReportedMap", "<init>", "()V", "qq-weather-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class a implements b.InterfaceC9565b {
    ...
    @NotNull
    private final Map<String, Boolean> uinToHasReportedMap;
    ...
    public a() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            ...
            this.uinToHasReportedMap = new LinkedHashMap();
        }
    }
    ...
    public void b(@NotNull List<com.tencent.qqnt.chats.core.bizEvent.b> items) {
        ...
        while (true) {
            if (listIterator.hasPrevious()) {
                ...
                g gVar2 = (g) obj;
                if (gVar2.n() == 103 && Intrinsics.areEqual(gVar2.k(), "u_vmmIQZ3yUOpBlO2DISdO2g")) {
                    z16 = true;
                } else {
                    z16 = false;
                }
