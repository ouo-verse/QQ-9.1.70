...
public class BasePluginActivity extends BaseActivity implements IPluginActivity, SkinnableActivityProcesser.Callback, PluginInterfaceHelper.OnPluginInterfaceLoadedListener {
    ...
    boolean mFinished;
    private ImmersiveConfig mImmerConfit;
    ...
    /* loaded from: classes16.dex */
    public static class ImmersiveConfig {
        static IPatchRedirector $redirector_;
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(7606);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 99)) {
    ...
    public BasePluginActivity() {
        ...
        this.mImmerConfit = new ImmersiveConfig();
    ...
    public View IGetContentView() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 34)) {
            return (View) iPatchRedirector.redirect((short) 34, (Object) this);
        }
    ...
    public Handler IGetInHandler() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 32)) {
            return (Handler) iPatchRedirector.redirect((short) 32, (Object) this);
        }
        return null;
    }
    ...
    public Resources IGetResource() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 59)) {
            return (Resources) iPatchRedirector.redirect((short) 59, (Object) this);
        }
    ...
    public void IInit(String str, String str2, Activity activity, ClassLoader classLoader, PackageInfo packageInfo, boolean z16, int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 57)) {
            iPatchRedirector.redirect((short) 57, this, str, str2, activity, classLoader, packageInfo, Boolean.valueOf(z16), Integer.valueOf(i3));
            return;
        }
    ...
    public void IOnActivityResult(int i3, int i16, Intent intent) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 52)) {
            iPatchRedirector.redirect((short) 52, this, Integer.valueOf(i3), Integer.valueOf(i16), intent);
        } else {
    ...
    public void IOnAttachFragment(Fragment fragment) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 55)) {
            iPatchRedirector.redirect((short) 55, (Object) this, (Object) fragment);
        } else {
    ...
    public void IOnConfigurationChanged(Configuration configuration) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 84)) {
            iPatchRedirector.redirect((short) 84, (Object) this, (Object) configuration);
        } else {
    ...
    public boolean IOnCreateOptionsMenu(Menu menu) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 73)) {
            return ((Boolean) iPatchRedirector.redirect((short) 73, (Object) this, (Object) menu)).booleanValue();
        }
    ...
    public boolean IOnKeyDown(int i3, KeyEvent keyEvent) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 28)) {
            return ((Boolean) iPatchRedirector.redirect((short) 28, (Object) this, i3, (Object) keyEvent)).booleanValue();
        }
    ...
    public boolean IOnKeyMultiple(int i3, int i16, KeyEvent keyEvent) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 30)) {
            return ((Boolean) iPatchRedirector.redirect((short) 30, this, Integer.valueOf(i3), Integer.valueOf(i16), keyEvent)).booleanValue();
        }
    ...
    public boolean IOnMenuItemSelected(int i3, MenuItem menuItem) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 83)) {
            return ((Boolean) iPatchRedirector.redirect((short) 83, (Object) this, i3, (Object) menuItem)).booleanValue();
        }
    ...
    public boolean IOnOptionsItemSelected(MenuItem menuItem) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 75)) {
            return ((Boolean) iPatchRedirector.redirect((short) 75, (Object) this, (Object) menuItem)).booleanValue();
        }
    ...
    public boolean IOnPrepareOptionsMenu(Menu menu) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 74)) {
            return ((Boolean) iPatchRedirector.redirect((short) 74, (Object) this, (Object) menu)).booleanValue();
        }
    ...
    public boolean IOnTouchEvent(MotionEvent motionEvent) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 76)) {
            return ((Boolean) iPatchRedirector.redirect((short) 76, (Object) this, (Object) motionEvent)).booleanValue();
        }
    ...
    public void ISetOutHandler(Handler handler) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 31)) {
            iPatchRedirector.redirect((short) 31, (Object) this, (Object) handler);
        }
    }
    ...
    public ImmersiveConfig IgetImmersiveConfig() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 89)) {
            return (ImmersiveConfig) iPatchRedirector.redirect((short) 89, (Object) this);
        }
    ...
    public int checkSelfPermission(String str) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 95)) {
            return ((Integer) iPatchRedirector.redirect((short) 95, (Object) this, (Object) str)).intValue();
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 77)) {
            z16 = ((Boolean) iPatchRedirector.redirect((short) 77, (Object) this, (Object) motionEvent)).booleanValue();
        } else if (!reflectHasAndIsNull(this, "mWindow", Activity.class) && !((IUnitedConfigManager) QRoute.api(IUnitedConfigManager.class)).isSwitchOn("plugin_dispatch_event", false)) {
    ...
    public View findViewById(int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 16)) {
            return (View) iPatchRedirector.redirect((short) 16, (Object) this, i3);
        }
    ...
    public Context getApplicationContext() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 49)) {
            return (Context) iPatchRedirector.redirect((short) 49, (Object) this);
        }
        if (this.mIsRunInPlugin) {
    ...
    public ApplicationInfo getApplicationInfo() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 71)) {
            return (ApplicationInfo) iPatchRedirector.redirect((short) 71, (Object) this);
        }
        if (this.mIsRunInPlugin) {
    ...
    public FragmentManager getFragmentManager() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 91)) {
            return (FragmentManager) iPatchRedirector.redirect((short) 91, (Object) this);
        }
        if (this.mIsRunInPlugin) {
    ...
    public Resources getHostResources() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 72)) {
            return (Resources) iPatchRedirector.redirect((short) 72, (Object) this);
        }
    ...
    public LayoutInflater getLayoutInflater() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 58)) {
            return (LayoutInflater) iPatchRedirector.redirect((short) 58, (Object) this);
        }
        Context context = this.mContext;
        if (context != null) {
    ...
    protected String getModuleId() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 90)) {
            return (String) iPatchRedirector.redirect((short) 90, (Object) this);
        }
    ...
    public Activity getOutActivity() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 62)) {
            return (Activity) iPatchRedirector.redirect((short) 62, (Object) this);
        }
    ...
    public PackageInfo getPackageInfo() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 70)) {
            return (PackageInfo) iPatchRedirector.redirect((short) 70, (Object) this);
        }
        if (this.mIsRunInPlugin) {
    ...
    public Object getSystemService(String str) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 63)) {
            return iPatchRedirector.redirect((short) 63, (Object) this, (Object) str);
        }
    ...
    public Window getWindow() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 66)) {
            return (Window) iPatchRedirector.redirect((short) 66, (Object) this);
        }
        if (this.mIsRunInPlugin) {
    ...
    public WindowManager getWindowManager() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 64)) {
            return (WindowManager) iPatchRedirector.redirect((short) 64, (Object) this);
        }
        if (this.mIsRunInPlugin) {
    ...
    public boolean isSamePackage2(Intent intent) {
        if (!this.mIsRunInPlugin || intent == null) {
            return false;
        }
        if (intent.hasExtra("PARAM_PLUGIN_INTERNAL_ACTIVITIES_ONLY")) {
        ...
        if (this.mOutActivity.getPackageName().equals(component.getPackageName())) {
            try {
                return BasePluginActivity.class.isAssignableFrom(Class.forName(component.getClassName(), false, this.mContext.getClassLoader()));
    ...
    public void onAttachFragment(Fragment fragment) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 92)) {
            iPatchRedirector.redirect((short) 92, (Object) this, (Object) fragment);
        } else {
    ...
    protected void onConfig(PluginConfig pluginConfig) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 39)) {
            iPatchRedirector.redirect((short) 39, (Object) this, (Object) pluginConfig);
        }
    }
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 85)) {
            iPatchRedirector.redirect((short) 85, (Object) this, (Object) configuration);
        } else {
            try {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (this.mIsRunInPlugin) {
            Activity activity = this.mOutActivity;
    ...
    public boolean onKeyDown(int i3, KeyEvent keyEvent) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 43)) {
            return ((Boolean) iPatchRedirector.redirect((short) 43, (Object) this, i3, (Object) keyEvent)).booleanValue();
        }
        if (this.mIsRunInPlugin) {
            return false;
        }
    ...
    public void onRequestPermissionsResult(int i3, @NonNull String[] strArr, @NonNull int[] iArr) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 94)) {
            iPatchRedirector.redirect((short) 94, this, Integer.valueOf(i3), strArr, iArr);
            return;
        }
    ...
    @Override // mqq.app.BaseActivity, mqq.app.IPermissionRequester
    @TargetApi(24)
    public void requestPermissions(Object obj, int i3, String... strArr) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 93)) {
            iPatchRedirector.redirect((short) 93, this, obj, Integer.valueOf(i3), strArr);
            return;
        }
        ArrayList arrayList = new ArrayList();
        ...
        if (arrayList.size() > 0) {
            ...
            if (isShadow() && (activity = this.mOutActivity) != null) {
                PermissionMonitor.requestPermissions(activity, (String[]) arrayList.toArray(new String[arrayList.size()]), i3);
                return;
            } else {
    ...
    public void setImmersiveConfig(ImmersiveConfig immersiveConfig) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 88)) {
            iPatchRedirector.redirect((short) 88, (Object) this, (Object) immersiveConfig);
        } else {
    ...
    public void setJumpDialog(Dialog dialog) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 98)) {
            iPatchRedirector.redirect((short) 98, (Object) this, (Object) dialog);
        } else {
    ...
    public void startActivityForResult(Intent intent, int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 19)) {
            iPatchRedirector.redirect((short) 19, (Object) this, (Object) intent, i3);
            return;
        }
        if (this.mIsRunInPlugin) {
            boolean z16 = false;
