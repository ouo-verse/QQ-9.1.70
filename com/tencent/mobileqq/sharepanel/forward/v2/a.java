...
import com.tencent.mobileqq.sharepanel.forward.e;
...
public final class a implements g {
    ...
    public a(@NotNull FragmentActivity activity, @NotNull ArrayList<SharePanelContactItem> targetList, @NotNull f uiControl) {
    ...
    @Override // com.tencent.mobileqq.sharepanel.forward.g
    @NotNull
    public g b(@NotNull com.tencent.mobileqq.sharepanel.forward.a eventListener) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public void show() {
        ...
        if (fragmentActivity != null && (bVar = this.launcher) != null) {
            bVar.c(fragmentActivity, this.param);
        }
    }
}
