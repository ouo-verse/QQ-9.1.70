...
@Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u000e\u001a\u00020\r\u00a2\u0006\u0004\b\u000f\u0010\u0010J\u0014\u0010\u0005\u001a\u0004\u0018\u00010\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0016J\u001a\u0010\t\u001a\u00020\b2\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006H\u0016J\b\u0010\n\u001a\u00020\bH\u0016J\b\u0010\f\u001a\u00020\u000bH\u0016\u00a8\u0006\u0011"}, d2 = {"Lcom/tencent/mobileqq/wifiphoto/banner/WifiPhotoBannerProcessor;", "Lcom/tencent/mobileqq/banner/processor/BaseBannerProcessor;", "Lcom/tencent/mobileqq/banner/a;", "banner", "Landroid/view/View;", "initBanner", "Landroid/os/Message;", "msg", "", "updateBanner", "onAccountChanged", "", "getId", "Lcom/tencent/mobileqq/app/QBaseActivity;", PM.BASE, "<init>", "(Lcom/tencent/mobileqq/app/QBaseActivity;)V", "wifiphoto_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes20.dex */
public final class WifiPhotoBannerProcessor extends BaseBannerProcessor {
    static IPatchRedirector $redirector_;

    public WifiPhotoBannerProcessor(@NotNull QBaseActivity base) {
    ...
    public static final void f(QBaseActivity activity, View v3) {
        ...
        com.tencent.mobileqq.wifiphoto.data.a.b(v3);
        f.D(f.f317624a, activity, "/wifi_photo/request_apply", 0, 0, 12, null);
    ...
    public View initBanner(@Nullable com.tencent.mobileqq.banner.a banner) {
        ...
        View view = QUINoticeBarManager.INSTANCE.a().h(baseActivity).c(new View.OnClickListener() { // from class: com.tencent.mobileqq.wifiphoto.banner.b
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                WifiPhotoBannerProcessor.f(QBaseActivity.this, view2);
            }
        }).getView();
        if (f.f317624a.F() == 2) {
            QLog.i("WifiPhotoBannerProcessor", 1, "initBanner");
            BannerManager.l().K(d.f200256i, 2);
        }
        return view;
    }
    ...
    public void onAccountChanged() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 4)) {
            ...
            BannerManager.l().K(d.f200256i, 0);
        }
    }
