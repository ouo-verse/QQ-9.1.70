...
@DebugMetadata(c = "com.tencent.mobileqq.qcoroutine.framework.coroutine.QCoroutineExecute$Companion$qWithContextExecute$2", f = "QCoroutineExecute.kt", i = {}, l = {153}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes16.dex */
public final class QCoroutineExecute$Companion$qWithContextExecute$2<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
    ...
    public QCoroutineExecute$Companion$qWithContextExecute$2(String str, Ref.ObjectRef objectRef, Ref.ObjectRef objectRef2, Function2 function2, Continuation continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> completion) {
        ...
        QCoroutineExecute$Companion$qWithContextExecute$2 qCoroutineExecute$Companion$qWithContextExecute$2 = new QCoroutineExecute$Companion$qWithContextExecute$2(this.$name, this.$runnable, this.$qJob, this.$block, completion);
        qCoroutineExecute$Companion$qWithContextExecute$2.L$0 = obj;
        return qCoroutineExecute$Companion$qWithContextExecute$2;
    }
    ...
    public final Object invoke(CoroutineScope coroutineScope, Object obj) {
        ...
        return ((QCoroutineExecute$Companion$qWithContextExecute$2) create(coroutineScope, (Continuation) obj)).invokeSuspend(Unit.INSTANCE);
    }
