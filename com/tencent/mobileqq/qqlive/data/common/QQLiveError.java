...
public final class QQLiveError {
    ...
    public static final int ANCHOR_PUSH_PULL_BROAD_CAST_ERR = 6255;
    public static final int ANCHOR_PUSH_URL_ERR = 6221;
    public static final int ANCHOR_PUSH_URL_STYLE_ERR = 6220;
    public static final int ANCHOR_SCREEN_CAPTURE_SOURCE_ERROR = 6107;
    ...
    public static final int ANCHOR_TRTC_ERROR = 6106;
    public static final int LIVE_SDK_STATUS_ERROR = 5109;
    ...
    public static final int LOGIN_REQUEST_INFO_ERR = 10000;
    public static final int NOT_ENTER_ROOM = 5106;
    public static final int PRE_ENTER_TRTC_ROOM_NOT_LOGIN_ERROR = -1;
    public static final int PRE_ENTER_TRTC_ROOM_SDK_INIT_FAILED_ERROR = -2;
    public static final int PRE_ENTER_TRTC_ROOM_SYSTEM_NOT_SUPPORT_ERROR = -3;
