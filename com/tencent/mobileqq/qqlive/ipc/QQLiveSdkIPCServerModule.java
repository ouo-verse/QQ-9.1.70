...
import com.tencent.mobileqq.qqlive.record.a;
...
public class QQLiveSdkIPCServerModule extends QIPCModule {
    ...
    public static QQLiveSdkIPCServerModule INSTANCE = null;
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(56769);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 3)) {
            redirector.redirect((short) 3);
        } else {
            INSTANCE = new QQLiveSdkIPCServerModule(IQQLiveSdkIPCServerApi.MODULE_NAME);
        }
    }
