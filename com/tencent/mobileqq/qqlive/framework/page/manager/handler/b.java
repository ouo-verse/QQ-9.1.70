...
import com.tencent.mobileqq.qqlive.framework.component.MultiMVVMComponent;
import com.tencent.mobileqq.qqlive.framework.component.SingleMVVMComponent;
...
public final class b extends c {
    ...
    public void a(@NotNull ComponentNode node, @NotNull ViewGroup rootView, @NotNull com.tencent.mobileqq.qqlive.framework.page.manager.c extInterfaceManager) {
        ...
        if (d16 instanceof SingleMVVMComponent) {
            com.tencent.mobileqq.qqlive.framework.page.manager.d.f271300a.a(extInterfaceManager, ((SingleMVVMComponent) d16).y());
        } else if (d16 instanceof MultiMVVMComponent) {
            com.tencent.mobileqq.qqlive.framework.page.manager.d.f271300a.a(extInterfaceManager, ((MultiMVVMComponent) d16).u());
        }
    }
