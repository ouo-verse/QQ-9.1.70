...
import com.tencent.mobileqq.qqlive.base.room.service.event.h;
...
/* synthetic */ class RoomConnector$initEventConnector$3 extends FunctionReferenceImpl implements Function1<h, Unit> {
    ...
    public RoomConnector$initEventConnector$3(Object obj) {
        super(1, obj, RoomConnector.class, "onPagePreload", "onPagePreload(Lcom/tencent/mobileqq/qqlive/base/room/service/event/PagePreloadEvent;)V", 0);
    ...
    public final void invoke2(@NotNull h p06) {
        ...
        ((RoomConnector) this.receiver).x(p06);
    }
}
