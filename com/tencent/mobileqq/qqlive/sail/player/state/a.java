...
public final class a implements b {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0006\u0010\u0007R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0005\u0010\u0004\u00a8\u0006\b"}, d2 = {"Lcom/tencent/mobileqq/qqlive/sail/player/state/a$a;", "", "", "STATE_NAME", "Ljava/lang/String;", "TAG", "<init>", "()V", "qq-live-sdk-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.qqlive.sail.player.state.a$a, reason: collision with other inner class name and from kotlin metadata */
    /* loaded from: classes17.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(44194);
    ...
    public a(@NotNull LiveVideoContext context) {
    ...
    public Object a(@NotNull Continuation<? super Unit> continuation) {
        ...
        companion.e("QQLive_Player|State|ErrorState", TencentLocation.RUN_MODE, "roomId=" + l16 + ", errCode=" + l3 + ", errMsg=" + str);
        this.context.t(LiveVideoContext.PlayerOperate.STOP);
    ...
    @Override // com.tencent.mobileqq.qqlive.sail.player.state.b
    @Nullable
    public Object b(@NotNull Continuation<? super b> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        ...
        if (companion.isDevelopLevel()) {
            companion.d("QQLive_Player|State|ErrorState", TencentLocation.RUN_MODE, "roomId=" + this.context.l() + ", operate=" + this.context.g());
        }
