...
public final class LiveEndNewRequest<T> extends LiveBaseRequest<T> {
    ...
    @NotNull
    public static final String TAG = "Open_Live|LiveEndNewRequest";
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/mobileqq/qqlive/sail/request/LiveEndNewRequest$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "qq-live-sdk-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.qqlive.sail.request.LiveEndNewRequest$a, reason: from kotlin metadata */
    /* loaded from: classes17.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(44324);
    ...
    public LiveEndNewRequest(@NotNull String wantAppId, long j3, @NotNull String trtcSig, @NotNull String programId) {
        super(wantAppId);
    ...
    public MessageNano getMessageNano() {
        ...
        a aVar = new a();
        aVar.f427106a = this.roomId;
        aVar.f427107b = com.tencent.mobileqq.qqlive.config.a.INSTANCE.a(getAppId()).a().e();
        aVar.f427108c = 4;
        aVar.f427109d = this.trtcSig;
        aVar.f427110e = 3;
        aVar.f427113h = 0;
        aVar.f427114i = 0;
        aVar.f427115j = 0;
        aVar.f427116k = this.programId;
        c cVar = new c();
