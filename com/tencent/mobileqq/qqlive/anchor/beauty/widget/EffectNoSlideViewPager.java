...
public class EffectNoSlideViewPager extends ViewPager {
    static IPatchRedirector $redirector_;

    public EffectNoSlideViewPager(@NonNull Context context) {
        super(context);
    ...
    public EffectNoSlideViewPager(@NonNull Context context, @Nullable AttributeSet attributeSet) {
