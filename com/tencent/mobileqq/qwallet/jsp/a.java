...
public final class a extends QWalletJsPlugin.b {
    ...
    public void a(@NotNull WebViewPlugin plugin, @Nullable JSONObject jsonData, @NotNull String[] args, @Nullable String jsCallback) {
        ...
        intent.putExtra("qw_extra_json", str);
        intent.putExtra("qw_js_callback", jsCallback);
