...
public final class QWalletAuthorize$GetAuthPhonePanelReq extends MessageMicro<QWalletAuthorize$GetAuthPhonePanelReq> {
    public static final int CHANGE_PHONE = 1;
    public static final int FIRST_OPEN = 0;
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42, 48, 58, 66}, new String[]{"appid", "mobile_gateway_tokens", "info", "msg_no", "sign", "status", "openid", QAdLoginDefine$LoginCookieKey.WX_ACCESS_TOKEN}, new Object[]{0L, null, null, "", "", 0, "", ""}, QWalletAuthorize$GetAuthPhonePanelReq.class);
