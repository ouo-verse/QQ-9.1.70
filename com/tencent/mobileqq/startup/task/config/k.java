...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0004\u0010\u0005J\b\u0010\u0003\u001a\u00020\u0002H\u0016\u00a8\u0006\u0006"}, d2 = {"Lcom/tencent/mobileqq/startup/task/config/k;", "Lcom/tencent/qqnt/startup/parse/c;", "", "readConfigFile", "<init>", "()V", "startup_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes18.dex */
public final class k implements com.tencent.qqnt.startup.parse.c {
    ...
    public String readConfigFile() {
        ...
        ColdStartupTask coldStartupTask12 = ColdStartupTask.SubKernelInitTask;
        ...
        ColdStartupTask coldStartupTask19 = ColdStartupTask.TabSdkInitTask;
        ...
        ColdStartupTask coldStartupTask22 = ColdStartupTask.UrlDrawableInitTask;
        ColdStartupTask coldStartupTask23 = ColdStartupTask.RFWInitTask;
        ColdStartupTask coldStartupTask24 = ColdStartupTask.QFSInitTask;
        ColdStartupTask coldStartupTask25 = ColdStartupTask.BrowserGlobalSettingTask;
        ColdStartupTask coldStartupTask26 = ColdStartupTask.BrowserPreloadTask;
        ColdStartupTask coldStartupTask27 = ColdStartupTask.MemoryCacheInitTask;
        ColdStartupTask coldStartupTask28 = ColdStartupTask.SkinInitTask;
        ColdStartupTask coldStartupTask29 = ColdStartupTask.BeaconSDKInitTask;
        ColdStartupTask coldStartupTask30 = ColdStartupTask.DtSdkInitTask;
        trimIndent = StringsKt__IndentKt.trimIndent("\n        \n        >> " + coldStartupStage + "\n            " + coldStartupTask + "\n            " + coldStartupTask2 + "-->" + coldStartupTask3 + "\n            " + coldStartupTask4 + "\n            " + coldStartupTask3 + "-->" + coldStartupTask5 + "\n        <<\n        >> " + coldStartupStage2 + "\n            " + coldStartupTask6 + "-->" + coldStartupTask7 + "-->" + coldStartupTask8 + "\n            " + coldStartupTask6 + "-->" + coldStartupTask9 + "\n            " + coldStartupTask6 + "-->" + coldStartupTask10 + "\n            " + coldStartupTask9 + "-->" + coldStartupTask8 + "\n            " + coldStartupTask11 + "\n            " + coldStartupTask12 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask13 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask14 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask15 + " \n            " + coldStartupTask8 + "-->" + coldStartupTask16 + "\n            " + coldStartupTask16 + "-->" + coldStartupTask17 + "-->" + coldStartupTask18 + "\n            " + coldStartupTask16 + "-->" + coldStartupTask19 + "\n            " + coldStartupTask16 + "-->" + coldStartupTask20 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask21 + "   \n            " + coldStartupTask8 + "-->" + coldStartupTask22 + " \n            " + coldStartupTask8 + "-->" + coldStartupTask23 + " \n            " + coldStartupTask8 + "-->" + coldStartupTask24 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask25 + "\n            " + coldStartupTask16 + "-->" + coldStartupTask26 + "\n            " + coldStartupTask25 + "-->" + coldStartupTask26 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask27 + "    \n            " + coldStartupTask8 + "-->" + coldStartupTask28 + "\n            " + coldStartupTask8 + "-->" + coldStartupTask29 + "-->" + coldStartupTask30 + "\n            " + coldStartupTask9 + "-->" + ColdStartupTask.CodeCheckTask + "\n            " + coldStartupTask9 + "-->" + coldStartupTask30 + "-->" + ColdStartupTask.LoadAllDtSampleConfigTask + "\n            " + coldStartupTask8 + "-->" + ColdStartupTask.MMKVMonitorTask + "\n        <<       \n    ");
        return trimIndent;
    }
}
