...
public final class AudioTransClientTransInfo$InfoHead extends MessageMicro<AudioTransClientTransInfo$InfoHead> {
    public static final int INFO_C2S_CREATE_SESSION_REQ = 1;
    public static final int INFO_C2S_CREATE_SESSION_RSP = 2;
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 40}, new String[]{"str_session_id", "str_uin", "uint32_seq", "enum_body_type", "uint32_error_no"}, new Object[]{"", "", 0, 1, 0}, AudioTransClientTransInfo$InfoHead.class);
