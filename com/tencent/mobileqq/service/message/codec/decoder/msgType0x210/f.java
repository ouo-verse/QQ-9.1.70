...
public class f implements n {
    ...
    public void c(msg_comm$MsgType0x210 msg_comm_msgtype0x210, msg_comm$Msg msg_comm_msg, List<MessageRecord> list, com.tencent.mobileqq.service.message.a aVar, MessageHandler messageHandler) {
        ...
        ((IQWalletPushApi) QRoute.api(IQWalletPushApi.class)).parseMsg0x210Sub0x66((QQAppInterface) BaseApplicationImpl.getApplication().getRuntime(), msg_comm_msgtype0x210.msg_content.get().toByteArray(), j3, i3, j16, i16);
    }
}
