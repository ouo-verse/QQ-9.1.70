...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\u0018\u0000 \t2\u00020\u0001:\u0001\tB\u0007\u00a2\u0006\u0004\b\u0007\u0010\bJ\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016J\u0011\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0096\u0002\u00a8\u0006\n"}, d2 = {"Lcom/tencent/mobileqq/qqgamepub/nt/a;", "Lcom/tencent/qqnt/chats/main/vm/usecase/click/b;", "Lcom/tencent/qqnt/chats/main/vm/usecase/click/b$a;", "params", "", "interestedIn", "invoke", "<init>", "()V", "a", "qqgamepubaccount-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class a implements com.tencent.qqnt.chats.main.vm.usecase.click.b {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/mobileqq/qqgamepub/nt/a$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "qqgamepubaccount-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.qqgamepub.nt.a$a, reason: collision with other inner class name and from kotlin metadata */
    /* loaded from: classes16.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(17922);
    ...
    public boolean interestedIn(@NotNull b.a params) {
        ...
        g gVar = (g) b16;
        if (gVar.n() != 103 || gVar.s().peerUin != Long.parseLong("2747277822")) {
            return false;
        }
        return true;
    }
    ...
    public boolean invoke(@NotNull b.a params) {
        ...
        if (b16 instanceof g) {
            try {
                ...
                QLog.e("NtGamePubClickUseCase", 1, "unreadInfo error");
                i3 = 0;
            }
            ((IQQGameHelper) QRoute.api(IQQGameHelper.class)).startQQGamePubFromRecent(params.c().getContext(), i3);
        }
        return true;
    }
