...
public class AuthorizationSupplementFragment extends QIphoneTitleBarFragment {
    static IPatchRedirector $redirector_ = null;
    private static final String TAG = "AuthorizationManageFragment";
    ...
    public AuthorizationSupplementFragment() {
    ...
    public void addBackListener(OnBackEventListener onBackEventListener) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 4)) {
            iPatchRedirector.redirect((short) 4, (Object) this, (Object) onBackEventListener);
        } else {
    ...
    public void onFinish() {
        ...
        QLog.d(TAG, 1, "onFinish");
        OnBackEventListener onBackEventListener = this.onBackEventListener;
        if (onBackEventListener != null) {
            onBackEventListener.onFinish();
            this.onBackEventListener = null;
        }
        super.onFinish();
    }
