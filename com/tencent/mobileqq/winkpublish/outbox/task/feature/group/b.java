...
public final class b extends FeatureGroup {
    ...
    public List<com.tencent.mobileqq.winkpublish.outbox.task.feature.base.a> d(TaskContext taskContext) {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new com.tencent.mobileqq.winkpublish.outbox.task.feature.base.a[]{new i(), new UploadVideoCoverFeat(0, null, 2, 0 == true ? 1 : 0)});
        return listOf;
    }

    @Override // com.tencent.mobileqq.winkpublish.outbox.task.feature.base.FeatureGroup
    public String e() {
        return "WinkPublish-upload2-UWEVideoFeatGroup";
    }
