...
public final class SquareVasPagImageView extends FrameLayout implements ISquarePagView, PAGImageView.PAGImageViewListener {
    ...
    private ISquarePagViewListener pagImageViewListener;

    @Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0000\u0018\u00002\u00020\u0001B<\u0012\b\u0010\u0013\u001a\u0004\u0018\u00010\f\u0012!\u0010\u0016\u001a\u001d\u0012\u0013\u0012\u00110\u0002\u00a2\u0006\f\b\u0014\u0012\b\b\u0015\u0012\u0004\b\b(\u0003\u0012\u0004\u0012\u00020\u00040\u0010\u0012\u0006\u0010\n\u001a\u00020\u0002\u00a2\u0006\u0004\b\u0017\u0010\u0018J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016R\u0017\u0010\n\u001a\u00020\u00028\u0006\u00a2\u0006\f\n\u0004\b\u0006\u0010\u0007\u001a\u0004\b\b\u0010\tR\u001c\u0010\u000f\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\f0\u000b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\r\u0010\u000eR&\u0010\u0012\u001a\u0014\u0012\u0010\u0012\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00040\u00100\u000b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u0011\u0010\u000e\u00a8\u0006\u0019"}, d2 = {"Lcom/tencent/mobileqq/vas/social/SquareVasPagImageView$b;", "Lcom/tencent/sqshow/zootopia/utils/PagLoader$b;", "", "result", "", "onComplete", "d", "Z", "getInitView", "()Z", "initView", "Lmqq/util/WeakReference;", "Lcom/tencent/mobileqq/vas/social/SquareVasPagImageView;", "e", "Lmqq/util/WeakReference;", "squarePagView", "Lkotlin/Function1;", "f", "bizCallback", "pagView", "Lkotlin/ParameterName;", "name", "callback", "<init>", "(Lcom/tencent/mobileqq/vas/social/SquareVasPagImageView;Lkotlin/jvm/functions/Function1;Z)V", "zplan_impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes35.dex */
    public static final class b implements PagLoader.b {
        ...
        /* renamed from: e, reason: collision with root package name and from kotlin metadata */
        private final WeakReference<SquareVasPagImageView> squarePagView;

        /* renamed from: f, reason: collision with root package name and from kotlin metadata */
        private final WeakReference<Function1<Boolean, Unit>> bizCallback;

        public b(SquareVasPagImageView squareVasPagImageView, Function1<? super Boolean, Unit> callback, boolean z16) {
            Intrinsics.checkNotNullParameter(callback, "callback");
            this.initView = z16;
            this.squarePagView = new WeakReference<>(squareVasPagImageView);
            this.bizCallback = new WeakReference<>(callback);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public static final void b(b this$0, SquareVasPagImageView squareVasPagImageView, boolean z16, Function1 function1) {
            Intrinsics.checkNotNullParameter(this$0, "this$0");
            if (this$0.initView) {
                squareVasPagImageView.l(z16, function1);
            } else {
        ...
        public void onComplete(final boolean result) {
            ...
            final SquareVasPagImageView squareVasPagImageView = this.squarePagView.get();
            QLog.d("SquareVasPagImageView", 1, "LoadComplete, " + result + ", " + (function1 != null) + ", " + (squareVasPagImageView != null));
            if (squareVasPagImageView == null || function1 == null) {
                return;
            }
            ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: com.tencent.mobileqq.vas.social.f
                @Override // java.lang.Runnable
                public final void run() {
                    SquareVasPagImageView.b.b(SquareVasPagImageView.b.this, squareVasPagImageView, result, function1);
                }
            });
        }
    }
    ...
    public SquareVasPagImageView(Context context) {
        super(context);
    ...
    private final void j(final Function1<? super Boolean, Unit> callback) {
        if (QLog.isDebugVersion()) {
            QLog.d("SquareVasPagImageView", 1, "initPagImage, loader.isLoad:" + this.loader.d());
        }
        if (this.loader.d()) {
            l(true, callback);
        } else {
            ThreadManagerV2.excute(new Runnable() { // from class: com.tencent.mobileqq.vas.social.c
                @Override // java.lang.Runnable
                public final void run() {
                    SquareVasPagImageView.k(SquareVasPagImageView.this, callback);
                }
            }, 64, null, true);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void k(SquareVasPagImageView this$0, Function1 callback) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        Intrinsics.checkNotNullParameter(callback, "$callback");
    ...
    public final void l(boolean soLoadResult, Function1<? super Boolean, Unit> callback) {
        if (QLog.isDebugVersion()) {
            QLog.d("SquareVasPagImageView", 1, "initPagImageView, result:" + soLoadResult + ", state:" + this.initState.get());
        }
        ...
        if (!(activity != null && activity.isFinishing())) {
            ...
            if (!z16) {
                try {
                    ...
                    addView(this.pagImageView, -1, -1);
                    callback.invoke(Boolean.TRUE);
                    return;
                } catch (Throwable th5) {
                    QLog.e("SquareVasPagImageView", 1, "initPagImageView err.", th5);
                    callback.invoke(Boolean.FALSE);
                    return;
                }
            }
    ...
    public final void o(final int repeatCount) {
        ...
        if (QLog.isDebugVersion()) {
            QLog.d("SquareVasPagImageView", 1, "playPagInner, state:" + i3);
        }
        if (i3 == 0 || i3 == 1) {
            return;
        }
        final WeakReference weakReference = new WeakReference(this.pagImageView);
        boolean z16 = false;
        if (QLog.isDebugVersion()) {
            QLog.d("SquareVasPagImageView", 1, "playPagInner, pagImageView is null:" + (this.pagImageView == null));
        }
        PAGImageView pAGImageView = this.pagImageView;
        if (pAGImageView != null && i3 != 3) {
            if (pAGImageView != null && pAGImageView.isPlaying()) {
                z16 = true;
            }
            if (z16) {
                QLog.d("SquareVasPagImageView", 1, "playPagReal, pagImageView is playing");
                return;
            }
            Integer num = this.pagRawId;
            if (num != null) {
                if (num != null) {
                    com.tencent.mobileqq.zootopia.utils.c.f329552a.c(num.intValue(), new SquareVasPagImageView$playPagInner$1$1(weakReference, this, repeatCount));
                    return;
                }
                return;
            } else if (this.path != null) {
                ThreadManagerV2.excute(new Runnable() { // from class: com.tencent.mobileqq.vas.social.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        SquareVasPagImageView.p(SquareVasPagImageView.this, weakReference, repeatCount);
                    }
                }, 64, null, true);
                return;
            } else {
                n(this.pagImageView, repeatCount);
                return;
            }
        }
        ISquarePagViewListener iSquarePagViewListener = this.pagImageViewListener;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void p(final SquareVasPagImageView this$0, final WeakReference weakPagView, final int i3) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: com.tencent.mobileqq.vas.social.e
            @Override // java.lang.Runnable
            public final void run() {
                SquareVasPagImageView.q(WeakReference.this, Load, this$0, i3);
            }
        });
    }
    ...
    public static final void q(WeakReference weakPagView, PAGFile pAGFile, SquareVasPagImageView this$0, int i3) {
        Intrinsics.checkNotNullParameter(weakPagView, "$weakPagView");
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public String getTextLayer(int layerIndex) {
        PAGImageView pAGImageView = this.pagImageView;
        PAGComposition composition = pAGImageView != null ? pAGImageView.getComposition() : null;
    ...
    public void playPag(final int repeatCount) {
        if (QLog.isDebugVersion()) {
            QLog.d("SquareVasPagImageView", 1, "playPag, repeatCount:" + repeatCount);
        }
        if (this.initState.compareAndSet(0, 1)) {
            Function1<Boolean, Unit> function1 = new Function1<Boolean, Unit>() { // from class: com.tencent.mobileqq.vas.social.SquareVasPagImageView$playPag$innerCallback$1
                ...
                public final void invoke(boolean z16) {
                    SquareVasPagImageView.this.o(repeatCount);
                }
    ...
    public void setLayerVisible(Integer[] layers, boolean visible) {
        ...
        PAGLayer composition = pAGImageView != null ? pAGImageView.getComposition() : null;
    ...
    public void setPagViewListener(ISquarePagViewListener listener) {
        this.pagImageViewListener = listener;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final void n(PAGImageView pagView, int repeatCount) {
        if (pagView == null) {
            return;
        }
        ...
        if (!pagView.isPlaying()) {
            QLog.d("SquareVasPagImageView", 1, "playPagReal, doPlay");
            pagView.play();
        } else {
            QLog.d("SquareVasPagImageView", 1, "playPagReal, unexpected playing");
        }
    }
