...
public final class VipFontUpdate$TFontSsoRsp extends MessageMicro<VipFontUpdate$TFontSsoRsp> {
    ...
    public VipFontUpdate$TFontFreshRsp st_fresh_rsp = new MessageMicro<VipFontUpdate$TFontFreshRsp>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TFontFreshRsp
    ...
    public VipFontUpdate$TFontMd5CheckRsp st_md5_check_rsp = new MessageMicro<VipFontUpdate$TFontMd5CheckRsp>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TFontMd5CheckRsp
    ...
    public VipFontUpdate$TPosterRsp st_poster_rsp = new MessageMicro<VipFontUpdate$TPosterRsp>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TPosterRsp
    ...
    public VipFontUpdate$TCheckRsp st_check_rsp = new MessageMicro<VipFontUpdate$TCheckRsp>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TCheckRsp
    ...
    public VipFontUpdate$TGetPosterFontRsp st_getposterfont_rsp = new MessageMicro<VipFontUpdate$TGetPosterFontRsp>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TGetPosterFontRsp
        ...
        public VipFontUpdate$TPosterFontRedPoint st_redpoint = new MessageMicro<VipFontUpdate$TPosterFontRedPoint>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TPosterFontRedPoint
    ...
    public VipFontUpdate$TSetPosterFontRsp st_setposterfont_rsp = new MessageMicro<VipFontUpdate$TSetPosterFontRsp>() { // from class: com.tencent.mobileqq.vas.font.diy.data.VipFontUpdate$TSetPosterFontRsp
