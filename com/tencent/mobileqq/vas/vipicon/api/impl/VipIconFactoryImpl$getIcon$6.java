...
final class VipIconFactoryImpl$getIcon$6 extends Lambda implements Function1<VipIcon, String[]> {
    final /* synthetic */ IVasRecentData.FriendsVipData $data;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public VipIconFactoryImpl$getIcon$6(IVasRecentData.FriendsVipData friendsVipData) {
        super(1);
    ...
    public final String[] invoke(@NotNull final VipIcon it) {
        ...
        final Function0<String[]> function0 = new Function0<String[]>() { // from class: com.tencent.mobileqq.vas.vipicon.api.impl.VipIconFactoryImpl$getIcon$6$getUrls$1
            /* JADX INFO: Access modifiers changed from: package-private */
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            ...
            public final String[] invoke() {
                return new String[]{com.tencent.mobileqq.vas.vipicon.g.this.h(friendsVipData.getNamePlateId(), friendsVipData.getVipType(), friendsVipData.getVipLevel(), false)};
            }
        };
        if (!gVar.isFileExists(this.$data.getNamePlateId())) {
            gVar.addDownLoadListener(this.$data.getNamePlateId(), new Runnable() { // from class: com.tencent.mobileqq.vas.vipicon.api.impl.g
                @Override // java.lang.Runnable
                public final void run() {
                    VipIconFactoryImpl$getIcon$6.b(VipIcon.this, function0);
                }
            });
            gVar.startDownload(this.$data.getNamePlateId());
        }
