...
public final class d extends ax {
    ...
    public boolean b() {
        if (h().equals("vasnewcustomer") && this.f307440e.equals("open")) {
            ...
            iVasPayRenewalPage.openNewCustomerPage(context, source);
            return true;
        }
        return false;
    }
