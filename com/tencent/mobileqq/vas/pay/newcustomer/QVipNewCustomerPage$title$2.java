...
final class QVipNewCustomerPage$title$2 extends Lambda implements Function0<QVipRenewalTitle> {
    final /* synthetic */ QVipNewCustomerPage this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QVipNewCustomerPage$title$2(QVipNewCustomerPage qVipNewCustomerPage) {
        super(0);
    ...
    public final QVipRenewalTitle invoke() {
        ...
        qVipRenewalTitle.setTitle("");
        qVipRenewalTitle.setLeftOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.vas.pay.newcustomer.z
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                QVipNewCustomerPage$title$2.b(QVipNewCustomerPage.this, view);
            }
        });
