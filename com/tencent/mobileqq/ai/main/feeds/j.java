...
public final class j extends RFWAbsLoadMoreAdapter {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\b\u0018\u00002\u00020\u0001B\u000f\u0012\u0006\u0010\u0007\u001a\u00020\u0002\u00a2\u0006\u0004\b\b\u0010\tR\u0017\u0010\u0007\u001a\u00020\u00028\u0006\u00a2\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006\u00a8\u0006\n"}, d2 = {"Lcom/tencent/mobileqq/ai/main/feeds/j$a;", "Landroidx/recyclerview/widget/RecyclerView$ViewHolder;", "Landroid/widget/TextView;", "E", "Landroid/widget/TextView;", "l", "()Landroid/widget/TextView;", "tv", "<init>", "(Landroid/widget/TextView;)V", "vas-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes10.dex */
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        ...
        textView.setText(textView.getContext().getString(R.string.swr));
    ...
    public void onLoadMoreEnd(boolean hasMore) {
        ...
        if (aVar != null && (l3 = aVar.l()) != null) {
            if (hasMore) {
                ...
                l3.setText(context.getString(R.string.swr));
                return;
            }
            l3.getLayoutParams().height = ViewUtils.dpToPx(0.0f);
            l3.setVisibility(8);
        }
    }
