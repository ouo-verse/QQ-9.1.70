...
public final class AIAvatarPendantFragment extends QBaseFragment {
    ...
    public List<Part> assembleParts() {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 3)) {
            mutableListOf = CollectionsKt__CollectionsKt.mutableListOf(new AIAvatarKuiklyPagePart(4));
