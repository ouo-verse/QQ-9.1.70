...
public class c implements d {
    ...
    public h[] getLifeCycleHelper() {
        ...
        plus = ArraysKt___ArraysJvmKt.plus((Object[]) new h[]{new b(), ((IAssistedChatApi) QRoute.api(IAssistedChatApi.class)).getAssistedChatHelper(), ((IPrologueApi) QRoute.api(IPrologueApi.class)).getPrologueHelper(), new DynamicPicHelper(), new ae(), new t(), new MsgReadedHelper(), new aw(), new f(), new MultiForwardHelper(), new ad(), new MsgRelevantHelper(), new ax(), new at(), new bc(), new AIOChatBackgroundHelper(), new o(), new au(), new StickerRecHelper(), new n(), new AIOUnreadBubbleHelper()}, (Object[]) ((IAIONotificationApi) QRoute.api(IAIONotificationApi.class)).getAIONotificationHelperArray());
        return (h[]) plus;
    }
