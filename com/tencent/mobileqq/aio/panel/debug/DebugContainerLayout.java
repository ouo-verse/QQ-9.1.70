...
public final class DebugContainerLayout extends FrameLayout {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public DebugContainerLayout(@NotNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    public /* synthetic */ DebugContainerLayout(Context context, AttributeSet attributeSet, int i3, int i16, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    @JvmOverloads
    public DebugContainerLayout(@NotNull Context context, @Nullable AttributeSet attributeSet, int i3) {
