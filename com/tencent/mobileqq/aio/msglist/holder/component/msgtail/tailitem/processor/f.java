...
import com.tencent.mobileqq.aio.msglist.holder.component.msgtail.tailitem.ui.j;
...
public final class f extends a {
    ...
    public com.tencent.mobileqq.aio.msglist.holder.component.msgtail.tailitem.ui.c a(@NotNull Context context, @NotNull AIOEmoReplyAdapter aioEmoReplyAdapter, @Nullable com.tencent.mobileqq.aio.msglist.holder.component.c parentVB) {
        ...
        return new j(j.INSTANCE.a(context), aioEmoReplyAdapter);
    }
    ...
    public com.tencent.mobileqq.aio.msglist.holder.component.msgtail.data.g b(@NotNull AIOMsgItem aioMsgItem, @NotNull MsgRecord msgRecord) {
        ...
        return new com.tencent.mobileqq.aio.msglist.holder.component.msgtail.data.h(msgRecord);
    }
    ...
    public int e(@NotNull AIOMsgItem msgItem, @NotNull List<Object> payloads) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (((HashMap) it.next()).get(AIOMsgItemPayloadType.QQ_STRANGER_TAIL_PAYLOAD) != null) {
                    z16 = true;
                } else {
                    z16 = false;
                }
    ...
    public boolean f(@NotNull AIOMsgItem msgItem) {
        ...
        Intrinsics.checkNotNullParameter(msgItem, "msgItem");
        if (!msgItem.isSelf() || msgItem.getMsgRecord().chatType != 104 || (l3 = MsgExtKt.l(msgItem.getMsgRecord())) == null || l3.rspCode != 46 || l3.rspErrType != 77 || (transSvrInfo = l3.transSvrInfo) == null || transSvrInfo.subType != 0 || transSvrInfo.retCode != 1001) {
            return false;
        }
        return true;
    }
