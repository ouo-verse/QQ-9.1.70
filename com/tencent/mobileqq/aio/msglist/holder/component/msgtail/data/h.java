...
public final /* data */ class h implements g {
    ...
    public h(@NotNull MsgRecord msg2) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if ((other instanceof h) && Intrinsics.areEqual(this.msg, ((h) other).msg)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "QQStrangerTailItem(msg=" + this.msg + ")";
    }
}
