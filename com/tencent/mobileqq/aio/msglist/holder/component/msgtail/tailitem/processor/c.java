...
public final class c extends a {
    ...
    public com.tencent.mobileqq.aio.msglist.holder.component.msgtail.tailitem.ui.c a(@NotNull Context context, @NotNull AIOEmoReplyAdapter aioEmoReplyAdapter, @Nullable com.tencent.mobileqq.aio.msglist.holder.component.c parentVB) {
        ...
        return new com.tencent.mobileqq.aio.msglist.holder.component.msgtail.tailitem.ui.e(com.tencent.mobileqq.aio.msglist.holder.component.msgtail.tailitem.ui.e.INSTANCE.a(context), aioEmoReplyAdapter, parentVB);
    }
    ...
    public com.tencent.mobileqq.aio.msglist.holder.component.msgtail.data.g b(@NotNull AIOMsgItem aioMsgItem, @NotNull MsgRecord msgRecord) {
        ...
        return new com.tencent.mobileqq.aio.msglist.holder.component.msgtail.data.d(msgRecord, aioMsgItem);
    }
    ...
    public int e(@NotNull AIOMsgItem msgItem, @NotNull List<Object> payloads) {
        ...
        if (!arrayList.isEmpty()) {
            ...
            while (true) {
                ...
                if (((HashMap) it.next()).get(AIOMsgItemPayloadType.ESSENCE_TAIL_PAYLOAD) != null) {
                    z16 = true;
                } else {
                    z16 = false;
                }
    ...
    public boolean f(@NotNull AIOMsgItem msgItem) {
        ...
        Intrinsics.checkNotNullParameter(msgItem, "msgItem");
        com.tencent.qqnt.aio.essence.a A = msgItem.A();
        if (A == null || !A.b()) {
            return false;
        }
        return true;
