...
public final /* data */ class k implements g {
    ...
    public k(@NotNull MsgRecord msg2) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if ((other instanceof k) && Intrinsics.areEqual(this.msg, ((k) other).msg)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "TroopFileTailItem(msg=" + this.msg + ")";
    }
}
