...
public final /* data */ class f implements g {
    ...
    public f(@NotNull MsgRecord msg2) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if ((other instanceof f) && Intrinsics.areEqual(this.msg, ((f) other).msg)) {
            return true;
        }
        return false;
    }
    ...
    public String toString() {
        ...
        return "GameShareTailItem(msg=" + this.msg + ")";
    }
}
