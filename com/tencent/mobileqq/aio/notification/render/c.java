...
public final class c implements d {
    ...
    @NotNull
    public static final c f193008a;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(54833);
    ...
    public void a(@NotNull IAIONotificationUIModel uiModel, @NotNull ViewBinding viewBinding, boolean isExpandDialogState, boolean isMultiFoldMode) {
        ...
        IAIONotificationUIModel.c cVar = (IAIONotificationUIModel.c) uiModel;
        AIONotificationUIUtils aIONotificationUIUtils = AIONotificationUIUtils.f192828a;
        ImageView imageView = iVar.f425755g;
        Intrinsics.checkNotNullExpressionValue(imageView, "view.aioNotificationIcon");
        aIONotificationUIUtils.S(imageView, uiModel.b());
        iVar.f425757i.setText(cVar.g());
        if (cVar.h() != 0) {
            TextView textView = iVar.f425757i;
            Intrinsics.checkNotNullExpressionValue(context, "context");
            textView.setTextColor(aIONotificationUIUtils.E(context, cVar.h()));
        }
        iVar.f425754f.setText(cVar.f());
        iVar.f425754f.setTextColor(iVar.getRoot().getContext().getColorStateList(R.color.qui_common_text_primary));
        ImageView imageView2 = iVar.f425750b;
        Intrinsics.checkNotNullExpressionValue(imageView2, "view.aioNotificationAction");
        aIONotificationUIUtils.N(imageView2, cVar.c(), cVar, isExpandDialogState, isMultiFoldMode);
        TextView textView2 = iVar.f425752d;
        Intrinsics.checkNotNullExpressionValue(textView2, "view.aioNotificationActionText");
        String d16 = cVar.d();
        int e16 = cVar.e();
        ...
        aIONotificationUIUtils.T(textView2, d16, e16, cVar, z16);
    }
    ...
    public ViewBinding b(@NotNull ViewGroup container) {
        ...
        i g16 = i.g(LayoutInflater.from(container.getContext()), container, false);
        Intrinsics.checkNotNullExpressionValue(g16, "inflate(\n            Lay\u2026ontainer, false\n        )");
        Context context = container.getContext();
        ViewUtils viewUtils = ViewUtils.f352270a;
        g16.f425753e.addView(new BoxShadow(context, viewUtils.a(9.0f), viewUtils.a(8.0f), Color.argb(7, 0, 0, 0)));
        return g16;
    }
