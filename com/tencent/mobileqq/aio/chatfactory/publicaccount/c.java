...
import com.tencent.qqnt.aio.helper.provider.g;
import com.tencent.qqnt.aio.helper.provider.j;
...
public final class c {
    ...
    @NotNull
    public static final c f188251a;

    /* renamed from: b, reason: collision with root package name and from kotlin metadata */
    @QAutoInjectJustClazz(configPath = "AutoInjectYml/Business/AIO/aio/Inject_publicaccount_vb_provider.yml", version = 1)
    @Nullable
    private static ArrayList<Class<com.tencent.aio.base.mvvm.a<?, ?>>> injectInputChildVBList;

    /* renamed from: c, reason: collision with root package name and from kotlin metadata */
    @QAutoInjectJustClazz(configPath = "AutoInjectYml/Business/AIO/helper/Inject_PublicAccountAIO_Outer_Helper_Provider.yml", version = 1)
    @NotNull
    private static final ArrayList<Class<? extends d>> outerHelperProvider;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(45453);
        ...
        arrayList.add(PublicAccountInputContainerVB.class);
        injectInputChildVBList.add(ll2.b.class);
