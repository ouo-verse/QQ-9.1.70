...
public final class b implements d {
    ...
    public h[] getLifeCycleHelper() {
        ...
        plus = ArraysKt___ArraysJvmKt.plus((Object[]) new h[]{new DynamicPicHelper(), new ae(), new t(), new ad(), new MsgReadedHelper(), new aw(), new f(), new ax(), new com.tencent.mobileqq.aio.helper.provider.b(), new at(), new MultiForwardHelper(), new AIOChatBackgroundHelper(), new MsgRelevantHelper(), new n(), new AIOUnreadBubbleHelper()}, (Object[]) ((IAIONotificationApi) QRoute.api(IAIONotificationApi.class)).getAIONotificationHelperArray());
        plus2 = ArraysKt___ArraysJvmKt.plus(plus, (Collection) c.f188251a.b());
        return (h[]) plus2;
    }
