...
final class CommunicationShareBarVB$mTouchBar$2 extends Lambda implements Function0<SelectTouchBarView> {
    static IPatchRedirector $redirector_;
    final /* synthetic */ CommunicationShareBarVB this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public CommunicationShareBarVB$mTouchBar$2(CommunicationShareBarVB communicationShareBarVB) {
        super(0);
    ...
    public static final void b(CommunicationShareBarVB this$0, View view) {
        ...
        this$0.sendIntent(new a.b(this$0.N()));
    ...
    public final SelectTouchBarView invoke() {
        ...
        selectTouchBarView.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.aio.input.communicationshare.c
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                CommunicationShareBarVB$mTouchBar$2.b(CommunicationShareBarVB.this, view);
            }
        });
