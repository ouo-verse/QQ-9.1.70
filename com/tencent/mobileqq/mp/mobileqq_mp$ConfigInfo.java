...
public final class mobileqq_mp$ConfigInfo extends MessageMicro<mobileqq_mp$ConfigInfo> {
    ...
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 42, 48, 56, 64, 74, 80}, new String[]{"type", "title", "content", "event_id", "url", StartupReportKey.AUTH_TYPE, "state", "confirm_flag", "confirm_tips", "state_id"}, new Object[]{1, "", "", 1, "", 0, 0, 0, "", 1}, mobileqq_mp$ConfigInfo.class);
