...
public class NightMaskConfProcessor extends l<a> {
    static IPatchRedirector $redirector_;

    public NightMaskConfProcessor() {
    ...
    public static a a() {
        ...
        try {
            ...
            QLog.e("NightMaskConfProcessor", 1, th5, new Object[0]);
            aVar = null;
        }
        if (aVar == null) {
            return new a();
    ...
    public a onParsed(ai[] aiVarArr) throws QStorageInstantiateException {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("NightMaskConfProcessor", 2, "onParsed:" + aVar);
        }
        return aVar;
    }
    ...
    public int migrateOldVersion() {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("NightMaskConfProcessor", 2, "migrateOldVersion");
            return 0;
        }
        return 0;
    }
    ...
    public void onReqFailed(int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 6)) {
            ...
            QLog.d("NightMaskConfProcessor", 2, "onReqFailed ", Integer.valueOf(i3));
        }
    }
