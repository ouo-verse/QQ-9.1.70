...
public final class w extends qh3.c {
    ...
    public w(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        hc4.a.f404730a.e(this.context, this.source, this.bundle);
    }
