...
public final class i extends qh3.c {
    ...
    public i(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        ob4.a.f422373a.a(this.context, this.source, this.bundle);
    }
