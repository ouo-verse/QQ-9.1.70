...
public final class u extends qh3.c {
    ...
    public u(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        TaskHalfScreenPanelFragment.INSTANCE.a(this.context, this.source, this.bundle);
    }
