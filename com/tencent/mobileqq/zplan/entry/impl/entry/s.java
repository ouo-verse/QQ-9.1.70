...
public final class s extends qh3.a {
    ...
    public s(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        ZootopiaActivity.Companion.c(ZootopiaActivity.INSTANCE, this.context, SimpleAvatarFragment.class, this.source, this.bundle, false, 16, null);
    }
