...
public final class o extends qh3.c {
    ...
    public o(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        ZootopiaActivity.Companion.c(ZootopiaActivity.INSTANCE, this.context, ZootopiaDetailFragmentV2.class, this.source, this.bundle, false, 16, null);
    }
