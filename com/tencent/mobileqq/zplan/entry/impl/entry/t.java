...
public final class t extends qh3.c {
    ...
    public t(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        Intent a16 = ZootopiaActivity.INSTANCE.a(this.context, ZootopiaActivity.class, SuitCustomColorFragment.class, this.source, this.bundle);
        a16.setFlags(65536);
