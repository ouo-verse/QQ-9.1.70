...
public final class k extends qh3.c {
    ...
    public k(Context context, ZootopiaSource source, Bundle bundle) {
    ...
    @Override // qh3.b
    public void c() {
        ZPlanDressDetailFragment.INSTANCE.a(this.context, this.source, this.bundle);
    }
