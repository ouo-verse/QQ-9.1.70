...
@DebugMetadata(c = "com.tencent.mobileqq.zplan.aigc.render.ZplanFilamentAIGCEditorManager$prepareResource$2", f = "ZplanFilamentAIGCEditorManager.kt", i = {}, l = {PlayerResources.ViewId.TITLE_BAR}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes35.dex */
public final class ZplanFilamentAIGCEditorManager$prepareResource$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public ZplanFilamentAIGCEditorManager$prepareResource$2(ZplanFilamentAIGCEditorManager zplanFilamentAIGCEditorManager, g gVar, Continuation<? super ZplanFilamentAIGCEditorManager$prepareResource$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ZplanFilamentAIGCEditorManager$prepareResource$2(this.this$0, this.$listener, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        GYFZPlanController gYFZPlanController = this.this$0.offScreenController;
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((ZplanFilamentAIGCEditorManager$prepareResource$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
