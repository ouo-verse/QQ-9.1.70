...
final class PayUtil$showPayDialog$1 extends Lambda implements Function0<Unit> {
    ...
    public PayUtil$showPayDialog$1(Context context, int i3, int i16, Function1<? super Boolean, Unit> function1) {
        super(0);
    ...
    public final void invoke2() {
        ...
        createCustomDialog.setNegativeButton(string, new DialogInterface.OnClickListener() { // from class: com.tencent.mobileqq.zplan.utils.p
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
                PayUtil$showPayDialog$1.c(Function1.this, dialogInterface, i3);
            }
        });
        ...
        createCustomDialog.setPositiveButton(string2, color, new DialogInterface.OnClickListener() { // from class: com.tencent.mobileqq.zplan.utils.q
            @Override // android.content.DialogInterface.OnClickListener
            public final void onClick(DialogInterface dialogInterface, int i3) {
                PayUtil$showPayDialog$1.d(Function1.this, dialogInterface, i3);
            }
        });
