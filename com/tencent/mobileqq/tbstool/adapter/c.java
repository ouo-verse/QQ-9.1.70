...
public final class c implements b {
    ...
    public void a(boolean add) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
            ...
            TBSToolLocalTbsViewManager.l().A(add);
        }
    }
    ...
    public void b(@NotNull Activity activity, int actionType) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 7)) {
            ...
            TBSToolLocalTbsViewManager.l().i(activity, actionType);
        }
    }
    ...
    public boolean c(@Nullable Activity activity) {
        ...
        return TBSToolLocalTbsViewManager.l().v(activity);
    }
    ...
    public void d(@Nullable Activity activity) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 9)) {
            ...
            TBSToolLocalTbsViewManager.l().C(activity);
        }
    }
    ...
    public void e(@NotNull Activity activity) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 8)) {
            ...
            Intrinsics.checkNotNullParameter(activity, "activity");
            TBSToolLocalTbsViewManager.l().x(activity);
        }
    }
    ...
    public TbsReaderView f(@Nullable Activity activity, @Nullable String strPath, long sessionId, @Nullable LocalTbsViewManager.e callBack) {
        ...
        return TBSToolLocalTbsViewManager.l().y(activity, strPath, sessionId, callBack);
    }
    ...
    public boolean g() {
        ...
        return TBSToolLocalTbsViewManager.l().p();
    }
    ...
    public void h(@Nullable Activity activity, long sessionId) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 13)) {
            ...
            TBSToolLocalTbsViewManager.l().h(activity, sessionId);
        }
    }
    ...
    public void i(@Nullable Activity activity, @Nullable String strPath, @Nullable LocalTbsViewManager.e callBack, boolean local) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 12)) {
            ...
            TBSToolLocalTbsViewManager.l().g(activity, strPath, callBack, local);
        }
    }
    ...
    public void onDestroy(@NotNull Activity activity) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 6)) {
            ...
            Intrinsics.checkNotNullParameter(activity, "activity");
            TBSToolLocalTbsViewManager.l().w(activity);
        }
    }
}
