...
import com.tencent.mobileqq.profilecard.bussiness.accountinfo.ElegantProfileAccountInfoV2Component;
import com.tencent.mobileqq.profilecard.bussiness.accountinfo.ProfileAccountInfoHeaderComponent;
import com.tencent.mobileqq.profilecard.bussiness.anonymous.ElegantProfileAnonymousComponent;
...
public class ElegantProfileComponentCollector implements IProfileComponentCollector, IProfileComponentConst {
    static IPatchRedirector $redirector_;

    public ElegantProfileComponentCollector() {
    ...
    public SparseArray<Class<? extends AbsProfileComponent>> collect() {
        ...
        sparseArray.put(1026, ElegantProfileAnonymousComponent.class);
        sparseArray.put(1039, ProfileEmptyAnonymousComponent.class);
        sparseArray.put(1023, ElegantProfileAccountInfoV2Component.class);
