...
public class FriendProfileCardFragment extends QPublicBaseFragment implements XListView.MotionEventInterceptor, TopGestureLayout.OnGestureListener, f, d {
    ...
    private static final String TAG = "FriendProfileCardFragment";
    ...
    private Bundle profileIntent;
    private Bundle savedInstanceState;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(33794);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 27)) {
            redirector.redirect((short) 27);
        } else {
            HANDLE_REQUEST_PROFILE_CARD_TYPE = new int[]{0, 60, 1, 78, 40, 41, 42, 73, 86, 36, 30, 32, 31, 50, 51, 34, 53, 29, 45, 46, 47, 20, 21, 58, 22, 3, 2, 74, 35, 37, 75, 61, 70, 25, 27, 28, 108, 26, 95, 4, 77, 52, 19, 23, 24, 120, 104, 111, 105, 106, 97, 98, 55, 56, 57, 72, 71, 82, 81, 83, 84, 101, 103, 102, 107, 110, 96, 112, 113, 115, 117};
        }
    }

    public FriendProfileCardFragment() {
        ...
        this.mAvatarObserver = new com.tencent.mobileqq.avatar.observer.a() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.1
            static IPatchRedirector $redirector_;

            {
                IPatchRedirector iPatchRedirector2 = $redirector_;
                if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 1)) {
                    iPatchRedirector2.redirect((short) 1, (Object) this, (Object) FriendProfileCardFragment.this);
                }
            }
            ...
            public void onUpdateCustomHead(boolean z16, String str) {
                ...
                if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 2)) {
                    ...
                    ((IProfileEditApi) QRoute.api(IProfileEditApi.class)).downloadHDAvatar(FriendProfileCardFragment.this.mApp.getCurrentAccountUin(), FriendProfileCardFragment.this.mApp);
                }
            }
        };
        this.onScrollListener = new AbsListView.OnScrollListener() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.2
            static IPatchRedirector $redirector_;
            ...
            public void onScroll(AbsListView absListView, int i3, int i16, int i17) {
                ...
                } else if (FriendProfileCardFragment.this.mProfileScrollListeners != null) {
                    Iterator it = FriendProfileCardFragment.this.mProfileScrollListeners.iterator();
                    while (it.hasNext()) {
            ...
            public void onScrollStateChanged(AbsListView absListView, int i3) {
                ...
                if (FriendProfileCardFragment.this.mProfileScrollListeners != null) {
                    Iterator it = FriendProfileCardFragment.this.mProfileScrollListeners.iterator();
                    while (it.hasNext()) {
        ...
        this.profileCardObserver = new ProfileCardObserver() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.3
            static IPatchRedirector $redirector_;
            ...
            protected void onGetProfileCard(boolean z16, Object obj) {
                IPatchRedirector iPatchRedirector2 = $redirector_;
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 2)) {
                    FriendProfileCardFragment.this.handleGetProfileCard(z16, obj);
                } else {
            ...
            protected void onSetCardTemplateReturn(boolean z16, Object obj) {
                IPatchRedirector iPatchRedirector2 = $redirector_;
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 3)) {
                    FriendProfileCardFragment.this.handleSetCardTemplateReturn(z16, obj);
                } else {
                    iPatchRedirector2.redirect((short) 3, this, Boolean.valueOf(z16), obj);
                }
            }
        };
        this.mSubCallback = new Handler.Callback() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.4
            static IPatchRedirector $redirector_;
            ...
            public boolean handleMessage(Message message) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.d(FriendProfileCardFragment.TAG, 2, String.format("handleMessage Sub msg=%s", message));
                }
                int i3 = message.what;
                if (i3 == 1) {
                    FriendProfileCardFragment.this.initProfileCard((String) message.obj);
                } else if (i3 == 2) {
                    FriendProfileCardFragment.this.initContactCard();
                } else if (i3 == 3) {
                    Object obj = message.obj;
                    if (obj instanceof Card) {
                        card = (Card) obj;
                    } else {
                        card = FriendProfileCardFragment.this.mProfileCardInfo.card;
                    }
                    if (message.arg1 == 1) {
                        z16 = true;
                    }
                    FriendProfileCardFragment.this.onCardUpdate(card, true, 3, z16);
                }
                return true;
            }
        };
        this.mUICallback = new Handler.Callback() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.5
            static IPatchRedirector $redirector_;
            ...
            public boolean handleMessage(Message message) {
                ...
                boolean z16 = false;
                if (QLog.isColorLevel()) {
                    QLog.d(FriendProfileCardFragment.TAG, 2, String.format("handleMessage UI msg=%s", message));
                }
                String str = null;
                FriendProfileCardFragment.this.mFgContainerView.setBackground(null);
                FriendProfileCardFragment.this.updateLoadingPage(false);
                switch (message.what) {
                    case 100:
                        Object obj = message.obj;
                        if (obj instanceof Card) {
                        ...
                        if (str != null && str.length() > 0) {
                            FriendProfileCardFragment.this.switchedToFriend(card, str);
                            break;
                        }
                        break;
                    case 101:
                        ...
                        FriendProfileCardFragment.this.updateContactCardInfo((ProfileCardInfo) message.obj, z16);
                        break;
                    case 102:
                        if (message.arg1 == 1) {
                            z16 = true;
                        ...
                        if (obj2 instanceof Card) {
                            ...
                            FriendProfileCardFragment.this.mProfileCardInfo.card = card3;
                            FriendProfileCardFragment.this.updateCardInfo(card3, z16);
                            break;
                        }
                        break;
                    case 103:
                        if (FriendProfileCardFragment.this.mProfileCardInfo.card != null) {
                            FriendProfileCardFragment.this.mProfileCardInfo.isTimeOut = true;
                            FriendProfileCardFragment.this.mProfileCardInfo.card.lCurrentStyleId = ProfileCardTemplate.DEFAULT_PROFILE_CARD_STYLE_ID;
                            FriendProfileCardFragment.this.mProfileCardInfo.card.templateRet = 0;
                            FriendProfileCardFragment.this.mProfileCardInfo.currentTemplate = null;
                            FriendProfileCardFragment friendProfileCardFragment = FriendProfileCardFragment.this;
                            friendProfileCardFragment.updateCardInfo(friendProfileCardFragment.mProfileCardInfo.card, false);
                            break;
                        }
                        break;
                }
        ...
        this.mProfileDelegate = new IProfileActivityDelegate() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.9
            static IPatchRedirector $redirector_;
            ...
            public void addProfileScrollListener(AbsListView.OnScrollListener onScrollListener) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 10)) {
                    FriendProfileCardFragment.this.addProfileScrollListener(onScrollListener);
                } else {
            ...
            public void checkAndSwitch2Friend(boolean z16, boolean z17, String str) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 14)) {
                    FriendProfileCardFragment.this.checkAndSwitch2Friend(z16, z17, str);
                } else {
            ...
            public boolean getIsShowZplanCover() {
                ...
                if (!isShowVasCustomBgCover() && FriendProfileCardFragment.this.mIsShowZplanCover) {
                    return true;
                }
                return false;
            }
            ...
            public PullToZoomHeaderListView getListView() {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 4)) {
                    return FriendProfileCardFragment.this.mProfileListView;
                }
            ...
            public IProfileConfig getProfileConfig() {
                IPatchRedirector iPatchRedirector2 = $redirector_;
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 2)) {
                    return FriendProfileCardFragment.this.mConfigHelper;
                }
            ...
            public ViewGroup getRootView() {
                ...
                return (ViewGroup) FriendProfileCardFragment.this.mRootView;
            }
            ...
            public IZPlanChangeTitleStatusListener getZPlanChangeTitleStatusListener() {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 23)) {
                    return FriendProfileCardFragment.this.mZPlanCheckTitleStatusListener;
                }
            ...
            public boolean isShowQCircleCover() {
                ...
                if (!isShowVasCustomBgCover() && FriendProfileCardFragment.this.mIsShowQCircleCover) {
                    return true;
                }
                return false;
            }
            ...
            public boolean isShowVasCustomBgCover() {
                ...
                return ((IProfileCardFeatureApi) QRoute.api(IProfileCardFeatureApi.class)).isVasCustomBg(FriendProfileCardFragment.this.mProfileCardInfo, FriendProfileCardFragment.this.mApp);
            }
            ...
            public void notifyCardUpdate() {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 6)) {
                    FriendProfileCardFragment.this.notifyCardUpdate(null);
                } else {
            ...
            public void removeProfileScrollListener(AbsListView.OnScrollListener onScrollListener) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 11)) {
                    FriendProfileCardFragment.this.removeProfileScrollListener(onScrollListener);
                } else {
            ...
            public void requestUpdateCard() {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 5)) {
                    FriendProfileCardFragment.this.requestUpdateCard(0L, null, null, false);
                } else {
            ...
            public void scrollToListTop() {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 8)) {
                    FriendProfileCardFragment.this.scrollToListTop();
                } else {
            ...
            public void scrollToMoreInfoView(int i3) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 9)) {
                    FriendProfileCardFragment.this.scrollToMoreInfoView(i3);
                } else {
            ...
            public void setInterceptTouchEvent(boolean z16) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 12)) {
                    FriendProfileCardFragment.this.setInterceptTouchEvent(z16);
                } else {
            ...
            public void setRemark(String str) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 13)) {
                    FriendProfileCardFragment.this.setNewRemark(str);
                } else {
            ...
            public void setZPlanChangeTitleStatusListener(IZPlanChangeTitleStatusListener iZPlanChangeTitleStatusListener) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 24)) {
                    FriendProfileCardFragment.this.mZPlanCheckTitleStatusListener = iZPlanChangeTitleStatusListener;
                } else {
            ...
            public void notifyCardUpdate(Card card) {
                ...
                if (iPatchRedirector2 == null || !iPatchRedirector2.hasPatch((short) 7)) {
                    FriendProfileCardFragment.this.notifyCardUpdate(card);
                } else {
    ...
    private String addNationCodeIfNeeded(String str) {
        return ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).addNationCodeIfNeeded(this.mApp, str);
    }
    ...
    public void checkAndSwitch2Friend(boolean z16, boolean z17, String str) {
        AllInOne allInOne;
        if (this.mApp != null && this.mUIHandler != null && (allInOne = this.mProfileCardInfo.allInOne) != null && !ProfilePAUtils.isPaTypeFriend(allInOne) && this.mProfileCardInfo.allInOne.f260789pa != 0 && !TextUtils.equals(str, this.mApp.getCurrentAccountUin()) && !TextUtils.equals(this.mProfileCardInfo.allInOne.uin, this.mApp.getCurrentAccountUin())) {
            boolean z18 = false;
            if (QLog.isColorLevel()) {
                QLog.i(TAG, 2, String.format("checkAndSwitch2Friend isFromContactCard=%s needCheckFriend=%s uin=%s", Boolean.valueOf(z16), Boolean.valueOf(z17), str));
            }
            if (z16) {
            ...
            boolean z19 = !z17;
            if (!z19) {
                com.tencent.qqnt.ntrelation.friendsinfo.bean.d friendsSimpleInfoWithUid = ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).getFriendsSimpleInfoWithUid(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(this.mProfileCardInfo.allInOne.uin), TAG);
            ...
            if (z19) {
                Card profileCard = ((IProfileDataService) this.mApp.getRuntimeService(IProfileDataService.class, "all")).getProfileCard(this.mProfileCardInfo.allInOne.uin, true);
    ...
    private boolean checkParamValidate(ProfileCardInfo profileCardInfo) {
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("checkParamValidate allInOne=%s", profileCardInfo.allInOne));
        }
        AllInOne allInOne = profileCardInfo.allInOne;
    ...
    private boolean checkToJumpOther(Bundle bundle, AllInOne allInOne) {
        Intent profileCardIntent;
        Intent babyQProfileCardIntent;
        Serializable serializable = bundle.getSerializable(IProfileCardConst.KEY_WZRY_DATA);
        if (serializable != null) {
            Intent kPLProfileCardIntent = ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).getKPLProfileCardIntent(getContext());
            kPLProfileCardIntent.putExtra(IProfileCardConst.KEY_WZRY_DATA, serializable);
            startActivity(kPLProfileCardIntent);
            m.b(getQBaseActivity());
            return true;
        }
        if (Utils.G(allInOne.uin) && (babyQProfileCardIntent = ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).getBabyQProfileCardIntent(getContext(), allInOne)) != null) {
            startActivity(babyQProfileCardIntent);
            getQBaseActivity().overridePendingTransition(0, 0);
            m.b(getQBaseActivity());
            return true;
        }
        if (!((IBmqqSegmentApi) QRoute.api(IBmqqSegmentApi.class)).isBmqqUinNoBlock(this.mProfileCardInfo.allInOne.uin) || this.mProfileCardInfo.isTroopMemberCard || (profileCardIntent = ((IQidianApi) QRoute.api(IQidianApi.class)).getProfileCardIntent(getContext(), this.mProfileCardInfo.allInOne)) == null) {
            return false;
        }
    ...
    private void clearProfileRedDot() {
        ThreadManagerV2.post(new Runnable() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.7
            static IPatchRedirector $redirector_;

            {
                IPatchRedirector iPatchRedirector = $redirector_;
                if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                    iPatchRedirector.redirect((short) 1, (Object) this, (Object) FriendProfileCardFragment.this);
                }
            }
            ...
            public void run() {
                ...
                } else if (FriendProfileCardFragment.this.mProfileCardInfo.allInOne.f260789pa == 0) {
                    ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).onProfileRedTouchClick(FriendProfileCardFragment.this.mApp);
                }
            }
        }, 5, null, false);
    }
    ...
    private void dealQQBrowserActivityIntent(Intent intent) {
        try {
            ...
            if (component != null && TextUtils.equals(component.getClassName(), name)) {
                ...
                if (QLog.isColorLevel()) {
                    QLog.d(TAG, 2, String.format("dealQQBrowserActivityIntent url=%s key=%s", stringExtra, stringExtra2));
                }
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                try {
                    ...
                    QLog.e(TAG, 1, "destroyProfileContainer fail.", e16);
                }
            }
    ...
    private void fixProfilePA() {
        ...
        AllInOne allInOne = this.mProfileCardInfo.allInOne;
        if (allInOne.profileEntryType == 100 && allInOne.f260789pa == 34 && !((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).isBindedIgnoreUpload(this.mApp)) {
            this.mProfileCardInfo.allInOne.f260789pa = 29;
        }
        if (this.mProfileCardInfo.allInOne.f260789pa != 53 && TextUtils.equals(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin)) {
            this.mProfileCardInfo.allInOne.f260789pa = 0;
        }
    }

    private AllInOne getAllInOneForTroop(Bundle bundle, AllInOne allInOne) {
        this.mProfileCardInfo.isTroopMemberCard = !TextUtils.isEmpty(bundle.getString("troopUin", ""));
        ProfileCardInfo profileCardInfo = this.mProfileCardInfo;
        if (profileCardInfo.isTroopMemberCard) {
            profileCardInfo.troopUin = bundle.getString("troopUin");
            this.mProfileCardInfo.troopMemberCard = new TroopMemberCard();
            if (allInOne == null) {
                String string = bundle.getString("memberUin");
                if (TextUtils.isEmpty(string)) {
                    string = this.mProfileCardInfo.allInOne.uin;
                }
                com.tencent.qqnt.ntrelation.friendsinfo.bean.d friendsSimpleInfoWithUid = ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).getFriendsSimpleInfoWithUid(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(string), TAG);
                if (friendsSimpleInfoWithUid != null && friendsSimpleInfoWithUid.B()) {
                    AllInOne allInOne2 = new AllInOne(string, 1);
                    allInOne2.nickname = friendsSimpleInfoWithUid.p();
                    allInOne2.remark = friendsSimpleInfoWithUid.r();
                    allInOne = allInOne2;
                } else {
                    allInOne = new AllInOne(string, 21);
            ...
            if (!TextUtils.isEmpty(allInOne.troopCode) && TextUtils.isEmpty(allInOne.troopUin)) {
                allInOne.troopUin = ((ITroopInfoService) this.mApp.getRuntimeService(ITroopInfoService.class, "")).getTroopCodeByTroopUin(allInOne.troopCode);
            }
        }
        return allInOne;
    }
    ...
    private AllInOne getProfileAllInOne(Bundle bundle) {
        AllInOne allInOneForTroop = getAllInOneForTroop(bundle, (AllInOne) bundle.getParcelable(IProfileCardConst.KEY_ALL_IN_ONE));
        if (TextUtils.isEmpty(allInOneForTroop.uid) && !TextUtils.isEmpty(allInOneForTroop.uin)) {
    ...
    public void handleGetProfileCard(boolean z16, Object obj) {
        ...
        boolean z17 = false;
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("onGetProfileCard isSuccess=%s data=%s", Boolean.valueOf(z16), obj));
        }
        ...
        if (z18 && isPaTypeHasUin) {
            ...
            if ((card.lUserFlag & 1) != 0) {
                ((IEnterpriseQQService) this.mApp.getRuntimeService(IEnterpriseQQService.class, "")).getMenuFromNet(card.uin, false);
            }
            z17 = p17;
        } else {
    ...
    private void handleNotifyProfileCard(boolean z16, Card card, ContactCard contactCard, boolean z17) {
        if (z16) {
            ...
            if (z17 && contactCard != null) {
                ...
                if (!TextUtils.isEmpty(contactCard.uin)) {
                    com.tencent.qqnt.ntrelation.friendsinfo.bean.d friendsSimpleInfoWithUid = ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).getFriendsSimpleInfoWithUid(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(contactCard.uin), TAG);
                ...
                IQQAvatarHandlerService iQQAvatarHandlerService2 = (IQQAvatarHandlerService) this.mApp.getRuntimeService(IQQAvatarHandlerService.class, "");
        ...
        if (z17 && contactCard2 != null && !contactCard2.isForbidAccount) {
            ContactCard contactCardByMobileNo = ((IProfileDataService) this.mApp.getRuntimeService(IProfileDataService.class, "all")).getContactCardByMobileNo(contactCard2.mobileNo, true);
        ...
        if (i3 != 0) {
            if (i3 != 1) {
                if (i3 != 40) {
                    if (i3 != 60) {
                        if (i3 == 78) {
                            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 24, j3, (byte) 1, 0L, 0L, bArr, "", j16, 3022, bArr2, (byte) 0);
                            return;
                        }
                        return;
                    }
                    iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 26, j3, (byte) 1, 0L, 0L, bArr, "", j16, 10004, bArr2, b16);
                    return;
                }
                iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 1, j3, (byte) 1, 0L, 0L, bArr, "", j16, 10004, bArr2, b16);
                return;
            }
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 1, j3, (byte) 1, 0L, 0L, bArr, "", j16, 10004, bArr2, b16);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 0, j3, (byte) 1, 0L, 0L, bArr, "", j16, 10004, bArr2, b16);
    }
    ...
    private void handleRequestProfileCard10(int i3, IProfileProtocolService iProfileProtocolService, long j3, byte[] bArr, byte[] bArr2, boolean z16, long j16, byte b16) {
        if (i3 != 96) {
            if (i3 != 107 && i3 != 110) {
                if (i3 == 112) {
                    iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3004, bArr2, (byte) 0);
                    return;
                }
                switch (i3) {
                    case 81:
            ...
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 25, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3045, bArr2, (byte) 0);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 53, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3094, bArr2, (byte) 0);
    }
    ...
    private void handleRequestProfileCard11(int i3, IProfileProtocolService iProfileProtocolService, long j3, byte[] bArr, byte[] bArr2, boolean z16, long j16, byte b16) {
        if (i3 != 113) {
            if (i3 != 115) {
                if (i3 == 117) {
                    iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3076, bArr2, (byte) 0);
                    return;
                }
                return;
            }
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3050, bArr2, (byte) 0);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3004, bArr2, (byte) 0);
    }
    ...
    private void handleRequestProfileCard2(int i3, IProfileProtocolService iProfileProtocolService, long j3, byte[] bArr, byte[] bArr2, boolean z16, long j16, byte b16) {
        ...
        if (i3 != 30) {
            if (i3 != 36) {
                ...
                iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 8, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                return;
            }
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), "0", 32, j3, (byte) 0, 0L, 0L, bArr, ProfileUtils.getMobileNumberWithNationCode(this.mProfileCardInfo.allInOne), j16, 3014, bArr2, (byte) 0);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 15, j3, (byte) 1, 0L, 0L, bArr, "", j16, 10004, bArr2, b16);
    }
    ...
    private void handleRequestProfileCard3(int i3, IProfileProtocolService iProfileProtocolService, long j3, byte[] bArr, byte[] bArr2, boolean z16, long j16, byte b16) {
        ...
        if (i3 == 29 || i3 == 34 || i3 == 53 || i3 == 31 || i3 == 32 || i3 == 50 || i3 == 51) {
            ...
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), "0", i16, j3, (byte) 0, 0L, 0L, bArr, addNationCodeIfNeeded, j16, 10004, null, (byte) 0);
        }
    }
        ...
        switch (i3) {
            ...
            case 47:
                ...
                if (str != null) {
                    ...
                    iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, i17, j3, (byte) 0, j18, 0L, bArr, "", j16, 10004, bArr2, b17);
                    return;
                }
                return;
            default:
    ...
    private void handleRequestProfileCard5(int i3, IProfileProtocolService iProfileProtocolService, long j3, byte[] bArr, byte[] bArr2, boolean z16, long j16, byte b16) {
        ...
        if (i3 != 3) {
            ...
            long troopCode = ProfileUtils.getTroopCode(this.mApp, this.mProfileCardInfo.allInOne);
            int i18 = this.mProfileCardInfo.allInOne.f260789pa;
            if (i18 == 20) {
                i17 = 2;
                b17 = 1;
            ...
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, i17, j3, b17, troopCode, 0L, bArr, "", j16, 10004, bArr2, b18);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 21, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
    }
            ...
            if (i3 != 35 && i3 != 37) {
                if (i3 != 61) {
                    if (i3 != 70) {
                        if (i3 != 74) {
                            if (i3 == 75) {
                                iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 38, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3017, bArr2, (byte) 0);
                                return;
                            }
                            return;
                        }
                        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 10, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                        return;
                    }
                    iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 36, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                    return;
                }
                iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 27, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                return;
            }
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 31, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3001, bArr2, (byte) 0);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 10, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
    }
    ...
    private void handleRequestProfileCard7(int i3, IProfileProtocolService iProfileProtocolService, long j3, byte[] bArr, byte[] bArr2, boolean z16, long j16, byte b16) {
        ...
        if (i18 != 3004 && i18 != 2004) {
            ...
            if (!TextUtils.isEmpty(allInOne.troopCode)) {
                ...
                str = ((ITroopInfoService) this.mApp.getRuntimeService(ITroopInfoService.class, "")).getTroopCodeByTroopUin(this.mProfileCardInfo.allInOne.troopUin);
            }
            if (str != null) {
                str2 = str;
            }
                ...
                if (i3 != 52) {
                    if (i3 != 77 && i3 != 95) {
                        if (i3 != 97) {
                            ...
                            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3095, bArr2, (byte) 0);
                            return;
                        }
                    }
                } else {
                    iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 24, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                    return;
                }
            }
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 25, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
    }
        ...
        if (i3 != 71) {
            if (i3 != 72) {
                if (i3 != 98) {
                    switch (i3) {
                        case 55:
                            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 28, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, b16);
                            return;
                        case 56:
                            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 29, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                            return;
                        case 57:
                            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 30, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
                            return;
                        default:
                            return;
                    }
                }
                iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 12, j3, (byte) 0, 0L, 0L, bArr, "", j16, 3096, bArr2, (byte) 0);
                return;
            }
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 34, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
            return;
        }
        iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 33, j3, (byte) 0, 0L, 0L, bArr, "", j16, 10004, bArr2, (byte) 0);
    }
    ...
    private void handleSwitchVasCard() {
        ...
        QLog.e(TAG, 1, "handleSwitchVasCard error, page out");
    }

    private void initCardInfo() {
        Message obtainMessage;
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, "send async message to init card in db");
        }
        if (this.mSubHandler != null) {
            ...
            if (allInOne.f260789pa == 33) {
                ...
                obtainMessage.obj = this.mProfileCardInfo.allInOne.uin;
                if (QLog.isColorLevel()) {
                    QLog.d(TAG, 2, "SUB_MSG_INIT_CARD.uni:" + this.mProfileCardInfo.allInOne.uin);
                }
            } else {
                obtainMessage = this.mSubHandler.obtainMessage();
                ...
                obtainMessage.obj = this.mProfileCardInfo.allInOne.uin;
                if (QLog.isColorLevel()) {
                    QLog.d(TAG, 2, "SUB_MSG_INIT_CONTACT_CARD.uni:" + this.mProfileCardInfo.allInOne.uin);
                }
            }
    ...
    private void initComponentCenter() {
        ...
        this.mComponentCenter.init(getQBaseActivity());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void initContactCard() {
        String addNationCodeIfNeeded = addNationCodeIfNeeded(ProfileUtils.getMobileNumberWithNationCode(this.mProfileCardInfo.allInOne));
        if (addNationCodeIfNeeded != null && addNationCodeIfNeeded.length() > 0) {
            IProfileDataService iProfileDataService = (IProfileDataService) this.mApp.getRuntimeService(IProfileDataService.class, "all");
            ...
            if (!TextUtils.isEmpty(contactCardByMobileNo.uin)) {
                com.tencent.qqnt.ntrelation.friendsinfo.bean.d friendsSimpleInfoWithUid = ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).getFriendsSimpleInfoWithUid(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(contactCardByMobileNo.uin), TAG);
                if (friendsSimpleInfoWithUid != null) {
                    this.mProfileCardInfo.allInOne.remark = friendsSimpleInfoWithUid.r();
                }
            }
    ...
    private void initContactCardInfoList(boolean z16) {
        ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).initContactCardInfoList(this.mApp, this.mProfileCardInfo, z16);
    }
    ...
    private void initDtReport() {
        ...
        int i17 = 2;
        if (ProfileUtils.isFriend(this.mApp, this.mProfileCardInfo.allInOne.uin)) {
            i3 = 1;
        } else {
            i3 = 2;
        }
        ...
        hashMap.put("profile_version", Integer.valueOf(i16));
        AllInOne allInOne = this.mProfileCardInfo.allInOne;
        ...
        if (allInOne2 != null && (bundle = allInOne2.extras) != null) {
            ...
            if (i26 != 0) {
                ...
                try {
                    ...
                    QLog.e(TAG, 1, "initDtReport error:", e16);
                }
            }
        }
        ...
        VideoReport.setPageContentId(this.mRootView, FriendProfileCardFragment.class.getName());
    ...
    private void initMainUI() {
        ...
        View inflate = View.inflate(getContext(), R.layout.azv, null);
        this.mContentView = inflate;
        this.mHeaderContainerView = inflate.findViewById(R.id.dk_);
    ...
    public void initProfileCard(String str) {
        ...
        byte[] bArr;
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("initProfileCard uin=%s", str));
        }
        ProfileCardTracer.tagNode("fetch_local_data_start_time");
        Card profileCard = ((IProfileDataService) this.mApp.getRuntimeService(IProfileDataService.class, "")).getProfileCard(str, true);
        if (profileCard != null) {
            com.tencent.qqnt.ntrelation.friendsinfo.bean.d friendsSimpleInfoWithUid = ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).getFriendsSimpleInfoWithUid(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(profileCard.uin), TAG);
            if (friendsSimpleInfoWithUid != null && friendsSimpleInfoWithUid.B()) {
                z16 = true;
            } else {
                z16 = false;
            }
            if (z16 && !this.mProfileCardInfo.allInOne.uin.equals(this.mApp.getCurrentAccountUin()) && !ProfilePAUtils.isPaTypeFriend(this.mProfileCardInfo.allInOne)) {
                this.mProfileCardInfo.allInOne.f260789pa = 1;
            }
    ...
    private View initProfileCardLayout(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup) {
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, "initProfileCardLayout");
        }
        ...
        initMainUI();
        TopGestureLayout topGestureLayout = new TopGestureLayout(getContext());
    ...
    private void initProfileContainer() {
        ...
        while (it.hasNext()) {
            ...
            try {
                ...
                QLog.e(TAG, 1, "initProfileContainer fail.", e16);
    ...
    private void initProfileFramework() {
        try {
            ...
            QLog.e(TAG, 1, "initComponentCenter fail.", e16);
            getQBaseActivity().finish();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$qOnNewIntent$0(String str) {
        AppRuntime peekAppRuntime = MobileQQ.sMobileQQ.peekAppRuntime();
        if (peekAppRuntime != null && isAdded()) {
            Card profileCard = ((IProfileDataService) peekAppRuntime.getRuntimeService(IProfileDataService.class, "all")).getProfileCard(str, false);
            if (profileCard != null) {
                requestUpdateCard(profileCard.feedPreviewTime, profileCard.vSeed, null, true);
            } else {
                requestUpdateCard(0L, null, null, true);
            }
        }
    }
    ...
    private byte needReqMedalWall() {
        ...
        byte needReqMedalWall = ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).needReqMedalWall(getContext(), this.mApp);
        ITroopInfoService iTroopInfoService = (ITroopInfoService) this.mApp.getRuntimeService(ITroopInfoService.class, "");
        ProfileCardInfo profileCardInfo = this.mProfileCardInfo;
    ...
    private void notifyComponentDataUpdate() {
        ...
        if (list != null && !list.isEmpty()) {
            int size = this.mProfileContainers.size();
            for (int i3 = 0; i3 < size && i3 < this.mProfileContainers.size(); i3++) {
                AbsProfileComponent absProfileComponent = this.mProfileContainers.get(i3);
                if (absProfileComponent != null) {
                    try {
                        absProfileComponent.lambda$checkValidComponent$3(this.mProfileCardInfo);
                    } catch (Exception e16) {
                        QLog.e(TAG, 1, "notifyComponentDataUpdate fail.", e16);
                    }
                }
            }
        }
    ...
    public synchronized void onCardUpdate(Card card, boolean z16, int i3, boolean z17) {
        int i16 = 1;
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("onCardUpdate card=%s isNetCard=%s msgType=%s isFromGetProfileCardRequest=%s", card, Boolean.valueOf(z16), Integer.valueOf(i3), Boolean.valueOf(z17)));
        }
        if (card != null) {
            ...
            ProfileTemplateApi.getTemplateManager(this.mComponentCenter).preNotifyOnCardUpdate(getQBaseActivity(), this.mProfileCardInfo);
    ...
    private void onMainUiInit() {
        FrameLayout frameLayout = (FrameLayout) getQBaseActivity().findViewById(android.R.id.content);
        if (frameLayout != null) {
    ...
    private void profileEntryReport() {
        if (Utils.G(this.mProfileCardInfo.allInOne.uin)) {
            int i3 = this.mProfileCardInfo.allInOne.profileEntryType;
            int i16 = 1;
            if (i3 != 59) {
                if (i3 == 1) {
                    i16 = 2;
            ...
            ReportController.o(this.mApp, "dc00898", "", "", "0X800723B", "0X800723B", i16, 0, "", "", "", "");
        }
        int i17 = this.mProfileCardInfo.allInOne.profileEntryType;
        if (i17 == 118) {
            ReportController.o(null, "dc00898", "", "", "0X800A11E", "0X800A11E", 0, 0, "", "", "", "");
        } else if (i17 == 121) {
            ReportController.o(this.mApp, "dc00898", "", "", "0X800A51D", "0X800A51D", 0, 0, "", "", "", "");
        }
        ReportController.o(this.mApp, "dc00898", "", "", "", "0X800A4BF", 0, 0, "", "", "", "");
        ...
        if (ProfileCardVersionController.getVersion().equals(ProfileCardVersion.V_ELEGANT) && ProfilePAUtils.isPaTypeStrangerInContact(this.mProfileCardInfo.allInOne)) {
            ReportController.o(this.mApp, "dc00898", "", "", "0X800C007", "0X800C007", ProfileCardReportUtil.getProfileSourceType(this.mProfileCardInfo.allInOne), 0, "", "", "", "");
        }
    }

    private void registerDetailModifyReceiver() {
        if (this.mDetailModifyReceiver == null) {
            this.mDetailModifyReceiver = new BroadcastReceiver() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.8
                static IPatchRedirector $redirector_;
                ...
                public void onReceive(Context context, Intent intent) {
                    ...
                    } else if (FriendProfileCardFragment.this.mProfileCardInfo.allInOne.uin.equals(FriendProfileCardFragment.this.mApp.getCurrentAccountUin()) && (profileCard = ((IProfileDataService) FriendProfileCardFragment.this.mApp.getRuntimeService(IProfileDataService.class, "all")).getProfileCard(FriendProfileCardFragment.this.mProfileCardInfo.allInOne.uin, false)) != null) {
                        FriendProfileCardFragment.this.requestUpdateCard(profileCard.feedPreviewTime, profileCard.vSeed, null, false);
                    }
                }
            };
            try {
                ...
                getQBaseActivity().registerReceiver(this.mDetailModifyReceiver, intentFilter);
            } catch (Throwable th5) {
                QLog.e(TAG, 1, "registerDetailModifyReceiver fail.", th5);
            }
        }
    }
    ...
    public void requestUpdateCard(long j3, byte[] bArr, byte[] bArr2, boolean z16) {
        ...
        byte[] bArr4;
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("requestUpdateCard forceRequest=%s mRequestCardCount=%s", Boolean.valueOf(z16), Integer.valueOf(this.mRequestCardCount)));
        }
        ...
        long control = ProfileUtils.getControl(this.mProfileCardInfo.allInOne, ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).needReqOCRCard(this.mApp));
        byte needReqMedalWall = needReqMedalWall();
        IProfileProtocolService iProfileProtocolService = (IProfileProtocolService) this.mApp.getRuntimeService(IProfileProtocolService.class, "all");
        byte[] bArr5 = bArr3;
        byte[] bArr6 = bArr4;
        ...
        if (!isNeedHandleRequestProfileCardDefault(this.mProfileCardInfo.allInOne.f260789pa)) {
            iProfileProtocolService.requestProfileCard(this.mApp.getCurrentAccountUin(), this.mProfileCardInfo.allInOne.uin, 65535, j3, (byte) 0, 0L, 0L, bArr3, "", control, BuddySource.DEFAULT, bArr4, (byte) 0);
        }
    }
    ...
    private void resetContentView() {
        ...
        this.mRootView = View.inflate(getContext(), R.layout.b0y, null);
        initMainUI();
        this.mTopView.addView(this.mRootView);
        onMainUiInit();
    }
    ...
    public void scrollToMoreInfoView(int i3) {
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("scrollToExtendsFriendInfo offset=%s", Integer.valueOf(i3)));
        }
        int height = (i3 + this.mHeaderContainerView.getHeight()) - getTitleBarHeight();
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("scrollToMoreInfoView offset=%s", Integer.valueOf(height)));
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void setInterceptTouchEvent(boolean z16) {
        QLog.e(TAG, 1, String.format("setInterceptTouchEvent intercept=%s", Boolean.valueOf(z16)));
    ...
    private void showBackOrStayDialogIfNeed() {
        ...
        boolean z16 = this.profileIntent.getBoolean(IProfileCardConst.KEY_FROM_APP_SHOW_DIALOG, false);
        String string = this.profileIntent.getString("src_name");
        if (z16 && !TextUtils.isEmpty(string)) {
            com.tencent.open.widget.b.e(getQBaseActivity(), str, string, null);
        }
    }

    private Card switchContactCardToFriendCard(String str, String str2) {
        IProfileDataService iProfileDataService = (IProfileDataService) this.mApp.getRuntimeService(IProfileDataService.class, "all");
        ContactCard contactCardByMobileNo = iProfileDataService.getContactCardByMobileNo(str2, false);
        if (contactCardByMobileNo != null) {
    ...
    public void switchedToFriend(Card card, String str) {
        ...
        byte[] bArr;
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("switchedToFriend card=%s uin=%s", card, str));
        }
        AllInOne allInOne = this.mProfileCardInfo.allInOne;
    ...
    private void unregisterDetailModifyReceiver() {
        if (this.mDetailModifyReceiver != null) {
            try {
                getQBaseActivity().unregisterReceiver(this.mDetailModifyReceiver);
            } catch (Exception e16) {
                QLog.e(TAG, 1, "unregisterDetailModifyReceiver fail.", e16);
            }
            this.mDetailModifyReceiver = null;
        }
    }
    ...
    public void updateCardInfo(Card card, boolean z16) {
        if (card != null && !TextUtils.isEmpty(card.uin) && card.uin.equals(this.mProfileCardInfo.allInOne.uin)) {
            if (QLog.isColorLevel()) {
                QLog.d(TAG, 2, String.format("updateCardInfo card=%s isNetRet=%s", card, Boolean.valueOf(z16)));
            }
    ...
    public void updateContactCardInfo(ProfileCardInfo profileCardInfo, boolean z16) {
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("updateContactCardInfo card=%s isNetRet=%s", profileCardInfo.contactCard, Boolean.valueOf(z16)));
        }
        ProfileCardInfo profileCardInfo2 = this.mProfileCardInfo;
    ...
    private void updateForbidState() {
        ...
        if (profileCardInfo != null && ProfileCardForbidAccountHelper.isForbidByAnyType(profileCardInfo)) {
            ...
            if (ProfileCardForbidAccountHelper.isForbidBySpecifyTypes(new ArrayList(Collections.singletonList(201)), this.mProfileCardInfo.card)) {
                QLog.i(TAG, 1, "updateForbidState forbidAccount");
                this.mForbidAccountHelper.showDialog(getQBaseActivity());
                return;
            }
            return;
        }
    ...
    private void updateFriendDetail(Card card, boolean z16) {
        boolean z17;
        boolean z18;
        if (this.mProfileCardInfo.allInOne.f260789pa != 0 && z16 && !this.mHasUpdateFriendsDetail) {
            this.mHasUpdateFriendsDetail = true;
            com.tencent.qqnt.ntrelation.friendsinfo.bean.d friendsSimpleInfoWithUid = ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).getFriendsSimpleInfoWithUid(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(card.uin), TAG);
            if (friendsSimpleInfoWithUid != null && friendsSimpleInfoWithUid.B()) {
                z17 = true;
            } else {
                z17 = false;
            ...
            if (QLog.isColorLevel()) {
                QLog.d(TAG, 2, String.format("onCardUpdate isFriend=%s profileFriend=%s", Boolean.valueOf(z17), Boolean.valueOf(z18)));
            }
            if (z18 != z17) {
                ((IFriendHandlerService) this.mApp.getRuntimeService(IFriendHandlerService.class, "all")).requestFriendInfo(card.uin);
            }
        }
    }
    ...
    private void updateNameArrayByCard(Card card, boolean z16) {
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("updateNameArrayByCard card=%s isNetRet=%s", card, Boolean.valueOf(z16)));
        }
        if (card == null) {
            return;
        }
        ProfileCardInfo profileCardInfo = this.mProfileCardInfo;
        if (profileCardInfo.nameArray == null) {
            profileCardInfo.nameArray = new String[8];
        }
        if ((z16 || !TextUtils.isEmpty(card.strNick)) && ProfileCardUtil.isContactNicknameValid(card.strNick)) {
    ...
    private void updateTheme() {
        ...
        try {
            ...
            QLog.e(TAG, 1, "updateTheme fail.", e16);
        }
    }
    ...
    public void flingLToR() {
        ...
        } else if (this.mInterceptTouchEvent && getContext() != null && !AppSetting.t(getContext())) {
            onBackEvent();
        }
    }
    ...
    public void onActivityResult(int i3, int i16, @Nullable Intent intent) {
        ...
        if (QLog.isColorLevel()) {
            QLog.d(TAG, 2, String.format("doOnActivityResult requestCode=%s resultCode=%s", Integer.valueOf(i3), Integer.valueOf(i16)));
        }
    ...
    public boolean onBackEvent() {
        ...
        if (iComponentCenter != null && iComponentCenter.onBackPressed()) {
            if (QLog.isColorLevel()) {
                QLog.d(TAG, 2, "onBackEvent event cost by component");
                return true;
            }
            return true;
        }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, OperateCustomButton.OPERATE_CREATE);
        ProfileCardVersionController.initConfig();
        this.savedInstanceState = bundle;
        QBaseActivity qBaseActivity = getQBaseActivity();
        super.onCreate(bundle);
        this.mApp = (AppInterface) qBaseActivity.getAppRuntime();
        this.profileIntent = getArguments();
        AppInterface appInterface = this.mApp;
        if (appInterface != null && !TextUtils.isEmpty(appInterface.getAccount()) && (bundle2 = this.profileIntent) != null) {
            AllInOne profileAllInOne = getProfileAllInOne(bundle2);
            ...
            this.mConfigHelper = ((IProfileCardBusinessApi) QRoute.api(IProfileCardBusinessApi.class)).createProfileConfig(this.mApp);
            ...
            if (!checkParamValidate(this.mProfileCardInfo)) {
                QLog.e(TAG, 1, "doOnCreate invalid params 2.");
                qBaseActivity.finish();
                return;
            }
            if (checkToJumpOther(this.profileIntent, profileAllInOne)) {
                QLog.e(TAG, 1, "doOnCreate jump to other.");
                return;
            }
            fixProfilePA();
            clearProfileRedDot();
            registerDetailModifyReceiver();
            qBaseActivity.addObserver(this.profileCardObserver);
            try {
                initContactCardInfoList(false);
                this.mProfileCardInfo.nameArray = new String[8];
                ThreadManagerV2.excute(new Runnable() { // from class: com.tencent.mobileqq.profilecard.fragment.FriendProfileCardFragment.6
                    static IPatchRedirector $redirector_;
                    ...
                    public void run() {
                        ...
                        try {
                            ProfileNameUtils.initNameArray(FriendProfileCardFragment.this.mApp, FriendProfileCardFragment.this.mProfileCardInfo);
                            ProfileNameUtils.updateProfileName(FriendProfileCardFragment.this.mProfileCardInfo);
                            if (!ProfilePAUtils.isPaTypeFriend(FriendProfileCardFragment.this.mProfileCardInfo.allInOne) && !ProfilePAUtils.isPaTypeStrangerInContact(FriendProfileCardFragment.this.mProfileCardInfo.allInOne)) {
                                FriendProfileCardFragment.this.checkAndSwitch2Friend(false, true, null);
                            }
                        } catch (Throwable th5) {
                            QLog.e(FriendProfileCardFragment.TAG, 1, "doOnCreate inner init fail.", th5);
                        }
                    }
                }, 16, null, true);
                this.mIsShowZplanCover = ((IProfileCardApi) QRoute.api(IProfileCardApi.class)).isProfileCardShowZplanCover(this.mProfileCardInfo);
                ...
                QLog.e(TAG, 1, "doOnCreate fail.", e16);
                qBaseActivity.finish();
                return;
            }
        }
        QLog.e(TAG, 1, "doOnCreate invalid params 1.");
        qBaseActivity.finish();
    }

    @Override // com.tencent.biz.richframework.part.BasePartFragment, androidx.fragment.app.Fragment
    public View onCreateView(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View initProfileCardLayout;
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
            initProfileCardLayout = (View) iPatchRedirector.redirect((short) 2, this, layoutInflater, viewGroup, bundle);
        } else {
            QLog.i("FriendProfileCardFragment_test", 1, "onCreateView");
            ProfileCardTracer.tagNode("page_on_create_time");
            initProfileCardLayout = initProfileCardLayout(layoutInflater, viewGroup);
        }
        AndroidXFragmentCollector.onAndroidXFragmentViewCreated(this, initProfileCardLayout);
        return initProfileCardLayout;
    }
    ...
    public void onDestroy() {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, MosaicConstants$JsFunction.FUNC_ON_DESTROY);
        WeakReferenceHandler weakReferenceHandler = this.mUIHandler;
        if (weakReferenceHandler != null) {
        ...
        getQBaseActivity().removeObserver(this.profileCardObserver);
        unregisterDetailModifyReceiver();
        this.mApp.removeObserver(this.mAvatarObserver);
        PullToZoomHeaderListView pullToZoomHeaderListView = this.mProfileListView;
        if (pullToZoomHeaderListView != null) {
            pullToZoomHeaderListView.setMotionEventInterceptor(null);
        }
    ...
    public void onDestroyView() {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, "onDestroyView");
        super.onDestroyView();
        IComponentCenter iComponentCenter = this.mComponentCenter;
        if (iComponentCenter != null) {
    ...
    public void onPause() {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, MiniSDKConst.NOTIFY_EVENT_ONPAUSE);
        super.onPause();
    ...
    public void onResume() {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, "onResume");
        super.onResume();
    ...
    public void onStart() {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, "onStart");
        super.onStart();
        if (this.hasStarted) {
            doOnRestart();
        }
    ...
    public void onStop() {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, DKHippyEvent.EVENT_STOP);
        super.onStop();
        IComponentCenter iComponentCenter = this.mComponentCenter;
        if (iComponentCenter != null) {
    ...
    public void onViewCreated(@NonNull View view, Bundle bundle) {
        ...
        QLog.i("FriendProfileCardFragment_test", 1, DKEngine.ExtraEvent.EXTRA_EVENT_ON_VIEW_CREATED);
        ...
        try {
            ...
            IComponentCenter iComponentCenter = this.mComponentCenter;
            if (iComponentCenter != null) {
                iComponentCenter.onCreate(qBaseActivity, bundle);
            }
            ...
            profileEntryReport();
            initDtReport();
            ((IProfileEditApi) QRoute.api(IProfileEditApi.class)).downloadHDAvatar(this.mApp.getCurrentAccountUin(), this.mApp);
            this.mApp.addObserver(this.mAvatarObserver);
            View view2 = this.mRootView;
            if (view2 != null) {
                view2.setBackgroundColor(qBaseActivity.getResources().getColor(R.color.qui_common_bg_bottom_light));
            }
        } catch (Exception e16) {
            QLog.e(TAG, 1, "doOnCreate fail.", e16);
            exitProfileCard();
        } catch (OutOfMemoryError e17) {
            QLog.e(TAG, 1, "doOnCreate fail. OutOfMemoryError:" + e17.getMessage(), e17);
            exitProfileCard();
        }
    }
    ...
    public void qOnNewIntent() {
        ...
        if (QLog.isColorLevel()) {
            QLog.i(TAG, 1, "qOnNewIntent invoke. hash_code=" + hashCode());
        }
        PullToZoomHeaderListView pullToZoomHeaderListView = this.mProfileListView;
        if (pullToZoomHeaderListView != null) {
            pullToZoomHeaderListView.setOnScrollListener(null);
        }
        resetContentView();
        destroyProfileContainer();
        IProfileConfig iProfileConfig = this.mConfigHelper;
        ...
        initProfileFramework();
        final String str = this.mProfileCardInfo.allInOne.uin;
        ThreadManagerV2.excute(new Runnable() { // from class: com.tencent.mobileqq.profilecard.fragment.a
            @Override // java.lang.Runnable
            public final void run() {
                FriendProfileCardFragment.this.lambda$qOnNewIntent$0(str);
            }
        }, 16, null, true);
    }
