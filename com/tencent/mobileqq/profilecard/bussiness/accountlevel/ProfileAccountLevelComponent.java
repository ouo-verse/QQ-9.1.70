...
public class ProfileAccountLevelComponent extends BaseProfileAccountLevelComponent {
    static IPatchRedirector $redirector_ = null;
    private static final String TAG = "ProfileAccountLevelComponent";

    public ProfileAccountLevelComponent(IComponentCenter iComponentCenter, ProfileCardInfo profileCardInfo) {
