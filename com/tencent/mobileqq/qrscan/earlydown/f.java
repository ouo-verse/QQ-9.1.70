...
public class f extends com.tencent.mobileqq.earlydownload.handler.b {
    static IPatchRedirector $redirector_;
    private int E;
    private boolean F;

    public f(AppRuntime appRuntime) {
        super("qq.android.minidetect.so_v8.9.85", appRuntime);
    ...
    public void G(XmlData xmlData, boolean z16, int i3, String str) {
        ...
        if (!z16) {
            M();
            N();
            QRScanResDownloadManager.g(1, false);
        }
        super.G(xmlData, z16, i3, str);
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectSoDownloadHandler", 2, "download finish: " + z16);
        }
    }
    ...
    public void H(long j3, long j16) {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectSoDownloadHandler", 2, "download progress: " + this.E);
        }
    }
    ...
    public void I(boolean z16) {
        ...
        super.I(z16);
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectSoDownloadHandler", 2, "restartDownload userClick=" + z16);
        }
    }
    ...
    public void N() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 9)) {
            ...
            QMMKVMigrateHelper.getMMKVMigratedSharePreferencesSync(MobileQQ.sMobileQQ, "mini_scan_sp", 4).edit().putInt("minidetect_so_version", v()).apply();
        }
    }
    ...
    public void f() {
        ...
        boolean c16 = q.c(new File(g.o()));
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectSoDownloadHandler", 2, "deleteUnZipFile ret: " + c16);
        }
    }
    ...
    public void i(String str) {
        ...
        byte n3 = g.n(str);
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectSoDownloadHandler", 2, "doOnDownloadSuccess ret=" + ((int) n3) + ", filePath=" + str);
        }
        if (n3 != 0) {
            M();
            N();
            ...
            QRScanResDownloadManager.g(1, true);
        }
        super.i(str);
    }
    ...
    public boolean k() {
        ...
        if (!this.F) {
            ...
            if (QLog.isColorLevel()) {
                QLog.d("MiniRecog.MiniScanDetectSoDownloadHandler", 2, "downloadResource later " + z16);
            }
            if (z16) {
                return false;
            }
