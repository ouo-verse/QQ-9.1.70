...
public class e extends com.tencent.mobileqq.earlydownload.handler.b {
    static IPatchRedirector $redirector_;
    private int E;
    private boolean F;

    public e(AppRuntime appRuntime) {
        super("qq.android.minidetect.model_v8.9.85", appRuntime);
    ...
    public void G(XmlData xmlData, boolean z16, int i3, String str) {
        ...
        if (!z16) {
            M();
            QRScanResDownloadManager.g(2, false);
        }
        super.G(xmlData, z16, i3, str);
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "download finish: " + z16);
        }
    }
    ...
    public void H(long j3, long j16) {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "download progress: " + this.E);
        }
    }
    ...
    public void I(boolean z16) {
        ...
        super.I(z16);
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "restartDownload userClick=" + z16);
        }
    }
    ...
    public void f() {
        ...
        boolean c16 = q.c(new File(d.o()));
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "deleteUnZipFile ret: " + c16);
        }
    }
    ...
    public void i(String str) {
        ...
        byte n3 = d.n(str);
        if (QLog.isColorLevel()) {
            QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "doOnDownloadSuccess ret=" + ((int) n3) + ", filePath=" + str);
        }
        if (n3 != 0) {
            M();
            QRScanResDownloadManager.g(2, false);
        } else {
            QRScanResDownloadManager.g(2, true);
        }
        super.i(str);
    }
    ...
    public boolean k() {
        ...
        if (!this.F) {
            ...
            if (QLog.isColorLevel()) {
                QLog.d("MiniRecog.MiniScanDetectModelsDownloadHandler", 2, "downloadResource later " + z16);
            }
            if (z16) {
                return false;
            }
