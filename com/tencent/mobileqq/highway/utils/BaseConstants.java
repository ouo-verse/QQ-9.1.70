...
public interface BaseConstants {
    ...
    public interface BdhBusinessType {
        ...
        public static final int[] reportBDHExcept;

        static {
            ReflectUtils.setStaticField(PatchRedirectCenter.getRedirector(16534), (Class<?>) BdhBusinessType.class, "$redirector_");
            IPatchRedirector iPatchRedirector = $redirector_;
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1);
            } else {
                reportBDHExcept = new int[]{1, 2, 12, 25};
            }
        }
    }
    ...
    public interface ERROR {
        ...
        public static final int ERR_NO_KERNEL_ENGINE = 9073;
    ...
    public interface REQ_CONST {
        ...
        public static final long DEFAULT_TIME_OUT_HEARTBREAK = 10000;
        public static final long DEFAULT_TIME_OUT_INCRE = 15000;
        public static final int HEARTBREAK_DELTA = 60000;
        public static final long URGENT_HEARTBREAK_TIMEOUT = 10000;
    }
