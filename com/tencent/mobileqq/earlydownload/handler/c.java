...
public class c extends b {
    ...
    public void E(XmlData xmlData) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 11)) {
            iPatchRedirector.redirect((short) 11, (Object) this, (Object) xmlData);
            return;
        }
        super.E(xmlData);
        if (QLog.isColorLevel()) {
    ...
    public void G(XmlData xmlData, boolean z16, int i3, String str) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 9)) {
            iPatchRedirector.redirect((short) 9, this, xmlData, Boolean.valueOf(z16), Integer.valueOf(i3), str);
            return;
        }
        if (!z16) {
            FaceScanDownloadManager.k(0, false);
        }
        super.G(xmlData, z16, i3, str);
        if (QLog.isColorLevel()) {
            QLog.d("FaceModelsDownloadHandler", 2, "download finish: " + z16);
        }
    }
    ...
    public void H(long j3, long j16) {
        ...
        this.E = i3;
        FaceScanDownloadManager.j(0, i3);
        if (QLog.isColorLevel()) {
            QLog.d("FaceModelsDownloadHandler", 2, "download progress: " + this.E);
        }
    }
    ...
    public void I(boolean z16) {
        ...
        super.I(z16);
        if (QLog.isColorLevel()) {
            QLog.d("FaceModelsDownloadHandler", 2, "download restart userClick = " + z16);
        }
    }
    ...
    public void i(String str) {
        ...
        if (com.tencent.mobileqq.ar.o.a(str) != 0) {
            M();
            FaceScanDownloadManager.k(0, false);
        } else {
            FaceScanDownloadManager.k(0, true);
            ReportController.o(this.f203921f, "dc00898", "", "", "0X8008358", "0X8008358", 0, 0, "", "", "model", "");
    ...
    public boolean k() {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("FaceModelsDownloadHandler", 2, "downloadResource,isDownloadReqedByUser = " + this.F);
        }
        if (!this.F) {
            ...
            if (QLog.isColorLevel()) {
                QLog.d("FaceModelsDownloadHandler", 2, "downloadResource later " + z16);
            }
            if (z16) {
                return false;
            }
