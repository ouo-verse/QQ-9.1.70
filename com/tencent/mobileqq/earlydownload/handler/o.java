...
public class o extends b {
    ...
    public boolean C() {
        ...
        return ((QavVideoData) o()).autoDownload;
    }
    ...
    public void I(boolean z16) {
        ...
        QavVideoData qavVideoData = (QavVideoData) o();
        if (qavVideoData != null && !qavVideoData.autoDownload) {
            qavVideoData.autoDownload = true;
            com.tencent.mobileqq.earlydownload.a.f(qavVideoData, VirtualAppProxy.KEY_AUTO_DOWNLOAD);
        }
        super.I(z16);
    }
    ...
    public void i(String str) {
        ...
        try {
            FileUtils.uncompressZip(str, v.b(), false);
        } catch (Exception e16) {
            e16.printStackTrace();
        }
    }
