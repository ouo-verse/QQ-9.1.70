...
import com.tencent.mobileqq.search.searchdetail.searchbox.views.RecyclerViewWithHeaderFooter;
...
public class RecyclerViewWithHeaderFooter extends RecyclerView {
    ...
    private final List<View> f284669f;

    /* renamed from: h, reason: collision with root package name */
    private final List<View> f284670h;
    ...
    public static class a extends GridLayoutManager.SpanSizeLookup {
        ...
        private final c f284671a;

        /* renamed from: b, reason: collision with root package name */
        private final GridLayoutManager f284672b;

        /* renamed from: c, reason: collision with root package name */
        private GridLayoutManager.SpanSizeLookup f284673c;

        public a(c cVar, GridLayoutManager gridLayoutManager) {
            this.f284671a = cVar;
            this.f284672b = gridLayoutManager;
        }

        @Override // androidx.recyclerview.widget.GridLayoutManager.SpanSizeLookup
        public int getSpanSize(int i3) {
            boolean z16;
            if (!this.f284671a.isHeaderPosition(i3) && !this.f284671a.isFooterPosition(i3)) {
                z16 = false;
            } else {
                z16 = true;
            }
            if (z16) {
                return this.f284672b.getSpanCount();
            }
            GridLayoutManager.SpanSizeLookup spanSizeLookup = this.f284673c;
            if (spanSizeLookup == null) {
                return 1;
            }
            return spanSizeLookup.getSpanSize(i3 - this.f284671a.getHeaderCount());
        }
    }
    ...
    public static class c<T extends RecyclerView.Adapter> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public int getItemCount() {
            return this.C.size() + this.f284674m.getItemCount() + this.D.size();
        }
        ...
        public long getItemId(int i3) {
            ...
            if (i3 < this.C.size() + this.f284674m.getItemCount()) {
                return this.f284674m.getItemId(i3 - this.C.size());
            }
            return this.D.get((i3 - this.C.size()) - this.f284674m.getItemCount()).hashCode();
        }
        ...
        public int getItemViewType(int i3) {
            ...
            if (i3 < this.C.size() + this.f284674m.getItemCount()) {
                return this.f284674m.getItemViewType(i3 - this.C.size());
            }
            return ((i3 - 2000) - this.C.size()) - this.f284674m.getItemCount();
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3, List<Object> list) {
            if (i3 >= this.C.size() && i3 < this.C.size() + this.f284674m.getItemCount()) {
                this.f284674m.onBindViewHolder(viewHolder, i3 - this.C.size(), list);
            } else {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i3) {
            ...
            return this.f284674m.onCreateViewHolder(viewGroup, i3);
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3) {
            if (i3 >= this.C.size() && i3 < this.C.size() + this.f284674m.getItemCount()) {
                this.f284674m.onBindViewHolder(viewHolder, i3 - this.C.size());
                return;
            }
        ...
        public class a extends RecyclerView.AdapterDataObserver {
            ...
            final /* synthetic */ WeakReference f284675d;

            a(WeakReference weakReference) {
                this.f284675d = weakReference;
            }

            private boolean g() {
                WeakReference weakReference = this.f284675d;
                if (weakReference != null && weakReference.get() != null && ((RecyclerView) this.f284675d.get()).isComputingLayout()) {
                    return true;
                }
                return false;
            }
            ...
            private void n(Runnable runnable) {
                ...
                if (weakReference != null && weakReference.get() != null) {
                    ((RecyclerView) this.f284675d.get()).post(runnable);
                }
            }
            ...
            public void onChanged() {
                try {
                    if (g()) {
                        n(new Runnable() { // from class: com.tencent.mobileqq.search.searchdetail.searchbox.views.g
                    ...
                    s.f("RecyclerViewWithHeaderFooter", "Exception adapter: " + c.this.f284674m, e16);
                }
            }
            ...
            public void onItemRangeChanged(final int i3, final int i16) {
                try {
                    if (g()) {
                        n(new Runnable() { // from class: com.tencent.mobileqq.search.searchdetail.searchbox.views.d
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            public void onItemRangeInserted(final int i3, final int i16) {
                try {
                    if (g()) {
                        n(new Runnable() { // from class: com.tencent.mobileqq.search.searchdetail.searchbox.views.b
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            public void onItemRangeMoved(final int i3, final int i16, int i17) {
                try {
                    if (g()) {
                        n(new Runnable() { // from class: com.tencent.mobileqq.search.searchdetail.searchbox.views.e
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            public void onItemRangeRemoved(final int i3, final int i16) {
                try {
                    if (g()) {
                        n(new Runnable() { // from class: com.tencent.mobileqq.search.searchdetail.searchbox.views.c
                            @Override // java.lang.Runnable
                            public final void run() {
            ...
            public void onItemRangeChanged(final int i3, final int i16, final Object obj) {
                try {
                    if (g()) {
                        n(new Runnable() { // from class: com.tencent.mobileqq.search.searchdetail.searchbox.views.f
                            @Override // java.lang.Runnable
                            public final void run() {
    ...
    public RecyclerViewWithHeaderFooter(Context context) {
        super(context);
        this.f284669f = new ArrayList();
        this.f284670h = new ArrayList();
    }
    ...
    public void setAdapter(RecyclerView.Adapter adapter) {
        if (this.f284669f.size() > 0 || this.f284670h.size() > 0) {
            c cVar = new c(adapter);
            Iterator<View> it = this.f284669f.iterator();
            while (it.hasNext()) {
                cVar.l0(it.next());
            }
            Iterator<View> it5 = this.f284670h.iterator();
            while (it5.hasNext()) {
                cVar.k0(it5.next());
            }
