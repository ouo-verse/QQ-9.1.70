...
final class a extends DrawableWrapper {
    ...
    public a(@Nullable Drawable drawable, @NotNull String uin, int i3, @NotNull IFaceDecoder faceDecoder) {
        super(drawable);
