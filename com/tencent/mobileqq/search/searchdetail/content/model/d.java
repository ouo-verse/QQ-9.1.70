...
/* compiled from: P */
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u0000  2\u00020\u0001:\u0001\u000bB\u0017\u0012\u0006\u0010\u001b\u001a\u00020\u001a\u0012\u0006\u0010\u001d\u001a\u00020\u001c\u00a2\u0006\u0004\b\u001e\u0010\u001fJ\u000e\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002J\b\u0010\u0007\u001a\u00020\u0006H\u0016J\u0010\u0010\u000b\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\bH\u0016J\u0017\u0010\f\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\bH\u0016\u00a2\u0006\u0004\b\f\u0010\rR\u0017\u0010\u0013\u001a\u00020\u000e8\u0006\u00a2\u0006\f\n\u0004\b\u000f\u0010\u0010\u001a\u0004\b\u0011\u0010\u0012R\u0017\u0010\u0019\u001a\u00020\u00148\u0006\u00a2\u0006\f\n\u0004\b\u0015\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018\u00a8\u0006!"}, d2 = {"Lcom/tencent/mobileqq/search/searchdetail/content/model/d;", "Lcom/tencent/mobileqq/search/searchdetail/a;", "", "bytesExtension", "", ReportConstant.COSTREPORT_PREFIX, "", "getItemType", "Lcom/tencent/mobileqq/search/searchdetail/c;", "newItem", "", "a", "p", "(Lcom/tencent/mobileqq/search/searchdetail/c;)Ljava/lang/Boolean;", "", tl.h.F, "Ljava/lang/String;", "r", "()Ljava/lang/String;", "text", "Lorg/json/JSONObject;", "i", "Lorg/json/JSONObject;", QCircleScheme.AttrQQPublish.INPUT_TAB_QZONE_TEXT_TAB, "()Lorg/json/JSONObject;", CacheTable.TABLE_NAME, "Lcom/tencent/mobileqq/search/searchdetail/b;", "commonInfo", "Lcom/tencent/qqnt/kernel/nativeinterface/SearchRecommendGuide;", "recommendGuide", "<init>", "(Lcom/tencent/mobileqq/search/searchdetail/b;Lcom/tencent/qqnt/kernel/nativeinterface/SearchRecommendGuide;)V", QCircleScheme.AttrQQPublish.INPUT_TAB_MAGIC_STUDIO, "qqsearch-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes18.dex */
public final class d extends com.tencent.mobileqq.search.searchdetail.a {
    ...
    public d(@NotNull CommonInfo commonInfo, @NotNull SearchRecommendGuide recommendGuide) {
        super(commonInfo);
        Intrinsics.checkNotNullParameter(commonInfo, "commonInfo");
        Intrinsics.checkNotNullParameter(recommendGuide, "recommendGuide");
        this.reportInfo = new JSONObject();
        String text = recommendGuide.getText();
        Intrinsics.checkNotNullExpressionValue(text, "recommendGuide.getText()");
        this.text = text;
    }
    ...
    public boolean a(@NotNull com.tencent.mobileqq.search.searchdetail.c newItem) {
        ...
        if ((newItem instanceof d) && Intrinsics.areEqual(this.text, ((d) newItem).text)) {
            return true;
        }
        return false;
    }
    ...
    public final void s(@NotNull byte[] bytesExtension) {
        ...
        try {
            ...
            QLog.e("NetSearchItemRecommendGuideItem", 1, "initExtension   parseJsonError:" + e16);
        }
    }
}
