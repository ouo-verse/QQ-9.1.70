...
public class r extends ContactSearchEngine {

    /* renamed from: a0, reason: collision with root package name */
    private Comparator<com.tencent.mobileqq.search.model.k> f282997a0;
    ...
    class a implements Comparator<com.tencent.mobileqq.search.model.k> {
        ...
        public int compare(com.tencent.mobileqq.search.model.k kVar, com.tencent.mobileqq.search.model.k kVar2) {
            ...
            boolean E = r.this.E((String) sVar.getUin());
            boolean E2 = r.this.E((String) sVar2.getUin());
            if (!E && !E2) {
                boolean R = r.this.R((String) sVar.getUin());
                boolean R2 = r.this.R((String) sVar2.getUin());
                if (!R && !R2) {
                    T = sVar2.T();
                    T2 = sVar.T();
                } else {
    ...
    public r(AppInterface appInterface, int i3, int i16, String str, Set<String> set) {
        super(appInterface, i3, i16, str, set);
        this.f282997a0 = new a();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public boolean E(String str) {
        return ((IFriendsInfoService) QRoute.api(IFriendsInfoService.class)).isFriend(((IRelationNTUinAndUidApi) QRoute.api(IRelationNTUinAndUidApi.class)).getUidFromUin(str), "TroopBatchAddFrdsMultipleSearchEngine");
    }
