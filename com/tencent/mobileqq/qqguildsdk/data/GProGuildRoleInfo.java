...
public class GProGuildRoleInfo implements IGProGuildRoleInfo {
    ...
    private final GProGuildRole mRole;
    ...
    public ArrayList<String> getApproveSpeakChannels() {
        ...
        while (it.hasNext()) {
            arrayList.add(com.tencent.mobileqq.qqguildsdk.util.g.X0(it.next().longValue()));
        }
        return arrayList;
    }
    ...
    public String getGuildId() {
        return com.tencent.mobileqq.qqguildsdk.util.g.X0(this.mRole.getGuildId());
    }
    ...
    public String getRoleId() {
        return com.tencent.mobileqq.qqguildsdk.util.g.X0(this.mRole.getRoleId());
    }
