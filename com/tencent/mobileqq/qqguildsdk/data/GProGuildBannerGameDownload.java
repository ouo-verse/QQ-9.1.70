...
import com.tencent.qqnt.kernelgpro.nativeinterface.GProGameDownloadLink;
import com.tencent.qqnt.kernelgpro.nativeinterface.GProGuildBannerGameDownloadInfo;
    ...
    public GProGuildBannerGameDownload(GProGuildBannerGameDownloadInfo gProGuildBannerGameDownloadInfo) {
        ...
        if (links != null) {
            ...
            while (it.hasNext()) {
                ...
                ap apVar = new ap();
                apVar.a(next.getPlatform());
                apVar.b(next.getUrl());
                this.links.add(apVar);
            }
        }
