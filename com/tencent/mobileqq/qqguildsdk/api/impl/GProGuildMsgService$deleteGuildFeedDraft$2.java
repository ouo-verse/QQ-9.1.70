...
final class GProGuildMsgService$deleteGuildFeedDraft$2 extends Lambda implements Function2<IKernelGProGuildMsgService, BaseService.b, Unit> {
    ...
    /* renamed from: com.tencent.mobileqq.qqguildsdk.api.impl.GProGuildMsgService$deleteGuildFeedDraft$2$1, reason: invalid class name */
    /* loaded from: classes17.dex */
    ...
    public GProGuildMsgService$deleteGuildFeedDraft$2(String str, int i3, String str2, GProGuildMsgService gProGuildMsgService, IGuildOperateCallback iGuildOperateCallback) {
        super(2);
        this.$draftId = str;
        this.$draftType = i3;
        this.$draftKey = str2;
    ...
    public final void invoke2(@NotNull IKernelGProGuildMsgService service, @NotNull BaseService.b bypass) {
        ...
        service.deleteGuildFeedDraft(str, i3, str2, new IGuildOperateCallback() { // from class: com.tencent.mobileqq.qqguildsdk.api.impl.ct
            @Override // com.tencent.qqnt.kernelgpro.nativeinterface.IGuildOperateCallback
            public final void onResult(int i16, String str3) {
                GProGuildMsgService$deleteGuildFeedDraft$2.b(Function2.this, i16, str3);
            }
        });
    }
}
