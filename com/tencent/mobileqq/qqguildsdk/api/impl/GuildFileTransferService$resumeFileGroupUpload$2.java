...
final class GuildFileTransferService$resumeFileGroupUpload$2 extends Lambda implements Function2<IKernelGuildFileTransferService, BaseService.b, Unit> {
    ...
    /* renamed from: com.tencent.mobileqq.qqguildsdk.api.impl.GuildFileTransferService$resumeFileGroupUpload$2$1, reason: invalid class name */
    /* loaded from: classes17.dex */
    ...
    public GuildFileTransferService$resumeFileGroupUpload$2(String str, GuildFileTransferService guildFileTransferService, IGProTransferFileOperateCallback iGProTransferFileOperateCallback) {
        super(2);
    ...
    public final void invoke2(@NotNull IKernelGuildFileTransferService service, @NotNull BaseService.b bypass) {
        ...
        service.resumeFileGroupUpload(str, new IGProTransferFileOperateCallback() { // from class: com.tencent.mobileqq.qqguildsdk.api.impl.dr
            ...
            public final void onResult(int i3, String str2) {
                GuildFileTransferService$resumeFileGroupUpload$2.b(Function2.this, i3, str2);
            }
        });
    }
}
