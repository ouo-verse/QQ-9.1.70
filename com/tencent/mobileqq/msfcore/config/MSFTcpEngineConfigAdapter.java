...
import com.tencent.mobileqq.msfcore.MSFTcpEngineConfig;
import com.tencent.mobileqq.qfix.redirect.IPatchRedirector;

/* compiled from: P */
/* loaded from: classes15.dex */
public class MSFTcpEngineConfigAdapter extends MSFTcpEngineConfig {
    ...
    public static final int DEFAULT_CONN_MODE = 1;
    public static final boolean DEFAULT_IS_ENABLE_HEARTBEAT_OPT = false;
    public static final double DEFAULT_PARALLEL_CONN_INTERVAL = 3000.0d;
    public static final int DEFAULT_PARALLEL_CONN_NUM = 3;
    public static final int DEFAULT_SERIAL_CONN_NUM = 3;
    ...
    public static class Builder {
        ...
        private final MSFTcpEngineConfig config;
        ...
        public Builder() {
            ...
            MSFTcpEngineConfig mSFTcpEngineConfig = new MSFTcpEngineConfig();
            this.config = mSFTcpEngineConfig;
            mSFTcpEngineConfig.setType(5);
            mSFTcpEngineConfig.setSerialConnNum(3);
            mSFTcpEngineConfig.setParallelConnNum(3);
            mSFTcpEngineConfig.setParallelConnInterval(3000.0d);
            mSFTcpEngineConfig.setConnMode(1);
            mSFTcpEngineConfig.setSideWayConnLimit(0);
            mSFTcpEngineConfig.setIsEnableHearbeatOpt(false);
            mSFTcpEngineConfig.setCheckPingTimeout(15);
            mSFTcpEngineConfig.setActiveCheckPingInterval(45);
            mSFTcpEngineConfig.setBackgroundCheckPingInterval(300);
        }
        ...
        public MSFTcpEngineConfig build() {
            IPatchRedirector iPatchRedirector = $redirector_;
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 12)) {
                return (MSFTcpEngineConfig) iPatchRedirector.redirect((short) 12, (Object) this);
            }
            return this.config;
        }
        ...
        public Builder connMode(int i3) {
            ...
            this.config.setConnMode(i3);
            return this;
        }

        public Builder isEnableHearbeatOpt(boolean z16) {
            IPatchRedirector iPatchRedirector = $redirector_;
        ...
        public Builder parallelConnInterval(double d16) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 5)) {
                return (Builder) iPatchRedirector.redirect((short) 5, this, Double.valueOf(d16));
            }
    ...
    public MSFTcpEngineConfigAdapter() {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, (Object) this);
        }
