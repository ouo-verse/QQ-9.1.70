...
public class MSFSideWayHttpConfig implements MSFConfig {
    ...
    public void setMaxParallelCount(int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 19)) {
            iPatchRedirector.redirect((short) 19, (Object) this, i3);
        } else {
            this.mMaxParallelCount = i3;
        }
    }

    public void setQuickRetryDelay(int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 14)) {
            iPatchRedirector.redirect((short) 14, (Object) this, i3);
        } else {
            this.mQuickRetryDelay = i3;
        }
    }
    ...
    public String toString() {
        ...
        return "MSFSideWayHttpConfig{mType=" + this.mType + ",mIsOpen=" + this.mIsOpen + ",mQuickRetryDelay=" + this.mQuickRetryDelay + ",mSendDelayTimeInXg=" + this.mSendDelayTimeInXg + ",mSendDelayTimeInWiFi=" + this.mSendDelayTimeInWiFi + ",mResendIntervalTimeInXg=" + this.mResendIntervalTimeInXg + ",mResendIntervalTimeInWiFi=" + this.mResendIntervalTimeInWiFi + ",mMaxParallelCount=" + this.mMaxParallelCount + ",mSidewayMode=" + this.mSidewayMode + ",}";
    }

    public MSFSideWayHttpConfig(int i3, boolean z16, int i16, int i17, int i18, int i19, int i26, int i27, int i28) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
            iPatchRedirector.redirect((short) 2, this, Integer.valueOf(i3), Boolean.valueOf(z16), Integer.valueOf(i16), Integer.valueOf(i17), Integer.valueOf(i18), Integer.valueOf(i19), Integer.valueOf(i26), Integer.valueOf(i27), Integer.valueOf(i28));
            return;
        }
        this.mType = i3;
        this.mIsOpen = z16;
        this.mQuickRetryDelay = i16;
        this.mSendDelayTimeInXg = i17;
        this.mSendDelayTimeInWiFi = i18;
        this.mResendIntervalTimeInXg = i19;
        this.mResendIntervalTimeInWiFi = i26;
        this.mMaxParallelCount = i27;
        this.mSidewayMode = i28;
    }
}
