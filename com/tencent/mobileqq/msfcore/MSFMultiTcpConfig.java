...
public class MSFMultiTcpConfig implements MSFConfig {
    ...
    public String toString() {
        ...
        return "MSFMultiTcpConfig{mType=" + this.mType + ",mIsOpen=" + this.mIsOpen + ",mSendDelayTimeInXg=" + this.mSendDelayTimeInXg + ",mSendDelayTimeInWiFi=" + this.mSendDelayTimeInWiFi + ",mResendIntervalTimeInXg=" + this.mResendIntervalTimeInXg + ",mResendIntervalTimeInWiFi=" + this.mResendIntervalTimeInWiFi + ",mSidewayMode=" + this.mSidewayMode + ",}";
    }

    public MSFMultiTcpConfig(int i3, boolean z16, int i16, int i17, int i18, int i19, int i26) {
        IPatchRedirector iPatchRedirector = $redirector_;
