...
public abstract class QIphoneStatusTitleBarFragment extends QPublicBaseFragment {
    static IPatchRedirector $redirector_ = null;
    public static final String HIDE_TITLE_LEFT_ARROW = "hide_title_left_arrow";
    public static final int LAYER_TYPE_SOFTWARE = 1;
    protected static final String TAG = "QIphoneStatusTitleBarFragment";

    /* renamed from: ad, reason: collision with root package name */
    private Drawable f211170ad;
    ...
    protected NavBarCommon f211171vg;
    ...
    class a implements View.OnClickListener {
        ...
        a() {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1, (Object) this, (Object) QIphoneStatusTitleBarFragment.this);
            }
        }
        ...
        public void onClick(View view) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
                ...
                QIphoneStatusTitleBarFragment.this.onBackEvent();
            }
            EventCollector.getInstance().onViewClicked(view);
        }
    }

    public QIphoneStatusTitleBarFragment() {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
    ...
    protected void doOnCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    protected void initTitle(Context context) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 4)) {
            ...
            this.titleRoot.setPadding(0, ImmersiveUtils.getStatusBarHeight(context), 0, 0);
        }
    }
    ...
    public View onCreateLeftView() {
        ...
        BaseAIOUtils.g(textView2, com.tencent.mobileqq.util.x.c(textView2.getContext(), 5.0f));
        ...
        TextView textView3 = this.mLeftBackText;
        if (textView3 != null && imageView != null) {
            textView3.setOnClickListener(this.onBackListener);
    ...
    public final View onCreateView(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
            ...
            View inflate = layoutInflater.inflate(getTitleLayoutId(), viewGroup, false);
            try {
            ...
            try {
                ...
                if (ImmersiveUtils.isSupporImmersive() == 1) {
                    ...
                    initTitle(layoutInflater.getContext());
                }
    ...
    public View setBottomTitleLayoutIdAndInflateIt(String str, int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 35)) {
            return (View) iPatchRedirector.redirect((short) 35, (Object) this, (Object) str, i3);
        }
        return this.f211171vg.setBottomTitleLayoutIdAndInflateIt(str, i3);
    }

    public void setLeftButton(int i3, View.OnClickListener onClickListener) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 23)) {
            iPatchRedirector.redirect((short) 23, (Object) this, i3, (Object) onClickListener);
            return;
        }
    ...
    public void setLeftViewName(Bundle bundle) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 10)) {
            this.f211171vg.setLeftViewName(bundle);
        } else {
    ...
    public void setRightButtonText(String str, View.OnClickListener onClickListener) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 30)) {
            iPatchRedirector.redirect((short) 30, (Object) this, (Object) str, (Object) onClickListener);
            return;
        }
        this.isRightHighlightButton = false;
        this.rightViewText.setVisibility(0);
    ...
    protected void setRightHighlightButton(int i3, View.OnClickListener onClickListener) {
        ...
        if (textView != null) {
            ...
            this.f211171vg.addView(this.rightHighLView, layoutParams);
            this.rightHighLView.setVisibility(8);
            if (onClickListener != null) {
    ...
    protected void setTextWithTalk(TextView textView, int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 29)) {
            iPatchRedirector.redirect((short) 29, (Object) this, (Object) textView, i3);
            return;
        }
        textView.setText(i3);
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 32)) {
            this.f211171vg.setTitle(charSequence);
        } else {
            iPatchRedirector.redirect((short) 32, (Object) this, (Object) charSequence);
        }
    }
    ...
    public boolean startTitleProgress() {
        ...
        if (this.centerView != null && getActivity() != null) {
            ...
            if (this.mUseOptimizMode && this.mLoadingParent != null) {
                ...
                this.f211170ad = getResources().getDrawable(R.drawable.common_loading5);
                ...
                Drawable drawable2 = this.f211170ad;
                ...
                ((Animatable) this.f211170ad).start();
                return true;
            }
        }
        return false;
    ...
    public void setLeftViewName(int i3) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 11)) {
            this.f211171vg.setLeftViewName(i3);
        } else {
    ...
    public void setTitle(CharSequence charSequence, String str) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 33)) {
            this.f211171vg.setTitle(charSequence, str);
        } else {
            iPatchRedirector.redirect((short) 33, (Object) this, (Object) charSequence, (Object) str);
        }
    }
    ...
    public void setTitle(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 34)) {
            this.f211171vg.setTitle(charSequence, charSequence2, charSequence3, charSequence4);
        } else {
            iPatchRedirector.redirect((short) 34, this, charSequence, charSequence2, charSequence3, charSequence4);
        }
    }
    ...
    public void setLeftButton(String str, View.OnClickListener onClickListener) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 24)) {
            iPatchRedirector.redirect((short) 24, (Object) this, (Object) str, (Object) onClickListener);
            return;
        }
        this.leftView.setVisibility(8);
