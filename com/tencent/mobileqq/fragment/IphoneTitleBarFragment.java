...
public abstract class IphoneTitleBarFragment extends PublicBaseFragment {
    ...
    @Deprecated
    protected NavBarCommon f211156vg;
    ...
    class a implements View.OnClickListener {
        ...
        a() {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1, (Object) this, (Object) IphoneTitleBarFragment.this);
            }
        }
        ...
        public void onClick(View view) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 2)) {
                ...
                IphoneTitleBarFragment.this.onBackEvent();
            }
    ...
    public static /* synthetic */ class b {
        ...
        static final /* synthetic */ int[] f211158a;

        static {
            IPatchRedirector redirector = PatchRedirectCenter.getRedirector(72308);
    ...
    private View initQUISecNavBar(LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, Bundle bundle) {
    ...
    private void initSecNavBarClick() {
        this.quiSecNavBar.setOnBaseTitleBarClickListener(new Function2() { // from class: com.tencent.mobileqq.fragment.j
            @Override // kotlin.jvm.functions.Function2
            public final Object invoke(Object obj, Object obj2) {
                Unit lambda$initSecNavBarClick$0;
                lambda$initSecNavBarClick$0 = IphoneTitleBarFragment.this.lambda$initSecNavBarClick$0((View) obj, (BaseAction) obj2);
    ...
    public /* synthetic */ Unit lambda$initSecNavBarClick$0(View view, BaseAction baseAction) {
        if (b.f211158a[baseAction.ordinal()] == 1) {
            onBackEvent();
            return null;
        }
        return null;
    ...
    protected void init(Bundle bundle) {
        ...
        ((FrameLayout) getBaseActivity().findViewById(android.R.id.content)).setForeground(getResources().getDrawable(R.drawable.skin_header_bar_shadow));
        if (isTransparent() && needImmersive() && needStatusTrans() && (parent = getBaseActivity().findViewById(android.R.id.title).getParent()) != null && (parent instanceof FrameLayout)) {
            ((FrameLayout) parent).setVisibility(8);
        }
        if (this.leftView == null) {
            this.f211156vg = (NavBarCommon) this.titleRoot.findViewById(R.id.rlCommenTitle);
            onCreateLeftView();
            try {
    ...
    protected View onCreateLeftView() {
        ...
        if (textView2 != null && imageView != null) {
            ...
            this.mLeftBackIcon.setContentDescription(getResources().getString(R.string.f170549u3));
        }
        this.leftView.setContentDescription(getResources().getString(R.string.f170549u3));
    ...
    public View setBottomTitleLayoutIdAndInflateIt(String str, int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 36)) {
            return (View) iPatchRedirector.redirect((short) 36, (Object) this, (Object) str, i3);
        }
        return this.f211156vg.setBottomTitleLayoutIdAndInflateIt(str, i3);
    }
    ...
    public void setLeftViewName(Bundle bundle) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 11)) {
            this.f211156vg.setLeftViewName(bundle);
        } else {
    ...
    public void setRightButtonText(String str, View.OnClickListener onClickListener) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 31)) {
            iPatchRedirector.redirect((short) 31, (Object) this, (Object) str, (Object) onClickListener);
            return;
        }
        this.isRightHighlightButton = false;
        this.rightViewText.setVisibility(0);
    ...
    protected void setRightHighlightButton(int i3, View.OnClickListener onClickListener) {
        ...
        if (textView != null) {
            ...
            TextView textView2 = (TextView) LayoutInflater.from(getBaseActivity()).inflate(R.layout.custom_commen_title_rightview_highlight, (ViewGroup) null);
            ...
            this.f211156vg.addView(this.rightHighLView, layoutParams);
            this.rightHighLView.setVisibility(8);
            if (onClickListener != null) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void setTextWithTalk(TextView textView, int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 30)) {
            iPatchRedirector.redirect((short) 30, (Object) this, (Object) textView, i3);
            return;
        }
        textView.setText(i3);
    ...
    public void setTitle(CharSequence charSequence) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 33)) {
            iPatchRedirector.redirect((short) 33, (Object) this, (Object) charSequence);
        } else if (useQUISecNavBar() && (qUISecNavBar = this.quiSecNavBar) != null) {
            qUISecNavBar.setCenterText(charSequence);
        } else {
            this.f211156vg.setTitle(charSequence);
        }
    }
    ...
    public boolean startTitleProgress() {
        ...
        if (this.centerView != null && getBaseActivity() != null) {
            View view = null;
            ...
            if (this.mUseOptimizMode && this.mLoadingParent != null) {
                ...
                if (imageView2 == null || imageView2.getVisibility() != 0) {
                    if (this.mLoadingView == null && view != null) {
                        ...
                        ImageView imageView3 = new ImageView(getBaseActivity());
                        ...
                        Drawable drawable = getBaseActivity().getResources().getDrawable(R.drawable.common_loading5);
                ...
                this.f211155ad = getResources().getDrawable(R.drawable.common_loading5);
                ...
                Drawable drawable2 = this.f211155ad;
                ...
                ((Animatable) this.f211155ad).start();
                return true;
            }
        }
        return false;
    ...
    public void setLeftViewName(int i3) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 12)) {
            this.f211156vg.setLeftViewName(i3);
        } else {
    ...
    public void setTitle(CharSequence charSequence, String str) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 34)) {
            this.f211156vg.setTitle(charSequence, str);
        } else {
            iPatchRedirector.redirect((short) 34, (Object) this, (Object) charSequence, (Object) str);
        }
    }
    ...
    public void setTitle(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, CharSequence charSequence4) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 35)) {
            this.f211156vg.setTitle(charSequence, charSequence2, charSequence3, charSequence4);
        } else {
            iPatchRedirector.redirect((short) 35, this, charSequence, charSequence2, charSequence3, charSequence4);
        }
    }
