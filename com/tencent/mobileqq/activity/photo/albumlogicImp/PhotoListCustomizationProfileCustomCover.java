...
public class PhotoListCustomizationProfileCustomCover extends PhotoListCustomizationDefault {
    static IPatchRedirector $redirector_;
    public static final String F;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(68931);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 4)) {
            redirector.redirect((short) 4);
        } else {
            F = PhotoListCustomizationProfileCustomCover.class.getName();
        }
    }

    protected PhotoListCustomizationProfileCustomCover(AbstractPhotoListActivity abstractPhotoListActivity) {
