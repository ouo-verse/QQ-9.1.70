...
public class PhotoListCustomizationLoginAvatar extends PhotoListCustomizationDefault {
    static IPatchRedirector $redirector_;
    public static final String F;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(68927);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 4)) {
            redirector.redirect((short) 4);
        } else {
            F = PhotoListCustomizationLoginAvatar.class.getName();
        }
    }

    protected PhotoListCustomizationLoginAvatar(AbstractPhotoListActivity abstractPhotoListActivity) {
    ...
    public void z0(LocalMediaInfo localMediaInfo, int i3) {
        ...
        this.D.startActivityForResult(intent, 10024);
