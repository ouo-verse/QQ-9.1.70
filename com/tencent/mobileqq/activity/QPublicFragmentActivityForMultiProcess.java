...
public class QPublicFragmentActivityForMultiProcess extends QPublicFragmentActivity {
    static IPatchRedirector $redirector_;

    public QPublicFragmentActivityForMultiProcess() {
    ...
    public static void startForResult(Activity activity, Intent intent, Class<? extends QPublicBaseFragment> cls, int i3) {
        QPublicFragmentActivity.b.e(activity, intent, QPublicFragmentActivityForMultiProcess.class, cls, i3);
    }
