...
public class c extends com.tencent.mobileqq.activity.newsetting.custom.group.a {
    ...
    private com.tencent.mobileqq.activity.newsetting.custom.config.b f183558e;
    ...
    protected Group c() {
        ...
        this.f183558e = new a(new x.b.d(g(R.string.f173110vr1)), new x.c.f(false, null), f());
        return new Group(this.f183558e);
    }
