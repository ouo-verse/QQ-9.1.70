...
public class b extends com.tencent.mobileqq.activity.newsetting.custom.group.a {
    ...
    private com.tencent.mobileqq.activity.newsetting.custom.config.b f183569e;
    ...
    protected Group c() {
        ...
        this.f183569e = new a(new x.b.d(g(R.string.f172976g92)), new x.c.f(false, null), f());
        return new Group("", g(R.string.fui), this.f183569e);
    }
