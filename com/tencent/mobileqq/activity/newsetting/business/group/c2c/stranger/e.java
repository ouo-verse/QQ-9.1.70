...
public class e extends com.tencent.mobileqq.activity.newsetting.custom.group.a {
    ...
    private com.tencent.mobileqq.activity.newsetting.custom.config.b f183596e;
    ...
    protected Group c() {
        ...
        this.f183596e = new a(new x.b.d(g(R.string.a2p)), new x.c.f(false, null), f());
        return new Group(this.f183596e);
    }
