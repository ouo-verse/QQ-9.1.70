...
public class c extends com.tencent.mobileqq.activity.newsetting.custom.group.a {
    ...
    private com.tencent.mobileqq.activity.newsetting.custom.config.b f183571e;
    ...
    protected Group c() {
        ...
        this.f183571e = new a(new x.b.d(g(R.string.fud)), new x.c.f(false, null), f());
        return new Group("", g(R.string.fug), this.f183571e);
    }
