...
public class e extends com.tencent.mobileqq.activity.newsetting.custom.group.a {
    static IPatchRedirector $redirector_;

    /* renamed from: e, reason: collision with root package name */
    private com.tencent.mobileqq.activity.newsetting.custom.config.b f183562e;
    ...
    class a extends com.tencent.mobileqq.activity.newsetting.custom.config.b<x.b.d, x.c.C8997c> {
        ...
        a(x.b bVar, x.c cVar, QUIListItemAdapter qUIListItemAdapter) {
            ...
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1, this, e.this, bVar, cVar, qUIListItemAdapter);
            }
        }
    }
    ...
    protected Group c() {
        ...
        this.f183562e = new a(new x.b.d(g(R.string.f173113vr4)), new x.c.f(false, null), f());
        return new Group(this.f183562e);
    }
