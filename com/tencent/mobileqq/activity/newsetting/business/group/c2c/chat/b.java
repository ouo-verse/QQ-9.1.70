...
public class b extends com.tencent.mobileqq.activity.newsetting.custom.group.a {
    ...
    private com.tencent.mobileqq.activity.newsetting.custom.config.b f183515e;
    ...
    public Group c() {
        ...
        this.f183515e = new a(new x.b.d(g(R.string.f225296l9)), new x.c.g("", true, false), f());
        return new Group(this.f183515e);
    }
