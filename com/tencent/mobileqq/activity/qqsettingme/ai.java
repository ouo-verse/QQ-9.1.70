...
public class ai extends com.tencent.mobileqq.processor.c {
    static IPatchRedirector $redirector_;

    /* renamed from: h, reason: collision with root package name */
    public MutableLiveData<com.tencent.mobileqq.activity.qqsettingme.bean.i> f184804h;

    /* renamed from: i, reason: collision with root package name */
    private boolean f184805i;

    /* renamed from: j, reason: collision with root package name */
    private final IVasLiangNum.b f184806j;
    ...
    class b implements Observer<com.tencent.mobileqq.activity.qqsettingme.bean.i> {
        ...
        final /* synthetic */ com.tencent.mobileqq.qqsettingme.a f184808d;

        b(com.tencent.mobileqq.qqsettingme.a aVar) {
            this.f184808d = aVar;
            IPatchRedirector iPatchRedirector = $redirector_;
            if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                iPatchRedirector.redirect((short) 1, (Object) this, (Object) ai.this, (Object) aVar);
            }
        }
        ...
        public void onChanged(com.tencent.mobileqq.activity.qqsettingme.bean.i iVar) {
            ...
            this.f184808d.L(iVar);
            if (this.f184808d.k() != null) {
                this.f184808d.k().N.postValue(iVar);
            }
        }
    }
    ...
    public ai() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            ...
            this.f184804h = new MutableLiveData<>();
            this.f184806j = new a();
        }
    }
    ...
    private boolean m() {
        ...
        if (isEnable && selfLiangId > 0) {
            ...
            if (businessInstance.isFileExists(selfLiangId)) {
                iVar.f184913d = com.tencent.cachedrawable.dynamicdrawable.api.a.a().d(businessInstance.getSavePath(selfLiangId) + "/lianghao.png").a();
                this.f184804h.postValue(iVar);
                return true;
            }
    ...
    public void d(com.tencent.mobileqq.qqsettingme.a aVar) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
            ...
            this.f184804h.observe(this.f259743d, new b(aVar));
        }
    }
    ...
    public void e() {
        ...
        iVar.f184912c = VasApngUtil.getApngURLDrawable(iVar.f184911b.logoUrl, new int[]{1}, com.tencent.mobileqq.urldrawable.b.f306350a, null, null);
    ...
    public void onDestroy() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 5)) {
            ...
            super.onDestroy();
            ((IVasLiangNum) QRoute.api(IVasLiangNum.class)).unregisterLiangIdChangedListener(this.f184806j);
        }
    }
    ...
    public void preload() {
        ...
        super.preload();
        ((IVasLiangNum) QRoute.api(IVasLiangNum.class)).registerLiangIdChangedListener(this.f184806j);
        m();
    }
