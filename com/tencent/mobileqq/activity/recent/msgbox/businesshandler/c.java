...
public class c implements b {
    ...
    public String c(AppInterface appInterface, String str) {
        ...
        PublicAccountInfo T = RecentItemPublicAccountChatMsgData.T((QQAppInterface) appInterface, (IPublicAccountDataManager) appInterface.getRuntimeService(IPublicAccountDataManager.class, "all"), str);
        if (T != null) {
            return T.name;
        }
        return "";
