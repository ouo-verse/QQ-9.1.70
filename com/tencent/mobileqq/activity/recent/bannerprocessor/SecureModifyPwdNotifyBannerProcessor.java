...
public class SecureModifyPwdNotifyBannerProcessor extends BaseBannerProcessor implements com.tencent.mobileqq.banner.processor.b {
    static IPatchRedirector $redirector_;

    /* renamed from: d, reason: collision with root package name */
    public static final int f185268d;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(20914);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 10)) {
            redirector.redirect((short) 10);
        } else {
            f185268d = com.tencent.mobileqq.banner.d.f200251d;
        }
    }

    public SecureModifyPwdNotifyBannerProcessor(QBaseActivity qBaseActivity) {
    ...
    public View initBanner(com.tencent.mobileqq.banner.a aVar) {
        ...
        return ((ISafeBlockApi) QRoute.api(ISafeBlockApi.class)).initModifyPwdBanner((BaseQQAppInterface) baseActivity.getAppRuntime(), baseActivity);
    }
    ...
    public void onResume() {
        ...
        ((ISafeBlockApi) QRoute.api(ISafeBlockApi.class)).updateBarDisplayStatus((BaseQQAppInterface) baseActivity.getAppRuntime(), System.currentTimeMillis());
    }
