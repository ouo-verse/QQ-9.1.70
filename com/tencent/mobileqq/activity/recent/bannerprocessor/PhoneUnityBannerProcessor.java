...
public class PhoneUnityBannerProcessor extends BaseBannerProcessor {
    static IPatchRedirector $redirector_;

    /* renamed from: d, reason: collision with root package name */
    public static final int f185250d;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(69223);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 7)) {
            redirector.redirect((short) 7);
        } else {
            f185250d = com.tencent.mobileqq.banner.d.f200250c;
        }
    }

    public PhoneUnityBannerProcessor(QBaseActivity qBaseActivity) {
    ...
    public View initBanner(com.tencent.mobileqq.banner.a aVar) {
        ...
        return com.tencent.mobileqq.app.identity.s.b((QQAppInterface) baseActivity.getAppRuntime(), baseActivity);
    }
