...
public class QPublicFragmentActivityForPeak extends QPublicFragmentActivity {
    static IPatchRedirector $redirector_;

    public QPublicFragmentActivityForPeak() {
    ...
    public static void startForResult(Activity activity, Intent intent, Class<? extends QPublicBaseFragment> cls, int i3) {
        QPublicFragmentActivity.b.e(activity, intent, QPublicFragmentActivityForPeak.class, cls, i3);
    }
