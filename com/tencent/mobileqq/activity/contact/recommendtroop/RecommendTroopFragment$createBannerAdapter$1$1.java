...
public final class RecommendTroopFragment$createBannerAdapter$1$1 extends Lambda implements Function3<com.tencent.mobileqq.troop.exp.model.d, com.tencent.mobileqq.troop.exp.model.c, Integer, Unit> {
    static IPatchRedirector $redirector_;
    final /* synthetic */ RecommendTroopFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public RecommendTroopFragment$createBannerAdapter$1$1(RecommendTroopFragment recommendTroopFragment) {
        super(3);
        this.this$0 = recommendTroopFragment;
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, (Object) this, (Object) recommendTroopFragment);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void b(com.tencent.mobileqq.troop.exp.model.c item, RecommendTroopFragment this$0, View view) {
            ...
            if (!startsWith$default) {
                ...
                if (!startsWith$default2) {
                    ...
                    if (startsWith$default3) {
                        ...
                        Intent intent = new Intent("android.intent.action.DIAL", Uri.parse(WebView.SCHEME_TEL + substring));
    ...
    public final void invoke(@NotNull com.tencent.mobileqq.troop.exp.model.d holder, @NotNull final com.tencent.mobileqq.troop.exp.model.c item, int i3) {
        ...
        holder.n(requireContext, item.a());
        holder.l().setFocusable(true);
        int i16 = i3 + 1;
        holder.l().setContentDescription("\u5e7f\u544a" + i16);
        ImageView l3 = holder.l();
        final RecommendTroopFragment recommendTroopFragment = this.this$0;
        l3.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.activity.contact.recommendtroop.j
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                RecommendTroopFragment$createBannerAdapter$1$1.b(com.tencent.mobileqq.troop.exp.model.c.this, recommendTroopFragment, view);
            }
        });
        RecommendTroopFragment recommendTroopFragment2 = this.this$0;
        ...
        RecommendTroopFragment.Oh(recommendTroopFragment2, l16, null, str, mapOf, ExposurePolicy.REPORT_ALL, null, ClickPolicy.REPORT_ALL, 34, null);
    }
}
