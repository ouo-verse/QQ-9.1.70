...
@DebugMetadata(c = "com.tencent.mobileqq.activity.contact.addcontact.addcontactv2.view.AddContactMoreFragment$initObserver$3", f = "AddContactMoreFragment.kt", i = {}, l = {360}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes10.dex */
public final class AddContactMoreFragment$initObserver$3 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public static final class a implements FlowCollector<com.tencent.mobileqq.activity.contact.addcontact.addcontactv2.viewmodel.c> {
        ...
        final /* synthetic */ AddContactMoreFragment f180906d;

        public a(AddContactMoreFragment addContactMoreFragment) {
            this.f180906d = addContactMoreFragment;
        ...
        public Object emit(com.tencent.mobileqq.activity.contact.addcontact.addcontactv2.viewmodel.c cVar, @NotNull Continuation<? super Unit> continuation) {
            ...
            addContactListAdapterV2 = this.f180906d.adapter;
            if (addContactListAdapterV2 == null) {
                Intrinsics.throwUninitializedPropertyAccessException("adapter");
                addContactListAdapterV2 = null;
            }
            addContactListAdapterV2.k0(cVar2);
    ...
    public AddContactMoreFragment$initObserver$3(AddContactMoreFragment addContactMoreFragment, Continuation<? super AddContactMoreFragment$initObserver$3> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        ...
        return new AddContactMoreFragment$initObserver$3(this.this$0, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
            ...
            if (i3 != 0) {
                ...
                ResultKt.throwOnFailure(obj);
                Lh = this.this$0.Lh();
                SharedFlow<com.tencent.mobileqq.activity.contact.addcontact.addcontactv2.viewmodel.c> S1 = Lh.S1();
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Unit> continuation) {
        IPatchRedirector iPatchRedirector = $redirector_;
        return (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 4)) ? ((AddContactMoreFragment$initObserver$3) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE) : iPatchRedirector.redirect((short) 4, (Object) this, (Object) coroutineScope, (Object) continuation);
    }
}
