...
public class b implements IPbSendReqHandler {
    ...
    public msg_svc$PbSendMsgReq handlePbSendMsg(AppInterface appInterface, MessageRecord messageRecord, im_msg_body$RichText im_msg_body_richtext, int i3, msg_svc$PbSendMsgReq msg_svc_pbsendmsgreq) {
        ...
        im_msg_body$Elem c16 = com.tencent.mobileqq.dating.f.c(messageRecord);
        if (c16 != null) {
            if (QLog.isColorLevel()) {
                QLog.d(LogTag.NEARBY_RANK, 2, "clearingElem has carry, elem:" + c16.near_by_msg.uint32_type.get());
            }
            im_msg_body_richtext.elems.add(c16);
        }
