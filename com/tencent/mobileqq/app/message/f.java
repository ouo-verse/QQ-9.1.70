...
public class f extends DatalineMessageManager {
    static IPatchRedirector $redirector_;

    public f(QQAppInterface qQAppInterface, QQMessageFacade qQMessageFacade) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            ...
            this.f195837f = AppConstants.DATALINE_PHONE_UIN;
            this.f195838h = 6005;
        }
    }
    ...
    public long a(DataLineMsgRecord dataLineMsgRecord, boolean z16) {
        ...
        if (dataLineMsgRecord != null) {
            ...
            dataLineMsgRecord.dataline_type = 2;
        }
    ...
    protected DataLineMsgProxy c() {
        ...
        return this.f195835d.getDataLineMsgProxy(2);
    }
    ...
    protected void p() {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
            ...
            ((DataLineHandler) this.f195835d.getBusinessHandler(BusinessHandlerFactory.DATALINE_HANDLER)).z4(false);
        }
    }
}
