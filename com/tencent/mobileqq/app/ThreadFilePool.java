...
public class ThreadFilePool extends ThreadSmartPool {
    ...
    public static final String TAG = "thread_sp_file_";

    static {
        int i3;
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(41019);
    ...
    ThreadFilePool(BlockingQueue<Runnable> blockingQueue, PriorityThreadFactory priorityThreadFactory) {
    ...
    public static ThreadSmartPool createThreadPool() {
        return new ThreadFilePool(new LinkedBlockingQueue(BLOCKING_QUEUE_SIZE), new PriorityThreadFactory(TAG, 2));
    }
