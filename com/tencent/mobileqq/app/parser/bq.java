...
public class bq extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        bp bpVar = new bp((QQAppInterface) baseQQAppInterface, context);
        bpVar.f307438c = str;
        bpVar.f307439d = jumpParserResult.getServer();
        bpVar.f307440e = jumpParserResult.getAction();
