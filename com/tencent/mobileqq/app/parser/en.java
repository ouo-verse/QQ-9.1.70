...
public class en extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        em emVar = new em((QQAppInterface) baseQQAppInterface, context);
        emVar.f307438c = str;
        emVar.f307439d = "vasvip";
        emVar.f307440e = TabDataHelper.SCENE_ASSISTANT_SETTING;
        return emVar;
    }
}
