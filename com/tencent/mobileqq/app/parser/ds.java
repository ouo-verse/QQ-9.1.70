...
public class ds extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        dr drVar = new dr((QQAppInterface) baseQQAppInterface, context);
        drVar.f307438c = str;
        drVar.f307439d = "schedule";
        drVar.f307440e = MiniChatConstants.MINI_APP_SHOW_DETAIL;
