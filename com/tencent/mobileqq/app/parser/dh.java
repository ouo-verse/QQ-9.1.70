...
public class dh extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        dg dgVar = new dg((QQAppInterface) baseQQAppInterface, context);
        dgVar.f307438c = str;
        dgVar.f307439d = "qzone";
        dgVar.f307440e = "open_homepage";
