...
public class dq extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        dp dpVar = new dp((QQAppInterface) baseQQAppInterface, context);
        dpVar.f307438c = str;
        if (jumpParserResult != null) {
            dpVar.f307439d = jumpParserResult.getServer();
            dpVar.f307440e = jumpParserResult.getAction();
            dpVar.s(jumpParserResult.getParamMap());
        }
        return dpVar;
    }
}
