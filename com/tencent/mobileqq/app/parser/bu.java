...
public class bu extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        bt btVar = new bt((QQAppInterface) baseQQAppInterface, context);
        btVar.f307438c = str;
        if (jumpParserResult != null) {
            btVar.f307439d = jumpParserResult.getServer();
            btVar.f307440e = jumpParserResult.getAction();
            btVar.s(jumpParserResult.getParamMap());
        }
        return btVar;
    }
}
