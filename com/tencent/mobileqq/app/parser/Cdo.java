...
/* compiled from: P */
/* renamed from: com.tencent.mobileqq.app.parser.do, reason: invalid class name */
...
public class Cdo extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        dn dnVar = new dn((QQAppInterface) baseQQAppInterface, context);
        dnVar.f307438c = str;
        dnVar.f307439d = "qzone";
        dnVar.f307440e = "to_redpocket_share";
        return dnVar;
    }
}
