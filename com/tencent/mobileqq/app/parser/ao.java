...
public class ao extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        an anVar = new an((QQAppInterface) baseQQAppInterface, context);
        anVar.f307438c = str;
        anVar.f307439d = "huayang";
        anVar.f307440e = "open";
        ...
        for (String str2 : split[1].split(ContainerUtils.FIELD_DELIMITER)) {
            ...
            if (split2.length == 2) {
                try {
                    ...
                    split2[1] = decode;
                    anVar.r(split2[0], decode);
                } catch (Exception e16) {
                    if (QLog.isColorLevel()) {
                        QLog.d("HuaYangParser", 2, "failed to decode param value,tmps[1] is:" + split2[0] + ",tmps[1] is:" + split2[1], e16);
                    }
                }
            }
        }
