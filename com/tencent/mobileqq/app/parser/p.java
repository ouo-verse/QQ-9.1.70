...
public class p extends av {
    ...
    public com.tencent.mobileqq.utils.ax a(BaseQQAppInterface baseQQAppInterface, Context context, String str, JumpParserResult jumpParserResult) {
        ...
        if (str.startsWith("mqqapi://webcustomheight")) {
            o oVar = new o((QQAppInterface) baseQQAppInterface, context);
            oVar.f307438c = str;
            oVar.f307439d = "webcustomheight";
            if (str.startsWith("mqqapi://webcustomheight/jump")) {
                oVar.f307440e = "jump";
            }
