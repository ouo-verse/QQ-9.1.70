...
public class t implements IRichTextAndMsgViaProvider {
    ...
    public Object[] getRichTextAndMsgViaFromMessageRecord(AppInterface appInterface, MessageRecord messageRecord, im_msg_body$RichText im_msg_body_richtext, int i3) {
        ...
        if (messageRecord.msgtype == -1051) {
            im_msg_body_richtext = com.tencent.mobileqq.service.message.p.q((MessageForLongTextMsg) messageRecord, true);
        }
