...
public class p implements IRichTextAndMsgViaProvider {
    ...
    public Object[] getRichTextAndMsgViaFromMessageRecord(AppInterface appInterface, MessageRecord messageRecord, im_msg_body$RichText im_msg_body_richtext, int i3) {
        ...
        if (messageRecord.msgtype == -1049) {
            ...
            im_msg_body_richtext = com.tencent.mobileqq.service.message.p.z(messageForReplyText);
            i3 = messageForReplyText.msgVia;
        }
