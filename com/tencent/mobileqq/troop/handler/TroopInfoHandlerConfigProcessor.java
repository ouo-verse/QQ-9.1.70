...
public class TroopInfoHandlerConfigProcessor extends l<a> {
    static IPatchRedirector $redirector_;

    public TroopInfoHandlerConfigProcessor() {
    ...
    public a migrateOldOrDefaultContent(int i3) {
        ...
        QLog.d("TroopInfoHandlerConfigProcessor", 2, "migrateOldOrDefaultContent, type = " + i3);
        return new a();
    }
    ...
    public void onReqFailed(int i3) {
        ...
        QLog.d("TroopInfoHandlerConfigProcessor", 1, "onReqFailed, failCode = " + i3);
    }
    ...
    public int type() {
        ...
        return TMAssistantDownloadErrorCode.DOWNLOAD_ERR_KNOWN_LENGTH_CHECK_ERROR;
    }
}
