...
public class JoinTroopSecurityTipsConfigProcessor extends l<a> {
    static IPatchRedirector $redirector_;

    public JoinTroopSecurityTipsConfigProcessor() {
    ...
    public a migrateOldOrDefaultContent(int i3) {
        ...
        QLog.d("JoinTroopSecurityTipsConfigProcessor", 2, "migrateOldOrDefaultContent, type = " + i3);
        return new a();
    }
    ...
    public a onParsed(ai[] aiVarArr) {
        ...
        if (aiVarArr != null && aiVarArr.length > 0) {
            return a.d(aiVarArr[0].f202268b);
        }
        return null;
    }
    ...
    public void onReqFailed(int i3) {
        ...
        QLog.d("JoinTroopSecurityTipsConfigProcessor", 1, "onReqFailed, failCode = " + i3);
    }
