...
public class a {
    ...
    public static List<oidb_0x9fb$Label> a(List<oidb_0x935$Label> list) {
        ...
        for (oidb_0x935$Label oidb_0x935_label : list) {
            ...
            oidb_0x9fb_label.edging_color.set(b(oidb_0x935_label.edging_color.get()));
            oidb_0x9fb_label.text_color.set(b(oidb_0x935_label.text_color.get()));
    ...
    private static oidb_0x9fb$Color b(oidb_0x935$Color oidb_0x935_color) {
