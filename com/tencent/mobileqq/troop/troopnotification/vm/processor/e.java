...
/* compiled from: P */
@Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\f\u0010\rJ\b\u0010\u0003\u001a\u00020\u0002H\u0016J\b\u0010\u0005\u001a\u00020\u0004H\u0016J\u0016\u0010\n\u001a\u00020\t2\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0016J\u0016\u0010\u000b\u001a\u00020\t2\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0016\u00a8\u0006\u000e"}, d2 = {"Lcom/tencent/mobileqq/troop/troopnotification/vm/processor/e;", "Lcom/tencent/mobileqq/troop/troopnotification/vm/processor/d;", "", "getTitle", "", "getCategory", "", "Lcom/tencent/qqnt/notification/f;", "notificationList", "", "b", "c", "<init>", "()V", "qqtroop-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class e implements d {
    ...
    public boolean b(@NotNull List<com.tencent.qqnt.notification.f> notificationList) {
        ...
        if (iTroopNotificationInnerService != null) {
            i3 = iTroopNotificationInnerService.getNotificationUnreadUnhandledCount();
        } else {
            i3 = 0;
        }
        if (i3 <= 0) {
    ...
    public String getTitle() {
        ...
        ITroopNotificationInnerService iTroopNotificationInnerService = (ITroopNotificationInnerService) bg.l(ITroopNotificationInnerService.class);
        if (iTroopNotificationInnerService != null) {
            i3 = iTroopNotificationInnerService.getNotificationUnhandledCount();
        } else {
            i3 = 0;
        }
        if (i3 > 0) {
            return HardCodeUtil.qqStr(R.string.f235217b2) + "(" + i3 + ")";
        }
        String qqStr = HardCodeUtil.qqStr(R.string.f235217b2);
        Intrinsics.checkNotNullExpressionValue(qqStr, "{\n            HardCodeUt\u2026ication_undeal)\n        }");
        return qqStr;
    }
}
