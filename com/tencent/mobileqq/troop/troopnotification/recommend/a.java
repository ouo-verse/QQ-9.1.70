...
public final class a extends t<Object> {
    ...
    protected boolean isForViewType(@NotNull Object item, @NotNull List<Object> items, int position) {
        ...
        if (item == TroopNotifyWithRecommendPlaceHolder.SHOW_EMPTY_NOTIFICATION) {
            return true;
        }
        return false;
    }
