package com.tencent.mobileqq.troop.jointype.view;
...
public final class TroopJoinTypeFloatingView extends QUSHalfScreenFloatingView {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public TroopJoinTypeFloatingView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
    ...
    public /* synthetic */ TroopJoinTypeFloatingView(Context context, AttributeSet attributeSet, int i3, int i16, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    @JvmOverloads
    public TroopJoinTypeFloatingView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i3) {
