...
public class TroopAssociationsEntryConfigProcessor extends l<a> {
    static IPatchRedirector $redirector_;

    public TroopAssociationsEntryConfigProcessor() {
    ...
    public a migrateOldOrDefaultContent(int i3) {
        ...
        QLog.d("TroopAssociationsEntryConfigProcessor", 2, "migrateOldOrDefaultContent, type: " + i3);
        return new a();
    }
    ...
    public void onReqFailed(int i3) {
        ...
        QLog.d("TroopAssociationsEntryConfigProcessor", 1, "onReqFailed, failCode = " + i3);
    }
    ...
    public int type() {
        ...
        return LpReportInfoConfig.ACTION_TYPE_DAWANG;
    }
}
