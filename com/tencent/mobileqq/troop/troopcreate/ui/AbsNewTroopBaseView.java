...
public abstract class AbsNewTroopBaseView extends FrameLayout {
    ...
    public QBaseActivity f300107d;

    /* renamed from: e, reason: collision with root package name */
    protected AppInterface f300108e;

    public AbsNewTroopBaseView(Context context) {
        super(context);
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 1)) {
            this.f300108e = (AppInterface) MobileQQ.sMobileQQ.waitAppRuntime(null);
        } else {
    ...
    public AbsNewTroopBaseView(Context context, AttributeSet attributeSet, int i3) {
