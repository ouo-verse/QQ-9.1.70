...
public class TroopCreditLevelEntryConfigProcessor extends l<a> {
    static IPatchRedirector $redirector_;

    public TroopCreditLevelEntryConfigProcessor() {
    ...
    public a migrateOldOrDefaultContent(int i3) {
        ...
        QLog.d("TroopCreditLevelEntryConfigProcessor", 2, "migrateOldOrDefaultContent, type = " + i3);
        return new a();
    }
    ...
    public a onParsed(ai[] aiVarArr) {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("TroopCreditLevelEntryConfigProcessor", 2, "onParsed");
        }
    ...
    public void onReqFailed(int i3) {
        ...
        QLog.d("TroopCreditLevelEntryConfigProcessor", 1, "onReqFailed, failCode = " + i3);
    }
