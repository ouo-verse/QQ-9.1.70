...
public class ShortcutBarInfo implements Serializable {
    ...
    public void setShowDel(boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public void setShowFrame(int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public ShortcutBarInfo(long j3, String str, String str2, int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
