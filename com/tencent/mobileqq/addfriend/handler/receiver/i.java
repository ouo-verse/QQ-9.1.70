...
public final class i extends a<NTAddFriendHandler> {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/mobileqq/addfriend/handler/receiver/i$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "qqaddfriend-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.addfriend.handler.receiver.i$a, reason: from kotlin metadata */
    /* loaded from: classes10.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(21919);
    ...
    public i(@NotNull AppInterface appRuntime, @NotNull NTAddFriendHandler handler) {
    ...
    private final void e(com.tencent.qqnt.remote.d toNTMsg, com.tencent.qqnt.remote.b fromNTMsg) {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("NTGetAutoInfoReceiver", 2, "handleGetAutoInfo resultCode:" + fromNTMsg.b() + " msg:" + fromNTMsg.c());
        }
        Bundle a16 = toNTMsg.a();
        Object a17 = fromNTMsg.a();
        if (a17 instanceof SmartRsp) {
            smartRsp = (SmartRsp) a17;
        } else {
            smartRsp = null;
        }
        if (fromNTMsg.b() == 0 && smartRsp != null) {
            a16.putInt("group_id", smartRsp.groupId);
            a16.putString(IQzoneWebViewPluginHelper.EXTRA_FAMOUS_SHARE_NICKNAME, smartRsp.remark);
            NTAddFriendHandler c16 = c();
            if (c16 != null) {
                c16.notifyUI(5, true, a16);
                return;
            }
            return;
        }
    ...
    public String b() {
        ...
        return com.tencent.mobileqq.addfriend.api.a.INSTANCE.d();
    }
