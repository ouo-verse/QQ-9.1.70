...
public final class bs extends bv {
    ...
    public Group x() {
        ...
        arrayList.addAll(new DataManageEssenceShowConfigList(b(), c(), e(), h(), d()).z().a());
        arrayList.addAll(new GameInfoDisplayConfigList(b(), c(), e(), h(), d(), 1).D().a());
