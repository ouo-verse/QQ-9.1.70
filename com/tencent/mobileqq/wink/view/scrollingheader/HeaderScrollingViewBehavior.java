...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
    ...
    private int f327095l;

    /* renamed from: m, reason: collision with root package name */
    private int f327096m;

    public HeaderScrollingViewBehavior() {
        this.f327093j = new Rect();
        this.f327094k = new Rect();
        this.f327095l = 0;
    }
    ...
    public void layoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, int i3) {
        ...
        if (findFirstDependency != null) {
            ...
            this.f327095l = rect2.top - findFirstDependency.getBottom();
            return;
        }
