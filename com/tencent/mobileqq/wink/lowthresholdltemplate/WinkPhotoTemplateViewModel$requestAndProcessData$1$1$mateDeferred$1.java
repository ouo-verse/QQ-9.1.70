...
@DebugMetadata(c = "com.tencent.mobileqq.wink.lowthresholdltemplate.WinkPhotoTemplateViewModel$requestAndProcessData$1$1$mateDeferred$1", f = "WinkPhotoTemplateViewModel.kt", i = {}, l = {114}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes21.dex */
final class WinkPhotoTemplateViewModel$requestAndProcessData$1$1$mateDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Pair<? extends MetaMaterial, ? extends Long>>, Object> {
    ...
    public WinkPhotoTemplateViewModel$requestAndProcessData$1$1$mateDeferred$1(WinkPhotoTemplateViewModel winkPhotoTemplateViewModel, String str, Ref.BooleanRef booleanRef, Continuation<? super WinkPhotoTemplateViewModel$requestAndProcessData$1$1$mateDeferred$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WinkPhotoTemplateViewModel$requestAndProcessData$1$1$mateDeferred$1(this.this$0, this.$templateId, this.$needDownLoadTemplate, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i3 != 0) {
                ...
                this.label = 1;
                obj = winkPhotoTemplateViewModel.Q1(str, this);
    ...
    public final Object invoke2(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Pair<MetaMaterial, Long>> continuation) {
        return ((WinkPhotoTemplateViewModel$requestAndProcessData$1$1$mateDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
