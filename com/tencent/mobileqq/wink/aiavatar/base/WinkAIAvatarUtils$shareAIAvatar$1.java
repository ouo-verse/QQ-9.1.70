...
public final class WinkAIAvatarUtils$shareAIAvatar$1 extends Lambda implements Function2<String, Boolean, Unit> {
    final /* synthetic */ Function0<Unit> $shareCallback;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public WinkAIAvatarUtils$shareAIAvatar$1(Function0<Unit> function0) {
        super(2);
    ...
    public static final void b(String shareType, boolean z16, Function0 shareCallback) {
        ...
        w53.b.a("WinkAIAvatarUtils", "shareAIAvatarPage shareType: " + shareType + ", success:" + z16);
    ...
    public final void invoke(@NotNull final String shareType, final boolean z16) {
        ...
        uIHandlerV2.post(new Runnable() { // from class: com.tencent.mobileqq.wink.aiavatar.base.g
            @Override // java.lang.Runnable
            public final void run() {
                WinkAIAvatarUtils$shareAIAvatar$1.b(shareType, z16, function0);
            }
        });
    }
}
