...
@DebugMetadata(c = "com.tencent.mobileqq.wink.preview.viewmodel.WinkBasePreviewShareViewModel$requestAndProcessData$1$1$mateDeferred$1", f = "WinkBasePreviewShareViewModel.kt", i = {}, l = {119}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes21.dex */
final class WinkBasePreviewShareViewModel$requestAndProcessData$1$1$mateDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Pair<? extends MetaMaterial, ? extends Long>>, Object> {
    ...
    public WinkBasePreviewShareViewModel$requestAndProcessData$1$1$mateDeferred$1(WinkBasePreviewShareViewModel winkBasePreviewShareViewModel, Ref.BooleanRef booleanRef, Continuation<? super WinkBasePreviewShareViewModel$requestAndProcessData$1$1$mateDeferred$1> continuation) {
    ...
    public final Continuation<Unit> create(@Nullable Object obj, @NotNull Continuation<?> continuation) {
        return new WinkBasePreviewShareViewModel$requestAndProcessData$1$1$mateDeferred$1(this.this$0, this.$needDownLoadTemplate, continuation);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            ...
            throw new WinkSharePreviewException(3, e16);
        }
    }
    ...
    public final Object invoke2(@NotNull CoroutineScope coroutineScope, @Nullable Continuation<? super Pair<MetaMaterial, Long>> continuation) {
        return ((WinkBasePreviewShareViewModel$requestAndProcessData$1$1$mateDeferred$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
