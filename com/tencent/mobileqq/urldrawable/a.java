...
public abstract class a implements DownloadParams.DecodeHandler {
    static IPatchRedirector $redirector_;

    /* renamed from: a, reason: collision with root package name */
    private static String f306321a;

    /* renamed from: b, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306322b;

    /* renamed from: c, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306323c;

    /* renamed from: d, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306324d;

    /* renamed from: e, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306325e;

    /* renamed from: f, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306326f;

    /* renamed from: g, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306327g;

    /* renamed from: h, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306328h;

    /* renamed from: i, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306329i;

    /* renamed from: j, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306330j;

    /* renamed from: k, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306331k;

    /* renamed from: l, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306332l;

    /* renamed from: m, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306333m;

    /* renamed from: n, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306334n;

    /* renamed from: o, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306335o;

    /* renamed from: p, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306336p;

    /* renamed from: q, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306337q;

    /* renamed from: r, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306338r;

    /* renamed from: s, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306339s;

    /* renamed from: t, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306340t;

    /* renamed from: u, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306341u;

    /* renamed from: v, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306342v;

    /* renamed from: w, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306343w;

    /* renamed from: x, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306344x;

    /* renamed from: y, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306345y;

    /* renamed from: z, reason: collision with root package name */
    public static final DownloadParams.DecodeHandler f306346z;

    /* compiled from: P */
    /* renamed from: com.tencent.mobileqq.urldrawable.a$a, reason: collision with other inner class name */
    /* loaded from: classes20.dex */
    class C8884a implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;
            ...
            if (obj instanceof int[]) {
                ...
                if (iArr.length == 4) {
                    ...
                    if (bitmap == null && QLog.isDevelopLevel()) {
                        QLog.w(a.f306321a, 2, "ROUND_CORNER_DECODER bitmap == null");
                    }
                }
            }
            return bitmap;
                    ...
                    if (iArr.length == 4) {
                        ...
                        if (i17 > 0 && i18 > 0) {
                            ...
                            try {
                                ...
                                a.e(matrix, bitmap.getWidth(), bitmap.getHeight(), i17, i18, i3, i16);
    ...
    class d implements DownloadParams.DecodeHandler {
        ...
        public Bitmap run(DownloadParams downloadParams, Bitmap bitmap) {
            ...
            if (bitmap != null) {
                Object obj = downloadParams.tag;
                if (GdtSmartBlur.b().f109538a && (obj instanceof int[])) {
                    int[] iArr = (int[]) obj;
                    if (iArr.length == 1) {
                        GdtSmartBlur.b().a(bitmap, iArr[0]);
                    }
                }
            }
            return bitmap;
            ...
            if (obj instanceof int[]) {
                ...
                if (iArr.length == 6) {
                    ...
                    if (QLog.isColorLevel()) {
                        QLog.i(a.f306321a, 2, String.format("CUSTOM_CLIP_DECODER [%d,%d,%d,%d,%d,%d] valid=%b", Integer.valueOf(i16), Integer.valueOf(i17), Integer.valueOf(i18), Integer.valueOf(i19), Integer.valueOf(i26), Integer.valueOf(i27), Boolean.valueOf(z16)));
                    }
                    if (!z16 && i26 > 0 && i27 > 0) {
                        float f16 = i26 / i27;
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.i(a.f306321a, 2, String.format("CUSTOM_CLIP_DECODER centerCrop %s", rect.toShortString()));
                    ...
                    if (z16) {
                        ...
                        if (QLog.isColorLevel()) {
                            QLog.i(a.f306321a, 2, String.format("CUSTOM_CLIP_DECODER [w,h]=[%d,%d] dstClip=%s sample=%d", Integer.valueOf(bitmap.getWidth()), Integer.valueOf(bitmap.getHeight()), rect2, Integer.valueOf(i3)));
                        }
    ...
    class m implements DownloadParams.DecodeHandler {
        ...
        public Bitmap run(DownloadParams downloadParams, Bitmap bitmap) {
            ...
            try {
                ...
                if (QLog.isColorLevel()) {
                    QLog.d(a.f306321a, 2, String.format("ALIGN_TOP_DECODER srcHeight = %s, srcWidth = %s, reqWidth = %s, reqHeight = %s, scale = %s", Integer.valueOf(height), Integer.valueOf(width), Integer.valueOf(i3), Integer.valueOf(i16), Float.valueOf(f16)));
                }
                return createBitmap;
            } catch (Exception e16) {
                e16.printStackTrace();
    ...
    /* compiled from: P */
    /* loaded from: classes20.dex */
    class o implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;
    ...
    /* compiled from: P */
    /* loaded from: classes20.dex */
    class t implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;
    ...
    /* compiled from: P */
    /* loaded from: classes20.dex */
    class u implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;
    ...
    /* compiled from: P */
    /* loaded from: classes20.dex */
    class v implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;
    ...
    /* compiled from: P */
    /* loaded from: classes20.dex */
    public static class w implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;

        /* renamed from: a, reason: collision with root package name */
        private int f306347a;
        ...
        public Bitmap run(DownloadParams downloadParams, Bitmap bitmap) {
            ...
            try {
                ...
                eh.a(createBitmap, this.f306347a);
                return createBitmap;
    ...
    /* compiled from: P */
    /* loaded from: classes20.dex */
    public static class x implements DownloadParams.DecodeHandler {
        static IPatchRedirector $redirector_;

        /* renamed from: a, reason: collision with root package name */
        private final int f306348a;

        /* renamed from: b, reason: collision with root package name */
        private final int f306349b;
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(77198);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 2)) {
            redirector.redirect((short) 2);
            return;
        }
        f306321a = "URLDrawableDecodeHandler";
        f306322b = new k();
        f306323c = new o();
        f306324d = new p();
        f306325e = new q();
    ...
    public static int[] b(int i3, int i16, int i17, int i18, int i19, int i26) {
        return new int[]{i3, i16, i17, i18, i19, i26};
    }

    public static final int[] c(int i3, int i16, int i17) {
        return new int[]{i3, i16, i17};
    }

    public static final int[] d(int i3, int i16) {
        return new int[]{i3, i16};
    }

    public static void e(Matrix matrix, int i3, int i16, int i17, int i18, float f16, float f17) {
        float f18;
        float f19;
        float f26;
        if (matrix == null) {
    ...
    public static Bitmap f(Bitmap bitmap) {
        ...
        int height = bitmap.getHeight();
        int i3 = (width * 15) / 16;
        int i16 = (height * 16) / 15;
        if (height > i3) {
            createBitmap = Bitmap.createBitmap(bitmap, 0, (height - i3) / 2, width, i3, (Matrix) null, false);
            bitmap.recycle();
        } else if (width > i16) {
            createBitmap = Bitmap.createBitmap(bitmap, (width - i16) / 2, 0, i16, height, (Matrix) null, false);
            bitmap.recycle();
        } else {
            return bitmap;
        }
