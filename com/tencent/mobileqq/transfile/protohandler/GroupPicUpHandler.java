...
public class GroupPicUpHandler extends PicUpHandler {
    static IPatchRedirector $redirector_ = null;
    private static final String TAG = "GroupPicUpHandler";
    int mReqNetType;
    ...
    private void handleSucResult(StatictisInfo statictisInfo, cmd0x388$TryUpImgRsp cmd0x388_tryupimgrsp, RichProto.RichProtoResp.GroupPicUpResp groupPicUpResp) throws Exception {
        groupPicUpResp.groupFileID = cmd0x388_tryupimgrsp.uint64_fileid.get();
        boolean z16 = false;
        if (cmd0x388_tryupimgrsp.bool_file_exit.has() && cmd0x388_tryupimgrsp.bool_file_exit.get()) {
            ...
            if (list3 != null && list3.size() > 0) {
                for (int i16 = 0; i16 < list3.size(); i16++) {
                    ...
                    groupPicUpResp.mIpList.add(i16, serverAddr2);
                }
            }
            ...
            if (bytes2HexStr != null && !bytes2HexStr.equals("") && list3 != null && list3.size() != 0) {
                groupPicUpResp.mUkey = bytes2HexStr;
                groupPicUpResp.blockSize = (int) cmd0x388_tryupimgrsp.uint64_block_size.get();
                groupPicUpResp.transferedSize = (int) cmd0x388_tryupimgrsp.uint64_up_offset.get();
                if (NetworkCenter.getInstance().getNetType() != this.mReqNetType) {
                    z16 = true;
                }
                groupPicUpResp.networkChange = z16;
                groupPicUpResp.startOffset = cmd0x388_tryupimgrsp.uint64_up_offset.get();
        ...
        setResult(0, 0, "", "", statictisInfo, groupPicUpResp);
    }
    ...
    void addOne(int i3, RichProto.RichProtoReq.ReqCommon reqCommon, cmd0x388$ReqBody cmd0x388_reqbody) {
        ...
        QLog.i(TAG, 1, "addOne, req=" + picUpReq);
    }
    ...
    protected void handleSucResp(FromServiceMsg fromServiceMsg, byte[] bArr, RichProto.RichProtoReq richProtoReq, RichProto.RichProtoResp richProtoResp, StatictisInfo statictisInfo, ProtoReqManagerImpl.ProtoResp protoResp, ProtoReqManagerImpl.ProtoReq protoReq) {
        ...
        String str7;
        String str8;
        RichProto.RichProtoResp.GroupPicUpResp groupPicUpResp2;
        RichProto.RichProtoResp.GroupPicUpResp groupPicUpResp3;
        long j3;
        int i16;
        long j16 = this;
        ...
        try {
            ...
            try {
                if (list != null && list.size() != 0) {
                    GroupPicUpHandler groupPicUpHandler = j16;
                    for (cmd0x388$TryUpImgRsp cmd0x388_tryupimgrsp : list) {
                        try {
                            groupPicUpResp2 = (RichProto.RichProtoResp.GroupPicUpResp) richProtoResp.resps.get((int) cmd0x388_tryupimgrsp.uint64_file_id.get());
                        } catch (Exception e16) {
                            e = e16;
                            i3 = i17;
                            str3 = str10;
                        ...
                        if (groupPicUpResp2 != null) {
                            try {
                                if (fromServiceMsg.getAttributes().containsKey(BaseConstants.ATTRIBUTE_SEND_BY_QUICKHTTP)) {
                                    try {
                                        groupPicUpResp2.isSendByQuickHttp = ((Boolean) fromServiceMsg2.getAttribute(BaseConstants.ATTRIBUTE_SEND_BY_QUICKHTTP, Boolean.FALSE)).booleanValue();
                                    } catch (Exception e17) {
                                        e = e17;
                                        i3 = i17;
                                        str3 = str10;
                                        ...
                                        try {
                                            ...
                                            try {
                                                ...
                                                str7 = str6;
                                                str8 = str5;
                                                setResult(-1, AppConstants.RichMediaErrorCode.ERROR_SERVER_BAD_RETCODE, serverReason, sb5.toString(), statictisInfo, groupPicUpResp);
                                                groupPicUpHandler = this;
                                ...
                                e = e26;
                                groupPicUpResp3 = groupPicUpResp2;
                                i3 = i17;
                                str3 = str10;
                                str4 = str9;
                                j3 = -9529;
                            ...
                            if (i16 == 0) {
                                groupPicUpHandler.handleSucResult(statictisInfo, cmd0x388_tryupimgrsp, groupPicUpResp2);
                            } else {
                                if (groupPicUpHandler.shouldRetryByRetCodeForGroup(i16)) {
                                    int i18 = groupPicUpHandler.mReqUrlCount + 1;
                                    groupPicUpHandler.mReqUrlCount = i18;
                                    if (i18 < i17) {
                                ...
                                str4 = str9;
                                try {
                                    setResult(-1, AppConstants.RichMediaErrorCode.ERROR_SERVER_BAD_RETCODE, ProcessorReport.getUrlReason(i16), "", statictisInfo, groupPicUpResp3);
                                    str8 = str3;
                                    str7 = str4;
                                } catch (Exception e27) {
                                    e = e27;
                                    groupPicUpResp = groupPicUpResp3;
                                    j16 = j3;
                                    str5 = str3;
                                    ...
                                    str7 = str6;
                                    str8 = str5;
                                    setResult(-1, AppConstants.RichMediaErrorCode.ERROR_SERVER_BAD_RETCODE, serverReason2, sb52.toString(), statictisInfo, groupPicUpResp);
                                    groupPicUpHandler = this;
                                    fromServiceMsg2 = fromServiceMsg;
                                    i17 = i3;
                                    str9 = str7;
    ...
    void initResps(RichProto.RichProtoReq richProtoReq) {
        ...
        for (int i3 = 0; i3 < richProtoReq.reqs.size(); i3++) {
            richProtoResp.resps.add(i3, new RichProto.RichProtoResp.GroupPicUpResp());
        }
    }
    ...
    public void sendRichProtoReq(RichProto.RichProtoReq richProtoReq) {
        ...
        if (richProtoReq != null && richProtoReq.reqs != null && richProtoReq.protoReqMgr != null) {
            ...
            protoReq.ssoCmd = "ImgStore.GroupPicUp";
