...
public class PAAudioPttDownloadProcessor extends BaseDownloadProcessor {
    static IPatchRedirector $redirector_;
    String mTempPath;

    public PAAudioPttDownloadProcessor(BaseTransFileController baseTransFileController, TransferRequest transferRequest) {
    ...
    public static String getPttPath(AppRuntime appRuntime, String str) {
        return VFSAssistantUtils.getSDKPrivatePath(AppConstants.SDCARD_PATH + Utils.Crc64String(appRuntime.getAccount()) + "/ptt/pa_audio_" + str + ".amr");
    }
