...
public interface INearbySPUtil extends QRouteApi {
    ...
    public static final String SP_KEY_SELF_ADDRESS = "self_address";
    public static final String SP_KEY_SELF_AGE = "self_age";
    public static final String SP_KEY_SELF_AIO_SHIELD_STATUS = "self_aio_shield_status";
    public static final String SP_KEY_SELF_GENDER = "self_gender";
    public static final String SP_KEY_SELF_GOD_FLAG = "self_god_flag";
    public static final String SP_KEY_SELF_NEARBY_SHIELD_STATUS = "self_nearby_shield_status";
    public static final String SP_KEY_SELF_NEARBY_VERITY_URL = "self_nearby_verify_url";
    ...
    public static final String SP_VERSION = "nearby_version_controll";
    ...
    void clearCornerRedDot(String str);

    boolean contains(String str, String str2);

    boolean contains(String str, String str2, int i3, String str3);

    boolean getDatingSessionSwitch(String str);

    boolean getLocVisiblityForPeople(String str);

    SosoLbsInfo getNearbyLastLocation(String str);

    SharedPreferences getSharedPreferences(String str, String str2, int i3);

    int getUnreadCount(String str, String str2);

    Object getValue(SharedPreferences sharedPreferences, String str, Object obj);

    Object getValue(String str, String str2, int i3, String str3, Object obj);

    Object getValue(String str, String str2, Object obj);

    boolean isObtainLocAllowed(String str);

    void preloadNearbyProcessSuc(String str);

    void setNearbyLastLocation(String str, SosoLbsInfo sosoLbsInfo);

    boolean setObtainLocAllowed(String str, boolean z16);

    boolean setValue(SharedPreferences sharedPreferences, String str, Object obj);

    boolean setValue(String str, String str2, int i3, String str3, Object obj);

    boolean setValue(String str, String str2, Object obj);

    boolean setVisibilityForPeople(String str, boolean z16);

    boolean setVoteInfo(String str, long j3, int i3);
}
