...
public final class bi extends com.tencent.mobileqq.part.a {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0006X\u0086T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/mobileqq/parts/bi$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "drawer-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.parts.bi$a, reason: from kotlin metadata */
    /* loaded from: classes16.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(28221);
    ...
    private final void G9() {
        ...
        this.nightModeSettingItem = new NightModeSettingItem(activity, lifecycleOwner, R.layout.f168870h42, true);
    ...
    private final void H9() {
        ...
        LifecycleOwner lifecycleOwner = getPartHost().getLifecycleOwner();
        Intrinsics.checkNotNullExpressionValue(lifecycleOwner, "partHost.hostLifecycleOwner");
        NormalSettingItem normalSettingItem2 = new NormalSettingItem(activity, (QQSettingMeViewModel) viewModel, lifecycleOwner, R.layout.f168870h42);
        normalSettingItem2.u(new View.OnClickListener() { // from class: com.tencent.mobileqq.parts.bh
        ...
        normalSettingItem2.v(R.drawable.qui_setting_light);
        View view = this.bottomContainer;
    ...
    public static final void I9(bi this$0, View view) {
    ...
    private final void J9() {
        ...
        LifecycleOwner lifecycleOwner = getPartHost().getLifecycleOwner();
        Intrinsics.checkNotNullExpressionValue(lifecycleOwner, "partHost.hostLifecycleOwner");
        WeatherSettingItem weatherSettingItem2 = new WeatherSettingItem(activity, (QQSettingMeViewModel) viewModel, lifecycleOwner, R.layout.h4a);
        weatherSettingItem2.getRoot().setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.parts.bg
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                bi.K9(bi.this, view);
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void K9(bi this$0, View view) {
        EventCollector.getInstance().onViewClickedBefore(view);
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (!FastClickUtils.isFastDoubleClick("QQSettingMeSettingPart")) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void M9(bi this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public void onInitView(@Nullable View rootView) {
        ...
        if (view2 != null) {
            view2.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.parts.be
                @Override // android.view.View.OnClickListener
    ...
    public void onPartResume(@Nullable Activity activity) {
        ...
        getPartRootView().post(new Runnable() { // from class: com.tencent.mobileqq.parts.bf
    ...
    public void onPostThemeChanged() {
        ...
        View view = this.bottomContainer;
        if (view != null) {
            view.setBackground(getContext().getDrawable(R.drawable.qui_common_fill_light_primary_bg));
        }
    }
}
