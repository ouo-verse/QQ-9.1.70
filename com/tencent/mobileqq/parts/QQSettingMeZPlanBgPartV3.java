...
public final class QQSettingMeZPlanBgPartV3 extends com.tencent.mobileqq.part.a {
    ...
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0006\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0006\u0010\u0007R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004R\u0014\u0010\u0005\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0005\u0010\u0004\u00a8\u0006\b"}, d2 = {"Lcom/tencent/mobileqq/parts/QQSettingMeZPlanBgPartV3$a;", "", "", "FILAMENT_DEFAULT_AVATAR", "Ljava/lang/String;", "TAG", "<init>", "()V", "drawer-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.mobileqq.parts.QQSettingMeZPlanBgPartV3$a, reason: from kotlin metadata */
    /* loaded from: classes16.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(28417);
    ...
    public QQSettingMeZPlanBgPartV3() {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            iPatchRedirector.redirect((short) 1, (Object) this);
        } else {
    ...
    public final void M9() {
        ...
        if (frameLayout2 != null) {
            frameLayout2.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.parts.ce
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    QQSettingMeZPlanBgPartV3.N9(QQSettingMeZPlanBgPartV3.this, view);
                }
            });
        }
        U9();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void N9(QQSettingMeZPlanBgPartV3 this$0, View view) {
    ...
    public final void O9() {
        ...
        if (qUIButton2 != null) {
            qUIButton2.setOnClickListener(new View.OnClickListener() { // from class: com.tencent.mobileqq.parts.cd
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    QQSettingMeZPlanBgPartV3.P9(QQSettingMeZPlanBgPartV3.this, view);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void P9(QQSettingMeZPlanBgPartV3 this$0, View view) {
        EventCollector.getInstance().onViewClickedBefore(view);
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    private final void T9() {
        ...
        DrawerUtils.f306948a.b(this.isDefaultAvatarInit, new Function0<Unit>() { // from class: com.tencent.mobileqq.parts.QQSettingMeZPlanBgPartV3$showDefaultAvatar$1
            static IPatchRedirector $redirector_;
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                ...
                IPatchRedirector iPatchRedirector = $redirector_;
                if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                    iPatchRedirector.redirect((short) 1, (Object) this, (Object) QQSettingMeZPlanBgPartV3.this);
                }
            }
            ...
            public final void invoke2() {
                IPatchRedirector iPatchRedirector = $redirector_;
                if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
                    QQSettingMeZPlanBgPartV3.this.O9();
                } else {
    ...
    public final void V9(boolean needShowBg, boolean needShowZPlan) {
        ...
        if (needShowBg) {
            DrawerUtils.f306948a.b(this.isZPlanContainerInit, new Function0<Unit>() { // from class: com.tencent.mobileqq.parts.QQSettingMeZPlanBgPartV3$updateZPlanContainer$1
                static IPatchRedirector $redirector_;
                ...
                public final void invoke2() {
                    IPatchRedirector iPatchRedirector = $redirector_;
                    if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
                        QQSettingMeZPlanBgPartV3.this.M9();
                    } else {
                        iPatchRedirector.redirect((short) 2, (Object) this);
                    }
                }
    ...
    public void onPartCreate(@Nullable Activity activity, @Nullable Bundle savedInstanceState) {
        ...
        final Function1<Integer, Unit> function1 = new Function1<Integer, Unit>() { // from class: com.tencent.mobileqq.parts.QQSettingMeZPlanBgPartV3$onPartCreate$1
            static IPatchRedirector $redirector_;
            ...
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                ...
                if (iPatchRedirector2 != null && iPatchRedirector2.hasPatch((short) 1)) {
                    iPatchRedirector2.redirect((short) 1, (Object) this, (Object) QQSettingMeZPlanBgPartV3.this);
                }
            }
            ...
            public final void invoke2(Integer num) {
                ...
                frameLayout = QQSettingMeZPlanBgPartV3.this.zPlanContainer;
                drawerUtils.o(frameLayout, num != null && num.intValue() == 0);
            }
        };
        mutableLiveData.observe(lifecycleOwner, new Observer() { // from class: com.tencent.mobileqq.parts.cb
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                QQSettingMeZPlanBgPartV3.Q9(Function1.this, obj);
            }
        });
        ...
        final Function1<Integer, Unit> function12 = new Function1<Integer, Unit>() { // from class: com.tencent.mobileqq.parts.QQSettingMeZPlanBgPartV3$onPartCreate$2
            static IPatchRedirector $redirector_;
            ...
            public final void invoke2(Integer num) {
                ...
                if (num != null && num.intValue() == 0) {
                    QQSettingMeZPlanBgPartV3.this.V9(true, true);
                    return;
                }
                if (num != null && num.intValue() == 1) {
                    QQSettingMeZPlanBgPartV3.this.V9(true, false);
                } else if (num != null && num.intValue() == 2) {
                    QQSettingMeZPlanBgPartV3.this.V9(false, false);
                }
            }
        };
        mutableLiveData2.observe(lifecycleOwner2, new Observer() { // from class: com.tencent.mobileqq.parts.cc
            @Override // androidx.lifecycle.Observer
            public final void onChanged(Object obj) {
                QQSettingMeZPlanBgPartV3.R9(Function1.this, obj);
            }
        });
    }
