...
public class AuthDetailDialog extends Dialog implements View.OnClickListener {
    ...
    private void initBottomDialog(Context context) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.di_, (ViewGroup) null);
        setContentView(inflate);
        this.ivBack = (ImageView) inflate.findViewById(R.id.y0f);
        this.tvTitle = (TextView) inflate.findViewById(R.id.f1061467x);
        this.lvDetail = (ListView) inflate.findViewById(R.id.yvl);
    }

    private void initCenterDialog(Context context) {
        View inflate = LayoutInflater.from(context).inflate(R.layout.fhj, (ViewGroup) null);
        setContentView(inflate);
        this.tvTitle = (TextView) inflate.findViewById(R.id.f1061467x);
    ...
    public class DetailAdapter extends BaseAdapter {
        ...
        class DetailViewHolder {
            ...
            public DetailViewHolder(View view) {
                this.tvTitle = (TextView) view.findViewById(R.id.ugt);
                this.tvDesc = (TextView) view.findViewById(R.id.ugs);
            }
        }
        ...
        public View getView(int i3, View view, ViewGroup viewGroup) {
            ...
            if (entry != null) {
                if (view != null) {
                    ...
                    view = LayoutInflater.from(AuthDetailDialog.this.mContext).inflate(R.layout.fhk, (ViewGroup) null);
    ...
    public AuthDetailDialog(Activity activity, INTERFACE$StSubscribeMessage iNTERFACE$StSubscribeMessage, int i3, int i16, int i17) {
