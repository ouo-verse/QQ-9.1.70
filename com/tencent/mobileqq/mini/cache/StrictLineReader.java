...
class StrictLineReader implements Closeable {
    ...
    private final InputStream f246361in;
    private int pos;
    ...
    private void fillBuf() throws IOException {
        InputStream inputStream = this.f246361in;
        byte[] bArr = this.buf;
    ...
    public void close() throws IOException {
        synchronized (this.f246361in) {
            if (this.buf != null) {
                this.buf = null;
                this.f246361in.close();
            }
        }
    }
    ...
    public String readLine() throws IOException {
        ...
        synchronized (this.f246361in) {
            if (this.buf != null) {
                ...
                ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream((this.end - this.pos) + 80) { // from class: com.tencent.mobileqq.mini.cache.StrictLineReader.1
