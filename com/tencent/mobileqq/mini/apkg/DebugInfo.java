...
public class DebugInfo implements Parcelable, Serializable {
    public static final Parcelable.Creator<DebugInfo> CREATOR = new Parcelable.Creator<DebugInfo>() { // from class: com.tencent.mobileqq.mini.apkg.DebugInfo.1
    ...
    public boolean valid() {
        return (TextUtils.isEmpty(this.roomId) || TextUtils.isEmpty(this.wsUrl)) ? false : true;
    }
