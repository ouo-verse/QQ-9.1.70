...
public final class MiniAppDesktopBottomPartLayoutBinding implements ViewBinding {
    ...
    public final RelativeLayout miniAppMoveUpGuide;
    public final ImageView miniAppMoveUpImg;
    public final TextView moreAdd;
    public final TextView moreDelete;
    private final FrameLayout rootView;

    MiniAppDesktopBottomPartLayoutBinding(FrameLayout frameLayout, RelativeLayout relativeLayout, View view, TextView textView, LinearLayout linearLayout, LinearLayout linearLayout2, LinearLayout linearLayout3, RelativeLayout relativeLayout2, ImageView imageView, TextView textView2, TextView textView3) {
        ...
        this.miniAppMoveUpGuide = relativeLayout2;
        this.miniAppMoveUpImg = imageView;
        this.moreAdd = textView2;
        this.moreDelete = textView3;
    }

    public static MiniAppDesktopBottomPartLayoutBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static MiniAppDesktopBottomPartLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.dic, viewGroup, false);
        if (z16) {
    ...
    public static MiniAppDesktopBottomPartLayoutBinding bind(View view) {
        int i3 = R.id.rcv;
                    ...
                    if (linearLayout != null) {
                        ...
                        if (linearLayout2 != null) {
                            ...
                            if (linearLayout3 != null) {
                                i3 = R.id.rgx;
                                RelativeLayout relativeLayout2 = (RelativeLayout) ViewBindings.findChildViewById(view, R.id.rgx);
                                if (relativeLayout2 != null) {
                                    ...
                                    if (imageView != null) {
                                        ...
                                        if (textView2 != null) {
                                            ...
                                            if (textView3 != null) {
                                                return new MiniAppDesktopBottomPartLayoutBinding((FrameLayout) view, relativeLayout, findChildViewById, textView, linearLayout, linearLayout2, linearLayout3, relativeLayout2, imageView, textView2, textView3);
                                            }
                                        }
                                    }
                                }
