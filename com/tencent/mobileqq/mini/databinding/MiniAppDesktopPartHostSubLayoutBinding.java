...
public final class MiniAppDesktopPartHostSubLayoutBinding implements ViewBinding {
    ...
    MiniAppDesktopPartHostSubLayoutBinding(LinearLayout linearLayout, LinearLayout linearLayout2, RelativeLayout relativeLayout, RecyclerView recyclerView, ImageView imageView, TextView textView) {
    ...
    public static MiniAppDesktopPartHostSubLayoutBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static MiniAppDesktopPartHostSubLayoutBinding bind(View view) {
        ...
        if (relativeLayout != null) {
            ...
            if (recyclerView != null) {
                ...
                if (imageView != null) {
                    ...
                    if (textView != null) {
                        return new MiniAppDesktopPartHostSubLayoutBinding(linearLayout, linearLayout, relativeLayout, recyclerView, imageView, textView);
                    }
                }
            }
        }
    ...
    public static MiniAppDesktopPartHostSubLayoutBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.dif, viewGroup, false);
        if (z16) {
