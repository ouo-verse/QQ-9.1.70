...
public final class MiniGameRetainForEntranceDialogLayoutLandscapeBinding implements ViewBinding {
    ...
    MiniGameRetainForEntranceDialogLayoutLandscapeBinding(RelativeLayout relativeLayout, View view, LinearLayout linearLayout, ImageView imageView, TextView textView, TextView textView2, RelativeLayout relativeLayout2, TextView textView3, TextView textView4, ViewPager viewPager, LinearLayout linearLayout2, CheckBox checkBox, LinearLayout linearLayout3, RelativeLayout relativeLayout3, RelativeLayout relativeLayout4) {
    ...
    public static MiniGameRetainForEntranceDialogLayoutLandscapeBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, null, false);
    }

    public static MiniGameRetainForEntranceDialogLayoutLandscapeBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.dkc, viewGroup, false);
        if (z16) {
    ...
    public static MiniGameRetainForEntranceDialogLayoutLandscapeBinding bind(View view) {
        int i3 = R.id.rcc;
                ...
                if (imageView != null) {
                    ...
                    if (textView != null) {
                        ...
                        if (textView2 != null) {
                            ...
                            if (textView3 != null) {
                                i3 = R.id.rda;
                                TextView textView4 = (TextView) ViewBindings.findChildViewById(view, R.id.rda);
                                if (textView4 != null) {
                                    i3 = R.id.rdb;
                                                ...
                                                if (linearLayout3 != null) {
                                                    ...
                                                    if (relativeLayout2 != null) {
                                                        ...
                                                        if (relativeLayout3 != null) {
                                                            return new MiniGameRetainForEntranceDialogLayoutLandscapeBinding(relativeLayout, findChildViewById, linearLayout, imageView, textView, textView2, relativeLayout, textView3, textView4, viewPager, linearLayout2, checkBox, linearLayout3, relativeLayout2, relativeLayout3);
                                                        }
                                                    }
                                                }
                                            }
