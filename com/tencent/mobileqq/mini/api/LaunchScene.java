...
public class LaunchScene {
    public static final int LAUNCH_HALF_SCREEN_NOTIFICATION = 3406;
    ...
    public static final int LAUNCH_SCENE_AIO_ADD_PANEL = 2052;
    ...
    public static final int LAUNCH_SCENE_BOTTOM_GUID = 3033;
    ...
    public static final int LAUNCH_SCENE_CONTACT_BANNER = 2122;
    ...
    public static final int LAUNCH_SCENE_DESKTOP_EXPRESS_SERVICE = 3040;
    ...
    public static final int LAUNCH_SCENE_DESKTOP_FRIEND_PK = 3022;
    ...
    public static final int LAUNCH_SCENE_DESKTOP_NEW_TINY_GAME = 5007;
    public static final int LAUNCH_SCENE_DESKTOP_PLAY = 3024;
    public static final int LAUNCH_SCENE_DESKTOP_POPULARITY_LIST = 3010;
    public static final int LAUNCH_SCENE_DESKTOP_QUALITY_GOOD_GAME = 3015;
    ...
    public static final int LAUNCH_SCENE_EMOTION_FRAGMENT = 2202;
    ...
    public static final int LAUNCH_SCENE_GAME_CENTER_FROM_GUILD = 3035;
    public static final int LAUNCH_SCENE_GAME_CENTER_QA = 3034;
    public static final int LAUNCH_SCENE_GUILD = 1075;
    public static final int LAUNCH_SCENE_GUILD_APPLICATION = 5002;
    public static final int LAUNCH_SCENE_ICGAME_LANDING_PAGE = 5507;
    ...
    public static final int LAUNCH_SCENE_MAP_DETAIL_CAR = 2121;
    public static final int LAUNCH_SCENE_MESSAGE_LONG_TIME_NOTIFICATION_VIA = 21232;
    public static final int LAUNCH_SCENE_MESSAGE_ONE_TIME_NOTIFICATION_VIA = 21231;
    public static final int LAUNCH_SCENE_MESSAGE_SERVICE_NOTIFICATION = 2123;
    public static final int LAUNCH_SCENE_MESSAGE_SYSTEM_NOTIFICATION_VIA = 21233;
    ...
    public static final int LAUNCH_SCENE_ONLINE_PRINT = 2300;
    public static final int LAUNCH_SCENE_OPEN_BY_MINI_APP = 1037;
    public static final int LAUNCH_SCENE_PENDANTHOLDER = 4004;
    public static final int LAUNCH_SCENE_PROFILE_GUEST_CARD = 2063;
    ...
    public static final int LAUNCH_SCENE_RETAIN_DIALOG_RECOMMEND = 2120;
    public static final int LAUNCH_SCENE_ROBOT_INLINE_BTN = 5006;
    public static final int LAUNCH_SCENE_ROBOT_MINI_SCENE = 5003;
    ...
    public static final int LAUNCH_SCENE_TROOP_OR_C2C_SLASH = 2074;
    public static final int LAUNCH_SCENE_UNKNOWN = 9999;
    public static final int LAUNCH_SCENE_USERLEADINGDIALOG = 4009;
    public static final int LAUNCH_SCENE_USER_TOP_ENTRY = 1022;
    public static final int LAUNCH_SCENE_VM_NOTIFICATION = 1133;
    public static final int LAUNCH_SCENE_WEATHER = 2066;
    public static final int LAUNCH_SCENE_WEBVIEW_HOOK = 2014;
    public static final int LAUNCH_SCENE_WECHAT_MSGHELPER = 1124;
    public static final int LAUNCH_SCENE_WX_MINI_AD_SCHEME = 1010000000;
