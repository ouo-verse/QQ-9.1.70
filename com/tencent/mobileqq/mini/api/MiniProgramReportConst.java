...
public class MiniProgramReportConst {
    ...
    public static final String NEW_PROFILE_CARD_ACTION = "minigame_data_card";
    ...
    public static final String RESERVES_ACTION_MINIGAME_SHOP_PAGE = "minigame_shop_page";
    ...
    public static final String SEARCH_SUB_ACTION_EM_CLICK = "em_click";
    public static final String SEARCH_SUB_ACTION_EM_EXPO = "em_expo";
    public static final String SEARCH_SUB_ACTION_PAGE_CLICK = "pg_click";
