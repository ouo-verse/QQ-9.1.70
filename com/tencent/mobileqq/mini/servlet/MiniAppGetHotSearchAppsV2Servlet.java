...
public class MiniAppGetHotSearchAppsV2Servlet extends MiniAppAbstractServlet {
    public static final String KEY_EXT_INFO = "key_hot_search_ext_info";
    public static final String KEY_GET_HOT_SEARCH_APPS = "getHotSearchAppsV2";
    public static final String KEY_GET_HOT_SEARCH_APPS_RSP = "getHotSearchAppsV2Response";
    public static final String TAG = "MiniAppGetHotSearchAppsV2Servlet";
        ...
        try {
            ...
            if (fromServiceMsg != null) {
                if (fromServiceMsg.isSuccess()) {
                    ...
                    notifyObserver(intent, 1101, true, bundle, MiniAppObserver.class);
                } else {
                    bundle.putLong("retCode", fromServiceMsg.getBusinessFailCode());
                    bundle.putString("errMsg", fromServiceMsg.getBusinessFailMsg());
                    notifyObserver(intent, 1101, false, bundle, MiniAppObserver.class);
                }
            } else {
                QLog.e(TAG, 1, "MiniAppGetHotSearchAppsV2Servlet response is null.");
            }
        } catch (Throwable th5) {
            QLog.e(TAG, 1, "MiniAppGetHotSearchAppsV2Servlet onReceive e:", Log.getStackTraceString(th5));
        }
    ...
    public void onSend(Intent intent, Packet packet) {
        ...
        byte[] encode = new GetHotSearchAppsV2Request(stCommonExt).encode(intent, intExtra, getTraceId());
        if (encode == null) {
            encode = new byte[4];
        }
        packet.setSSOCommand(GetHotSearchAppsV2Request.CMD_STRING);
