...
public class GetUserAppListRequestV2 extends ProtoBufRequest {
    ...
    public GetUserAppListRequestV2(COMM.StCommonExt stCommonExt, ArrayList<INTERFACE$StRecommendApp> arrayList, ArrayList<Integer> arrayList2, int i3, INTERFACE$DeviceInfo iNTERFACE$DeviceInfo, ArrayList<Integer> arrayList3, ArrayList<String> arrayList4) {
