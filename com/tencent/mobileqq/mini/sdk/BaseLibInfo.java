...
public class BaseLibInfo implements Parcelable, Serializable {
    public static final Parcelable.Creator<BaseLibInfo> CREATOR = new Parcelable.Creator<BaseLibInfo>() { // from class: com.tencent.mobileqq.mini.sdk.BaseLibInfo.1
        ...
        public BaseLibInfo createFromParcel(Parcel parcel) {
            ...
            try {
                ...
                QDLog.e("miniapp", "BaseLibInfo createFromParcel exception!", th5);
                return baseLibInfo;
            }
        }
    ...
    public JSONObject toJSONObject() {
        ...
        try {
            ...
            QLog.e("BaseLibInfo", 1, "[MiniEng]BaseLibInfo convert to json failed " + DebugUtil.getPrintableStackTrace(e16));
        }
        return jSONObject;
    }
    ...
    public void updateFor64AbiIfNeed() {
        if (QUAUtil.isAbi64()) {
            String baseLibUrl64 = getBaseLibUrl64();
            if (TextUtils.isEmpty(baseLibUrl64)) {
                return;
            }
            QLog.i("BaseLibInfo", 1, "QUAUtil.isAbi64() is true, update baselib url from " + this.baseLibUrl + " to " + baseLibUrl64);
            this.baseLibUrl = baseLibUrl64;
        }
    }
    ...
    public void updateFor64IfNeed() {
        ...
        QLog.i("BaseLibInfo", 1, "IS_CPU_64_BIT, update baselib url from " + this.baseLibUrl + " to " + baseLibUrl64);
        this.baseLibUrl = baseLibUrl64;
    }
    ...
    public String getBaseLibUrl64() {
        try {
            ...
            return new JSONObject(this.baseLibDesc).optString("downloadUrl_64");
        } catch (Throwable th5) {
            QLog.e("BaseLibInfo", 1, th5, new Object[0]);
            return null;
        }
    }
    ...
    public static BaseLibInfo fromJSON(JSONObject jSONObject) {
        if (jSONObject != null) {
            try {
                ...
                QLog.e("BaseLibInfo", 1, "[MiniEng]BaseLibInfo create from json failed " + DebugUtil.getPrintableStackTrace(e16));
            }
        }
        return null;
    }
