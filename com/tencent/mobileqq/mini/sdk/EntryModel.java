...
public class EntryModel implements Parcelable {
    public static final Parcelable.Creator<EntryModel> CREATOR = new Parcelable.Creator<EntryModel>() { // from class: com.tencent.mobileqq.mini.sdk.EntryModel.1
    ...
    public static final int TYPE_CUSTOM_TITLEBAR = 2;
    ...
    public EntryModel(int i3, long j3, String str, boolean z16) {
        this.titleBarClassName = "";
        this.type = i3;
        this.uin = j3;
        this.name = str;
