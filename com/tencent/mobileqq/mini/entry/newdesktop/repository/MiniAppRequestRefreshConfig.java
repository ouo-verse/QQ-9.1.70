...
/* compiled from: P */
@Metadata(d1 = {"\u00006\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0018\u0000 \u00142\u00020\u0001:\u0001\u0014B\u0005\u00a2\u0006\u0002\u0010\u0002J\u000e\u0010\u0006\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tJ\u000e\u0010\n\u001a\u00020\u00072\u0006\u0010\b\u001a\u00020\tJ\n\u0010\u000b\u001a\u0004\u0018\u00010\fH\u0002J\u000e\u0010\r\u001a\u00020\u000e2\u0006\u0010\b\u001a\u00020\tJ\u0016\u0010\u000f\u001a\u00020\u00102\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\u0011\u001a\u00020\u0007J\u0016\u0010\u0012\u001a\u00020\u00102\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\u0013\u001a\u00020\u0007R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u0004\u00a2\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004X\u0082\u0004\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0015"}, d2 = {"Lcom/tencent/mobileqq/mini/entry/newdesktop/repository/MiniAppRequestRefreshConfig;", "", "()V", "mLastRequestTimes", "Landroid/util/SparseLongArray;", "mRefreshIntervals", "getLastRequestTime", "", "scene", "Lcom/tencent/mobileqq/mini/entry/desktop/GetAppListV2Scene;", "getRefreshInterval", "getSp", "Landroid/content/SharedPreferences;", "isExpired", "", "setLastRequestTime", "", CommonUsedSystemEmojiManagerConstants.LAST_REQUEST_TIME, "setRefreshInterval", "refreshInterval", "Companion", "qqmini_impl_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
/* loaded from: classes33.dex */
public final class MiniAppRequestRefreshConfig {
    private static final String KEY_LAST_REFRESH_TIME = "desktop_last_refresh_time";
    private static final String KEY_REFRESH_INTERVAL = "desktop_refresh_interval";
    private static final String TAG = "MiniAppRequestRefreshConfig";
    ...
    private final SharedPreferences getSp() {
        ...
        QLog.e(TAG, 1, "getSp, app is null.");
        return null;
    }
    ...
    public final long getLastRequestTime(GetAppListV2Scene scene) {
        ...
        if (this.mLastRequestTimes.indexOfKey(scene.ordinal()) < 0) {
            this.mLastRequestTimes.put(scene.ordinal(), MiniAppMMKVUtils.getLong("desktop_last_refresh_time_" + scene.ordinal(), 0L));
        }
    ...
    public final long getRefreshInterval(GetAppListV2Scene scene) {
        ...
        if (this.mRefreshIntervals.indexOfKey(scene.ordinal()) < 0) {
            this.mRefreshIntervals.put(scene.ordinal(), MiniAppMMKVUtils.getLong("desktop_refresh_interval_" + scene.ordinal(), 0L));
        }
    ...
    public final void setLastRequestTime(GetAppListV2Scene scene, long lastRequestTime) {
        ...
        MiniAppMMKVUtils.putLong("desktop_last_refresh_time_" + scene.ordinal(), lastRequestTime);
    }
    ...
    public final void setRefreshInterval(GetAppListV2Scene scene, long refreshInterval) {
        ...
        MiniAppMMKVUtils.putLong("desktop_refresh_interval_" + scene.ordinal(), refreshInterval);
    }
}
