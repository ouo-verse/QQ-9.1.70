...
public class RankMiniAppInnerRvAdapter extends AsyncListDifferDelegationAdapter<DesktopItemInfo> {
    ...
    public void setItems(List<DesktopItemInfo> items) {
        if (items != null && items.size() > 10) {
            super.setItems(items.subList(0, 10));
        } else {
