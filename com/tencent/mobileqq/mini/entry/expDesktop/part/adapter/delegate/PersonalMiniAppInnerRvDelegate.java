...
public final class PersonalMiniAppInnerRvDelegate extends AbsItemAdapterDelegate<DesktopItemInfo, DesktopItemInfo> {
    ...
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<DesktopItemInfo>>> sections) {
        ...
        sections.add(MiniAppRvItemScanningLightIconSection.class);
    ...
    protected void onBindViewHolder(DesktopItemInfo item, SectionViewHolder<?> holder, int position, List<Object> payloads) {
        ...
        super.onBindViewHolder((PersonalMiniAppInnerRvDelegate) item, (SectionViewHolder) holder, position, payloads);
