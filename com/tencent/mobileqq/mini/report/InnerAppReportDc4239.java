...
public class InnerAppReportDc4239 {
    ...
    public static void innerAppReport(final MiniAppConfig miniAppConfig, final String str, final String str2, final String str3, final String str4) {
        MiniProgramReporter.getInstance().getReportHandler().post(new Runnable() { // from class: com.tencent.mobileqq.mini.report.InnerAppReportDc4239.1
            @Override // java.lang.Runnable
            public void run() {
                MiniAppConfig miniAppConfig2 = MiniAppConfig.this;
                MiniProgramLpReportDC04239.report(miniAppConfig2, MiniProgramLpReportDC04239.getAppType(miniAppConfig2), str, "inner_app", "from_api", str2, str3, str4, null, null, null);
            }
        });
    }
}
