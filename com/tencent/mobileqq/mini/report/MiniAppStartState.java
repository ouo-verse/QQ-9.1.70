...
public class MiniAppStartState {
    ...
    public static String getBaselibLoadDesc(String str) {
        ...
        if (baselibLoad == 0) {
            return com.tencent.qqmini.sdk.report.MiniAppReportManager2.VALUE_SERVICE_NOT_PRELOAD;
        }
        if (baselibLoad != 1) {
            return "unknown";
        }
        return com.tencent.qqmini.sdk.report.MiniAppReportManager2.VALUE_SERVICE_PRELOAD;
    }
