...
public final class QQStrangerMsgSettingListPart$newChatMsgNotifyCheckedChangedListener$2 extends Lambda implements Function0<CompoundButton.OnCheckedChangeListener> {
    final /* synthetic */ QQStrangerMsgSettingListPart this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public QQStrangerMsgSettingListPart$newChatMsgNotifyCheckedChangedListener$2(QQStrangerMsgSettingListPart qQStrangerMsgSettingListPart) {
        super(0);
    ...
    public final CompoundButton.OnCheckedChangeListener invoke() {
        ...
        return new CompoundButton.OnCheckedChangeListener() { // from class: com.tencent.mobileqq.matchfriend.reborn.content.msg.setting.part.d
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z16) {
                QQStrangerMsgSettingListPart$newChatMsgNotifyCheckedChangedListener$2.b(QQStrangerMsgSettingListPart.this, compoundButton, z16);
            }
        };
    }
}
