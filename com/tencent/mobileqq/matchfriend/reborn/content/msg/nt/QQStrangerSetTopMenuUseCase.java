...
/* compiled from: P */
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0007\u0018\u0000 \u00072\u00020\u0001:\u0001\u0007B\u000f\u0012\u0006\u0010\u0010\u001a\u00020\u000f\u00a2\u0006\u0004\b\u0011\u0010\u0012J\u001a\u0010\u0007\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0002J\u0010\u0010\u000b\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\bH\u0016J\u0019\u0010\u000e\u001a\n\u0012\u0004\u0012\u00020\r\u0018\u00010\f2\u0006\u0010\t\u001a\u00020\bH\u0096\u0002\u00a8\u0006\u0013"}, d2 = {"Lcom/tencent/mobileqq/matchfriend/reborn/content/msg/nt/QQStrangerSetTopMenuUseCase;", "Lcom/tencent/qqnt/chats/main/vm/usecase/meun/a;", "Landroid/content/Context;", "context", "Lcom/tencent/qqnt/chats/core/adapter/itemdata/g;", PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME, "", "a", "Lcom/tencent/qqnt/chats/main/vm/usecase/meun/a$a;", "params", "", "interestedIn", "Lkotlinx/coroutines/flow/Flow;", "Lcom/tencent/qqnt/chats/main/vm/usecase/result/a;", "invoke", "Lcom/tencent/qqnt/chats/main/vm/datasource/IRecentContactRepo;", "recentContactRepo", "<init>", "(Lcom/tencent/qqnt/chats/main/vm/datasource/IRecentContactRepo;)V", "matchfriend_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes33.dex */
public final class QQStrangerSetTopMenuUseCase extends com.tencent.qqnt.chats.main.vm.usecase.meun.a {

    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u001d\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0018\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016\u00a8\u0006\b"}, d2 = {"com/tencent/mobileqq/matchfriend/reborn/content/msg/nt/QQStrangerSetTopMenuUseCase$b", "Lcom/tencent/qqnt/chats/api/c;", "", "result", "", "errMsg", "", "onResult", "matchfriend_impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes33.dex */
    public static final class b implements com.tencent.qqnt.chats.api.c {

        /* renamed from: b, reason: collision with root package name */
        final /* synthetic */ com.tencent.qqnt.chats.core.adapter.itemdata.b f244670b;
        ...
        public static final void b(int i3, String str) {
            QLog.d("QQStrangerSetTopMenuUseCase", 1, "setItemTop result: " + i3 + ", errMsg: " + str);
        }
        ...
        public void onResult(int result, String errMsg) {
            ...
            if (result == 0) {
                QQStrangerSetTopMenuUseCase.this.getRecentContactRepo().k(((com.tencent.qqnt.chats.core.adapter.itemdata.g) this.f244670b).k(), ((com.tencent.qqnt.chats.core.adapter.itemdata.g) this.f244670b).l(), true, ((com.tencent.qqnt.chats.core.adapter.itemdata.g) this.f244670b).n(), new IOperateCallback() { // from class: com.tencent.mobileqq.matchfriend.reborn.content.msg.nt.v
                    @Override // com.tencent.qqnt.kernel.nativeinterface.IOperateCallback
                    public final void onResult(int i3, String str) {
                        QQStrangerSetTopMenuUseCase.b.b(i3, str);
                    }
                });
            } else if (result != 3000) {
                QQToastUtil.showQQToastInUiThread(1, BaseApplication.getContext().getString(R.string.f201074tu));
            } else {
    ...
    public QQStrangerSetTopMenuUseCase(IRecentContactRepo recentContactRepo) {
    ...
    public Flow<com.tencent.qqnt.chats.main.vm.usecase.result.a> invoke(a.C9600a params) {
        ...
        ((IStrangerChatsApi) QRoute.api(IStrangerChatsApi.class)).doSetTopOrNot(gVar.k(), true, new b(b16));
        a(params.a(), gVar);
        return FlowKt.flow(new QQStrangerSetTopMenuUseCase$invoke$2(null));
    }
