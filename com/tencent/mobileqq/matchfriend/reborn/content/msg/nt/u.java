...
public final class u {
    ...
    public final void b(View view, QUIBadgeDragLayout dragArea, LIAAnimView lightInterActionView) {
        ...
        this.mChatsVM = (com.tencent.qqnt.chats.core.mvi.a) iChatsViewModelCreator.createQQStrangerChatsViewModel(LifecycleOwnerKt.getLifecycleScope((QBaseActivity) context), this.mContext, new f(), new s());
        a(dragArea, lightInterActionView);
    }
    ...
    private final View a(QUIBadgeDragLayout dragArea, LIAAnimView lightInterActionView) {
        ...
        l lVar2 = new l(aVar, new QQStrangerOftenChatListBuilder(), false, true);
        this.mChatsVB = lVar2;
        ...
        lVar2.d0(new ChatsListVB.b((RecyclerView) findViewById2, dragArea, null, this.mContext, null, null, lightInterActionView, null, 176, null));
