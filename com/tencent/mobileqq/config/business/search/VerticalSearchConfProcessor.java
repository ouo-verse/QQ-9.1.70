...
public class VerticalSearchConfProcessor extends l<c> {
    ...
    public c onParsed(ai[] aiVarArr) {
        ...
        if (aiVarArr != null && aiVarArr.length > 0) {
            if (QLog.isColorLevel()) {
                QLog.d("VerticalSearchConfProcessor", 2, "onParsed " + aiVarArr.length);
            }
            return c.g(aiVarArr[0]);
        }
        return null;
    }
    ...
    public void onUpdate(c cVar) {
        ...
        if (QLog.isColorLevel()) {
            ...
            sb5.append(str);
            QLog.d("VerticalSearchConfProcessor", 2, sb5.toString());
        }
    }
    ...
    public void onReqFailed(int i3) {
        if (QLog.isColorLevel()) {
            QLog.e("VerticalSearchConfProcessor", 2, "onReqFailed " + i3);
        }
    }

    @Override // com.tencent.mobileqq.config.l
    public int type() {
        return QFSNumberConstants.Int.NUM_456;
    }
}
