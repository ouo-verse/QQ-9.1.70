...
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\b\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0013\u0010\u0014J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0007J\u0010\u0010\b\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0007J\u0012\u0010\t\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0007J\u0016\u0010\u000e\u001a\u00020\r2\u0006\u0010\n\u001a\u00020\u00062\u0006\u0010\f\u001a\u00020\u000bR\u0014\u0010\u0011\u001a\u00020\u000b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u000f\u0010\u0010R\u0018\u0010\u0003\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u000e\u0010\u0012\u00a8\u0006\u0015"}, d2 = {"Lcom/tencent/mobileqq/leba/view/LebaListItemPreLoader;", "", "Lcom/tencent/mobileqq/leba/view/f;", "preInflateHelper", "", "d", "Landroid/view/ViewGroup;", MosaicConstants$JsProperty.PROP_ROOT_VIEW, "e", "f", "viewGroup", "", "layoutResId", "Landroid/view/View;", "c", "b", "I", "itemLayoutRes", "Lcom/tencent/mobileqq/leba/view/f;", "<init>", "()V", "qqleba-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes15.dex */
public final class LebaListItemPreLoader {
    static IPatchRedirector $redirector_;

    /* renamed from: a, reason: collision with root package name */
    @NotNull
    public static final LebaListItemPreLoader f240780a;
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(19403);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 3)) {
            redirector.redirect((short) 3);
        } else {
            f240780a = new LebaListItemPreLoader();
            itemLayoutRes = R.layout.f167912m2;
        }
    }

    LebaListItemPreLoader() {
    ...
    public static final synchronized void d(@NotNull f preInflateHelper2) {
        synchronized (LebaListItemPreLoader.class) {
    ...
    public static final void e(@NotNull final ViewGroup rootView) {
        ...
        if (com.tencent.mobileqq.leba.util.a.f240763a.a()) {
            ...
            if (fVar != null) {
                fVar.f(rootView, itemLayoutRes, 23, 15);
                return;
            }
            return;
        }
        ThreadManagerV2.getUIHandlerV2().post(new Runnable(rootView) { // from class: com.tencent.mobileqq.leba.view.LebaListItemPreLoader$preLoadItems$$inlined$runOnMainThread$1
            static IPatchRedirector $redirector_;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ ViewGroup f240783d;

            {
                this.f240783d = rootView;
                IPatchRedirector iPatchRedirector = $redirector_;
                if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            ...
            public final void run() {
                ...
                if (iPatchRedirector == null || !iPatchRedirector.hasPatch((short) 2)) {
                    f fVar2 = LebaListItemPreLoader.preInflateHelper;
                    if (fVar2 != null) {
                        fVar2.f(this.f240783d, LebaListItemPreLoader.itemLayoutRes, 23, 15);
                        return;
                    }
                    return;
                }
    ...
    @JvmStatic
    public static final void f(@Nullable f preInflateHelper2) {
        f fVar = preInflateHelper;
        if (fVar != null && Intrinsics.areEqual(fVar, preInflateHelper2)) {
            preInflateHelper = null;
        }
        QLog.i("LebaListItemPreLoader", 1, "release. " + preInflateHelper);
    }
