...
public interface ShortVideoConstants {
    ...
    public static final String FILE_SOURCE_HOT_PIC = "hot_pic";
    ...
    public static final String FILE_VIDEO_SOURCE_PATH = "file_video_source_path";
    ...
    public static final String SOURCE_VIDEO_CODEC_FORMAT = "source_video_codec_format";
    ...
    public static final String VIDEO_EMOTICON_HOMEPAGE_URL = "VIDEO_EMOTICON_HOMEPAGE_URL";
    public static final String VIDEO_EMOTICON_SRC_DESC = "VIDEO_EMOTICON_SRC_DESC";
    public static final String VIDEO_EMOTICON_SRC_TYPE = "VIDEO_EMOTICON_SRC_TYPE";
    public static final String VIDEO_EMOTICON_VIDEO_ICON_URL = "VIDEO_EMOTICON_VIDEO_ICON_URL";
    public static final String VIDEO_EMOTICON_VIDEO_OTHER = "VIDEO_EMOTICON_VIDEO_OTHER";
    public static final String VIDEO_IS_GENERATE_GIF = "video_is_generate_gif";
    public static final String VIDEO_IS_H265 = "video_is_h265";
    public static final String VIDEO_IS_HDR = "video_is_hdr";
    ...
    public static final long VIDEO_SIZE_LIMIT = 104345600;
    public static final long VIDEO_SIZE_LIMIT_UNCOMPRESS = 1048576000;
    ...
    public static final String MESSAGEFORSHORTVIDEO_MSG = HardCodeUtil.qqStr(R.string.tgp);
    public static final String MESSAGE_FOR_SHORT_VIDEO_PTV = HardCodeUtil.qqStr(R.string.the);
    public static final String[] DEBUG_RESOLUTIONS = {"1920*1080", "1280*720", "960*720", "640*480"};
    public static final String[] DEBUG_BITRATES = {"1000", TroopAvatarWallPreviewActivity.PUBLIC_ACCOUNT_IMAGE_SID, "4000", "8000"};
}
