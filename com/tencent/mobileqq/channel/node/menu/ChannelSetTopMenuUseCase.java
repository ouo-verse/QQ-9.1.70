...
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\b\u0007\u0018\u0000 \u00112\u00020\u0001:\u0001\u0011B\u000f\u0012\u0006\u0010\u000e\u001a\u00020\r\u00a2\u0006\u0004\b\u000f\u0010\u0010J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016J\u0019\u0010\b\u001a\n\u0012\u0004\u0012\u00020\u0007\u0018\u00010\u00062\u0006\u0010\u0003\u001a\u00020\u0002H\u0096\u0002R\u0014\u0010\f\u001a\u00020\t8VX\u0096\u0004\u00a2\u0006\u0006\u001a\u0004\b\n\u0010\u000b\u00a8\u0006\u0012"}, d2 = {"Lcom/tencent/mobileqq/channel/node/menu/ChannelSetTopMenuUseCase;", "Lcom/tencent/qqnt/chats/main/vm/usecase/meun/a;", "Lcom/tencent/qqnt/chats/main/vm/usecase/meun/a$a;", "params", "", "interestedIn", "Lkotlinx/coroutines/flow/Flow;", "Lcom/tencent/qqnt/chats/main/vm/usecase/result/a;", "invoke", "", "getProcessType", "()I", "processType", "Lcom/tencent/qqnt/chats/main/vm/datasource/IRecentContactRepo;", "repo", "<init>", "(Lcom/tencent/qqnt/chats/main/vm/datasource/IRecentContactRepo;)V", "Companion", "qqchat_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes11.dex */
public final class ChannelSetTopMenuUseCase extends com.tencent.qqnt.chats.main.vm.usecase.meun.a {
    ...
    @NotNull
    private static final String TAG = "ChannelSetTopMenuUseCase";

    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0012\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002\u00a2\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T\u00a2\u0006\u0002\n\u0000\u00a8\u0006\u0005"}, d2 = {"Lcom/tencent/mobileqq/channel/node/menu/ChannelSetTopMenuUseCase$Companion;", "", "()V", "TAG", "", "qqchat_impl_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    /* loaded from: classes11.dex */
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(22693);
    ...
    public ChannelSetTopMenuUseCase(@NotNull IRecentContactRepo repo) {
        super(repo);
    ...
    public static final void invoke$lambda$3$lambda$2$lambda$1(GuildContactInfo it, int i3, String str) {
        ...
        QLog.i(TAG, 1, "setTop channelId = " + it.channelId + " result = " + i3 + " errMsg = " + str);
    }
        ...
        if (gVar != null && (s16 = gVar.s()) != null && (guildContactInfo = s16.guildContactInfo) != null) {
            ...
            if (guildContactInfo != null) {
                ...
                if (iGPSService != null) {
                    ...
                    iGPSService.setQQMsgListChannel(str3, str4, 3, new cc() { // from class: com.tencent.mobileqq.channel.node.menu.a
                        @Override // vh2.cc
                        public final void onResult(int i3, String str5) {
                            ChannelSetTopMenuUseCase.invoke$lambda$3$lambda$2$lambda$1(GuildContactInfo.this, i3, str5);
                        }
                    });
                }
            }
        }
        return FlowKt.flow(new ChannelSetTopMenuUseCase$invoke$3(null));
    }
}
