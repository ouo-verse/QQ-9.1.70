...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.c W;
    private Rect Y;
    private long Z;
    ...
    final List<View> f275350d = new ArrayList();

    /* renamed from: e, reason: collision with root package name */
    private final float[] f275351e = new float[2];

    /* renamed from: f, reason: collision with root package name */
    RecyclerView.ViewHolder f275352f = null;
    int H = -1;
    int J = 0;
    List<e> L = new ArrayList();
    final Runnable P = new Runnable() { // from class: com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.ItemTouchHelper.1
        @Override // java.lang.Runnable
        public void run() {
            ItemTouchHelper itemTouchHelper = ItemTouchHelper.this;
            if (itemTouchHelper.f275352f != null && itemTouchHelper.scrollIfNecessary()) {
                ItemTouchHelper itemTouchHelper2 = ItemTouchHelper.this;
                RecyclerView.ViewHolder viewHolder = itemTouchHelper2.f275352f;
                if (viewHolder != null) {
    ...
    class a implements RecyclerView.OnItemTouchListener {
        ...
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            if (actionMasked == 0) {
                ...
                ItemTouchHelper.this.f275353h = motionEvent.getX();
                ItemTouchHelper.this.f275354i = motionEvent.getY();
                ItemTouchHelper.this.obtainVelocityTracker();
                ItemTouchHelper itemTouchHelper = ItemTouchHelper.this;
                if (itemTouchHelper.f275352f == null && (c16 = itemTouchHelper.c(motionEvent)) != null) {
                    ItemTouchHelper itemTouchHelper2 = ItemTouchHelper.this;
                    itemTouchHelper2.f275353h -= c16.F;
                    itemTouchHelper2.f275354i -= c16.G;
                    itemTouchHelper2.b(c16.f275368i, true);
                    if (ItemTouchHelper.this.f275350d.remove(c16.f275368i.itemView)) {
                        ItemTouchHelper itemTouchHelper3 = ItemTouchHelper.this;
                        itemTouchHelper3.I.c(itemTouchHelper3.N, c16.f275368i);
                    }
                    ItemTouchHelper.this.select(c16.f275368i, c16.f275369m);
            ...
            if (ItemTouchHelper.this.f275352f != null) {
                return true;
            }
            return false;
        }
        ...
        public void onTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            ItemTouchHelper itemTouchHelper = ItemTouchHelper.this;
            RecyclerView.ViewHolder viewHolder = itemTouchHelper.f275352f;
            if (viewHolder == null) {
                return;
            }
            int i3 = 0;
    ...
    public class b extends e {
        ...
        @Override // com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.ItemTouchHelper.e, com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.b, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            ...
            if (this.L <= 0) {
                ...
                ItemTouchHelper.this.f275350d.add(this.M.itemView);
                this.E = true;
                int i3 = this.L;
                if (i3 > 0) {
        ...
        public void onLongPress(MotionEvent motionEvent) {
            ...
            if (findChildView != null && (childViewHolder = ItemTouchHelper.this.N.getChildViewHolder(findChildView)) != null) {
                ...
                if (pointerId == i3) {
                    ...
                    ItemTouchHelper itemTouchHelper2 = ItemTouchHelper.this;
                    itemTouchHelper2.f275353h = x16;
                    itemTouchHelper2.f275354i = y16;
    ...
    public static abstract class f extends c {
        ...
        /* renamed from: e, reason: collision with root package name */
        private int f275372e;

        /* renamed from: f, reason: collision with root package name */
        private int f275373f;
    ...
    private int checkHorizontalSwipe(RecyclerView.ViewHolder viewHolder, int i3) {
        ...
        if ((i3 & 12) != 0) {
            ...
            if (velocityTracker != null && this.H > -1) {
                ...
                if ((i17 & i3) != 0 && i16 == i17 && abs >= this.I.l(this.f275355m) && abs > Math.abs(yVelocity)) {
                    return i17;
                }
            }
    ...
    private int checkVerticalSwipe(RecyclerView.ViewHolder viewHolder, int i3) {
        ...
        if ((i3 & 3) != 0) {
            ...
            if (velocityTracker != null && this.H > -1) {
                ...
                if ((i17 & i3) != 0 && i17 == i16 && abs >= this.I.l(this.f275355m) && abs > Math.abs(xVelocity)) {
                    return i17;
                }
            }
    ...
    private void d() {
        ...
        this.W = new com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.c(this.N.getContext(), new d());
    }
    ...
    private void destroyCallbacks() {
        ...
        for (int size = this.L.size() - 1; size >= 0; size--) {
            this.I.c(this.N, this.L.get(0).f275368i);
        }
        this.L.clear();
        this.U = null;
        this.V = -1;
    ...
    private List<RecyclerView.ViewHolder> findSwapTargets(RecyclerView.ViewHolder viewHolder) {
        ...
        while (i18 < childCount) {
            ...
            if (childAt != viewHolder2.itemView && childAt.getBottom() >= round2 && childAt.getTop() <= height && childAt.getRight() >= round && childAt.getLeft() <= width) {
                ...
                if (this.I.a(this.N, this.f275352f, childViewHolder)) {
    ...
    private RecyclerView.ViewHolder findSwipedView(MotionEvent motionEvent) {
        ...
        int findPointerIndex = motionEvent.findPointerIndex(i3);
        float x16 = motionEvent.getX(findPointerIndex) - this.f275353h;
        float y16 = motionEvent.getY(findPointerIndex) - this.f275354i;
    ...
    private void getSelectedDxDy(float[] fArr) {
        if ((this.K & 12) != 0) {
            fArr[0] = (this.F + this.D) - this.f275352f.itemView.getLeft();
        } else {
            fArr[0] = this.f275352f.itemView.getTranslationX();
        }
        if ((this.K & 3) != 0) {
            fArr[1] = (this.G + this.E) - this.f275352f.itemView.getTop();
        } else {
            fArr[1] = this.f275352f.itemView.getTranslationY();
        }
    }
    ...
    boolean a(int i3, MotionEvent motionEvent, int i16) {
        ...
        int f16;
        if (this.f275352f != null || i3 != 2 || this.J == 2 || !this.I.q() || this.N.getScrollState() == 1 || (findSwipedView = findSwipedView(motionEvent)) == null || (f16 = (this.I.f(this.N, findSwipedView) & 65280) >> 8) == 0) {
            return false;
        }
        float x16 = motionEvent.getX(i16);
        float y16 = motionEvent.getY(i16);
        float f17 = x16 - this.f275353h;
        float f18 = y16 - this.f275354i;
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView != null) {
            ...
            this.f275355m = resources.getDimension(R.dimen.f159068vg);
    ...
    e c(MotionEvent motionEvent) {
        ...
        for (int size = this.L.size() - 1; size >= 0; size--) {
            e eVar = this.L.get(size);
            if (eVar.f275368i.itemView == findChildView) {
                return eVar;
            }
        }
        return null;
    ...
    void e(final e eVar, final int i3) {
        this.N.post(new Runnable() { // from class: com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.ItemTouchHelper.4
            @Override // java.lang.Runnable
            public void run() {
                RecyclerView recyclerView = ItemTouchHelper.this.N;
                if (recyclerView != null && recyclerView.isAttachedToWindow()) {
                    e eVar2 = eVar;
                    if (!eVar2.H && eVar2.f275368i.getAdapterPosition() != -1) {
                        RecyclerView.ItemAnimator itemAnimator = ItemTouchHelper.this.N.getItemAnimator();
                        if ((itemAnimator == null || !itemAnimator.isRunning(null)) && !ItemTouchHelper.this.hasRunningRecoverAnim()) {
                            ItemTouchHelper.this.I.B(eVar.f275368i, i3);
                        } else {
    ...
    View findChildView(MotionEvent motionEvent) {
        ...
        RecyclerView.ViewHolder viewHolder = this.f275352f;
        if (viewHolder != null) {
        ...
        for (int size = this.L.size() - 1; size >= 0; size--) {
            e eVar = this.L.get(size);
            View view2 = eVar.f275368i.itemView;
    ...
    public void onChildViewDetachedFromWindow(View view) {
        ...
        if (this.f275350d.remove(childViewHolder.itemView)) {
    ...
    public void onDraw(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        float f17;
        this.V = -1;
        if (this.f275352f != null) {
            getSelectedDxDy(this.f275351e);
            float[] fArr = this.f275351e;
            float f18 = fArr[0];
            f17 = fArr[1];
            f16 = f18;
        } else {
        ...
        this.I.w(canvas, recyclerView, this.f275352f, this.L, this.J, f16, f17);
    }
    ...
    public void onDrawOver(Canvas canvas, RecyclerView recyclerView, RecyclerView.State state) {
        ...
        this.I.x(canvas, recyclerView, this.f275352f, this.L, this.J, f16, f17);
    }
    ...
    */
    boolean scrollIfNecessary() {
        ...
        layoutManager.calculateItemDecorationsForChild(this.f275352f.itemView, this.Y);
        if (layoutManager.canScrollHorizontally()) {
            int i18 = (int) (this.F + this.D);
            int paddingLeft = (i18 - this.Y.left) - this.N.getPaddingLeft();
            float f16 = this.D;
            if (f16 < 0.0f && paddingLeft < 0) {
                i3 = paddingLeft;
            } else if (f16 > 0.0f && (width = ((i18 + this.f275352f.itemView.getWidth()) + this.Y.right) - (this.N.getWidth() - this.N.getPaddingRight())) > 0) {
                i3 = width;
            }
            if (layoutManager.canScrollVertically()) {
                int i19 = (int) (this.G + this.E);
                int paddingTop = (i19 - this.Y.top) - this.N.getPaddingTop();
                float f17 = this.E;
                if (f17 < 0.0f && paddingTop < 0) {
                    i16 = paddingTop;
                } else if (f17 > 0.0f) {
                    i16 = ((i19 + this.f275352f.itemView.getHeight()) + this.Y.bottom) - (this.N.getHeight() - this.N.getPaddingBottom());
                }
                if (i3 != 0) {
                    i3 = this.I.p(this.N, this.f275352f.itemView.getWidth(), i3, this.N.getWidth(), j3);
                }
                int i26 = i3;
                if (i16 != 0) {
                    i17 = i26;
                    i16 = this.I.p(this.N, this.f275352f.itemView.getHeight(), i16, this.N.getHeight(), j3);
                } else {
                    i17 = i26;
                }
                if (i17 != 0 && i16 == 0) {
    ...
    */
    void select(RecyclerView.ViewHolder viewHolder, int i3) {
        ...
        float signum;
        int i16;
        if (viewHolder == this.f275352f && i3 == this.J) {
            return;
        }
        this.Z = Long.MIN_VALUE;
        int i17 = this.J;
        ...
        int i18 = (1 << ((i3 * 8) + 8)) - 1;
        RecyclerView.ViewHolder viewHolder2 = this.f275352f;
        if (viewHolder2 != null) {
    ...
    void updateDxDy(MotionEvent motionEvent, int i3, int i16) {
        float x16 = motionEvent.getX(i16);
        float y16 = motionEvent.getY(i16);
        float f16 = x16 - this.f275353h;
        this.D = f16;
        this.E = y16 - this.f275354i;
        if ((i3 & 4) == 0) {
    ...
    public static abstract class c {
        ...
        private int f275362a = -1;

        /* renamed from: c, reason: collision with root package name */
        private static final Interpolator f275360c = new a();

        /* renamed from: d, reason: collision with root package name */
        private static final Interpolator f275361d = new b();

        /* renamed from: b, reason: collision with root package name */
        private static final com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.d f275359b = new com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.f();
        ...
        private int i(RecyclerView recyclerView) {
            if (this.f275362a == -1) {
                this.f275362a = recyclerView.getResources().getDimensionPixelSize(R.dimen.f159066ve);
            }
            return this.f275362a;
        }
        ...
        public void A(RecyclerView.ViewHolder viewHolder, int i3) {
            if (viewHolder != null) {
                f275359b.onSelected(viewHolder.itemView);
            }
        }
        ...
        public void c(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
            f275359b.clearView(viewHolder.itemView);
        }
        ...
        public int p(RecyclerView recyclerView, int i3, int i16, int i17, long j3) {
            ...
            float f16 = 1.0f;
            int signum = (int) (((int) Math.signum(i16)) * i18 * f275361d.getInterpolation(Math.min(1.0f, (Math.abs(i16) * 1.0f) / i3)));
            if (j3 <= 2000) {
                f16 = ((float) j3) / 2000.0f;
            }
            int interpolation = (int) (signum * f275360c.getInterpolation(f16));
            if (interpolation == 0) {
                if (i16 > 0) {
                    return 1;
                }
        ...
        public void u(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float f16, float f17, int i3, boolean z16) {
            f275359b.onDraw(canvas, recyclerView, viewHolder.itemView, f16, f17, i3, z16);
        }
        ...
        public void v(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float f16, float f17, int i3, boolean z16) {
            f275359b.onDrawOver(canvas, recyclerView, viewHolder.itemView, f16, f17, i3, z16);
        }
        ...
        void w(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<e> list, int i3, float f16, float f17) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                ...
                u(canvas, recyclerView, eVar.f275368i, eVar.F, eVar.G, eVar.f275369m, false);
        ...
        void x(Canvas canvas, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, List<e> list, int i3, float f16, float f17) {
            ...
            for (int i16 = 0; i16 < size; i16++) {
                e eVar = list.get(i16);
                int save = canvas.save();
                v(canvas, recyclerView, eVar.f275368i, eVar.F, eVar.G, eVar.f275369m, false);
                canvas.restoreToCount(save);
            }
            if (viewHolder != null) {
                int save2 = canvas.save();
    ...
    /* compiled from: P */
    /* loaded from: classes17.dex */
    public class e extends com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.b {
        ...
        /* renamed from: d, reason: collision with root package name */
        final float f275364d;

        /* renamed from: e, reason: collision with root package name */
        final float f275365e;

        /* renamed from: f, reason: collision with root package name */
        final float f275366f;

        /* renamed from: h, reason: collision with root package name */
        final float f275367h;

        /* renamed from: i, reason: collision with root package name */
        final RecyclerView.ViewHolder f275368i;
        ...
        class a implements ValueAnimator.AnimatorUpdateListener {
            ...
            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ ItemTouchHelper f275370d;

            a(ItemTouchHelper itemTouchHelper) {
                this.f275370d = itemTouchHelper;
            }
        ...
        public void d() {
            this.f275368i.setIsRecyclable(false);
            this.C.start();
        }

        public void e() {
            float f16 = this.f275364d;
            float f17 = this.f275366f;
            if (f16 == f17) {
                this.F = this.f275368i.itemView.getTranslationX();
            } else {
                this.F = f16 + (this.J * (f17 - f16));
            }
            float f18 = this.f275365e;
            float f19 = this.f275367h;
            if (f18 == f19) {
                this.G = this.f275368i.itemView.getTranslationY();
            } else {
        ...
        @Override // com.tencent.mobileqq.qqvideoedit.editor.clipping.timeline.reorder.b, android.animation.Animator.AnimatorListener
        public void onAnimationEnd(Animator animator) {
            if (!this.I) {
                this.f275368i.setIsRecyclable(true);
            }
            this.I = true;
        }
