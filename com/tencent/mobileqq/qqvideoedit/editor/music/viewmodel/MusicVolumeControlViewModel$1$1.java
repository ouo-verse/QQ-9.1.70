...
final class MusicVolumeControlViewModel$1$1 extends Lambda implements Function1<Boolean, Unit> {
    ...
    public MusicVolumeControlViewModel$1$1(MediatorLiveData<Float> mediatorLiveData, MusicVolumeControlViewModel musicVolumeControlViewModel) {
        super(1);
    ...
    public final void invoke2(Boolean bool) {
        ...
        if (!bool.booleanValue()) {
            ...
            final MediatorLiveData<Float> mediatorLiveData3 = this.$this_apply;
            final Function1<Float, Unit> function1 = new Function1<Float, Unit>() { // from class: com.tencent.mobileqq.qqvideoedit.editor.music.viewmodel.MusicVolumeControlViewModel$1$1.1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(1);
                }
                ...
                public final void invoke2(Float f16) {
                    mediatorLiveData3.postValue(f16);
                }
            };
            mediatorLiveData2.addSource(mutableLiveData, new Observer() { // from class: com.tencent.mobileqq.qqvideoedit.editor.music.viewmodel.e
