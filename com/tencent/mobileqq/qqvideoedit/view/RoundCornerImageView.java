...
public class RoundCornerImageView extends PressDarkImageView {
    ...
    public void draw(Canvas canvas) {
        if (this.f276260m == null) {
            this.f276260m = new Path();
        }
        this.f276260m.reset();
        ...
        float f16 = i3;
        this.f276260m.addRoundRect(rectF, f16, f16, Path.Direction.CCW);
        this.f276260m.setFillType(Path.FillType.EVEN_ODD);
        canvas.clipPath(this.f276260m);
        super.draw(canvas);
        if (this.F) {
