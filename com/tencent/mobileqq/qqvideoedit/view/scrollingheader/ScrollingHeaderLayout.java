...
public class ScrollingHeaderLayout extends LinearLayout implements CoordinatorLayout.AttachedBehavior {
    ...
    private int f276330d;

    /* renamed from: e, reason: collision with root package name */
    private int f276331e;

    /* renamed from: f, reason: collision with root package name */
    private int f276332f;

    /* renamed from: h, reason: collision with root package name */
    @Nullable
    private WindowInsetsCompat f276333h;
    ...
    public static class BaseBehavior<T extends ScrollingHeaderLayout> extends HeaderBehavior<T> {
        ...
        private int f276334q;

        /* renamed from: r, reason: collision with root package name */
        private int f276335r;
        ...
        public class a implements AccessibilityViewCommand {
            ...
            final /* synthetic */ CoordinatorLayout f276336a;

            /* renamed from: b, reason: collision with root package name */
            final /* synthetic */ ScrollingHeaderLayout f276337b;

            /* renamed from: c, reason: collision with root package name */
            final /* synthetic */ View f276338c;

            /* renamed from: d, reason: collision with root package name */
            final /* synthetic */ int f276339d;

            a(CoordinatorLayout coordinatorLayout, ScrollingHeaderLayout scrollingHeaderLayout, View view, int i3) {
                this.f276336a = coordinatorLayout;
                this.f276337b = scrollingHeaderLayout;
                this.f276338c = view;
                this.f276339d = i3;
            }
            ...
            public boolean perform(@NonNull View view, @Nullable AccessibilityViewCommand.CommandArguments commandArguments) {
                BaseBehavior.this.onNestedPreScroll(this.f276336a, this.f276337b, this.f276338c, 0, this.f276339d, new int[]{0, 0}, 1);
                return true;
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // com.tencent.mobileqq.qqvideoedit.view.scrollingheader.HeaderBehavior
        ...
        @Override // com.tencent.mobileqq.qqvideoedit.view.scrollingheader.ViewOffsetBehavior
        ...
        int getTopBottomOffsetForScrollingSibling() {
            return getTopAndBottomOffset() + this.f276334q;
        }
        ...
        @Override // com.tencent.mobileqq.qqvideoedit.view.scrollingheader.HeaderBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        public /* bridge */ /* synthetic */ boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull MotionEvent motionEvent) {
            return super.onInterceptTouchEvent(coordinatorLayout, view, motionEvent);
        }

        @Override // com.tencent.mobileqq.qqvideoedit.view.scrollingheader.ViewOffsetBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
    ...
    public static class ScrollingViewBehavior extends HeaderScrollingViewBehavior {
        ...
        private void offsetChildAsNeeded(@NonNull View view, @NonNull View view2) {
            ...
            if (behavior instanceof BaseBehavior) {
                ViewCompat.offsetTopAndBottom(view, (((view2.getBottom() - view.getTop()) + ((BaseBehavior) behavior).f276334q) + getVerticalLayoutGap()) - getOverlapPixelsForOffset(view2));
            }
        }

        @Override // com.tencent.mobileqq.qqvideoedit.view.scrollingheader.HeaderScrollingViewBehavior
        @Nullable
        ...
        @Override // com.tencent.mobileqq.qqvideoedit.view.scrollingheader.HeaderScrollingViewBehavior, androidx.coordinatorlayout.widget.CoordinatorLayout.Behavior
        ...
        public boolean onRequestChildRectangleOnScreen(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull Rect rect, boolean z16) {
            if (findFirstDependency(coordinatorLayout.getDependencies(view)) != null) {
                ...
                this.f276326j.set(0, 0, coordinatorLayout.getWidth(), coordinatorLayout.getHeight());
            }
            return false;
        }
    ...
    @VisibleForTesting
    final int c() {
        WindowInsetsCompat windowInsetsCompat = this.f276333h;
    ...
    WindowInsetsCompat i(WindowInsetsCompat windowInsetsCompat) {
        ...
        if (!ObjectsCompat.equals(this.f276333h, windowInsetsCompat2)) {
            this.f276333h = windowInsetsCompat2;
            l();
            requestLayout();
        }
