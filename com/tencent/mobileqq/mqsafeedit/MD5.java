...
public class MD5 {
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(9444);
    ...
    */
    ...
    /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:51:0x0034 -> B:19:0x004f). Please report as a decompilation issue!!! */
    ...
    public static String toMD5(byte[] bArr) {
        ...
        for (int i3 = 0; i3 < 16; i3++) {
            str = String.valueOf(str) + byteHEX(md5[i3]);
        }
        return str;
    }
    ...
    public byte[] getMD5(byte[] bArr, int i3, int i16) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 3)) {
            return (byte[]) iPatchRedirector.redirect((short) 3, this, bArr, Integer.valueOf(i3), Integer.valueOf(i16));
        }
    ...
    public static String toMD5(String str) {
        ...
        for (int i3 = 0; i3 < 16; i3++) {
            str2 = String.valueOf(str2) + byteHEX(md5[i3]);
        }
        return str2;
    }
    ...
    public byte[] getMD5(InputStream inputStream, long j3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 4)) {
            return (byte[]) iPatchRedirector.redirect((short) 4, this, inputStream, Long.valueOf(j3));
        }
