...
public class ShaderHelper {
    ...
    public static int compileShader(int i3, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            if (iArr[0] == 0) {
                Logger.e(TAG, "Error compiling shader: " + GLES20.glGetShaderInfoLog(glCreateShader));
                GLES20.glDeleteShader(glCreateShader);
                glCreateShader = 0;
            }
        }
        if (glCreateShader == 0) {
            Logger.e(TAG, "Error creating shader.");
        }
    ...
    public static int createAndLinkProgram(int i3, int i16, String[] strArr) {
        ...
        if (glCreateProgram != 0) {
            ...
            if (iArr[0] == 0) {
                Logger.e(TAG, "Error compiling program: " + GLES20.glGetProgramInfoLog(glCreateProgram));
