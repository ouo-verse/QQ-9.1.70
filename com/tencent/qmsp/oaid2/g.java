...
public interface g extends IInterface {
    ...
    public static abstract class a extends Binder implements g {
        ...
        /* compiled from: P */
        /* renamed from: com.tencent.qmsp.oaid2.g$a$a, reason: collision with other inner class name */
        /* loaded from: classes22.dex */
        private static class C9340a implements g {
            static IPatchRedirector $redirector_;

            /* renamed from: a, reason: collision with root package name */
            private IBinder f344222a;

            C9340a(IBinder iBinder) {
                IPatchRedirector iPatchRedirector = $redirector_;
                if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                    iPatchRedirector.redirect((short) 1, (Object) this, (Object) iBinder);
                } else {
                    this.f344222a = iBinder;
                }
            }
            ...
            public String a(String str) {
                ...
                try {
                    try {
                        ...
                        OaidMonitor.binderTransact(this.f344222a, 4, obtain, obtain2, 0);
            ...
            public String b(String str) {
                ...
                try {
                    try {
                        OaidMonitor.writeParcelToken(obtain, "com.coolpad.deviceidsupport.IDeviceIdManager");
                        obtain.writeString(str);
                        OaidMonitor.binderTransact(this.f344222a, 2, obtain, obtain2, 0);
                        obtain2.readException();
                        str2 = obtain2.readString();
                    } catch (RemoteException e16) {
                        e16.printStackTrace();
