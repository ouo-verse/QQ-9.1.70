...
public class k0 {
    ...
    private static final Uri f344231a;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(16599);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 1)) {
            redirector.redirect((short) 1);
        } else {
            f344231a = Uri.parse("content://cn.nubia.identity/identity");
        }
    }
    ...
    public static String a(Context context, String str) {
        try {
            ...
            ContentProviderClient acquireUnstableContentProviderClient = context.getContentResolver().acquireUnstableContentProviderClient(f344231a);
            ...
            if (call.getInt("code", -1) == 0) {
                ...
                t0.b("NubiaLog succeed:" + string);
                return string;
            }
            String string2 = call.getString("message");
            t0.b("NubiaLog failed:" + string2);
            return string2;
        } catch (Exception e16) {
            e16.printStackTrace();
            return null;
