...
public class f0 {
    ...
    public static volatile f0 f344215g;
    ...
    public Boolean f344220e;

    /* renamed from: f, reason: collision with root package name */
    public BroadcastReceiver f344221f;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(16259);
    ...
    public f0() {
        ...
        this.f344216a = new e0("udid");
        this.f344217b = new e0("oaid");
        this.f344219d = new e0("vaid");
        this.f344218c = new e0("aaid");
    }
    ...
    public static h0 a(Cursor cursor) {
        ...
        if (cursor == null) {
            ...
            if (columnIndex >= 0) {
                h0Var.f344227c = cursor.getString(columnIndex);
            } else {
                b("parseValue fail, index < 0.");
            }
            int columnIndex2 = cursor.getColumnIndex("code");
            if (columnIndex2 >= 0) {
                h0Var.f344225a = cursor.getInt(columnIndex2);
            } else {
                b("parseCode fail, index < 0.");
            }
            int columnIndex3 = cursor.getColumnIndex("expired");
            if (columnIndex3 >= 0) {
                h0Var.f344226b = cursor.getLong(columnIndex3);
            } else {
    ...
    public final String a(Context context, e0 e0Var) {
        ...
        if (!e0Var.a()) {
            b("queryId : " + e0Var.f344207c);
            try {
                cursor = ContactsMonitor.query(context.getContentResolver(), Uri.parse("content://com.meizu.flyme.openidsdk/"), null, null, new String[]{e0Var.f344207c}, null);
            ...
            try {
                ...
                try {
                    h0 a16 = a(cursor);
                    String str = a16.f344227c;
                    try {
                        e0Var.a(str);
                        e0Var.a(a16.f344226b);
                        e0Var.a(a16.f344225a);
                        b(e0Var.f344207c + " errorCode : " + e0Var.f344205a);
                        if (a16.f344225a == 1000) {
                            cursor.close();
                            return str;
                        }
                        a(context);
    ...
    public e0 a(String str) {
        ...
        if ("oaid".equals(str)) {
            return this.f344217b;
        }
        if ("vaid".equals(str)) {
            return this.f344219d;
        }
        if ("aaid".equals(str)) {
            return this.f344218c;
        }
        if ("udid".equals(str)) {
            return this.f344216a;
        }
        return null;
    }
