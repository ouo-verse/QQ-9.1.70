...
public interface n extends IInterface {
    ...
    public static abstract class a extends Binder implements n {
        ...
        /* loaded from: classes22.dex */
        public static class C9341a implements n {
            static IPatchRedirector $redirector_;

            /* renamed from: a, reason: collision with root package name */
            public IBinder f344249a;

            public C9341a(IBinder iBinder) {
                IPatchRedirector iPatchRedirector = $redirector_;
                if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
                    iPatchRedirector.redirect((short) 1, (Object) this, (Object) iBinder);
                } else {
                    this.f344249a = iBinder;
                }
            }
            ...
            public boolean b() {
                ...
                try {
                    ...
                    OaidMonitor.binderTransact(this.f344249a, 1, obtain, obtain2, 0);
            ...
            public String c() {
                ...
                try {
                    OaidMonitor.writeParcelToken(obtain, "com.asus.msa.SupplementaryDID.IDidAidlInterface");
                    OaidMonitor.binderTransact(this.f344249a, 3, obtain, obtain2, 0);
                    obtain2.readException();
            ...
            public String i() {
                ...
                try {
                    OaidMonitor.writeParcelToken(obtain, "com.asus.msa.SupplementaryDID.IDidAidlInterface");
                    OaidMonitor.binderTransact(this.f344249a, 5, obtain, obtain2, 0);
                    obtain2.readException();
                    String readString = obtain2.readString();
                    OaidMonitor.parcelRecycle(obtain2);
                    OaidMonitor.parcelRecycle(obtain);
