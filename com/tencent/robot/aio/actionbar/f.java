...
/* compiled from: P */
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u0000 \u00072\u00020\u0001:\u0001\"B/\u0012\u0006\u0010\u000f\u001a\u00020\n\u0012\u0006\u0010\u001f\u001a\u00020\u001e\u0012\b\u0010\u0014\u001a\u0004\u0018\u00010\u0010\u0012\f\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00060\u0015\u00a2\u0006\u0004\b \u0010!J\b\u0010\u0003\u001a\u00020\u0002H\u0016J\b\u0010\u0005\u001a\u00020\u0004H\u0016J\b\u0010\u0007\u001a\u00020\u0006H\u0016J\b\u0010\b\u001a\u00020\u0004H\u0016J\b\u0010\t\u001a\u00020\u0002H\u0016R\u0017\u0010\u000f\u001a\u00020\n8\u0006\u00a2\u0006\f\n\u0004\b\u000b\u0010\f\u001a\u0004\b\r\u0010\u000eR\u0019\u0010\u0014\u001a\u0004\u0018\u00010\u00108\u0006\u00a2\u0006\f\n\u0004\b\t\u0010\u0011\u001a\u0004\b\u0012\u0010\u0013R\u001d\u0010\u0019\u001a\b\u0012\u0004\u0012\u00020\u00060\u00158\u0006\u00a2\u0006\f\n\u0004\b\u0003\u0010\u0016\u001a\u0004\b\u0017\u0010\u0018R\u0016\u0010\u001d\u001a\u00020\u001a8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u001b\u0010\u001c\u00a8\u0006#"}, d2 = {"Lcom/tencent/robot/aio/actionbar/f;", "Lcom/tencent/qqnt/aio/menu/ui/d;", "", "f", "", "c", "", h.F, "b", "e", "Landroid/content/Context;", "d", "Landroid/content/Context;", "getContext", "()Landroid/content/Context;", "context", "Lcom/tencent/qqnt/kernel/nativeinterface/InlineKeyboardButton;", "Lcom/tencent/qqnt/kernel/nativeinterface/InlineKeyboardButton;", "getButton", "()Lcom/tencent/qqnt/kernel/nativeinterface/InlineKeyboardButton;", "button", "Lkotlin/Function0;", "Lkotlin/jvm/functions/Function0;", "getOnClick", "()Lkotlin/jvm/functions/Function0;", NodeProps.ON_CLICK, "", "g", "Z", "isLike", "Lcom/tencent/mobileqq/aio/msg/AIOMsgItem;", "msgItem", "<init>", "(Landroid/content/Context;Lcom/tencent/mobileqq/aio/msg/AIOMsgItem;Lcom/tencent/qqnt/kernel/nativeinterface/InlineKeyboardButton;Lkotlin/jvm/functions/Function0;)V", "a", "robot-business-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes25.dex */
public final class f extends com.tencent.qqnt.aio.menu.ui.d {
    ...
    public f(@NotNull Context context, @NotNull AIOMsgItem msgItem, @Nullable InlineKeyboardButton inlineKeyboardButton, @NotNull Function0<Unit> onClick) {
        super(msgItem);
        Integer num;
        int i3;
    ...
    public static final void j(f this$0, int i3, String str) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        QLog.i("RobotLikeMenuItem", 1, "[getMemberInfo]: result is " + i3 + ", errMsg is " + str);
        if (i3 != 0) {
    ...
    public int b() {
        if (this.isLike) {
            return R.drawable.qui_like_filled_allwhite_primary;
        }
        return R.drawable.qui_like_allwhite_primary;
    }
    ...
    public String getTitle() {
        String string = this.context.getString(R.string.f222396de);
        Intrinsics.checkNotNullExpressionValue(string, "context.getString(R.string.robot_like)");
        return string;
    }
    ...
    public void h() {
        ...
        ((IMsgService) QRoute.api(IMsgService.class)).likeOrDislikeReportForMsg(contact, feedBackMsgInfo, new FeedBackDataForMsg(1, z16, str2), new IOperateCallback() { // from class: com.tencent.robot.aio.actionbar.e
