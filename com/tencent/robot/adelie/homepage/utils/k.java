...
public final class k {
    ...
    private final boolean c() {
        if (!QQTheme.isNowThemeIsNight() && !QQTheme.isDefaultTheme() && !Intrinsics.areEqual("2971", QQTheme.getCurrentThemeId())) {
            return true;
        }
        return false;
    }
    ...
    private final void d() {
        ...
        if (je0.a.a(BaseApplication.getContext())) {
            be0.a.b("zplan").c(QUIProfileConstants.DEFAULT_NIGHT_COLOR_PALETTE);
        } else {
