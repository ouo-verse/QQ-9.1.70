...
final class AdelieAvatarGenerateFragment$loadPagSoAsync$1$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ Function1<Boolean, Unit> $resultBlock;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    /* JADX WARN: Multi-variable type inference failed */
    public AdelieAvatarGenerateFragment$loadPagSoAsync$1$1(Function1<? super Boolean, Unit> function1) {
        super(0);
    ...
    public final void invoke2() {
        ...
        if (!initPagSo) {
            QLog.e("AdelieUgcImagePreviewFragment", 1, "load so failed.");
        }
        Handler uIHandlerV2 = ThreadManagerV2.getUIHandlerV2();
        final Function1<Boolean, Unit> function1 = this.$resultBlock;
        uIHandlerV2.post(new Runnable() { // from class: com.tencent.robot.adelie.homepage.ugc.ab
            @Override // java.lang.Runnable
            public final void run() {
                AdelieAvatarGenerateFragment$loadPagSoAsync$1$1.b(Function1.this, initPagSo);
            }
        });
    }
}
