...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B'\b\u0007\u0012\u0006\u0010\u0018\u001a\u00020\u0017\u0012\n\b\u0002\u0010\u001a\u001a\u0004\u0018\u00010\u0019\u0012\b\b\u0002\u0010\u001b\u001a\u00020\u0005\u00a2\u0006\u0004\b\u001c\u0010\u001dJ\b\u0010\u0003\u001a\u00020\u0002H\u0002J\u000e\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u0002J\u000e\u0010\u0007\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u0002J\u000e\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00050\u0004H\u0002J\b\u0010\n\u001a\u0004\u0018\u00010\tJ\u0006\u0010\u000b\u001a\u00020\u0002J\u000e\u0010\r\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u0005J\u000e\u0010\u000e\u001a\u00020\u00022\u0006\u0010\f\u001a\u00020\u0005R\u0018\u0010\u0010\u001a\u0004\u0018\u00010\t8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u0007\u0010\u000fR\u0018\u0010\u0013\u001a\u0004\u0018\u00010\u00118\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\b\u0010\u0012R\u0018\u0010\u0014\u001a\u0004\u0018\u00010\t8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u000fR\u0018\u0010\u0016\u001a\u0004\u0018\u00010\t8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\u0015\u0010\u000f\u00a8\u0006\u001e"}, d2 = {"Lcom/tencent/robot/adelie/homepage/create/view/AdeliePolarLightBkgView;", "Landroid/widget/RelativeLayout;", "", "f", "", "", "c", "d", "e", "Landroid/view/View;", "a", "b", "visibility", "setMaskVisibility", "setBackgroundVisibility", "Landroid/view/View;", "contentView", "Lcom/tencent/biz/qui/quipolarlight/QUIPolarLightView;", "Lcom/tencent/biz/qui/quipolarlight/QUIPolarLightView;", "polarLightView", "polarMask", tl.h.F, "bgView", "Landroid/content/Context;", "context", "Landroid/util/AttributeSet;", Node.ATTRS_ATTR, "defStyleAttr", "<init>", "(Landroid/content/Context;Landroid/util/AttributeSet;I)V", "robot-business-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes25.dex */
public final class AdeliePolarLightBkgView extends RelativeLayout {
    ...
    @JvmOverloads
    public AdeliePolarLightBkgView(@NotNull Context context) {
    ...
    private final void f() {
        ...
        if (view3 != null) {
            qUIPolarLightView = (QUIPolarLightView) view3.findViewById(R.id.f26260d2);
        } else {
        ...
        if (view4 != null) {
            view = view4.findViewById(R.id.f26280d4);
        } else {
            view = null;
        }
        this.polarMask = view;
        ...
        if (view5 != null) {
            view2 = view5.findViewById(R.id.vry);
        } else {
            view2 = null;
        }
        this.bgView = view2;
    ...
    public final View a() {
        ...
        this.contentView = LayoutInflater.from(getContext()).inflate(R.layout.dsv, this);
        f();
    ...
    public final void setBackgroundVisibility(int visibility) {
    ...
    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public AdeliePolarLightBkgView(@NotNull Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0, 4, null);
        Intrinsics.checkNotNullParameter(context, "context");
    }

    public /* synthetic */ AdeliePolarLightBkgView(Context context, AttributeSet attributeSet, int i3, int i16, DefaultConstructorMarker defaultConstructorMarker) {
        this(context, (i16 & 2) != 0 ? null : attributeSet, (i16 & 4) != 0 ? 0 : i3);
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    @JvmOverloads
    public AdeliePolarLightBkgView(@NotNull Context context, @Nullable AttributeSet attributeSet, int i3) {
