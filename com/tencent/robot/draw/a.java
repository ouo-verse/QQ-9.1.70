...
public final class a implements c {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0005\b\u0082\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0005\u0010\u0006R\u0014\u0010\u0003\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0003\u0010\u0004\u00a8\u0006\u0007"}, d2 = {"Lcom/tencent/robot/draw/a$a;", "", "", "TAG", "Ljava/lang/String;", "<init>", "()V", "robot-business-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: com.tencent.robot.draw.a$a, reason: collision with other inner class name */
    /* loaded from: classes25.dex */
    private static final class C9773a {
        public /* synthetic */ C9773a(DefaultConstructorMarker defaultConstructorMarker) {
            this();
        }
    ...
    public void d(@NotNull View rootView) {
        ...
        this.mAIOContext.e().h(new AIOMsgSendEvent.SetAIBusinessFlag(2));
        this.mAIOContext.e().h(new SlashDialogMsgIntent.OnSlashDialogChanged(true));
        HashMap hashMap = new HashMap();
        MMKVOptionEntityV2 fromV2 = QMMKV.fromV2(rootView.getContext().getApplicationContext(), "common_mmkv_configurations");
        Intrinsics.checkNotNullExpressionValue(fromV2, "fromV2(rootView.context.\u2026t, QMMKVFile.FILE_COMMON)");
        hashMap.put("is_auto_polish", Integer.valueOf(fromV2.getBoolean("robot_ai_draw_revise_switch", true) ? 1 : 0));
        b.q("em_bas_ai_draw_floating", hashMap);
    }
    ...
    @Override // com.tencent.robot.slash.businessapi.c
    @Nullable
    public com.tencent.robot.slash.businessapi.a j(@Nullable Object drawResponse, @NotNull String keyword) {
    ...
    public n<u54.c> m(@NotNull com.tencent.mvi.api.runtime.b mviContext) {
        ...
        return new b44.a(this.mAIOContext, this);
    }
}
