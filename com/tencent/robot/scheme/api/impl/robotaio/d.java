    ...
    public ax a(@Nullable BaseQQAppInterface app, @Nullable Context context, @Nullable String jump, @Nullable JumpParserResult jumpParserResult) {
        if (app != null && jump != null && jumpParserResult != null) {
            ...
            if (QLog.isColorLevel()) {
                QLog.d("RobotAIOJumpParser", 2, "parse, jumpParserResult=" + jumpParserResult);
            }
            return bVar;
        }
        QLog.e("RobotAIOJumpParser", 1, "parse, invalid arguments, app=" + app + ", context=" + context + " jump=" + jump + " jumpParserResult=" + jumpParserResult);
        return null;
    }
}
