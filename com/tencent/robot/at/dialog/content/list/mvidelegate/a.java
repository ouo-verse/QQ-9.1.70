...
public final class a implements c<f, e<u54.c>> {
    ...
    public f a(@NotNull com.tencent.mvi.api.help.a createViewParams) {
        ...
        CommonListVB.Companion companion = CommonListVB.INSTANCE;
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -1);
        layoutParams.weight = 1.0f;
        Unit unit = Unit.INSTANCE;
        return companion.a(createViewParams, layoutParams);
    }
    ...
    public List<com.tencent.input.base.mvicompat.c<com.tencent.robot.widget.list.vb.a, CommonListUIState, d, ? super f>> b(@NotNull d host) {
        ...
        listOf = CollectionsKt__CollectionsKt.listOf((Object[]) new com.tencent.input.base.mvicompat.c[]{new f64.a(host), new RobotAtListVBDelegate(host)});
        return listOf;
    }
