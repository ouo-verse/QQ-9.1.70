...
public final class Caelum {
    ...
    public ByteBuffer f375490a;

    /* renamed from: b, reason: collision with root package name */
    public String f375491b;
    ...
    public final void a() {
        ...
        ByteBuffer byteBuffer = this.f375490a;
    ...
    public final boolean b(int i3) {
        ...
        while (true) {
            try {
                ByteBuffer duplicate = this.f375490a.duplicate();
                ...
                a(i17);
                a(b17);
            } catch (Auriga | BufferUnderflowException unused) {
                return false;
            }
        }
        return i3 == i16;
    ...
    public Caelum(byte[] bArr, int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public final void a(byte b16) {
        ...
        switch (b16) {
            ...
            case 13:
                ...
                throw new Auriga("skipField with invalid type, type value: " + ((int) b16) + ", " + ((int) b18));
            default:
                throw new Auriga("invalid type.");
        }
    }
    ...
    public final void b() {
        ...
        while (this.f375490a.remaining() != 0) {
            ByteBuffer byteBuffer = this.f375490a;
            byte b16 = byteBuffer.get();
            byte b17 = (byte) (b16 & RegisterType.DOUBLE_HI);
            if (((b16 & 240) >> 4) == 15) {
    ...
    public final String b(int i3, boolean z16) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 17)) {
            return (String) iPatchRedirector.redirect((short) 17, this, Integer.valueOf(i3), Boolean.valueOf(z16));
        }
        if (b(i3)) {
            ByteBuffer byteBuffer = this.f375490a;
            byte b16 = byteBuffer.get();
            ...
            if (b17 == 6) {
                ...
                this.f375490a.get(bArr);
                try {
                    return new String(bArr, this.f375491b);
                } catch (UnsupportedEncodingException unused) {
                    return new String(bArr);
                }
            }
            if (b17 == 7) {
                int i17 = this.f375490a.getInt();
                if (i17 <= 104857600 && i17 >= 0) {
                    byte[] bArr2 = new byte[i17];
                    this.f375490a.get(bArr2);
                    try {
                        return new String(bArr2, this.f375491b);
                    } catch (UnsupportedEncodingException unused2) {
                        return new String(bArr2);
                    }
                }
                throw new Auriga("String too long: " + i17);
            }
            if (b17 != 11) {
                throw new Auriga("type mismatch.");
            }
        } else if (z16) {
            throw new Auriga("require field not exist.");
        }
        return null;
    }

    public final boolean a(boolean z16, int i3, boolean z17) {
        IPatchRedirector iPatchRedirector = $redirector_;
    ...
    public final <T> T[] b(T t16, int i3, boolean z16) {
        ...
        if (a16 >= 0) {
            ...
            for (int i16 = 0; i16 < a16; i16++) {
                tArr[i16] = a((Caelum) t16, 0, true);
            }
            return tArr;
        }
        throw new Auriga("size invalid: " + a16);
    }
    ...
    public final long a(long j3, int i3, boolean z16) {
        ...
        if (b17 == 0) {
            i16 = this.f375490a.get();
        } else if (b17 == 1) {
            i16 = this.f375490a.getShort();
        } else {
            if (b17 != 2) {
                if (b17 == 3) {
                    return this.f375490a.getLong();
                }
                throw new Auriga("type mismatch.");
            }
            i16 = this.f375490a.getInt();
        }
        return i16;
    }
    ...
    public final double a(double d16, int i3, boolean z16) {
        ...
        if (b17 == 5) {
            return this.f375490a.getDouble();
        }
        if (b17 == 11) {
            return d16;
        }
    ...
    public final <K, V> HashMap<K, V> a(Map<K, V> map, int i3, boolean z16) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 18)) {
            return (HashMap) iPatchRedirector.redirect((short) 18, this, map, Integer.valueOf(i3), Boolean.valueOf(z16));
        }
        ...
        if (map != null && !map.isEmpty()) {
            ...
            for (int i16 = 0; i16 < a16; i16++) {
                mapFieldLite.put(a((Caelum) key, 0, true), a((Caelum) value, 1, true));
            }
            return mapFieldLite;
        }
        return new HashMap<>();
    ...
    public final byte[] a(int i3, boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 21)) {
            return (byte[]) iPatchRedirector.redirect((short) 21, this, Integer.valueOf(i3), Boolean.valueOf(z16));
        }
        if (b(i3)) {
            ByteBuffer byteBuffer = this.f375490a;
            byte b16 = byteBuffer.get();
            ...
            if (b17 != 11) {
                if (b17 == 13) {
                    ByteBuffer byteBuffer2 = this.f375490a;
                    ...
                    if (b19 == 0) {
                        ...
                        throw new Auriga("invalid size, tag: " + i3 + ", type: " + ((int) b17) + ", " + ((int) b19) + ", size: " + a17);
                    }
                    throw new Auriga("type mismatch, tag: " + i3 + ", type: " + ((int) b17) + ", " + ((int) b19));
                }
                throw new Auriga("type mismatch.");
            }
        } else if (z16) {
    ...
    public final CanisMinor a(CanisMinor canisMinor, int i3, boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 19)) {
            return (CanisMinor) iPatchRedirector.redirect((short) 19, this, canisMinor, Integer.valueOf(i3), Boolean.valueOf(z16));
        }
        if (!b(i3)) {
            if (z16) {
                throw new Auriga("require field not exist.");
        ...
        try {
            CanisMinor canisMinor2 = (CanisMinor) canisMinor.getClass().newInstance();
            ByteBuffer byteBuffer = this.f375490a;
            byte b16 = byteBuffer.get();
            byte b17 = (byte) (b16 & RegisterType.DOUBLE_HI);
            if (((b16 & 240) >> 4) == 15) {
            ...
            throw new Auriga(e16.getMessage());
        }
    }
    ...
    public final <T> Object a(T t16, int i3, boolean z16) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 20)) {
            return iPatchRedirector.redirect((short) 20, this, t16, Integer.valueOf(i3), Boolean.valueOf(z16));
        }
        ...
        if (t16 instanceof CanisMinor) {
            return a((CanisMinor) t16, i3, z16);
        }
        if (t16.getClass().isArray()) {
            if (!(t16 instanceof byte[]) && !(t16 instanceof Byte[])) {
                    ...
                    if (b(i3)) {
                        ...
                        if (b26 == 9) {
                            ...
                            if (a17 >= 0) {
                                ...
                                throw new Auriga("size invalid: " + a17);
                            }
                        } else if (b26 != 11) {
                            throw new Auriga("type mismatch.");
                        }
                ...
                if (t16 instanceof int[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer3 = this.f375490a;
                        ...
                        if (b28 == 9) {
                            ...
                            if (a18 >= 0) {
                                ...
                                throw new Auriga("size invalid: " + a18);
                            }
                        } else if (b28 != 11) {
                            throw new Auriga("type mismatch.");
                        }
                ...
                if (t16 instanceof long[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer4 = this.f375490a;
                        ...
                        if (b36 == 9) {
                            ...
                            if (a19 >= 0) {
                                ...
                                throw new Auriga("size invalid: " + a19);
                            }
                        } else if (b36 != 11) {
                            throw new Auriga("type mismatch.");
                        }
                ...
                if (t16 instanceof float[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer5 = this.f375490a;
                        ...
                        if (b38 == 9) {
                            ...
                            if (a26 >= 0) {
                                ...
                                throw new Auriga("size invalid: " + a26);
                            }
                        } else if (b38 != 11) {
                            throw new Auriga("type mismatch.");
                        }
                ...
                if (t16 instanceof double[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer6 = this.f375490a;
                        ...
                        if (b46 == 9) {
                            ...
                            if (a27 >= 0) {
                                ...
                                throw new Auriga("size invalid: " + a27);
                            }
                        } else if (b46 != 11) {
                            throw new Auriga("type mismatch.");
                        }
                ...
                throw new Auriga("unable to get type of key and value.");
            }
            return a(i3, z16);
        }
        throw new Auriga("read object error: unsupport type.");
    }
}
