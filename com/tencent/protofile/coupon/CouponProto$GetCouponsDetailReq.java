...
public final class CouponProto$GetCouponsDetailReq extends MessageMicro<CouponProto$GetCouponsDetailReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24}, new String[]{QQGamePreDownloadServiceImpl.QQGAME_BIDS_KEY, "cids", "source_ids"}, new Object[]{0, 0, 0}, CouponProto$GetCouponsDetailReq.class);
    ...
    public CouponProto$GetCouponsDetailReq() {
