...
public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener {
    ...
    private abstract class BaseConfigChooser implements EGLConfigChooser {
        ...
        @Override // com.tencent.qq.effect.alphavideo.videoplayer.view.GLTextureView.EGLConfigChooser
    ...
    private class ComponentSizeChooser extends BaseConfigChooser {
        ...
        @Override // com.tencent.qq.effect.alphavideo.videoplayer.view.GLTextureView.BaseConfigChooser
    ...
    private class DefaultContextFactory implements EGLContextFactory {
        ...
        @Override // com.tencent.qq.effect.alphavideo.videoplayer.view.GLTextureView.EGLContextFactory
    ...
    private static class DefaultWindowSurfaceFactory implements EGLWindowSurfaceFactory {
        ...
        @Override // com.tencent.qq.effect.alphavideo.videoplayer.view.GLTextureView.EGLWindowSurfaceFactory
                                    ...
                                    try {
                                        if (!this.mEventQueue.isEmpty()) {
                                            ...
                                            if (!this.mHasSurface && !this.mWaitingForSurface) {
                                                ...
                                                z26 = z55;
                                                sb5.append(getId());
                                                LogUtil.d(GLTextureView.TAG, sb5.toString());
                ...
                synchronized (GLTextureView.sGLThreadManager) {
                    ...
                    while (!this.mWaitingForSurface && !this.mExited) {
                        if (!this.mLogPrinted) {
                            ...
                            LogUtil.d(GLTextureView.TAG, "mWaitingForSurface " + this.mWaitingForSurface + " mExited " + this.mExited);
                        }
                        try {
                            LockMethodProxy.wait(GLTextureView.sGLThreadManager);
                        } catch (InterruptedException unused) {
    ...
    public static class GLThreadManager {
        ...
        static {
            IPatchRedirector redirector = PatchRedirectCenter.getRedirector(TVKEventId.PLAYER_STATE_PRE_AD_CGI_HTTP_REQUEST);
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(11385);
        $redirector_ = redirector;
    ...
    public GLTextureView(Context context) {
        ...
        this.mCheckAlphaTask = new Runnable() { // from class: com.tencent.qq.effect.alphavideo.videoplayer.view.GLTextureView.1
            static IPatchRedirector $redirector_;
            ...
            public void run() {
                ...
                LogUtil.d(GLTextureView.TAG, "TextureView mCheckAlphaTask,alpha:" + GLTextureView.this.getViewAlpha());
    ...
    private void init() {
        ...
        addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.tencent.qq.effect.alphavideo.videoplayer.view.GLTextureView.2
            static IPatchRedirector $redirector_;
    ...
    public void setViewAlpha(float f16) {
        setAlpha(f16);
        LogUtil.d(TAG, "TextureView setAlpha,alpha:" + f16);
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i3, int i16) {
        ...
        LogUtil.d(TAG, " TextureView onSurfaceTextureAvailable surfaceCreated use:" + (System.currentTimeMillis() - currentTimeMillis));
    }
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surfaceTexture) {
        ...
        LogUtil.d(TAG, " TextureView onSurfaceTextureDestroyed");
        setViewAlpha(0.0f);
        return true;
    }
    ...
    public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i3, int i16) {
        ...
        LogUtil.d(TAG, " TextureView onSurfaceTextureSizeChanged surfaceChanged use:" + (System.currentTimeMillis() - currentTimeMillis));
    }
    ...
    public void surfaceChanged(SurfaceTexture surfaceTexture, int i3, int i16, int i17) {
        ...
        if (this.mSurfaceWidth != i16 || this.mSurfaceHeight != i17) {
            ...
            LogUtil.d(TAG, " surfaceChanged, onWindowResize");
        }
        removeCallbacks(this.mCheckAlphaTask);
        if (this.mSurfaceTextureAvailable && getViewAlpha() != 1.0f) {
            setViewAlpha(1.0f);
        }
        LogUtil.d(TAG, " surfaceChanged, w:" + i16 + ",h:" + i17 + " use:" + (System.currentTimeMillis() - currentTimeMillis));
    }
