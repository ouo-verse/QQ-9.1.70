...
final class MiniBoxAppManagerFragment$1$1 extends Lambda implements Function1<MiniBoxDownloadTask, Unit> {
    final /* synthetic */ MiniBoxAppManagerFragment this$0;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public MiniBoxAppManagerFragment$1$1(MiniBoxAppManagerFragment miniBoxAppManagerFragment) {
        super(1);
        this.this$0 = miniBoxAppManagerFragment;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void b(MiniBoxAppManagerFragment this$0, MiniBoxDownloadTask it) {
    ...
    public final void invoke2(@NotNull final MiniBoxDownloadTask it) {
        ...
        uIHandlerV2.post(new Runnable() { // from class: com.tencent.qq.minibox.ui.x
            @Override // java.lang.Runnable
            public final void run() {
                MiniBoxAppManagerFragment$1$1.b(MiniBoxAppManagerFragment.this, it);
            }
        });
    }
}
