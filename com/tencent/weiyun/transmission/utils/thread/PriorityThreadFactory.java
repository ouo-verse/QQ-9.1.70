...
public class PriorityThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(Runnable runnable) {
        ...
        return new BaseThread(runnable, this.mName + '-' + this.mNumber.getAndIncrement() + " sub:") { // from class: com.tencent.weiyun.transmission.utils.thread.PriorityThreadFactory.1
