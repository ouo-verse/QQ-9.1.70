...
public final class DownloaderTaskStatus {
    ...
    private static final /* synthetic */ DownloaderTaskStatus[] f113577a;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(12150);
        ...
        f113577a = new DownloaderTaskStatus[]{downloaderTaskStatus, downloaderTaskStatus2, downloaderTaskStatus3, downloaderTaskStatus4, downloaderTaskStatus5, downloaderTaskStatus6, downloaderTaskStatus7};
    }

    DownloaderTaskStatus(String str, int i3) {
    ...
    public static DownloaderTaskStatus[] values() {
        return (DownloaderTaskStatus[]) f113577a.clone();
    }
}
