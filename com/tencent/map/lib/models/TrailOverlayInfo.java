...
public class TrailOverlayInfo extends OverlayListenerInfo {
    ...
    public void setAnimateEndTime(int i3) {
        this.mAnimateEndTime = i3;
    }

    public void setAnimateStartTime(int i3) {
        this.mAnimateStartTime = i3;
    }
    ...
    public void setDataList(List<Collection<TrailLatLng>> list) {
        if (list != null && list.size() != 0) {
            ...
            for (int i3 = 0; i3 < list.size(); i3++) {
                Collection<TrailLatLng> collection = list.get(i3);
    ...
    public void setPlayRatio(float f16) {
        this.mPlayRatio = f16;
    }
