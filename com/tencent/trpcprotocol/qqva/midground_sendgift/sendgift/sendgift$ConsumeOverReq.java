...
public final class sendgift$ConsumeOverReq extends MessageMicro<sendgift$ConsumeOverReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 32, 40, 48, 56, 66, 74, 80}, new String[]{"req_msg", "info", "scene_id", "combo_seq", "combo_cnt", "all_combo_cnt", "plat", "report_ext", "ext_dict", "pay_from"}, new Object[]{ByteStringMicro.EMPTY, null, 0, 0L, 0, 0, 0, "", null, 0}, sendgift$ConsumeOverReq.class);
