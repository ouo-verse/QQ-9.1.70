...
public final class UserConfig$SetOptionsReq extends MessageMicro<UserConfig$SetOptionsReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"optionIDs", "options"}, new Object[]{0, null}, UserConfig$SetOptionsReq.class);
