...
public final class userInfo$BatchGetMiniUserInfoReq extends MessageMicro<userInfo$BatchGetMiniUserInfoReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 24}, new String[]{"account_ids", "account_type", "mini_info_ids"}, new Object[]{"", 0, 0}, userInfo$BatchGetMiniUserInfoReq.class);
