...
public final class InteractiveMarkerPB$InteractiveMarker extends MessageMicro<InteractiveMarkerPB$InteractiveMarker> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40, 48}, new String[]{"appid", "marker_id", "tinyid", "peer_tinyid", "count", "level"}, new Object[]{0, 0, 0L, 0L, 0L, 0L}, InteractiveMarkerPB$InteractiveMarker.class);
