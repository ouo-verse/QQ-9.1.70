...
public final class DownloadApkReport$DownloadInfo extends MessageMicro<DownloadApkReport$DownloadInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50}, new String[]{"filename", "client_ip", "timestamp", "guid", "client_ver", "url"}, new Object[]{byteStringMicro, byteStringMicro, "", byteStringMicro, "", ""}, DownloadApkReport$DownloadInfo.class);
    }

    public DownloadApkReport$DownloadInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
