...
public final class DownloaderTaskPriority {
    ...
    public static final /* synthetic */ DownloaderTaskPriority[] f114362a;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(10209);
        ...
        f114362a = new DownloaderTaskPriority[]{downloaderTaskPriority, downloaderTaskPriority2, downloaderTaskPriority3, downloaderTaskPriority4};
    }

    public DownloaderTaskPriority(String str, int i3) {
    ...
    public static DownloaderTaskPriority[] values() {
        return (DownloaderTaskPriority[]) f114362a.clone();
    }
}
