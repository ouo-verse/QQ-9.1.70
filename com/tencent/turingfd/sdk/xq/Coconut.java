...
public class Coconut {
    ...
    public static HashMap<String, Class<?>> f382651a;

    /* renamed from: b, reason: collision with root package name */
    public static HashMap<Class<?>, HashMap<String, Field>> f382652b;

    /* renamed from: c, reason: collision with root package name */
    public static HashMap<Class<?>, HashMap<String, Method>> f382653c;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(11286);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 1)) {
            redirector.redirect((short) 1);
            return;
        }
        f382651a = new HashMap<>();
        f382652b = new HashMap<>();
        f382653c = new HashMap<>();
    }
    ...
    public static Object a(String str, String str2) {
        ...
        try {
            try {
                cls = f382651a.get(str);
                if (cls == null) {
                    cls = Class.forName(str);
                }
                f382651a.put(str, cls);
            } catch (Throwable th5) {
                th5.printStackTrace();
                cls = null;
            }
    ...
    */
    public static Object a(Class<?> cls, String str, Object obj) {
        ...
        try {
            if (cls != null) {
                try {
                    hashMap = f382652b.get(cls);
                    if (hashMap == null) {
                        hashMap = new HashMap<>();
                        f382652b.put(cls, hashMap);
                    }
        ...
        if (cls != null) {
            try {
                if (!TextUtils.isEmpty(str)) {
                    ...
                    HashMap<String, Method> hashMap = f382653c.get(cls);
                    if (hashMap == null) {
                        hashMap = new HashMap<>();
                        f382653c.put(cls, hashMap);
                    }
