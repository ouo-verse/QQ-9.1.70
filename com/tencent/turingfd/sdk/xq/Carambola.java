    ...
    */
    public static String a(Context context, String str) {
        ...
        try {
            ...
            try {
                str2 = Vulpecula.a(((X509Certificate) CertificateFactory.getInstance("X.509").generateCertificate(byteArrayInputStream)).getEncoded());
        ...
        try {
            ...
            if (a16 != null) {
                for (Certificate certificate : a16) {
                    arrayList.add(Vulpecula.a(certificate.getEncoded()));
                }
            }
