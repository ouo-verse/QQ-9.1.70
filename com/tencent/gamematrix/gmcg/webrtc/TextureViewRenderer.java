...
public class TextureViewRenderer extends TextureView {
    ...
    public void onFrameResolutionChanged(int i3, int i16, int i17) {
        if (this.fullScreen) {
            ...
            CGLog.i("TextureViewRenderer onFrameResolutionChanged, width=" + i3 + ", height=" + i16);
            postOrRun(new Runnable() { // from class: com.tencent.gamematrix.gmcg.webrtc.c
    ...
    public void setFullScreen(boolean z16) {
        this.fullScreen = z16;
        CGLog.i("TextureViewRenderer setFullScreen=" + z16);
    }
