...
public class b extends zl0.a {
    public b(AdClickData adClickData, yl0.a aVar) {
        super(adClickData, aVar);
    }

    @Override // zl0.a
    public void f(yl0.a aVar, AdClickData adClickData) {
        dm0.a.e(GdtFeedUtilForQZone.l(), adClickData.m().getOperationInfo().appid, com.tencent.gdt.tangram.ad.qzone.embedded.b.h(adClickData));
    }
