...
public final class TimDocSSOMsg$CancelPinPadReqBody extends MessageMicro<TimDocSSOMsg$CancelPinPadReqBody> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 40, 50}, new String[]{"uint32_appid", "bytes_pad_url", "msg_login_info", "uint32_list_type", "uint32_domainid", "bytes_localpadid"}, new Object[]{0, byteStringMicro, null, 0, 0, byteStringMicro}, TimDocSSOMsg$CancelPinPadReqBody.class);
    }

    public TimDocSSOMsg$CancelPinPadReqBody() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
