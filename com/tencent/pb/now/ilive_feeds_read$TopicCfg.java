...
public final class ilive_feeds_read$TopicCfg extends MessageMicro<ilive_feeds_read$TopicCfg> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 32, 40, 50, 810}, new String[]{"topic_tag", "topic_desc", "topic_name", "topic_parti_num", "topic_type", "topic_pic_url", "jump_url"}, new Object[]{0, "", "", 0, 0, "", ""}, ilive_feeds_read$TopicCfg.class);
