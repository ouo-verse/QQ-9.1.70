...
public final class LbsShare$LocationReq extends MessageMicro<LbsShare$LocationReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 34, 42, 48, 56, 64, 74, 82}, new String[]{QCircleSchemeAttr.Polymerize.LAT, "lng", "coordinate", "keyword", "category", "page", "count", "requireMyLbs", "imei", "city"}, new Object[]{0, 0, 0, "", "", 0, 0, 0, "", ""}, LbsShare$LocationReq.class);
