...
public final class QidProfile$GetProfileRsp extends MessageMicro<QidProfile$GetProfileRsp> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26, 32}, new String[]{"imgurl", "qid_type", "resource", IPreloadServiceProxy.KEY_RESID}, new Object[]{"", 0, "", 0}, QidProfile$GetProfileRsp.class);
