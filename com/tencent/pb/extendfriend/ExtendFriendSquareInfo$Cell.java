...
public final class ExtendFriendSquareInfo$Cell extends MessageMicro<ExtendFriendSquareInfo$Cell> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 24, 32, 40}, new String[]{"int32_mcc", "int32_mnc", "int32_lac", "int32_cellid", "int32_rssi"}, new Object[]{-1, -1, -1, -1, 0}, ExtendFriendSquareInfo$Cell.class);
