...
public final class VipFontUpdate$TFontSsoReq extends MessageMicro<VipFontUpdate$TFontSsoReq> {
    ...
    public VipFontUpdate$TFontFreshReq st_fresh_req = new MessageMicro<VipFontUpdate$TFontFreshReq>() { // from class: com.tencent.pb.vipfontupdate.VipFontUpdate$TFontFreshReq
    ...
    public VipFontUpdate$TFontMd5CheckReq st_md5_check_req = new MessageMicro<VipFontUpdate$TFontMd5CheckReq>() { // from class: com.tencent.pb.vipfontupdate.VipFontUpdate$TFontMd5CheckReq
    ...
    public VipFontUpdate$TPosterReq st_poster_req = new MessageMicro<VipFontUpdate$TPosterReq>() { // from class: com.tencent.pb.vipfontupdate.VipFontUpdate$TPosterReq
    ...
    public VipFontUpdate$TCheckReq st_check_req = new MessageMicro<VipFontUpdate$TCheckReq>() { // from class: com.tencent.pb.vipfontupdate.VipFontUpdate$TCheckReq
    ...
    public VipFontUpdate$TGetPosterFontReq st_getposterfont_req = new MessageMicro<VipFontUpdate$TGetPosterFontReq>() { // from class: com.tencent.pb.vipfontupdate.VipFontUpdate$TGetPosterFontReq
    ...
    public VipFontUpdate$TSetPosterFontReq st_setposterfont_req = new MessageMicro<VipFontUpdate$TSetPosterFontReq>() { // from class: com.tencent.pb.vipfontupdate.VipFontUpdate$TSetPosterFontReq
