...
public class Stvdh {
    ...
    public static final String f382038a;

    /* renamed from: b, reason: collision with root package name */
    public static final String f382039b;

    /* renamed from: c, reason: collision with root package name */
    public static final String f382040c;

    /* renamed from: d, reason: collision with root package name */
    public static final String f382041d;

    /* renamed from: e, reason: collision with root package name */
    public static final String f382042e;

    /* renamed from: f, reason: collision with root package name */
    public static long f382043f;

    /* renamed from: g, reason: collision with root package name */
    public static final String[] f382044g;
    ...
    public static class spXPg {
        ...
        /* renamed from: a, reason: collision with root package name */
        public final boolean f382045a;

        /* renamed from: b, reason: collision with root package name */
        public final String f382046b;

        public spXPg(boolean z16, String str) {
    ...
    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(21274);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 1)) {
            redirector.redirect((short) 1);
            return;
        }
        f382038a = LwgsO.a(LwgsO.f381884b);
        f382039b = LwgsO.a(LwgsO.f381887c);
        f382040c = LwgsO.a(LwgsO.f381890d);
        f382041d = LwgsO.a(LwgsO.f381893e);
        f382042e = LwgsO.a(LwgsO.f381896f);
        f382043f = 0L;
        f382044g = new String[]{"^/data/user/\\d+$", "^/data/data$"};
    }
    ...
    public static String a(Context context, String str) {
        ...
        try {
            sb5.append((String) ((ArrayList) pZo7n.a(new File(str2))).get(0));
    ...
    */
    public static String a(Context context) {
        ...
        if (parentFile == null) {
            ...
            if (parentFile2 == null) {
                ...
                if (z16 && !packageName.equals(context.getPackageName())) {
                    spxpg = new spXPg(z16, a(context, packageName));
                } else {
                    spxpg = new spXPg(z16, "");
                }
            }
        }
        if (spxpg.f382045a && !TextUtils.isEmpty(spxpg.f382046b)) {
            a16 = CEO0r.a(0, true, 0);
            ZwVTT zwVTT = new ZwVTT();
            zwVTT.f382125a = f382038a + f382040c;
            zwVTT.f382126b = spxpg.f382046b;
            arrayList.add(zwVTT);
            z17 = false;
        } else {
            z17 = false;
            a16 = CEO0r.a(0, false, 0);
        }
        Context applicationContext = context.getApplicationContext();
        if (applicationContext == null) {
            spxpg2 = new spXPg(z17, "");
        } else {
            try {
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        try {
                            ...
                            ?? a19 = CEO0r.a(a16, spxpg2.f382045a, 1);
                            if (spxpg2.f382045a) {
                            }
                            ?? sb7 = new StringBuilder();
                            a17 = LwgsO.a(LwgsO.f381898f1);
                            try {
                                if (a17 == null) {
                                }
                                str3 = Build.BRAND;
                ...
                ?? a192 = CEO0r.a(a16, spxpg2.f382045a, 1);
                if (spxpg2.f382045a) {
                }
            ...
            if (!TextUtils.isEmpty(str) && (indexOf = str.indexOf("-")) != -1) {
                ...
                if (!TextUtils.isEmpty(substring)) {
                    ...
                    if (!z18) {
                        spxpg2 = new spXPg(z18, a(context, packageName222));
                    } else {
                        spxpg2 = new spXPg(z18, "");
                    }
                }
            }
            z18 = false;
        ...
        ?? a1922 = CEO0r.a(a16, spxpg2.f382045a, 1);
        if (spxpg2.f382045a) {
            ZwVTT zwVTT2 = new ZwVTT();
            zwVTT2.f382125a = f382038a + f382041d;
            zwVTT2.f382126b = spxpg2.f382046b;
            arrayList.add(zwVTT2);
        }
        ...
        if (a17 == null && a17.equalsIgnoreCase(Build.BRAND)) {
            ...
            if (!TextUtils.isEmpty(b16) && str4.equals(b16)) {
                String a26 = LwgsO.a(LwgsO.f381901g1);
                if (a26 != null) {
                    sb722.append(a26);
                } else {
                    sb722.append("H");
            ...
            sb5 = sb722;
            i3 = a1922;
            spXPg spxpg4 = new spXPg(z19, sb5.toString());
            sb722 = CEO0r.a(i3, spxpg4.f382045a, 2);
            a1922 = spxpg4.f382045a;
            if (a1922 != 0) {
            }
            new SparseArray();
            str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
            ...
            a18 = CEO0r.a(sb722, spxpg3.f382045a, 4);
            if (spxpg3.f382045a) {
            }
            if (a18 > 0) {
            }
            f382043f = System.currentTimeMillis() - currentTimeMillis;
        ...
        if ("xiaomi".equalsIgnoreCase(str3)) {
            if (a()) {
                ...
                sb5 = sb722;
                i3 = a1922;
                spXPg spxpg42 = new spXPg(z19, sb5.toString());
                sb722 = CEO0r.a(i3, spxpg42.f382045a, 2);
                a1922 = spxpg42.f382045a;
                if (a1922 != 0) {
                    ZwVTT zwVTT3 = new ZwVTT();
                    zwVTT3.f382125a = f382038a + f382042e;
                    zwVTT3.f382126b = spxpg42.f382046b;
                    arrayList.add(zwVTT3);
                }
                new SparseArray();
                str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
                ...
                i16 = Integer.parseInt(str2);
                if (i16 <= 0) {
                    spxpg3 = new spXPg(true, "");
                } else {
                    spxpg3 = new spXPg(false, "");
                }
                a18 = CEO0r.a(sb722, spxpg3.f382045a, 4);
                if (spxpg3.f382045a) {
                    ZwVTT zwVTT4 = new ZwVTT();
                    zwVTT4.f382125a = f382038a + "dual_e";
                    zwVTT4.f382126b = spxpg42.f382046b;
                    arrayList.add(zwVTT4);
                }
                if (a18 > 0) {
                    ZwVTT zwVTT5 = new ZwVTT();
                    zwVTT5.f382125a = f382038a + f382039b;
                    zwVTT5.f382126b = tbHx2.a("", a18);
                    arrayList.add(zwVTT5);
                }
                f382043f = System.currentTimeMillis() - currentTimeMillis;
                it = arrayList.iterator();
                while (it.hasNext()) {
                    ZwVTT zwVTT6 = (ZwVTT) it.next();
                    sb6.append(zwVTT6.f382125a);
                    sb6.append(":");
                    sb6.append(zwVTT6.f382126b);
                    sb6.append(",");
                }
                return sb6.toString();
            }
            ...
            sb5 = sb722;
            i3 = a1922;
            spXPg spxpg422 = new spXPg(z19, sb5.toString());
            sb722 = CEO0r.a(i3, spxpg422.f382045a, 2);
            a1922 = spxpg422.f382045a;
            if (a1922 != 0) {
            }
            new SparseArray();
            str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
            Random random22 = Ckq8l.f381753a;
            if (str2 == null) {
            }
            i16 = Integer.parseInt(str2);
            if (i16 <= 0) {
        ...
        if ("redmi".equalsIgnoreCase(str3)) {
            if (a()) {
                ...
                sb5 = sb722;
                i3 = a1922;
                spXPg spxpg4222 = new spXPg(z19, sb5.toString());
                sb722 = CEO0r.a(i3, spxpg4222.f382045a, 2);
                a1922 = spxpg4222.f382045a;
                if (a1922 != 0) {
                }
                new SparseArray();
                str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
                Random random222 = Ckq8l.f381753a;
                if (str2 == null) {
                }
                i16 = Integer.parseInt(str2);
                if (i16 <= 0) {
            ...
            sb5 = sb722;
            i3 = a1922;
            spXPg spxpg42222 = new spXPg(z19, sb5.toString());
            sb722 = CEO0r.a(i3, spxpg42222.f382045a, 2);
            a1922 = spxpg42222.f382045a;
            if (a1922 != 0) {
            }
            new SparseArray();
            str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
            Random random2222 = Ckq8l.f381753a;
            if (str2 == null) {
            }
            i16 = Integer.parseInt(str2);
            if (i16 <= 0) {
        ...
        if ("oppo".equalsIgnoreCase(str3)) {
            if (a()) {
                ...
                sb5 = sb722;
                i3 = a1922;
                spXPg spxpg422222 = new spXPg(z19, sb5.toString());
                sb722 = CEO0r.a(i3, spxpg422222.f382045a, 2);
                a1922 = spxpg422222.f382045a;
                if (a1922 != 0) {
                }
                new SparseArray();
                str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
                Random random22222 = Ckq8l.f381753a;
                if (str2 == null) {
                }
                i16 = Integer.parseInt(str2);
                if (i16 <= 0) {
            ...
            sb5 = sb722;
            i3 = a1922;
            spXPg spxpg4222222 = new spXPg(z19, sb5.toString());
            sb722 = CEO0r.a(i3, spxpg4222222.f382045a, 2);
            a1922 = spxpg4222222.f382045a;
            if (a1922 != 0) {
            }
            new SparseArray();
            str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
            Random random222222 = Ckq8l.f381753a;
            if (str2 == null) {
            }
            i16 = Integer.parseInt(str2);
            if (i16 <= 0) {
        ...
        if (CommonBadgeUtilImpl.MANUFACTURER_OF_HARDWARE_VIVO.equalsIgnoreCase(str3)) {
            if (a()) {
                ...
                sb5 = sb722;
                i3 = a1922;
                spXPg spxpg42222222 = new spXPg(z19, sb5.toString());
                sb722 = CEO0r.a(i3, spxpg42222222.f382045a, 2);
                a1922 = spxpg42222222.f382045a;
                if (a1922 != 0) {
                }
                new SparseArray();
                str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
                Random random2222222 = Ckq8l.f381753a;
                if (str2 == null) {
                }
                i16 = Integer.parseInt(str2);
                if (i16 <= 0) {
            ...
            if (new String(F2BEC.a("/proc/self/mountinfo")).contains(context.getApplicationContext().getPackageName() + "_cloned")) {
                sb722.append("VIVO_B");
            }
            z19 = false;
            sb5 = sb722;
            i3 = a1922;
            spXPg spxpg422222222 = new spXPg(z19, sb5.toString());
            sb722 = CEO0r.a(i3, spxpg422222222.f382045a, 2);
            a1922 = spxpg422222222.f382045a;
            if (a1922 != 0) {
            }
            new SparseArray();
            str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
            Random random22222222 = Ckq8l.f381753a;
            if (str2 == null) {
            }
            i16 = Integer.parseInt(str2);
            if (i16 <= 0) {
        ...
        if (CommonBadgeUtilImpl.MANUFACTURER_OF_HARDWARE_SANXING.equalsIgnoreCase(str3) && (myUid = Process.myUid() / 100000) > 50) {
            ...
            sb5 = sb722;
            i3 = a1922;
            spXPg spxpg4222222222 = new spXPg(z19, sb5.toString());
            sb722 = CEO0r.a(i3, spxpg4222222222.f382045a, 2);
            a1922 = spxpg4222222222.f382045a;
            if (a1922 != 0) {
            }
            new SparseArray();
            str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
            Random random222222222 = Ckq8l.f381753a;
            if (str2 == null) {
            }
            i16 = Integer.parseInt(str2);
            if (i16 <= 0) {
        ...
        sb5 = sb722;
        i3 = a1922;
        spXPg spxpg42222222222 = new spXPg(z19, sb5.toString());
        sb722 = CEO0r.a(i3, spxpg42222222222.f382045a, 2);
        a1922 = spxpg42222222222.f382045a;
        if (a1922 != 0) {
        }
        new SparseArray();
        str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
        Random random2222222222 = Ckq8l.f381753a;
        if (str2 == null) {
        }
        i16 = Integer.parseInt(str2);
        if (i16 <= 0) {
        ...
        sb5 = sb722;
        i3 = a1922;
        spXPg spxpg422222222222 = new spXPg(z19, sb5.toString());
        sb722 = CEO0r.a(i3, spxpg422222222222.f382045a, 2);
        a1922 = spxpg422222222222.f382045a;
        if (a1922 != 0) {
        }
        new SparseArray();
        str2 = (String) SWw7W.a(TNative$aa.d91_FC6D5B0A7013DB60(new SparseArray(), context, 206), 206, String.class);
        Random random22222222222 = Ckq8l.f381753a;
        if (str2 == null) {
        }
        i16 = Integer.parseInt(str2);
        if (i16 <= 0) {
