...
public final class YunKQ {
    ...
    public ByteBuffer f382113a;

    /* renamed from: b, reason: collision with root package name */
    public String f382114b;
    ...
    public final void a() {
        ...
        ByteBuffer byteBuffer = this.f382113a;
    ...
    public boolean b(int i3) {
        ...
        while (true) {
            try {
                ByteBuffer duplicate = this.f382113a.duplicate();
                ...
                a(i17);
                a(b17);
            } catch (i3cNc | BufferUnderflowException unused) {
                return false;
            }
        }
        return i3 == i16;
    ...
    public final void a(byte b16) {
        ...
        switch (b16) {
            ...
            case 13:
                ...
                throw new i3cNc("skipField with invalid type, type value: " + ((int) b16) + ", " + ((int) b18));
            default:
                throw new i3cNc("invalid type.");
        }
    }
    ...
    public void b() {
        ...
        while (this.f382113a.remaining() != 0) {
            ByteBuffer byteBuffer = this.f382113a;
            byte b16 = byteBuffer.get();
            byte b17 = (byte) (b16 & RegisterType.DOUBLE_HI);
            if (((b16 & 240) >> 4) == 15) {
    ...
    public String b(int i3, boolean z16) {
        ...
        if (b(i3)) {
            ...
            if (b17 == 6) {
                ...
                this.f382113a.get(bArr);
                try {
                    return new String(bArr, this.f382114b);
                } catch (UnsupportedEncodingException unused) {
                    return new String(bArr);
                }
            }
            if (b17 == 7) {
                int i17 = this.f382113a.getInt();
                if (i17 <= 104857600 && i17 >= 0) {
                    byte[] bArr2 = new byte[i17];
                    this.f382113a.get(bArr2);
                    try {
                        return new String(bArr2, this.f382114b);
                    } catch (UnsupportedEncodingException unused2) {
                        return new String(bArr2);
                    }
                }
                throw new i3cNc(tbHx2.a("String too long: ", i17));
            }
            if (b17 != 11) {
                throw new i3cNc("type mismatch.");
            }
        } else if (z16) {
            throw new i3cNc("require field not exist.");
        }
        return null;
    }
    ...
    public final <T> T[] b(T t16, int i3, boolean z16) {
        ...
        if (a16 >= 0) {
            ...
            for (int i16 = 0; i16 < a16; i16++) {
                tArr[i16] = a((YunKQ) t16, 0, true);
            }
            return tArr;
        }
        throw new i3cNc(tbHx2.a("size invalid: ", a16));
    }
    ...
    public long a(long j3, int i3, boolean z16) {
        ...
        if (b17 == 0) {
            i16 = this.f382113a.get();
        } else if (b17 == 1) {
            i16 = this.f382113a.getShort();
        } else {
            if (b17 != 2) {
                if (b17 == 3) {
                    return this.f382113a.getLong();
                }
                throw new i3cNc("type mismatch.");
            }
            i16 = this.f382113a.getInt();
        }
        return i16;
    }
    ...
    public double a(double d16, int i3, boolean z16) {
        ...
        if (b17 == 5) {
            return this.f382113a.getDouble();
        }
        if (b17 == 11) {
            return d16;
        }
    ...
    public <K, V> HashMap<K, V> a(Map<K, V> map, int i3, boolean z16) {
        ...
        if (map != null && !map.isEmpty()) {
            ...
            for (int i16 = 0; i16 < a16; i16++) {
                mapFieldLite.put(a((YunKQ) key, 0, true), a((YunKQ) value, 1, true));
            }
            return mapFieldLite;
        }
        return new HashMap<>();
    ...
    public byte[] a(int i3, boolean z16) {
        ...
        if (b(i3)) {
            ...
            if (b17 != 11) {
                if (b17 == 13) {
                    ByteBuffer byteBuffer2 = this.f382113a;
                    ...
                    if (b19 == 0) {
                        ...
                        throw new i3cNc("invalid size, tag: " + i3 + ", type: " + ((int) b17) + ", " + ((int) b19) + ", size: " + a17);
                    }
                    throw new i3cNc("type mismatch, tag: " + i3 + ", type: " + ((int) b17) + ", " + ((int) b19));
                }
                throw new i3cNc("type mismatch.");
            }
        } else if (z16) {
    ...
    public UMDtK a(UMDtK uMDtK, int i3, boolean z16) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 19)) {
            return (UMDtK) iPatchRedirector.redirect((short) 19, this, uMDtK, Integer.valueOf(i3), Boolean.valueOf(z16));
        }
        if (!b(i3)) {
            if (z16) {
                throw new i3cNc("require field not exist.");
        ...
        try {
            UMDtK uMDtK2 = (UMDtK) uMDtK.getClass().newInstance();
            ByteBuffer byteBuffer = this.f382113a;
            byte b16 = byteBuffer.get();
            byte b17 = (byte) (b16 & RegisterType.DOUBLE_HI);
            if (((b16 & 240) >> 4) == 15) {
            ...
            throw new i3cNc(e16.getMessage());
        }
    }
    ...
    public <T> Object a(T t16, int i3, boolean z16) {
        ...
        if (t16 instanceof UMDtK) {
            return a((UMDtK) t16, i3, z16);
        }
        if (t16.getClass().isArray()) {
            if (!(t16 instanceof byte[]) && !(t16 instanceof Byte[])) {
                    ...
                    if (b(i3)) {
                        ...
                        if (b26 == 9) {
                            ...
                            if (a17 >= 0) {
                                ...
                                throw new i3cNc(tbHx2.a("size invalid: ", a17));
                            }
                        } else if (b26 != 11) {
                            throw new i3cNc("type mismatch.");
                        }
                ...
                if (t16 instanceof int[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer3 = this.f382113a;
                        ...
                        if (b28 == 9) {
                            ...
                            if (a18 >= 0) {
                                ...
                                throw new i3cNc(tbHx2.a("size invalid: ", a18));
                            }
                        } else if (b28 != 11) {
                            throw new i3cNc("type mismatch.");
                        }
                ...
                if (t16 instanceof long[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer4 = this.f382113a;
                        ...
                        if (b36 == 9) {
                            ...
                            if (a19 >= 0) {
                                ...
                                throw new i3cNc(tbHx2.a("size invalid: ", a19));
                            }
                        } else if (b36 != 11) {
                            throw new i3cNc("type mismatch.");
                        }
                ...
                if (t16 instanceof float[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer5 = this.f382113a;
                        ...
                        if (b38 == 9) {
                            ...
                            if (a26 >= 0) {
                                ...
                                throw new i3cNc(tbHx2.a("size invalid: ", a26));
                            }
                        } else if (b38 != 11) {
                            throw new i3cNc("type mismatch.");
                        }
                ...
                if (t16 instanceof double[]) {
                    if (b(i3)) {
                        ByteBuffer byteBuffer6 = this.f382113a;
                        ...
                        if (b46 == 9) {
                            ...
                            if (a27 >= 0) {
                                ...
                                throw new i3cNc(tbHx2.a("size invalid: ", a27));
                            }
                        } else if (b46 != 11) {
                            throw new i3cNc("type mismatch.");
                        }
                ...
                throw new i3cNc("unable to get type of key and value.");
            }
            return a(i3, z16);
        }
        throw new i3cNc("read object error: unsupport type.");
    }
}
