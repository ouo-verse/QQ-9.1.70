...
public class Xjpd8 {
    ...
    public ByteBuffer f382096a;

    /* renamed from: b, reason: collision with root package name */
    public String f382097b;
    ...
    public Xjpd8(int i3) {
        ...
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 1)) {
            ...
            this.f382097b = "GBK";
            this.f382096a = ByteBuffer.allocate(i3);
        }
    }
    ...
    public byte[] a() {
        ...
        byte[] bArr = new byte[this.f382096a.position()];
        System.arraycopy(this.f382096a.array(), 0, bArr, 0, this.f382096a.position());
        return bArr;
    }
    ...
    public void b(byte b16, int i3) {
        ...
        if (i3 < 15) {
            this.f382096a.put((byte) (b16 | (i3 << 4)));
        } else {
            if (i3 < 256) {
                this.f382096a.put((byte) (b16 | 240));
                this.f382096a.put((byte) i3);
                return;
            }
            throw new Ww1Z6(tbHx2.a("tag is too large: ", i3));
        }
    }
    ...
    public void a(int i3) {
        ...
        } else if (this.f382096a.remaining() < i3) {
            ByteBuffer allocate = ByteBuffer.allocate((this.f382096a.capacity() + i3) * 2);
            allocate.put(this.f382096a.array(), 0, this.f382096a.position());
            this.f382096a = allocate;
        }
    }
    ...
    public void a(String str, int i3) {
        ...
        try {
            bytes = str.getBytes(this.f382097b);
        ...
        if (bytes.length > 255) {
            b((byte) 7, i3);
            this.f382096a.putInt(bytes.length);
            this.f382096a.put(bytes);
        } else {
            b((byte) 6, i3);
            this.f382096a.put((byte) bytes.length);
            this.f382096a.put(bytes);
        }
    }
    ...
    public void a(UMDtK uMDtK, int i3) {
        IPatchRedirector iPatchRedirector = $redirector_;
        if (iPatchRedirector != null && iPatchRedirector.hasPatch((short) 15)) {
            iPatchRedirector.redirect((short) 15, (Object) this, (Object) uMDtK, i3);
            return;
        }
        a(2);
        b((byte) 10, i3);
    ...
    public void a(Object obj, int i3) {
        ...
        if (obj instanceof Collection) {
            ...
            StringBuilder a16 = tmnyR.a("write object error: unsupport type. ");
            a16.append(obj.getClass());
            throw new Ww1Z6(a16.toString());
        }
    }
}
