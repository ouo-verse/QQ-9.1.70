...
public interface MavEventId {
    public static final int EM_SDK_EVENT_ID_ABILITY_CHANGED = 162;
    ...
    public static final int EM_SDK_EVENT_ID_BUSSINESS_COMMON_TIPS_NOTIFY = 188;
    public static final int EM_SDK_EVENT_ID_CAMERAQOS_FPS_CHANGE = 171;
    public static final int EM_SDK_EVENT_ID_CAMERA_REOPEN = 154;
    ...
    public static final int EM_SDK_EVENT_ID_EMBED_CMD = 18;
    ...
    public static final int EM_SDK_EVENT_ID_GENERAL_RAW_CHANNEL_DATA = 189;
    public static final int EM_SDK_EVENT_ID_GET_MUL_ROOM_INFO = 9;
    public static final int EM_SDK_EVENT_ID_GET_ROOM_INFO = 8;
    public static final int EM_SDK_EVENT_ID_GET_SIGN_RSP = 184;
    public static final int EM_SDK_EVENT_ID_GET_UIN_OPENID_MAP_RSP = 183;
    ...
    public static final int EM_SDK_EVENT_ID_NOTIFY_EXT_BUSINESS_INFO = 182;
    public static final int EM_SDK_EVENT_ID_NOTIFY_MIC_CLOSED_SPEAKING = 186;
    ...
    public static final int EM_SDK_EVENT_ID_USER_NET_STATE_CHANGE = 185;
