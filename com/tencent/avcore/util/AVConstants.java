...
public interface AVConstants {
    public static final int AV_RELATION_AIBOT_CHAT = 12;
    ...
    public static final int AV_RELATION_TYPE_OPENSDK = 6;
    public static final int AV_RELATION_UNKNOWN = 0;
    public static final int DEVICE_AUDIO_PLAY_FAILED = 6;
    ...
    public static final int MULTIAV_AIBOT_CHAT = 18;
    public static final int MULTIAV_ALL = 0;
    public static final int MULTIAV_AUDIO_VIDEO = 1;
    public static final int MULTIAV_BUSI_TYPE_OPENSDK = 7;
    ...
    public static final int MULTIAV_SMALL_HOME = 17;
    ...
    /* compiled from: P */
    /* loaded from: classes3.dex */
    public interface ShareOpsResult {
