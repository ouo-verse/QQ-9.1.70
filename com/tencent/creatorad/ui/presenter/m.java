...
public class m extends com.tencent.creatorad.ui.b {
    static IPatchRedirector $redirector_;

    /* renamed from: f, reason: collision with root package name */
    public static final int f100450f;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(26790);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 6)) {
            redirector.redirect((short) 6);
        } else {
            f100450f = com.tencent.creatorad.ui.c.c(3, true, 1);
        }
    }
