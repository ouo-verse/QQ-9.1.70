...
public class k extends com.tencent.creatorad.ui.b {
    static IPatchRedirector $redirector_;

    /* renamed from: f, reason: collision with root package name */
    public static final int f100438f;

    static {
        IPatchRedirector redirector = PatchRedirectCenter.getRedirector(26750);
        $redirector_ = redirector;
        if (redirector != null && redirector.hasPatch((short) 7)) {
            redirector.redirect((short) 7);
        } else {
            f100438f = com.tencent.creatorad.ui.c.c(4, false, 1);
        }
    }
