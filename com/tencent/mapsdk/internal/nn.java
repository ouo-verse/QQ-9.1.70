...
public class nn extends ng<np> implements ArcLineOverlay {
    /* JADX INFO: Access modifiers changed from: package-private */
    public nn(no noVar, np npVar) {
        super(noVar, npVar);
    }
    ...
    public ReturnInfoModelClass.ReturnStatus executeCommandFunction(CommandFunctionModelClass.BaseCommandFunction baseCommandFunction) {
        ...
        if (!name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$SetZoomLevelRangeCommand")) {
            if (!name.equals("com.tencent.map.lib.models.CommandFunctionModelClass$SetVisibleCommand")) {
                ...
                return new ReturnInfoModelClass.BaseBooleanReturnInfo(((np) this.f149454d).isVisible());
            }
        ...
        ((np) this.f149454d).setZoomLevelRange(zoomLevelRangeParams.minLevel, zoomLevelRangeParams.maxLevel);
        a((nn) this.f149454d);
        return new ReturnInfoModelClass.ReturnStatus();
    }
    ...
    public void setLevel(int i3) {
        T t16 = this.f149454d;
        if (((np) t16).f149468a != null) {
            ((np) t16).f149468a.displayLevel(i3);
        }
        ((np) this.f149454d).setDisplayLevel(i3);
        a((nn) this.f149454d);
    }
    ...
    public void setOpacity(float f16) {
        T t16 = this.f149454d;
        if (((np) t16).f149468a != null) {
            ((np) t16).f149468a.opacity(f16);
        }
        ((np) this.f149454d).setOpacity(f16);
        a((nn) this.f149454d);
    }
    ...
    public void setVisibility(boolean z16) {
        T t16 = this.f149454d;
        if (((np) t16).f149468a != null) {
            ((np) t16).f149468a.visibility(z16);
        }
        ((np) this.f149454d).setVisibility(z16);
        a((nn) this.f149454d);
    }
    ...
    public void setZIndex(int i3) {
        T t16 = this.f149454d;
        if (((np) t16).f149468a != null) {
            ((np) t16).f149468a.zIndex(i3);
        }
        ((np) this.f149454d).setzIndex(i3);
        a((nn) this.f149454d);
    }
