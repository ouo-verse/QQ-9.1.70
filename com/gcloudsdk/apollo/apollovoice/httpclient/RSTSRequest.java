...
public class RSTSRequest {
    ...
    public class RSTSHTTPTask {
        ...
        public RSTSHTTPTask(String str, String str2, String str3, String str4, int i3, int i16, int i17) {
            this.mSession = str;
            this.mUrl = str2;
            this.mToken = str3;
            this.mContent = str4;
        ...
        private void dealTask() {
            ...
            if (url == null) {
                ...
                if (httpURLConnection == null) {
                    ...
                    long j3 = RSTSRequest.this.mDelegate;
                    RSTSHTTPTask rSTSHTTPTask = this.mTask;
                    String str = rSTSHTTPTask.mSession;
                    int i17 = rSTSHTTPTask.mSeq;
                    int i18 = rSTSHTTPTask.mEnd;
                    if (byteArrayOutputStream != null) {
                        bArr = byteArrayOutputStream.toByteArray();
                    }
                    RSTSRequest.response(j3, i16, str, i17, i18, bArr);
                }
            }
            byteArrayOutputStream = null;
            i16 = i3;
            RSTSRequest.access$006(RSTSRequest.this);
            long j36 = RSTSRequest.this.mDelegate;
            RSTSHTTPTask rSTSHTTPTask2 = this.mTask;
            String str2 = rSTSHTTPTask2.mSession;
            int i172 = rSTSHTTPTask2.mSeq;
            int i182 = rSTSHTTPTask2.mEnd;
            if (byteArrayOutputStream != null) {
            }
            RSTSRequest.response(j36, i16, str2, i172, i182, bArr);
        }
    ...
    static /* synthetic */ int access$006(RSTSRequest rSTSRequest) {
        int i3 = rSTSRequest.mHttpCnt - 1;
        rSTSRequest.mHttpCnt = i3;
        return i3;
    }
    ...
    public int addTask(String str, String str2, String str3, String str4, int i3, int i16, int i17) {
        ...
        RSTSHTTPTask rSTSHTTPTask = new RSTSHTTPTask(str, str2, str3, str4, i3, i16, i17);
        this.mHttpCnt++;
    ...
    public void setDelegate(long j3) {
        this.mHttpCnt = 0;
        this.mDelegate = j3;
        this.mFixedThreadPool = ProxyExecutors.newFixedThreadPool(8);
        this.mInit = true;
    }
}
