...
public class BaseUtils {
    ...
    public static String getCacheData(Context context, String str, boolean z16) {
        if (z16) {
    ...
    public static boolean isMainProc(Context context) {
        String a16 = p.a(context);
        String str = context.getApplicationInfo().processName;
        HMSLog.i("BaseUtils", "main process name: " + str + ", current process name: " + a16);
    ...
    public static boolean saveCacheData(Context context, String str, String str2, boolean z16) {
        if (z16) {
    ...
    public static void saveProxyInit(Context context, boolean z16) {
        i.a(context).saveBoolean("_proxy_init", z16);
    }
