...
public enum ErrorEnum {
    ...
    ERROR_NO_NETWORK(800000002, SendException.ERROR_NO_NETWORK, RaffleJsPlugin.ERROR_REPORT_NO_NETWORK),
    ...
    ERROR_NO_NETWORK_OLD(907122005, SendException.ERROR_NO_NETWORK, RaffleJsPlugin.ERROR_REPORT_NO_NETWORK),
    ...
    ErrorEnum(int i3, int i16, String str) {
        this.internalCode = i3;
        this.externalCode = i16;
        this.message = str;
    }

    public static ErrorEnum fromCode(int i3) {
