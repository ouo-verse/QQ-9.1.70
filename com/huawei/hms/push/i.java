...
public class i {
    public static void a(Context context, Intent intent) {
        try {
            ...
            HMSLog.e("PushSelfShowLog", "onReceive RuntimeException.", e16);
    ...
    public static void a(Context context, Intent intent, k kVar) {
        ...
        if (j.a(kVar.i())) {
            ...
            q.a(context, intent, a16);
        }
    }

    public static void a(Context context, Intent intent, String str, k kVar, int i3) {
