...
public abstract class HuaweiApiAvailability {
    ...
    public static void setServicesVersionCode(int i3) {
        SERVICES_VERSION_CODE = i3;
    }
    ...
    public abstract PendingIntent getErrPendingIntent(Context context, int i3, int i16);

    public abstract PendingIntent getErrPendingIntent(Context context, ConnectionResult connectionResult);

    public abstract Dialog getErrorDialog(Activity activity, int i3, int i16);

    public abstract Dialog getErrorDialog(Activity activity, int i3, int i16, DialogInterface.OnCancelListener onCancelListener);

    public abstract String getErrorString(int i3);

    public abstract Task<Void> getHuaweiServicesReady(Activity activity);

    public abstract Intent getResolveErrorIntent(Activity activity, int i3);

    public abstract PendingIntent getResolveErrorPendingIntent(Activity activity, int i3);
    ...
    public abstract int isHuaweiMobileServicesAvailable(Context context, int i3);

    public abstract boolean isUserResolvableError(int i3);

    public abstract boolean isUserResolvableError(int i3, PendingIntent pendingIntent);

    public abstract void popupErrNotification(Context context, ConnectionResult connectionResult);

    public abstract void resolveError(Activity activity, int i3, int i16);

    public abstract void resolveError(Activity activity, int i3, int i16, PendingIntent pendingIntent);

    public abstract boolean showErrorDialogFragment(Activity activity, int i3, int i16);

    public abstract boolean showErrorDialogFragment(Activity activity, int i3, int i16, DialogInterface.OnCancelListener onCancelListener);

    public abstract boolean showErrorDialogFragment(Activity activity, int i3, Fragment fragment, int i16, DialogInterface.OnCancelListener onCancelListener);

    public abstract void showErrorNotification(Context context, int i3);
}
