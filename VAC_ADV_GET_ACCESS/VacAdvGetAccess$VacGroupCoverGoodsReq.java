...
public final class VacAdvGetAccess$VacGroupCoverGoodsReq extends MessageMicro<VacAdvGetAccess$VacGroupCoverGoodsReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 32, 40, 50, 56}, new String[]{"ware_house_id", "media_type", "content_id", "content_type", "product_id_list", "product_list", "seller_id"}, new Object[]{100, 0, "", 0, 0L, null, 0L}, VacAdvGetAccess$VacGroupCoverGoodsReq.class);
    ...
    public static final class Product extends MessageMicro<Product> {
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{ReportDataBuilder.KEY_PRODUCT_ID, "production_token"}, new Object[]{0L, ""}, Product.class);
