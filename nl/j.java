...
/* compiled from: P */
@Metadata(d1 = {"\u0000V\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0010\u0015\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010!\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\b\n\u0002\u0018\u0002\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b(\u0010)J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0002J\u0010\u0010\u0006\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0002J\b\u0010\b\u001a\u00020\u0007H\u0014J\u0010\u0010\u000b\u001a\u00020\u00042\u0006\u0010\n\u001a\u00020\tH\u0014J(\u0010\u0011\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\r\u001a\u00020\f2\u000e\u0010\u0010\u001a\n\u0012\u0004\u0012\u00020\u000f\u0018\u00010\u000eH\u0014R\u0016\u0010\u0015\u001a\u00020\u00128\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u0013\u0010\u0014R\u0016\u0010\u0017\u001a\u00020\u00128\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u0016\u0010\u0014R\u0016\u0010\u001b\u001a\u00020\u00188\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u0019\u0010\u001aR\u0016\u0010\u001f\u001a\u00020\u001c8\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u001d\u0010\u001eR\u0016\u0010 \u001a\u00020\u00128\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u0011\u0010\u0014R\u0016\u0010\"\u001a\u00020\u001c8\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b!\u0010\u001eR\u0016\u0010$\u001a\u00020\u001c8\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b#\u0010\u001eR\u0016\u0010'\u001a\u00020%8\u0002@\u0002X\u0082.\u00a2\u0006\u0006\n\u0004\b\u0005\u0010&\u00a8\u0006*"}, d2 = {"Lnl/j;", "Lnl/b;", "Lkl/a;", "data", "", "G", "H", "", "getViewStubLayoutId", "Landroid/view/View;", "containerView", "onInitView", "", "position", "", "", "payload", "D", "Lcom/qzone/reborn/feedx/widget/QZoneRichTextView;", tl.h.F, "Lcom/qzone/reborn/feedx/widget/QZoneRichTextView;", "mMessageTv", "i", "mContextMessageTv", "Landroid/view/ViewGroup;", QCircleScheme.AttrQQPublish.INPUT_TAB_MAGIC_STUDIO, "Landroid/view/ViewGroup;", "mOperatorLayout", "Landroid/widget/LinearLayout;", BdhLogUtil.LogTag.Tag_Conn, "Landroid/widget/LinearLayout;", "mReplyBtn", "mReplyText", "E", "mContextLayout", UserInfo.SEX_FEMALE, "mContentRoot", "Landroidx/recyclerview/widget/RecyclerView;", "Landroidx/recyclerview/widget/RecyclerView;", "mContextPictureGrid", "<init>", "()V", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class j extends b {
    ...
    private RecyclerView mContextPictureGrid;
    ...
    public static final void F(j this$0, kl.a data, View view) {
    ...
    public void onBindData(final kl.a data, int position, List<Object> payload) {
        ...
        G(data);
        H(data);
        View.OnClickListener onClickListener = new View.OnClickListener() { // from class: nl.i
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                j.F(j.this, data, view);
            }
        };
        ...
        QZoneRichTextView qZoneRichTextView4 = this.mMessageTv;
    ...
    public void onInitView(View containerView) {
        ...
        View findViewById2 = containerView.findViewById(R.id.n7_);
        Intrinsics.checkNotNullExpressionValue(findViewById2, "containerView.findViewBy\u2026one_message_context_text)");
        this.mContextMessageTv = (QZoneRichTextView) findViewById2;
        View findViewById3 = containerView.findViewById(R.id.n79);
        Intrinsics.checkNotNullExpressionValue(findViewById3, "containerView.findViewBy\u2026age_context_picture_grid)");
        this.mContextPictureGrid = (RecyclerView) findViewById3;
        View findViewById4 = containerView.findViewById(R.id.n78);
        Intrinsics.checkNotNullExpressionValue(findViewById4, "containerView.findViewBy\u2026e_message_context_layout)");
        this.mContextLayout = (LinearLayout) findViewById4;
        View findViewById5 = containerView.findViewById(R.id.mrf);
        Intrinsics.checkNotNullExpressionValue(findViewById5, "containerView.findViewBy\u2026tton_list_content_layout)");
        this.mOperatorLayout = (ViewGroup) findViewById5;
        View findViewById6 = containerView.findViewById(R.id.mrh);
        Intrinsics.checkNotNullExpressionValue(findViewById6, "containerView.findViewBy\u2026zone_button_reply_layout)");
        this.mReplyBtn = (LinearLayout) findViewById6;
        View findViewById7 = containerView.findViewById(R.id.n7i);
        Intrinsics.checkNotNullExpressionValue(findViewById7, "containerView.findViewBy\u2026sage_notice_content_root)");
        this.mContentRoot = (LinearLayout) findViewById7;
