...
public final class e_elaborate_report_cookie implements Serializable {
    ...
    public static final int _ELABORATE_REPORT_SHAISHAI_NEWTAG = 54;
    public static final int _ELABORATE_REPORT_SHARE_FEEDS_URL = 37;
    public static final int _ELABORATE_REPORT_TAIL_REPORTID = 51;
    public static final int _ELABORATE_REPORT_TAIL_SCHEMA = 52;
    public static final int _ELABORATE_REPORT_THIRD_APPID = 39;
    public static final int _ELABORATE_REPORT_THIRD_PARTY_APPID = 55;
    public static final int _ELABORATE_REPORT_THIRD_PARTY_TRANS_INFO = 56;
    ...
    public static final int _ELABORATE_REPORT_YUHENG_CONTENTID = 53;
