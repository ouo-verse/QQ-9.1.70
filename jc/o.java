...
/* compiled from: P */
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0000\n\u0002\u0010 \n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0002\b\u0004\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u0016\u0010\u0017J\u001a\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0002J\u000e\u0010\n\u001a\b\u0012\u0004\u0012\u00020\t0\bH\u0016J\u001a\u0010\u000b\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0014J\u0010\u0010\r\u001a\u00020\f2\u0006\u0010\u0003\u001a\u00020\u0002H\u0014J\u0010\u0010\u000e\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u0002H\u0014J\u0010\u0010\u000f\u001a\u00020\f2\u0006\u0010\u0003\u001a\u00020\u0002H\u0014J\b\u0010\u0010\u001a\u00020\tH\u0014J\b\u0010\u0012\u001a\u00020\u0011H\u0014J\u0018\u0010\u0015\u001a\u00020\u00142\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u0006H\u0014\u00a8\u0006\u0018"}, d2 = {"Ljc/o;", "Lcom/qzone/reborn/albumx/common/layer/action/CommonLayerShareScanCodeAction;", "Lic/c;", "shareContext", "Lcom/qzone/reborn/albumx/common/layer/action/CommonLayerShareScanCodeAction$b;", "listener", "", "B", "", "", "c", BdhLogUtil.LogTag.Tag_Conn, "", QCircleScheme.AttrQQPublish.INPUT_TAB_ZSHOW, "D", ExifInterface.GPS_MEASUREMENT_IN_PROGRESS, ReportConstant.COSTREPORT_PREFIX, "Lcom/qzone/reborn/albumx/common/layer/action/CommonLayerShareScanCodeAction$CodeType;", "p", "scanResult", "", "E", "<init>", "()V", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes38.dex */
public final class o extends CommonLayerShareScanCodeAction<ic.c> {
    ...
    */
    private final boolean B(ic.c shareContext, CommonLayerShareScanCodeAction.b listener) {
        ...
        if (!TextUtils.isEmpty(extraInfoBean != null ? extraInfoBean.getLLoc() : null)) {
            if (cVar != null && (M1 = cVar.M1()) != null) {
                ...
                boolean containsKey = M1.containsKey(extraInfoBean2 != null ? extraInfoBean2.getLLoc() : null);
                z16 = true;
            }
            z16 = false;
            if (z16) {
                HashMap<String, Boolean> M12 = cVar.M1();
                QZAlbumxLayerExtraInfoBean extraInfoBean3 = shareContext.getExtraInfoBean();
                Boolean bool = M12.get(extraInfoBean3 != null ? extraInfoBean3.getLLoc() : null);
    ...
    public void y(ic.c shareContext, boolean scanResult) {
        ...
        Intrinsics.checkNotNullParameter(shareContext, "shareContext");
        QZAlbumxLayerExtraInfoBean extraInfoBean = shareContext.getExtraInfoBean();
        if (TextUtils.isEmpty(extraInfoBean != null ? extraInfoBean.getLLoc() : null) || (cVar = (q9.c) getViewModel()) == null || (M1 = cVar.M1()) == null) {
            return;
        }
        QZAlbumxLayerExtraInfoBean extraInfoBean2 = shareContext.getExtraInfoBean();
        String lLoc = extraInfoBean2 != null ? extraInfoBean2.getLLoc() : null;
        Intrinsics.checkNotNull(lLoc);
        M1.put(lLoc, Boolean.valueOf(scanResult));
    }

    @Override // com.qzone.reborn.albumx.common.layer.action.CommonLayerShareScanCodeAction
    protected CommonLayerShareScanCodeAction.CodeType p() {
        return CommonLayerShareScanCodeAction.CodeType.QQCODE;
    }
    ...
    public List<Integer> c() {
        ...
        arrayListOf = CollectionsKt__CollectionsKt.arrayListOf(56);
        return arrayListOf;
    }
}
