...
/* compiled from: P */
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \r2\u00020\u0001:\u0001\u000eB\u0007\u00a2\u0006\u0004\b\u000b\u0010\fJ\u001c\u0010\u0007\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016J\u001c\u0010\n\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\t\u001a\u0004\u0018\u00010\bH\u0016\u00a8\u0006\u000f"}, d2 = {"Lcz2/a;", "Lmqq/app/MSFServlet;", "Landroid/content/Intent;", "intent", "Lmqq/app/Packet;", "packet", "", "onSend", "Lcom/tencent/qphone/base/remote/FromServiceMsg;", "fromServiceMsg", "onReceive", "<init>", "()V", "d", "a", "vas-adv-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class a extends MSFServlet {
    ...
    @NotNull
    private static final Map<String, d> f392521e = new LinkedHashMap();

    /* compiled from: P */
    @Metadata(d1 = {"\u0000:\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u0012\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010%\n\u0002\b\u0002\n\u0002\u0010\t\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u000b\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u001a\u0010\u001bJ&\u0010\n\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0004\u001a\u00020\u00022\u0006\u0010\u0006\u001a\u00020\u00052\u0006\u0010\b\u001a\u00020\u0007R \u0010\f\u001a\u000e\u0012\u0004\u0012\u00020\u0002\u0012\u0004\u0012\u00020\u00070\u000b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\f\u0010\rR\u0014\u0010\u000f\u001a\u00020\u000e8\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u000f\u0010\u0010R\u0014\u0010\u0012\u001a\u00020\u00118\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0012\u0010\u0013R\u0014\u0010\u0014\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0014\u0010\u0015R\u0014\u0010\u0016\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0016\u0010\u0015R\u0014\u0010\u0017\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0017\u0010\u0015R\u0014\u0010\u0018\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0018\u0010\u0015R\u0014\u0010\u0019\u001a\u00020\u00028\u0002X\u0082T\u00a2\u0006\u0006\n\u0004\b\u0019\u0010\u0015\u00a8\u0006\u001c"}, d2 = {"Lcz2/a$a;", "", "", "cmd", "uuid", "", "data", "Lcom/tencent/mobileqq/vas/adv/base/support/app/d;", "callback", "", "a", "", "CALLBACK_MAP", "Ljava/util/Map;", "", "DEFAULT_VALUE_TIMEOUT", "J", "", "RSP_HEADER_LENGTH", "I", "SEND_EXTRA_KEY_CMD", "Ljava/lang/String;", "SEND_EXTRA_KEY_DATA", "SEND_EXTRA_KEY_REQ_UUID", "SEND_EXTRA_KEY_TIMEOUT", "TAG", "<init>", "()V", "vas-adv-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: cz2.a$a, reason: collision with other inner class name and from kotlin metadata */
    /* loaded from: classes20.dex */
    public static final class Companion {
        ...
        public final void a(@NotNull String cmd, @NotNull String uuid, @NotNull byte[] data, @NotNull d callback) {
            ...
            try {
                ...
                a.f392521e.put(uuid, callback);
            } catch (Exception e16) {
                a.f392521e.remove(uuid);
                callback.a(-10107, "send cmd failed", e16);
    ...
    public void onReceive(@Nullable Intent intent, @Nullable FromServiceMsg fromServiceMsg) {
        if (intent != null && fromServiceMsg != null) {
            ...
            if (!TextUtils.isEmpty(stringExtra) && !TextUtils.isEmpty(stringExtra2)) {
                d dVar = (d) TypeIntrinsics.asMutableMap(f392521e).remove(stringExtra2);
                if (!fromServiceMsg.isSuccess()) {
                    if (dVar != null) {
                        dVar.a(fromServiceMsg.getResultCode(), "from service msg failed", null);
                    }
                ...
                try {
                    ...
                    if (dVar != null) {
                        dVar.b(trpcRspFuncRetCode, bArr);
                        return;
                    }
                    return;
                } catch (Exception e16) {
                    if (dVar != null) {
                        dVar.a(-10107, "error when parse response", e16);
                    }
