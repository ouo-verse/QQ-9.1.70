...
public final class b extends BaseActivityResPreloadTask {
    ...
    public b() {
        ...
        hashMap.put(new PreloadRequest(R.layout.er7, "", null, 4, null), 4);
        hashMap.put(new PreloadRequest(R.layout.eow, "", null, 4, null), 1);
        hashMap.put(new PreloadRequest(R.layout.f168080ep2, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.f168081ep3, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.ep5, "", null, 4, null), 1);
        hashMap.put(new PreloadRequest(R.layout.f168184f91, "", null, 4, null), 5);
        hashMap.put(new PreloadRequest(R.layout.f168183f90, "", null, 4, null), 9);
        hashMap.put(new PreloadRequest(R.layout.eou, "", null, 4, null), 8);
        hashMap.put(new PreloadRequest(R.layout.eoz, "", null, 4, null), 8);
        hashMap.put(new PreloadRequest(R.layout.eom, "", null, 4, null), 8);
        hashMap.put(new PreloadRequest(R.layout.f8z, "", null, 4, null), 6);
        hashMap.put(new PreloadRequest(R.layout.eqf, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.f169066hn3, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.e7_, "", null, 4, null), 1);
        hashMap.put(new PreloadRequest(R.layout.exe, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.erf, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.eov, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.eox, "", null, 4, null), 2);
        hashMap.put(new PreloadRequest(R.layout.f168078ep0, "", null, 4, null), 2);
    ...
    public boolean isTarget(@NotNull ClassLoader classLoader, @NotNull String activityClassName, @NotNull Intent intent) {
        ...
        intent.setExtrasClassLoader(GuildHomeFragment.class.getClassLoader());
        String stringExtra = intent.getStringExtra("public_fragment_class");
        if (super.isTarget(classLoader, activityClassName, intent) && Intrinsics.areEqual(stringExtra, Reflection.getOrCreateKotlinClass(GuildHomeFragment.class).getQualifiedName())) {
            return true;
        }
        return false;
    }
