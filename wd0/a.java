...
public class a {
    ...
    static final double[][] f445462a = {new double[]{0.41233895d, 0.35762064d, 0.18051042d}, new double[]{0.2126d, 0.7152d, 0.0722d}, new double[]{0.01932141d, 0.11916382d, 0.95034478d}};

    /* renamed from: b, reason: collision with root package name */
    static final double[][] f445463b = {new double[]{3.2413774792388685d, -1.5376652402851851d, -0.49885366846268053d}, new double[]{-0.9691452513005321d, 1.8758853451067872d, 0.04156585616912061d}, new double[]{0.05562093689691305d, -0.20395524564742123d, 1.0571799111220335d}};

    /* renamed from: c, reason: collision with root package name */
    static final double[] f445464c = {95.047d, 100.0d, 108.883d};
    ...
    public static double[] m(int i3) {
        return b.d(new double[]{i(k(i3)), i(f(i3)), i(d(i3))}, f445462a);
    }
