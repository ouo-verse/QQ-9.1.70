...
public final class d extends f<QZoneAutoTexting$TextInfo> {
    ...
    public boolean isForViewType(QZoneAutoTexting$TextInfo item, List<QZoneAutoTexting$TextInfo> items, int position) {
    ...
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<QZoneAutoTexting$TextInfo>>> sections) {
