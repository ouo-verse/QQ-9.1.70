...
public final class INTERFACE$StApiUserInfo extends MessageMicro<INTERFACE$StApiUserInfo> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 34, 42, 50}, new String[]{"nick", "avatar", "gender", "address", IjkMediaMeta.IJKM_KEY_LANGUAGE, "openid"}, new Object[]{"", "", 0, null, "", ""}, INTERFACE$StApiUserInfo.class);
