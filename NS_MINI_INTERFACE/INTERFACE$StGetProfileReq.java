...
public final class INTERFACE$StGetProfileReq extends MessageMicro<INTERFACE$StGetProfileReq> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 16, 26}, new String[]{"appid", "withCredentials", "lang"}, new Object[]{"", 0, ""}, INTERFACE$StGetProfileReq.class);
