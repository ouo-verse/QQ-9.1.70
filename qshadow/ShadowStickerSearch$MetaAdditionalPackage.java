...
public final class ShadowStickerSearch$MetaAdditionalPackage extends MessageMicro<ShadowStickerSearch$MetaAdditionalPackage> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50, 58, 66}, new String[]{"lowPackageUrl", "lowPackageMd5", "superLowPackageUrl", "superLowPackageMd5", "midPackageUrl", "midPackageMd5", "highPackageUrl", "highPackageMd5"}, new Object[]{"", "", "", "", "", "", "", ""}, ShadowStickerSearch$MetaAdditionalPackage.class);
