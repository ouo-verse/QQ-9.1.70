...
public abstract class Task {
    ...
    public Task(@NotNull String name, boolean z16) {
    ...
    public /* synthetic */ Task(String str, boolean z16, int i3, DefaultConstructorMarker defaultConstructorMarker) {
