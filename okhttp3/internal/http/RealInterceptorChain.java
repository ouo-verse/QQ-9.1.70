...
public final class RealInterceptorChain implements Interceptor.Chain {
    ...
    public RealInterceptorChain(@NotNull RealCall call, @NotNull List<? extends Interceptor> interceptors, int i3, @Nullable Exchange exchange, @NotNull Request request, int i16, int i17, int i18) {
        ...
        this.connectTimeoutMillis = i16;
        this.readTimeoutMillis = i17;
        this.writeTimeoutMillis = i18;
    }

    public static /* synthetic */ RealInterceptorChain copy$okhttp$default(RealInterceptorChain realInterceptorChain, int i3, Exchange exchange, Request request, int i16, int i17, int i18, int i19, Object obj) {
        if ((i19 & 1) != 0) {
            i3 = realInterceptorChain.index;
        }
        if ((i19 & 2) != 0) {
        ...
        if ((i19 & 8) != 0) {
            i16 = realInterceptorChain.connectTimeoutMillis;
        }
        int i26 = i16;
        if ((i19 & 16) != 0) {
            i17 = realInterceptorChain.readTimeoutMillis;
        }
        int i27 = i17;
        if ((i19 & 32) != 0) {
            i18 = realInterceptorChain.writeTimeoutMillis;
        }
        return realInterceptorChain.copy$okhttp(i3, exchange2, request2, i26, i27, i18);
    }
    ...
    @NotNull
    public final RealInterceptorChain copy$okhttp(int index, @Nullable Exchange exchange, @NotNull Request r142, int connectTimeoutMillis, int readTimeoutMillis, int writeTimeoutMillis) {
        Intrinsics.checkNotNullParameter(r142, "request");
        return new RealInterceptorChain(this.call, this.interceptors, index, exchange, r142, connectTimeoutMillis, readTimeoutMillis, writeTimeoutMillis);
    }
    ...
    @Override // okhttp3.Interceptor.Chain
    @NotNull
    public Response proceed(@NotNull Request r152) throws IOException {
        boolean z16;
        boolean z17;
        boolean z18;
        Intrinsics.checkNotNullParameter(r152, "request");
        boolean z19 = false;
        ...
        if (z16) {
            ...
            Exchange exchange = this.exchange;
            if (exchange != null) {
                if (exchange.getFinder().sameHostAndPort(r152.url())) {
                    if (this.calls == 1) {
                        z18 = true;
                    } else {
                        z18 = false;
            ...
            RealInterceptorChain copy$okhttp$default = copy$okhttp$default(this, this.index + 1, null, r152, 0, 0, 0, 58, null);
