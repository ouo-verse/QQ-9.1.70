    ...
    public static final Date toHttpDateOrNull(@NotNull String toHttpDateOrNull) {
        ...
        synchronized (strArr) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                ...
                if (dateFormat == null) {
                    dateFormat = new SimpleDateFormat(BROWSER_COMPATIBLE_DATE_FORMAT_STRINGS[i3], Locale.US);
