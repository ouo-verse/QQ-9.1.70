...
public final class c extends com.qzone.reborn.base.f<CommonGridItemData> {
    ...
    public boolean isForViewType(CommonGridItemData item, List<CommonGridItemData> items, int position) {
        Intrinsics.checkNotNullParameter(item, "item");
        Intrinsics.checkNotNullParameter(items, "items");
        return item.getItemType() == CommonGridItemData.ItemType.PIC_SECTION_ITEM;
    }

    @Override // com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public int getLayoutId() {
        return R.layout.f127450p;
    }

    @Override // com.qzone.reborn.base.f, com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<CommonGridItemData>>> sections) {
        List<Class<? extends Section<CommonGridItemData>>> r65;
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        super.initSection(parent, itemView, sections);
        l9.b bVar = (l9.b) b(l9.b.class);
        if (bVar == null || (r65 = bVar.r6()) == null) {
            return;
        }
        sections.addAll(r65);
    }
