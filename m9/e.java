...
public final class e extends com.qzone.reborn.base.f<CommonAlbumListBean> {
    ...
    public boolean isForViewType(CommonAlbumListBean item, List<CommonAlbumListBean> items, int position) {
    ...
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<CommonAlbumListBean>>> sections) {
        List<Class<? extends Section<CommonAlbumListBean>>> W8;
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        super.initSection(parent, itemView, sections);
        l9.d dVar = (l9.d) b(l9.d.class);
        if (dVar == null || (W8 = dVar.W8()) == null) {
            return;
        }
        sections.addAll(W8);
    }
