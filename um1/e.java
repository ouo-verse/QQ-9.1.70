...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \u00072\u00020\u0001:\u0001\bB\u0007\u00a2\u0006\u0004\b\u000b\u0010\fJ\u001a\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016J\u001a\u0010\b\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u0004H\u0016R\u0018\u0010\n\u001a\u0004\u0018\u00010\u00048\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\b\u0010\t\u00a8\u0006\r"}, d2 = {"Lum1/e;", "Lum1/a;", "Lfm1/i;", "mediaInfo", "", "displayIndex", "Lorg/json/JSONObject;", "b", "a", "Ljava/lang/Integer;", "mPatternId", "<init>", "()V", "qqguild_feed_impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class e implements a {
    ...
    public JSONObject a(@NotNull i mediaInfo, int displayIndex) {
        ...
        jSONObject.put(AppConstants.Key.KEY_QZONE_VIDEO_URL, "");
        jSONObject.put("url", "");
    ...
    public JSONObject b(@NotNull i mediaInfo, int displayIndex) {
        ...
        if (mediaInfo.f()) {
            ...
            jSONObject.put("fileId", mediaInfo.getCom.tencent.mobileqq.mini.servlet.MiniAppGetGameTaskTicketServlet.KEY_TASKID java.lang.String());
            if (!mediaInfo.f()) {
                jSONObject.put("playUrl", mediaInfo.getDocUrl());
            }
            jSONObject.put("display_index", displayIndex);
            JSONObject jSONObject2 = new JSONObject();
            jSONObject2.put("display_index", displayIndex);
            jSONObject2.put("picId", "");
            jSONObject2.put("width", mediaInfo.getWidth());
            jSONObject2.put("height", mediaInfo.getHeight());
            Unit unit = Unit.INSTANCE;
            jSONObject.put("cover", jSONObject2);
            return jSONObject;
        }
        JSONObject jSONObject3 = new JSONObject(mediaInfo.getExtras());
        jSONObject3.put("pattern_id", String.valueOf(this.mPatternId));
        return jSONObject3;
    }
}
