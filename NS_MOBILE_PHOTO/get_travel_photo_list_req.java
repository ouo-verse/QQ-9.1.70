...
public final class get_travel_photo_list_req extends JceStruct {
    ...
    public get_travel_photo_list_req(long j3, String str, String str2, String str3, Map<Integer, String> map, int i3, String str4, int i16) {
        this.uin = j3;
        this.albumid = str;
    ...
    public get_travel_photo_list_req(long j3, String str, String str2, String str3, Map<Integer, String> map, int i3, String str4, int i16, BannerAttachInfo bannerAttachInfo) {
        this.uin = j3;
        this.albumid = str;
        this.attach_info = str2;
        this.password = str3;
