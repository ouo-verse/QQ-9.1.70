...
public final class publish_active_album_req extends JceStruct {
    ...
    public void readFrom(JceInputStream jceInputStream) {
        ...
        this.pic_total = jceInputStream.read(this.pic_total, 4, false);
    }
    ...
    public void writeTo(JceOutputStream jceOutputStream) {
        ...
        jceOutputStream.write(this.pic_total, 4);
    }

    public publish_active_album_req(long j3, Map<String, String> map, ArrayList<active_photo> arrayList, shuoshuo_privacy shuoshuo_privacyVar, long j16) {
        this.uin = j3;
        this.map_params = map;
