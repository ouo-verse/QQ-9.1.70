...
public final class ListAllCategoryReq extends JceStruct {
    ...
    static {
        cache_req_item_map.put(0, new ListAllCategoryReqItem());
    }
    ...
    public void writeTo(JceOutputStream jceOutputStream) {
        ...
        Map<Integer, ListAllCategoryReqItem> map = this.req_item_map;
        if (map != null) {
            jceOutputStream.write((Map) map, 1);
        }
    }

    public ListAllCategoryReq(long j3, Map<Integer, ListAllCategoryReqItem> map) {
        this.host = j3;
