...
import com.tencent.robot.discover.adapter.section.j;
...
public final class f extends c<GroupRobot> {
    ...
    public boolean isForViewType(@NotNull GroupRobot item, @NotNull List<GroupRobot> items, int position) {
    ...
    @Override // com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(@NotNull ViewGroup parent, @NotNull View itemView, @NotNull List<Class<? extends Section<GroupRobot>>> sections) {
