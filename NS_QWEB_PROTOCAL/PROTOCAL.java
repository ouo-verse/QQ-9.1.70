...
public final class PROTOCAL {
    ...
    public static final class StAuthInfo extends MessageMicro<StAuthInfo> {
        ...
        static {
            ...
            __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 32, 42, 50, 58, 66}, strArr, new Object[]{"", byteStringMicro, "", 0, "", "", byteStringMicro, null}, StAuthInfo.class);
        }
    ...
    public static final class StEncryption extends MessageMicro<StEncryption> {
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18}, new String[]{"method", "iv"}, new Object[]{0, ""}, StEncryption.class);
        public final PBUInt32Field method = PBField.initUInt32(0);

        /* renamed from: iv, reason: collision with root package name */
        public final PBStringField f25068iv = PBField.initString("");
    }

    /* loaded from: classes.dex */
    public static final class StQWebReq extends MessageMicro<StQWebReq> {
        static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 26, 34, 42, 50, 58, 66, 74, 82, 88}, new String[]{"Seq", "qua", "deviceInfo", "busiBuff", "traceid", "Module", "Cmdname", IProfileProtocolConst.PARAM_LOGIN_SIG, "Crypto", "Extinfo", "contentType"}, new Object[]{0L, "", "", ByteStringMicro.EMPTY, "", "", "", null, null, null, 0}, StQWebReq.class);
