...
/* compiled from: P */
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\u0011\n\u0000\n\u0002\u0010\u0000\n\u0002\b\u0005\u0018\u00002\u00020\u0001B\u0007\u00a2\u0006\u0004\b\u000b\u0010\fJ9\u0010\t\u001a\u0004\u0018\u00010\b2\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0005\u001a\u00020\u00042\u0016\u0010\u0007\u001a\f\u0012\b\b\u0001\u0012\u0004\u0018\u00010\u00040\u0006\"\u0004\u0018\u00010\u0004H\u0016\u00a2\u0006\u0004\b\t\u0010\n\u00a8\u0006\r"}, d2 = {"Lsy2/c;", "Lsy2/e;", "Landroid/content/Context;", "context", "", "methodName", "", "args", "", "a", "(Landroid/content/Context;Ljava/lang/String;[Ljava/lang/String;)Ljava/lang/Object;", "<init>", "()V", "QQCommon_release"}, k = 1, mv = {1, 7, 1})
...
public final class c implements e {
    ...
    public Object a(@NotNull Context context, @NotNull String methodName, @NotNull String... args) {
        ...
        if (TextUtils.equals(methodName, "checkAppInstalledBatchAuthorized")) {
            if (args.length == 0) {
                z16 = true;
            } else {
                z16 = false;
            ...
            if (!z16) {
                ...
                return PackageInstallMonitorKt.b(context, b16.getPackageName(), b16.getBusiness());
            }
            return null;
        }
        return null;
