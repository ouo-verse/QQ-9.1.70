...
public final class b implements c {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\f\b\u0082\b\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\r\u001a\u00020\u0002\u0012\u0006\u0010\u0010\u001a\u00020\u0004\u00a2\u0006\u0004\b\u0011\u0010\u0012J\t\u0010\u0003\u001a\u00020\u0002H\u00d6\u0001J\t\u0010\u0005\u001a\u00020\u0004H\u00d6\u0001J\u0013\u0010\b\u001a\u00020\u00072\b\u0010\u0006\u001a\u0004\u0018\u00010\u0001H\u00d6\u0003R\u0017\u0010\r\u001a\u00020\u00028\u0006\u00a2\u0006\f\n\u0004\b\t\u0010\n\u001a\u0004\b\u000b\u0010\fR\u0017\u0010\u0010\u001a\u00020\u00048\u0006\u00a2\u0006\f\n\u0004\b\u000b\u0010\u000e\u001a\u0004\b\t\u0010\u000f\u00a8\u0006\u0013"}, d2 = {"Ldq1/b$a;", "", "", "toString", "", "hashCode", "other", "", "equals", "a", "Ljava/lang/String;", "b", "()Ljava/lang/String;", WadlProxyConsts.KEY_JUMP_URL, "I", "()I", "jumpType", "<init>", "(Ljava/lang/String;I)V", "qqguild-impl_release"}, k = 1, mv = {1, 7, 1})
    /* renamed from: dq1.b$a, reason: from toString */
    /* loaded from: classes13.dex */
    ...
    public b(@NotNull String guildId, @NotNull IGProChannelInfo channelInfo, @Nullable Bundle bundle) {
    ...
    private final void e(AppChannelJumpInfo jumpInfo) {
        Logger.f235387a.d().i("Guild.jump.AppChannelStrategy", 1, "jumpAppChannelWith " + jumpInfo);
        ...
        if (jumpType != 1) {
            if (jumpType != 2) {
                if (jumpType != 3) {
                    if (jumpType != 4) {
                        QQToastUtil.showQQToast(0, R.string.f158101op);
                        return;
                    } else {
                        i(jumpInfo);
                        return;
    ...
    private final void f(AppChannelJumpInfo jumpInfo) {
        ...
        ((IMiniAppService) QRoute.api(IMiniAppService.class)).startMiniApp(c16, k3.V(), 5002, entryModel, null);
    }

    private final void g(AppChannelJumpInfo jumpInfo) {
        Context c16 = c("jumpGuest");
        if (c16 == null) {
            return;
        }
        ((IGuildStandalonePageOpenApi) QRoute.api(IGuildStandalonePageOpenApi.class)).openJoinInvitationDialog(c16, l(jumpInfo));
    }
    ...
    private final void h(AppChannelJumpInfo jumpInfo) {
        ...
        if (applicationId == 9999999) {
            kg1.a.c(c16, k3);
            return;
        }
        if (applicationId == 1000101) {
            z16 = true;
        } else {
            z16 = false;
        }
    ...
    private final void j(AppChannelJumpInfo jumpInfo) {
        Context c16 = c("jumpNative");
        if (c16 == null) {
            return;
        }
        JumpGuildParam l3 = l(jumpInfo);
        Logger.f235387a.d().i("Guild.jump.AppChannelStrategy", 1, "AppChannelStrategy::jumpNative() jumpParam.detailContentJumpUrl.isNotBlank(), jumpParam = " + l3);
    ...
    @Override // dq1.c
    public void jump(@NotNull final Context context) {
        boolean isBlank;
        Intrinsics.checkNotNullParameter(context, "context");
        ...
        if (isBlank) {
            ...
            ((IGPSService) S02).refreshAppChannelPreInfos(this.guildId, true, new em() { // from class: dq1.a
                @Override // wh2.em
