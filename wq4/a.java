            ...
            if (readTag != 0) {
                if (readTag != 10) {
                    if (readTag != 16) {
                        ...
                        this.f446089b = codedInputByteBufferNano.readUInt32();
                    }
                } else {
                    if (this.f446088a == null) {
                        this.f446088a = new j();
                    }
                    codedInputByteBufferNano.readMessage(this.f446088a);
                }
            } else {
                return this;
            }
