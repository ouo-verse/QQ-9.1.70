...
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$CSQQAccessBaseInfo;
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$CSQQAccessReply;
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$CSQQAccessReqHeader;
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$CSQQAccessRequest;
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$CSQQAccessRspHeader;
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$NetInfo;
import com.tencent.icgame.trpc.yes.common.BaseInterfaceOuterClass$Terminal;
...
public abstract class a extends MSFServlet {
    ...
    */
    public void onReceive(Intent intent, FromServiceMsg fromServiceMsg) {
        ...
        if (fromServiceMsg == null) {
            g.d("ICGameNetCore_BaseTimiGameServlet_", "onReceive cmd=" + b16 + ", response is null");
        } else if (!fromServiceMsg.isSuccess()) {
            g.d("ICGameNetCore_BaseTimiGameServlet_", "onReceive cmd=" + b16 + ", msf not success - " + fromServiceMsg.getResultCode());
        } else {
            ...
            try {
                ...
                g.d("ICGameNetCore_BaseTimiGameServlet_", "onReceive cmd=" + b16 + ", decode CSQQAccessReply fail - " + a16);
                i3 = -9999;
                str = "";
                str2 = "\u56de\u5305\u89e3\u6790\u5931\u8d25";
                i16 = -9999;
            ...
            if (baseInterfaceOuterClass$CSQQAccessReply.get() == null && (baseInterfaceOuterClass$CSQQAccessRspHeader = baseInterfaceOuterClass$CSQQAccessReply.rsp_header) != null) {
                ...
                if (z17) {
                    g.h("ICGameNetCore_BaseTimiGameServlet_", "onReceive cmd=" + b16 + ", timi notify success!");
                } else {
                    g.d("ICGameNetCore_BaseTimiGameServlet_", "onReceive cmd=" + b16 + ", timi notify error, timiErrorCode=" + i3 + ", timiErrorMsg=" + str + ", timiDisplayErrorMsg=" + str2);
                }
                z18 = z17;
            } else {
                g.d("ICGameNetCore_BaseTimiGameServlet_", "onReceive cmd=" + b16 + ", decode CSQQAccessReply fail - " + a16);
    ...
    public void onSend(Intent intent, Packet packet) {
        ...
        int b16 = b();
        if (intent == null) {
            g.d("ICGameNetCore_BaseTimiGameServlet_", "onSend bad request, cmd=" + b16);
            return;
        }
        if (c() && b16 == 0) {
        ...
        if (packet == null) {
            g.d("ICGameNetCore_BaseTimiGameServlet_", "onSend bad packet, cmd=" + b16);
            return;
        }
        ...
        baseInterfaceOuterClass$Terminal.client_version.set(com.tencent.icgame.game.utils.b.b().a());
        BaseInterfaceOuterClass$NetInfo baseInterfaceOuterClass$NetInfo = new BaseInterfaceOuterClass$NetInfo();
        baseInterfaceOuterClass$NetInfo.client_ip.set(com.tencent.icgame.game.utils.b.b().c());
        ...
        sb5.append(i3);
        g.h("ICGameNetCore_BaseTimiGameServlet_", sb5.toString());
    }
    ...
    public void sendToMSF(Intent intent, ToServiceMsg toServiceMsg) {
        ...
        g.h("ICGameNetCore_BaseTimiGameServlet_", "sendToMSF cmd=" + b() + ", appSeq= " + toServiceMsg.getAppSeq());
    }
}
