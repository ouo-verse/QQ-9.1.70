...
public final class FontRecommendRsp extends JceStruct {
    ...
    public void writeTo(JceOutputStream jceOutputStream) {
        ...
        ArrayList<FontInfo> arrayList = this.vItems;
        if (arrayList != null) {
            jceOutputStream.write((Collection) arrayList, 1);
        }
    }

    public FontRecommendRsp(CommonRsp commonRsp, ArrayList<FontInfo> arrayList) {
