...
import com.tencent.mobileqq.guild.feed.nativedetail.content.feedcomment.section.h;
...
public final class c extends hl1.a<jl1.f, hl1.g> {
    ...
    @Override // com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(@NotNull ViewGroup parent, @NotNull View itemView, @NotNull List<Class<? extends Section<jl1.f>>> sections) {
