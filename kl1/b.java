...
public final class b extends hl1.a<jl1.g, hl1.g> {
    ...
    public void initSection(@NotNull ViewGroup parent, @NotNull View itemView, @NotNull List<Class<? extends Section<jl1.g>>> sections) {
        ...
        sections.add(com.tencent.mobileqq.guild.feed.nativedetail.content.feedcomment.section.f.class);
    }
}
