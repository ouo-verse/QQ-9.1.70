...
public class k extends d {
    ...
    public void a(Manifold manifold, Transform transform, Transform transform2) {
        this.f404483p.getCollision().d(manifold, (com.qzone.jbox2d.collision.shapes.c) this.f404473f.i(), transform, (com.qzone.jbox2d.collision.shapes.e) this.f404474g.i(), transform2);
    }
