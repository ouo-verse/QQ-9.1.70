                        ...
                        if (readTag != 26) {
                            if (readTag != 32) {
                                if (readTag != 42) {
                                    ...
                                    this.f429393e = aVarArr2;
                                }
                            } else {
                                this.f429392d = codedInputByteBufferNano.readInt32();
                            }
                        } else {
                            int repeatedFieldArrayLength2 = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 26);
                            e[] eVarArr = this.f429391c;
                            if (eVarArr == null) {
                                length2 = 0;
                            } else {
