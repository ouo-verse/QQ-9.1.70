...
/* compiled from: P */
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0004\n\u0002\u0010\u000b\n\u0002\b\u0007\u0018\u0000 \u00102\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0007B\u0019\u0012\u0006\u0010\t\u001a\u00020\u0002\u0012\b\b\u0002\u0010\r\u001a\u00020\n\u00a2\u0006\u0004\b\u000e\u0010\u000fJ\u0016\u0010\u0006\u001a\u00020\u00052\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00020\u0003H\u0016J\b\u0010\u0007\u001a\u00020\u0002H\u0016R\u0014\u0010\t\u001a\u00020\u00028\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u0007\u0010\bR\u0014\u0010\r\u001a\u00020\n8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u000b\u0010\f\u00a8\u0006\u0011"}, d2 = {"Lmt0/a;", "Lcom/tencent/timi/game/api/cookie/IDataSupplier;", "", "Lcom/tencent/timi/game/api/cookie/DataSupplierCallback;", "callback", "", "getDataAsync", "a", "Ljava/lang/String;", "domain", "", "b", "Z", "noCache", "<init>", "(Ljava/lang/String;Z)V", "c", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class a implements IDataSupplier<String> {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000!\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0016\u0010\u0006\u001a\u00020\u00052\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00030\u0002H\u0016J\u0012\u0010\t\u001a\u00020\u00052\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0016J\u0012\u0010\n\u001a\u00020\u00052\b\u0010\b\u001a\u0004\u0018\u00010\u0007H\u0016\u00a8\u0006\u000b"}, d2 = {"mt0/a$b", "Lcom/tencent/timi/game/api/ticket/PSKeyCallback;", "", "Lcom/tencent/timi/game/api/ticket/PSKey;", "pSKeys", "", "onSuccess", "", "msg", "onFailed", "onTimeout", "ic-game-timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes7.dex */
    public static final class b implements PSKeyCallback {

        /* renamed from: a, reason: collision with root package name */
        final /* synthetic */ DataSupplierCallback<String> f417545a;

        b(DataSupplierCallback<String> dataSupplierCallback) {
            this.f417545a = dataSupplierCallback;
        }

        @Override // com.tencent.timi.game.api.ticket.PSKeyCallback
        public void onFailed(@Nullable String msg2) {
            DataSupplierCallback<String> dataSupplierCallback = this.f417545a;
            if (msg2 == null) {
                msg2 = "onFailed";
            }
        ...
        public void onSuccess(@NotNull List<PSKey> pSKeys) {
            ...
            QLog.d("ICGamePSKeyDataSupplier", 1, "getPsKeysAsync onSuccess");
            if (pSKeys.isEmpty()) {
                QLog.e("ICGamePSKeyDataSupplier", 1, "pSKey is empty");
                this.f417545a.onFailed(2, "pSKey is empty");
                return;
            }
            DataSupplierCallback<String> dataSupplierCallback = this.f417545a;
    ...
    public String getDataSync() {
        QLog.i("ICGamePSKeyDataSupplier", 1, "getDataSync domain=" + this.domain);
    ...
    public void getDataAsync(@NotNull DataSupplierCallback<String> callback) {
        ...
        QLog.i("ICGamePSKeyDataSupplier", 1, "getDataAsync domain:" + this.domain + ",noCache:" + this.noCache);
