...
public final class f implements c45.d {
    ...
    public static final a f413193i = new a();

    /* renamed from: d, reason: collision with root package name */
    public final String f413194d;

    /* renamed from: e, reason: collision with root package name */
    public final String f413195e;

    /* renamed from: f, reason: collision with root package name */
    public final String f413196f;

    /* renamed from: h, reason: collision with root package name */
    public final int f413197h;
    ...
    public final int getProtoSize() {
        ...
        int a17 = iVar.a(1, a16, this.f413194d) + 0;
        c45.b a18 = aVar.a(2);
        Intrinsics.checkNotNull(a18);
        int a19 = iVar.a(2, a18, this.f413195e) + a17;
        c45.b a26 = aVar.a(3);
        Intrinsics.checkNotNull(a26);
        int a27 = iVar.a(3, a26, this.f413196f) + a19;
        c45.b a28 = aVar.a(4);
        Intrinsics.checkNotNull(a28);
        return iVar.a(4, a28, Integer.valueOf(this.f413197h)) + a27;
    }
    ...
    public final void writeMessage(c45.g gVar) {
        ...
        c45.b a16 = aVar.a(1);
        Intrinsics.checkNotNull(a16);
        eVar.b(1, a16, this.f413194d);
        c45.b a17 = aVar.a(2);
        Intrinsics.checkNotNull(a17);
        eVar.b(2, a17, this.f413195e);
        c45.b a18 = aVar.a(3);
        Intrinsics.checkNotNull(a18);
        eVar.b(3, a18, this.f413196f);
        c45.b a19 = aVar.a(4);
        Intrinsics.checkNotNull(a19);
        eVar.b(4, a19, Integer.valueOf(this.f413197h));
    }
    ...
    */
    public /* synthetic */ f(int i3, int i16) {
        this(r0, r3, r1, i3);
        String str = (i16 & 1) != 0 ? "" : null;
        String str2 = (i16 & 2) != 0 ? "" : null;
        String str3 = (i16 & 4) == 0 ? null : "";
        i3 = (i16 & 8) != 0 ? 0 : i3;
        if ((i16 & 16) != 0) {
    ...
    public static final class a implements d.a<f> {
        ...
        public final f b(c45.f fVar) {
            ...
            ((e45.c) fVar).b(this, new Function2<Integer, Object, Unit>() { // from class: kuikly.com.tencent.trpcprotocol.search.unifysearch.GeoInfo$Companion$decodeWith$unknownFields$1
            ...
            return new f((String) objectRef.element, (String) objectRef2.element, (String) objectRef3.element, intRef.element);
        }
