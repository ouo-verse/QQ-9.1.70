...
public final class h implements c45.d {
    ...
    public static final a f413294f = new a();

    /* renamed from: d, reason: collision with root package name */
    public final kuikly.trpc.relation.blacklist.a f413295d;

    /* renamed from: e, reason: collision with root package name */
    public final f f413296e;

    public h(kuikly.trpc.relation.blacklist.a aVar, f fVar) {
        this.f413295d = aVar;
        this.f413296e = fVar;
    }
    ...
    public final int getProtoSize() {
        ...
        int a17 = iVar.a(1, a16, this.f413295d) + 0;
        c45.b a18 = aVar.a(2);
        Intrinsics.checkNotNull(a18);
        return iVar.a(2, a18, this.f413296e) + a17;
    }
    ...
    public final void writeMessage(c45.g gVar) {
        ...
        c45.b a16 = aVar.a(1);
        Intrinsics.checkNotNull(a16);
        eVar.b(1, a16, this.f413295d);
        c45.b a17 = aVar.a(2);
        Intrinsics.checkNotNull(a17);
        eVar.b(2, a17, this.f413296e);
    }
    ...
    public static final class a implements d.a<h> {
        ...
        public final h b(c45.f fVar) {
            ...
            ((e45.c) fVar).b(this, new Function2<Integer, Object, Unit>() { // from class: kuikly.trpc.relation.blacklist.UnblockReq$Companion$decodeWith$unknownFields$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(2);
                }

                /* JADX WARN: Type inference failed for: r3v1, types: [kuikly.trpc.relation.blacklist.a, T] */
                /* JADX WARN: Type inference failed for: r3v2, types: [T, kuikly.trpc.relation.blacklist.f] */
            ...
            return new h((kuikly.trpc.relation.blacklist.a) objectRef.element, (f) objectRef2.element);
        }
