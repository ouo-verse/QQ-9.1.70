...
public class SubstituteLogger implements Logger {
    ...
    public SubstituteLogger(String str, Queue<SubstituteLoggingEvent> queue, boolean z16) {
        this.name = str;
        this.eventQueue = queue;
        this.createdPostInitialization = z16;
    }
