...
public class ImmutableInstruction35mi extends ImmutableInstruction implements Instruction35mi {
    ...
    public ImmutableInstruction35mi(@Nonnull Opcode opcode, int i3, int i16, int i17, int i18, int i19, int i26, int i27) {
        super(opcode);
        int i28;
        int i29;
        int i36;
        ...
        this.inlineIndex = Preconditions.checkInlineIndex(i27);
    }
