...
public class BuilderInstruction45cc extends BuilderInstruction implements Instruction45cc {
    ...
    public BuilderInstruction45cc(@Nonnull Opcode opcode, int i3, int i16, int i17, int i18, int i19, int i26, @Nonnull Reference reference, @Nonnull Reference reference2) {
        super(opcode);
        int i27;
        int i28;
        int i29;
