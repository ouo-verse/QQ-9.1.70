...
public class EdgeAndCircleContact extends Contact {
    ...
    public EdgeAndCircleContact(IWorldPool iWorldPool) {
        super(iWorldPool);
    }
    ...
    public void evaluate(Manifold manifold, Transform transform, Transform transform2) {
        this.pool.getCollision().collideEdgeAndCircle(manifold, (EdgeShape) this.m_fixtureA.getShape(), transform, (CircleShape) this.m_fixtureB.getShape(), transform2);
    }
