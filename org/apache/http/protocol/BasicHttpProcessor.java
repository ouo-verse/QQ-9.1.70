...
public final class BasicHttpProcessor implements HttpProcessor, HttpRequestInterceptorList, HttpResponseInterceptorList {
    ...
    public final void addInterceptor(HttpRequestInterceptor httpRequestInterceptor, int i3) {
        throw new RuntimeException("Stub!");
    }
    ...
    public final void addInterceptor(HttpResponseInterceptor httpResponseInterceptor, int i3) {
        throw new RuntimeException("Stub!");
    }
}
