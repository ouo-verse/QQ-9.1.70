...
public class DefaultClientConnection extends SocketHttpClientConnection implements OperatedClientConnection {
    ...
    @Override // org.apache.http.conn.OperatedClientConnection
    public void openCompleted(boolean z16, HttpParams httpParams) throws IOException {
        throw new RuntimeException("Stub!");
    }
    ...
    @Override // org.apache.http.conn.OperatedClientConnection
    public void update(Socket socket, HttpHost httpHost, boolean z16, HttpParams httpParams) throws IOException {
        throw new RuntimeException("Stub!");
    }
}
