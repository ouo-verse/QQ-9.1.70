...
public class FileUtils {
    ...
    */
    ...
    public static String getFileNameWithSuffixByPath(String str) {
        String str2;
        String str3 = TAG;
        LightLogUtil.v(str3, "[getFileNameWithSuffixByPath] path = " + str);
        if (!TextUtils.isEmpty(str)) {
            str2 = str.substring(str.lastIndexOf("/") + 1);
        } else {
            str2 = null;
        }
        LightLogUtil.v(str3, "[getFileNameWithSuffixByPath] return title = " + str2);
        return str2;
    }
            ...
            try {
                ...
                while (true) {
                    try {
                        ...
                        e16 = e17;
                        LightLogUtil.i(TAG, e16.getMessage());
                        IOUtils.closeQuietly(bufferedReader);
                        IOUtils.closeQuietly(fileInputStream);
                        return sb5.toString();
                    }
    ...
    /* JADX WARN: Type inference failed for: r7v13, types: [org.light.utils.ByteArrayPool] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
    */
    public static byte[] readFile(String str) {
        ...
        try {
            ...
            r26 = new ByteArrayOutputStream(length);
            try {
                r36 = new FileInputStream(file);
                r46 = 4096;
            } catch (Exception e17) {
                e = e17;
                r36 = 0;
        ...
        try {
            try {
                if (length < 4096) {
                    r46 = ByteArrayPool.getGenericInstance().getBuf(4096);
                } else {
                    r46 = ByteArrayPool.getGenericInstance().getBuf(12288);
                }
            } catch (OutOfMemoryError unused) {
                r46 = ByteArrayPool.getGenericInstance().getBuf(r46);
            }
            int i3 = 0;
            while (i3 < length) {
                int read = r36.read(r46);
                r26.write(r46, 0, read);
                i3 += read;
            }
            ByteArrayPool.getGenericInstance().returnBuf(r46);
            bArr = r26.toByteArray();
            r26.close();
            r36.close();
        } catch (Exception e26) {
            e = e26;
