...
public abstract class b<E> extends j<E> {
    ...
    /* loaded from: classes36.dex */
    public static class C11479b extends RecyclerView.ViewHolder {
        public C11479b(View view) {
            super(view);
        }

        public void l(BusinessFeedData businessFeedData, int i3) {
            View view = this.itemView;
            if (view instanceof QZoneBaseFeedItemView) {
                ((QZoneBaseFeedItemView) view).setData(businessFeedData, i3);
            }
        }
    }
    ...
    protected void n0(final RecyclerView recyclerView) {
        f fVar = this.C;
        if (fVar != null) {
            fVar.M1().observe(getParentFragment(), new Observer() { // from class: we.a
    ...
    protected void p0(RecyclerView recyclerView) {
        this.f445495m = new c(getContext(), recyclerView, this);
        this.C = (f) getViewModel(f.class);
        List<hh.b> l06 = l0();
        if (l06 != null && l06.size() > 0) {
            Iterator<hh.b> it = l06.iterator();
            while (it.hasNext()) {
                this.f445495m.d(it.next());
            }
        }
        addOnScrollListener(this.f445495m);
        this.f445495m.j(recyclerView);
    ...
    public static /* synthetic */ void m0(RecyclerView recyclerView, Integer num) {
        for (int i3 = 0; i3 < recyclerView.getChildCount(); i3++) {
            try {
                ...
                RFWLog.fatal("QZoneBaseFeedListAdapter", RFWLog.USR, e16);
                return;
            }
        }
    }
