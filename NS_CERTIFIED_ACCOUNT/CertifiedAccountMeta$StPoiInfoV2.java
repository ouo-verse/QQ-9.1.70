...
public final class CertifiedAccountMeta$StPoiInfoV2 extends MessageMicro<CertifiedAccountMeta$StPoiInfoV2> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 34, 42, 48, 58, 64, 72, 82, 90, 98, 106, 112, 120, 130, 138, 146}, new String[]{"poiId", "name", "poiType", "typeName", "address", "districtCode", "gps", Element.ELEMENT_NAME_DISTANCE, "hotValue", "phone", "country", "province", "city", "poiNum", "poiOrderType", "defaultName", "district", "dianPingId"}, new Object[]{"", "", 0, "", "", 0, null, 0, 0, "", "", "", "", 0, 0, "", "", ""}, CertifiedAccountMeta$StPoiInfoV2.class);
