...
public final class b extends RFWAbsLoadMoreAdapter {
    ...
    public void onLoadMoreStart() {
        ...
        if (aVar2 != null) {
            textView = aVar2.getProgressInfo();
        } else {
            textView = null;
        }
        if (textView != null) {
