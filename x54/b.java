...
/* compiled from: P */
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u00002\u00020\u0001B\u0017\u0012\u0006\u0010\f\u001a\u00020\b\u0012\u0006\u0010\u0011\u001a\u00020\r\u00a2\u0006\u0004\b\u0012\u0010\u0013J\u0010\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00020\u0001H\u0016J\u0010\u0010\u0005\u001a\u00020\u00032\u0006\u0010\u0002\u001a\u00020\u0001H\u0016J\u0012\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\u0002\u001a\u00020\u0001H\u0016R\u0017\u0010\f\u001a\u00020\b8\u0006\u00a2\u0006\f\n\u0004\b\u0004\u0010\t\u001a\u0004\b\n\u0010\u000bR\u0017\u0010\u0011\u001a\u00020\r8\u0006\u00a2\u0006\f\n\u0004\b\u0005\u0010\u000e\u001a\u0004\b\u000f\u0010\u0010\u00a8\u0006\u0014"}, d2 = {"Lx54/b;", "Lb74/a;", "newItemData", "", "a", "b", "", "c", "Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotInfo;", "Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotInfo;", "e", "()Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotInfo;", "robotInfo", "Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotFeatureInfo;", "Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotFeatureInfo;", "d", "()Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotFeatureInfo;", "commandInfo", "<init>", "(Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotInfo;Lcom/tencent/qqnt/kernel/nativeinterface/CommonBotFeatureInfo;)V", "robot-business-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class b implements b74.a {
    ...
    public boolean b(@NotNull b74.a newItemData) {
        Intrinsics.checkNotNullParameter(newItemData, "newItemData");
        b bVar = (b) newItemData;
        if (this.robotInfo.mark == bVar.robotInfo.mark && Intrinsics.areEqual(this.commandInfo.name, bVar.commandInfo.name) && Intrinsics.areEqual(this.commandInfo.desc, bVar.commandInfo.desc)) {
            return true;
        }
        return false;
    }
    ...
    public Object c(@NotNull b74.a newItemData) {
        ...
        if (!Intrinsics.areEqual(this.commandInfo.name, bVar.commandInfo.name)) {
            String str = bVar.commandInfo.name;
            Intrinsics.checkNotNullExpressionValue(str, "newItemData.commandInfo.name");
            arrayList.add(new SlashItemCommandNamePayload(str));
        }
        if (!Intrinsics.areEqual(this.commandInfo.desc, bVar.commandInfo.desc)) {
            String str2 = bVar.commandInfo.desc;
            Intrinsics.checkNotNullExpressionValue(str2, "newItemData.commandInfo.desc");
            arrayList.add(new SlashItemCommandDescPayload(str2));
        }
        return arrayList;
    }
