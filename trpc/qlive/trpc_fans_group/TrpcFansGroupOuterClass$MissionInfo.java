...
public final class TrpcFansGroupOuterClass$MissionInfo extends MessageMicro<TrpcFansGroupOuterClass$MissionInfo> {
    ...
    public TrpcFansGroupOuterClass$MissionAction action = new MessageMicro<TrpcFansGroupOuterClass$MissionAction>() { // from class: trpc.qlive.trpc_fans_group.TrpcFansGroupOuterClass$MissionAction
