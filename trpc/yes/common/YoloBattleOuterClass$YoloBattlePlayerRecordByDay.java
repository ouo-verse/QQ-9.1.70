...
public final class YoloBattleOuterClass$YoloBattlePlayerRecordByDay extends MessageMicro<YoloBattleOuterClass$YoloBattlePlayerRecordByDay> {
    ...
    public YoloBattleSmobaOuterClass$SmobaPlayerRecordByDay smoba_record_by_day = new MessageMicro<YoloBattleSmobaOuterClass$SmobaPlayerRecordByDay>() { // from class: trpc.yes.common.YoloBattleSmobaOuterClass$SmobaPlayerRecordByDay
