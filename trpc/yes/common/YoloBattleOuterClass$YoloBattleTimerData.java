...
public final class YoloBattleOuterClass$YoloBattleTimerData extends MessageMicro<YoloBattleOuterClass$YoloBattleTimerData> {
    ...
    public YoloBattleOuterClass$YoloBattleEventReq next_event = new MessageMicro<YoloBattleOuterClass$YoloBattleEventReq>() { // from class: trpc.yes.common.YoloBattleOuterClass$YoloBattleEventReq
