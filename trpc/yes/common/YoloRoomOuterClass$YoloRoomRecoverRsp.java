...
public final class YoloRoomOuterClass$YoloRoomRecoverRsp extends MessageMicro<YoloRoomOuterClass$YoloRoomRecoverRsp> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 24, 34, 40, 50, 66}, new String[]{AegisLogger.ROOM_INFO, "room_speaking_pos_list", "speaking_pos_list_version", "room_conf", "cur_action_id", "rotate_messsage_list", "room_user_data"}, new Object[]{null, null, 0, null, 0L, null, null}, YoloRoomOuterClass$YoloRoomRecoverRsp.class);
