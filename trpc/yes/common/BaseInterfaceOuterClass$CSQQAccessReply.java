...
public final class BaseInterfaceOuterClass$CSQQAccessReply extends MessageMicro<BaseInterfaceOuterClass$CSQQAccessReply> {
    ...
    public BaseInterfaceOuterClass$AccountInfo account_info = new MessageMicro<BaseInterfaceOuterClass$AccountInfo>() { // from class: trpc.yes.common.BaseInterfaceOuterClass$AccountInfo
