...
public final class YoloBattlePartnerOuterClass$YoloBattlePartnerReq extends MessageMicro<YoloBattlePartnerOuterClass$YoloBattlePartnerReq> {
    ...
    public YoloBattlePartnerOuterClass$YoloBattlePartnerReqMessage req_message = new MessageMicro<YoloBattlePartnerOuterClass$YoloBattlePartnerReqMessage>() { // from class: trpc.yes.common.YoloBattlePartnerOuterClass$YoloBattlePartnerReqMessage
