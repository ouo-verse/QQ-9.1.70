...
public final class NearbyCommonOuterClass$YesGameRecommendTeamPos extends MessageMicro<NearbyCommonOuterClass$YesGameRecommendTeamPos> {
    ...
    public NearbyCommonOuterClass$YesGameRecommendTeamUser userinfo = new MessageMicro<NearbyCommonOuterClass$YesGameRecommendTeamUser>() { // from class: trpc.yes.common.NearbyCommonOuterClass$YesGameRecommendTeamUser
