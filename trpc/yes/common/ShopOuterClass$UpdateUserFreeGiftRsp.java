...
public final class ShopOuterClass$UpdateUserFreeGiftRsp extends MessageMicro<ShopOuterClass$UpdateUserFreeGiftRsp> {
    ...
    public ShopOuterClass$SendGiftTimeInfo send_gift_time = new MessageMicro<ShopOuterClass$SendGiftTimeInfo>() { // from class: trpc.yes.common.ShopOuterClass$SendGiftTimeInfo
