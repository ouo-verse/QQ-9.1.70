...
public final class QsmDataOuterClass$QSMPlayerBattleResult extends MessageMicro<QsmDataOuterClass$QSMPlayerBattleResult> {
    ...
    public QsmDataOuterClass$QSMPlayerSpeedSingleResult speed_single_result = new MessageMicro<QsmDataOuterClass$QSMPlayerSpeedSingleResult>() { // from class: trpc.yes.common.QsmDataOuterClass$QSMPlayerSpeedSingleResult
    ...
    public QsmDataOuterClass$QSMPlayerSpeedTeamResult speed_team_result = new MessageMicro<QsmDataOuterClass$QSMPlayerSpeedTeamResult>() { // from class: trpc.yes.common.QsmDataOuterClass$QSMPlayerSpeedTeamResult
    ...
    public QsmDataOuterClass$QSMPlayerPropSingleResult prop_single_result = new MessageMicro<QsmDataOuterClass$QSMPlayerPropSingleResult>() { // from class: trpc.yes.common.QsmDataOuterClass$QSMPlayerPropSingleResult
    ...
    public QsmDataOuterClass$QSMPlayerPropTeamResult prop_team_result = new MessageMicro<QsmDataOuterClass$QSMPlayerPropTeamResult>() { // from class: trpc.yes.common.QsmDataOuterClass$QSMPlayerPropTeamResult
    ...
    public QsmDataOuterClass$QSMPlayerActionSpeedTeamResult action_speed_team_result = new MessageMicro<QsmDataOuterClass$QSMPlayerActionSpeedTeamResult>() { // from class: trpc.yes.common.QsmDataOuterClass$QSMPlayerActionSpeedTeamResult
    ...
    public QsmDataOuterClass$QSMPlayerActionSpeedSingleResult action_speed_single_result = new MessageMicro<QsmDataOuterClass$QSMPlayerActionSpeedSingleResult>() { // from class: trpc.yes.common.QsmDataOuterClass$QSMPlayerActionSpeedSingleResult
