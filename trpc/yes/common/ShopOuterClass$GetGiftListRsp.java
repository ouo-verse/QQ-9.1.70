...
public final class ShopOuterClass$GetGiftListRsp extends MessageMicro<ShopOuterClass$GetGiftListRsp> {
    ...
    public ShopOuterClass$GiftCommonConf gift_common_conf = new MessageMicro<ShopOuterClass$GiftCommonConf>() { // from class: trpc.yes.common.ShopOuterClass$GiftCommonConf
        ...
        public ShopOuterClass$GiftNumItemList num_config = new MessageMicro<ShopOuterClass$GiftNumItemList>() { // from class: trpc.yes.common.ShopOuterClass$GiftNumItemList
    ...
    public ShopOuterClass$GiftListConfList gift_list = new MessageMicro<ShopOuterClass$GiftListConfList>() { // from class: trpc.yes.common.ShopOuterClass$GiftListConfList
    ...
    public ShopOuterClass$UserBagList bag_list = new MessageMicro<ShopOuterClass$UserBagList>() { // from class: trpc.yes.common.ShopOuterClass$UserBagList
