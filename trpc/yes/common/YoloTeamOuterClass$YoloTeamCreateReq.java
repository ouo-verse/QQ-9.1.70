...
public final class YoloTeamOuterClass$YoloTeamCreateReq extends MessageMicro<YoloTeamOuterClass$YoloTeamCreateReq> {
    ...
    public YoloTeamOuterClass$YoloTeamParams team_params = new MessageMicro<YoloTeamOuterClass$YoloTeamParams>() { // from class: trpc.yes.common.YoloTeamOuterClass$YoloTeamParams
        ...
        public YoloTeamOuterClass$YoloTeamAnchorSmobaInfo anchor_smoba_info = new MessageMicro<YoloTeamOuterClass$YoloTeamAnchorSmobaInfo>() { // from class: trpc.yes.common.YoloTeamOuterClass$YoloTeamAnchorSmobaInfo
