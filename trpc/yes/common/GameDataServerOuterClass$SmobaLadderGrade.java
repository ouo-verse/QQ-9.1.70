...
public final class GameDataServerOuterClass$SmobaLadderGrade extends MessageMicro<GameDataServerOuterClass$SmobaLadderGrade> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 32, 42, 48, 58, 66, 72}, new String[]{"disp_grade_level", "logic_grade_level", "grade_level_name", "total_star", "display_name", "big_grade_level", "small_image", "big_image", "disp_style"}, new Object[]{0, 0, "", 0, "", 0, "", "", 0}, GameDataServerOuterClass$SmobaLadderGrade.class);
