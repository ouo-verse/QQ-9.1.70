...
public final class PremadesTeamServerOuterClass$RoomTabInfo extends MessageMicro<PremadesTeamServerOuterClass$RoomTabInfo> {
    ...
    public PremadesTeamServerOuterClass$RoomTabRedPointInfo tab_red_point_info = new MessageMicro<PremadesTeamServerOuterClass$RoomTabRedPointInfo>() { // from class: trpc.yes.common.PremadesTeamServerOuterClass$RoomTabRedPointInfo
        ...
        public final PBStringField f437247id = PBField.initString("");
    };

    /* renamed from: id, reason: collision with root package name */
    public final PBStringField f437246id = PBField.initString("");
}
