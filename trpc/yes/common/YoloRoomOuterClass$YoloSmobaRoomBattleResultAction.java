...
public final class YoloRoomOuterClass$YoloSmobaRoomBattleResultAction extends MessageMicro<YoloRoomOuterClass$YoloSmobaRoomBattleResultAction> {
    ...
    public WujiSmobaOuterClass$WujiSmobaHeroConfList smoba_hero_conf_list = new MessageMicro<WujiSmobaOuterClass$WujiSmobaHeroConfList>() { // from class: trpc.yes.wuji.WujiSmobaOuterClass$WujiSmobaHeroConfList
