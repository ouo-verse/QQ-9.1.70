...
public final class SmobaDataOuterClass$YoloBattleRoomInfo extends MessageMicro<SmobaDataOuterClass$YoloBattleRoomInfo> {
    ...
    public SmobaDataOuterClass$RoomBattleInfo battleinfo = new MessageMicro<SmobaDataOuterClass$RoomBattleInfo>() { // from class: trpc.yes.common.SmobaDataOuterClass$RoomBattleInfo
