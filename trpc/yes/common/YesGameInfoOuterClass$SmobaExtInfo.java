...
public final class YesGameInfoOuterClass$SmobaExtInfo extends MessageMicro<YesGameInfoOuterClass$SmobaExtInfo> {
    ...
    /* JADX WARN: Type inference failed for: r2v1, types: [trpc.yes.common.YesGameInfoOuterClass$SmobaHonorInfo] */
    public YesGameInfoOuterClass$SmobaExtInfo() {
        ...
        this.honor_info = new MessageMicro<YesGameInfoOuterClass$SmobaHonorInfo>() { // from class: trpc.yes.common.YesGameInfoOuterClass$SmobaHonorInfo
