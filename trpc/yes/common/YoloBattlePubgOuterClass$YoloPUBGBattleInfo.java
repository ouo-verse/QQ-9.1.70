...
public final class YoloBattlePubgOuterClass$YoloPUBGBattleInfo extends MessageMicro<YoloBattlePubgOuterClass$YoloPUBGBattleInfo> {
    ...
    public YoloBattlePubgOuterClass$PUBGTeamMateWrapper team_mate_wrapper = new MessageMicro<YoloBattlePubgOuterClass$PUBGTeamMateWrapper>() { // from class: trpc.yes.common.YoloBattlePubgOuterClass$PUBGTeamMateWrapper
