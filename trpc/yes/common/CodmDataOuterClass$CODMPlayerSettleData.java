...
public final class CodmDataOuterClass$CODMPlayerSettleData extends MessageMicro<CodmDataOuterClass$CODMPlayerSettleData> {
    ...
    public CodmDataOuterClass$CODMPlayerAccountInfo account_info = new MessageMicro<CodmDataOuterClass$CODMPlayerAccountInfo>() { // from class: trpc.yes.common.CodmDataOuterClass$CODMPlayerAccountInfo
    ...
    public CodmDataOuterClass$CODMPlayerPicInfo pic_info = new MessageMicro<CodmDataOuterClass$CODMPlayerPicInfo>() { // from class: trpc.yes.common.CodmDataOuterClass$CODMPlayerPicInfo
