...
public final class GameDataServerOuterClass$SmobaGameRoleAbsInfo extends MessageMicro<GameDataServerOuterClass$SmobaGameRoleAbsInfo> {
    static final MessageMicro.FieldMap __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 40, 48, 58, 66, 72, 82, 88, 96}, new String[]{GdtGetUserInfoHandler.KEY_AREA, "partition", "role_name", "role_id", "logic_grade_level", "disp_grade_level", "grade_level_name", "grade_level_short_name", "role_level", "role_desc", "is_default", "big_grade_level"}, new Object[]{0, 0, "", "", 0, 0, "", "", 0, "", Boolean.FALSE, 0}, GameDataServerOuterClass$SmobaGameRoleAbsInfo.class);
