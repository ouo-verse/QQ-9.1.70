...
public final class YesGameInfoOuterClass$YesGameRoleInfo extends MessageMicro<YesGameInfoOuterClass$YesGameRoleInfo> {
    ...
    /* JADX WARN: Type inference failed for: r0v2, types: [trpc.yes.common.YesGameInfoOuterClass$QsmExtInfo] */
    public YesGameInfoOuterClass$YesGameRoleInfo() {
        ...
        this.qsm_ext_info = new MessageMicro<YesGameInfoOuterClass$QsmExtInfo>() { // from class: trpc.yes.common.YesGameInfoOuterClass$QsmExtInfo
