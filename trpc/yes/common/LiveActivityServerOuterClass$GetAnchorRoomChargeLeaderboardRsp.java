...
public final class LiveActivityServerOuterClass$GetAnchorRoomChargeLeaderboardRsp extends MessageMicro<LiveActivityServerOuterClass$GetAnchorRoomChargeLeaderboardRsp> {
    ...
    public LiveActivityServerOuterClass$AnchorRoomChargeLeaderboardItem last_charge = new MessageMicro<LiveActivityServerOuterClass$AnchorRoomChargeLeaderboardItem>() { // from class: trpc.yes.common.LiveActivityServerOuterClass$AnchorRoomChargeLeaderboardItem
