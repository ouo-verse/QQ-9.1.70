...
public final class a extends f<q5.a> {
    ...
    public boolean isForViewType(q5.a item, List<q5.a> items, int position) {
    ...
    public int getLayoutId() {
        return R.layout.f129526a;
    }

    @Override // com.qzone.reborn.base.f, com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<q5.a>>> sections) {
