...
public final class c extends f<wn.d> {
    ...
    public boolean isForViewType(wn.d item, List<wn.d> items, int position) {
        ...
        return item.getRsTask().status.get() == 0;
    }
