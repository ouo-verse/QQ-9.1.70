...
import com.qzone.reborn.repair.section.QZonePhotoRepairTaskRepairedAreaSection;
...
public final class b extends f<wn.d> {
    ...
    public boolean isForViewType(wn.d item, List<wn.d> items, int position) {
        Intrinsics.checkNotNullParameter(item, "item");
        Intrinsics.checkNotNullParameter(items, "items");
        return item.getRsTask().status.get() == 1;
    }
    ...
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<wn.d>>> sections) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        super.initSection(parent, itemView, sections);
        sections.add(com.qzone.reborn.repair.section.d.class);
        sections.add(com.qzone.reborn.repair.section.b.class);
        sections.add(QZonePhotoRepairTaskRepairedAreaSection.class);
    }
}
