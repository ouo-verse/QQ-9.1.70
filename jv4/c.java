...
public final class c extends ExtendableMessageNano<c> {
    ...
    public c mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 10) {
                if (this.f411014a == null) {
                    this.f411014a = new iv4.l();
                }
                codedInputByteBufferNano.readMessage(this.f411014a);
            } else if (readTag != 16) {
                if (!storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            } else {
                this.f411015b = codedInputByteBufferNano.readInt32();
            }
        }
    }
