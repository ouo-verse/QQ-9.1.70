...
public final class Okio {
    ...
    public static final <T extends Closeable, R> R use(T t16, @NotNull Function1<? super T, ? extends R> function1) {
        return (R) Okio__OkioKt.use(t16, function1);
    }
    ...
    public static final Sink sink(@NotNull File file, boolean z16) throws FileNotFoundException {
        return Okio__JvmOkioKt.sink(file, z16);
    }
