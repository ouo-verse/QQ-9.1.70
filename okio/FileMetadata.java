...
public final class FileMetadata {
    ...
    public String toString() {
        ...
        Long l16 = this.createdAtMillis;
        if (l16 != null) {
            arrayList.add(Intrinsics.stringPlus("createdAt=", l16));
        }
        Long l17 = this.lastModifiedAtMillis;
        if (l17 != null) {
            arrayList.add(Intrinsics.stringPlus("lastModifiedAt=", l17));
        }
        Long l18 = this.lastAccessedAtMillis;
        if (l18 != null) {
            arrayList.add(Intrinsics.stringPlus("lastAccessedAt=", l18));
        }
    ...
    public FileMetadata(boolean z16, boolean z17, @Nullable Path path, @Nullable Long l3, @Nullable Long l16, @Nullable Long l17, @Nullable Long l18, @NotNull Map<KClass<?>, ? extends Object> extras) {
        Map<KClass<?>, Object> map;
        Intrinsics.checkNotNullParameter(extras, "extras");
        this.isRegularFile = z16;
        this.isDirectory = z17;
        this.symlinkTarget = path;
        this.size = l3;
        this.createdAtMillis = l16;
        this.lastModifiedAtMillis = l17;
        this.lastAccessedAtMillis = l18;
        map = MapsKt__MapsKt.toMap(extras);
        this.extras = map;
    }

    public /* synthetic */ FileMetadata(boolean z16, boolean z17, Path path, Long l3, Long l16, Long l17, Long l18, Map map, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this((i3 & 1) != 0 ? false : z16, (i3 & 2) == 0 ? z17 : false, (i3 & 4) != 0 ? null : path, (i3 & 8) != 0 ? null : l3, (i3 & 16) != 0 ? null : l16, (i3 & 32) != 0 ? null : l17, (i3 & 64) == 0 ? l18 : null, (i3 & 128) != 0 ? MapsKt__MapsKt.emptyMap() : map);
    }
}
