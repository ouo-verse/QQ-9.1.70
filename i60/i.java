...
import com.tencent.biz.qqcircle.list.bizblocks.QFSSearchResultMoreUserListBlock;
...
public class i extends g {
    private final QFSSearchResultMoreUserListBlock D;
    ...
    public i() {
        ...
        QFSSearchResultMoreUserListBlock qFSSearchResultMoreUserListBlock = new QFSSearchResultMoreUserListBlock(null);
        this.D = qFSSearchResultMoreUserListBlock;
        this.mPeerBlocks.add(qFSSearchResultMoreUserListBlock);
        initListener();
    }
    ...
    private void C9(QFSSearchInfo qFSSearchInfo) {
        ...
        ua0.i.i(getActivity(), getHostFragment().getView(), QCircleDaTongConstant.PageId.PG_XSJ_USER_VERTICAL_SEARCH_PAGE, hashMap);
    }
    ...
    private void initListener() {
        this.D.setQueryFixClickListener(new com.tencent.biz.qqcircle.immersive.search.a() { // from class: i60.h
            @Override // com.tencent.biz.qqcircle.immersive.search.a
            public final void a(QFSSearchInfo qFSSearchInfo) {
                i.this.E9(qFSSearchInfo);
            }
        });
    }
