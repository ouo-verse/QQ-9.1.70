...
public final class c {
    ...
    public c(@NotNull String guildId, @NotNull String keyWord) {
    ...
    private final GProBatchManageOperateReq c(boolean deletePoster, BatchManageOperate state, String channelId) {
        ...
        long l3 = MiscKt.l(channelId);
        gProBatchManageOperateReq.orgChannelId = l3;
        QLog.d("BatchDeleteFeedOperator", 1, "constructBatchDeleteFeedRequest " + l3);
        gProBatchManageOperateReq.operateType = 2;
        ...
        gProBatchManageOperateReq.removePoster = deletePoster;
        return gProBatchManageOperateReq;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void e(final c this$0, final int i3, final String str, GProBatchManageOperateRsp gProBatchManageOperateRsp) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        QLog.i("BatchDeleteFeedOperator", 1, "BatchDeleteFeedOperator|result=" + i3 + ", errMsg=" + str + ", toast=" + gProBatchManageOperateRsp.toast);
        ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: yi1.b
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void f(int i3, String errMsg, c this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        if (n.v(i3)) {
        ...
        n.A(2, "\u5220\u9664\u6210\u529f");
        g gVar2 = this$0.mOperationListener;
        if (gVar2 != null) {
            gVar2.a(true);
        }
    }

    public final void d(boolean deletePoster, @NotNull BatchManageOperate state, @NotNull String channelId) {
        Intrinsics.checkNotNullParameter(state, "state");
        Intrinsics.checkNotNullParameter(channelId, "channelId");
        GProBatchManageOperateReq c16 = c(deletePoster, state, channelId);
        o c17 = l.c();
        if (c17 != null) {
            c17.batchManageOperate(c16, new IGProBatchManageOperateCallback() { // from class: yi1.a
                ...
                public final void onResult(int i3, String str, GProBatchManageOperateRsp gProBatchManageOperateRsp) {
                    c.e(c.this, i3, str, gProBatchManageOperateRsp);
                }
            });
        }
    }
