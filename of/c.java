...
public class c extends nf.a<QZoneForwardFeedItemView> {
    @Override // nf.a
    ...
    public QZoneFeedType b() {
        return QZoneFeedType.UNIQUE_TYPE_FORWARD_SINGLE_VIDEO_FEED;
    }

    @Override // nf.a
    public boolean c(BusinessFeedData businessFeedData) {
        return com.qzone.reborn.feedx.itemview.d.d(businessFeedData) && com.qzone.reborn.feedx.itemview.d.b(businessFeedData.getOriginalInfo()) == 1;
    }
}
