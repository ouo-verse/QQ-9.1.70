...
public final class af extends ExtendableMessageNano<af> {
        ...
        while (true) {
            ...
            if (readTag != 0) {
                if (readTag != 10) {
                    ...
                    this.f401294a = codedInputByteBufferNano.readString();
                }
            } else {
                return this;
            }
    ...
    public int computeSerializedSize() {
        ...
        if (!this.f401294a.equals("")) {
            return computeSerializedSize + CodedOutputByteBufferNano.computeStringSize(1, this.f401294a);
        }
    ...
    public void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!this.f401294a.equals("")) {
            codedOutputByteBufferNano.writeString(1, this.f401294a);
        }
