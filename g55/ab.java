...
public final class ab extends ExtendableMessageNano<ab> {
    ...
    public boolean f401289a;

    /* renamed from: b, reason: collision with root package name */
    public boolean f401290b;
            ...
            if (readTag != 0) {
                if (readTag != 8) {
                    if (readTag != 16) {
                        ...
                        this.f401290b = codedInputByteBufferNano.readBool();
                    }
                } else {
                    this.f401289a = codedInputByteBufferNano.readBool();
                }
            } else {
                return this;
            }
