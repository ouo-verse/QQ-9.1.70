...
public final class FeedCloudRead$PicRecomEntry extends MessageMicro<FeedCloudRead$PicRecomEntry> {
    ...
    public final PBRepeatMessageField<FeedCloudRead$PicRecTags> tags = PBField.initRepeatMessage(FeedCloudRead$PicRecTags.class);
}
