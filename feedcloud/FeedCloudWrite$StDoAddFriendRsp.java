...
public final class FeedCloudWrite$StDoAddFriendRsp extends MessageMicro<FeedCloudWrite$StDoAddFriendRsp> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 18, 24, 32, 42, 50}, new String[]{"uint32_result", "bytes_reason", "uint32_reason", "uint32_permission", "bytes_notice", "bytes_ext"}, new Object[]{0, byteStringMicro, 0, 0, byteStringMicro, byteStringMicro}, FeedCloudWrite$StDoAddFriendRsp.class);
    }

    public FeedCloudWrite$StDoAddFriendRsp() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
