...
public class a extends c {
    ...
    protected String getLogTag() {
        return "QFSSearchRelatedGoodsResultBlock";
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i3) {
        FeedCloudRead$StSearchRelatedGoods feedCloudRead$StSearchRelatedGoods = (FeedCloudRead$StSearchRelatedGoods) getItem(i3);
        if (feedCloudRead$StSearchRelatedGoods != null && feedCloudRead$StSearchRelatedGoods.items.has()) {
            this.C.setVisibility(0);
            this.C.setData(feedCloudRead$StSearchRelatedGoods.items.get());
            this.C.setTitle(feedCloudRead$StSearchRelatedGoods.title.get());
            return;
        }
