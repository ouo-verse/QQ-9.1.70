...
public final class a implements n<c> {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000\u0011\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\b\u0010\u0003\u001a\u00020\u0002H\u0016\u00a8\u0006\u0004"}, d2 = {"f74/a$b", "Lw64/m;", "Lcom/tencent/mvi/runtime/strategy/b;", "a", "robot-business-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes25.dex */
    ...
    public a(@NotNull com.tencent.mvi.api.runtime.b mviContext, @NotNull com.tencent.robot.slash.businessapi.c businessDelegate) {
        ...
        this.f397979a = new u54.a(mviContext, businessDelegate);
    }

    @Override // w64.n
    @NotNull
    public k<c> a() {
        return this.f397979a.a();
    }
    ...
    @NotNull
    public f c() {
        return this.f397979a.c();
    }

    @Override // w64.n
    @NotNull
    public i d() {
        return this.f397979a.d();
    }
