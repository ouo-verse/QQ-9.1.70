...
public final class bb implements ViewBinding {
    ...
    @NonNull
    private final RadiusFrameLayout f442394a;

    /* renamed from: b, reason: collision with root package name */
    @NonNull
    public final ImageView f442395b;

    /* renamed from: c, reason: collision with root package name */
    @NonNull
    public final GuildHomeActiveChannelMaskView f442396c;

    /* renamed from: d, reason: collision with root package name */
    @NonNull
    public final GuildHomeActiveChannelMicAvatarView f442397d;

    /* renamed from: e, reason: collision with root package name */
    @NonNull
    public final GuildHomeActiveChannelMicAvatarView f442398e;

    /* renamed from: f, reason: collision with root package name */
    @NonNull
    public final GuildHomeActiveChannelMicAvatarView f442399f;

    /* renamed from: g, reason: collision with root package name */
    @NonNull
    public final GuildHomeActiveChannelMicAvatarView f442400g;

    /* renamed from: h, reason: collision with root package name */
    @NonNull
    public final LottieAnimationView f442401h;

    /* renamed from: i, reason: collision with root package name */
    @NonNull
    public final LinearLayout f442402i;

    /* renamed from: j, reason: collision with root package name */
    @NonNull
    public final ImageView f442403j;

    /* renamed from: k, reason: collision with root package name */
    @NonNull
    public final TextView f442404k;

    /* renamed from: l, reason: collision with root package name */
    @NonNull
    public final LinearLayout f442405l;

    /* renamed from: m, reason: collision with root package name */
    @NonNull
    public final TextView f442406m;

    bb(@NonNull RadiusFrameLayout radiusFrameLayout, @NonNull ImageView imageView, @NonNull GuildHomeActiveChannelMaskView guildHomeActiveChannelMaskView, @NonNull GuildHomeActiveChannelMicAvatarView guildHomeActiveChannelMicAvatarView, @NonNull GuildHomeActiveChannelMicAvatarView guildHomeActiveChannelMicAvatarView2, @NonNull GuildHomeActiveChannelMicAvatarView guildHomeActiveChannelMicAvatarView3, @NonNull GuildHomeActiveChannelMicAvatarView guildHomeActiveChannelMicAvatarView4, @NonNull LottieAnimationView lottieAnimationView, @NonNull LinearLayout linearLayout, @NonNull ImageView imageView2, @NonNull TextView textView, @NonNull LinearLayout linearLayout2, @NonNull TextView textView2) {
        this.f442394a = radiusFrameLayout;
        this.f442395b = imageView;
        this.f442396c = guildHomeActiveChannelMaskView;
        this.f442397d = guildHomeActiveChannelMicAvatarView;
        this.f442398e = guildHomeActiveChannelMicAvatarView2;
        this.f442399f = guildHomeActiveChannelMicAvatarView3;
        this.f442400g = guildHomeActiveChannelMicAvatarView4;
        this.f442401h = lottieAnimationView;
        this.f442402i = linearLayout;
        this.f442403j = imageView2;
        this.f442404k = textView;
        this.f442405l = linearLayout2;
        this.f442406m = textView2;
    }
    ...
    @NonNull
    public static bb g(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.etf, viewGroup, false);
        if (z16) {
