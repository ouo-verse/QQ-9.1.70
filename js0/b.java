...
public final class b extends com.tencent.aio.base.mvvm.a<e, GuildAioDefaultInputUIState> {
    ...
    private final void e1() {
        ...
        guildGuestBottomLayout.setJoinButtonClickListener(new View.OnClickListener() { // from class: js0.a
        ...
        iGuildDTReportApi.setElementExposureAndClickParams(guildGuestBottomLayout2.a(), "em_stream_aio_tourist", null);
    }
    ...
    public static final void f1(b this$0, View view) {
        ...
        QLog.i("GuildLiveAioInputGuestVB", 1, "addBtn onClicked");
    ...
    private final void g1(int permissions, boolean isJuBao) {
        ...
        boolean O = GuildSpeakLimitStatus.INSTANCE.O(permissions);
