...
/* compiled from: P */
@Metadata(d1 = {"\u0000.\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0006\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b\u0010\u0010\u0011J\u0006\u0010\u0003\u001a\u00020\u0002J$\u0010\u000b\u001a\u00020\n2\b\u0010\u0005\u001a\u0004\u0018\u00010\u00042\b\u0010\u0007\u001a\u0004\u0018\u00010\u00062\u0006\u0010\t\u001a\u00020\bH\u0016R\u0016\u0010\u000f\u001a\u00020\f8\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\r\u0010\u000e\u00a8\u0006\u0012"}, d2 = {"Ljs3/a;", "Lcom/tencent/mobileqq/qipc/QIPCModule;", "", "registerModule", "", "action", "Landroid/os/Bundle;", "params", "", "callbackId", "Leipc/EIPCResult;", "onCall", "", "e", "Z", "sInRegister", "<init>", "()V", "minibox-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes22.dex */
public final class a extends QIPCModule {

    /* renamed from: d, reason: collision with root package name */
    @NotNull
    public static final a f410940d = new a();

    /* renamed from: e, reason: collision with root package name and from kotlin metadata */
    private static boolean sInRegister;

    a() {
        super("minibox_qipc_module");
    }

    @Override // eipc.EIPCModule
    @NotNull
    public EIPCResult onCall(@Nullable String action, @Nullable Bundle params, int callbackId) {
        QLog.d("MiniBoxIPCModule", 4, "MiniBoxIPCModule,onCall action:" + action);
        if (action != null && params != null && ((IMiniGameVAManager) QRoute.api(IMiniGameVAManager.class)).startMiniAIO(action, params)) {
        ...
        MiniBoxHostEventProcessor.o(action, params, callbackId, this);
    ...
    public final void registerModule() {
        ...
        try {
            ...
            QLog.e("MiniBoxIPCModule", 1, "registerModule failed, e=", e16);
        }
    }
}
