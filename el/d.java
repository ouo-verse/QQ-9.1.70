...
import com.qzone.reborn.message.section.ah;
...
public final class d extends f<CommonNoticeBean> {
    ...
    public boolean isForViewType(CommonNoticeBean item, List<CommonNoticeBean> items, int position) {
        ...
        Object obj = item.getNotice().getCom.tencent.gamecenter.wadl.biz.entity.WadlProxyConsts.EXTRA_DATA java.lang.String();
        if (!(obj instanceof BusinessFeedData)) {
            obj = null;
        }
        return fVar.c((BusinessFeedData) obj);
    }
