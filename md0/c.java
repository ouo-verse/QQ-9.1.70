...
public class c {
    private void A(int i3, int[] iArr, double[] dArr) {
        int i16 = 0;
        iArr[0] = i3;
        iArr[1] = 1;
        if (i3 > 2) {
    ...
    private void C(int i3, double[] dArr, int i16, double[] dArr2, int i17) {
        int i18 = i3 >> 1;
        int i19 = (i16 * 2) / i18;
        int i26 = 0;
    ...
    private void D(int i3, double[] dArr, int i16, double[] dArr2, int i17) {
        int i18 = i3 >> 1;
        int i19 = (i16 * 2) / i18;
        int i26 = 0;
        for (int i27 = 2; i27 < i18; i27 += 2) {
    ...
    private final void a(int i3, int[] iArr, int i16, double[] dArr) {
        int i17;
        iArr[i16 + 0] = 0;
        int i18 = i3;
        int i19 = 1;
    ...
    private final void f(int i3, int[] iArr, int i16, double[] dArr) {
        int i17;
        int i18 = 0;
        iArr[i16 + 0] = 0;
        int i19 = i3;
    ...
    private final void h(int i3, double[] dArr, double[] dArr2, int i16) {
        int i17 = i3 >> 3;
        int i18 = i17 * 2;
        int i19 = i18 + i18;
        int i26 = i19 + i18;
    ...
    private void i(int i3, double[] dArr, int[] iArr, int i16, int i17, double[] dArr2) {
        if (i3 > 32) {
            int i18 = i3 >> 2;
            h(i3, dArr, dArr2, i17 - i18);
            if (i3 > 512) {
                w(i18, dArr, 0, i17, dArr2);
                x(i18, dArr, i18, i17, dArr2);
                w(i18, dArr, i18 * 2, i17, dArr2);
                w(i18, dArr, i18 * 3, i17, dArr2);
            } else if (i18 > 32) {
                j(i3, dArr, 0, i17, dArr2);
            } else {
                s(i3, dArr, 0, i17, dArr2);
            }
            f(i3, iArr, i16, dArr);
            return;
        }
    ...
    private void j(int i3, double[] dArr, int i16, int i17, double[] dArr2) {
        int i18 = i3 >> 2;
        while (i18 > 128) {
            for (int i19 = i18; i19 < i3; i19 <<= 2) {
                for (int i26 = i19 - i18; i26 < i3; i26 += i19 * 4) {
                    int i27 = i17 - (i18 >> 1);
                    int i28 = i18;
                    u(i28, dArr, i16 + i26, dArr2, i27);
                    v(i28, dArr, i16 + i19 + i26, dArr2, i17 - i18);
                    u(i28, dArr, i16 + (i19 * 2) + i26, dArr2, i27);
                }
            }
            u(i18, dArr, (i16 + i3) - i18, dArr2, i17 - (i18 >> 1));
            i18 >>= 2;
        }
        for (int i29 = i18; i29 < i3; i29 <<= 2) {
            for (int i36 = i29 - i18; i36 < i3; i36 += i29 * 4) {
                int i37 = i16 + i36;
                int i38 = i17 - (i18 >> 1);
                u(i18, dArr, i37, dArr2, i38);
                s(i18, dArr, i37, i17, dArr2);
                int i39 = i16 + i29 + i36;
                v(i18, dArr, i39, dArr2, i17 - i18);
                t(i18, dArr, i39, i17, dArr2);
                int i46 = i16 + (i29 * 2) + i36;
                u(i18, dArr, i46, dArr2, i38);
                s(i18, dArr, i46, i17, dArr2);
            }
        }
        int i47 = (i16 + i3) - i18;
        u(i18, dArr, i47, dArr2, i17 - (i18 >> 1));
        s(i18, dArr, i47, i17, dArr2);
    }

    private void k(int i3, double[] dArr, int i16, int i17, double[] dArr2) {
        int i18 = i3 >> 1;
        int i19 = i3 >> 2;
        while (i19 > 128) {
            for (int i26 = i19; i26 < i18; i26 <<= 2) {
                for (int i27 = i26 - i19; i27 < i18; i27 += i26 * 2) {
                    int i28 = i17 - (i19 >> 1);
                    int i29 = i19;
                    u(i29, dArr, i16 + i27, dArr2, i28);
                    u(i29, dArr, i16 + i18 + i27, dArr2, i28);
                }
                for (int i36 = (i26 * 2) - i19; i36 < i18; i36 += i26 * 4) {
                    int i37 = i17 - i19;
                    int i38 = i19;
                    v(i38, dArr, i16 + i36, dArr2, i37);
                    v(i38, dArr, i16 + i18 + i36, dArr2, i37);
                }
            }
            i19 >>= 2;
        }
        for (int i39 = i19; i39 < i18; i39 <<= 2) {
            for (int i46 = i39 - i19; i46 < i18; i46 += i39 * 2) {
                ...
                int i48 = i17 - (i19 >> 1);
                int i49 = i19;
                u(i49, dArr, i47, dArr2, i48);
                int i56 = i19;
                s(i56, dArr, i47, i17, dArr2);
                int i57 = i16 + i18 + i46;
                u(i49, dArr, i57, dArr2, i48);
                s(i56, dArr, i57, i17, dArr2);
            }
            for (int i58 = (i39 * 2) - i19; i58 < i18; i58 += i39 * 4) {
                int i59 = i16 + i58;
                int i65 = i17 - i19;
                int i66 = i19;
                v(i66, dArr, i59, dArr2, i65);
                int i67 = i19;
                t(i67, dArr, i59, i17, dArr2);
                int i68 = i16 + i18 + i58;
                v(i66, dArr, i68, dArr2, i65);
                t(i67, dArr, i68, i17, dArr2);
            }
        }
    }
    ...
    private void m(double[] dArr, int i3, double[] dArr2, int i16) {
    ...
    private void n(double[] dArr, int i3, double[] dArr2, int i16) {
        double d16 = dArr2[i16 + 1];
    ...
    private void o(double[] dArr, int i3, double[] dArr2, int i16) {
        double d16 = dArr2[i16 + 1];
    ...
    private void p(double[] dArr, int i3, double[] dArr2, int i16) {
        double d16 = dArr2[i16 + 1];
        double d17 = dArr2[i16 + 4];
        double d18 = dArr2[i16 + 5];
    ...
    private void q(int i3, double[] dArr, double[] dArr2, int i16) {
        int i17 = i3 >> 3;
        int i18 = i17 * 2;
        int i19 = i18 + i18;
        int i26 = i19 + i18;
    ...
    private void r(int i3, double[] dArr, int[] iArr, int i16, int i17, double[] dArr2) {
        if (i3 > 32) {
            int i18 = i3 >> 2;
            q(i3, dArr, dArr2, i17 - i18);
            if (i3 > 512) {
                w(i18, dArr, 0, i17, dArr2);
                x(i18, dArr, i18, i17, dArr2);
                w(i18, dArr, i18 * 2, i17, dArr2);
    ...
    private void s(int i3, double[] dArr, int i16, int i17, double[] dArr2) {
        if (i3 == 128) {
            int i18 = i17 - 8;
            o(dArr, i16, dArr2, i18);
            p(dArr, i16 + 32, dArr2, i17 - 32);
            o(dArr, i16 + 64, dArr2, i18);
            o(dArr, i16 + 96, dArr2, i18);
            return;
        }
        int i19 = i17 - 16;
        m(dArr, i16, dArr2, i19);
        n(dArr, i16 + 16, dArr2, i19);
        m(dArr, i16 + 32, dArr2, i19);
        m(dArr, i16 + 48, dArr2, i19);
    }

    private void t(int i3, double[] dArr, int i16, int i17, double[] dArr2) {
        if (i3 == 128) {
            int i18 = i17 - 8;
            o(dArr, i16, dArr2, i18);
            int i19 = i17 - 32;
            p(dArr, i16 + 32, dArr2, i19);
            o(dArr, i16 + 64, dArr2, i18);
            p(dArr, i16 + 96, dArr2, i19);
            return;
        }
        int i26 = i17 - 16;
        m(dArr, i16, dArr2, i26);
        n(dArr, i16 + 16, dArr2, i26);
        m(dArr, i16 + 32, dArr2, i26);
        n(dArr, i16 + 48, dArr2, i26);
    }

    private final void u(int i3, double[] dArr, int i16, double[] dArr2, int i17) {
        int i18 = i3 >> 3;
        int i19 = i18 * 2;
        int i26 = i19 + i19;
        int i27 = i26 + i19;
    ...
    private final void v(int i3, double[] dArr, int i16, double[] dArr2, int i17) {
        int i18 = i3 >> 3;
        int i19 = i18 * 2;
    ...
    private void w(int i3, double[] dArr, int i16, int i17, double[] dArr2) {
        int i18 = i3 >> 2;
        int i19 = i18 * 2;
        u(i3, dArr, i16, dArr2, i17 - i19);
        if (i3 > 512) {
            w(i18, dArr, i16, i17, dArr2);
            x(i18, dArr, i16 + i18, i17, dArr2);
            w(i18, dArr, i16 + i19, i17, dArr2);
            w(i18, dArr, i16 + (i18 * 3), i17, dArr2);
            return;
        }
        j(i3, dArr, i16, i17, dArr2);
    }

    private void x(int i3, double[] dArr, int i16, int i17, double[] dArr2) {
        int i18 = i3 >> 2;
        v(i3, dArr, i16, dArr2, i17 - i3);
        if (i3 > 512) {
            w(i18, dArr, i16, i17, dArr2);
            x(i18, dArr, i16 + i18, i17, dArr2);
            w(i18, dArr, i16 + (i18 * 2), i17, dArr2);
            x(i18, dArr, i16 + (i18 * 3), i17, dArr2);
            return;
        }
        k(i3, dArr, i16, i17, dArr2);
    }
    ...
    private void z(int i3, int[] iArr, double[] dArr, int i16) {
        iArr[1] = i3;
        if (i3 > 1) {
            int i17 = i3 >> 1;
            double d16 = i17;
    ...
    public void B(int i3, int i16, double[] dArr, int[] iArr, double[] dArr2) {
        int i17 = iArr[0];
        if (i3 > (i17 << 2)) {
            i17 = i3 >> 2;
            A(i17, iArr, dArr2);
        ...
        if (i3 > (i19 << 2)) {
            i19 = i3 >> 2;
            z(i19, iArr, dArr2, i18);
        }
        int i26 = i19;
        if (i16 >= 0) {
            if (i3 > 4) {
                r(i3, dArr, iArr, 2, i18, dArr2);
                D(i3, dArr, i26, dArr2, i18);
            } else if (i3 == 4) {
                r(i3, dArr, iArr, 2, i18, dArr2);
            }
            double d16 = dArr[0];
        ...
        dArr[0] = d18 - d19;
        if (i3 > 4) {
            C(i3, dArr, i26, dArr2, i18);
            i(i3, dArr, iArr, 2, i18, dArr2);
        } else if (i3 == 4) {
            i(i3, dArr, iArr, 2, i18, dArr2);
        }
    }
