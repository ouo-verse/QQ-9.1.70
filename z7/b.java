...
public class b extends NTPublishImage {
    ...
    public static final void e(BatchUploadTask task, b this$0) {
    ...
    public void updateFileAfterUpload(final BatchUploadTask task) {
        ...
        if (task.fileInfo.fileType.getKlass() == FileClass.KFILECLASSPICTURE.ordinal()) {
            RFWThreadManager.getInstance().execOnAsyncDisplayThread(new Runnable() { // from class: z7.a
                @Override // java.lang.Runnable
                public final void run() {
                    b.e(BatchUploadTask.this, this);
                }
            });
        }
    }
    ...
    public byte[] genBizExtInfo() {
        ...
        QZPicCommentNTPublishModel qZPicCommentNTPublishModel = model instanceof QZPicCommentNTPublishModel ? (QZPicCommentNTPublishModel) model : null;
        if (qZPicCommentNTPublishModel == null) {
            return new byte[0];
        }
        ...
        storageNTSdkExtInfo$PhotoApplyUploadReqExtInfo.batch_id.set(qZPicCommentNTPublishModel.getBatchID());
        storageNTSdkExtInfo$PhotoApplyUploadReqExtInfo.album_type_id.set(qZPicCommentNTPublishModel.getAlbumTypeID());
        storageNTSdkExtInfo$PhotoApplyUploadReqExtInfo.batch_upload_time.set(qZPicCommentNTPublishModel.getUploadTime());
        storageNTSdkExtInfo$PhotoApplyUploadReqExtInfo.batch_upload_num.set(qZPicCommentNTPublishModel.getFileList().size());
    ...
    public String getLogTag() {
        return "QZPicCommentNTPublishImage";
    }
}
