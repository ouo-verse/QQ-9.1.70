...
/* compiled from: P */
@Metadata(d1 = {"\u0000F\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0003\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0006\b\u00c6\u0002\u0018\u00002\u00020\u0001B\t\b\u0002\u00a2\u0006\u0004\b!\u0010\"J\u001a\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0003\u001a\u00020\u00022\b\u0010\u0004\u001a\u0004\u0018\u00010\u0002H\u0002J\u0016\u0010\n\u001a\u00020\t2\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\u00070\u0006H\u0002J\u0010\u0010\f\u001a\u00020\t2\u0006\u0010\u000b\u001a\u00020\u0007H\u0002J\u001a\u0010\u0011\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u000e\u001a\u00020\r2\u0006\u0010\u0010\u001a\u00020\u000fH\u0002J\u001a\u0010\u0013\u001a\u0004\u0018\u00010\u00022\u0006\u0010\u0012\u001a\u00020\r2\u0006\u0010\u0010\u001a\u00020\u000fH\u0002J\u000e\u0010\u0014\u001a\u00020\t2\u0006\u0010\u0003\u001a\u00020\u0002J\u0014\u0010\u0016\u001a\u00020\t2\f\u0010\u0015\u001a\b\u0012\u0004\u0012\u00020\u00020\u0006J\u001c\u0010\u001b\u001a\u00020\t2\u0006\u0010\u0018\u001a\u00020\u00172\f\u0010\u001a\u001a\b\u0012\u0004\u0012\u00020\u00070\u0019J\u000e\u0010\u001c\u001a\u00020\u00072\u0006\u0010\u0003\u001a\u00020\u0002R\u0014\u0010 \u001a\u00020\u001d8\u0002X\u0082D\u00a2\u0006\u0006\n\u0004\b\u001e\u0010\u001f\u00a8\u0006#"}, d2 = {"Lio4/k;", "", "Lcom/tencent/timi/game/userinfo/impl/db/UserInfoEntity;", "entity", "dbEntity", "y", "", "Lcom/tencent/timi/game/userinfo/api/IUserInfo;", "infoList", "", "p", "info", DomainData.DOMAIN_NAME, "", "uid", "Lcom/tencent/timi/game/databasecore/impl/YesDataBaseHelper;", "yesDataBaseHelper", HippyTKDListViewAdapter.X, "qqUin", "r", "j", "entityList", "l", "Ltrpc/yes/common/CommonOuterClass$QQUserId;", "qqUserId", "Lcom/tencent/timi/game/utils/IResultListener;", "listener", ReportConstant.COSTREPORT_PREFIX, "i", "", "b", "Ljava/lang/String;", "TAG", "<init>", "()V", "timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes26.dex */
public final class k {

    /* renamed from: a, reason: collision with root package name */
    @NotNull
    public static final k f408119a = new k();
    ...
    public static final void k(UserInfoEntity entity) {
        ...
        kVar.n(i3);
        eo4.a.INSTANCE.a().e(Long.valueOf(i3.b()), i3);
    }
    ...
    public static final void m(List entityList) {
        ...
        f408119a.p(arrayList);
    }

    private final void n(final IUserInfo info) {
        ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: io4.h
    ...
    public static final void o(IUserInfo info) {
        ...
        eo4.b.INSTANCE.a().d(info);
    }

    private final void p(final List<? extends IUserInfo> infoList) {
        ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: io4.j
            @Override // java.lang.Runnable
            public final void run() {
                k.q(infoList);
            }
    ...
    public static final void q(List infoList) {
        ...
        while (it.hasNext()) {
            eo4.b.INSTANCE.a().d((IUserInfo) it.next());
        }
    }
    ...
    private final UserInfoEntity r(long qqUin, YesDataBaseHelper yesDataBaseHelper) {
        ...
        List<? extends Entity> k3 = yesDataBaseHelper.k(UserInfoEntity.class, false, "qqUin=?", new String[]{String.valueOf(qqUin)}, null, null, "uid desc", null);
        ...
        com.tencent.timi.game.utils.l.e(TAG, "queryUserByUinSync not find ");
        return null;
    }
    ...
    public static final void u(long j3, long j16, final IResultListener listener) {
        ...
        if (x16 != null) {
            ...
            eo4.a.INSTANCE.a().d(Long.valueOf(j3), i3);
            ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: io4.e
                @Override // java.lang.Runnable
                public final void run() {
        ...
        ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: io4.f
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private final UserInfoEntity x(long uid, YesDataBaseHelper yesDataBaseHelper) {
        ...
        List<? extends Entity> k3 = yesDataBaseHelper.k(UserInfoEntity.class, false, "uid=?", new String[]{String.valueOf(uid)}, null, null, null, null);
        if (k3 != null && k3.size() > 0) {
            Entity entity = k3.get(0);
            if (entity instanceof UserInfoEntity) {
                return (UserInfoEntity) entity;
        ...
        com.tencent.timi.game.utils.l.e(TAG, "queryUserInfoSync not find ");
        return null;
    }
    ...
    public final IUserInfo i(@NotNull UserInfoEntity entity) {
        Intrinsics.checkNotNullParameter(entity, "entity");
        return new do4.b(entity);
    }

    public final void j(@NotNull final UserInfoEntity entity) {
        Intrinsics.checkNotNullParameter(entity, "entity");
        ThreadManagerV2.excute(new Runnable() { // from class: io4.g
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final void l(@NotNull final List<? extends UserInfoEntity> entityList) {
        Intrinsics.checkNotNullParameter(entityList, "entityList");
        ThreadManagerV2.excute(new Runnable() { // from class: io4.i
            @Override // java.lang.Runnable
            public final void run() {
                k.m(entityList);
            }
    ...
    public final void s(@NotNull CommonOuterClass$QQUserId qqUserId, @NotNull final IResultListener<IUserInfo> listener) {
        ...
        if (j3 != 0) {
            g16 = eo4.a.INSTANCE.a().a(Long.valueOf(j3));
        } else {
            g16 = eo4.a.INSTANCE.a().g(j16);
        }
        if (g16 != null) {
            if (Intrinsics.areEqual(Looper.getMainLooper(), Looper.myLooper())) {
                ...
                ThreadManagerV2.getUIHandlerV2().post(new Runnable() { // from class: io4.c
                    @Override // java.lang.Runnable
                    public final void run() {
        ...
        ThreadManagerV2.excute(new Runnable() { // from class: io4.d
            @Override // java.lang.Runnable
            public final void run() {
                k.u(j3, j16, listener);
            }
