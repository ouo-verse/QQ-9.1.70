...
/* compiled from: P */
@Metadata(d1 = {"\u0000>\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010 \n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \u00162\b\u0012\u0004\u0012\u00020\u00020\u0001:\u0001\u0017B\u0007\u00a2\u0006\u0004\b\u0014\u0010\u0015J\u0018\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0004\u001a\u00020\u00032\u0006\u0010\u0005\u001a\u00020\u0002H\u0002J\u0010\u0010\u000b\u001a\u00020\n2\u0006\u0010\t\u001a\u00020\bH\u0002J\u000e\u0010\u000e\u001a\b\u0012\u0004\u0012\u00020\r0\fH\u0016J\b\u0010\u0010\u001a\u00020\u000fH\u0016J\u0018\u0010\u0013\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u00022\u0006\u0010\u0012\u001a\u00020\u0011H\u0016\u00a8\u0006\u0018"}, d2 = {"Lhi/d;", "Lcom/qzone/reborn/albumx/common/share/a;", "Lgi/a;", "Landroid/content/Context;", "context", "shareContext", "", "l", "Lcom/qzone/reborn/groupalbum/layer/bean/GroupAlbumLayerExtraInfoBean;", "bean", "", QCircleScheme.AttrQQPublish.INPUT_TAB_MAGIC_STUDIO, "", "", "c", "Lcom/qzone/reborn/albumx/common/share/QQShareActionManager$ShareLine;", "b", "Lcom/tencent/mobileqq/utils/ShareActionSheetBuilder$ActionSheetItem;", PublicAccountMessageUtilImpl.ITEM_STRUCT_FIRST_LEVEL_NAME, "k", "<init>", "()V", "e", "a", "qzone_df_impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes38.dex */
public final class d extends com.qzone.reborn.albumx.common.share.a<gi.a> {
    private final void l(Context context, gi.a shareContext) {
        ...
        GroupAlbumLayerExtraInfoBean groupAlbumLayerExtraInfoBean2 = groupAlbumLayerExtraInfoBean;
        if (groupAlbumLayerExtraInfoBean2 == null) {
        ...
        g16.n(groupAlbumLayerExtraInfoBean2.getUploadUid());
        String uploadUid = groupAlbumLayerExtraInfoBean2.getUploadUid();
        ...
        try {
            if (!TextUtils.isEmpty(groupAlbumLayerExtraInfoBean2.getAlbumId())) {
                String albumId = groupAlbumLayerExtraInfoBean2.getAlbumId();
                replace$default2 = StringsKt__StringsJVMKt.replace$default(replace$default2, "{pid}", albumId == null ? "" : albumId, false, 4, (Object) null);
            }
            if (!TextUtils.isEmpty(groupAlbumLayerExtraInfoBean2.getSLoc())) {
                String sLoc = groupAlbumLayerExtraInfoBean2.getSLoc();
                str = StringsKt__StringsJVMKt.replace$default(replace$default2, "{cid}", sLoc == null ? "" : sLoc, false, 4, (Object) null);
            } else {
                String lLoc = groupAlbumLayerExtraInfoBean2.getLLoc();
        ...
        g16.v(str);
        g16.i("100673");
        g16.m(str + m(groupAlbumLayerExtraInfoBean2));
        g16.r(groupAlbumLayerExtraInfoBean2.getGroupId());
        com.qzone.feed.utils.f.INSTANCE.a(context, g16);
    }

    private final String m(GroupAlbumLayerExtraInfoBean bean) {
        String replace$default;
        ...
        replace$default = StringsKt__StringsJVMKt.replace$default(str2, "{qunid}", groupId, false, 4, (Object) null);
