...
public final class ErrorPropertyDescriptor implements PropertyDescriptor {
    ...
    public <R, D> R accept(DeclarationDescriptorVisitor<R, D> declarationDescriptorVisitor, D d16) {
        return (R) this.$$delegate_0.accept(declarationDescriptorVisitor, d16);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.CallableMemberDescriptor
    @NotNull
    public CallableMemberDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, DescriptorVisibility descriptorVisibility, CallableMemberDescriptor.Kind kind, boolean z16) {
        return this.$$delegate_0.copy(declarationDescriptor, modality, descriptorVisibility, kind, z16);
    }
    ...
    public ConstantValue<?> mo1775getCompileTimeInitializer() {
        return this.$$delegate_0.mo1775getCompileTimeInitializer();
    }
