...
public final class FilteredAnnotations implements Annotations {
    ...
    public FilteredAnnotations(@NotNull Annotations delegate, boolean z16, @NotNull Function1<? super FqName, Boolean> fqNameFilter) {
        Intrinsics.checkNotNullParameter(delegate, "delegate");
        Intrinsics.checkNotNullParameter(fqNameFilter, "fqNameFilter");
        this.delegate = delegate;
        this.isDefinitelyNewInference = z16;
    ...
    public AnnotationDescriptor mo1774findAnnotation(@NotNull FqName fqName) {
        ...
        if (this.fqNameFilter.invoke(fqName).booleanValue()) {
            return this.delegate.mo1774findAnnotation(fqName);
        }
        return null;
    }
