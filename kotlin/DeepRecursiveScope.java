...
public abstract class DeepRecursiveScope<T, R> {
    ...
    @Nullable
    public abstract Object callRecursive(T t16, @NotNull Continuation<? super R> continuation);

    @Nullable
    public abstract <U, S> Object callRecursive(@NotNull DeepRecursiveFunction<U, S> deepRecursiveFunction, U u16, @NotNull Continuation<? super S> continuation);
