...
public interface ContinuationInterceptor extends CoroutineContext.Element {
    ...
    public static final class DefaultImpls {
        public static <R> R fold(@NotNull ContinuationInterceptor continuationInterceptor, R r16, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> operation) {
            Intrinsics.checkNotNullParameter(operation, "operation");
            return (R) CoroutineContext.Element.DefaultImpls.fold(continuationInterceptor, r16, operation);
        }
        ...
        public static <E extends CoroutineContext.Element> E get(@NotNull ContinuationInterceptor continuationInterceptor, @NotNull CoroutineContext.Key<E> key) {
            ...
            if (key instanceof AbstractCoroutineContextKey) {
                ...
                E e16 = (E) abstractCoroutineContextKey.tryCast$kotlin_stdlib(continuationInterceptor);
