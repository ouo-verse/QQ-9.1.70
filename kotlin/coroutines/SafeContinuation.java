...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public final Object getOrThrow() {
        ...
        if (obj == coroutineSingletons) {
            ...
            if (b.a(atomicReferenceFieldUpdater, this, coroutineSingletons, coroutine_suspended2)) {
        ...
        while (true) {
            ...
            if (obj != coroutineSingletons) {
                ...
                if (obj == coroutine_suspended) {
                    AtomicReferenceFieldUpdater<SafeContinuation<?>, Object> atomicReferenceFieldUpdater = RESULT;
                    coroutine_suspended2 = IntrinsicsKt__IntrinsicsKt.getCOROUTINE_SUSPENDED();
                    if (b.a(atomicReferenceFieldUpdater, this, coroutine_suspended2, CoroutineSingletons.RESUMED)) {
            ...
            } else if (b.a(RESULT, this, coroutineSingletons, result)) {
                return;
            }
        }
    }
