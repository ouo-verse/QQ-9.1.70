...
public abstract class AbstractMap<K, V> implements Map<K, V>, KMappedMarker {
    ...
    public static final class Companion {
        ...
        public final boolean entryEquals$kotlin_stdlib(@NotNull Map.Entry<?, ?> e16, @Nullable Object other) {
            Intrinsics.checkNotNullParameter(e16, "e");
            if (!(other instanceof Map.Entry)) {
                return false;
            }
            Map.Entry entry = (Map.Entry) other;
            if (!Intrinsics.areEqual(e16.getKey(), entry.getKey()) || !Intrinsics.areEqual(e16.getValue(), entry.getValue())) {
                return false;
            }
            return true;
        }

        public final int entryHashCode$kotlin_stdlib(@NotNull Map.Entry<?, ?> e16) {
            int i3;
            Intrinsics.checkNotNullParameter(e16, "e");
        ...
        @NotNull
        public final String entryToString$kotlin_stdlib(@NotNull Map.Entry<?, ?> e16) {
            Intrinsics.checkNotNullParameter(e16, "e");
            StringBuilder sb5 = new StringBuilder();
            sb5.append(e16.getKey());
            sb5.append('=');
            sb5.append(e16.getValue());
            return sb5.toString();
        }
    ...
    private final String toString(Object o16) {
        return o16 == this ? "(this Map)" : String.valueOf(o16);
    }
}
