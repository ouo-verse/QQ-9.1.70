...
public class MapsKt__MapsKt extends MapsKt__MapsJVMKt {
    ...
    public static final <K, V> V getOrElseNullable(@NotNull Map<K, ? extends V> map, K k3, @NotNull Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = map.get(k3);
    ...
    public static final <K, V> V getOrPut(@NotNull Map<K, V> map, K k3, @NotNull Function0<? extends V> defaultValue) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(defaultValue, "defaultValue");
        V v3 = map.get(k3);
        if (v3 == null) {
    ...
    public static <K, V> V getValue(@NotNull Map<K, ? extends V> map, K k3) {
        Object orImplicitDefaultNullable;
        Intrinsics.checkNotNullParameter(map, "<this>");
        orImplicitDefaultNullable = MapsKt__MapWithDefaultKt.getOrImplicitDefaultNullable(map, k3);
        return (V) orImplicitDefaultNullable;
    }
    ...
    @SinceKotlin(version = "1.1")
    @NotNull
    public static final <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, K k3) {
        Map mutableMap;
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @InlineOnly
    private static final <K, V> void set(Map<K, V> map, K k3, V v3) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        map.put(k3, v3);
    }
    ...
    private static final <K, V> Map<K, V> buildMap(int i3, @BuilderInference Function1<? super Map<K, V>, Unit> builderAction) {
        ...
        Map<K, V> build;
        Intrinsics.checkNotNullParameter(builderAction, "builderAction");
        createMapBuilder = MapsKt__MapsJVMKt.createMapBuilder(i3);
        builderAction.invoke(createMapBuilder);
        build = MapsKt__MapsJVMKt.build(createMapBuilder);
        return build;
    }
    ...
    @SinceKotlin(version = "1.1")
    @NotNull
    public static <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull Iterable<? extends K> keys) {
        Map mutableMap;
        Intrinsics.checkNotNullParameter(map, "<this>");
    ...
    @SinceKotlin(version = "1.1")
    @NotNull
    public static <K, V> Map<K, V> minus(@NotNull Map<? extends K, ? extends V> map, @NotNull K[] keys) {
        Map mutableMap;
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(keys, "keys");
        mutableMap = toMutableMap(map);
    ...
    @SinceKotlin(version = "1.1")
    @NotNull
    public static <K, V, M extends Map<? super K, ? super V>> M toMap(@NotNull Map<? extends K, ? extends V> map, @NotNull M destination) {
        Intrinsics.checkNotNullParameter(map, "<this>");
        Intrinsics.checkNotNullParameter(destination, "destination");
