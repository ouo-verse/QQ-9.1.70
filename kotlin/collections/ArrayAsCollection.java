...
public final class ArrayAsCollection<T> implements Collection<T>, KMappedMarker {
    ...
    public ArrayAsCollection(@NotNull T[] values, boolean z16) {
    ...
    public boolean contains(Object element) {
        boolean contains;
        contains = ArraysKt___ArraysKt.contains(this.values, element);
        return contains;
    }
