...
public final class GeneratorSequence$iterator$1<T> implements Iterator<T>, KMappedMarker {
    ...
    public T next() {
        ...
        if (this.nextState != 0) {
            T t16 = this.nextItem;
            Intrinsics.checkNotNull(t16, "null cannot be cast to non-null type T of kotlin.sequences.GeneratorSequence");
            this.nextState = -1;
            return t16;
        }
    ...
    public final void setNextItem(@Nullable T t16) {
        this.nextItem = t16;
    }
