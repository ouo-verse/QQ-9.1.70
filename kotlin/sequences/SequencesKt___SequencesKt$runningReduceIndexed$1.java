...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\u0010\u0004\u001a\u00020\u0003\"\u0004\b\u0000\u0010\u0000\"\b\b\u0001\u0010\u0001*\u00028\u0000*\b\u0012\u0004\u0012\u00028\u00000\u0002H\u008a@"}, d2 = {ExifInterface.LATITUDE_SOUTH, "T", "Lkotlin/sequences/SequenceScope;", "", "<anonymous>"}, k = 3, mv = {1, 7, 1})
            ...
            if (i3 != 1) {
                if (i3 == 2) {
                    ...
                    while (it.hasNext()) {
                        ...
                        Object invoke = function3.invoke(Boxing.boxInt(i16), next, it.next());
                        ...
                        sequencesKt___SequencesKt$runningReduceIndexed$1.I$0 = i18;
