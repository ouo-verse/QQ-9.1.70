...
public final class DurationJvmKt {
    ...
    @NotNull
    public static final String formatToExactDecimals(double d16, int i3) {
        ...
        String format = createFormatForDecimals.format(d16);
        Intrinsics.checkNotNullExpressionValue(format, "format.format(value)");
        return format;
    }

    @NotNull
    public static final String formatUpToDecimals(double d16, int i3) {
        DecimalFormat createFormatForDecimals = createFormatForDecimals(0);
        createFormatForDecimals.setMaximumFractionDigits(i3);
        String format = createFormatForDecimals.format(d16);
