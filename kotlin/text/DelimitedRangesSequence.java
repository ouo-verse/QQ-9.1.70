...
public final class DelimitedRangesSequence implements Sequence<IntRange> {
    ...
    public DelimitedRangesSequence(@NotNull CharSequence input, int i3, int i16, @NotNull Function2<? super CharSequence, ? super Integer, Pair<Integer, Integer>> getNextMatch) {
