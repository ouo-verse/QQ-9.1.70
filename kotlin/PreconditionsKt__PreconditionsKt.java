...
class PreconditionsKt__PreconditionsKt extends PreconditionsKt__AssertionsJVMKt {
    @InlineOnly
    private static final void check(boolean z16) {
        if (!z16) {
    ...
    @InlineOnly
    private static final <T> T checkNotNull(T t16) {
        if (t16 != null) {
            return t16;
        }
    ...
    @InlineOnly
    private static final void require(boolean z16) {
        if (!z16) {
    ...
    @InlineOnly
    private static final <T> T requireNotNull(T t16) {
        if (t16 != null) {
            return t16;
        }
    ...
    @InlineOnly
    private static final void check(boolean z16, Function0<? extends Object> lazyMessage) {
    ...
    @InlineOnly
    private static final <T> T checkNotNull(T t16, Function0<? extends Object> lazyMessage) {
        Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (t16 != null) {
            return t16;
        }
    ...
    @InlineOnly
    private static final void require(boolean z16, Function0<? extends Object> lazyMessage) {
        Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (!z16) {
    ...
    @InlineOnly
    private static final <T> T requireNotNull(T t16, Function0<? extends Object> lazyMessage) {
        Intrinsics.checkNotNullParameter(lazyMessage, "lazyMessage");
        if (t16 != null) {
            return t16;
        }
