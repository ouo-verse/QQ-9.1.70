...
final class OpenEndDoubleRange implements OpenEndRange<Double> {
    ...
    public OpenEndDoubleRange(double d16, double d17) {
        this._start = d16;
        this._endExclusive = d17;
    }

    private final boolean lessThanOrEquals(double a16, double b16) {
        if (a16 <= b16) {
            return true;
        }
        return false;
    ...
    public /* bridge */ /* synthetic */ boolean contains(Double d16) {
        return contains(d16.doubleValue());
    }
