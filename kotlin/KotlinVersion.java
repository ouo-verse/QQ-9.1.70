...
public final class KotlinVersion implements Comparable<KotlinVersion> {
    ...
    public KotlinVersion(int i3, int i16, int i17) {
        this.major = i3;
        this.minor = i16;
        this.patch = i17;
        this.version = versionOf(i3, i16, i17);
    }
    ...
    public final boolean isAtLeast(int major, int minor) {
        int i3 = this.major;
        return i3 > major || (i3 == major && this.minor >= minor);
    }
    ...
    public final boolean isAtLeast(int major, int minor, int patch) {
        int i3;
        int i16 = this.major;
        return i16 > major || (i16 == major && ((i3 = this.minor) > minor || (i3 == minor && this.patch >= patch)));
    }

    public KotlinVersion(int i3, int i16) {
        this(i3, i16, 0);
    }
}
