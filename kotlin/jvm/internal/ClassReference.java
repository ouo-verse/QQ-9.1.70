...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
        ...
        public final String getClassQualifiedName(@NotNull Class<?> jClass) {
            ...
            if (jClass.isArray()) {
                ...
                if (componentType.isPrimitive() && (str = (String) ClassReference.classFqNames.get(componentType.getName())) != null) {
                    str2 = str + Entry.DATA_TYPE_Array;
                }
                if (str2 == null) {
                    return "kotlin.Array";
                }
        ...
        */
        public final String getClassSimpleName(@NotNull Class<?> jClass) {
            ...
            if (jClass.isArray()) {
                ...
                str = Entry.DATA_TYPE_Array;
                if (isPrimitive && (str2 = (String) ClassReference.simpleNames.get(componentType.getName())) != null) {
                    str3 = str2 + Entry.DATA_TYPE_Array;
                }
                if (str3 != null) {
                    return str3;
                }
    ...
    static {
        ...
        hashMap.put(HippyControllerProps.BOOLEAN, "kotlin.Boolean");
        hashMap.put(WinkDaTongReportConstant.ElementParamValue.XSJ_EDIT_STICKER_TYPE_CHAR, "kotlin.Char");
        hashMap.put("byte", "kotlin.Byte");
        hashMap.put(Geo2AddressParam.PoiOptions.ADDRESS_FORMAT_SHORT, "kotlin.Short");
        hashMap.put(PoiListCacheRecord.WEIGHT_TYPE, "kotlin.Int");
        hashMap.put("float", "kotlin.Float");
        hashMap.put(PoiListCacheRecord.TIMESTAMP_TYPE, "kotlin.Long");
        ...
        for (String kotlinName : values) {
            ...
            Pair pair = TuplesKt.to(sb5.toString(), kotlinName + ".Companion");
