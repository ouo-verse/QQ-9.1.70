...
public final class Cell extends JceStruct {
    ...
    public String toString() {
        return "Cell[cellId=" + this.iCellId + ",Lac=" + this.iLac + ",Mcc=" + ((int) this.shMcc) + ",Mnc=" + ((int) this.shMnc) + ",rssi=" + ((int) this.shRssi) + "]\n";
    }
    ...
    public Cell(short s16, short s17, int i3, int i16, short s18) {
        this.shMcc = s16;
        this.shMnc = s17;
        this.iLac = i3;
        this.iCellId = i16;
