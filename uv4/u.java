...
public final class u extends ExtendableMessageNano<u> {
    ...
    public u a() {
        ...
        this.f440448f = null;
        this.f440449g = 0;
        this.f440450h = WireFormatNano.EMPTY_INT_ARRAY;
        this.f440451i = null;
        this.f440452j = am.b();
        this.f440453k = bi.b();
        ...
        while (true) {
            ...
            switch (readTag) {
                ...
                case 10:
                    ...
                    this.f440443a = aqVarArr2;
                    break;
                case 18:
                    int repeatedFieldArrayLength2 = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 18);
                    ar[] arVarArr = this.f440444b;
                    ...
                    this.f440444b = arVarArr2;
                    break;
                case 26:
                    if (this.f440445c == null) {
                        this.f440445c = new ak();
                    }
                    codedInputByteBufferNano.readMessage(this.f440445c);
                    break;
                case 34:
                    int repeatedFieldArrayLength3 = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 34);
                    ap[] apVarArr = this.f440446d;
                    ...
                    this.f440446d = apVarArr2;
                    break;
                case 42:
                    if (this.f440447e == null) {
                        this.f440447e = new at();
                    }
                    codedInputByteBufferNano.readMessage(this.f440447e);
                    break;
                case 50:
                    if (this.f440448f == null) {
                        this.f440448f = new au();
                    }
                    codedInputByteBufferNano.readMessage(this.f440448f);
                    break;
                case 56:
                    this.f440449g = codedInputByteBufferNano.readInt32();
                    break;
                case 64:
                    int repeatedFieldArrayLength4 = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 64);
                    int[] iArr = this.f440450h;
                ...
                case 66:
                    ...
                    break;
                case 74:
                    if (this.f440451i == null) {
                        this.f440451i = new av();
                    }
                    codedInputByteBufferNano.readMessage(this.f440451i);
                    break;
                case 82:
                    int repeatedFieldArrayLength5 = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 82);
                    am[] amVarArr = this.f440452j;
    ...
    public int computeSerializedSize() {
        ...
        if (aqVarArr != null && aqVarArr.length > 0) {
            int i16 = 0;
            while (true) {
                aq[] aqVarArr2 = this.f440443a;
                if (i16 >= aqVarArr2.length) {
                    break;
                }
                aq aqVar = aqVarArr2[i16];
                if (aqVar != null) {
        ...
        if (biVarArr != null && biVarArr.length > 0) {
            while (true) {
                bi[] biVarArr2 = this.f440453k;
                if (i3 >= biVarArr2.length) {
                    break;
                }
                bi biVar = biVarArr2[i3];
                if (biVar != null) {
