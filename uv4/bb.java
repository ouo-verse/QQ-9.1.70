...
public final class bb extends ExtendableMessageNano<bb> {
    ...
    public bb mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 8) {
                this.f440310a = codedInputByteBufferNano.readUInt32();
            } else if (readTag == 16) {
                int repeatedFieldArrayLength = WireFormatNano.getRepeatedFieldArrayLength(codedInputByteBufferNano, 16);
                int[] iArr = this.f440311b;
    ...
    public bb a() {
        this.f440310a = 0;
        this.f440311b = WireFormatNano.EMPTY_INT_ARRAY;
