...
public final class b extends av {
    ...
    public ax a(BaseQQAppInterface app, Context context, String jump, JumpParserResult jumpParserResult) {
        ...
        aVar.f307438c = jump;
        aVar.f307439d = "vasvip";
        aVar.f307440e = "kuikly";
        return aVar;
    }
}
