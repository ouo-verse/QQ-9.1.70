...
public final class c extends ExtendableMessageNano<c> {
    ...
    public c a() {
        this.f392176a = WireFormatNano.EMPTY_LONG_ARRAY;
        this.f392177b = 0;
    ...
    public c mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 8) {
                ...
                this.f392177b = codedInputByteBufferNano.readUInt32();
            }
        }
    }
