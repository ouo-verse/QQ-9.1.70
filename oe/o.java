...
public final class o extends com.qzone.reborn.share.a {
    ...
    public void b(com.qzone.reborn.share.e shareContext, com.qzone.reborn.share.b item) {
        ...
        QLog.i("QzoneFeedProDetailShareSetDressAction", 2, "share clicked");
        if (shareContext.getCom.tencent.mobileqq.winkreport.datong.WinkPublishMediaRecord.WINK_REPORT_TYPE_ACTIVITY java.lang.String() == null) {
            QLog.e("QzoneFeedProDetailShareSetDressAction", 1, "doAction activity null");
        } else {
            vo.c.q(shareContext.getCom.tencent.mobileqq.winkreport.datong.WinkPublishMediaRecord.WINK_REPORT_TYPE_ACTIVITY java.lang.String(), "feedsdetails", LoginData.getInstance().getUin());
        }
    }
    ...
    public List<String> g() {
        ...
        arrayListOf = CollectionsKt__CollectionsKt.arrayListOf("set_decorations");
        return arrayListOf;
    }
    ...
    public boolean j(com.qzone.reborn.share.e shareContext) {
        ...
        ao aoVar = ao.f54312a;
        re.b r17 = r();
        return aoVar.d(r17 != null ? r17.S1() : null, 7);
    }
