...
public final class k extends ExtendableMessageNano<k> {
    ...
    public long f408787a;

    /* renamed from: b, reason: collision with root package name */
    public long f408788b;
    ...
    public k mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (readTag == 8) {
                this.f408787a = codedInputByteBufferNano.readUInt64();
            } else if (readTag != 16) {
                if (!storeUnknownField(codedInputByteBufferNano, readTag)) {
                    return this;
                }
            } else {
                this.f408788b = codedInputByteBufferNano.readUInt64();
            }
        }
    }
    ...
    public int computeSerializedSize() {
        ...
        long j3 = this.f408787a;
        if (j3 != 0) {
            computeSerializedSize += CodedOutputByteBufferNano.computeUInt64Size(1, j3);
        }
        long j16 = this.f408788b;
