...
/* compiled from: P */
@Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\u0018\u0000 \u000b2\u00020\u0001:\u0001\u000bB\u0007\u00a2\u0006\u0004\b\f\u0010\rJ.\u0010\u000b\u001a\u0004\u0018\u00010\n2\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u00042\u0006\u0010\u0007\u001a\u00020\u00062\u0006\u0010\t\u001a\u00020\bH\u0016\u00a8\u0006\u000e"}, d2 = {"Lin0/b;", "Lin0/d;", "Landroid/content/Intent;", "intent", "Landroid/os/Bundle;", "extra", "Landroidx/fragment/app/FragmentManager;", "fm", "", "containerId", "Lus/a;", "a", "<init>", "()V", "aio-guild_release"}, k = 1, mv = {1, 7, 1})
...
public final class b implements d {
    ...
    public us.a a(@Nullable Intent intent, @Nullable Bundle extra, @NotNull FragmentManager fm5, int containerId) {
        ...
        if (intent != null && extra != null) {
            String string = extra.getString("guild_article_guild_id");
            String string2 = extra.getString("guild_article_channel_id");
            if (string2 != null && string != null) {
                ...
                String name = hn0.a.class.getName();
                Intrinsics.checkNotNullExpressionValue(name, "GuildArticleAIOFactory::class.java.name");
            ...
            QLog.d("GuildArticleChatFragmentCreator", 1, "create aioContact error!");
            return null;
        }
        QLog.d("GuildArticleChatFragmentCreator", 1, "create args error!");
        return null;
    }
}
