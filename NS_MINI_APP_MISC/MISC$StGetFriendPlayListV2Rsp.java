...
public final class MISC$StGetFriendPlayListV2Rsp extends MessageMicro<MISC$StGetFriendPlayListV2Rsp> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{8, 16, 26, 34, 42, 48}, new String[]{"total", "finish", "appPlayingInfos", "moreJumpLink", "ext", "showOtherFriPlay"}, new Object[]{0, bool, null, "", null, bool}, MISC$StGetFriendPlayListV2Rsp.class);
    }
}
