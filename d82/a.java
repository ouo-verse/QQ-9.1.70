...
public final class a extends AbsItemAdapterDelegate<QQStrangerMsgMatchChatData, QQStrangerMsgMatchChatData> {
    ...
    public boolean isForViewType(QQStrangerMsgMatchChatData item, List<QQStrangerMsgMatchChatData> items, int position) {
    ...
    @Override // com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<QQStrangerMsgMatchChatData>>> sections) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        sections.add(com.tencent.mobileqq.matchfriend.reborn.content.msg.top.section.b.class);
    }
}
