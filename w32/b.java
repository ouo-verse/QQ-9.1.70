...
public class b {
    public static com.tencent.mobileqq.qqlive.report.tianjige.c a(String str, com.tencent.mobileqq.qqlive.report.tianjige.a aVar) {
        boolean isEnable;
        boolean a16;
        boolean b16;
        double c16;
        if (aVar != null) {
            try {
                ...
                QLog.e("ICGameOpenTelemetryConfigManager", 1, 1, e16.toString());
                return null;
            }
        } else {
            c16 = 0.0d;
