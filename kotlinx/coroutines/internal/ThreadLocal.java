...
public final class ThreadLocal<T> implements ThreadContextElement<T> {
    ...
    public ThreadLocal(T t16, @NotNull java.lang.ThreadLocal<T> threadLocal) {
        this.value = t16;
    ...
    public <R> R fold(R r16, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
        return (R) ThreadContextElement.DefaultImpls.fold(this, r16, function2);
    }
