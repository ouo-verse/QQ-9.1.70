...
public final class DispatchedTaskKt {
    ...
    public static final <T> void dispatch(@NotNull DispatchedTask<? super T> dispatchedTask, int i3) {
        boolean z16;
        ...
        if (!z16 && (delegate$kotlinx_coroutines_core instanceof DispatchedContinuation) && isCancellableMode(i3) == isCancellableMode(dispatchedTask.resumeMode)) {
            CoroutineDispatcher coroutineDispatcher = ((DispatchedContinuation) delegate$kotlinx_coroutines_core).dispatcher;
            CoroutineContext coroutineContext = delegate$kotlinx_coroutines_core.get$context();
            if (coroutineDispatcher.isDispatchNeeded(coroutineContext)) {
                coroutineDispatcher.mo2047dispatch(coroutineContext, dispatchedTask);
                return;
            } else {
        ...
        resume(dispatchedTask, delegate$kotlinx_coroutines_core, z16);
    }
    ...
    public static final <T> void resume(@NotNull DispatchedTask<? super T> dispatchedTask, @NotNull Continuation<? super T> continuation, boolean z16) {
        ...
        Object m476constructorimpl = Result.m476constructorimpl(successfulResult$kotlinx_coroutines_core);
        if (z16) {
            ...
            try {
                dispatchedContinuation.continuation.resumeWith(m476constructorimpl);
    ...
    public static final void resumeWithStackTrace(@NotNull Continuation<?> continuation, @NotNull Throwable th5) {
        Result.Companion companion = Result.INSTANCE;
    ...
    public static final void runUnconfinedEventLoop(@NotNull DispatchedTask<?> dispatchedTask, @NotNull EventLoop eventLoop, @NotNull Function0<Unit> function0) {
        ...
        try {
            ...
            try {
                dispatchedTask.handleFatalException(th5, null);
                InlineMarker.finallyStart(1);
            } catch (Throwable th6) {
                InlineMarker.finallyStart(1);
