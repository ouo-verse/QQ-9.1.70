...
public class ExperimentalCoroutineDispatcher extends ExecutorCoroutineDispatcher {
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i3, int i16, long j3, String str, int i17, DefaultConstructorMarker defaultConstructorMarker) {
        this(i3, i16, j3, (i17 & 8) != 0 ? "CoroutineScheduler" : str);
    }

    public static /* synthetic */ CoroutineDispatcher blocking$default(ExperimentalCoroutineDispatcher experimentalCoroutineDispatcher, int i3, int i16, Object obj) {
        if (obj == null) {
            if ((i16 & 1) != 0) {
                i3 = TasksKt.BLOCKING_DEFAULT_PARALLELISM;
            }
            return experimentalCoroutineDispatcher.blocking(i3);
        }
    ...
    public void mo2047dispatch(@NotNull CoroutineContext context, @NotNull Runnable block) {
        try {
            ...
            DefaultExecutor.INSTANCE.mo2047dispatch(context, block);
        }
    }
    ...
    public ExperimentalCoroutineDispatcher(int i3, int i16, long j3, @NotNull String str) {
    ...
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i3, int i16, String str, int i17, DefaultConstructorMarker defaultConstructorMarker) {
        this((i17 & 1) != 0 ? TasksKt.CORE_POOL_SIZE : i3, (i17 & 2) != 0 ? TasksKt.MAX_POOL_SIZE : i16, (i17 & 4) != 0 ? TasksKt.DEFAULT_SCHEDULER_NAME : str);
    }

    public ExperimentalCoroutineDispatcher(int i3, int i16, @NotNull String str) {
        this(i3, i16, TasksKt.IDLE_WORKER_KEEP_ALIVE_NS, str);
    }

    public /* synthetic */ ExperimentalCoroutineDispatcher(int i3, int i16, int i17, DefaultConstructorMarker defaultConstructorMarker) {
        this((i17 & 1) != 0 ? TasksKt.CORE_POOL_SIZE : i3, (i17 & 2) != 0 ? TasksKt.MAX_POOL_SIZE : i16);
    }

    @Deprecated(level = DeprecationLevel.HIDDEN, message = "Binary compatibility for Ktor 1.0-beta")
    public /* synthetic */ ExperimentalCoroutineDispatcher(int i3, int i16) {
        this(i3, i16, TasksKt.IDLE_WORKER_KEEP_ALIVE_NS, null, 8, null);
    }
}
