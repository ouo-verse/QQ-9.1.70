...
public final class AbstractChannelKt {
    ...
    @JvmField
    @NotNull
    public static final Symbol EMPTY = new Symbol(PatternUtils.NO_MATCH);
    ...
    private static final <E> Object toResult(Object obj) {
        return obj instanceof Closed ? ChannelResult.INSTANCE.m2021closedJP2dKIU(((Closed) obj).closeCause) : ChannelResult.INSTANCE.m2023successJP2dKIU(obj);
    }

    private static final <E> Object toResult(Closed<?> closed) {
        return ChannelResult.INSTANCE.m2021closedJP2dKIU(closed.closeCause);
    }
