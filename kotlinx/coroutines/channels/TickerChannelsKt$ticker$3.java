...
public final class TickerChannelsKt$ticker$3 extends SuspendLambda implements Function2<ProducerScope<? super Unit>, Continuation<? super Unit>, Object> {
    ...
    public TickerChannelsKt$ticker$3(TickerMode tickerMode, long j3, long j16, Continuation<? super TickerChannelsKt$ticker$3> continuation) {
        super(2, continuation);
        this.$mode = tickerMode;
        this.$delayMillis = j3;
        this.$initialDelayMillis = j16;
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            int i16 = WhenMappings.$EnumSwitchMapping$0[this.$mode.ordinal()];
            if (i16 != 1) {
                if (i16 == 2) {
                    ...
                    this.label = 2;
                    fixedDelayTicker = TickerChannelsKt.fixedDelayTicker(j3, j16, channel, this);
                    if (fixedDelayTicker == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                }
            } else {
                long j17 = this.$delayMillis;
                long j18 = this.$initialDelayMillis;
                SendChannel channel2 = producerScope.getChannel();
                this.label = 1;
                fixedPeriodTicker = TickerChannelsKt.fixedPeriodTicker(j17, j18, channel2, this);
