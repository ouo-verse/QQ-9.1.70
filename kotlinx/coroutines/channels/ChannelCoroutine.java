...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public ChannelCoroutine(@NotNull CoroutineContext coroutineContext, @NotNull Channel<E> channel, boolean z16, boolean z17) {
    ...
    public Object mo2001receiveCatchingJP2dKIU(@NotNull Continuation<? super ChannelResult<? extends E>> continuation) {
        Object mo2001receiveCatchingJP2dKIU = this._channel.mo2001receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2002tryReceivePtdJZtk() {
        return this._channel.mo2002tryReceivePtdJZtk();
    }
