...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$7 implements Flow<Integer> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$7", f = "Builders.kt", i = {0}, l = {115}, m = QCircleDaTongConstant.ElementParamValue.COLLECT, n = {"$this$asFlow_u24lambda_u2d13"}, s = {"L$0"})
            ...
            if ((i17 & Integer.MIN_VALUE) != 0) {
                ...
                if (i3 == 0) {
                    if (i3 == 1) {
                        ...
                        i16++;
                        if (i16 < length) {
                            Integer boxInt = Boxing.boxInt(Boxing.boxInt(iArr[i16]).intValue());
