            ...
            if ((i16 & Integer.MIN_VALUE) != 0) {
                ...
                if (i3 == 0) {
                    if (i3 != 1) {
                        if (i3 != 2) {
                            ...
                            if (!((Boolean) obj).booleanValue()) {
                                ...
                                FlowCollector flowCollector = flowKt__LimitKt$dropWhile$lambda4$$inlined$collect$1.$this_unsafeFlow$inlined;
                    ...
                    if (this.$matched$inlined.element) {
                        ...
                        if (flowCollector2.emit(t16, anonymousClass1) == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
