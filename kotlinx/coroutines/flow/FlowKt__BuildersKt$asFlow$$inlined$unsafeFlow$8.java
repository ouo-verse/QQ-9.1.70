...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8 implements Flow<Long> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$8", f = "Builders.kt", i = {0}, l = {115}, m = QCircleDaTongConstant.ElementParamValue.COLLECT, n = {"$this$asFlow_u24lambda_u2d15"}, s = {"L$0"})
            ...
            if ((i17 & Integer.MIN_VALUE) != 0) {
                ...
                if (i3 == 0) {
                    if (i3 == 1) {
                        ...
                        i16++;
                        if (i16 < length) {
                            Long boxLong = Boxing.boxLong(Boxing.boxLong(jArr[i16]).longValue());
