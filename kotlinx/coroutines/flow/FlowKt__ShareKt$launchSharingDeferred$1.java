...
public final class FlowKt__ShareKt$launchSharingDeferred$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
                ...
                Object obj2 = new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__ShareKt$launchSharingDeferred$1$invokeSuspend$$inlined$collect$1
                    ...
                    public Object emit(T t16, @NotNull Continuation<? super Unit> continuation) {
                        ...
                        if (unit == null) {
                            ...
                            ?? r46 = (T) StateFlowKt.MutableStateFlow(t16);
                            completableDeferred.complete(new ReadonlyStateFlow(r46, JobKt.getJob(coroutineScope2.getCoroutineContext())));
                            Unit unit2 = Unit.INSTANCE;
                            objectRef2.element = r46;
                        }
            ...
            this.$result.completeExceptionally(th5);
            throw th5;
        }
    }
