...
public final class LintKt {
    ...
    private static final <T> Flow<T> m2034catch(SharedFlow<? extends T> sharedFlow, Function3<? super FlowCollector<? super T>, ? super Throwable, ? super Continuation<? super Unit>, ? extends Object> function3) {
        return FlowKt.m2026catch(sharedFlow, function3);
    }
    ...
    static /* synthetic */ Flow retry$default(SharedFlow sharedFlow, long j3, Function2 function2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            j3 = Long.MAX_VALUE;
        }
        if ((i3 & 2) != 0) {
        ...
        return FlowKt.retry(sharedFlow, j3, (Function2<? super Throwable, ? super Continuation<? super Boolean>, ? extends Object>) function2);
    }
