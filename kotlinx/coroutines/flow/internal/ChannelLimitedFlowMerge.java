...
public final class ChannelLimitedFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelLimitedFlowMerge(Iterable iterable, CoroutineContext coroutineContext, int i3, BufferOverflow bufferOverflow, int i16, DefaultConstructorMarker defaultConstructorMarker) {
        this(iterable, (i16 & 2) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i16 & 4) != 0 ? -2 : i3, (i16 & 8) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    public ChannelLimitedFlowMerge(@NotNull Iterable<? extends Flow<? extends T>> iterable, @NotNull CoroutineContext coroutineContext, int i3, @NotNull BufferOverflow bufferOverflow) {
