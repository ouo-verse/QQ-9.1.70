...
public final class ChannelFlowMerge<T> extends ChannelFlow<T> {
    ...
    public /* synthetic */ ChannelFlowMerge(Flow flow, int i3, CoroutineContext coroutineContext, int i16, BufferOverflow bufferOverflow, int i17, DefaultConstructorMarker defaultConstructorMarker) {
        this(flow, i3, (i17 & 4) != 0 ? EmptyCoroutineContext.INSTANCE : coroutineContext, (i17 & 8) != 0 ? -2 : i16, (i17 & 16) != 0 ? BufferOverflow.SUSPEND : bufferOverflow);
    }
    ...
    public Object collectTo(@NotNull ProducerScope<? super T> producerScope, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object collect = this.flow.collect(new ChannelFlowMerge$collectTo$$inlined$collect$1((Job) continuation.get$context().get(Job.INSTANCE), Semaphore$default, producerScope, sendingCollector), continuation);
    ...
    public ChannelFlowMerge(@NotNull Flow<? extends Flow<? extends T>> flow, int i3, @NotNull CoroutineContext coroutineContext, int i16, @NotNull BufferOverflow bufferOverflow) {
