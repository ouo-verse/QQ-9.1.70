...
public final class SendingCollector<T> implements FlowCollector<T> {
    ...
    public Object emit(T t16, @NotNull Continuation<? super Unit> continuation) {
        ...
        Object send = this.channel.send(t16, continuation);
