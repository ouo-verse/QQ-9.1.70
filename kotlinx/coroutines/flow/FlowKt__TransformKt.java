...
public final /* synthetic */ class FlowKt__TransformKt {
    ...
    public static final <T, R> Flow<R> runningFold(@NotNull Flow<? extends T> flow, R r16, @BuilderInference @NotNull Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return new FlowKt__TransformKt$runningFold$$inlined$unsafeFlow$1(r16, flow, function3);
    }
    ...
    public static final <T, R> Flow<R> scan(@NotNull Flow<? extends T> flow, R r16, @BuilderInference @NotNull Function3<? super R, ? super T, ? super Continuation<? super R>, ? extends Object> function3) {
        return FlowKt.runningFold(flow, r16, function3);
    }
            ...
            public Object collect(@NotNull final FlowCollector<? super IndexedValue<? extends T>> flowCollector, @NotNull Continuation<? super Unit> continuation) {
                ...
                Object collect = Flow.this.collect(new FlowCollector<T>() { // from class: kotlinx.coroutines.flow.FlowKt__TransformKt$withIndex$lambda-7$$inlined$collect$1
                    ...
                    public Object emit(T t16, @NotNull Continuation<? super Unit> continuation2) {
                        ...
                        if (i3 >= 0) {
                            Object emit = flowCollector2.emit(new IndexedValue(i3, t16), continuation2);
