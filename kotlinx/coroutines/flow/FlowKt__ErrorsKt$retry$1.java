...
public final class FlowKt__ErrorsKt$retry$1 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
    ...
    @Nullable
    public final Object invoke(@NotNull Throwable th5, @Nullable Continuation<? super Boolean> continuation) {
        return ((FlowKt__ErrorsKt$retry$1) create(th5, continuation)).invokeSuspend(Unit.INSTANCE);
    }
}
