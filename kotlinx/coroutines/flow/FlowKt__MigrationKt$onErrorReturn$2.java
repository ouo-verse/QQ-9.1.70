...
/* compiled from: P */
@Metadata(d1 = {"\u0000\u0012\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0003\n\u0000\n\u0002\u0010\u0002\n\u0000\u0010\u0005\u001a\u00020\u0004\"\u0004\b\u0000\u0010\u0000*\b\u0012\u0004\u0012\u00028\u00000\u00012\u0006\u0010\u0003\u001a\u00020\u0002H\u008a@"}, d2 = {"T", "Lkotlinx/coroutines/flow/FlowCollector;", "", "e", "", "<anonymous>"}, k = 3, mv = {1, 5, 1})
...
public final class FlowKt__MigrationKt$onErrorReturn$2<T> extends SuspendLambda implements Function3<FlowCollector<? super T>, Throwable, Continuation<? super Unit>, Object> {
    ...
    public FlowKt__MigrationKt$onErrorReturn$2(Function1<? super Throwable, Boolean> function1, T t16, Continuation<? super FlowKt__MigrationKt$onErrorReturn$2> continuation) {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i3 != 0) {
            ...
            if (this.$predicate.invoke(th5).booleanValue()) {
                T t16 = this.$fallback;
                this.L$0 = null;
                this.label = 1;
    ...
    @Nullable
    public final Object invoke(@NotNull FlowCollector<? super T> flowCollector, @NotNull Throwable th5, @Nullable Continuation<? super Unit> continuation) {
        ...
        flowKt__MigrationKt$onErrorReturn$2.L$1 = th5;
