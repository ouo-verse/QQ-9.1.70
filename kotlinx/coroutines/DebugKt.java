...
public final class DebugKt {
    ...
    static {
        ...
        if (systemProp != null) {
            ...
            DEBUG = z16;
            if (z16 || !SystemPropsKt.systemProp(STACKTRACE_RECOVERY_PROPERTY_NAME, true)) {
                z17 = false;
            }
            RECOVER_STACK_TRACES = z17;
    ...
    private static final void m1987assert(Function0<Boolean> function0) {
    }
}
