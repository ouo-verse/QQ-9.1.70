...
public abstract class AbstractCoroutine<T> extends JobSupport implements Continuation<T>, CoroutineScope {
    ...
    public AbstractCoroutine(@NotNull CoroutineContext coroutineContext, boolean z16, boolean z17) {
        super(z17);
        if (z16) {
