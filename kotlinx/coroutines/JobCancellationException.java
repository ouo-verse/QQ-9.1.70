...
public final class JobCancellationException extends CancellationException implements CopyableThrowable<JobCancellationException> {
    ...
    public JobCancellationException(@NotNull String str, @Nullable Throwable th5, @NotNull Job job) {
        super(str);
        this.job = job;
        if (th5 != null) {
            initCause(th5);
