...
public final class stSimpleMetaComment extends JceStruct {
    ...
    static {
        cache_replyList.add(new stSimpleMetaReply());
    ...
    public void readFrom(JceInputStream jceInputStream) {
        this.f25128id = jceInputStream.readString(0, false);
        ...
        this.receiver = (stSimpleMetaPerson) jceInputStream.read((JceStruct) cache_receiver, 5, false);
    ...
    public void writeTo(JceOutputStream jceOutputStream) {
        ...
        if (stsimplemetaperson2 != null) {
            jceOutputStream.write((JceStruct) stsimplemetaperson2, 5);
        }
        ...
        ArrayList<stSimpleMetaReply> arrayList = this.replyList;
        if (arrayList != null) {
    ...
    public stSimpleMetaComment(String str, String str2, String str3, stSimpleMetaPerson stsimplemetaperson, String str4, stSimpleMetaPerson stsimplemetaperson2, int i3, int i16, int i17, String str5, int i18, long j3, int i19, ArrayList<stSimpleMetaReply> arrayList, long j16, String str6, Map<Integer, String> map, String str7, long j17) {
        this.isTempData = false;
        this.f25128id = str;
        this.wording = str2;
        this.poster_id = str3;
