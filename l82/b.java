...
public final class b extends a {
    ...
    public b(View anchorView, Activity activity) {
        List listOf;
        ...
        aVar.a().h(this, (r15 & 2) != 0 ? Dispatcher.DEFAULT_GROUP_NAME : null, (r15 & 4) != 0 ? "" : null, (r15 & 8) != 0 ? Integer.MIN_VALUE : 1, (r15 & 16) != 0 ? Long.MIN_VALUE : TimeUnit.DAYS.toMillis(1L), (r15 & 32) == 0 ? 0 : Integer.MIN_VALUE);
        ...
        String string = fromV2.getString(com.tencent.mobileqq.matchfriend.reborn.utils.h.f245480a.a("feed_publish_guide_last_show_date"), "");
        boolean z16 = false;
        if (string != null) {
            if (!(string.length() == 0)) {
                z16 = true;
        ...
        if (z16) {
            ...
            listOf = CollectionsKt__CollectionsJVMKt.listOf(Long.valueOf(System.currentTimeMillis() - TimeUnit.HOURS.toMillis(12L)));
            ScheduleManager.l(a16, this, null, listOf, 0, false, 26, null);
        }
    }
    ...
    public boolean isElementCanActivate() {
        ...
        if (QLog.isColorLevel()) {
            QLog.d("MainGuideBubbleElement", 2, "Check can activated " + z16);
        }
        return z16;
    }
    ...
    public void onElementActivated() {
        ...
        QLog.i("MainGuideBubbleElement", 1, "Activated main guide bubble");
        QQStrangerFeedPublishGuideHelper.f245463a.h(this.anchorView, this);
        m82.a.f416439a.b().inactivateElement(this);
    }

    @Override // com.tencent.biz.richframework.order.IOrderElement
    public void onElementInactivated() {
        if (QLog.isColorLevel()) {
            QLog.d("MainGuideBubbleElement", 2, "Element inactivated");
        }
    }
}
