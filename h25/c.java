...
public final class c extends c45.j {
    ...
    public /* synthetic */ c(x xVar, f fVar, int i3, DefaultConstructorMarker defaultConstructorMarker) {
        this(null, null);
    }
    ...
    public final Map<Integer, c45.h> getIndexes() {
        ...
        mapOf = MapsKt__MapsKt.mapOf(TuplesKt.to(1, new c45.h(1, this.f404188d, new b.d(new x(null, null, null, null, null, 0, null, 65535)))), TuplesKt.to(2, new c45.h(2, this.f404189e, new b.d(new f(null, 0, 0, 7, null)))));
        return mapOf;
    }
