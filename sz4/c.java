...
public final class c extends a<f> {
    ...
    public final long a() {
        ...
        try {
            return DatabaseUtils.queryNumEntries(this.f435064a, "apm");
        } catch (Exception e16) {
            e16.printStackTrace();
            return 0L;
        }
    ...
    public final long b(f fVar) {
        ...
        try {
            ...
            return this.f435064a.insert("apm", null, contentValues);
        } catch (Exception e16) {
            e16.printStackTrace();
            return -1L;
        }
    ...
    public final boolean c(ArrayList arrayList) {
        ...
        try {
            ...
            while (it.hasNext()) {
                f fVar = (f) it.next();
                this.f435064a.delete("apm", "id = " + fVar.f435069a, null);
            }
            return true;
        } catch (Exception e16) {
            e16.printStackTrace();
    ...
    public final ArrayList f() {
        ...
        try {
            Cursor query = this.f435064a.query("apm", e.f435068a, null, null, null, null, "id ASC LIMIT + 100");
            try {
