...
public final class GetTroopListReqV2Simplify extends JceStruct {
    ...
    public void writeTo(JceOutputStream jceOutputStream) {
        ...
        ArrayList<stTroopNumSimplify> arrayList = this.vecGroupInfo;
        if (arrayList != null) {
    ...
    public GetTroopListReqV2Simplify(long j3, byte b16, byte[] bArr, ArrayList<stTroopNumSimplify> arrayList, byte b17, int i3, long j16, long j17, byte b18) {
        this.uin = j3;
