...
public final class UnifySearchCommon$ExtensionRequestInfo extends MessageMicro<UnifySearchCommon$ExtensionRequestInfo> {
    static final MessageMicro.FieldMap __fieldMap__;
    public final PBBytesField action;
    public final PBUInt32Field adcode;
    public final PBBytesField city;
    public final PBUInt32Field key_word_src;
    public final PBFloatField latitude;
    public final PBStringField lbs;
    ...
    static {
        String[] strArr = {"action", "latitude", "longitude", "radius", "city", TtmlNode.TAG_REGION, "key_word_src", "rpt_pubacc_local_result", "adcode", "trace_id", "lbs"};
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        Float valueOf = Float.valueOf(0.0f);
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 21, 29, 32, 42, 50, 56, 64, 72, 82, 90}, strArr, new Object[]{byteStringMicro, valueOf, valueOf, 0, byteStringMicro, byteStringMicro, 0, 0L, 0, byteStringMicro, ""}, UnifySearchCommon$ExtensionRequestInfo.class);
    }

    public UnifySearchCommon$ExtensionRequestInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
        ...
        this.adcode = PBField.initUInt32(0);
        this.trace_id = PBField.initBytes(byteStringMicro);
        this.lbs = PBField.initString("");
    }
}
