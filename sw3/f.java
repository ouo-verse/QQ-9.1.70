...
public final class f implements ViewBinding {
    ...
    @NonNull
    private final ConstraintLayout f434902a;

    f(@NonNull ConstraintLayout constraintLayout) {
        this.f434902a = constraintLayout;
    }
    ...
    public static f h(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.f168233fe4, viewGroup, false);
        if (z16) {
