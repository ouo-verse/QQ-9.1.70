...
public final class h implements ViewBinding {
    ...
    @NonNull
    private final ConstraintLayout f434905a;

    h(@NonNull ConstraintLayout constraintLayout) {
        this.f434905a = constraintLayout;
    }
    ...
    public static h h(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, boolean z16) {
        View inflate = layoutInflater.inflate(R.layout.fer, viewGroup, false);
        if (z16) {
