...
/* compiled from: P */
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u0018\u0000 \r2\u00020\u0001:\u0001\u000eB\u0007\u00a2\u0006\u0004\b\u000b\u0010\fJ\u001c\u0010\u0007\u001a\u00020\u00062\b\u0010\u0003\u001a\u0004\u0018\u00010\u00022\b\u0010\u0005\u001a\u0004\u0018\u00010\u0004H\u0016J\u0018\u0010\n\u001a\u00020\u00062\u0006\u0010\u0003\u001a\u00020\u00022\u0006\u0010\t\u001a\u00020\bH\u0016\u00a8\u0006\u000f"}, d2 = {"Lo74/c;", "Lmqq/app/MSFServlet;", "Landroid/content/Intent;", Const.BUNDLE_KEY_REQUEST, "Lmqq/app/Packet;", "packet", "", "onSend", "Lcom/tencent/qphone/base/remote/FromServiceMsg;", "response", "onReceive", "<init>", "()V", "d", "a", "superqqshow-portal-impl_release"}, k = 1, mv = {1, 7, 1})
...
public final class c extends MSFServlet {
    ...
    public void onReceive(Intent request, FromServiceMsg response) {
        ...
        if (QLog.isColorLevel()) {
            ...
            QLog.d("[zplan]_ZPlanRequestServlet", 2, "onReceive cmd=" + request.getStringExtra("cmd") + ",success=" + response.isSuccess());
        } else {
            j3 = 0;
        }
        ...
        BusinessHandler businessHandler = appInterface != null ? appInterface.getBusinessHandler(ZPlanRequestHandler.class.getName()) : null;
        ...
        ((ZPlanRequestHandler) businessHandler).G2(request, response, bArr);
        if (QLog.isColorLevel()) {
            QLog.d("[zplan]_ZPlanRequestServlet", 2, "onReceive exit|cost: " + (System.currentTimeMillis() - j3));
        }
    }
    ...
    public void onSend(Intent request, Packet packet) {
        ...
        QLog.d("[zplan]_ZPlanRequestServlet", 2, "onSend exit cmd=" + stringExtra);
    }
}
