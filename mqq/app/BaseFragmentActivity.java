...
public class BaseFragmentActivity extends FragmentActivity implements IPermissionRequester {
    ...
    private MobileQQ f417202mqq;

    private void attachDebugUiHierarchyTools(final Activity activity) {
        if (MqqInjectorManager.instance().isDebugVersion()) {
            BroadcastReceiver broadcastReceiver = new BroadcastReceiver() { // from class: mqq.app.BaseFragmentActivity.1
    ...
    public void onDestroy() {
        ...
        this.f417202mqq.removeBaseActivity(this);
        this.f417202mqq = null;
    }
    ...
    public AppRuntime waitAppRuntime() {
        AppRuntime waitAppRuntime = this.f417202mqq.waitAppRuntime();
