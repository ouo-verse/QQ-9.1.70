...
/* compiled from: P */
@Metadata(d1 = {"\u0000/\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\b\u0005\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0006*\u0001\u000b\u0018\u0000 \n2\u00020\u0001:\u0001\bB\u0007\u00a2\u0006\u0004\b\u0015\u0010\u0016J\u0010\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H\u0016J\u0010\u0010\b\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J\u0010\u0010\t\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u0006H\u0016J\b\u0010\n\u001a\u00020\u0004H\u0016R\u0014\u0010\r\u001a\u00020\u000b8\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\b\u0010\fR\u0018\u0010\u000f\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e\u00a2\u0006\u0006\n\u0004\b\t\u0010\u000eR$\u0010\u0014\u001a\u0012\u0012\u0004\u0012\u00020\u00060\u0010j\b\u0012\u0004\u0012\u00020\u0006`\u00118\u0002X\u0082\u0004\u00a2\u0006\u0006\n\u0004\b\u0012\u0010\u0013\u00a8\u0006\u0017"}, d2 = {"Lcl4/a;", "Lal4/a;", "Lcom/tencent/mobileqq/qqlive/api/room/ILiveRoom;", "liveRoom", "", "e", "Lcom/tencent/mobileqq/qqlive/callback/message/IQQCmdPushCallback;", "cb", "a", "b", "d", "cl4/a$b", "Lcl4/a$b;", "pushCallback", "Lcom/tencent/mobileqq/qqlive/api/room/ILiveRoom;", "mLiveRoom", "Ljava/util/HashSet;", "Lkotlin/collections/HashSet;", "c", "Ljava/util/HashSet;", "listenerPool", "<init>", "()V", "timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
/* loaded from: classes26.dex */
public final class a implements al4.a {
    ...
    /* compiled from: P */
    @Metadata(d1 = {"\u0000#\n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u0012\u0010\u0005\u001a\u00020\u00042\b\u0010\u0003\u001a\u0004\u0018\u00010\u0002H\u0016J\u001a\u0010\n\u001a\u00020\u00042\u0006\u0010\u0007\u001a\u00020\u00062\b\u0010\t\u001a\u0004\u0018\u00010\bH\u0016\u00a8\u0006\u000b"}, d2 = {"cl4/a$b", "Lcom/tencent/mobileqq/qqlive/callback/message/IQQCmdPushCallback;", "", "data", "", "onReceive", "", "errCode", "", "errMsg", "onFail", "timi-game-impl_release"}, k = 1, mv = {1, 7, 1})
    /* loaded from: classes26.dex */
        ...
        public void onReceive(@Nullable byte[] data) {
            if (data != null) {
                try {
                    ...
                    Iterator it = new HashSet(a.this.listenerPool).iterator();
                    while (it.hasNext()) {
                        ((IQQCmdPushCallback) it.next()).onReceive(c16.f28643c);
                    }
                    return;
                } catch (InvalidProtocolBufferNanoException e16) {
                    l.d("TimiPushServiceImpl_", 1, "parse data error", e16);
                    return;
                }
            }
            l.c("TimiPushServiceImpl_", 4, "receive data null");
        }
    }
    ...
    public void a(@NotNull IQQCmdPushCallback cb5) {
        ...
        l.h("TimiPushServiceImpl_", 1, "registerPushCallback cb:" + cb5);
    }
    ...
    public void b(@NotNull IQQCmdPushCallback cb5) {
        ...
        l.h("TimiPushServiceImpl_", 1, "unRegisterPushCallback cb:" + cb5);
    }
    ...
    public void d() {
        ...
        l.h("TimiPushServiceImpl_", 1, "destroy, roomId:" + l3);
    ...
    public void e(@NotNull ILiveRoom liveRoom) {
        ...
        l.h("TimiPushServiceImpl_", 1, "init finish, roomId:" + l3);
    }
}
