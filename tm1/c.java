...
public final class c implements b {
    ...
    public c(@NotNull i transparentJsonTranslator, @NotNull com.tencent.mobileqq.guild.feed.nativepublish.tool.translate.translator.e[] extendedTranslators) {
    ...
    public JSONObject a(@NotNull nm1.b translateInfo) {
        ...
        try {
            ...
            QLog.d("TranslateToDraftTool", 1, "[translate]: taskId=" + str + ", text.length=" + translateInfo.getEditable().length() + ", mediaList.size=" + translateInfo.c().size());
            ...
            QLog.d("TranslateToDraftTool", 1, "translate error! " + e16.getMessage());
