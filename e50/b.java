...
import com.tencent.biz.qqcircle.immersive.part.profilecard.QFSSetDynamicAvatarPart;
...
public class b extends f {
    public static boolean x(QCircleInitBean qCircleInitBean) {
        if (qCircleInitBean == null || qCircleInitBean.getSchemeAttrs() == null || !TextUtils.equals(qCircleInitBean.getSchemeAttrs().get("key_jump_from"), String.valueOf(1006))) {
            return false;
        }
        return true;
    }
    ...
    protected List<Part> g(@NonNull com.tencent.biz.qqcircle.immersive.layer.base.a aVar) {
        ...
        arrayList.add(new QFSSetDynamicAvatarPart(aVar2.b().getFeed().get().f398449id.get()));
        return arrayList;
    }
