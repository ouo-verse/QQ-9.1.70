...
public final class ArraySet<E> implements Collection<E>, Set<E> {
    ...
    public boolean add(E e16) {
        ...
        if (e16 == null) {
            ...
            if (this.mIdentityHashCode) {
                hashCode = System.identityHashCode(e16);
            } else {
                hashCode = e16.hashCode();
            }
            i3 = hashCode;
    ...
    public ArraySet(int i3, boolean z16) {
        this.mIdentityHashCode = z16;
        if (i3 == 0) {
            this.mHashes = INT;
            this.mArray = OBJECT;
        } else {
