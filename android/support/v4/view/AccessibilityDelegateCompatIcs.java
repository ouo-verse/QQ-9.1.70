...
class AccessibilityDelegateCompatIcs {
    ...
    public static Object newAccessibilityDelegateBridge(final AccessibilityDelegateBridge accessibilityDelegateBridge) {
        return new View.AccessibilityDelegate() { // from class: android.support.v4.view.AccessibilityDelegateCompatIcs.1
            ...
            public void sendAccessibilityEvent(View view, int i3) {
                AccessibilityDelegateBridge.this.sendAccessibilityEvent(view, i3);
            }
    ...
    public static void sendAccessibilityEvent(Object obj, View view, int i3) {
        ((View.AccessibilityDelegate) obj).sendAccessibilityEvent(view, i3);
    }
