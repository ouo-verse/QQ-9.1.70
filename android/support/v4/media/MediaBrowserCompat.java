    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        public void onReceiveResult(int i3, Bundle bundle) {
            ...
            if (i3 != -1) {
                if (i3 != 0) {
                    if (i3 != 1) {
                        Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i3 + " (extras=" + this.mExtras + ", resultData=" + bundle + ")");
                        return;
                    }
    ...
    static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
        ...
        public void onConnected() {
            try {
                ...
                Log.e(MediaBrowserCompat.TAG, "Unexpected IllegalStateException", e16);
            }
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            if (isConnected()) {
                ...
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error searching items with query: " + str, e16);
        ...
        public void sendCustomAction(@NonNull final String str, final Bundle bundle, @Nullable final CustomActionCallback customActionCallback) {
            if (isConnected()) {
                ...
                try {
                    ...
                    Log.i(MediaBrowserCompat.TAG, "Remote error sending a custom action: action=" + str + ", extras=" + bundle, e16);
                    if (customActionCallback != null) {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public class MediaServiceConnection implements ServiceConnection {
            ...
            boolean isCurrent(String str) {
                ...
                int i16 = mediaBrowserImplBase.mState;
                if (i16 != 0 && i16 != 1) {
            ...
            public void onServiceConnected(final ComponentName componentName, final IBinder iBinder) {
                postOrRun(new Runnable() { // from class: android.support.v4.media.MediaBrowserCompat.MediaBrowserImplBase.MediaServiceConnection.1
                    @Override // java.lang.Runnable
                    public void run() {
                        boolean z16 = MediaBrowserCompat.DEBUG;
                        if (z16) {
                ...
                public void run() {
                    ...
                    if (mediaBrowserImplBase.mServiceBinderWrapper == null) {
                        if (mediaBrowserImplBase.mCallbacksMessenger == null) {
                            ...
                            try {
                                MediaBrowserImplBase mediaBrowserImplBase3 = MediaBrowserImplBase.this;
                                z16 = mediaBrowserImplBase3.mContext.bindService(intent, mediaBrowserImplBase3.mServiceConnection, 1);
