...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public Bitmap getBitmap(String str) {
        try {
            ...
            Log.w(TAG, "Failed to retrieve a key as Bitmap.", e16);
            return null;
        }
    }
    ...
    public MediaDescriptionCompat getDescription() {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            while (i3 < 3) {
                ...
                int i17 = i16 + 1;
                CharSequence text2 = getText(strArr[i16]);
        ...
        while (true) {
            ...
            if (i19 < strArr3.length) {
                String string2 = getString(strArr3[i19]);
    ...
    public RatingCompat getRating(String str) {
        try {
            ...
            Log.w(TAG, "Failed to retrieve a key as Rating.", e16);
            return null;
        }
    }
    ...
    public static final class Builder {
        ...
        private Bitmap scaleBitmap(Bitmap bitmap, int i3) {
            float f16 = i3;
            float min = Math.min(f16 / bitmap.getWidth(), f16 / bitmap.getHeight());
