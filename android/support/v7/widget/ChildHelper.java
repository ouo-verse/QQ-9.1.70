...
public class ChildHelper {
    ...
    public static class Bucket {
        ...
        void insert(int i3, boolean z16) {
            ...
            if (z17 || this.next != null) {
                ensureNext();
                this.next.insert(0, z17);
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public View findHiddenNonRemovedView(int i3, int i16) {
        int size = this.mHiddenViews.size();
        for (int i17 = 0; i17 < size; i17++) {
            View view = this.mHiddenViews.get(i17);
            RecyclerView.ViewHolder childViewHolder = this.mCallback.getChildViewHolder(view);
            if (childViewHolder.getLayoutPosition() == i3 && !childViewHolder.isInvalid() && !childViewHolder.isRemoved() && (i16 == -1 || childViewHolder.getItemViewType() == i16)) {
                return view;
            }
        }
        return null;
