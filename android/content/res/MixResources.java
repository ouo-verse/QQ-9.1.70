...
public class MixResources extends ResourcesWrapper {
    ...
    @Override // android.content.res.ResourcesWrapper, android.content.res.Resources
    ...
    public void getValue(int i3, TypedValue typedValue, boolean z16) throws Resources.NotFoundException {
        try {
            super.getValue(i3, typedValue, z16);
        } catch (Resources.NotFoundException unused) {
            this.mHostResources.getValue(i3, typedValue, z16);
        }
    }
    ...
    public void getValue(String str, TypedValue typedValue, boolean z16) throws Resources.NotFoundException {
        try {
            ...
            this.mHostResources.getValue(str, typedValue, z16);
        }
    }
