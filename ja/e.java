...
public final class e extends com.qzone.reborn.base.f<LocalMediaInfo> {
    ...
    public boolean isForViewType(LocalMediaInfo item, List<LocalMediaInfo> items, int position) {
        ...
        return ea.a.g(item) == 3 || ea.a.g(item) == 1;
    }
