...
public class QzoneVideoBeaconReport {
    ...
    public static void reportAlbumEvent(String str, String str2) {
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(str, str2, true, 0L, 0L, new HashMap<>(), null);
        if (QLog.isColorLevel()) {
            QLog.d("QzoneVideoBeaconReport", 2, "event:" + str2);
        }
    }

    public static void reportQzoneLiveEvent(String str, String str2, String str3) {
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        ...
        StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(str, str2, true, 0L, 0L, hashMap, null);
        if (QLog.isColorLevel()) {
    ...
    public static void reportAlbumEvent(String str, String str2, String str3) {
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        HashMap<String, String> hashMap = new HashMap<>();
    ...
    public static void reportVideoEvent(String str, String str2, HashMap<String, String> hashMap) {
        HashMap<String, String> hashMap2 = new HashMap<>();
        hashMap2.putAll(hashMap);
        StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(str, str2, true, 0L, 0L, hashMap2, null);
        if (QLog.isColorLevel()) {
            QLog.d("QzoneVideoBeaconReport", 2, "event:" + str2);
        }
    }

    public static void reportAlbumEvent(String str, String str2, String str3, String str4) {
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        HashMap<String, String> hashMap = new HashMap<>();
    ...
    public static void reportVideoEvent(String str, String str2, String str3, String str4, String str5) {
        HashMap<String, String> hashMap = new HashMap<>();
    ...
    public static void reportVideoEvent(String str, String str2, long j3) {
        StatisticCollector.getInstance(BaseApplication.getContext()).collectPerformance(str, str2, true, j3, 0L, new HashMap<>(), null);
        if (QLog.isColorLevel()) {
            QLog.d("QzoneVideoBeaconReport", 2, "event:" + str2 + " duration:" + j3);
        }
    }
}
