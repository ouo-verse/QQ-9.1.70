...
public class QzoneVerticalVideoConst {
    ...
    public static final String KEY_QCIRCLE_SCHEMA_FROM_VERTICAL_VIDEO = "key_qcircle_schema_from_vertical_video";
    public static final String KEY_QCIRCLE_SCHEME = "key_qcircle_scheme";
        ...
        if (intent != null) {
            try {
                if (intent.hasExtra(KEY_REQUEST_FROM)) {
                    if (intent.getIntExtra(KEY_REQUEST_FROM, 0) == 5) {
                        return true;
                    }
                }
            } catch (Exception unused) {
