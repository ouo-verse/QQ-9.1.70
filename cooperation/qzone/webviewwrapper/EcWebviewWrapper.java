...
public class EcWebviewWrapper implements IWebviewWrapper {
    ...
    public EcWebviewWrapper(Context context) {
    ...
    public void onInit(Activity activity, Intent intent, String str, final IWebviewListener iWebviewListener) {
        ...
        this.mWebViewBuilder.setWebviewStatusListener(new QzoneWebViewBaseBuilder.WebviewStatusListener() { // from class: cooperation.qzone.webviewwrapper.EcWebviewWrapper.1
            @Override // cooperation.qzone.webviewwrapper.QzoneWebViewBaseBuilder.WebviewStatusListener
            public void onPageFinished() {
                if (EcWebviewWrapper.this.mWebview == null) {
                    return;
                }
                if (EcWebviewWrapper.this.mWebview.getVisibility() != 0) {
                    EcWebviewWrapper.this.mWebview.setVisibility(0);
                }
