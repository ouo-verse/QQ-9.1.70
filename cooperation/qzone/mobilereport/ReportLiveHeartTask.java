...
public class ReportLiveHeartTask extends BaseReportTask {
    ...
    protected void doMobileReport(HashMap<ReportKey, ArrayList<ItemInfo>> hashMap) {
        ...
        if (QLog.isColorLevel()) {
            QLog.i(TAG, 2, "doMobileReport size = " + arrayList.size());
        }
        g.a(10, runtime, new UserCommReportBuilder().setUin(runtime.getLongAccountUin()).setNetwork_type(a.e()).build(), arrayList);
    }
}
