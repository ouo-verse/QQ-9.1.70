...
public class ReportActionInfoTask extends BaseReportTask {
    ...
    protected void doMobileReport(HashMap<ReportKey, ArrayList<ItemInfo>> hashMap) {
        ...
        g.b(runtime, new UserCommReportBuilder().setUin(runtime.getLongAccountUin()).setNetwork_type(a.e()).build(), arrayList);
    }
}
