...
public class LpReportInfoConfig {
    ...
    public static final int ACTION_DELETE_FEED_SUPPORT_REEDIT = 3001;
    public static final int ACTION_FEED_FOLDED_TEXT_AREA = 201;
    public static final int ACTION_FEED_GUIDE_UPLOAD_ALBUM = 146;
    public static final int ACTION_FEED_GUIDE_UPLOAD_ALBUM_H5_PERMISSION_SETTING = 1200;
    public static final int ACTION_FEED_GUIDE_UPLOAD_ALBUM_UPLOAD_PHOTO_PAGE = 2;
    ...
    public static final int ACTION_LOCAL_PHOTO_SCAN = 146;
    public static final int ACTION_MAKE_DYNAMIC = 87;
    public static final int ACTION_NEW_SIMPLE_MODE = 143;
    ...
    public static final int ACTION_TEEN_ONLINE_TIMEOUT = 145;
    public static final int ACTION_TEMPLATE_SYNC_QCIRCLE = 3000;
    public static final int ACTION_TODAYINHISTORY_ENTRY = 346;
    ...
    public static final int RESERVES_ACTION_HEADER_CLICK = 2;
    public static final int RESERVES_ACTION_HEADER_REPORT = 1;
    ...
    public static final int RESERVES_HOMEPAGE_GUEST_SETTING = 0;
    ...
    public static final int RESERVE_ACTION_FROM_GROUP_ALBUM = 4;
    public static final int RESERVE_ACTION_FROM_GROUP_FEEDS = 3;
    ...
    public static final String RESERVE_DELETE_FEED_TYPE_ALBUM = "album";
    public static final String RESERVE_DELETE_FEED_TYPE_SHUOSHUO = "shuoshuo";
    ...
    public static final int RESERVE_FRIEND_FEED_READ_DIVIDE_LINE_CLICK = 2;
    public static final int RESERVE_FRIEND_FEED_READ_DIVIDE_LINE_EXPOSE = 1;
    public static final int RESERVE_GUIDE_UPLOAD_ALBUM_IS_CLOSE = 2;
    public static final int RESERVE_GUIDE_UPLOAD_ALBUM_IS_OPEN = 1;
    public static final int RESERVE_LOCAL_PHOTO_SCAN_CLICK_CANCEL = 3;
    public static final int RESERVE_LOCAL_PHOTO_SCAN_CLICK_CONFIRM = 2;
    public static final int RESERVE_LOCAL_PHOTO_SCAN_EXPOSE = 1;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_AREA_EXPOSURE = 0;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_AUTO_TEMPLATE = 7;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_CLK_PREVIEW_AREA = 5;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_NOT_SELECTED_WHEN_PUBLISH = 4;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_SELECTED_WHEN_PUBLISH = 3;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_SO_NOT_READY = 6;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_TAG_DELETE_CLK = 2;
    public static final int RESERVE_LOCAL_SYNC_QCIRCLE_TAG_EXPOSURE = 1;
    public static final String RESERVE_LOCAL_SYNC_QCIRCLE_VAL_IS_TAG = "1";
    public static final String RESERVE_LOCAL_SYNC_QCIRCLE_VAL_NONE = "none";
    public static final String RESERVE_LOCAL_SYNC_QCIRCLE_VAL_NO_TAG = "0";
    ...
    public static final int RESERVE_RECOMMEND_FEED_GUIDE_SHAI_SHAI_CLICK = 2;
    public static final int RESERVE_RECOMMEND_FEED_GUIDE_SHAI_SHAI_EXPOSE = 1;
    public static final String RESERVE_REFER_FROM_FEEDX_LAYER = "1";
    ...
    public static final String RESERVE_SYNC_QCIRCLE_MEMORY_SYNC_SWITCH_BUBBLE = "3";
    public static final String RESERVE_SYNC_QCIRCLE_SHARE_EVENT_SWITCH_BUBBLE = "1";
    public static final String RESERVE_SYNC_QCIRCLE_TEXT_TO_VIDEO_PREVIEW_BUBBLE = "3";
    public static final String RESERVE_SYNC_QCIRCLE_TEXT_TO_VIDEO_SWITCH_BUBBLE = "2";
    public static final String RESERVE_SYNC_QCIRCLE_TOPIC_EVENT_PREVIEW_BUBBLE = "2";
    public static final String RESERVE_SYNC_QCIRCLE_VIDEO_TEMPLATE_PREVIEW_BUBBLE = "1";
    public static final int RESERVE_TEEN_ONLINE_TIMEOUT_CLICK_CONTINUE_BROW = 1;
    public static final int RESERVE_TEEN_ONLINE_TIMEOUT_CLICK_OK = 2;
    public static final int RESERVE_TEMPLATE_SYNC_QCIRCLE_OPEN = 3;
    public static final int RESERVE_TEMPLATE_SYNC_QCIRCLE_PUBLISH_CLICK = 2;
    public static final int RESERVE_TEMPLATE_SYNC_QCIRCLE_PUBLISH_EXPOSE = 1;
    public static final int RESERVE_TODAYINHISTORY_DETAIL_EXPOSE = 1;
    public static final String RESERVE_TODAYINHISTORY_FROM_PULIC_ACCOUNT = "1";
    public static final String RESERVE_TODAYINHISTORY_FROM_PUSH = "2";
    public static final int RESERVE_TODAYINHISTORY_SHARE_CLICK = 3;
    public static final int RESERVE_TODAYINHISTORY_SHARE_EXPOSE = 2;
    ...
    public static final int RESERVE_UPLOAD_ALBUM_CARD_BTN_CLICK = 1;
    public static final int RESERVE_UPLOAD_ALBUM_CARD_CLOSE_CLICK = 2;
    public static final int RESERVE_UPLOAD_ALBUM_CARD_EXPOSE = 0;
    ...
    public static final int RESERVE_UPLOAD_PHOTO_PAGE_FROM_GUIDE_UPLOAD_ALBUM_BANNER = 4;
    ...
    public static final String REVERSE_IS_DETAIL_FEED = "1";
    public static final String REVERSE_IS_FEED = "0";
    public static final String REVERSE_IS_NOT_SAFEMODEL = "0";
    public static final String REVERSE_IS_SAFEMODEL = "1";
    public static final int REVERSE_TEXT_AREA_CLICK = 1;
    ...
    public static final int SUB_ACTION_COMMENT_TEXT_AREA = 2;
    public static final int SUB_ACTION_DELETE_FEED_SUPPORT_REEDIT = 1;
    ...
    public static final int SUB_ACTION_FORWARD_TEXT_AREA = 3;
    public static final int SUB_ACTION_FRIENDSHIP = 2;
    public static final int SUB_ACTION_GIF_EDIT_EXPOSE = 1;
    public static final int SUB_ACTION_GUIDE_UPLOAD_ALBUM_PAGE_CLICK_UPLOAD = 12;
    ...
    public static final int SUB_ACTION_HOMEPAGE_GUEST_SETTING = 1;
    public static final int SUB_ACTION_LOCAL_PHOTO_SCAN_TAB_DIALOG = 9;
    public static final int SUB_ACTION_LOCAL_SYNC_QCIRCLE = 62;
    public static final int SUB_ACTION_LOCAL_SYNC_QCIRCLE_SWITCH_BUBBLE = 63;
    ...
    public static final int SUB_ACTION_NEW_SIMPLE_HEADER_AVATAR = 2;
    public static final int SUB_ACTION_NEW_SIMPLE_HEADER_MSG = 1;
    public static final int SUB_ACTION_NEW_SIMPLE_HEADER_NICKNAME = 3;
    public static final int SUB_ACTION_PERMISSION_SETTING_GUIDE = 5;
    public static final int SUB_ACTION_PERMISSION_SETTING_GUIDE_STATUS = 4;
    ...
    public static final int SUB_ACTION_PRAISE_TEXT_AREA = 1;
    ...
    public static final int SUB_ACTION_SETTING_GUIDE_H5_PERMISSION_SWITCH = 5;
    ...
    public static final int SUB_ACTION_TEEN_ONLINE_TIMEOUT_CLICK = 1;
    public static final int SUB_ACTION_TEEN_ONLINE_TIMEOUT_SHOW_DIALOG = 0;
    public static final int SUB_ACTION_TEMPLATE_SYNC_QCIRCLE = 1;
    ...
    public static final int SUB_ACTION_TYPE_WEZONE = 51;
    public static final int SUB_ACTION_TYPE_WE_PLAY = 33;
    public static final int SUB_ACTION_TYP_QZONE_SETTING = 2;
    public static final int SUB_ACTION_UPLOAD_ALBUM_GUIDE = 6;
    public static final int SUB_ACTION_UPLOAD_PHOTO_PAGE_LOCAL_SYNC_QCIRCLE = 17;
    ...
    public static final int SUB_ALBUM_ACTION_PERMISSION_SETTING_GUIDE = 7;
    public static final int SUB_ALBUM_ACTION_UPLOAD_ALBUM_GUIDE = 8;
    public static final int SUB_EDIT_BUTTON = 4;
    public static final int SUB_FRIEND_FEED_READ_DIVIDE_LINE = 504;
    ...
    public static final int SUB_TODAYINHISTORY_ENTRY_CLICK = 10;
    public static final int SUB_TODAYINHISTORY_ENTRY_EXPOSE = 9;
    ...
    public static final int THIRD_ACTION_DELETE_FEED_SUPPORT_REEDIT_BTN_CLICK = 1;
    public static final int THIRD_ACTION_DELETE_FEED_SUPPORT_REEDIT_EXPOSE = 0;
    ...
    public static final int WRITE_MOOD_QZONE_AUTO_TEMPLATE_RESERVE_TYPE = 7;
