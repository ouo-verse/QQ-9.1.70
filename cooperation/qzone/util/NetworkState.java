...
public class NetworkState {
    ...
    private static INetEventHandler netEventHandler = new INetEventHandler() { // from class: cooperation.qzone.util.NetworkState.1
    ...
    public static int getApnValue() {
        ...
        Integer num = mApnMap.get(NetworkMonitor.netGetExInfo(recentNetworkInfo));
        if (num != null) {
            i3 = num.intValue();
        } else {
            i3 = 5;
    ...
    private static boolean getIsMobileForDebugVersion() {
        try {
            ...
            QZLog.e(TAG, "getIsMobileForDebugVersion error", e16);
    ...
    public static String getProviderName() {
        if (TextUtils.isEmpty(providerName)) {
            String imsi = ((ILpReportUtils) QRoute.api(ILpReportUtils.class)).getIMSI();
