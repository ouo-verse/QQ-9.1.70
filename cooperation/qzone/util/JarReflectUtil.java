...
public class JarReflectUtil {
    ...
    public static Object callSpecifiedMethod(Object obj, String str, boolean z16, Class[] clsArr, Object... objArr) {
        ...
        try {
            ...
            e16.printStackTrace();
            QZLog.e(TAG, "IllegalAccessException: " + e16.getMessage());
            return null;
        } catch (NoSuchMethodException e17) {
            QZLog.e(TAG, "NoSuchMethodException: " + e17.getMessage());
            e17.printStackTrace();
            return null;
        } catch (NullPointerException e18) {
            e18.printStackTrace();
            QZLog.e(TAG, "NullPointerException: " + e18.getMessage());
            return null;
        } catch (InvocationTargetException e19) {
            QZLog.e(TAG, "InvocationTargetException: " + e19.getMessage());
            e19.printStackTrace();
            return null;
        }
    }
    ...
    public static Object callSpecifiedStaticMethod(String str, String str2, boolean z16, Class[] clsArr, Object... objArr) {
        ...
        try {
            ...
            e16.printStackTrace();
            QZLog.e(TAG, "ClassNotFoundException: " + e16.getMessage());
            return null;
        } catch (IllegalAccessException e17) {
            e17.printStackTrace();
            QZLog.e(TAG, "IllegalAccessException: " + e17.getMessage());
            return null;
        } catch (NoSuchMethodException e18) {
            e18.printStackTrace();
            QZLog.e(TAG, "NoSuchMethodException: " + e18.getMessage());
            return null;
        } catch (NullPointerException e19) {
            e19.printStackTrace();
            QZLog.e(TAG, "NullPointerException: " + e19.getMessage());
            return null;
        } catch (InvocationTargetException e26) {
            e26.printStackTrace();
            QZLog.e(TAG, "InvocationTargetException: " + e26.getMessage());
            return null;
        }
    }
    ...
    public static Object creatSpecifiedObject(String str, Class[] clsArr, Object... objArr) {
        ...
        try {
            ...
            QZLog.e(TAG, "InstantiationException: " + e18.getMessage());
            e18.printStackTrace();
            return null;
        } catch (NoSuchMethodException e19) {
            QZLog.e(TAG, "NoSuchMethodException: " + e19.getMessage());
            e19.printStackTrace();
            return null;
        } catch (InvocationTargetException e26) {
            QZLog.e(TAG, "InvocationTargetException: " + e26.getMessage());
    ...
    public static Object getSpecifiedField(Object obj, String str, boolean z16) {
        ...
        try {
            ...
            QZLog.e(TAG, "IllegalAccessException: ");
            e16.printStackTrace();
            return obj3;
        } catch (NoSuchFieldException e17) {
            QZLog.e(TAG, "NoSuchFieldException: ");
            e17.printStackTrace();
            return obj3;
        }
    }
    ...
    public static Object getStaticField(String str, String str2) {
        ...
        try {
            ...
            QZLog.e(TAG, "ClassNotFoundException: ");
            e16.printStackTrace();
            return null;
        } catch (IllegalAccessException e17) {
            QZLog.e(TAG, "IllegalAccessException: ");
