...
public class QZoneJsConstants {
    ...
    public static final String KEY_NEW_CARD_IS_NEED_SHOW = "key_is_use_new_card";
    ...
    public static String METHOD_PUBLISH_CALLBACK = "publishCallBack";
    public static final String METHOD_QZONEUPLOADANDPUBLISH = "qzoneUploadAndPublish";
    public static final String METHOD_QZONE_SELECT_GET_PICTURE = "getPicture";
    ...
    public static final String METHOD_REFRESH_FRIEND_FEED = "refreshFriendFeed";
    ...
    public static final String PKGNAME_QZONE_INTIMATE_SPACE = "QZIntimateSpace";
    ...
    public static final String SOURCE_HOLIDAY = "holiday";
    ...
    public static final String DYNAMIC_ALBUM_BUTTON = HardCodeUtil.qqStr(R.string.rxn);
    public static final String DYNAMIC_ALBUM_DESC_TEXT = HardCodeUtil.qqStr(R.string.rxm);
    ...
    /* compiled from: P */
    /* loaded from: classes28.dex */
    static final class QZoneQunFeedJsConstants {
