...
public interface PeakConstants extends QAlbumConstants {
    ...
    public static final int BUSINESS_ORIGIN_GUILD_CHANNEL_FOR_RESULT = 107;
    ...
    public static final String COMMENT_CONTENT = "PhotoConst.COMMENT_CONTENT";
    ...
    public static final String CROP_SINGLE_PHOTO_URI = "crop_single_photo_uri";
    ...
    public static final int FROM_AIO_PHOTO_OR_VIDEO_PREVIEW = 4;
    ...
    public static final int FROM_PHOTO_LIST_CUSTOMIZATION = 5;
    ...
    public static final String GUILD_ALBUM_QUALITY = "original_pic";
    public static final String GUILD_ALBUM_SELECT_PHOTOS = "select_photos";
    public static final String GUILD_OPEN_AIO_INTENT = "key_guild_open_aio_intent";
    public static final String GUILD_VIDEO_SEND_FLAG = "guild_video_send_flag";
    ...
    public static final String IS_FROM_XIAOWO = "PhotoConst.IS_FROM_XIAOWO";
    ...
    public static final String IS_NEED_FILTER_MOOD_PRIVATE_ALBUM = "PhotoConst.IS_NEED_FILTER_MOOD_PRIVATE_ALBUM";
    ...
    public static final String IS_START_ACTIVITY_FOR_RESULT = "PhotoConst.START_ACTIVITY_FOR_RESULT";
    public static final String IS_SUPPORT_COMMENT_IN_PREVIEW = "PhotoConst.IS_SUPPORT_COMMENT_IN_PREVIEW";
    ...
    public static final String KEY_BACK_TO_INIT_CLASS = "PhotoConst.BACK_TO_INIT_CLASS";
    public static final String KEY_CHOOSE_VIDEO_DIRECT_RETURN = "choose_video_direct_return";
    public static final String KEY_CHOOSE_VIDEO_PATH = "key_video_path";
    ...
    public static final String KEY_IS_FROM_QZONE_AUTO_TEMPLATE = "key_is_from_qzone_auto_template";
    ...
    public static final String KEY_QZONE_SYNC_CIRCLE = "key_qzone_sync_circle";
    ...
    public static final String KEY_TROOP_GROUP_NAME = "key_troop_group_name";
    ...
    public static final String PANEL_VIDEO_EDIT_SEND = "panelVideoEditSend";
    ...
    public static final String PHOTOLIST_KEY_FILTER_VIDEO = "PhotoConst.PHOTOLIST_KEY_FILTER_VIDEO";
    ...
    public static final String PHOTO_CROP_CANCEL = "PhotoConst.PHOTO_CROP_CANCEL";
    ...
    public static final String QCIRCLE_CLIENT_EVENTID = "qcircle_client_eventid";
    ...
    public static final String QCIRCLE_CLIENT_EXT3 = "qcircle_client_ext3";
    public static final String QCIRCLE_CLIENT_MSG = "qcircle_client_msg";
    ...
    public static final int QCIRCLE_FIRST_SCREEN_PHOTO_SIZE_IN_RECENT_PHOTO = 100;
    ...
    public static final long QZONE_UPLOAD_PHOTO_ACTIVITY_VIDEO_DURATION_LOWER_LIMIT = 1000;
    public static final long QZONE_UPLOAD_PHOTO_ACTIVITY_VIDEO_DURATION_UPPER_LIMIT = 601000;
    ...
    public static final int REQUEST_CODE_GAME_CENTER_STRATEGY = 10022;
    public static final int REQUEST_CODE_GAME_CENTER_STRATEGY_EDIT_PIC = 10025;
    public static final int REQUEST_CODE_GAME_CENTER_STRATEGY_VIDEO = 10023;
    public static final int REQUEST_CODE_GUID_MEDIA_PEAK = 10014;
    public static final int REQUEST_CODE_GUILD_MEIDA_PANEL_PREVIEW = 10015;
    ...
    public static final int REQUEST_CODE_KUIKLY_MODULE = 10026;
    public static final int REQUEST_CODE_KUIKLY_MODULE_FOR_EDIT = 10027;
    public static final int REQUEST_CODE_LOGIN_AVATAR = 10024;
    ...
    public static final int REQUEST_CODE_QQ_STRANGER = 10028;
    ...
    public static final int REQUEST_PHOTO_CROP_RESULT = 257;
    public static final int REQUEST_PHOTO_PICK_RESULT = 272;
    public static final int REQUEST_QZONE_AUTO_TEMPLATE = 10;
    ...
    public static final String SEND_COMMENT_CONTENT = "PhotoConst.SEND_COMMENT_CONTENT";
    ...
    public static final String SEND_PHOTO_ACTIVITY_FROM = "PhotoConst.SEND_PHOTO_ACTIVITY_FROM";
    public static final String SEND_PHOTO_ACTIVITY_FROM_AIO_PHOTO_LIST = "PhotoConst.AIO_PHOTO_LIST";
    public static final String SEND_PHOTO_ACTIVITY_RESULT = "PhotoConst.send_photo_activity_result";
    public static final String SEND_PICTURE_EDIT_PLAY_PARAMS = "PhotoConst.EDIT_PLAY_PARAMS";
    ...
    public static final String SHOW_QZONE_MEDIA_PICKER_PUBLISH_TEXT_MOOD_ENTRANCE = "show_qzone_media_picker_publichs_text_mood_entrance";
    ...
    public static final String TAKE_PHOTO_BUSINESS = "take_photo_business";
    ...
    public static final String TITLE_BAR_BLACK_BG = "PhotoConst.TITLE_BAR_BG";
    ...
    public static final String USE_AUDIO = "useaudio";
    public static final String USE_NEW_ALBUM = "useNewAlbum";
    ...
    public static final String VIDEO_EDIT_AND_THEN_PREVIEW = "video_edit_and_then_preview";
    public static final String VIDEO_EDIT_ENABLED = "video_edit_enabled";
    public static final String VIDEO_EDIT_GAME_STRATEGY_PUBLISH = "video_edit_game_strategy_publish";
    public static final String VIDEO_EDIT_NEW_MEDIA = "video_edit_new_media";
    public static final String VIDEO_EDIT_OLD_MEDIA = "video_edit_old_media";
    ...
    public static final int WINK_PHOTO_LIST_ENTRANCE_FROM_CUSTOM_STICKER = 4;
    public static final int WINK_PHOTO_LIST_ENTRANCE_FROM_PUBLISH = 0;
    public static final int WINK_PHOTO_LIST_ENTRANCE_FROM_TEMPLATE_CLIP = 3;
    ...
    public interface Menu {
        public static final int MENU_CUT_AND_ROTATE = 2131895625;
        public static final int MENU_DOODLE = 2131895626;
        public static final int MENU_SEND_NOMAL = 2131895627;
        public static final int MENU_SEND_RAW = 2131895628;
        public static final int MENU_WATERMARK = 2131895629;
    }
