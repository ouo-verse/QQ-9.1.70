    ...
    public static AppRuntime a(BaseApplicationImpl baseApplicationImpl, String str) {
        ...
        if (baseApplicationImpl != null && str != null) {
            try {
                try {
                    try {
                        cls = Class.forName("com.qqindividuality.application.QQIndividualityRuntime");
                ...
                Class<?> loadClass = orCreateClassLoader.loadClass("com.qqindividuality.application.QQIndividualityRuntime");
