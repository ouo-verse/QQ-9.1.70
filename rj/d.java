...
public final class d extends com.qzone.reborn.base.f<QZoneAlbumInfoBean> {
    ...
    public boolean isForViewType(QZoneAlbumInfoBean item, List<QZoneAlbumInfoBean> items, int position) {
    ...
    public int getLayoutId() {
        return R.layout.f128523l;
    }

    @Override // com.qzone.reborn.base.f, com.tencent.biz.richframework.part.adapter.delegate.AbsItemAdapterDelegate
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<QZoneAlbumInfoBean>>> sections) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        super.initSection(parent, itemView, sections);
        sections.add(hk.b.class);
        sections.add(hk.a.class);
    }
}
