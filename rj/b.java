...
public final class b extends com.qzone.reborn.base.f<QZIntimateProfileReader$IntimateSpaceAbs> {
    ...
    public boolean isForViewType(QZIntimateProfileReader$IntimateSpaceAbs item, List<QZIntimateProfileReader$IntimateSpaceAbs> items, int position) {
    ...
    public void initSection(ViewGroup parent, View itemView, List<Class<? extends Section<QZIntimateProfileReader$IntimateSpaceAbs>>> sections) {
        Intrinsics.checkNotNullParameter(parent, "parent");
        Intrinsics.checkNotNullParameter(itemView, "itemView");
        Intrinsics.checkNotNullParameter(sections, "sections");
        super.initSection(parent, itemView, sections);
        sections.add(jk.b.class);
    }
}
