...
public final class ThirdPartLogin$UinInfo extends MessageMicro<ThirdPartLogin$UinInfo> {
    ...
    static {
        ...
        __fieldMap__ = MessageMicro.initFieldMap(new int[]{10, 18, 26, 34, 42, 50}, new String[]{"str_mask_uin", "str_nick", "str_image_url", "bytes_encrypt_uin", "str_key_uin", "bytes_a1_sig"}, new Object[]{"", "", "", byteStringMicro, "", byteStringMicro}, ThirdPartLogin$UinInfo.class);
    }

    public ThirdPartLogin$UinInfo() {
        ByteStringMicro byteStringMicro = ByteStringMicro.EMPTY;
