...
public class c extends com.tencent.biz.qqcircle.viewmodels.a implements IDataDisplaySurface<e30.b> {
    ...
    private final MediatorLiveData<UIStateData<List<e30.b>>> f398594m = new MediatorLiveData<>();
    ...
    public static class a implements VSDispatchObserver.OnVSRspCallBack<FeedCloudRead$StGetSearchPageRsp> {
        ...
        private final WeakReference<c> f398595a;

        a(c cVar) {
            this.f398595a = new WeakReference<>(cVar);
        }
        ...
        public void onReceive(BaseRequest baseRequest, boolean z16, long j3, String str, FeedCloudRead$StGetSearchPageRsp feedCloudRead$StGetSearchPageRsp) {
            ...
            sb5.append(str);
            sb5.append(" | size:");
            sb5.append(feedCloudRead$StGetSearchPageRsp != null ? feedCloudRead$StGetSearchPageRsp.searchFeedInfo.feedList.size() : 0);
            QLog.d("ECVideoViewModel", 1, sb5.toString());
            if (!z16 || j3 != 0) {
    ...
    private boolean Q1() {
        if ((this.f398594m.getValue() != null ? this.f398594m.getValue().getState() : 0) != 1) {
            return false;
        }
        QLog.d("ECVideoViewModel", 1, hashCode() + "|requestFeed is loading");
        return true;
    }
    ...
    public List<e30.b> T1() {
        UIStateData<List<e30.b>> value = this.f398594m.getValue();
        if (value == null) {
    ...
    public void W1(final FeedCloudRead$StGetSearchPageRsp feedCloudRead$StGetSearchPageRsp) {
        ThreadManagerV2.excute(new Runnable() { // from class: fg2.a
    ...
    public /* synthetic */ void Z1(boolean z16, Collection collection, UIStateData uIStateData) {
        if (this.f398594m.getValue() != null) {
            List<e30.b> data = this.f398594m.getValue().getData();
            ArrayList arrayList = new ArrayList();
        ...
        this.f398594m.setValue(uIStateData);
    }
    ...
    private void c2(FeedCloudRead$StGetSearchPageRsp feedCloudRead$StGetSearchPageRsp, boolean z16) {
        ...
        QLog.d("ECVideoViewModel", 1, hashCode() + "| filter ditto size:" + S1.size());
    ...
    public void f2(List<FeedCloudMeta$StFeed> list) {
        if (list != null && !list.isEmpty()) {
            ...
            this.f398594m.setValue(obtainSuccess);
            if (b16 == null || b16.isEmpty()) {
                QLog.w("ECVideoViewModel", 1, "#refreshData: no feedBlockDataList, stFeeds.size=" + list.size());
                return;
            }
            return;
        }
        this.f398594m.setValue(null);
        QLog.i("ECVideoViewModel", 2, "#refreshData: empty data");
    }
    ...
    public MutableLiveData<UIStateData<List<e30.b>>> getDisplaySurfaceData(Object... objArr) {
        UIStateData<List<e30.b>> value = this.f398594m.getValue();
        if (value == null) {
            QLog.w("ECVideoViewModel", 1, "#getDisplaySurfaceData: uiStateData is null");
        } else {
            List<e30.b> data = value.getData();
            if (data == null) {
                QLog.w("ECVideoViewModel", 1, "#getDisplaySurfaceData: blockDataList is null");
            } else {
                QLog.d("ECVideoViewModel", 1, "#getDisplaySurfaceData: blockDataList size=" + data.size());
            }
        }
        return this.f398594m;
    }
    ...
    private static boolean b2(FeedCloudRead$StGetSearchPageRsp feedCloudRead$StGetSearchPageRsp) {
        return feedCloudRead$StGetSearchPageRsp == null || feedCloudRead$StGetSearchPageRsp.searchFeedInfo.isOver.get() > 0;
    }
}
