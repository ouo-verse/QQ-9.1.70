...
public final class PicInfo extends JceStruct {
    ...
    static {
        ...
        cache_through_to_adapt_server = hashMap2;
        hashMap2.put("", "");
        HashMap hashMap3 = new HashMap();
        cache_pic_extend = hashMap3;
        hashMap3.put("", "");
    }
    ...
    public PicInfo() {
        ...
        this.richval = "";
        this.vectPicBin = null;
        this.uploadtime = 0L;
        this.sourceType = 0;
        this.imageId = "";
        this.picmd5 = "";
        this.through_to_adapt_server = null;
        this.video_id = "";
        this.quan_key = "";
        this.pic_extend = null;
    }
    ...
    public void readFrom(JceInputStream jceInputStream) {
        ...
        this.sourceType = jceInputStream.read(this.sourceType, 18, false);
        this.imageId = jceInputStream.readString(19, false);
        this.picmd5 = jceInputStream.readString(20, false);
        this.through_to_adapt_server = (Map) jceInputStream.read((JceInputStream) cache_through_to_adapt_server, 21, false);
        this.video_id = jceInputStream.readString(22, false);
        this.quan_key = jceInputStream.readString(23, false);
        this.pic_extend = (Map) jceInputStream.read((JceInputStream) cache_pic_extend, 24, false);
    }
    ...
    public void writeTo(JceOutputStream jceOutputStream) {
        ...
        String str12 = this.quan_key;
        if (str12 != null) {
            jceOutputStream.write(str12, 23);
        }
        Map<String, String> map3 = this.pic_extend;
        if (map3 != null) {
            jceOutputStream.write((Map) map3, 24);
        }
    }

    public PicInfo(String str, String str2, String str3, int i3, int i16, int i17, boolean z16, String str4, int i18, int i19, String str5, String str6, Map<String, String> map, String str7, int i26, String str8, byte[] bArr, long j3, int i27, String str9, String str10, Map<String, String> map2, String str11, String str12, Map<String, String> map3) {
        this.albumid = str;
        this.pictureid = str2;
        this.sloc = str3;
        this.pictype = i3;
        ...
        this.richval = str8;
        this.vectPicBin = bArr;
        this.uploadtime = j3;
        this.sourceType = i27;
        this.imageId = str9;
        this.picmd5 = str10;
        this.through_to_adapt_server = map2;
        this.video_id = str11;
        this.quan_key = str12;
        this.pic_extend = map3;
    }
}
