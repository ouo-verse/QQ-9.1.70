...
public final class a {
    ...
    private final void d() {
        ...
        be0.a.b("qq_stranger").c(QUIProfileConstants.DEFAULT_COLOR_PALETTE);
    }
    ...
    public final LayoutInflater a(LayoutInflater base) {
        ...
        QLog.i("QQStrangerQUIProfileTheme", 1, "use profile layout inflater " + this.context.getClass().getName());
        this.quiLayoutInflater = new QUIProfileLayoutInflater(base, this.context, "qq_stranger");
        d();
    ...
    public final Resources b(Resources base) {
        ...
        QLog.i("QQStrangerQUIProfileTheme", 1, "use profile resources " + this.context.getClass().getName());
        this.quiResources = new QUIProfileResources(base, this.context, "qq_stranger");
        d();
