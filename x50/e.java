...
public class e extends u implements SimpleEventReceiver, View.OnClickListener, d.a, IOrderElement, c.a {
    private x50.b D;
    ...
    private View f447228d;

    /* renamed from: e, reason: collision with root package name */
    private View f447229e;

    /* renamed from: f, reason: collision with root package name */
    private View f447230f;

    /* renamed from: h, reason: collision with root package name */
    private ImageView f447231h;

    /* renamed from: i, reason: collision with root package name */
    private ImageView f447232i;

    /* renamed from: m, reason: collision with root package name */
    private volatile boolean f447233m = false;
    ...
    private void F9() {
        QLog.d("QFSMainPageAdPart", 1, "changeToCollapseMode");
        if (this.f447228d == null) {
            return;
        }
        this.f447233m = false;
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.f447228d, "translationX", 0.0f, cx.a(8.0f));
        ofFloat.setDuration(120L);
        ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.f447228d, "translationX", cx.a(8.0f), -cx.a(94.0f));
        ofFloat2.setDuration(200L);
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.addListener(new b());
        animatorSet.play(ofFloat).before(ofFloat2);
        animatorSet.start();
        VideoReport.traversePage(this.f447230f);
    }
    ...
    private void I9() {
        QLog.d("QFSMainPageAdPart", 1, "fetchData");
        ga0.c.m().a();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void J9() {
        QLog.d("QFSMainPageAdPart", 1, "handleCollapseViewAppear");
        fa0.d<x50.b> dVar = this.E;
        x50.b bVar = this.D;
        if (this.f447229e != null && dVar != null && bVar != null) {
            dVar.i(bVar.f447221d, this.f447231h);
            this.f447229e.setVisibility(0);
            View view = this.f447228d;
            if (view != null) {
                view.setVisibility(8);
                H9(this.f447232i);
            }
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.f447229e, "translationX", -cx.a(36.0f), 0.0f);
            ofFloat.setDuration(160L);
            ofFloat.addListener(new c(bVar));
            ofFloat.start();
            return;
        }
        QLog.e("QFSMainPageAdPart", 1, "handleCollapseViewAppear mCollapsedContainer == null || resLoadManager == null");
    }
    ...
    private void K9(@NonNull QFSFeedPositionChangeEvent qFSFeedPositionChangeEvent) {
        ...
        int i3 = this.F + 1;
        this.F = i3;
        if (i3 >= 3 && this.f447233m) {
            F9();
        }
    }

    private void L9(@NonNull x50.b bVar) {
        if (this.f447230f != null) {
            return;
        }
        View inflate = ((ViewStub) getPartRootView().findViewById(R.id.scj)).inflate();
        this.f447230f = inflate;
        View findViewById = inflate.findViewById(R.id.f33320w5);
        this.f447228d = findViewById;
        ImageView imageView = (ImageView) findViewById.findViewById(R.id.f33330w6);
        this.f447232i = imageView;
        imageView.setOnClickListener(this);
        View findViewById2 = this.f447228d.findViewById(R.id.f33290w2);
        findViewById2.setOnClickListener(this);
        View findViewById3 = this.f447230f.findViewById(R.id.f349510j);
        this.f447229e = findViewById3;
        View findViewById4 = findViewById3.findViewById(R.id.f33300w3);
        findViewById4.setOnClickListener(this);
        ImageView imageView2 = (ImageView) this.f447229e.findViewById(R.id.f33310w4);
        this.f447231h = imageView2;
        imageView2.setOnClickListener(this);
        E9(this.f447232i, bVar, "open");
        E9(this.f447231h, bVar, QCircleDaTongConstant.ElementParamValue.CONTAINER_STATUS_STOW);
    ...
    private void P9() {
        try {
            ...
            QLog.e("QFSMainPageAdPart", 1, "convert json error:" + e16);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void W9(ImageView imageView, String str) {
        if (!TextUtils.isEmpty(str) && imageView != null) {
            Drawable drawable = imageView.getDrawable();
            Option needShowLoadingDrawable = Option.obtain().setUrl(str).setTargetView(imageView).setNeedShowLoadingDrawable(false);
            if (drawable != null) {
                needShowLoadingDrawable.setLoadingDrawable(drawable);
            }
            QCircleFeedPicLoader.g().loadImage(needShowLoadingDrawable);
        }
    }

    private void X9() {
        getMainHandler().post(new Runnable() { // from class: x50.d
    ...
    private void Z9(View view) {
        int i3;
        if (view == null) {
            QLog.d("QFSMainPageAdPart", 1, "[updateAdRootViewVisible] view should not be null.");
            return;
        }
        boolean a16 = x50.a.a();
        QLog.d("QFSMainPageAdPart", 1, "[updateAdRootViewVisible] isAdRootViewExp: " + a16);
        if (a16) {
            i3 = 8;
        } else {
            i3 = 0;
    ...
    @Override // fa0.d.a
    public void A2() {
        QLog.d("QFSMainPageAdPart", 1, "onPreloadSucceed");
        com.tencent.biz.qqcircle.immersive.manager.e.a().notifyGroupActivate(this);
    }
    ...
    public void G9() {
        QLog.d("QFSMainPageAdPart", 1, "changeToExpandMode");
        fa0.d<x50.b> dVar = this.E;
        x50.b bVar = this.D;
        View view = this.f447228d;
        if (view != null && dVar != null && bVar != null) {
            view.setVisibility(0);
            dVar.i(bVar.f447219b, this.f447232i);
            this.f447233m = true;
            View view2 = this.f447229e;
            if (view2 != null) {
                view2.setVisibility(8);
            }
            H9(this.f447231h);
            ObjectAnimator ofFloat = ObjectAnimator.ofFloat(this.f447228d, "translationX", cx.a(-72.0f), cx.a(8.0f));
            ofFloat.setDuration(240L);
            ObjectAnimator ofFloat2 = ObjectAnimator.ofFloat(this.f447228d, "translationX", cx.a(8.0f), 0.0f);
        ...
        QLog.e("QFSMainPageAdPart", 1, "mExpandContainer == null || resLoadManager == null");
    }
    ...
    public boolean isElementCanActivate() {
        ...
        QLog.e("QFSMainPageAdPart", 1, "isElementCanActivate elementShowHistory containChangeTabElement");
        return false;
    }
    ...
    public class a implements Animator.AnimatorListener {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ x50.b f447234d;
        ...
        public void onAnimationEnd(Animator animator) {
            e eVar = e.this;
            eVar.W9(eVar.f447232i, this.f447234d.f447223f);
        }
    ...
    public class c implements Animator.AnimatorListener {
        ...
        /* renamed from: d, reason: collision with root package name */
        final /* synthetic */ x50.b f447237d;
        ...
        public void onAnimationEnd(Animator animator) {
            e eVar = e.this;
            eVar.W9(eVar.f447231h, this.f447237d.f447224g);
        }
