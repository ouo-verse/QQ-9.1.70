...
public class a {
    ...
    private static Object f438191a = new Object();

    /* renamed from: b, reason: collision with root package name */
    private static QQLiveCurRoomInfo f438192b;
    ...
    private static Bundle b(@NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            if (callServer == null) {
                QLog.e("ICGame_IPC_RRM", 1, str + ", ipc result is null");
                return null;
            }
            if (!callServer.isSuccess()) {
                QLog.e("ICGame_IPC_RRM", 1, str + ", result is failed: " + callServer.code, callServer.f396321e);
                return null;
            }
            Bundle bundle2 = callServer.data;
            if (bundle2 == null) {
                QLog.e("ICGame_IPC_RRM", 1, str + ", result's data is null");
                return null;
            }
            return bundle2;
        } catch (Throwable th5) {
            QLog.e("ICGame_IPC_RRM", 1, th5, new Object[0]);
            return null;
        }
    }
    ...
    public static QQLiveCurRoomInfo c(@Nullable String str) {
        if (QLog.isColorLevel()) {
            QLog.d("ICGame_IPC_RRM", 1, "getCurRoomInfo, appId=" + str);
        }
        if (f()) {
            return e(str);
        }
    ...
    private static QQLiveCurRoomInfo d(@Nullable String str) {
        if (QLog.isColorLevel()) {
            QLog.d("ICGame_IPC_RRM", 1, "getCurRoomInfoIPC, appId=" + str);
        }
    ...
    private static QQLiveCurRoomInfo e(@Nullable String str) {
        if (QLog.isColorLevel()) {
            QLog.d("ICGame_IPC_RRM", 1, "getCurRoomInfoInMainProcess, appId=" + str);
        }
        return f438192b;
    }
    ...
    public static boolean f() {
        if (QLog.isColorLevel()) {
            QLog.d("ICGame_IPC_RRM", 1, "processId: " + MobileQQ.sProcessId);
        }
    ...
    public static void g(@Nullable String str, QQLiveCurRoomInfo qQLiveCurRoomInfo) {
        if (QLog.isColorLevel()) {
            QLog.d("ICGame_IPC_RRM", 1, "recordCurRoomInfo, appId=" + str);
        }
        if (f()) {
    ...
    public static void h(@Nullable String str, long j3) {
        QLog.i("ICGame_IPC_RRM", 1, "removeCurRoomInfo, appId=" + str + ", roomId:" + j3);
        if (f()) {
            j(str, j3);
        } else {
            i(str, j3);
    ...
    private static void i(@Nullable String str, long j3) {
        QLog.d("ICGame_IPC_RRM", 1, "removeCurRoomInfoIPC, appId=" + str + ", roomId:" + j3);
        Bundle bundle = new Bundle();
        bundle.putString("key_app_id", str);
    ...
    private static void j(@Nullable String str, long j3) {
        QLog.i("ICGame_IPC_RRM", 1, "removeCurRoomInfoInMainProcess, appId=" + str + ", roomId:" + j3);
        synchronized (f438191a) {
            QQLiveCurRoomInfo qQLiveCurRoomInfo = f438192b;
            if (qQLiveCurRoomInfo == null) {
                QLog.w("ICGame_IPC_RRM", 1, "removeCurRoomRecord, curRoomInfo is null, appId:" + str);
                return;
            }
            if (j3 == -1) {
                f438192b = null;
                QLog.w("ICGame_IPC_RRM", 1, "roomId is -1, clear");
            } else {
                if (qQLiveCurRoomInfo.roomId != j3) {
                    QLog.w("ICGame_IPC_RRM", 1, "removeCurRoomRecord, roomId diff, cur=" + f438192b.roomId + ", target=" + j3);
                    return;
                }
                f438192b = null;
            }
    ...
    private static void k(@Nullable String str, QQLiveCurRoomInfo qQLiveCurRoomInfo) {
        if (QLog.isColorLevel()) {
            QLog.d("ICGame_IPC_RRM", 1, "setCurRoomInfoIPC, appId=" + str);
        }
        Bundle bundle = new Bundle();
        bundle.putString("key_app_id", str);
    ...
    private static void l(@Nullable String str, QQLiveCurRoomInfo qQLiveCurRoomInfo) {
        ...
        if (QLog.isColorLevel()) {
            ...
            QLog.d("ICGame_IPC_RRM", 1, sb5.toString());
        }
        synchronized (f438191a) {
            QQLiveCurRoomInfo qQLiveCurRoomInfo3 = f438192b;
            if (qQLiveCurRoomInfo3 != null && !qQLiveCurRoomInfo3.isConditionEquals(qQLiveCurRoomInfo)) {
                QLog.e("ICGame_IPC_RRM", 1, "recordCurRoomInfo, curRoomInfo not null");
            }
            f438192b = qQLiveCurRoomInfo;
        }
    }
}
