    ...
    public void onSend(Intent intent, Packet packet) {
        ...
        if (byteArrayExtra != null) {
            ...
            try {
                ...
                QLog.e("CertifiedAccountPublishFeedServlet", 2, QLog.getStackTraceString(e17));
            }
        } else {
            stCommonExt = null;
        }
        ...
        if (byteArrayExtra2 != null) {
            ...
            try {
                ...
                e16 = e19;
                QLog.e("CertifiedAccountPublishFeedServlet", 2, QLog.getStackTraceString(e16));
                certifiedAccountMeta$StFeed2 = certifiedAccountMeta$StFeed;
                a16 = new d(stCommonExt, certifiedAccountMeta$StFeed2).a(intent, intExtra, a.getTraceId());
                if (a16 == null) {
                }
                packet.setSSOCommand("CertifiedAccountSvc.certified_account_write.PublishFeed");
